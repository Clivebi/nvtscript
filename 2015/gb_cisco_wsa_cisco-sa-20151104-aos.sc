...
if(version_is_less( version: version, test_version: "7.7.0.761" )){
	fix = "7.7.0-761";
}
if(version_in_range( version: version, test_version: "8.0", test_version2: "8.0.8.112" )){
	fix = "8.0.8-113";
}
if(version_in_range( version: version, test_version: "8.1", test_version2: "8.5.3.050" )){
	fix = "8.5.3-051";
}
if(version_in_range( version: version, test_version: "8.6", test_version2: "8.7.0.170" )){
	fix = "8.7.0-171-LD";
}
if(version_in_range( version: version, test_version: "8.8", test_version2: "8.8.0.084" )){
	fix = "8.8.0-085";
}
if(fix){
