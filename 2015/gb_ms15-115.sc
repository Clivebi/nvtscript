if(description){
	...
	script_cve_id( "CVE-2015-6100", "CVE-2015-6101", "CVE-2015-6102", "CVE-2015-6103", "CVE-2015-6104", "CVE-2015-6109", "CVE-2015-6113" );
...
if( hotfix_check_sp( winVista: 3, win2008: 3 ) > 0 ){
	if(dllVer){
		if( version_is_less( version: dllVer, test_version: "6.0.6002.19525" ) ){
			...
			if(version_in_range( version: dllVer, test_version: "6.0.6002.23000", test_version2: "6.0.6002.23834" )){
				VULN2 = TRUE;
	...
	if(exeVer){
		if( version_is_less( version: exeVer, test_version: "6.0.6002.19514" ) ){
			...
			if(version_in_range( version: exeVer, test_version: "6.0.6002.23000", test_version2: "6.0.6002.23823" )){
				VULN3 = TRUE;
	...
	if( hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0 ){
		if(dllVer){
			if( version_is_less( version: dllVer, test_version: "6.1.7601.19044" ) ){
				...
				if(version_in_range( version: dllVer, test_version: "6.1.7601.22000", test_version2: "6.1.7601.23249" )){
					VULN2 = TRUE;
		...
		if(exeVer){
			if( version_is_less( version: exeVer, test_version: "6.1.7601.19045" ) ){
				...
				if(exeVer && version_in_range( version: exeVer, test_version: "6.1.7601.22000", test_version2: "6.1.7601.23249" )){
					VULN3 = TRUE;
					Vulnerable_range = "6.1.7601.22000 - 6.1.7601.23249";
				}
			}
		...
		if( hotfix_check_sp( win8: 1, win8x64: 1, win2012: 1 ) > 0 ){
			if(dllVer){
				if( version_is_less( version: dllVer, test_version: "6.2.9200.17554" ) ){
					...
					if(version_in_range( version: dllVer, test_version: "6.2.9200.20000", test_version2: "6.2.9200.21670" )){
						VULN2 = TRUE;
			...
			if(exeVer){
				if( version_is_less( version: exeVer, test_version: "6.2.9200.17557" ) ){
					...
					if(version_in_range( version: exeVer, test_version: "6.2.9200.20000", test_version2: "6.2.9200.21673" )){
						VULN3 = TRUE;
			...
			if( hotfix_check_sp( win8_1: 1, win8_1x64: 1, win2012R2: 1 ) > 0 ){
				if( dllVer && version_is_less( version: dllVer, test_version: "6.3.9600.18093" ) ){
					...
					if(exeVer && version_is_less( version: exeVer, test_version: "6.3.9600.18090" )){
						VULN3 = TRUE;
