...
if(description){
	...
	script_cve_id( "CVE-2015-8005", "CVE-2015-8004", "CVE-2015-8003", "CVE-2015-8002", "CVE-2015-8001" );
...
if( version_is_less( version: http_ver, test_version: "1.23.11" ) ){
	...
	if( version_in_range( version: http_ver, test_version: "1.24.0", test_version2: "1.24.3" ) ){
		fix = "1.24.4";
		VULN = TRUE;
	}
	else {
		if(version_in_range( version: http_ver, test_version: "1.25.0", test_version2: "1.25.3" )){
			fix = "1.25.3";
			VULN = TRUE;
		}
	}
