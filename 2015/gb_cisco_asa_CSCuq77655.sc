...
if(( revcomp( a: compver, b: "7.2.5.16" ) < 0 ) && ( revcomp( a: compver, b: "7.2" ) >= 0 )){
	report = "Installed Version: " + version + "\n" + "Fixed Version:     7.2(5.16)\n";
	security_message( port: 0, data: report );
	exit( 0 );
}
if(( revcomp( a: compver, b: "8.2.5.57" ) < 0 ) && ( revcomp( a: compver, b: "8.2" ) >= 0 )){
	report = "Installed Version: " + version + "\n" + "Fixed Version:     8.2(5.57)\n";
	security_message( port: 0, data: report );
	exit( 0 );
}
if(( revcomp( a: compver, b: "8.3.2.44" ) < 0 ) && ( revcomp( a: compver, b: "8.3" ) >= 0 )){
	report = "Installed Version: " + version + "\n" + "Fixed Version:     8.3(2.44)\n";
	security_message( port: 0, data: report );
	exit( 0 );
}
if(( revcomp( a: compver, b: "8.4.7.28" ) < 0 ) && ( revcomp( a: compver, b: "8.4" ) >= 0 )){
	report = "Installed Version: " + version + "\n" + "Fixed Version:     8.4(7.28)\n";
	security_message( port: 0, data: report );
	exit( 0 );
}
if(( revcomp( a: compver, b: "8.5.1.24" ) < 0 ) && ( revcomp( a: compver, b: "8.5" ) >= 0 )){
	report = "Installed Version: " + version + "\n" + "Fixed Version:     8.5(1.24)\n";
	security_message( port: 0, data: report );
	exit( 0 );
}
if(( revcomp( a: compver, b: "8.6.1.17" ) < 0 ) && ( revcomp( a: compver, b: "8.6" ) >= 0 )){
	report = "Installed Version: " + version + "\n" + "Fixed Version:     8.6(1.17)\n";
	security_message( port: 0, data: report );
	exit( 0 );
}
if(( revcomp( a: compver, b: "8.7.1.16" ) < 0 ) && ( revcomp( a: compver, b: "8.7" ) >= 0 )){
	report = "Installed Version: " + version + "\n" + "Fixed Version:     8.7(1.16)\n";
	security_message( port: 0, data: report );
	exit( 0 );
}
if(( revcomp( a: compver, b: "9.0.4.33" ) < 0 ) && ( revcomp( a: compver, b: "9.0" ) >= 0 )){
	report = "Installed Version: " + version + "\n" + "Fixed Version:     9.0(4.33)\n";
	security_message( port: 0, data: report );
	exit( 0 );
}
if(( revcomp( a: compver, b: "9.1.6.1" ) < 0 ) && ( revcomp( a: compver, b: "9.1" ) >= 0 )){
	report = "Installed Version: " + version + "\n" + "Fixed Version:     9.1(6.1)\n";
	security_message( port: 0, data: report );
	exit( 0 );
}
if(( revcomp( a: compver, b: "9.2.3.4" ) < 0 ) && ( revcomp( a: compver, b: "9.2" ) >= 0 )){
	report = "Installed Version: " + version + "\n" + "Fixed Version:     9.2(3.4)\n";
	security_message( port: 0, data: report );
	exit( 0 );
}
if(( revcomp( a: compver, b: "9.3.3" ) < 0 ) && ( revcomp( a: compver, b: "9.3" ) >= 0 )){
	report = "Installed Version: " + version + "\n" + "Fixed Version:     9.3(3)\n";
	security_message( port: 0, data: report );
	exit( 0 );
}
