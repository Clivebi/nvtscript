	...
	if(path){
		for ver in make_list( "",
			...
			if(commVer){
				...
				if(version_in_range( version: commVer, test_version: "5.0", test_version2: "5.0.8687.147" ) || version_in_range( version: commVer, test_version: "4.0", test_version2: "4.0.7577.4483" )){
