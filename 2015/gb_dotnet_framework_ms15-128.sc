	...
	if(dllVer){
		if( hotfix_check_sp( win8: 1, win2012: 1 ) > 0 ){
			if( version_in_range( version: dllVer, test_version: "3.0.6920.6400", test_version2: "3.0.6920.6421" ) ){
				...
				if(version_in_range( version: dllVer, test_version: "3.0.6920.8600", test_version2: "3.0.6920.8692" )){
					VULN1 = TRUE;
		...
		if(exeVer){
			if(hotfix_check_sp( winVista: 3, win2008: 3 ) > 0){
				if( version_in_range( version: exeVer, test_version: "3.0.6920.4200", test_version2: "3.0.6920.4229" ) ){
					...
					if(version_in_range( version: exeVer, test_version: "3.0.6920.7000", test_version2: "3.0.6920.8692" )){
						VULN2 = TRUE;
		...
		if(dllPres){
			if(hotfix_check_sp( winVista: 3, win2008: 3 ) > 0){
				if( version_in_range( version: dllPres, test_version: "4.0.30319.1000", test_version2: "4.0.30319.1043" ) ){
					...
					if(version_in_range( version: dllPres, test_version: "4.0.30319.2000", test_version2: "4.0.30319.2076" )){
						VULN3 = TRUE;
		...
		if(dllv45){
			if(hotfix_check_sp( winVista: 3, win2008: 3 ) > 0){
				if( version_in_range( version: dllv45, test_version: "4.0", test_version2: "4.0.30319.34279" ) ){
					...
					if(version_in_range( version: dllv45, test_version: "4.0.30319.36000", test_version2: "4.0.30319.36329" )){
						VULN4 = TRUE;
