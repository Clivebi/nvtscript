...
General solution options are to upgrade to a newer release, disable respective features, remove the product or replace the product by another one." );
	...
	script_dependencies( "gb_phpwiki_detect.sc" );
...
url = dir + "/index.php?pagename=%3C%2Fscript%3E%3Cscript%3Ealert%28document" + ".cookie%29%3C%2Fscript%3E%3C!--";
if(http_vuln_check( port: http_port, url: url, check_header: TRUE, pattern: "<script>alert\\(document.cookie\\)</script", extra_check: "PhpWiki" )){
