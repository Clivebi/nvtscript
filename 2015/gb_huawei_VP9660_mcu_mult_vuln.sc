...
if(description){
	...
	script_version( "2020-12-11T05:22:36+0000" );
	script_tag( name: "last_modification", value: "2020-12-11 05:22:36 +0000 (Fri, 11 Dec 2020)" );
	...
	script_dependencies( "gb_huawei_VP9660_mcu_detect.sc" );
...
if(IsMatchRegexp( vers, "^V200R001C01" ) || IsMatchRegexp( vers, "^V200R001C02" ) || ( IsMatchRegexp( vers, "^V200R001C30" ) && version_is_less( version: vers, test_version: "V200R001C30SPC700" ) )){
