...
version = v[0] + "." + v[1];
if(version_is_less( version: v[0], test_version: "9.3.0" )){
	exit( 99 );
}
if( version_is_less( version: version, test_version: "9.3.2.19" ) ) {
	fix = "9.3.2MR19";
}
else {
	if( version_in_range( version: version, test_version: "9.4.2", test_version2: "9.4.2.8" ) ) {
		fix = "9.4.2MR9";
	}
	else {
		if(version_in_range( version: version, test_version: "9.5.0", test_version2: "9.5.0.7" )){
			fix = "9.5.0MR8";
		}
	}
}
