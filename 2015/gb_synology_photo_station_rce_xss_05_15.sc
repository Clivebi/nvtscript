...
url = dir + "/m/login.php?success=%3E%3Cscript%3Ealert%28documen" + "t.cookie%29%3C/script%3E";
if(http_vuln_check( port: photoPort, url: url, pattern: "<script>alert\\(document.cookie\\)</script>", extra_check: make_list( ">Photo Station<",
	 ">Synology" ), check_header: TRUE )){
