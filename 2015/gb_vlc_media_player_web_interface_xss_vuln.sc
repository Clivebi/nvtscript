...
if(description){
  ...
  version 2.2.0 or later." );
	...
	script_dependencies( "gb_vlc_media_player_remote_detect.sc" );
...
if(http_vuln_check( port: vlcPort, url: url, check_header: TRUE, pattern: "<script>alert\\(document\\.cookie\\);</script>" )){
