...
if(version_is_less( version: version, test_version: "8.5.7.043" )){
	fix = "8.5.7-043";
}
if(version_in_range( version: version, test_version: "9.0", test_version2: "9.1.1.022" )){
	fix = "9.1.1-023";
}
if(version_in_range( version: version, test_version: "9.5", test_version2: "9.6.0.045" )){
	fix = "9.6.0-046";
}
if(fix){
