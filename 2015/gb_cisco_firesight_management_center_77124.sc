...
and executing commands on the underlying operating system. The user needs to log in to the device with valid administrator-level credentials." );
	...
	script_dependencies( "gb_cisco_firesight_management_center_version.sc" );
...
if(version_in_range( version: version, test_version: "5.3.1", test_version2: "5.3.1.7" )){
	VULN = TRUE;
}
if(version_in_range( version: version, test_version: "5.4.0", test_version2: "5.4.0.4" )){
	VULN = TRUE;
}
if(version == "6.0.0"){
	VULN = TRUE;
