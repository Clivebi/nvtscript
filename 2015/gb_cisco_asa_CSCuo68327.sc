...
if(( revcomp( a: compver, b: "9.0.4.13" ) < 0 ) && ( revcomp( a: compver, b: "9.0.4.8" ) >= 0 )){
	report = "Installed Version: " + version + "\n" + "Fixed Version:     9.0(4.13)\n";
	security_message( port: 0, data: report );
	exit( 0 );
}
if(( revcomp( a: compver, b: "9.1.5.7" ) < 0 ) && ( revcomp( a: compver, b: "9.1.5.2" ) >= 0 )){
	report = "Installed Version: " + version + "\n" + "Fixed Version:     9.1(5.7)\n";
	security_message( port: 0, data: report );
	exit( 0 );
}
if(( revcomp( a: compver, b: "9.2.2" ) < 0 ) && ( revcomp( a: compver, b: "9.2" ) >= 0 )){
	report = "Installed Version: " + version + "\n" + "Fixed Version:     9.2(2)\n";
	security_message( port: 0, data: report );
	exit( 0 );
}
