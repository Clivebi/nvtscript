if(description){
	...
	script_cve_id( "CVE-2015-2376", "CVE-2015-2377", "CVE-2015-2415", "CVE-2015-2378", "CVE-2015-2375" );
...
if(IsMatchRegexp( excelVer, "^(12|14|15)\\..*" )){
	if(version_in_range( version: excelVer, test_version: "12.0", test_version2: "12.0.6723.4999" ) || version_in_range( version: excelVer, test_version: "14.0", test_version2: "14.0.7153.4999" ) || version_in_range( version: excelVer, test_version: "15.0", test_version2: "15.0.4737.999" )){
