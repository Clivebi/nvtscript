...
if( hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0 && dllVer ){
	if( version_is_less( version: dllVer, test_version: "2001.12.8531.19062" ) ){
		...
		if(version_in_range( version: dllVer, test_version: "2001.12.8531.23000", test_version2: "2001.12.8531.23277" )){
	...
	if( hotfix_check_sp( winVista: 3, win2008: 3 ) > 0 && dllVer ){
		if( version_is_less( version: dllVer, test_version: "2001.12.6932.19537" ) ){
			Vulnerable_range = "Less than 2001.12.6932.19537";
			VULN = TRUE;
		}
		else {
			if(version_in_range( version: dllVer, test_version: "2001.12.6932.23000", test_version2: "2001.12.6932.23846" )){
		...
		if( hotfix_check_sp( win8: 1, win8x64: 1, win2012: 1 ) > 0 ){
			if(dllVer){
				if( version_is_less( version: dllVer, test_version: "2001.12.10130.17581" ) ){
					...
					if(version_in_range( version: dllVer, test_version: "2001.12.10130.21000", test_version2: "2001.12.10130.21702" )){
			...
			if(dllVer2){
				if( version_is_less( version: dllVer2, test_version: "6.2.9200.17561" ) ){
					...
					if(version_in_range( version: dllVer2, test_version: "6.2.9200.21000", test_version2: "6.2.9200.21677" )){
