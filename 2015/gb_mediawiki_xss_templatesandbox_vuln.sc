...
if(IsMatchRegexp( reswiki, ">TemplateSandbox<" )){
	...
	if(IsMatchRegexp( rcvRes, "HTTP/1\\.. 200" ) && ContainsString( rcvRes, "javascript:alert(document.cookie)" )){
