...
if(IsMatchRegexp( jreVer, "^(1\\.(8|7))" )){
	if(version_in_range( version: jreVer, test_version: "1.8.0", test_version2: "1.8.0.60" ) || version_in_range( version: jreVer, test_version: "1.7.0", test_version2: "1.7.0.85" )){
