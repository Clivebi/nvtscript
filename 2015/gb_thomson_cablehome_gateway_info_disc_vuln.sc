...
if(IsMatchRegexp( sysdesc, "Thomson CableHome Gateway" )){
	soc = open_sock_udp( snmp_port );
	if(!soc){
		exit( 0 );
	}
	req = raw_string(  );
	...
	if(ContainsString( buf, "Thomson CableHome Gateway" ) && ContainsString( buf, "admin" ) && ContainsString( buf, "Uq-4GIt3M" )){
