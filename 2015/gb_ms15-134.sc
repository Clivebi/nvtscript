...
if( hotfix_check_sp( win7: 2, win7x64: 2 ) > 0 ){
	if( version_is_less( version: ehshell_ver, test_version: "6.1.7601.19061" ) ){
		...
		if(version_in_range( version: ehshell_ver, test_version: "6.1.7601.22000", test_version2: "6.1.7601.23264" )){
	...
	if( hotfix_check_sp( win8: 1, win8x64: 1 ) > 0 ){
		if( version_is_less( version: ehshell_ver, test_version: "6.2.9200.17569" ) ){
			...
			if(version_in_range( version: ehshell_ver, test_version: "6.2.9200.20000", test_version2: "6.2.9200.21687" )){
		...
		if( hotfix_check_sp( win8_1: 1, win8_1x64: 1 ) > 0 ){
			...
			if(hotfix_check_sp( winVista: 3 ) > 0){
				if( version_is_less( version: ehshell_ver, test_version: "6.0.6002.19537" ) ){
					...
					if(version_in_range( version: ehshell_ver, test_version: "6.0.6002.23000", test_version2: "6.0.6002.23846" )){
