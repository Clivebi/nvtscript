...
if( version_is_less( version: http_ver, test_version: "1.19.19" ) ){
	...
	if( version_in_range( version: http_ver, test_version: "1.22.0", test_version2: "1.22.10" ) ){
		fix = "1.22.11";
		VULN = TRUE;
	}
	else {
		if(version_in_range( version: http_ver, test_version: "1.23.0", test_version2: "1.23.3" )){
			fix = "1.23.4";
			VULN = TRUE;
		}
	}
