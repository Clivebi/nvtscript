...
if( registry_key_exists( key: "SOFTWARE\\Microsoft\\Office\\14.0\\InfoPath\\InstallRoot" ) ){
	...
	if( registry_key_exists( key: "SOFTWARE\\Microsoft\\Office\\12.0\\InfoPath\\InstallRoot" ) ){
...
if(infoPath){
	...
	if(IsMatchRegexp( exeVer, "^(12|14|15)\\..*" )){
		...
		if(version_in_range( version: exeVer, test_version: "12.0", test_version2: "12.0.6735.4999" ) || version_in_range( version: exeVer, test_version: "14.0", test_version2: "14.0.7162.4999" ) || version_in_range( version: exeVer, test_version: "15.0", test_version2: "15.0.4763.0999" )){
