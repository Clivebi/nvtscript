...
if(description){
	...
	script_cve_id( "CVE-2015-4736", "CVE-2015-4729", "CVE-2015-2613", "CVE-2015-2619", "CVE-2015-2597" );
...
if(IsMatchRegexp( jreVer, "^(1\\.(8|7))" )){
	if(version_in_range( version: jreVer, test_version: "1.7.0", test_version2: "1.7.0.80" ) || version_in_range( version: jreVer, test_version: "1.8.0", test_version2: "1.8.0.45" )){
