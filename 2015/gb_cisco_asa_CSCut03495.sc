...
if(( revcomp( a: compver, b: "8.2.5.58" ) < 0 ) && ( revcomp( a: compver, b: "7.2" ) >= 0 )){
...
if(( revcomp( a: compver, b: "8.7.1.17" ) < 0 ) && ( revcomp( a: compver, b: "8.7" ) >= 0 )){
...
if(( revcomp( a: compver, b: "9.1.6.4" ) < 0 ) && ( revcomp( a: compver, b: "9.1" ) >= 0 )){
...
if(( revcomp( a: compver, b: "9.3.1" ) < 0 ) && ( revcomp( a: compver, b: "9.3" ) >= 0 )){
	report = "Installed Version: " + version + "\n" + "Fixed Version:     9.3(1)\n";
	security_message( port: 0, data: report );
	exit( 0 );
}
if(( revcomp( a: compver, b: "9.4.1.1" ) < 0 ) && ( revcomp( a: compver, b: "9.4" ) >= 0 )){
