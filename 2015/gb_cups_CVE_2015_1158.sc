...
url = "/help/?QUERY=%3Ca%20href=%22%20%3E%3Cscript%3Ealert%28document.cooki" + "e%29%3C/script%3E%3C!--&SEARCH=Search";
if(http_vuln_check( port: cupsPort, url: url, pattern: "script>alert\\(document.cookie\\)</script>", extra_check: make_list( ">Online Help",
	 "CUPS" ), check_header: TRUE )){
