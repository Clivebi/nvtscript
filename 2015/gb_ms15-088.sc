...
if(hotfix_check_sp( winVista: 3, win2008: 3 ) > 0){
	if(exeVer){
		if( version_is_less( version: exeVer, test_version: "6.0.6002.19438" ) ){
			...
			if(version_in_range( version: exeVer, test_version: "6.0.6002.23000", test_version2: "6.0.6002.23745" )){
	...
	if(dllVer){
		if( version_is_less( version: dllVer, test_version: "6.0.6002.19440" ) ){
			...
			if(version_in_range( version: dllVer, test_version: "6.0.6002.23000", test_version2: "6.0.6002.23747" )){
...
if(hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0){
	if(exeVer){
		if( version_is_less( version: exeVer, test_version: "6.1.7601.18917" ) ){
			...
			if(version_in_range( version: exeVer, test_version: "6.1.7601.22000", test_version2: "6.1.7601.23119" )){
	...
	if(dllVer){
		if( version_is_less( version: dllVer, test_version: "6.1.7601.18918" ) ){
			...
			if(version_in_range( version: dllVer, test_version: "6.1.7601.22000", test_version2: "6.1.7601.23120" )){
...
if(hotfix_check_sp( win8: 1, win8x64: 1, win2012: 1 ) > 0 && exeVer){
	if( version_is_less( version: exeVer, test_version: "6.2.9200.17434" ) ){
		...
		if(version_in_range( version: exeVer, test_version: "6.2.9200.20000", test_version2: "6.2.9200.21544" )){
