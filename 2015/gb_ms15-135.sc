if(description){
	...
	script_cve_id( "CVE-2015-6171", "CVE-2015-6173", "CVE-2015-6174", "CVE-2015-6175", "CVE-2015-6106", "CVE-2015-6107", "CVE-2015-6108" );
		...
		if( IsMatchRegexp( dllVer, "^(6\\.2\\.9200\\.1)" ) ){
			...
			if( IsMatchRegexp( dllVer, "^(6\\.2\\.9200\\.2)" ) ){
				...
				if( IsMatchRegexp( dllVer, "^(6\\.3\\.9600\\.1)" ) ){
					...
					if( IsMatchRegexp( dllVer, "^(6\\.1\\.7600\\.1)" ) ){
...
if( hotfix_check_sp( winVista: 3, win2008: 3 ) > 0 ){
	if(version_is_less( version: dllVer, test_version: "6.0.6002.19535" ) || version_in_range( version: dllVer, test_version: "6.0.6002.23000", test_version2: "6.0.6002.23844" )){
		VULN = TRUE;
	}
}
else {
	if( hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0 ){
		if(version_is_less( version: dllVer, test_version: "6.1.7601.19061" ) || version_in_range( version: dllVer, test_version: "6.1.7601.22000", test_version2: "6.1.7601.23264" )){
			VULN = TRUE;
		}
	}
	else {
		if( hotfix_check_sp( win8: 1, win2012: 1 ) > 0 ){
			if(version_is_less( version: dllVer, test_version: "6.2.9200.17568" ) || version_in_range( version: dllVer, test_version: "6.2.9200.21000", test_version2: "6.2.9200.21686" )){
				VULN = TRUE;
			}
		}
		else {
			if( hotfix_check_sp( win8_1: 1, win8_1x64: 1, win2012R2: 1 ) > 0 ){
				...
				if(hotfix_check_sp( win10: 1, win10x64: 1 ) > 0){
					if( version_is_less( version: dllVer, test_version: "10.0.10240.16384" ) ){
						...
						if(version_in_range( version: dllVer, test_version: "10.0.10586.0", test_version2: "10.0.10586.19" )){
