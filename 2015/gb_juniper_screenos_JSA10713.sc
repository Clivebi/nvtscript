...
if( IsMatchRegexp( version, "^6\\.2\\.0" ) ){
	if(version_is_less( version: version, test_version: "6.2.0.15" )){
		exit( 99 );
	}
	...
	if(IsMatchRegexp( version, "^6\\.3\\.0" )){
		if(version_is_less( version: version, test_version: "6.3.0.12" )){
			exit( 99 );
		}
		display_fix = "6.3.0r21";
		fix = "6.3.0.21";
		patched = make_list( "6.3.0r12b",
			 "6.3.0r13b",
			 "6.3.0r14b",
			 "6.3.0r15b",
			 "6.3.0r16b",
			 ...
			 "6.3.0r19b" );
		for p in patched {
			if(IsMatchRegexp( display_version, "^" ) + p){
				exit( 99 );
			}
		}
	}
