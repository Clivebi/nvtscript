if(description){
	...
	script_cve_id( "CVE-2015-1130", "CVE-2015-1131", "CVE-2015-1132", "CVE-2015-1133", "CVE-2015-1134", "CVE-2015-1135", "CVE-2015-1136", "CVE-2015-1088", "CVE-2015-1089", "CVE-2015-1091", "CVE-2015-1093", "CVE-2015-1137", "CVE-2015-1138", "CVE-2015-1139", "CVE-2015-1140", "CVE-2015-1141", "CVE-2015-1142", "CVE-2015-1143", "CVE-2015-1144", "CVE-2015-1145", "CVE-2015-1146", "CVE-2015-1147", "CVE-2015-1148", "CVE-2015-1095", "CVE-2015-1098", "CVE-2015-1099", "CVE-2015-1100", "CVE-2015-1101", "CVE-2015-1102", "CVE-2015-1103", "CVE-2015-1104", "CVE-2015-1105", "CVE-2015-1117", "CVE-2015-1118" );
...
if(( osVer == "10.8.5" ) || ( osVer == "10.9.5" )){
	...
	if( osVer == "10.8.5" && version_is_less( version: buildVer, test_version: "12F2518" ) ){
		...
		if(osVer == "10.9.5" && version_is_less( version: buildVer, test_version: "13F1077" )){
			fix = "Apply Security Update 2015-004";
			osVer = osVer + " Build " + buildVer;
		}
	}
