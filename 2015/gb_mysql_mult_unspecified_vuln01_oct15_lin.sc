if(description){
	...
	script_cve_id( "CVE-2015-4913", "CVE-2015-4830", "CVE-2015-4826", "CVE-2015-4815", "CVE-2015-4807", "CVE-2015-4802", "CVE-2015-4792", "CVE-2015-4870", "CVE-2015-4861", "CVE-2015-4858", "CVE-2015-4836" );
	script_bugtraq_id( 77153, 77228, 77237, 77222, 77205, 77165, 77171, 77208, 77137, 77145, 77190 );
...
if(IsMatchRegexp( vers, "^5\\.[56]\\." )){
	if(version_in_range( version: vers, test_version: "5.5", test_version2: "5.5.45" ) || version_in_range( version: vers, test_version: "5.6", test_version2: "5.6.26" )){
