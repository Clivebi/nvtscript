...
if(hotfix_check_sp( win2003: 3, win2003x64: 3, winVista: 3, win2008: 3, win7: 2, win7x64: 2, win2008r2: 2 ) <= 0){
	exit( 0 );
}
...
if(hotfix_check_sp( win2003x64: 3, win2003: 3 ) > 0){
	if(version_is_less( version: dllVer, test_version: "11.0.5721.5275" ) || version_in_range( version: dllVer, test_version: "10", test_version2: "10.0.0.4010" )){
		security_message( port: 0, data: "The target host was found to be vulnerable" );
	}
	exit( 0 );
}
if(hotfix_check_sp( winVista: 3, win2008: 3 ) > 0){
	if(version_is_less( version: dllVer, test_version: "11.0.6002.19378" ) || version_in_range( version: dllVer, test_version: "11.0.6002.23000", test_version2: "11.0.6002.23683" )){
		security_message( port: 0, data: "The target host was found to be vulnerable" );
	}
	exit( 0 );
}
if(hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0){
	if(version_is_less( version: dllVer, test_version: "12.0.7601.18840" ) || version_in_range( version: dllVer, test_version: "12.0.7601.22000", test_version2: "12.0.7601.23040" )){
		security_message( port: 0, data: "The target host was found to be vulnerable" );
	}
	exit( 0 );
}
