if(description){
	...
	script_dependencies( "gb_cisco_esa_web_detect.sc" );
...
cookie = ac[1] + cookie;
if(http_vuln_check( port: port, url: "/monitor/user_report", pattern: "action=Logout", extra_check: make_list( "System Status",
