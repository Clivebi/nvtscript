...
for ver in make_list( "\\OFFICE14",
	...
	if(dllVer){
		if(version_in_range( version: dllVer, test_version: "14.0", test_version2: "14.0.7149.4999" ) || version_in_range( version: dllVer, test_version: "15.0", test_version2: "15.0.4719.999" )){
