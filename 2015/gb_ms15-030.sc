...
if(hotfix_check_sp( win7: 2, win7x64: 2, win8: 1, win8x64: 1, win2012: 1, win2012R2: 1, win8_1: 1, win8_1x64: 1 ) <= 0){
	exit( 0 );
}
...
if(hotfix_check_sp( win7: 2, win7x64: 2 )){
	...
	if(ContainsString( edition, "Ultimate" ) || ContainsString( edition, "Enterprise" ) || IsMatchRegexp( rdpVer, "^(6\\.2\\.9200)" )){
		if(version_is_less( version: RdpVer, test_version: "6.1.7601.18740" ) || version_in_range( version: RdpVer, test_version: "6.1.7601.22000", test_version2: "6.1.7601.22946" ) || version_in_range( version: RdpVer, test_version: "6.2.9200.16000", test_version2: "6.2.9200.17052" ) || version_in_range( version: RdpVer, test_version: "6.2.9200.21000", test_version2: "6.2.9200.21171" )){
...
if(hotfix_check_sp( win8: 1 ) > 0){
	if(version_is_less( version: RdpVer, test_version: "6.2.9200.17247" ) || version_in_range( version: RdpVer, test_version: "6.2.9200.20000", test_version2: "6.2.9200.21363" )){
		security_message( port: 0, data: "The target host was found to be vulnerable" );
	}
	exit( 0 );
}
...
if(hotfix_check_sp( win8x64: 1, win2012: 1 ) > 0){
	...
	if(version_is_less( version: sysVer2, test_version: "6.2.9200.17247" ) || version_in_range( version: sysVer2, test_version: "6.2.9200.20000", test_version2: "6.2.9200.21363" )){
		security_message( port: 0, data: "The target host was found to be vulnerable" );
	}
	exit( 0 );
}
