...
if( IsMatchRegexp( dllVer, "^(5\\.7\\.6002\\.2)" ) ){
	...
	if(IsMatchRegexp( dllVer, "^(5\\.7)" )){
		Vulnerable_range = "Less than 5.7.6002.19549";
	}
}
if(hotfix_check_sp( winVista: 3, win2008: 3 ) > 0){
	if(( version_in_range( version: dllVer, test_version: "5.7", test_version2: "5.7.6002.19548" ) ) || ( version_in_range( version: dllVer, test_version: "5.7.6002.23000", test_version2: "5.7.6002.23858" ) )){
