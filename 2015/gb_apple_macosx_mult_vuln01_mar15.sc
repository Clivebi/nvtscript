if(description){
	...
	script_cve_id( "CVE-2014-8838", "CVE-2014-8837", "CVE-2014-8835", "CVE-2014-8834", "CVE-2014-8833", "CVE-2014-8832", "CVE-2014-8831", "CVE-2014-8830", "CVE-2014-8829", "CVE-2014-8828", "CVE-2014-8827", "CVE-2014-8826", "CVE-2014-8825", "CVE-2014-8824", "CVE-2014-8823", "CVE-2014-8822", "CVE-2014-8821", "CVE-2014-8820", "CVE-2014-8819", "CVE-2014-8817", "CVE-2014-8816", "CVE-2014-4499", "CVE-2014-4498", "CVE-2014-4497" );
...
if(( osVer == "10.9.5" ) || ( osVer == "10.8.5" )){
	...
	if( osVer == "10.9.5" && version_is_less( version: buildVer, test_version: "13F34" ) ){
		...
		if(osVer == "10.8.5" && version_is_less( version: buildVer, test_version: "12F1107" )){
			fix = "Apply Security Update 2015-001";
			osVer = osVer + " Build " + buildVer;
		}
	}
