...
if( version_in_range( version: vers, test_version: "10.1", test_version2: "10.1.15" ) ){
	...
	if(version_in_range( version: vers, test_version: "11.0", test_version2: "11.0.12" )){
		fix = "11.0.13";
		VULN = TRUE;
	}
}
