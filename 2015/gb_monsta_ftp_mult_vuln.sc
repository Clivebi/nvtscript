...
if(description){
  ...
  or later." );
	...
	script_dependencies( "gb_monsta_ftp_detect.sc" );
...
if(http_vuln_check( port: http_port, url: url, check_header: TRUE, pattern: "alert\\(document.cookie\\)", extra_check: make_list( "<title>Monsta FTP",
	 "value=\"Login\"" ) )){
