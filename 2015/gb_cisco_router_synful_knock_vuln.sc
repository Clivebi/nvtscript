...
ip = forge_ip_packet( ip_hl: 5, ip_v: 4, ip_tos: 0, ip_len: 65535, ip_id: 0x7f35, ip_off: 0, ip_ttl: 64, ip_p: 6, ip_src: saddr, ip_dst: daddr );
tcppacket = forge_tcp_packet( ip: ip, th_sport: sport, th_dport: dport, th_flags: 0x02, th_seq: 0, th_ack: 0, th_off: 5, th_win: 1480, th_urp: 0 );
if(tcppacket && IsMatchRegexp( hexstr( tcppacket ), "020405b40101040201030305" )){
