...
if(hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0){
	if(version_is_less( version: dllVer, test_version: "8.110.7601.18782" ) || version_in_range( version: dllVer, test_version: "8.110.7601.22000", test_version2: "8.110.7601.22985" )){
		security_message( port: 0, data: "The target host was found to be vulnerable" );
	}
	exit( 0 );
}
