if(description){
	...
	script_cve_id( "CVE-2015-0491", "CVE-2015-0488", "CVE-2015-0480", "CVE-2015-0478", "CVE-2015-0477", "CVE-2015-0469", "CVE-2015-0460", "CVE-2015-0459" );
...
if(IsMatchRegexp( vers, "^1\\.[5-8]" )){
	if(version_in_range( version: vers, test_version: "1.8.0", test_version2: "1.8.0.40" ) || version_in_range( version: vers, test_version: "1.7.0", test_version2: "1.7.0.76" ) || version_in_range( version: vers, test_version: "1.6.0", test_version2: "1.6.0.91" ) || version_in_range( version: vers, test_version: "1.5.0", test_version2: "1.5.0.81" )){
