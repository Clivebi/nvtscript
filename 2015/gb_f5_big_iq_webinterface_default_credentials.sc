...
if(description){
	...
	if(FEED_NAME == "GSF" || FEED_NAME == "SCM"){
		script_dependencies( "gsf/gb_f5_big_iq_consolidation.sc" );
	}
...
if(!ContainsString( res, "Authentication failed" ) && ( ContainsString( res, "loginReference" ) && ContainsString( res, "token" ) && ContainsString( res, "\"username\":\"admin\"" ) )){
