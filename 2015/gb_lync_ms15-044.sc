...
if(get_kb_item( "MS/Lync/Ver" )){
	...
	if(path){
		for ver in make_list( "",
			...
			if(commVer){
				if(version_in_range( version: commVer, test_version: "5.0", test_version2: "5.0.8687.133" ) || version_in_range( version: commVer, test_version: "4.0", test_version2: "4.0.7577.4460" )){
