if(description){
	...
	script_cve_id( "CVE-2015-1642", "CVE-2015-2423", "CVE-2015-2466", "CVE-2015-2467", "CVE-2015-2468", "CVE-2015-2469", "CVE-2015-2470", "CVE-2015-2477" );
...
if(officeVer && IsMatchRegexp( officeVer, "^12\\." )){
	...
	if(dllPath){
		...
		dllVer = fetch_file_version( sysPath: dllPath, file_name: "Microsoft Shared\\OFFICE12\\msptls.dll" );
		msoVer = fetch_file_version( sysPath: dllPath, file_name: "Microsoft Shared\\OFFICE12\\mso.dll" );
		if(dllVer6 || dllVer || msoVer){
			if(version_is_less( version: dllVer6, test_version: "6.5.10.55" ) || version_in_range( version: dllVer, test_version: "12.0", test_version2: "12.0.6727.4999" ) || version_in_range( version: msoVer, test_version: "12.0", test_version2: "12.0.6728.4999" )){
				security_message( port: 0, data: "The target host was found to be vulnerable" );
				exit( 0 );
			}
		}
...
if(officeVer && IsMatchRegexp( officeVer, "^14\\." )){
	...
	if(dllPath){
		...
		if(dllVer || vbVer){
			if(version_in_range( version: dllVer, test_version: "14.0", test_version2: "14.0.7155.4999" ) || version_in_range( version: vbVer, test_version: "7.0", test_version2: "7.0.16.36" )){
				security_message( port: 0, data: "The target host was found to be vulnerable" );
				exit( 0 );
			}
		}
...
if(officeVer && IsMatchRegexp( officeVer, "^15\\." )){
	...
	if(dllPath){
		...
		if(dllVer || vbVer){
			if(version_in_range( version: dllVer, test_version: "15.0", test_version2: "15.0.4745.999" ) || version_in_range( version: vbVer, test_version: "7.1", test_version2: "7.1.15.4662" )){
				security_message( port: 0, data: "The target host was found to be vulnerable" );
				exit( 0 );
			}
		}
