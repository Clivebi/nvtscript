...
url = dir + "/jclassifiedsmanager/classifieds/offerring-ads?controller=displa" + "yads&view=displayads&task=viewad&id=\"SQL-INJECTION-TEST";
if(http_vuln_check( port: http_port, url: url, check_header: FALSE, pattern: "You have an error in your SQL syntax", extra_check: make_list( "SQL-INJECTION-TEST",
	 "classifiedsmanager" ) )){
