...
if(( revcomp( a: compver, b: "7.2.5.13" ) < 0 ) && ( revcomp( a: compver, b: "7.2" ) >= 0 )){
	report = "Installed Version: " + version + "\n" + "Fixed Version:     7.2(5.13)\n";
	security_message( port: 0, data: report );
	exit( 0 );
}
if(( revcomp( a: compver, b: "8.2.5.50" ) < 0 ) && ( revcomp( a: compver, b: "8.2" ) >= 0 )){
...
if(( revcomp( a: compver, b: "8.4.7.15" ) < 0 ) && ( revcomp( a: compver, b: "8.4" ) >= 0 )){
...
if(( revcomp( a: compver, b: "9.1.5.1" ) < 0 ) && ( revcomp( a: compver, b: "9.1" ) >= 0 )){
