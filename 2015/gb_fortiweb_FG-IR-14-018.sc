...
to Fortinet products." );
	...
	script_tag( name: "solution", value: "Update to FortiWeb 5.3.1 or later." );
	script_tag( name: "summary", value: "Fortinet FortiWeb is prone to multiple vulnerabilities in OpenSSL." );
