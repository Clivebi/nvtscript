...
if(hotfix_check_sp( win2003: 3, win2003x64: 3, winVista: 3, winVistax64: 3, win2008: 3, win2008x64: 3 ) <= 0){
	exit( 0 );
}
...
if(hotfix_check_sp( win2003: 3, win2003x64: 3 ) > 0){
	if(( version_in_range( version: dllVer, test_version: "5.6", test_version2: "5.6.0.8853" ) ) || ( version_in_range( version: dllVer, test_version: "5.7", test_version2: "5.7.6002.23628" ) )){
		security_message( port: 0, data: "The target host was found to be vulnerable" );
	}
	exit( 0 );
}
if(hotfix_check_sp( winVista: 3, win2008: 3 ) > 0){
	if(( version_in_range( version: dllVer, test_version: "5.7", test_version2: "5.7.6002.19318" ) ) || ( version_in_range( version: dllVer, test_version: "5.7.6002.23000", test_version2: "5.7.6002.23628" ) )){
		security_message( port: 0, data: "The target host was found to be vulnerable" );
	}
	exit( 0 );
}
