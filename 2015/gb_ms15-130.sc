...
if(dllVer){
	if( IsMatchRegexp( dllVer, "^(1\\.626\\.7601\\.1)" ) ){
		Vulnerable_range = "1.626.7601.18000 - 1.626.7601.19053";
	}
	else {
		if(IsMatchRegexp( dllVer, "^(1\\.626\\.7601\\.2)" )){
			Vulnerable_range = "1.626.7601.22000 - 1.626.7601.23258";
		}
	}
}
if(hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0){
	if(version_in_range( version: dllVer, test_version: "1.626.7601.18000", test_version2: "1.626.7601.19053" ) || version_in_range( version: dllVer, test_version: "1.626.7601.22000", test_version2: "1.626.7601.23258" )){
