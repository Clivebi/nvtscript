...
if(hotfix_check_sp( win7: 2, win7x64: 2, win8: 1, win8x64: 1, win8_1: 1, win8_1x64: 1, winVista: 3 ) <= 0){
	exit( 0 );
}
...
if( hotfix_check_sp( win7: 2 ) > 0 ){
	if( version_is_less( version: ehshell_ver, test_version: "6.1.7601.18968" ) ){
		...
		if(version_in_range( version: ehshell_ver, test_version: "6.1.7601.22000", test_version2: "6.1.7601.23170" )){
	...
	if( hotfix_check_sp( win8: 1, win8x64: 1 ) > 0 ){
		if( version_is_less( version: ehshell_ver, test_version: "6.2.9200.17486" ) ){
			...
			if(version_in_range( version: ehshell_ver, test_version: "6.2.9200.20000", test_version2: "6.2.9200.21600" )){
		...
		if( hotfix_check_sp( win8_1: 1, win8_1x64: 1 ) > 0 ){
			...
			if(hotfix_check_sp( winVista: 3 ) > 0){
				if( version_is_less( version: ehshell_ver, test_version: "6.0.6002.19478" ) ){
					...
					if(version_in_range( version: ehshell_ver, test_version: "6.0.6002.23000", test_version2: "6.0.6002.23787" )){
