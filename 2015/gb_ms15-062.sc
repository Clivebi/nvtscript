...
if(ProgramFilesDir){
	...
	if(adfs1_ver){
		if(( hotfix_check_sp( win2008: 3 ) > 0 ) && ( version_in_range( version: adfs1_ver, test_version: "6.1.7601.00000", test_version2: "6.1.7601.18846" ) || version_in_range( version: adfs1_ver, test_version: "6.1.7601.23000", test_version2: "6.1.7601.23048" ) )){
...
if(sysPath){
	...
	if(adfs2_ver){
		if(( hotfix_check_sp( win2012: 1 ) > 0 ) && ( version_in_range( version: adfs2_ver, test_version: "6.2.9200.16000", test_version2: "6.2.9200.17365" ) || version_in_range( version: adfs2_ver, test_version: "6.2.9200.20000", test_version2: "6.2.9200.21477" ) )){
			security_message( port: 0, data: "The target host was found to be vulnerable" );
			exit( 0 );
		}
	}
