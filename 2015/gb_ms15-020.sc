...
if(dllVer || shell32Ver){
	if(hotfix_check_sp( win2003x64: 3, win2003: 3 ) > 0){
		if(version_is_less( version: dllVer, test_version: "5.2.3790.5528" ) || version_is_less( version: shell32Ver, test_version: "6.0.3790.5558" )){
			security_message( port: 0, data: "The target host was found to be vulnerable" );
		}
		exit( 0 );
	}
	if(hotfix_check_sp( winVista: 3, win2008: 3 ) > 0){
		if(version_is_less( version: dllVer, test_version: "6.0.6002.19296" ) || version_in_range( version: dllVer, test_version: "6.0.6002.23000", test_version2: "6.0.6002.23605" ) || version_is_less( version: shell32Ver, test_version: "6.0.6002.19322" ) || version_in_range( version: shell32Ver, test_version: "6.0.6002.23000", test_version2: "6.0.6002.23631" )){
			security_message( port: 0, data: "The target host was found to be vulnerable" );
		}
		exit( 0 );
	}
	if(hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0){
		if(version_is_less( version: dllVer, test_version: "6.1.7601.18731" ) || version_in_range( version: dllVer, test_version: "6.1.7601.22000", test_version2: "6.1.7601.22936" ) || version_is_less( version: shell32Ver, test_version: "6.1.7601.18762" ) || version_in_range( version: shell32Ver, test_version: "6.1.7601.22000", test_version2: "6.1.7601.22968" )){
			security_message( port: 0, data: "The target host was found to be vulnerable" );
		}
		exit( 0 );
	}
	if(hotfix_check_sp( win8: 1, win8x64: 1, win2012: 1 ) > 0){
		if(version_is_less( version: dllVer, test_version: "6.2.9200.17243" ) || version_in_range( version: dllVer, test_version: "6.2.9200.20000", test_version2: "6.2.9200.21360" ) || version_is_less( version: shell32Ver, test_version: "6.2.9200.17279" ) || version_in_range( version: shell32Ver, test_version: "6.2.9200.20000", test_version2: "6.2.9200.21394" )){
			security_message( port: 0, data: "The target host was found to be vulnerable" );
		}
		exit( 0 );
	}
	if(hotfix_check_sp( win8_1: 1, win8_1x64: 1, win2012R2: 1 ) > 0){
		if(version_is_less( version: dllVer, test_version: "6.3.9600.17664" ) || version_is_less( version: shell32Ver, test_version: "6.3.9600.17680" )){
			security_message( port: 0, data: "The target host was found to be vulnerable" );
		}
		exit( 0 );
	}
