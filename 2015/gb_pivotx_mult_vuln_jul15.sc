...
url = dir + "/index.php/\"><script>alert(document.cookie)</script></scri" + "pt>?page=page&uid=3";
if(http_vuln_check( port: pivPort, url: url, check_header: TRUE, pattern: "<script>alert\\(document.cookie\\)</script>", extra_check: ">PivotX" )){
