if(description){
	...
	script_cve_id( "CVE-2014-4416", "CVE-2014-4403", "CVE-2014-4402", "CVE-2014-4401", "CVE-2014-4400", "CVE-2014-4399", "CVE-2014-4398", "CVE-2014-4397", "CVE-2014-4396", "CVE-2014-4395", "CVE-2014-4394", "CVE-2014-4393", "CVE-2014-4390", "CVE-2014-4376", "CVE-2014-4350", "CVE-2014-1391" );
...
if(!osVer || !IsMatchRegexp( osVer, "^10\\.[7-9]" )){
	exit( 0 );
}
if( IsMatchRegexp( osVer, "^10\\.[78]" ) ){
	if( version_in_range( version: osVer, test_version: "10.7", test_version2: "10.8.4" ) || version_in_range( version: osVer, test_version: "10.8", test_version2: "10.7.4" ) ){
		fix = "Upgrade to latest OS release and apply patch from vendor";
	}
	else {
		if(osVer == "10.7.5" || osVer == "10.8.5"){
			buildVer = get_kb_item( "ssh/login/osx_build" );
			if(buildVer){
				if(( osVer == "10.7.5" && version_is_less( version: buildVer, test_version: "12F2518" ) ) || ( osVer == "10.8.5" && version_is_less( version: buildVer, test_version: "13F1077" ) )){
