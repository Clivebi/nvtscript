...
if(officeVer && IsMatchRegexp( officeVer, "^1[245]\\." )){
	...
	if(InsPath){
		for offsubver in make_list( "Office12",
			...
			if(exeVer){
				if(version_in_range( version: exeVer, test_version: "12.0", test_version2: "12.0.6718.4999" ) || version_in_range( version: exeVer, test_version: "14.0", test_version2: "14.0.7145.4999" ) || version_in_range( version: exeVer, test_version: "15.0", test_version2: "15.0.4701.999" )){
...
if(comPath){
	...
	if(!isnull( ortVer ) || !isnull( ortconVer )){
		if(version_in_range( version: ortVer, test_version: "14.0", test_version2: "14.0.7134.4999" ) || version_in_range( version: ortconVer, test_version: "14.0", test_version2: "14.0.7134.4999" )){
			security_message( port: 0, data: "The target host was found to be vulnerable" );
			exit( 0 );
		}
	}
