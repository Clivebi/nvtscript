if(description){
	...
	script_cve_id( "CVE-2015-2549", "CVE-2015-2550", "CVE-2015-2552", "CVE-2015-2553", "CVE-2015-2554" );
...
if(hotfix_check_sp( winVista: 3, win7: 2, win7x64: 2, win2008r2: 2, win8: 1, win8x64: 1, win2012: 1, win2012R2: 1, win8_1: 1, win8_1x64: 1, win10: 1, win10x64: 1 ) <= 0){
	exit( 0 );
}
...
if(hotfix_check_sp( winVista: 3, win2008: 3 ) > 0){
	if( version_is_less( version: exeVer, test_version: "6.0.6002.19503" ) ){
		...
		if(version_in_range( version: exeVer, test_version: "6.0.6002.23000", test_version2: "6.0.6002.23812" )){
...
if(hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0){
	if( version_is_less( version: exeVer, test_version: "6.1.7601.19018" ) ){
		...
		if(version_in_range( version: exeVer, test_version: "6.1.7601.23000", test_version2: "6.1.7601.23222" )){
...
if(hotfix_check_sp( win8: 1, win8x64: 1, win2012: 1 ) > 0){
	if( version_is_less( version: exeVer, test_version: "6.2.9200.17528" ) ){
		...
		if(version_in_range( version: exeVer, test_version: "6.2.9200.20000", test_version2: "6.2.9200.21644" )){
