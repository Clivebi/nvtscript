...
if(hotfix_check_sp( win2008r2: 2, win8x64: 1, win2012: 1, win2012R2: 1, win8_1x64: 1 ) <= 0){
	exit( 0 );
}
...
if(hotfix_check_sp( win2008r2: 2 ) > 0 && dllVer){
	if(version_is_less( version: dllVer, test_version: "6.1.7601.18844" ) || version_in_range( version: dllVer, test_version: "6.1.7601.22000", test_version2: "6.1.7601.23044" )){
		security_message( port: 0, data: "The target host was found to be vulnerable" );
	}
	exit( 0 );
}
if(hotfix_check_sp( win8x64: 1, win2012: 1 ) > 0 && dllVer){
	if(version_is_less( version: dllVer, test_version: "6.2.9200.17361" ) || version_in_range( version: dllVer, test_version: "6.2.9200.20000", test_version2: "6.2.9200.21472" )){
		security_message( port: 0, data: "The target host was found to be vulnerable" );
	}
	exit( 0 );
}
if(hotfix_check_sp( win8_1x64: 1, win2012R2: 1 ) > 0){
	if(( dllVer && version_is_less( version: dllVer, test_version: "6.3.9600.17723" ) ) || ( dllVer2 && version_is_less( version: dllVer2, test_version: "6.3.9600.17723" ) )){
		security_message( port: 0, data: "The target host was found to be vulnerable" );
	}
	exit( 0 );
}
