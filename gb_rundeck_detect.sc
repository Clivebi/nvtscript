...
if(ContainsString( res, "Rundeck - Login</title>" )){
	version = "unknown";
	...
	log_message( data: build_detection_report( app: "Rundeck", version: version, install: "/", cpe: cpe, concluded: vers[0] ), port: port );
	exit( 0 );
}
exit( 0 );
