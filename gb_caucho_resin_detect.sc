...
if(IsMatchRegexp( buf, "Server: *Resin" )){
	...
	register_and_report_cpe( app: "Resin", ver: version, concluded: ver[0], base: CPE, expr: "([0-9.]+)", insloc: port + "/tcp", regPort: port, regService: "www" );
}
exit( 0 );
