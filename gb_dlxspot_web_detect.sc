...
if(ContainsString( res, "b>DlxSpot</b>" ) && ContainsString( res, "class=\"grassetto\"" )){
	version = "unknown";
	...
	log_message( data: build_detection_report( app: "Tecnovision DlxSpot", version: version, install: "/", cpe: cpe, concluded: vers[0] ), port: port );
	exit( 0 );
}
exit( 0 );
