if(description){
	...
	script_dependencies( "smtpserver_detect.sc", "smtp_relay.sc" );
...
if(n_sent > 0){
	report = NASLString( "The file 42.zip was sent ", n_sent, " times. If there is an antivirus in your MTA, it might ", "have crashed. Please check its status right now, as it is ", "not possible to do so remotely." );
