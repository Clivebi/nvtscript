...
if(description){
	...
	script_dependencies( "ldu_detection.sc" );
	script_require_ports( "Services/www", 80 );
	script_mandatory_keys( "ldu/detected" );
	script_xref( name: "URL", value: "https://www.securityfocus.com/archive/1/409511" );
...
if(ContainsString( res, "MySQL error" ) && egrep( string: res, pattern: "syntax to use near '(asc&o=|0.+page_vuln-test)" )){
