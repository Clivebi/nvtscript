...
func sql_recv( socket ){
	var head, len_hi, len_lo, len, body;
	...
	return ( NASLString( head, body ) );
}
func make_sql_login_pkt( username, password ){
	var ulen, plen, upad, ppad, ubuf, pbuf, nul, ublen, pblen, sql_packet;
