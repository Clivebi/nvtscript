if(description){
	...
	script_tag( name: "last_modification", value: "2021-01-21 12:43:45 +0000 (Thu, 21 Jan 2021)" );
...
waf_headers = make_array( "^X-CDN: Incapsula", "Incapsula WAF", "^Server:.*mod_security", "ModSecurity WAF" );
...
for waf_header in keys( waf_headers ) {
