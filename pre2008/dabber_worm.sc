if(description){
	...
	script_version( "2020-05-04T10:45:48+0000" );
	script_tag( name: "last_modification", value: "2020-05-04 10:45:48 +0000 (Mon, 04 May 2020)" );
...
for(port = 9898;port <= 9999;port++){
	dabber_ports = make_list( dabber_ports,
		 port );
}
