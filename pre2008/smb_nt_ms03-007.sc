...
if(hotfix_check_sp( nt: 7, xp: 2, win2k: 4 ) <= 0){
	exit( 0 );
}
if(hotfix_missing( name: "Q811493" ) > 0 && hotfix_missing( name: "Q815021" ) > 0 && hotfix_missing( name: "840987" ) > 0){
	if(hotfix_check_sp( xp: 2 ) > 0 && hotfix_missing( name: "890859" ) <= 0){
		exit( 0 );
	}
