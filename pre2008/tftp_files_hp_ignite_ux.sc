...
file_list = make_list( "/var/opt/ignite/config.local",
	 "/var/opt/ignite/local/config",
	 "/var/opt/ignite/local/host.info",
	 "/var/opt/ignite/local/hw.info",
	 ...
	 "/var/opt/ignite/server/preferences" );
