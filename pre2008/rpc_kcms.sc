if(description){
	...
	script_family( "RPC" );
	script_dependencies( "secpod_rpc_portmap_udp.sc", "secpod_rpc_portmap_tcp.sc", "gather-package-list.sc", "os_detection.sc" );
...
if(version && ereg( pattern: "5\\.1[0-9]", string: version )){
	exit( 0 );
}
RPC_PROG = 100221;
tcp = FALSE;
