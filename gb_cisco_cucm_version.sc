...
log_message( data: build_detection_report( app: "Cisco Unified Communications Manager", version: vers, install: "ssh", cpe: cpe, concluded: "show version active" ), port: 0 );
exit( 0 );
