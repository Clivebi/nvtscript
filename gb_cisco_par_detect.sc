...
if(ContainsString( res, "productName=\"Cisco Prime Access Registrar\"" )){
	version = "unknown";
	...
	log_message( data: build_detection_report( app: "Cisco Prime Access Registrar", version: version, install: "/", cpe: cpe, concluded: vers[0] ), port: port );
	exit( 0 );
}
exit( 0 );
