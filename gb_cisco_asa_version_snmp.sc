...
if(ContainsString( sysdesc, "Cisco Adaptive Security Appliance" )){
	...
	os_register_and_report( os: "Cisco ASA", cpe: cpe2, banner_type: "SNMP sysdesc", banner: sysdesc, port: port, proto: "udp", desc: "Cisco ASA Detection (SNMP)", runs_key: "unixoide" );
	log_message( data: build_detection_report( app: "Cisco ASA", version: version, install: "161/udp", cpe: cpe, concluded: sysdesc, extra: "Model: " + model ), port: port, proto: "udp" );
	exit( 0 );
}
exit( 0 );
