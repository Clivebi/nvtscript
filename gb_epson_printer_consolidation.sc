if(description){
	...
	script_dependencies( "gb_epson_printer_http_detect.sc", "gb_epson_printer_snmp_detect.sc", "gb_epson_printer_pjl_detect.sc", "gb_epson_printer_ftp_detect.sc", "global_settings.sc" );
...
if( detected_model != "unknown" ){
	...
	if( detected_fw_version != "unknown" ) {
		os_cpe = build_cpe( value: tolower( detected_fw_version ), exp: "^([0-9a-z.]+)", base: "cpe:/o:epson:" + cpe_model + "_firmware:" );
	}
	else {
	...
	if( detected_fw_version != "unknown" ) {
		os_cpe = build_cpe( value: tolower( detected_fw_version ), exp: "^([0-9a-z.]+)", base: "cpe:/o:epson:printer_firmware:" );
	}
	else {
...
os_register_and_report( os: os_name, cpe: os_cpe, runs_key: "unixoide", desc: "Epson Printer Detection Consolidation" );
