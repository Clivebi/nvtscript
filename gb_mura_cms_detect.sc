...
if(ContainsString( res, "<meta name=\"generator\" content=\"Mura CMS" ) && ContainsString( res, "MuraBootstrap" )){
	version = "unknown";
	...
	log_message( data: build_detection_report( app: "Mura CMS", version: version, install: "/", cpe: cpe, concluded: vers[0] ), port: port );
	exit( 0 );
}
exit( 0 );
