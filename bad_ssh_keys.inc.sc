...
-----END RSA PRIVATE KEY---";
supermicro_ipmi_key = "-----BEGIN RSA PRIVATE KEY-----
...
-----END RSA PRIVATE KEY-----";
bad_keys = make_list( "ADMIN:split:" + supermicro_ipmi_key,
	 "root:split:" + supermicro_ipmi_key,
	 "sync:split:-----BEGIN DSA PRIVATE KEY-----
...
-----END RSA PRIVATE KEY-----",
	 "root:split:-----BEGIN DSA PRIVATE KEY-----
