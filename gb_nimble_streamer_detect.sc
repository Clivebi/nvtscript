...
if(IsMatchRegexp( banner, "Server: Nimble/" )){
	version = "unknown";
	...
	log_message( data: build_detection_report( app: "Nimble Streamer", version: version, install: "/", cpe: cpe, concluded: vers[0] ), port: port );
	exit( 0 );
}
exit( 0 );
