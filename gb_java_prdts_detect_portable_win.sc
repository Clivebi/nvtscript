if(description){
	...
	script_dependencies( "gb_java_prdts_detect_win.sc", "gb_wmi_access.sc", "lsc_options.sc" );
	script_mandatory_keys( "win/lsc/search_portable_apps", "WMI/access_successful" );
	script_exclude_keys( "win/lsc/disable_wmi_search" );
	script_tag( name: "summary", value: "SMB login and WMI file search based detection of Java Portable." );
...
for filePath in keys( fileList ) {
	...
	if(vers && version = eregmatch( string: vers, pattern: "^([0-9]+\\.[0-9]+\\.[0-9]{1,3})" )){
		...
		if( ContainsString( location, "java64" ) ){
			set_kb_item( name: "Sun/Java64/JRE64/Win/Ver", value: vers );
			if( version_is_less( version: vers, test_version: "1.4.2.38" ) || version_in_range( version: vers, test_version: "1.5", test_version2: "1.5.0.33" ) || version_in_range( version: vers, test_version: "1.6", test_version2: "1.6.0.18" ) ){
