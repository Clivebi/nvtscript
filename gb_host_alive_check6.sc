if(description){
	...
	script_dependencies( "default_http_auth_credentials.sc", "default_ssh_credentials.sc", "find_service_nmap.sc", "toolcheck.sc", "gb_host_alive_check5.sc", "global_settings.sc", "unknown_services.sc" );
...
if(ContainsString( ping, "3 packets transmitted, 0 received" ) || ContainsString( ping, "3 packets transmitted, 0 packets received" )){
