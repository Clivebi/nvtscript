...
if(ContainsString( res, "<title>WISEGIGA</title>" ) && ContainsString( res, "/webfolder/</a><br" )){
	version = "unknown";
	...
	log_message( data: build_detection_report( app: "WiseGiga NAS Device", version: version, install: "/", cpe: cpe ), port: netPort );
	exit( 0 );
}
exit( 0 );
