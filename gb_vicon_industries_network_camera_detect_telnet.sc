...
if(egrep( string: banner, pattern: "^IQinVision .* Version ", icase: FALSE ) || ( IsMatchRegexp( banner, "IQinVision " ) && IsMatchRegexp( banner, "Type HELP at the .* prompt for assistance" ) )){
...
if(!ContainsString( banner, "IQinVision" ) && ContainsString( banner, "Software version " ) && ContainsString( banner, "MAC address " )){
	type = "Branded";
}
if(type == "unknown"){
	username = "login";
