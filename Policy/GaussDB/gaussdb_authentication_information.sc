...
user = script_get_preference( name: "User", id: 1 );
if( user != "" ) {
...
password = script_get_preference( name: "Password", id: 2 );
if( password != "" ) {
...
ip = script_get_preference( name: "IP", id: 3 );
if( ip != "" ) {
...
port = script_get_preference( name: "Port", id: 4 );
if( port != "" ) {
