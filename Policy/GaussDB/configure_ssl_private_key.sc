...
if( get_kb_item( "Policy/zsql/dv_parameters/ssh/ERROR" ) ){
	...
	if( get_kb_item( "Policy/zsql/dv_parameters/ERROR" ) ){
		...
		if( ( !_FACTOR_KEY = get_kb_item( "Policy/zsql/dv_parameters/_FACTOR_KEY/value" ) ) || ( !LOCAL_KEY = get_kb_item( "Policy/zsql/dv_parameters/LOCAL_KEY/value" ) ) ){
			compliant = "incomplete";
			value = "None";
			comment = "Can not find value for _FACTOR_KEY or LOCAL_KEY in table DV_PARAMETERS";
		}
		else {
			if(_FACTOR_KEY == "dc4hoQWGQs7/Uv3AiherFw==" || LOCAL_KEY == "UTiYlBoTC71MvTyBvWhVDodc0VAop1GMe135ZCov8Pv4xsnlEHn9Bs/pjRo7ZNM1BXq8Z4XuyRjfaNpY/7McEQ=="){
				compliant = "no";
			}
