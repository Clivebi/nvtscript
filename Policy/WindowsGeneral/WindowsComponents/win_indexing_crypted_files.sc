if(description){
	...
	script_version( "2021-02-12T06:33:17+0000" );
	script_tag( name: "last_modification", value: "2021-02-12 06:33:17 +0000 (Fri, 12 Feb 2021)" );
	...
	script_xref( name: "Policy", value: "CIS Microsoft Windows 10 Enterprise (Release 2004) Benchmark v1.9.1: 18.9.64.5 (L1) Ensure 'Allow indexing of encrypted files' is set to 'Disabled'" );
	script_xref( name: "Policy", value: "CIS Microsoft Windows Server 2019 RTM (Release 1809) Benchmark v1.1.0: 18.9.61.3 (L1) Ensure 'Allow indexing of encrypted files' is set to 'Disabled'" );
