if(description){
	...
	script_xref( name: "Policy", value: "CIS Microsoft Windows 10 Enterprise (Release 2004) Benchmark v1.9.1: 18.9.30.3 (L1) Ensure 'Turn off heap termination on corruption' is set to 'Disabled'" );
	script_xref( name: "Policy", value: "CIS Microsoft Windows Server 2019 RTM (Release 1809) Benchmark v1.1.0: 18.9.30.3 (L1) Ensure 'Turn off heap termination on corruption' is set to 'Disabled'" );
