if(description){
	...
	script_xref( name: "Policy", value: "CIS Microsoft Windows 10 Enterprise (Release 2004) Benchmark v1.9.1: 17.5.4 (L1) Ensure 'Audit Logon' is set to 'Success and Failure'" );
	script_xref( name: "Policy", value: "CIS Microsoft Windows Server 2019 RTM (Release 1809) Benchmark v1.1.0: 17.5.4 (L1) Ensure 'Audit Logon' is set to 'Success and Failure'" );
