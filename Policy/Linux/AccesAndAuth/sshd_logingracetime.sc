if(description){
	...
	script_xref( name: "Policy", value: "CIS Distribution Independent Linux v2.0.0: 5.2.17 Ensure SSH LoginGraceTime is set to one minute or less (Scored)" );
	script_xref( name: "Policy", value: "CIS CentOS Linux 8 Benchmark v1.0.0: 5.2.14 Ensure SSH LoginGraceTime is set to one minute or less (Scored)" );
