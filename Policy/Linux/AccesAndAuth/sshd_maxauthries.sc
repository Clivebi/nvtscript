if(description){
	...
	script_xref( name: "Policy", value: "CIS Distribution Independent Linux v2.0.0: 5.2.7 Ensure SSH MaxAuthTries is set to 4 or less (Scored)" );
	script_xref( name: "Policy", value: "CIS CentOS Linux 8 Benchmark v1.0.0: 5.2.7 Ensure SSH MaxAuthTries is set to 4 or less (Scored)" );
