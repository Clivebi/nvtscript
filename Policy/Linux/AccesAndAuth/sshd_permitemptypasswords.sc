if(description){
	...
	script_xref( name: "Policy", value: "CIS Distribution Independent Linux v2.0.0: 5.2.11 Ensure SSH PermitEmptyPasswords is disabled (Scored)" );
	script_xref( name: "Policy", value: "CIS CentOS Linux 8 Benchmark v1.0.0: 5.2.11 Ensure SSH PermitEmptyPasswords is disabled (Scored)" );
