if(description){
	...
	script_xref( name: "Policy", value: "CIS Distribution Independent Linux v2.0.0: 1.7.1.2 Ensure local login warning banner is configured properly (Scored)" );
	script_xref( name: "Policy", value: "CIS CentOS Linux 8 Benchmark v1.0.0: 1.8.1.2 Ensure local login warning banner is configured properly (Scored)" );
