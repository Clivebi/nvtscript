if(description){
	...
	script_version( "2020-11-27T10:30:56+0000" );
	script_tag( name: "last_modification", value: "2020-11-27 10:30:56 +0000 (Fri, 27 Nov 2020)" );
	...
	script_dependencies( "read_and_parse_systemctl_list_units.sc" );
...
if( get_kb_item( "Policy/linux/systemctl/ssh/ERROR" ) ){
	...
	if( get_kb_item( "Policy/linux/systemctl/ERROR" ) ){
		value = "Error";
		compliant = "incomplete";
