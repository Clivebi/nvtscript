if(description){
	...
	script_dependencies( "vrp_display_ospfv3_peer.sc" );
...
if( get_kb_item( "Policy/vrp/installed/ERROR" ) ){
	...
	if( get_kb_item( "Policy/vrp/ssh/ERROR" ) ){
		...
		if( get_kb_item( "Policy/vrp/ospfv3/peer/empty" ) ){
			...
			for interface in interfaces {
				...
				if(!IsMatchRegexp( ret, "ospfv3 authentication-mode hmac-sha256 key-id [0-9]+ cipher" )){
