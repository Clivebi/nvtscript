if(description){
	...
	script_dependencies( "vrp_display_isis_peer.sc" );
...
if( get_kb_item( "Policy/vrp/installed/ERROR" ) ){
	...
	if( get_kb_item( "Policy/vrp/ssh/ERROR" ) ){
		...
		if( get_kb_item( "Policy/vrp/isis/peer/empty" ) ){
			...
			for interface in interfaces {
				...
				if(!IsMatchRegexp( ret, "isis authentication-mode" ) || IsMatchRegexp( ret, "isis authentication-mode md5 cipher" )){
