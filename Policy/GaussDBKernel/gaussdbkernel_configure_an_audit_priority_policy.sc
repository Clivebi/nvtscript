if(description){
	script_oid( "1.3.6.1.4.1.25623.1.0.150475" );
	...
	script_name( "GaussDB Kernel: Configure an Audit Priority Policy" );
...
solution = "gs_guc reload -Z coordinator -Z datanode -N all -I all -c 'audit_resource_policy = on'";
default = "on";
test_type = "SQL_Query";
