if(description){
	script_oid( "1.3.6.1.4.1.25623.1.0.150480" );
	...
	script_name( "GaussDB Kernel: Configuring the Maximum Number of Audit Log Files" );
...
solution = "Set the value of audit_file_remain_threshold to 1048576.
