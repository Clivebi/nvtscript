if(description){
	script_oid( "1.3.6.1.4.1.25623.1.0.150458" );
	...
	script_name( "GaussDB Kernel: Configuring the Number of Connections to a Role" );
...
solution = "alter role <ROLENAME> connection limit <connection_num> ;";
default = "none";
test_type = "SQL_Query";
