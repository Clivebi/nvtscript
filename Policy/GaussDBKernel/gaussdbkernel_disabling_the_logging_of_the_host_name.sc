if(description){
	script_oid( "1.3.6.1.4.1.25623.1.0.150493" );
	...
	script_name( "GaussDB Kernel: Disabling the Logging of the Host Name" );
...
solution = "Set log_hostname to off in the postgresql.conf file and then restart the
Database.";
default = "off";
test_type = "SQL_Query";
