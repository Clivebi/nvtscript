if(description){
	script_oid( "1.3.6.1.4.1.25623.1.0.150489" );
	...
	script_name( "GaussDB Kernel: Configuring the Level of Error-Deriving SQL Statements to Be Logged" );
...
solution = "Set log_min_error_statement to error in the postgresql.conf file and restart the
Database.";
