if(description){
	script_oid( "1.3.6.1.4.1.25623.1.0.150454" );
	...
	script_name( "GaussDB Kernel: Configuring the Password Encryption Mode" );
	...
	script_tag( name: "summary", value: "GaussDB Kernel supports two password encryption modes: MD5 and SHA256.
MD5 is an insecure encryption mode and should not be configured. This mode is
reserved only for compatibility with open-source third-party tools. SHA256
...
solution = "gs_guc reload -Z coordinator -D /gaussdb/data/coordinator -c 'password_encryption_type=2'";
default = "2";
test_type = "SQL_Query";
