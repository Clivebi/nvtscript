if(description){
	script_oid( "1.3.6.1.4.1.25623.1.0.150490" );
	...
	script_name( "GaussDB Kernel: Enabling the Logging of User Login" );
...
solution = "Set log_connections to on in the postgresql.conf file and then restart the
Database.";
default = "on";
test_type = "SQL_Query";
