if(description){
	script_oid( "1.3.6.1.4.1.25623.1.0.150419" );
	...
	script_name( "GaussDB Kernel: Configuring the Port" );
...
solution = "Set port to any value except 8000 in the postgresql.conf file and then restart the
Database.";
default = "none";
test_type = "SQL_Query";
