if(description){
	script_oid( "1.3.6.1.4.1.25623.1.0.150439" );
	...
	script_name( "GaussDB Kernel: Resource Labels" );
	...
	script_tag( name: "summary", value: "You can add a resource label to a group of database resources to control them,
improving resource management efficiency. Therefore, you are advised to enable
