if(description){
	script_oid( "1.3.6.1.4.1.25623.1.0.150492" );
	...
	script_name( "GaussDB Kernel: Configuring the Levels of Logs to Be Written into the Server" );
...
solution = "Set log_error_verbosity to DEFAULT in the postgresql.conf file and restart the
Database.";
