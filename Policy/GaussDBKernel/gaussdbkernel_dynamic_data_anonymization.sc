if(description){
	script_oid( "1.3.6.1.4.1.25623.1.0.150443" );
	...
	script_name( "GaussDB Kernel: Dynamic Data Anonymization" );
	...
	script_tag( name: "summary", value: "Dynamic data anonymization can flexibly protect privacy data based on
customized anonymization policies. Therefore, you are advised to enable
...
title = "Dynamic Data Anonymization";
solution = "gs_guc reload -Z coordinator -Z datanode -N all -I all -c 'enable_security_policy=on'";
default = "on";
test_type = "SQL_Query";
