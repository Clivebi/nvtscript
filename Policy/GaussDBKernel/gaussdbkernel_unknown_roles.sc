if(description){
	script_oid( "1.3.6.1.4.1.25623.1.0.150445" );
	...
	script_name( "GaussDB Kernel: Unknown Roles" );
	...
	script_tag( name: "summary", value: "Check the purpose of each unknown role in the query and delete unnecessary
Roles." );
	exit( 0 );
}
