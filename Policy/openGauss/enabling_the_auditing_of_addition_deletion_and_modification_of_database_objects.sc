if(description){
	script_oid( "1.3.6.1.4.1.25623.1.0.150380" );
	...
	script_name( "openGauss: Enabling the Auditing of Addition, Deletion, and Modification of Database Objects" );
...
solution = "gs_guc reload -N all -I all -c 'audit_system_object = 12295'";
default = "12295";
test_type = "SQL_Query";
