if(description){
	script_oid( "1.3.6.1.4.1.25623.1.0.150386" );
	...
	script_name( "openGauss: Configuring the Minimum Audit Log File Retention Period" );
...
solution = "gs_guc reload -N all -I all -c 'audit_file_remain_time = 90'";
default = "90";
test_type = "SQL_Query";
