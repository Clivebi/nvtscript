if(description){
	script_oid( "1.3.6.1.4.1.25623.1.0.150385" );
	...
	script_name( "openGauss: Configuring the Maximum Disk Space Occupied by All Audit Log Files" );
...
solution = "gs_guc reload -N all -I all -c 'audit_space_limit = 1048576'";
default = "1048576";
test_type = "SQL_Query";
