if(description){
	script_oid( "1.3.6.1.4.1.25623.1.0.150363" );
	...
	script_name( "openGauss: Configuring the Number of Days Before Which a Password Cannot Be Reused" );
...
solution = "gs_guc reload -D /gaussdb/data/dbnode -c 'password_reuse_time=60'";
default = "60";
test_type = "SQL_Query";
