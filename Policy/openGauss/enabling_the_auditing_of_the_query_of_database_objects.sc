if(description){
	script_oid( "1.3.6.1.4.1.25623.1.0.150381" );
	...
	script_name( "openGauss: Enabling the Auditing of the Query of Database Objects" );
...
solution = "gs_guc reload -N all -I all -c 'audit_dml_state_select = 1'";
default = "1";
test_type = "SQL_Query";
