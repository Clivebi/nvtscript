if(description){
	script_oid( "1.3.6.1.4.1.25623.1.0.150365" );
	...
	script_name( "openGauss: Configuring the Automatic Account Unlocking Time" );
...
solution = "gs_guc reload -D /gaussdb/data/dbnode -c 'password_lock_time=1'";
default = "1";
test_type = "SQL_Query";
