if(description){
	script_oid( "1.3.6.1.4.1.25623.1.0.150358" );
	...
	script_name( "openGauss: Checking the CREATEROLE Permission" );
	...
	script_tag( name: "summary", value: "Only the role with the CREATEROLE permission can create, modify, or delete other
roles. Such a role can also grant permissions to or revoke permissions of other
roles. To avoid arbitrary permission granting, delete roles that do not require the
