if(description){
	script_oid( "1.3.6.1.4.1.25623.1.0.150376" );
	...
	script_name( "openGauss: Enabling the Auditing of Database Login and Logout" );
...
solution = "gs_guc reload -N all -I all -c 'audit_login_logout = 7'";
default = "7";
test_type = "SQL_Query";
