if(description){
	script_oid( "1.3.6.1.4.1.25623.1.0.150384" );
	...
	script_name( "openGauss: Configuring the Maximum Capacity of an Audit Log File" );
...
solution = "gs_guc reload -N all -I all -c 'audit_rotation_size = 10240'";
default = "10240";
test_type = "SQL_Query";
