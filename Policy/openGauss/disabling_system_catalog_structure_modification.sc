if(description){
	script_oid( "1.3.6.1.4.1.25623.1.0.150348" );
	...
	script_name( "openGauss: Disabling System Catalog Structure Modification" );
...
parameter collaborates with openGauss to help recover a severely damaged
