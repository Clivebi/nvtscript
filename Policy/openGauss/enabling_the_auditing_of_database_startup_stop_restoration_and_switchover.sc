if(description){
	script_oid( "1.3.6.1.4.1.25623.1.0.150377" );
	...
	script_name( "openGauss: Enabling the Auditing of Database Startup, Stop, Restoration, and Switchover" );
...
solution = "gs_guc reload -N all -I all -c 'audit_database_process = 1'";
default = "1";
test_type = "SQL_Query";
