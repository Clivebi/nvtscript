if(description){
	script_oid( "1.3.6.1.4.1.25623.1.0.150383" );
	...
	script_name( "openGauss: Configuring the Maximum Logging Duration of An Audit Log File" );
...
solution = "gs_guc reload -N all -I all -c 'audit_rotation_interval = 1440'";
default = "1440";
test_type = "SQL_Query";
