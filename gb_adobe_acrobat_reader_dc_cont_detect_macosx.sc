...
psVer = chomp( ssh_cmd( socket: sock, cmd: "defaults read /Applications/" + "Adobe\\ Acrobat\\ Reader\\ DC.app/Contents/Info CFBundleShortVersionString" ) );
close( sock );
...
log_message( data: build_detection_report( app: "Adobe Acrobat Reader DC Continuous", version: psVer, install: "/Applications", cpe: cpe, concluded: psVer ) );
exit( 0 );
