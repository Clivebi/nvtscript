...
if(ContainsString( res, "<title>CA Privileged Access Manager</title>" ) && ContainsString( res, "ACCESSKEY=" )){
	version = "unknown";
	...
	log_message( data: build_detection_report( app: "CA Privileged Access Manager", version: version, install: "/", cpe: cpe, concluded: vers[0] ), port: port );
	exit( 0 );
}
exit( 0 );
