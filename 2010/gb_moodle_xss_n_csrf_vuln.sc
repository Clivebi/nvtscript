if(description){
	...
	script_cve_id( "CVE-2010-2229", "CVE-2010-2228", "CVE-2010-2231", "CVE-2010-2230" );
...
if(version_in_range( version: moodleVer, test_version: "1.8", test_version2: "1.8.12" ) || version_in_range( version: moodleVer, test_version: "1.9", test_version2: "1.9.8" )){
