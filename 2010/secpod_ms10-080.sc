if(description){
	...
	script_cve_id( "CVE-2010-3230", "CVE-2010-3231", "CVE-2010-3232", "CVE-2010-3233", "CVE-2010-3234", "CVE-2010-3235", "CVE-2010-3236", "CVE-2010-3237", "CVE-2010-3238", "CVE-2010-3239", "CVE-2010-3240", "CVE-2010-3241", "CVE-2010-3242" );
...
if(excelVer && IsMatchRegexp( excelVer, "^1[012]\\.0" )){
	if(version_in_range( version: excelVer, test_version: "10.0", test_version2: "10.0.6865" ) || version_in_range( version: excelVer, test_version: "11.0", test_version2: "11.0.8327" ) || version_in_range( version: excelVer, test_version: "12.0", test_version2: "12.0.6545.4999" )){
...
if(cmpPckVer && IsMatchRegexp( cmpPckVer, "^12\\.0" )){
