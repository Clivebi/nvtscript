...
if(login_details){
	...
	if(!ContainsString( atkres1, "250 CWD command successful" )){
	...
	if(ContainsString( atkres1, "250 CWD command successful" ) && ContainsString( atkres2, "257 " ) && ContainsString( atkres2, chk_res )){
