...
vers = infos["version"];
loc = infos["location"];
if(version_is_equal( version: vers, test_version: "3.3.11" ) || version_is_equal( version: vers, test_version: "3.4.6" ) || version_is_equal( version: vers, test_version: "3.5.0" ) || version_in_range( version: vers, test_version: "3.4", test_version2: "3.4.5" ) || version_in_range( version: vers, test_version: "3.3", test_version2: "3.3.10" )){
