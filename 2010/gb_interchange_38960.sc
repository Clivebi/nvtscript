if(description){
	...
	script_dependencies( "gb_interchange_web_detect.sc" );
...
if(vers = get_version_from_kb( port: port, app: "interchange" )){
	if(version_in_range( version: vers, test_version: "5.6", test_version2: "5.6.2" ) || version_in_range( version: vers, test_version: "5.4", test_version2: "5.4.4" )){
