...
if(IsMatchRegexp( officeVer, "^[10|11|12].*" )){
	pubVer = get_kb_item( "SMB/Office/Publisher/Version" );
	if(!pubVer){
		exit( 0 );
	}
	if(version_in_range( version: pubVer, test_version: "10.0", test_version2: "10.0.6860" ) || version_in_range( version: pubVer, test_version: "11.0", test_version2: "11.0.8320" ) || version_in_range( version: pubVer, test_version: "12.0", test_version2: "12.0.6527.4999" )){
