if(description){
	...
	script_cve_id( "CVE-2010-3331", "CVE-2010-3330", "CVE-2010-3329", "CVE-2010-3328", "CVE-2010-3327", "CVE-2010-3326", "CVE-2010-3325", "CVE-2010-3243", "CVE-2010-3324", "CVE-2010-0808" );
...
if( hotfix_check_sp( xp: 4 ) > 0 ){
	...
	if(ContainsString( SP, "Service Pack 3" )){
		if(version_in_range( version: dllVer, test_version: "6.0", test_version2: "6.0.2900.6035" ) || version_in_range( version: dllVer, test_version: "7.0", test_version2: "7.0.6000.17090" ) || version_in_range( version: dllVer, test_version: "8.0", test_version2: "8.0.6001.18967" )){
	...
	if( hotfix_check_sp( win2003: 3 ) > 0 ){
		...
		if(ContainsString( SP, "Service Pack 2" )){
			if(version_in_range( version: dllVer, test_version: "6.0", test_version2: "6.0.3790.4771" ) || version_in_range( version: dllVer, test_version: "7.0", test_version2: "7.0.6000.17090" ) || version_in_range( version: dllVer, test_version: "8.0", test_version2: "8.0.6001.18967" )){
				security_message( port: 0, data: "The target host was found to be vulnerable" );
			}
			exit( 0 );
		}
		...
		if( hotfix_check_sp( winVista: 2, win2008: 2 ) > 0 ){
			...
			if(ContainsString( SP, "Service Pack 1" )){
				if(version_in_range( version: dllVer, test_version: "7.0", test_version2: "7.0.6001.18526" ) || version_in_range( version: dllVer, test_version: "8.0", test_version2: "8.0.6001.18974" )){
					security_message( port: 0, data: "The target host was found to be vulnerable" );
				}
				exit( 0 );
			}
			if(ContainsString( SP, "Service Pack 2" )){
				if(version_in_range( version: dllVer, test_version: "7.0", test_version2: "7.0.6002.18308" ) || version_in_range( version: dllVer, test_version: "8.0", test_version2: "8.0.6001.18974" )){
					security_message( port: 0, data: "The target host was found to be vulnerable" );
				}
				exit( 0 );
			}
