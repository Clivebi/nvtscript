...
url = NASLString( dir, "/error.php?type=", vt_strings["default"], "&error=Attack+via+", "characters+injection+-+[a%40http://www.", vt_strings["lowercase"], ".org%40_self]", "This%20Is%20a%20Link[%2Fa]" );
if(http_vuln_check( port: port, url: url, pattern: "<h1>phpMyAdmin - " + vt_strings["default"] + "</h1>", extra_check: make_list( "Attack via characters injection",
