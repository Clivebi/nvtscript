...
if(description){
	...
	script_dependencies( "gb_wikyblog_http_detect.sc" );
...
if(IsMatchRegexp( buf, "^HTTP/1\\.[01] 200" ) && egrep( pattern: "<script>alert\\('" + vt_strings["lowercase"] + "'\\)</script>", string: buf, icase: TRUE )){
