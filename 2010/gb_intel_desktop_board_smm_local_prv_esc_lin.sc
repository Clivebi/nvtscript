if(description){
	...
	script_dependencies( "gb_desktop_board_bios_info_ssh_login_detect.sc" );
...
aff_prods = ["DQ43AP","DQ45CB","DQ45EK","DQ35JO","DQ35MP","DP55KG","DP55SB","DP55WG","DP55WB","DQ57TM","DH55TC","DH55HC","DG41KR","DB43LD","DG41MJ","DG41RQ","DG41TY"];
fix_prod_ver = ["APQ4310H.86A.0031","CBQ4510H.86A.0109","CBQ4510H.86A.0109","JOQ3510J.86A.1126","JOQ3510J.86A.1126","KGIBX10J.86A.4236","KGIBX10J.86A.4236","KGIBX10J.86A.4236","WBIBX10J.86A.0181","TMIBX10H.86A.0025","TCIBX10H.86A.0028","TCIBX10H.86A.0028","KRG4110H.86A.0029","LDB4310H.86A.0035","MJG4110H.86A.0006","RQG4110H.86A.0013","TYG4110H.86A.0037"];
aff_prods_len = max_index( aff_prods );
for(i = 0;i < aff_prods_len;i++){
	if(base_board_prod_name == aff_prods[i]){
		intel_bios_ver = split( buffer: bios_ver, sep: "." );
