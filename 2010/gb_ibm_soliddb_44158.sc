...
func soliddb_alive(  ){
	...
	tcp = NASLString( "tcp ", get_host_name(), " ", port );
...
if( safe_checks() ){
	...
	req = raw_string( 0x02, 0x00, 0x00, 0x00, 0x00, 0x11, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 );
	for(i = 0;i < 20000;i++){
