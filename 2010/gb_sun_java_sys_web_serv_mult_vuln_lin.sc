...
if(description){
	...
	script_cve_id( "CVE-2010-0272", "CVE-2010-0273", "CVE-2010-0360", "CVE-2010-0361", "CVE-2010-0388", "CVE-2010-0389" );
...
vers = infos["version"];
path = infos["location"];
if(version_is_equal( version: vers, test_version: "7.0.6" ) || version_is_equal( version: vers, test_version: "7.0.7" )){
