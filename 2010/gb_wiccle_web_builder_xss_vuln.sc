...
if(description){
	...
	script_dependencies( "gb_wiccle_http_detect.sc" );
...
url = dir + "/index.php?module=site&show=post_search&post_text=%3Cmarquee" + "%3E%3Cfont%20color=red%20size=15%3E" + vt_strings["lowercase"] + "%20Attack%3C/font" + "%3E%3C/marquee%3E";
if(http_vuln_check( port: port, url: url, pattern: "<b><marquee><font color=red size=15>" + vt_strings["lowercase"] + "</font></marquee>" )){
