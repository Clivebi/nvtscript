...
if(vmpVer){
	if(version_is_equal( version: vmpVer, test_version: "3.0" ) || version_in_range( version: vmpVer, test_version: "2.5", test_version2: "2.5.3" )){
...
if(vmwtnVer){
	if(version_is_equal( version: vmwtnVer, test_version: "7.0" ) || version_in_range( version: vmwtnVer, test_version: "6.0", test_version2: "6.5.3" )){
		security_message( port: 0, data: "The target host was found to be vulnerable" );
		exit( 0 );
	}
}
...
if(aceVer){
	if(version_is_equal( version: aceVer, test_version: "2.6" ) || version_in_range( version: aceVer, test_version: "2.5", test_version2: "2.5.3" )){
		security_message( port: 0, data: "The target host was found to be vulnerable" );
	}
}
