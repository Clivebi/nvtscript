...
if(( hotfix_missing( name: "983583" ) == 0 ) || ( hotfix_missing( name: "983589" ) == 0 || hotfix_missing( name: "983590" ) == 0 )){
	exit( 0 );
}
	...
	if(ContainsString( path, "\\Microsoft.NET\\Framework" )){
		...
		if(Ver){
			if(hotfix_check_sp( xp: 4, win2k: 5, win2003: 3 ) > 0){
				if(version_in_range( version: Ver, test_version: "2.0.50727.3000", test_version2: "2.0.50727.3614" ) || version_in_range( version: Ver, test_version: "2.0.50727.4000", test_version2: "2.0.50727.4454" )){
					security_message( port: 0, data: "The target host was found to be vulnerable" );
					exit( 0 );
				}
			}
			if(hotfix_check_sp( winVista: 3, win2008: 3 ) > 0){
				if(version_in_range( version: Ver, test_version: "2.0.50727.4000", test_version2: "2.0.50727.4205" ) || version_in_range( version: Ver, test_version: "2.0.50727.4400", test_version2: "2.0.50727.4453" )){
					security_message( port: 0, data: "The target host was found to be vulnerable" );
					exit( 0 );
				}
			}
			if(hotfix_check_sp( win7: 1 ) > 0){
				if(version_in_range( version: Ver, test_version: "2.0.50727.4000", test_version2: "2.0.50727.4951" ) || version_in_range( version: Ver, test_version: "2.0.50727.5000", test_version2: "2.0.50727.5017" )){
					security_message( port: 0, data: "The target host was found to be vulnerable" );
					exit( 0 );
				}
			}
