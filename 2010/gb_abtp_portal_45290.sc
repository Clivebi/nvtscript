...
for dir in nasl_make_list_unique( "/abtpportal", "/portal", http_cgi_dirs( port: port ) ) {
	if(dir == "/"){
		dir = "";
	}
	for file in keys( files ) {
		url = NASLString( dir, "/includes/esqueletos/skel_null.php?ABTPV_BLOQUE_CENTRAL=/", files[file] );
