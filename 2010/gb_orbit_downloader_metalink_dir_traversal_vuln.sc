if(description){
	...
	script_dependencies( "gb_orbit_downloader_detect.sc" );
...
if(ver){
	if(version_is_equal( version: ver, test_version: "3.0.0.4" ) || version_is_equal( version: ver, test_version: "3.0.0.5" )){
