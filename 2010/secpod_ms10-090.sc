if(description){
	...
	script_cve_id( "CVE-2010-3340", "CVE-2010-3342", "CVE-2010-3343", "CVE-2010-3345", "CVE-2010-3346", "CVE-2010-3348", "CVE-2010-3962" );
...
if( hotfix_check_sp( xp: 4 ) > 0 ){
	...
	if(ContainsString( SP, "Service Pack 3" )){
		if(version_in_range( version: dllVer, test_version: "6.0", test_version2: "6.0.2900.6048" ) || version_in_range( version: dllVer, test_version: "7.0", test_version2: "7.0.6000.17092" ) || version_in_range( version: dllVer, test_version: "8.0", test_version2: "8.0.6001.18991" )){
	...
	if( hotfix_check_sp( win2003: 3 ) > 0 ){
		...
		if(ContainsString( SP, "Service Pack 2" )){
			if(version_in_range( version: dllVer, test_version: "6.0", test_version2: "6.0.3790.4794" ) || version_in_range( version: dllVer, test_version: "7.0", test_version2: "7.0.6000.17092" ) || version_in_range( version: dllVer, test_version: "8.0", test_version2: "8.0.6001.18991" )){
				security_message( port: 0, data: "The target host was found to be vulnerable" );
			}
			exit( 0 );
		}
		...
		if( hotfix_check_sp( winVista: 3, win2008: 3 ) > 0 ){
			...
			if(ContainsString( SP, "Service Pack 1" )){
				if(version_in_range( version: dllVer, test_version: "7.0", test_version2: "7.0.6001.18541" ) || version_in_range( version: dllVer, test_version: "8.0", test_version2: "8.0.6001.18998" )){
					security_message( port: 0, data: "The target host was found to be vulnerable" );
				}
				exit( 0 );
			}
			if(ContainsString( SP, "Service Pack 2" )){
				if(version_in_range( version: dllVer, test_version: "7.0", test_version2: "7.0.6002.18331" ) || version_in_range( version: dllVer, test_version: "8.0", test_version2: "8.0.6001.18998" )){
					security_message( port: 0, data: "The target host was found to be vulnerable" );
				}
				exit( 0 );
			}
