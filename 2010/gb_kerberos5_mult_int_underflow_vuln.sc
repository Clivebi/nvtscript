...
if(description){
	...
	script_dependencies( "gb_kerberos5_ssh_login_detect.sc" );
...
if(version_in_range( version: version, test_version: "1.3", test_version2: "1.6.3" ) || version_is_equal( version: version, test_version: "1.7" )){
