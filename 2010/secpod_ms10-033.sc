...
if(hotfix_missing( name: "975562" ) == 0 || hotfix_missing( name: "978695" ) == 0 || hotfix_missing( name: "979332" ) == 0 || hotfix_missing( name: "979482" ) == 0){
	exit( 0 );
}
...
if( hotfix_check_sp( win2k: 5 ) > 0 ){
	...
	if(IsMatchRegexp( directXver, "^4\\.09" )){
	...
	if(hotfix_check_sp( xp: 4 ) > 0){
		...
		if(dllVer){
			if( ContainsString( SP, "Service Pack 2" ) ){
				if(version_in_range( version: dllVer, test_version: "9.0", test_version2: "9.0.0.3271" ) || version_in_range( version: dllVer, test_version: "10.0", test_version2: "10.0.0.3705" ) || version_in_range( version: dllVer, test_version: "11.0", test_version2: "11.0.5721.5274" )){
					security_message( port: 0, data: "The target host was found to be vulnerable" );
					exit( 0 );
				}
			}
				...
				if(ContainsString( SP, "Service Pack 3" )){
					if(version_in_range( version: dllVer, test_version: "9.0", test_version2: "9.0.0.4508" ) || version_in_range( version: dllVer, test_version: "10.0", test_version2: "10.0.0.3705" ) || version_in_range( version: dllVer, test_version: "11.0", test_version2: "11.0.5721.5274" )){
						security_message( port: 0, data: "The target host was found to be vulnerable" );
						exit( 0 );
					}
				}
