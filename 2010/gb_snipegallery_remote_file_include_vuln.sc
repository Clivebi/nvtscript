if(description){
	...
	script_dependencies( "gb_snipegallery_detect.sc" );
...
if(snipeVer[1]){
	if(version_is_equal( version: snipeVer[1], test_version: "3.1.4" ) || version_is_equal( version: snipeVer[1], test_version: "3.1.5" )){
