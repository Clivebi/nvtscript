if(description){
	...
	script_cve_id( "CVE-2010-2760", "CVE-2010-2764", "CVE-2010-2766", "CVE-2010-2765", "CVE-2010-2768", "CVE-2010-2767", "CVE-2010-2769", "CVE-2010-3166", "CVE-2010-3167", "CVE-2010-3169", "CVE-2010-3168" );
...
if(ffVer){
	if(version_in_range( version: ffVer, test_version: "3.6", test_version2: "3.6.8" ) || version_in_range( version: ffVer, test_version: "3.5", test_version2: "3.5.11" )){
...
if(tbVer){
	if(version_in_range( version: tbVer, test_version: "3.1", test_version2: "3.1.2" ) || version_in_range( version: tbVer, test_version: "3.0", test_version2: "3.0.6" )){
		security_message( port: 0, data: "The target host was found to be vulnerable" );
	}
}
