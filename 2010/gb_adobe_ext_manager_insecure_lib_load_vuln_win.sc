...
aemPath = registry_get_sz( key: "SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\", item: "ProgramFilesDir" );
if(!aemPath){
	exit( 0 );
}
exePath = aemPath + "\\Adobe\\Adobe Extension Manager CS5" + "\\Adobe Extension Manager CS5.exe";
