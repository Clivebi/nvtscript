if(description){
	...
	script_cve_id( "CVE-2007-0942", "CVE-2007-0944", "CVE-2007-0945", "CVE-2007-0947", "CVE-2007-2221" );
...
if( hotfix_check_sp( win2k: 5 ) > 0 && vers ){
	...
	if(ContainsString( SP, "Service Pack 4" )){
		if(version_in_range( version: vers, test_version: "5.0", test_version2: "5.0.3850.1900" ) || version_in_range( version: vers, test_version: "6.0", test_version2: "6.0.2800.1593" )){
	...
	if( hotfix_check_sp( xp: 4 ) > 0 ){
		...
		if(ContainsString( SP, "Service Pack 2" )){
			if(( vers && version_in_range( version: vers, test_version: "6.0", test_version2: "6.0.2800.1593" ) ) || ( vers && version_in_range( version: vers, test_version: "6.0", test_version2: "6.0.3790.4026" ) ) || ( vers2 && version_in_range( version: vers2, test_version: "7.0", test_version2: "7.0.6000.16432" ) )){
				security_message( port: 0, data: "The target host was found to be vulnerable" );
				exit( 0 );
			}
		}
		...
		if( hotfix_check_sp( win2003: 3 ) > 0 ){
			...
			if( ContainsString( SP, "Service Pack 1" ) ){
				if(( vers && version_in_range( version: vers, test_version: "6.0", test_version2: "6.0.3790.2885" ) ) || ( vers2 && version_in_range( version: vers2, test_version: "7.0", test_version2: "7.0.6000.16432" ) )){
					security_message( port: 0, data: "The target host was found to be vulnerable" );
					exit( 0 );
				}
			}
				...
				if(ContainsString( SP, "Service Pack 2" )){
					if(( vers && version_in_range( version: vers, test_version: "6.0", test_version2: "6.0.3790.4026" ) ) || ( vers2 && version_in_range( version: vers2, test_version: "6.0", test_version2: "7.0.6000.16432" ) )){
						security_message( port: 0, data: "The target host was found to be vulnerable" );
						exit( 0 );
					}
				}
			...
			if(hotfix_check_sp( vista: 2 ) > 0 && vers){
				SP = get_kb_item( "SMB/WinVista/ServicePack" );
				if(ContainsString( SP, "Service Pack 0" )){
