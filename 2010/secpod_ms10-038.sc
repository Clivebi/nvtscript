if(description){
	...
	script_cve_id( "CVE-2010-0821", "CVE-2010-0822", "CVE-2010-0823", "CVE-2010-0824", "CVE-2010-1246", "CVE-2010-1245", "CVE-2010-1247", "CVE-2010-1249", "CVE-2010-1248", "CVE-2010-1250", "CVE-2010-1251", "CVE-2010-1252", "CVE-2010-1253" );
	script_bugtraq_id( 40518, 40520, 40521, 40522, 40524, 40523, 40525, 40526, 40527, 40528, 40529, 40530, 40531 );
...
if(IsMatchRegexp( excelVer, "^1[0-2]\\.0" )){
	if(version_in_range( version: excelVer, test_version: "10.0", test_version2: "10.0.6861" ) || version_in_range( version: excelVer, test_version: "11.0", test_version2: "11.0.8323" ) || version_in_range( version: excelVer, test_version: "12.0", test_version2: "12.0.6535.5001" )){
