...
if( IsMatchRegexp( version, "^4\\.8" ) && version_in_range( version: version, test_version: "4.8.0", test_version2: "4.8.1368" ) ){
	report = report_fixed_ver( installed_version: version, fixed_version: fixed, install_path: location );
	security_message( data: report, port: 0 );
	exit( 0 );
}
else {
	if(IsMatchRegexp( version, "^5\\.0" ) && version_in_range( version: version, test_version: "5.0", test_version2: "5.0.417" )){
		report = report_fixed_ver( installed_version: version, fixed_version: fixed, install_path: location );
		security_message( data: report, port: 0 );
		exit( 0 );
	}
