...
if(!officeVer || !IsMatchRegexp( officeVer, "^1[12]\\." )){
	exit( 0 );
}
...
if(offPath){
	...
	if(version_in_range( version: dllVer, test_version: "11.0", test_version2: "11.0.8323" ) || version_in_range( version: dllVer, test_version: "12.0", test_version2: "12.0.6535.5001" )){
		security_message( port: 0, data: "The target host was found to be vulnerable" );
		exit( 0 );
	}
}
ovPath = registry_get_sz( key: "SOFTWARE\\Microsoft\\Windows\\CurrentVersion" + "\\App Paths\\visio.exe", item: "Path" );
if(ovPath){
	share = ereg_replace( pattern: "([A-Z]):.*", replace: "\\1$", string: ovPath );
	file = ereg_replace( pattern: "[A-Z]:(.*)", replace: "\\1", string: ovPath + "visio.exe" );
	visioVer = GetVer( file: file, share: share );
	if(!isnull( visioVer )){
		if(version_in_range( version: visioVer, test_version: "11.0", test_version2: "11.0.8206" ) || version_in_range( version: visioVer, test_version: "12.0", test_version2: "12.0.6529.4999" )){
			security_message( port: 0, data: "The target host was found to be vulnerable" );
			exit( 0 );
		}
	}
...
if(!isnull( xlVer )){
	if(version_in_range( version: xlVer, test_version: "11.0", test_version2: "11.0.8323" ) || version_in_range( version: xlVer, test_version: "12.0", test_version2: "12.0.6535.5001" )){
		security_message( port: 0, data: "The target host was found to be vulnerable" );
		exit( 0 );
	}
}
...
if(!isnull( ppntVer )){
	if(version_in_range( version: ppntVer, test_version: "11.0", test_version2: "11.0.8323.0" ) || version_in_range( version: ppntVer, test_version: "12.0", test_version2: "12.0.6500.4999" )){
		security_message( port: 0, data: "The target host was found to be vulnerable" );
		exit( 0 );
	}
}
...
if(!isnull( pubVer )){
	if(version_in_range( version: pubVer, test_version: "11.0", test_version2: "11.0.8323.0" ) || version_in_range( version: pubVer, test_version: "12.0", test_version2: "12.0.6535.5001" )){
		security_message( port: 0, data: "The target host was found to be vulnerable" );
		exit( 0 );
	}
}
...
if(!isnull( winwordVer )){
	if(version_in_range( version: winwordVer, test_version: "11.0", test_version2: "11.0.8323.0" ) || version_in_range( version: winwordVer, test_version: "12.0", test_version2: "12.0.6535.4999" )){
		security_message( port: 0, data: "The target host was found to be vulnerable" );
		exit( 0 );
	}
}
