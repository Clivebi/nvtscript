...
if(officeVer && IsMatchRegexp( officeVer, "^1[01]\\." )){
	...
	if(pptVer && IsMatchRegexp( pptVer, "^1[01]\\." )){
		if(version_in_range( version: pptVer, test_version: "10.0", test_version2: "10.0.6857" ) || version_in_range( version: pptVer, test_version: "11.0", test_version2: "11.0.8317" )){
