...
if(description){
	...
	script_dependencies( "gb_adobe_fms_detect.sc" );
...
if(version_in_range( version: vers, test_version: "4.0", test_version2: "4.0.0" ) || version_in_range( version: vers, test_version: "3.5", test_version2: "3.5.4" ) || version_in_range( version: vers, test_version: "3.0", test_version2: "3.0.6" )){
