if(description){
	...
	script_cve_id( "CVE-2010-1211", "CVE-2010-1212", "CVE-2010-1213", "CVE-2010-2752", "CVE-2010-2753", "CVE-2010-2754", "CVE-2010-0654" );
...
if(tbVer){
	if(version_is_equal( version: tbVer, test_version: "3.1.0" ) || version_in_range( version: tbVer, test_version: "3.0", test_version2: "3.0.5" )){
		security_message( port: 0, data: "The target host was found to be vulnerable" );
	}
}
