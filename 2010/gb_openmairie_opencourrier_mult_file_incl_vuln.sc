...
if(description){
	...
	script_version( "2021-08-05T08:11:13+0000" );
	script_tag( name: "last_modification", value: "2021-08-05 08:11:13 +0000 (Thu, 05 Aug 2021)" );
	...
	script_mandatory_keys( "openmairie/open_courrier/http/detected" );
  ...
  product or replace the product by another one." );
	script_tag( name: "summary", value: "openMairie openCourrier is prone to multiple file inclusion
  vulnerabilities." );
