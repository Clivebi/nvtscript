if(description){
	...
	script_dependencies( "viewvc_detect.sc" );
...
if(!version = get_kb_item( NASLString( "www/", port, "/viewvc" ) )){
	exit( 0 );
}
...
if(!isnull( vers ) && !ContainsString( "unknown", vers )){
	if(version_in_range( version: vers, test_version: "1.1", test_version2: "1.1.3" ) || version_in_range( version: vers, test_version: "1.0", test_version2: "1.0.9" )){
