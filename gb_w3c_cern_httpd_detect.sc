...
if(IsMatchRegexp( buf, "Server: *CERN" )){
	...
	register_and_report_cpe( app: "CERN httpd", ver: version, concluded: ver[0], base: CPE, expr: "([0-9A-Z.]+)-?([a-z.]+)?", insloc: port + "/tcp", regPort: port, regService: "www" );
}
exit( 0 );
