...
if(!banner || !ContainsString( banner, "Server: Ipswitch" )){
	exit( 0 );
}
useragent = http_get_user_agent();
host = http_host_name( port: port );
req = NASLString( "GET /NmConsole/Default.asp?bIsJavaScriptDisabled=false HTTP/1.1\r\n", "Host: ", host, "\r\n", "User-Agent: ", useragent, "\r\n", "Accept: text/xml,application/xml,application/xhtml+xml,text/html;q=0.9,text/plain;q=0.8,image/png,*.*;q=0.5\r\n", "Accept-Language: en-us,en;q=0.5\r\n", "Accept-Encoding: gzip,deflate\r\n", "Accept-Charset: ISO-8859-1,utf-8;q=0.7,*;q=0.7\r\n", "Referer: http://", host, "/\r\n", "\r\n" );
res = http_keepalive_send_recv( port: port, data: req, bodyonly: FALSE );
if(res == NULL){
	exit( 0 );
}
if(ContainsString( res, "Location: /NmConsole/Login.asp" )){
	req = NASLString( "GET /NmConsole/Default.asp?bIsJavaScriptDisabled=false HTTP/1.1\r\n", "Host: ", host, "\r\n", "User-Agent: Ipswitch/1.0\r\n", "User-Application: NmConsole\r\n", "Accept: text/xml,application/xml,application/xhtml+xml,text/html;q=0.9,text/plain;q=0.8,image/png,*.*;q=0.5\r\n", "Accept-Language: en-us,en;q=0.5\r\n", "Accept-Encoding: gzip,deflate\r\n", "Accept-Charset: ISO-8859-1,utf-8;q=0.7,*;q=0.7\r\n", "Referer: http://", host, "/\r\n", "\r\n" );
	res = http_keepalive_send_recv( port: port, data: req, bodyonly: TRUE );
	if(!res){
		exit( 0 );
	}
	if(ContainsString( res, "<title>Group Device List for" )){
