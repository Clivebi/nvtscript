...
iExpVer = registry_get_sz( key: "SOFTWARE\\Microsoft\\Internet Explorer", item: "Version" );
if(!iExpVer){
...
if(ereg( pattern: "^(7\\..*|8\\.0\\.(([0-5]?[0-9]?[0-9]?[0-9]|6000)\\..*|6001" + "\\.(0?[0-9]?[0-9]?[0-9]?[0-9]|1[0-7][0-9][0-9][0-9]|18[01]" + "[0-9][0-9]|182([0-3][0-9]|4[01]))))($|[^.0-9])", string: iExpVer )){
