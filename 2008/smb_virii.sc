...
var nname, url, key, item, exp;
if(!get_kb_item( "SMB/WindowsVersion" )){
	exit( 0 );
}
func check_reg( nname, url, key, item, exp ){
	...
	if(exp == NULL || ContainsString( tolower( value ), tolower( exp ) )){
		report = NASLString( "The virus '", nname, "' is present on the remote host\\n\\n", "Registry Key checked '", key, "'\\n", "Registry Item checked '", item, "'\\n", "Registry Value exists '", value, "'\\n", "Registry Value expected '", exp, "'\\n", "Solution: ", url );
...
if(resp){
	...
	if(ContainsString( data, "shell=explorer.exe load.exe -dontrunold" )){
		report = NASLString( "The virus 'W32.Nimda.A@mm' is present on the remote host\\n\\n", "Location checked: ", file, "\\n\\n", "Solution: http://www.symantec.com/avcenter/venc/data/w32.nimda.a@mm.html" );
...
_file = NASLString( file, "\\\\System32\\\\", trojanname );
handle = smb_read_file( file: _file, share: share, offset: 0, count: 8 );
if(!handle){
	_file = NASLString( file, "\\\\System32\\\\_svchost.exe" );
	handle = smb_read_file( file: _file, share: share, offset: 0, count: 8 );
}
if(!handle){
	_file = NASLString( file, "\\\\System32\\\\Outlook Express" );
	handle = smb_read_file( file: _file, share: share, offset: 0, count: 8 );
}
if(!handle){
	_file = NASLString( file, "\\\\System32\\\\CFXP.DRV" );
	handle = smb_read_file( file: _file, share: share, offset: 0, count: 8 );
}
if(!handle){
	_file = NASLString( file, "\\\\System32\\\\CHJO.DRV" );
	handle = smb_read_file( file: _file, share: share, offset: 0, count: 8 );
}
if(!handle){
	_file = NASLString( file, "\\\\System32\\\\MMSYSTEM.DLX" );
	handle = smb_read_file( file: _file, share: share, offset: 0, count: 8 );
}
if(!handle){
	_file = NASLString( file, "\\\\System32\\\\OLECLI.DLX" );
	handle = smb_read_file( file: _file, share: share, offset: 0, count: 8 );
}
if(!handle){
	_file = NASLString( file, "\\\\System32\\\\Windll.dlx" );
	handle = smb_read_file( file: _file, share: share, offset: 0, count: 8 );
}
if(!handle){
	_file = NASLString( file, "\\\\System32\\\\Activity.AVI" );
	handle = smb_read_file( file: _file, share: share, offset: 0, count: 8 );
}
if(!handle){
	_file = NASLString( file, "\\\\System32\\\\Upgrade.AVI" );
	handle = smb_read_file( file: _file, share: share, offset: 0, count: 8 );
}
if(!handle){
	_file = NASLString( file, "\\\\System32\\\\System.lst" );
	handle = smb_read_file( file: _file, share: share, offset: 0, count: 8 );
}
if(!handle){
	_file = NASLString( file, "\\\\System32\\\\PF30txt.dlx" );
	handle = smb_read_file( file: _file, share: share, offset: 0, count: 8 );
}
if(handle){
	report = NASLString( "The trojan 'hotword' is present on the remote host\\n\\n", "Location checked: ", _file, "\\n\\n", "See also : http://securityresponse.symantec.com/avcenter/venc/data/trojan.hotword.html\\n", "See also : http://securityresponse.symantec.com/avcenter/venc/data/trojan.rona.html\\n", "Solution:  Use latest anti-virus signatures to clean the machine." );
	security_message( port: 0, data: report );
}
