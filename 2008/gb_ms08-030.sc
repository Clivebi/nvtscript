...
if( ContainsString( SP, "Service Pack 2" ) ){
	...
	if(egrep( pattern: "^5\\.0?1\\.2600\\.([0-2]?[0-9]?[0-9]?[0-9]|3[0-2][0-9][0-9]" + "|33([0-7][0-9]|8[0-8]))$", string: sysVer )){
	...
	if(ContainsString( SP, "Service Pack 3" )){
		...
		if(egrep( pattern: "5\\.0?1\\.2600\\.([0-4]?[0-9]?[0-9]?[0-9]|5[0-5][0-9][0-9]|" + "56[01][0-9])$", string: sysVer )){
			security_message( port: 0, data: "The target host was found to be vulnerable" );
		}
	}
}
