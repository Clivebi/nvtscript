...
hostExpVer = registry_get_sz( key: "SOFTWARE\\Hummingbird\\Event Monitoring" + "\\Product Info\\HostExplorer 2008", item: "Version" );
if(!hostExpVer){
	hostExpVer = registry_get_sz( key: "SOFTWARE\\Hummingbird\\Event Monitoring" + "\\Product Info\\HostExplorer 2008\\HostExplorer", item: "Version" );
	if(!hostExpVer){
		exit( 0 );
	}
}
