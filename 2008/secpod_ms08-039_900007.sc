...
if( ContainsString( appName, "Microsoft Exchange Server 2003" ) ){
	...
	if(egrep( pattern: "^(0?([0-5]\\..*|6\\.0?([0-4]\\..*|5\\.([0-6]?[0-9]?" + "[0-9]?[0-9]\\..*|7[0-5][0-9][0-9]\\..*|76[0-4].*|765" + "[0-2]\\..*|7653\\.0?([0-2]?[0-9]|3[0-7])))))$", string: fileVer )){
	...
	if(ContainsString( appName, "Microsoft Exchange Server 2007" )){
		...
		if( !spCheck ){
			...
			if(egrep( pattern: "^(0?([0-7]\\..*|8\\.0?0\\.0?([0-6]?[0-9][0-9]" + "\\..*|7[0-4][0-9]\\..*)))$", string: fileVer )){
				security_message( port: 0, data: "The target host was found to be vulnerable" );
			}
			exit( 0 );
		}
			...
			if(egrep( pattern: "^(0?([0-7]\\..*|8\\.0?0\\..*|8\\.0?1\\.0?([01]?[0-9][0-9]" + "\\..*|2[0-6][0-9]\\..*|27[0-7]\\..*)))$", string: fileVer )){
				security_message( port: 0, data: "The target host was found to be vulnerable" );
			}
			exit( 0 );
		}
