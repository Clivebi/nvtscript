...
if( hotfix_check_sp( win2k: 5 ) > 0 ){
	...
	if(ereg( pattern: "^(1999\\..*|2000\\.(1\\..*|2\\.([0-2]?[0-9].|3[0-4].*|" + "35[0-4][0-9]\\..*)))$", string: vers )){
	...
	if( hotfix_check_sp( xp: 4 ) > 0 ){
		...
		if( ContainsString( SP, "Service Pack 2" ) ){
			if(ereg( pattern: "^(2000\\..*|2001\\.(0?[0-9]\\..*|1[01]\\..*|12\\." + "([0-3]?[0-9].*|4[0-3].*|440[0-9]\\..*|441[0-3]" + "\\..*|4414\\.([0-2]?[0-9]?[0-9]|3[01][0-9])))).?$", string: vers )){
				security_message( port: 0, data: "The target host was found to be vulnerable" );
			}
			exit( 0 );
		}
			...
			if( ContainsString( SP, "Service Pack 3" ) ){
				if(ereg( pattern: "^(2000\\..*|2001\\.(0?[0-9]\\..*|1[01]\\..*|12\\." + "([0-3]?[0-9].*|4[0-3].*|440[0-9]\\..*|441[0-3]" + "\\..*|4414\\.([0-6]?[0-9]?[0-9]|70[0-5])))).?$", string: vers )){
					security_message( port: 0, data: "The target host was found to be vulnerable" );
				}
				exit( 0 );
			}
		...
		if(hotfix_check_sp( win2003: 3 ) > 0){
			...
			if( ContainsString( SP, "Service Pack 1" ) ){
				if(ereg( pattern: "^(2000\\..*|2001\\.(0?[0-9]\\..*|1[01]\\..*|12\\." + "([0-3]?[0-9].*|4[0-6].*|47[01][0-9]\\..*|4720" + "\\.([0-2]?[0-9]?[0-9]?[0-9]|30.*|31[01][0-9]|" + "312[0-8])))).?$", string: vers )){
					security_message( port: 0, data: "The target host was found to be vulnerable" );
				}
				exit( 0 );
			}
				...
				if( ContainsString( SP, "Service Pack 2" ) ){
					if(ereg( pattern: "^(2000\\..*|2001\\.(0?[0-9]\\..*|1[01]\\..*|12\\." + "([0-3]?[0-9].*|4[0-6].*|47[01][0-9]\\..*|4720" + "\\.([0-3]?[0-9]?[0-9]?[0-9]|4[01].*|42[0-7][0-9]|" + "428[01])))).?$", string: vers )){
						security_message( port: 0, data: "The target host was found to be vulnerable" );
					}
					exit( 0 );
				}
