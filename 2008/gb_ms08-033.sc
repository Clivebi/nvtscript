...
if(hotfix_check_sp( win2k: 5 ) > 0){
	if( egrep( pattern: "^4\\.07", string: directXver ) ){
		...
		if(egrep( pattern: "^6\\.01\\.09\\.0?([0-6]?[0-9]?[0-9]|7([0-2][0-9]|3[0-3]))$", string: fileVer )){
			security_message( port: 0, data: "The target host was found to be vulnerable" );
		}
	}
	else {
		if( egrep( pattern: "^4\\.08", string: directXver ) ){
			if(egrep( pattern: "^6\\.03\\.01\\.0?([0-7]?[0-9]?[0-9]|8([0-8][0-9]|90))$", string: fileVer )){
				security_message( port: 0, data: "The target host was found to be vulnerable" );
			}
		}
		else {
			if(egrep( pattern: "^4\\.09", string: directXver )){
				if( egrep( pattern: "^6\\.05\\.0?1\\.0?([0-8]?[0-9]?[0-9]|90[0-8])$", string: fileVer ) ){
					security_message( port: 0, data: "The target host was found to be vulnerable" );
				}
				else {
					if(egrep( pattern: "^6\\.05\\.2600\\.(0?[0-9]?[0-9]?[0-9]|1([0-2][0-9]" + "[0-9]|3(0[0-9]|1[0-5])))$", string: fileVer )){
						security_message( port: 0, data: "The target host was found to be vulnerable" );
					}
				}
			}
...
if(hotfix_check_sp( xp: 4 ) > 0){
	if(egrep( pattern: "^4\\.09", string: directXver )){
		...
		if( ContainsString( SP, "Service Pack 2" ) ){
			if(egrep( pattern: "^6\\.05\\.2600\\.([0-2]?[0-9]?[0-9]?[0-9]|3([0-2][0-9]" + "[0-9]|3([0-5][0-9]|6[0-6])))$", string: fileVer )){
				security_message( port: 0, data: "The target host was found to be vulnerable" );
			}
		}
		else {
			if(ContainsString( SP, "Service Pack 3" )){
				if(egrep( pattern: "^6\\.05\\.2600\\.([0-4]?[0-9]?[0-9]?[0-9]|5([0-4][0-9]" + "[0-9]|5([0-8][0-9]|9[0-5])))$", string: fileVer )){
					security_message( port: 0, data: "The target host was found to be vulnerable" );
				}
			}
		}
...
if(hotfix_check_sp( win2003: 3 ) > 0){
	if(egrep( pattern: "^4\\.09", string: directXver )){
		...
		if( ContainsString( SP, "Service Pack 1" ) ){
			if(egrep( pattern: "^6\\.05\\.3790\\.([0-2]?[0-9]?[0-9]?[0-9]|3(0[0-9]" + "[0-9]|1[0-2][0-9]))$", string: fileVer )){
				security_message( port: 0, data: "The target host was found to be vulnerable" );
			}
		}
		else {
			if(ContainsString( SP, "Service Pack 2" )){
				if(egrep( pattern: "^6\\.05\\.3790\\.([0-3]?[0-9]?[0-9]?[0-9]|4([01][0-9]" + "[0-9]|2([0-7][0-9]|8[0-2])))$", string: fileVer )){
					security_message( port: 0, data: "The target host was found to be vulnerable" );
				}
			}
		}
