if(description){
	...
	script_version( "2021-03-30T06:07:24+0000" );
	script_cve_id( "CVE-2020-17008" );
	script_tag( name: "cvss_base", value: "7.2" );
	script_tag( name: "cvss_base_vector", value: "AV:L/AC:L/Au:N/C:C/I:C/A:C" );
	script_tag( name: "last_modification", value: "2021-03-30 06:07:24 +0000 (Tue, 30 Mar 2021)" );
	...
	script_tag( name: "summary", value: "This host is prone to a critical
  ...
  on the target host." );
	script_tag( name: "insight", value: "The flaw exists due to wrong fix of pointers
  which are simply changed to offsets." );
  ...
  - Microsoft Windows Server 2019" );
	script_tag( name: "solution", value: "The vendor has released updates Please check the
  referenced replacement VTs for more information." );
