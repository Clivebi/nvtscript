...
if(ContainsString( res, "\"name\": \"B4N Orchestrator\"" )){
	version = "unknown";
	url = "/api/version";
	...
	log_message( data: build_detection_report( app: "Brain4Net Orchestrator", version: version, install: "/", cpe: cpe, concluded: vers[0], concludedUrl: concUrl ), port: port );
	exit( 0 );
}
exit( 0 );
