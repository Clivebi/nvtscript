...
if(ContainsString( res, "<title>Cisco Energy Management</title>" ) && ContainsString( res, "var JEM_FLAVOR" )){
	version = "unknown";
	...
	log_message( data: build_detection_report( app: "Cisco Energy Management Suite", version: version, install: "/", cpe: cpe, concluded: vers[0] ), port: port );
	exit( 0 );
}
exit( 0 );
