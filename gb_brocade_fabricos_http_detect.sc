...
if(!IsMatchRegexp( buf, "^HTTP/1\\.[01] 302" ) || !ContainsString( buf, "switchExplorer.html" )){
	exit( 0 );
}
...
if(ContainsString( buf1, "<application-desc main-class=\"com.brocade.web" ) || ContainsString( buf2, "CODE=\"com.brocade.web" ) || ContainsString( buf3, "CODE=\"com.brocade.web" )){
	version = "unknown";
