...
if(description){
	...
	script_name( "Adobe Acrobat DC 2015 Security Update (APSB20-48) - Windows" );
...
if(version_in_range( version: vers, test_version: "15.0", test_version2: "15.006.30526" )){
	report = report_fixed_ver( installed_version: vers, fixed_version: "15.006.30527(2015.006.30527)", install_path: path );
