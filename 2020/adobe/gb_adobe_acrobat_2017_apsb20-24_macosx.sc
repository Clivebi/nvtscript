...
if(description){
	...
	script_name( "Adobe Acrobat 2017 Security Update (APSB20-24) - Mac OS X" );
...
vers = infos["version"];
path = infos["location"];
if(version_in_range( version: vers, test_version: "17.0", test_version2: "17.011.30170" )){
	report = report_fixed_ver( installed_version: vers, fixed_version: "17.011.30171(2017.011.30171)", install_path: path );
