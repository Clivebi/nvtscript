...
if(description){
	...
	script_name( "Adobe Acrobat DC (Continuous) Security Update (APSB20-48) - Mac OS X" );
...
vers = infos["version"];
path = infos["location"];
if(version_in_range( version: vers, test_version: "20.0", test_version2: "20.012.20040" )){
	report = report_fixed_ver( installed_version: vers, fixed_version: "20.012.20041(2020.012.20041)", install_path: path );
