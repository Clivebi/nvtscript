...
if(description){
	...
	script_name( "Adobe Acrobat DC (Continuous) Security Update (APSB20-05) - Mac OS X" );
  ...
  to version 2020.006.20034." );
	script_tag( name: "solution", value: "Update to Adobe Acrobat DC (Continuous)
  version 2020.006.20034 or later." );
