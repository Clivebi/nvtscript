...
if(description){
	...
	script_name( "Adobe Reader DC 2015 Security Update (APSB20-48) - Mac OS X" );
  ...
  to version 2015.006.30527." );
	script_tag( name: "solution", value: "Update to Adobe Reader DC 2015 (Classic) to
  version 2015.006.30527 or later." );
...
vers = infos["version"];
path = infos["location"];
if(version_in_range( version: vers, test_version: "15.0", test_version2: "15.006.30526" )){
	report = report_fixed_ver( installed_version: vers, fixed_version: "15.006.30526(2015.006.30526)", install_path: path );
