...
if(description){
	...
	script_name( "Adobe Acrobat DC 2020 Security Update (APSB20-67) - Windows" );
	script_tag( name: "summary", value: "Adobe Acrobat DC (Classic) 2020 is prone to multiple vulnerabilities." );
  ...
  to version 2020.001.30010." );
	script_tag( name: "solution", value: "Update to Adobe Acrobat DC 2020 (Classic) to
