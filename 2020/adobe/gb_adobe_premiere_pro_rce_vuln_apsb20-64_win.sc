...
if(description){
	...
	script_tag( name: "severity_date", value: "2020-11-02 12:53:00 +0000 (Mon, 02 Nov 2020)" );
	...
	script_tag( name: "summary", value: "Adobe Premiere Pro is prone to RCE vulnerability." );
  ...
  to execute arbitrary code on affected system." );
	script_tag( name: "affected", value: "Adobe Premiere Pro 14.4 and prior." );
	script_tag( name: "solution", value: "Update Adobe Premiere Pro to version 14.5
  or later." );
