...
if(http_vuln_check( port: port, url: url, pattern: "\"EONAPI_KEY\": \"[a-f0-9]+\"", extra_check: "\"http_code\": \"200 OK\"", check_header: TRUE )){
	report = "It was possible to obtain EONAPI_KEY for the user 'admin' at " + http_report_vuln_url( port: port, url: url, url_only: TRUE );
