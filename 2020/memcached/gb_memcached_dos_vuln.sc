...
if(description){
	...
	script_tag( name: "severity_date", value: "2020-03-27 19:48:00 +0000 (Fri, 27 Mar 2020)" );
	...
	script_tag( name: "insight", value: "The remote DoS (segfault) flaw exists in the code used to parse
  the binary protocol header that was introduced in 1.6.0." );
