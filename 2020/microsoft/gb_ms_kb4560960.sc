if(description){
	...
	script_tag( name: "severity_date", value: "2020-06-12 16:05:00 +0000 (Fri, 12 Jun 2020)" );
...
if(version_in_range( version: fileVer, test_version: "10.0.18362.0", test_version2: "10.0.18362.899" )){
	report = report_fixed_ver( file_checked: sysPath + "\\Kernel32.dll", file_version: fileVer, vulnerable_range: "10.0.18362.0 - 10.0.18362.899" );
