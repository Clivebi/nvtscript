if(description){
	...
	script_tag( name: "severity_date", value: "2020-10-20 13:11:00 +0000 (Tue, 20 Oct 2020)" );
...
if(version_in_range( version: excelVer, test_version: "15.0", test_version2: "15.0.5285.0999" )){
	report = report_fixed_ver( file_checked: excelPath + "Excel.exe", file_version: excelVer, vulnerable_range: "15.0 - 15.0.5285.0999" );
