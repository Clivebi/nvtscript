...
if(version_is_less( version: dllVer, test_version: "10.0.17763.1282" )){
	report = report_fixed_ver( file_checked: sysPath + "\\drivers\\Dxgkrnl.sys", file_version: dllVer, vulnerable_range: "Less than 10.0.17763.1282" );
