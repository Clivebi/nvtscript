...
for key in key_list {
	...
	if(msPath){
		...
		if(IsMatchRegexp( offdllVer, "^16\\." ) && version_is_less( version: offdllVer, test_version: "16.0.5017.1000" )){
			report = report_fixed_ver( file_checked: msPath + "\\Microsoft Office\\Root\\VFS\\ProgramFilesCommonX86\\Microsoft Shared\\Office16\\Mso.dll", file_version: offdllVer, vulnerable_range: "16.0 - 16.0.5017.0999" );
