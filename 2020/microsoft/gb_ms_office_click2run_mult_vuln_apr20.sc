if(description){
	...
	script_cve_id( "CVE-2020-0760", "CVE-2020-0906", "CVE-2020-0961", "CVE-2020-0980", "CVE-2020-0991" );
	...
	if( UpdateChannel == "Semi-Annual Channel (Targeted)" ){
		...
		if(UpdateChannel == "Semi-Annual Channel"){
			if( version_is_less( version: officeVer, test_version: "16.0.11328.20564" ) ){
				...
				if(version_in_range( version: officeVer, test_version: "16.0.11929", test_version2: "16.0.11929.20707" )){
