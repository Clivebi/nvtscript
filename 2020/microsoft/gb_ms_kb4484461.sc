if(description){
	...
	script_cve_id( "CVE-2020-1497", "CVE-2020-1496", "CVE-2020-1495", "CVE-2020-1494", "CVE-2020-1498", "CVE-2020-1504" );
...
if(version_in_range( version: excelVer, test_version: "14.0", test_version2: "14.0.7256.4999" )){
	report = report_fixed_ver( file_checked: excelPath + "Excel.exe", file_version: excelVer, vulnerable_range: "14.0 - 14.0.7256.4999" );
