if(description){
	...
	script_cve_id( "CVE-2020-17128", "CVE-2020-17123", "CVE-2020-17125", "CVE-2020-17126", "CVE-2020-17129" );
...
if(version_in_range( version: excelVer, test_version: "15.0", test_version2: "15.0.5301.0999" )){
	report = report_fixed_ver( file_checked: excelPath + "Excel.exe", file_version: excelVer, vulnerable_range: "15.0 - 15.0.5301.0999" );
