if(description){
	...
	script_cve_id( "CVE-2020-1582", "CVE-2020-1495", "CVE-2020-1498", "CVE-2020-1496", "CVE-2020-1497", "CVE-2020-1494", "CVE-2020-1493", "CVE-2020-1483", "CVE-2020-1583", "CVE-2020-1502", "CVE-2020-1503", "CVE-2020-1581", "CVE-2020-1563" );
	...
	if( UpdateChannel == "Semi-Annual Channel (Targeted)" ){
		...
		if(UpdateChannel == "Semi-Annual Channel"){
			if( version_is_less( version: officeVer, test_version: "16.0.11328.20644" ) ){
				...
				if( version_in_range( version: officeVer, test_version: "16.0.11929", test_version2: "16.0.11929.20934" ) ){
					fix = "1908 (Build 11929.20934)";
				}
				else {
					if(version_in_range( version: officeVer, test_version: "16.0.12527", test_version2: "16.0.12527.20988" )){
						fix = "2002 (Build 12527.20988)";
					}
				}
			}
