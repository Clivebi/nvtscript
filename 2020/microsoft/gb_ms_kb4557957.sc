if(description){
	...
	script_tag( name: "severity_date", value: "2020-06-15 13:15:00 +0000 (Mon, 15 Jun 2020)" );
...
if(version_in_range( version: dllVer, test_version: "10.0.19041.0", test_version2: "10.0.19041.328" )){
	report = report_fixed_ver( file_checked: sysPath + "\\Gdiplus.dll", file_version: dllVer, vulnerable_range: "10.0.19041.0 - 10.0.19041.328" );
