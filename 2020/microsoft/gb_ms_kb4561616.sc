...
if(version_in_range( version: dllVer, test_version: "10.0.14393.0", test_version2: "10.0.14393.3749" )){
	report = report_fixed_ver( file_checked: sysPath + "\\Ntoskrnl.exe", file_version: dllVer, vulnerable_range: "10.0.14393.0 - 10.0.14393.3749" );
