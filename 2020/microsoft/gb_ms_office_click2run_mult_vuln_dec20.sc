if(description){
	...
	script_cve_id( "CVE-2020-17123", "CVE-2020-17125", "CVE-2020-17126", "CVE-2020-17128", "CVE-2020-17129", "CVE-2020-17130", "CVE-2020-17119", "CVE-2020-17124" );
	...
	if( UpdateChannel == "Semi-Annual Channel (Targeted)" ){
		...
		if(UpdateChannel == "Semi-Annual Channel"){
			if( version_is_less( version: officeVer, test_version: "16.0.11929.20984" ) ){
				...
				if(version_in_range( version: officeVer, test_version: "16.0.12527", test_version2: "16.0.12527.21415" )){
