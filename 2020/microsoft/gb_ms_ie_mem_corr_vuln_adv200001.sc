...
if(hotfix_check_sp( win2008: 3, win2008x64: 3, win2012: 1, win7: 2, win7x64: 2, win2008r2: 2, win8_1: 1, win8_1x64: 1, win2012R2: 1, win10: 1, win10x64: 1 ) <= 0){
	exit( 0 );
}
...
if( hotfix_check_sp( win2008: 3, win2008x64: 3 ) > 0 ){
	if(IsMatchRegexp( ieVer, "^9\\." ) && version_is_less_equal( version: iedllVer, test_version: "5.8.7601.21387" )){
		Vulnerable_range1 = "Less than 5.8.7601.21387";
	}
}
else {
	if( hotfix_check_sp( win2012: 1 ) > 0 ){
		if( IsMatchRegexp( ieVer, "^11\\." ) && version_is_less_equal( version: iedllVer, test_version: "5.8.9600.19597" ) ){
			Vulnerable_range1 = "Less than 5.8.9600.19597";
		}
		else {
			if(IsMatchRegexp( ieVer, "^10\\." ) && version_is_less_equal( version: iedllVer, test_version: "5.8.9200.22949" )){
		...
		if( hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2, win8_1: 1, win8_1x64: 1, win2012R2: 1 ) > 0 ){
			...
			if(hotfix_check_sp( win10: 1, win10x64: 1 ) > 0 && IsMatchRegexp( ieVer, "^11\\." )){
				if( version_in_range( version: dllVer, test_version: "10.0.17134.0", test_version2: "10.0.17134.1246" ) ){
					...
					if( version_in_range( version: dllVer1, test_version: "10.0.17763.0", test_version2: "10.0.17763.973" ) ){
						Vulnerable_range3 = "10.0.17763.0 - 10.0.17763.973";
					}
					else {
						if( version_in_range( version: dllVer1, test_version: "10.0.18362.0", test_version2: "10.0.18362.592" ) ){
							Vulnerable_range3 = "10.0.18362.0 - 10.0.18362.592";
						}
						else {
							if( version_in_range( version: dllVer, test_version: "10.0.16299.0", test_version2: "10.0.16299.1625" ) ){
								Vulnerable_range2 = "10.0.16299.0 - 10.0.16299.1625";
							}
							else {
								if( version_in_range( version: dllVer, test_version: "10.0.10240.0", test_version2: "10.0.10240.18453" ) ){
									Vulnerable_range2 = "10.0.10240.0 - 10.0.10240.18453";
								}
								else {
									if(version_in_range( version: dllVer1, test_version: "10.0.14393.0", test_version2: "10.0.14393.3442" )){
...
if(Vulnerable_range1){
	report = report_fixed_ver( file_checked: iePath + "\\Jscript.dll", file_version: iedllVer, vulnerable_range: Vulnerable_range1 );
	security_message( data: report );
	exit( 0 );
}
if(Vulnerable_range2){
	report = report_fixed_ver( file_checked: iePath + "\\User32.dll", file_version: iedllVer, vulnerable_range: Vulnerable_range2 );
	security_message( data: report );
	exit( 0 );
}
if(Vulnerable_range3){
	report = report_fixed_ver( file_checked: iePath + "\\Gdiplus.dll", file_version: iedllVer, vulnerable_range: Vulnerable_range3 );
	security_message( data: report );
	exit( 0 );
}
exit( 0 );
