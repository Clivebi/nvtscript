if(description){
	...
	script_cve_id( "CVE-2020-17128", "CVE-2020-17123", "CVE-2020-17125", "CVE-2020-17126", "CVE-2020-17127" );
...
if(IsMatchRegexp( exeVer, "^14\\." ) && version_is_less( version: exeVer, test_version: "14.0.7263.5000" )){
	report = report_fixed_ver( file_checked: exePath + "Excel.exe", file_version: exeVer, vulnerable_range: "14.0 - 14.0.7263.4999" );
