if(description){
	...
	script_cve_id( "CVE-2020-1226", "CVE-2020-1225", "CVE-2020-1229", "CVE-2020-1322", "CVE-2020-1321" );
	...
	if( UpdateChannel == "Semi-Annual Channel (Targeted)" ){
		...
		if(UpdateChannel == "Semi-Annual Channel"){
			if( version_is_less( version: officeVer, test_version: "16.0.11328.20602" ) ){
				...
				if(version_in_range( version: officeVer, test_version: "16.0.11929", test_version2: "16.0.11929.20837" )){
