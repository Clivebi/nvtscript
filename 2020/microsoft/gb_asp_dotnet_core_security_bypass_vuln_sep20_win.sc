...
if(description){
	...
	script_tag( name: "summary", value: "ASP.NET Core is prone to a security feature bypass vulnerability." );
...
vers = infos["version"];
path = infos["location"];
if( IsMatchRegexp( vers, "^2\\.1" ) && version_is_less( version: vers, test_version: "2.1.22" ) ){
	fix = "2.1.22";
}
else {
	if(IsMatchRegexp( vers, "^3\\.1" ) && version_is_less( version: vers, test_version: "3.1.8" )){
		fix = "3.1.8";
	}
}
if(fix){
