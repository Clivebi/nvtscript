...
if(version_in_range( version: fileVer, test_version: "10.0.19041.0", test_version2: "10.0.19041.387" )){
	report = report_fixed_ver( file_checked: dllPath + "\\Gdiplus.dll", file_version: fileVer, vulnerable_range: "10.0.19041.0 - 10.0.19041.387" );
