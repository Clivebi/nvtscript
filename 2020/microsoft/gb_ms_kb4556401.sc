...
for key in key_list {
				...
				for item in registry_enum_keys( key: key ) {
					...
					if(dllVer){
						if( version_in_range( version: dllVer, test_version: "3.0", test_version2: "3.0.4506.8840" ) ){
							...
							if( version_in_range( version: dllVer, test_version: "4.0.30319.30000", test_version2: "4.0.30319.36626" ) ){
								vulnerable_range = "4.0.30319.30000 - 4.0.30319.36626";
								break;
							}
							else {
								if( version_in_range( version: dllVer, test_version: "4.6", test_version2: "4.7.3619" ) ){
	...
	if(vulnerable_range){
		report = report_fixed_ver( file_checked: dotPath + "System.identitymodel.dll", file_version: dllVer, vulnerable_range: vulnerable_range );
