...
if(version_is_less( version: dllVer, test_version: "6.2.9200.23063" )){
	report = report_fixed_ver( file_checked: sysPath + "\\Win32k.sys", file_version: dllVer, vulnerable_range: "Less than Win32k.sys" );
