...
if( IsMatchRegexp( version, "^9\\.(9|10|11)\\.[0-9]+s[0-9]" ) ){
	if(version_in_range( version: version, test_version: "9.9.3s1", test_version2: "9.11.18s1" )){
		report = report_fixed_ver( installed_version: version, fixed_version: "9.11.19-S1", install_path: location );
	...
	if(version_in_range( version: version, test_version: "9.0.0", test_version2: "9.11.18" )){
		report = report_fixed_ver( installed_version: version, fixed_version: "9.11.19", install_path: location );
		security_message( port: port, data: report, proto: proto );
		exit( 0 );
	}
	if(version_in_range( version: version, test_version: "9.12.0", test_version2: "9.12.4p2" )){
		report = report_fixed_ver( installed_version: version, fixed_version: "9.14.12", install_path: location );
		security_message( port: port, data: report, proto: proto );
		exit( 0 );
	}
	if(IsMatchRegexp( version, "^9\\.13\\." )){
		report = report_fixed_ver( installed_version: version, fixed_version: "9.14.12", install_path: location );
		security_message( port: port, data: report, proto: proto );
		exit( 0 );
	}
	...
	if(IsMatchRegexp( version, "^9\\.15\\." )){
		report = report_fixed_ver( installed_version: version, fixed_version: "9.16.3", install_path: location );
		security_message( port: port, data: report, proto: proto );
		exit( 0 );
	}
