...
if( version_in_range( version: version, test_version: "1.5.6", test_version2: "1.6.0" ) ){
	report = report_fixed_ver( installed_version: version, fixed_version: "1.6.1 / 1.7.4", install_path: location );
	security_message( port: port, data: report );
	exit( 0 );
}
else {
	if(version_in_range( version: version, test_version: "1.7.0", test_version2: "1.7.3" )){
