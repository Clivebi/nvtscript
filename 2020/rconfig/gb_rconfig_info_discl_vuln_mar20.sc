...
if(description){
	...
	script_tag( name: "severity_date", value: "2020-03-25 18:20:00 +0000 (Wed, 25 Mar 2020)" );
...
if(ContainsString( res, "defaultNodeUsername" ) && ContainsString( res, "defaultNodePassword" )){
