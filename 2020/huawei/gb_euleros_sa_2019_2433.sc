if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2019-2433" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'expat' package(s) announced via the EulerOS-SA-2019-2433 advisory." );
