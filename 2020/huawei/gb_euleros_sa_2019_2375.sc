if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2019-2375" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'exiv2' package(s) announced via the EulerOS-SA-2019-2375 advisory." );
...
An Invalid memory address dereference was ... [Please see the references for more information on the vulnerabilities]" );
