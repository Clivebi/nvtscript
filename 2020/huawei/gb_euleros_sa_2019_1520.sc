if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2019-1520" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'kernel' package(s) announced via the EulerOS-SA-2019-1520 advisory." );
...
The ip6_route_add function in net/ipv6/route.c in the Linux kernel through 3.13.6 does not properly count the addition of routes, which allows remote attackers to cause a denial of service (memory consumption) ... [Please see the references for more information on the vulnerabilities]" );
