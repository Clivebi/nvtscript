if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2019-2160" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'ImageMagick' package(s) announced via the EulerOS-SA-2019-2160 advisory." );
...
In ImageMagick 7.0.8-3 Q16, ReadDIBImage and WriteDIBImage in coders/dib.c allow ... [Please see the references for more information on the vulnerabilities]" );
