if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2020-1390" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'ImageMagick' package(s) announced via the EulerOS-SA-2020-1390 advisory." );
...
Buffer ... [Please see the references for more information on the vulnerabilities]" );
