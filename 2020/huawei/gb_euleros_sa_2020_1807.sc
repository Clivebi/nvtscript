if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2020-1807" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'kernel' package(s) announced via the EulerOS-SA-2020-1807 advisory." );
...
go7007_snd_init in drivers/media/usb/go7007/snd-go7007.c in the Linux kernel ... [Please see the references for more information on the vulnerabilities]" );
