if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2020-1186" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'kernel' package(s) announced via the EulerOS-SA-2020-1186 advisory." );
...
An issue was discovered in the Linux kernel before 5.0.4. There is a use-after-free upon attempted read access to /proc/ioports after the ipmi_si module is ... [Please see the references for more information on the vulnerabilities]" );
