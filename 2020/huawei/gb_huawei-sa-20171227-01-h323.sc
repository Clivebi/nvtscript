												...
												if( cpe == "cpe:/o:huawei:ar510_firmware" ){
													...
													if( cpe == "cpe:/o:huawei:dp300_firmware" ){
														...
														if( cpe == "cpe:/o:huawei:ips_module_firmware" ){
															if(IsMatchRegexp( version, "^V100R001C10SPC200" ) || IsMatchRegexp( version, "^V100R001C20" ) || IsMatchRegexp( version, "^V100R001C30" ) || IsMatchRegexp( version, "^V500R001C00" ) || IsMatchRegexp( version, "^V500R001C20" ) || IsMatchRegexp( version, "^V500R001C30" ) || IsMatchRegexp( version, "^V500R001C50" )){
															...
															if( cpe == "cpe:/o:huawei:ngfw_module_firmware" ){
																if(IsMatchRegexp( version, "^V100R001C10SPC200" ) || IsMatchRegexp( version, "^V100R001C20" ) || IsMatchRegexp( version, "^V100R001C30" ) || IsMatchRegexp( version, "^V500R001C00" ) || IsMatchRegexp( version, "^V500R001C20" ) || IsMatchRegexp( version, "^V500R002C00" ) || IsMatchRegexp( version, "^V500R002C10" )){
																												...
																												if( cpe == "cpe:/o:huawei:usg6300_firmware" ){
																													...
																													if( cpe == "cpe:/o:huawei:usg6500_firmware" ){
																														...
																														if( cpe == "cpe:/o:huawei:usg6600_firmware" ){
																															if(IsMatchRegexp( version, "^V100R001C00SPC200" ) || IsMatchRegexp( version, "^V100R001C10" ) || IsMatchRegexp( version, "^V100R001C20" ) || IsMatchRegexp( version, "^V100R001C30" ) || IsMatchRegexp( version, "^V500R001C00" ) || IsMatchRegexp( version, "^V500R001C20" ) || IsMatchRegexp( version, "^V500R001C30" ) || IsMatchRegexp( version, "^V500R001C50" ) || IsMatchRegexp( version, "^V500R001C60" )){
																																if(!patch || version_is_less( version: patch, test_version: "V500R001C60SPC500" )){
																																	report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V500R001C60SPC500" );
																																	security_message( port: 0, data: report );
																																	exit( 0 );
																																					...
																																					if( cpe == "cpe:/o:huawei:usg6000v_firmware" ){
																																						...
																																						if( cpe == "cpe:/o:huawei:usg9500_firmware" ){
																																							...
																																							if( cpe == "cpe:/o:huawei:usg9520_firmware" ){
																																								if(IsMatchRegexp( version, "^V300R001C01" ) || IsMatchRegexp( version, "^V300R001C20" )){
																																									if(!patch || version_is_less( version: patch, test_version: "V500R001C60SPC500" )){
																																										report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V500R001C60SPC500" );
																																										security_message( port: 0, data: report );
																																										exit( 0 );
																																								...
																																								if( cpe == "cpe:/o:huawei:usg9560_firmware" ){
																																									...
																																									if( cpe == "cpe:/o:huawei:usg9580_firmware" ){
																																										if(IsMatchRegexp( version, "^V300R001C01" ) || IsMatchRegexp( version, "^V300R001C20" )){
																																											if(!patch || version_is_less( version: patch, test_version: "V500R001C60SPC500" )){
																																												report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V500R001C60SPC500" );
																																												security_message( port: 0, data: report );
																																										...
																																										if( cpe == "cpe:/o:huawei:vp9660_firmware" ){
																																											if(IsMatchRegexp( version, "^V500R002C00" ) || IsMatchRegexp( version, "^V500R002C10" )){
																																												if(!patch || version_is_less( version: patch, test_version: "V500R001C60SPC500" )){
																																													report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V500R001C60SPC500" );
																																													security_message( port: 0, data: report );
																																													exit( 0 );
																																											...
																																											if( cpe == "cpe:/o:huawei:viewpoint_8660_firmware" ){
																																												if(IsMatchRegexp( version, "^V100R008C03" )){
																																												...
																																												if(cpe == "cpe:/o:huawei:viewpoint_9030_firmware"){
																																													if(IsMatchRegexp( version, "^V100R011C02" )){
