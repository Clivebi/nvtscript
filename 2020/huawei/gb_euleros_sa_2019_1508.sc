if(description){
	...
	script_tag( name: "severity_date", value: "2020-08-03 16:24:00 +0000 (Mon, 03 Aug 2020)" );
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2019-1508" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'kernel' package(s) announced via the EulerOS-SA-2019-1508 advisory." );
...
An out-of-bounds flaw was found in the kernel, where the sco_sock_bind() function (bluetooth/sco) did not check ... [Please see the references for more information on the vulnerabilities]" );
