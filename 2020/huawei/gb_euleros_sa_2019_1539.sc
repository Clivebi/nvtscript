if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2019-1539" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'kernel' package(s) announced via the EulerOS-SA-2019-1539 advisory." );
...
A flaw was found where the kernel truncated the value used to indicate the size of a buffer which it would later become zero using an untruncated value. This can corrupt memory outside of ... [Please see the references for more information on the vulnerabilities]" );
