...
if( cpe == "cpe:/o:huawei:dbs3900_tdd_lte_firmware" ){
	...
	if( cpe == "cpe:/o:huawei:dp300_firmware" ){
		...
		if( cpe == "cpe:/o:huawei:ips_module_firmware" ){
			if(IsMatchRegexp( version, "^V500R001C00" ) || IsMatchRegexp( version, "^V500R001C30SPC100" )){
			...
			if( cpe == "cpe:/o:huawei:ngfw_module_firmware" ){
				if(IsMatchRegexp( version, "^V500R001C00" ) || IsMatchRegexp( version, "^V500R002C00SPC100" )){
					if(!patch || version_is_less( version: patch, test_version: "V500R001C60SPC200" )){
						report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V500R001C60SPC200" );
						security_message( port: 0, data: report );
						exit( 0 );
							...
							if( cpe == "cpe:/o:huawei:s12700_firmware" ){
								...
								if( cpe == "cpe:/o:huawei:s1700_firmware" ){
									...
									if( cpe == "cpe:/o:huawei:s2700_firmware" ){
										if(IsMatchRegexp( version, "^V200R006C10" ) || IsMatchRegexp( version, "^V200R007C00" ) || IsMatchRegexp( version, "^V200R008C00" ) || IsMatchRegexp( version, "^V200R009C00" ) || IsMatchRegexp( version, "^V200R010C00" )){
											if(!patch || version_is_less( version: patch, test_version: "V200R011C10" )){
												report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V200R011C10" );
												security_message( port: 0, data: report );
												exit( 0 );
										...
										if( cpe == "cpe:/o:huawei:s5700_firmware" ){
											if(IsMatchRegexp( version, "^V200R006C00SPC100" ) || IsMatchRegexp( version, "^V200R007C00" ) || IsMatchRegexp( version, "^V200R008C00" ) || IsMatchRegexp( version, "^V200R009C00" ) || IsMatchRegexp( version, "^V200R010C00" )){
												if(!patch || version_is_less( version: patch, test_version: "V200R011C10" )){
													report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V200R011C10" );
													security_message( port: 0, data: report );
													exit( 0 );
											...
											if( cpe == "cpe:/o:huawei:s6700_firmware" ){
												...
												if( cpe == "cpe:/o:huawei:s7700_firmware" ){
													if(IsMatchRegexp( version, "^V200R007C00" ) || IsMatchRegexp( version, "^V200R008C00" ) || IsMatchRegexp( version, "^V200R009C00" ) || IsMatchRegexp( version, "^V200R010C00" )){
														if(!patch || version_is_less( version: patch, test_version: "V200R011C10" )){
															report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V200R011C10" );
															security_message( port: 0, data: report );
															exit( 0 );
															...
															if( cpe == "cpe:/o:huawei:usg6500_firmware" ){
																...
																if( cpe == "cpe:/o:huawei:usg6600_firmware" ){
																	...
																	if( cpe == "cpe:/o:huawei:te30_firmware" ){
																		if(IsMatchRegexp( version, "^V100R001C02SPC100" ) || IsMatchRegexp( version, "^V100R001C10" ) || IsMatchRegexp( version, "^V500R002C00SPC200" ) || IsMatchRegexp( version, "^V600R006C00" )){
																			if(!patch || version_is_less( version: patch, test_version: "V600R006C00SPC400" )){
																				report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V600R006C00SPC400" );
																				security_message( port: 0, data: report );
																				exit( 0 );
																						...
																						if( cpe == "cpe:/o:huawei:tp3206_firmware" ){
																							...
																							if( cpe == "cpe:/o:huawei:usg9500_firmware" ){
																								...
																								if(cpe == "cpe:/o:huawei:viewpoint_9030_firmware"){
																									if(IsMatchRegexp( version, "^V100R011C02SPC100" ) || IsMatchRegexp( version, "^V100R011C03SPC100" )){
