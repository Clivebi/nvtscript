...
if( cpe == "cpe:/o:huawei:ar120-s_firmware" ){
	if(IsMatchRegexp( version, "^V200R005C32" )){
							...
							if( cpe == "cpe:/o:huawei:ar200-s_firmware" ){
								...
								if( cpe == "cpe:/o:huawei:ar2200-s_firmware" ){
									...
									if( cpe == "cpe:/o:huawei:ar3200_firmware" ){
										if(IsMatchRegexp( version, "^V200R005C32" ) || IsMatchRegexp( version, "^V200R007C00" )){
											if(!patch || version_is_less( version: patch, test_version: "V200R007C00SPC900" )){
												report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V200R007C00SPC900" );
												security_message( port: 0, data: report );
												exit( 0 );
										...
										if( cpe == "cpe:/o:huawei:ar510_firmware" ){
											...
											if( cpe == "cpe:/o:huawei:cloudengine_12800_firmware" ){
												if(IsMatchRegexp( version, "^V100R003C00HP0002" ) || IsMatchRegexp( version, "^V100R003C00HP0003" ) || IsMatchRegexp( version, "^V100R003C00SPC501" ) || IsMatchRegexp( version, "^V100R003C10" ) || IsMatchRegexp( version, "^V100R003C10B052" ) || IsMatchRegexp( version, "^V100R003C10B058" ) || IsMatchRegexp( version, "^V100R003C10SPC100" ) || IsMatchRegexp( version, "^V100R005C00" ) || IsMatchRegexp( version, "^V100R005C10" ) || IsMatchRegexp( version, "^V100R006C00" )){
												...
												if( cpe == "cpe:/o:huawei:netengine16ex_firmware" ){
													...
													if( cpe == "cpe:/o:huawei:s12700_firmware" ){
														if(IsMatchRegexp( version, "^V200R007C00" ) || IsMatchRegexp( version, "^V200R007C01" ) || IsMatchRegexp( version, "^V200R008C00" )){
														...
														if( cpe == "cpe:/o:huawei:s2700_firmware" ){
															if(IsMatchRegexp( version, "^V200R006C10" ) || IsMatchRegexp( version, "^V200R007C00" ) || IsMatchRegexp( version, "^V200R008C00" )){
																if(!patch || version_is_less( version: patch, test_version: "V2R9C00" )){
																	report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V2R9C00" );
																	security_message( port: 0, data: report );
																	exit( 0 );
