if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2017-1245" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'kernel' package(s) announced via the EulerOS-SA-2017-1245 advisory." );
...
The prepare_vmcs02 function in ... [Please see the references for more information on the vulnerabilities]" );
