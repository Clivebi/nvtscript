if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2019-1484" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'kernel' package(s) announced via the EulerOS-SA-2019-1484 advisory." );
...
It was found that the x86 ISA (Instruction Set Architecture) is prone to a denial of service attack inside a virtualized environment in the form of an infinite loop in the microcode due to the way (sequential) delivering of benign ... [Please see the references for more information on the vulnerabilities]" );
