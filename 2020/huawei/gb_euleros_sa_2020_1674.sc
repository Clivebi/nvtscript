if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2020-1674" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'kernel' package(s) announced via the EulerOS-SA-2020-1674 advisory." );
...
Linux Kernel version 3.18 to 4.16 incorrectly handles an SG_IO ... [Please see the references for more information on the vulnerabilities]" );
