if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2017-1167" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'freeradius' package(s) announced via the EulerOS-SA-2017-1167 advisory." );
