if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2018-1059" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'java-1.7.0-openjdk' package(s) announced via the EulerOS-SA-2018-1059 advisory." );
...
It was discovered that multiple classes in the Libraries, AWT, and JNDI components of OpenJDK did not sufficiently validate input when creating object instances from the ... [Please see the references for more information on the vulnerabilities]" );
