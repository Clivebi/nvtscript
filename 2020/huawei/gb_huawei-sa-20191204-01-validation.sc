...
if( cpe == "cpe:/o:huawei:ar120-s_firmware" ){
	if(IsMatchRegexp( version, "^V200R005C20" ) || IsMatchRegexp( version, "^V200R006C10" ) || IsMatchRegexp( version, "^V200R007C00" ) || IsMatchRegexp( version, "^V200R008C50" )){
	...
	if( cpe == "cpe:/o:huawei:ar1200_firmware" ){
		if(IsMatchRegexp( version, "^V200R005C00" ) || IsMatchRegexp( version, "^V200R006C10" ) || IsMatchRegexp( version, "^V200R007C00" ) || IsMatchRegexp( version, "^V200R008C50" )){
			if(!patch || version_is_less( version: patch, test_version: "V200R009C00SPC500" )){
				report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V200R009C00SPC500" );
				security_message( port: 0, data: report );
				exit( 0 );
									...
									if( cpe == "cpe:/o:huawei:ar2200-s_firmware" ){
										...
										if( cpe == "cpe:/o:huawei:ar3200_firmware" ){
											...
											if( cpe == "cpe:/o:huawei:ar3600_firmware" ){
												if(IsMatchRegexp( version, "^V200R006C10" ) || IsMatchRegexp( version, "^V200R007C00" ) || IsMatchRegexp( version, "^V200R008C50" )){
													if(!patch || version_is_less( version: patch, test_version: "V200R009C00SPC500" )){
														report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V200R009C00SPC500" );
														security_message( port: 0, data: report );
														exit( 0 );
												...
												if( cpe == "cpe:/o:huawei:cloudengine_12800_firmware" ){
													if(IsMatchRegexp( version, "^V200R002C10" ) || IsMatchRegexp( version, "^V200R002C20" )){
													...
													if( cpe == "cpe:/o:huawei:ips_module_firmware" ){
														if(IsMatchRegexp( version, "^V500R001C30SPC100" ) || IsMatchRegexp( version, "^V500R001C30SPC100PWE" ) || IsMatchRegexp( version, "^V500R001C30SPC200" )){
																...
																if( cpe == "cpe:/o:huawei:nip6600_firmware" ){
																	...
																	if( cpe == "cpe:/o:huawei:netengine16ex_firmware" ){
																		...
																		if( cpe == "cpe:/o:huawei:s6700_firmware" ){
																			if(IsMatchRegexp( version, "^V200R008C00" ) || IsMatchRegexp( version, "^V200R010C00SPC300" ) || IsMatchRegexp( version, "^V200R010C00SPC600" ) || IsMatchRegexp( version, "^V200R011C00SPC200" )){
