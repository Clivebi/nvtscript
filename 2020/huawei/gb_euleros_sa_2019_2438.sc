if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2019-2438" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'php' package(s) announced via the EulerOS-SA-2019-2438 advisory." );
...
In PHP before 5.6.32, 7.x before ... [Please see the references for more information on the vulnerabilities]" );
