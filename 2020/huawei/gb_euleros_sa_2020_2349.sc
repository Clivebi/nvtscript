if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2020-2349" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'ImageMagick' package(s) announced via the EulerOS-SA-2020-2349 advisory." );
...
ImageMagick 7.0.8-50 Q16 has a stack-based buffer overflow at ... [Please see the references for more information on the vulnerabilities]" );
