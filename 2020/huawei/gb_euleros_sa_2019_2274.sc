if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2019-2274" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'kernel' package(s) announced via the EulerOS-SA-2019-2274 advisory." );
...
Systems with microprocessors utilizing speculative ... [Please see the references for more information on the vulnerabilities]" );
