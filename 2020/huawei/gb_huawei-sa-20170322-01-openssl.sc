...
if( cpe == "cpe:/o:huawei:ac6005_firmware" ){
	...
	if( cpe == "cpe:/o:huawei:ac6605_firmware" ){
		if(IsMatchRegexp( version, "^V200R005C00" ) || IsMatchRegexp( version, "^V200R005C10" )){
			if(!patch || version_is_less( version: patch, test_version: "V2R7C10" )){
				report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V2R7C10" );
				security_message( port: 0, data: report );
				exit( 0 );
		...
		if( cpe == "cpe:/o:huawei:ap5010sn-gn_firmware" ){
			...
			if( cpe == "cpe:/o:huawei:ap5030dn_firmware" ){
				...
				if( cpe == "cpe:/o:huawei:ap5130dn_firmware" ){
					if(IsMatchRegexp( version, "^V200R005C10" )){
						if(!patch || version_is_less( version: patch, test_version: "V2R7C10" )){
							report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V2R7C10" );
							security_message( port: 0, data: report );
					...
					if( cpe == "cpe:/o:huawei:ap6010sn-gn_firmware" ){
						if(IsMatchRegexp( version, "^V200R005C10" )){
							if(!patch || version_is_less( version: patch, test_version: "V2R7C10" )){
								report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V2R7C10" );
								security_message( port: 0, data: report );
						...
						if( cpe == "cpe:/o:huawei:ap6310sn-gn_firmware" ){
							if(IsMatchRegexp( version, "^V200R005C10" )){
								if(!patch || version_is_less( version: patch, test_version: "V2R7C10" )){
									report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V2R7C10" );
									security_message( port: 0, data: report );
							...
							if( cpe == "cpe:/o:huawei:ap6510dn-agn_firmware" ){
								if(IsMatchRegexp( version, "^V200R005C10" )){
									if(!patch || version_is_less( version: patch, test_version: "V2R7C10" )){
										report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V2R7C10" );
										security_message( port: 0, data: report );
								...
								if( cpe == "cpe:/o:huawei:ap6610dn-agn_firmware" ){
									if(IsMatchRegexp( version, "^V200R005C10" )){
										if(!patch || version_is_less( version: patch, test_version: "V2R7C10" )){
											report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V2R7C10" );
											security_message( port: 0, data: report );
									...
									if( cpe == "cpe:/o:huawei:ap7030de_firmware" ){
										if(IsMatchRegexp( version, "^V200R005C10" ) || IsMatchRegexp( version, "^V200R005C20" )){
											if(!patch || version_is_less( version: patch, test_version: "V2R7C10" )){
												report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V2R7C10" );
												security_message( port: 0, data: report );
												exit( 0 );
										...
										if( cpe == "cpe:/o:huawei:ap7110dn-agn_firmware" ){
											if(IsMatchRegexp( version, "^V200R005C10" )){
												if(!patch || version_is_less( version: patch, test_version: "V2R7C10" )){
													report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V2R7C10" );
													security_message( port: 0, data: report );
											...
											if( cpe == "cpe:/o:huawei:ap7110sn-gn_firmware" ){
												if(IsMatchRegexp( version, "^V200R005C10" )){
													if(!patch || version_is_less( version: patch, test_version: "V2R7C10" )){
														report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V2R7C10" );
														security_message( port: 0, data: report );
												...
												if( cpe == "cpe:/o:huawei:ap8030dn_firmware" ){
													if(IsMatchRegexp( version, "^V200R005C10" )){
														if(!patch || version_is_less( version: patch, test_version: "V2R7C10" )){
															report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V2R7C10" );
															security_message( port: 0, data: report );
													...
													if( cpe == "cpe:/o:huawei:ap8130dn_firmware" ){
														if(IsMatchRegexp( version, "^V200R005C10" )){
															if(!patch || version_is_less( version: patch, test_version: "V2R7C10" )){
																report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V2R7C10" );
																security_message( port: 0, data: report );
														...
														if( cpe == "cpe:/o:huawei:ap9330dn_firmware" ){
															if(IsMatchRegexp( version, "^V200R005C20" )){
																if(!patch || version_is_less( version: patch, test_version: "V2R7C10" )){
																	report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V2R7C10" );
																	security_message( port: 0, data: report );
																	exit( 0 );
															...
															if( cpe == "cpe:/o:huawei:ar3200_firmware" ){
																if(IsMatchRegexp( version, "^V200R008C10" ) || IsMatchRegexp( version, "^V200R008C20" )){
																...
																if( cpe == "cpe:/o:huawei:dp300_firmware" ){
																	...
																	if( cpe == "cpe:/o:huawei:e6000_firmware" ){
																		if(IsMatchRegexp( version, "^V100R002C03" )){
																		...
																		if( cpe == "cpe:/o:huawei:fusionmanager_firmware" ){
																			if(IsMatchRegexp( version, "^V100R005C00" )){
																			...
																			if( cpe == "cpe:/o:huawei:ipc6112-d_firmware" ){
																				...
																				if( cpe == "cpe:/o:huawei:ipc6611-z30-i_firmware" ){
																					if(IsMatchRegexp( version, "^V100R001C00" )){
																					...
																					if( cpe == "cpe:/o:huawei:oceanstor_9000_firmware" ){
																						if(IsMatchRegexp( version, "^V100R001C01" ) || IsMatchRegexp( version, "^V100R001C30" ) || IsMatchRegexp( version, "^V300R005C00" )){
																						...
																						if( cpe == "cpe:/o:huawei:oceanstor_backup_firmware" ){
																							...
																							if( cpe == "cpe:/o:huawei:oceanstor_uds_firmware" ){
																								if(IsMatchRegexp( version, "^V100R002C00LVDF01" ) || IsMatchRegexp( version, "^V1R2C01LHWS01RC3" ) || IsMatchRegexp( version, "^V1R2C01LHWS01RC6" )){
																								...
																								if( cpe == "cpe:/o:huawei:rh5885_v2_firmware" ){
																									if(IsMatchRegexp( version, "^V100R001C01" ) || IsMatchRegexp( version, "^V100R001C02" )){
																									...
																									if( cpe == "cpe:/o:huawei:rse6500_firmware" ){
																										...
																										if( cpe == "cpe:/o:huawei:smsc_firmware" ){
																											if(IsMatchRegexp( version, "^V300R002C90LG0005" )){
																											...
																											if( cpe == "cpe:/o:huawei:semg9811_firmware" ){
																												if(IsMatchRegexp( version, "^V300R001C01" )){
																												...
																												if( cpe == "cpe:/o:huawei:te30_firmware" ){
																													if(IsMatchRegexp( version, "^V100R001C02B053SP02" ) || IsMatchRegexp( version, "^V100R001C02B053SP03" ) || IsMatchRegexp( version, "^V100R001C02SPC100" ) || IsMatchRegexp( version, "^V100R001C02SPC100B011" ) || IsMatchRegexp( version, "^V100R001C02SPC100B012" ) || IsMatchRegexp( version, "^V100R001C02SPC100B013" ) || IsMatchRegexp( version, "^V100R001C02SPC100B014" ) || IsMatchRegexp( version, "^V100R001C02SPC100B015" ) || IsMatchRegexp( version, "^V100R001C02SPC100B016" ) || IsMatchRegexp( version, "^V100R001C02SPC100T" ) || IsMatchRegexp( version, "^V100R001C02SPC100TB010" ) || IsMatchRegexp( version, "^V100R001C02SPC101T" ) || IsMatchRegexp( version, "^V100R001C02SPC101TB010" ) || IsMatchRegexp( version, "^V100R001C02SPC102T" ) || IsMatchRegexp( version, "^V100R001C02SPC102TB010" ) || IsMatchRegexp( version, "^V100R001C02SPC103T" ) || IsMatchRegexp( version, "^V100R001C02SPC103TB010" ) || IsMatchRegexp( version, "^V100R001C02SPC200" ) || IsMatchRegexp( version, "^V100R001C02SPC200B010" ) || IsMatchRegexp( version, "^V100R001C02SPC200B011" ) || IsMatchRegexp( version, "^V100R001C02SPC200T" ) || IsMatchRegexp( version, "^V100R001C02SPC200TB010" ) || IsMatchRegexp( version, "^V100R001C02SPC201TB010" ) || IsMatchRegexp( version, "^V100R001C02SPC202T" ) || IsMatchRegexp( version, "^V100R001C02SPC202TB010" ) || IsMatchRegexp( version, "^V100R001C02SPC203T" ) || IsMatchRegexp( version, "^V100R001C02SPC300B010" ) || IsMatchRegexp( version, "^V100R001C10" ) || IsMatchRegexp( version, "^V100R001C10SPC100" ) || IsMatchRegexp( version, "^V100R001C10SPC200B010" ) || IsMatchRegexp( version, "^V100R001C10SPC300" ) || IsMatchRegexp( version, "^V100R001C10SPC500" ) || IsMatchRegexp( version, "^V100R001C10SPC600" ) || IsMatchRegexp( version, "^V100R001C10SPC700B010" ) || IsMatchRegexp( version, "^V100R001C10SPC800" ) || IsMatchRegexp( version, "^V500R002C00SPC200" ) || IsMatchRegexp( version, "^V500R002C00SPC500" ) || IsMatchRegexp( version, "^V500R002C00SPC600" ) || IsMatchRegexp( version, "^V500R002C00SPC700" )){
																													...
																													if( cpe == "cpe:/o:huawei:te40_firmware" ){
																														if(IsMatchRegexp( version, "^V500R002C00SPC600" ) || IsMatchRegexp( version, "^V500R002C00SPC700" )){
																														...
																														if( cpe == "cpe:/o:huawei:te60_firmware" ){
																															if(IsMatchRegexp( version, "^V100R001C10" ) || IsMatchRegexp( version, "^V500R002C00" )){
																															...
																															if( cpe == "cpe:/o:huawei:usg9520_firmware" ){
																																if(IsMatchRegexp( version, "^V200R001C01" ) || IsMatchRegexp( version, "^V300R001C01" ) || IsMatchRegexp( version, "^V300R001C20" )){
																																	if(!patch || version_is_less( version: patch, test_version: "V300R001C01SPHa02" )){
																																		report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V300R001C01SPHa02" );
																																		security_message( port: 0, data: report );
																																		exit( 0 );
																																...
																																if( cpe == "cpe:/o:huawei:usg9560_firmware" ){
																																	...
																																	if( cpe == "cpe:/o:huawei:vcm_firmware" ){
																																		if(IsMatchRegexp( version, "^V100R001C10" ) || IsMatchRegexp( version, "^V100R001C10SPC001" ) || IsMatchRegexp( version, "^V100R001C10SPC002" ) || IsMatchRegexp( version, "^V100R001C10SPC003" ) || IsMatchRegexp( version, "^V100R001C10SPC004" ) || IsMatchRegexp( version, "^V100R001C10SPC005" ) || IsMatchRegexp( version, "^V100R001C10SPC006" ) || IsMatchRegexp( version, "^V100R001C20" )){
																																		...
																																		if( cpe == "cpe:/o:huawei:viewpoint_9030_firmware" ){
																																			if(IsMatchRegexp( version, "^V100R011C02SPC100" ) || IsMatchRegexp( version, "^V100R011C02SPC100B010" ) || IsMatchRegexp( version, "^V100R011C03B012SP15" ) || IsMatchRegexp( version, "^V100R011C03B012SP16" ) || IsMatchRegexp( version, "^V100R011C03B015SP03" ) || IsMatchRegexp( version, "^V100R011C03LGWL01SPC100" ) || IsMatchRegexp( version, "^V100R011C03LGWL01SPC100B012" ) || IsMatchRegexp( version, "^V100R011C03LGWL02SPC100T" ) || IsMatchRegexp( version, "^V100R011C03SPC100" ) || IsMatchRegexp( version, "^V100R011C03SPC100B010" ) || IsMatchRegexp( version, "^V100R011C03SPC100B011" ) || IsMatchRegexp( version, "^V100R011C03SPC100B012" ) || IsMatchRegexp( version, "^V100R011C03SPC100T" ) || IsMatchRegexp( version, "^V100R011C03SPC200" ) || IsMatchRegexp( version, "^V100R011C03SPC200T" ) || IsMatchRegexp( version, "^V100R011C03SPC300" ) || IsMatchRegexp( version, "^V100R011C03SPC400" )){
																																			...
																																			if( cpe == "cpe:/o:huawei:eapp610_firmware" ){
																																				if(IsMatchRegexp( version, "^V100R003C00" )){
																																				...
																																				if( cpe == "cpe:/o:huawei:elog_firmware" ){
																																					if(IsMatchRegexp( version, "^V200R005C00SPC101" )){
																																					...
																																					if( cpe == "cpe:/o:huawei:espace_7910_firmware" ){
																																						if(IsMatchRegexp( version, "^V200R003C00" )){
																																						...
																																						if( cpe == "cpe:/o:huawei:espace_7950_firmware" ){
																																							if(IsMatchRegexp( version, "^V200R003C00SPCF00" ) || IsMatchRegexp( version, "^V200R003C30" )){
																																							...
																																							if( cpe == "cpe:/o:huawei:espace_8950_firmware" ){
																																								if(IsMatchRegexp( version, "^V200R003C00" )){
																																									if(!patch || version_is_less( version: patch, test_version: "V200R003C00SPCh00" )){
																																										report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V200R003C00SPCh00" );
																																										security_message( port: 0, data: report );
																																								...
																																								if( cpe == "cpe:/o:huawei:espace_iad_firmware" ){
																																									if(IsMatchRegexp( version, "^V300R002C01SPCB00" )){
																																									...
																																									if( cpe == "cpe:/o:huawei:espace_u1981_firmware" ){
																																										if(IsMatchRegexp( version, "^V200R003C30" )){
																																										...
																																										if( cpe == "cpe:/o:huawei:espace_usm_firmware" ){
																																											if(IsMatchRegexp( version, "^V100R001C10SPC105" ) || IsMatchRegexp( version, "^V300R001C00" )){
																																											...
																																											if( cpe == "cpe:/o:huawei:espace_vcn3000_firmware" ){
																																												if(IsMatchRegexp( version, "^V100R002C00SPC100" ) || IsMatchRegexp( version, "^V100R002C00SPC108" ) || IsMatchRegexp( version, "^V100R002C00SPC109" ) || IsMatchRegexp( version, "^V100R002C10B026" ) || IsMatchRegexp( version, "^V100R002C10SPC001" ) || IsMatchRegexp( version, "^V100R002C10SPC100" ) || IsMatchRegexp( version, "^V100R002C10SPC100T" ) || IsMatchRegexp( version, "^V100R002C10SPC101" ) || IsMatchRegexp( version, "^V100R002C10SPC101T" ) || IsMatchRegexp( version, "^V100R002C10SPC102" ) || IsMatchRegexp( version, "^V100R002C10SPC102T" ) || IsMatchRegexp( version, "^V100R002C10SPC102TB011" ) || IsMatchRegexp( version, "^V100R002C10SPC103" ) || IsMatchRegexp( version, "^V100R002C10SPC103T" ) || IsMatchRegexp( version, "^V100R002C10SPC105T" ) || IsMatchRegexp( version, "^V100R002C10SPC106" ) || IsMatchRegexp( version, "^V100R002C10SPC107" ) || IsMatchRegexp( version, "^V100R002C10SPC107_B1253000" ) || IsMatchRegexp( version, "^V100R002C10SPC108" ) || IsMatchRegexp( version, "^V100R002C20B022" ) || IsMatchRegexp( version, "^V100R002C20SPC001B012" ) || IsMatchRegexp( version, "^V100R002C20SPC001T" ) || IsMatchRegexp( version, "^V100R002C20SPC100" ) || IsMatchRegexp( version, "^V100R002C20SPC200" ) || IsMatchRegexp( version, "^V100R002C20SPC201" ) || IsMatchRegexp( version, "^V100R002C20SPC201T" ) || IsMatchRegexp( version, "^V100R002C20SPC201TB012" )){
																																													if(!patch || version_is_less( version: patch, test_version: "V100R002C50SPC100" )){
																																														report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V100R002C50SPC100" );
																																														security_message( port: 0, data: report );
																																														exit( 0 );
																																												...
																																												if(cpe == "cpe:/o:huawei:ibmc_firmware"){
																																													if(IsMatchRegexp( version, "^V100R002C10" ) || IsMatchRegexp( version, "^V100R002C30" ) || IsMatchRegexp( version, "^V200R002C20" )){
