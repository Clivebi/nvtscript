if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2019-1302" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'kernel' package(s) announced via the EulerOS-SA-2019-1302 advisory." );
...
A new software page cache side channel attack scenario was discovered in operating systems that implement the very common 'page cache' caching mechanism. A malicious ... [Please see the references for more information on the vulnerabilities]" );
