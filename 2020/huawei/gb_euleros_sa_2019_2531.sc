if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2019-2531" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'kernel' package(s) announced via the EulerOS-SA-2019-2531 advisory." );
...
The rtnl_fill_link_ifmap function in net/core/rtnetlink.c in the Linux kernel before 4.5.5 does not initialize a certain data structure, which allows local users to obtain sensitive information ... [Please see the references for more information on the vulnerabilities]" );
