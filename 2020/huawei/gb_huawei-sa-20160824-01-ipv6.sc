...
if(IsMatchRegexp( cpe, "^cpe:/o:huawei:ar" )){
	if(IsMatchRegexp( version, "^V200R005C00" ) || IsMatchRegexp( version, "^V200R006C00" ) || IsMatchRegexp( version, "^V200R006C10" ) || IsMatchRegexp( version, "^V200R007C00" )){
		report = report_fixed_ver( installed_version: version, fixed_version: "V200R007C00SPC900" );
		security_message( port: 0, data: report );
		exit( 0 );
	}
}
if(IsMatchRegexp( cpe, "^cpe:/o:huawei:cloudengine_(128|68)00" )){
	if(IsMatchRegexp( version, "^V100R001C00" ) || IsMatchRegexp( version, "^V100R001C01" ) || IsMatchRegexp( version, "^V100R002C00" ) || IsMatchRegexp( version, "^V100R003C00" ) || IsMatchRegexp( version, "^V100R003C10" ) || IsMatchRegexp( version, "^V100R005C00" ) || IsMatchRegexp( version, "^V100R005C10" ) || IsMatchRegexp( version, "^V100R006C00" )){
...
if(cpe == "cpe:/o:huawei:cloudengine_5800_firmware"){
	if(IsMatchRegexp( version, "^V100R001C00" ) || IsMatchRegexp( version, "^V100R001C01" ) || IsMatchRegexp( version, "^V100R002C00" ) || IsMatchRegexp( version, "^V100R003C00" ) || IsMatchRegexp( version, "^V100R003C10" ) || IsMatchRegexp( version, "^V100R006C00" )){
		report = report_fixed_ver( installed_version: version, fixed_version: "V200R001C00SPC700" );
		security_message( port: 0, data: report );
		exit( 0 );
	}
...
if(cpe == "cpe:/o:huawei:s12700_firmware"){
	if(IsMatchRegexp( version, "^V200R005C00" ) || IsMatchRegexp( version, "^V200R006C00" ) || IsMatchRegexp( version, "^V200R007C00" ) || IsMatchRegexp( version, "^V200R008C00" ) || IsMatchRegexp( version, "^V200R009C00" )){
		report = report_fixed_ver( installed_version: version, fixed_version: "V200R009C00SPC500" );
		security_message( port: 0, data: report );
		exit( 0 );
	}
}
if(IsMatchRegexp( cpe, "^cpe:/o:huawei:s(23|27|33|37)00_firmware" )){
	if(IsMatchRegexp( version, "^V100R006C05" )){
...
if(cpe == "^cpe:/o:huawei:s5300_firmware"){
	if(IsMatchRegexp( version, "^V200R002C00" ) || IsMatchRegexp( version, "^V200R005C00" )){
		report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V200R005C00SPC500", fixed_patch: "V200R005SPH012" );
		security_message( port: 0, data: report );
		exit( 0 );
	}
	if(IsMatchRegexp( version, "^V200R006C00" ) || IsMatchRegexp( version, "^V200R007C00" ) || IsMatchRegexp( version, "^V200R008C00" ) || IsMatchRegexp( version, "^V200R009C00" )){
		report = report_fixed_ver( installed_version: version, fixed_version: "V200R009C00SPC500" );
		security_message( port: 0, data: report );
		exit( 0 );
	}
}
if(IsMatchRegexp( cpe, "^cpe:/o:huawei:s5700_firmware" )){
	if(IsMatchRegexp( version, "^V200R002C00" ) || IsMatchRegexp( version, "^V200R003C00" ) || IsMatchRegexp( version, "^V200R005C00" )){
		report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V200R005C00SPC500", fixed_patch: "V200R005SPH012" );
		security_message( port: 0, data: report );
		exit( 0 );
	}
...
if(IsMatchRegexp( cpe, "^cpe:/o:huawei:s(63|67)00_firmware" )){
	if(IsMatchRegexp( version, "^V200R002C00" ) || IsMatchRegexp( version, "^V200R003C00" ) || IsMatchRegexp( version, "^V200R005C00" )){
		report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V200R005C00SPC500", fixed_patch: "V200R005SPH012" );
		security_message( port: 0, data: report );
		exit( 0 );
...
if(IsMatchRegexp( cpe, "^cpe:/o:huawei:s(77|93|97)00_firmware" )){
	if(IsMatchRegexp( version, "^V200R002C00" ) || IsMatchRegexp( version, "^V200R003C00" ) || IsMatchRegexp( version, "^V200R005C00" ) || IsMatchRegexp( version, "^V200R006C00" ) || IsMatchRegexp( version, "^V200R007C00" ) || IsMatchRegexp( version, "^V200R008C00" ) || IsMatchRegexp( version, "^V200R009C00" )){
