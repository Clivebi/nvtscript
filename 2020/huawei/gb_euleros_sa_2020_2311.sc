if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2020-2311" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'kernel' package(s) announced via the EulerOS-SA-2020-2311 advisory." );
...
A missing CAP_NET_RAW check in NFC socket creation in net
...
A flaw was found in the HDLC_PPP module of the Linux kernel in versions before 5.9-rc7. Memory corruption and a read overflow is caused by improper input validation in the ppp_cp_parse_cr function ... [Please see the references for more information on the vulnerabilities]" );
