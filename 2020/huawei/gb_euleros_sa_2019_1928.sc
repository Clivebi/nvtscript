if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2019-1928" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'php' package(s) announced via the EulerOS-SA-2019-1928 advisory." );
...
When PHP EXIF extension is parsing EXIF information from an ... [Please see the references for more information on the vulnerabilities]" );
