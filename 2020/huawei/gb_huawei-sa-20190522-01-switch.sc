...
if( cpe == "cpe:/o:huawei:s12700_firmware" ){
	if(IsMatchRegexp( version, "^V200R005C00" ) || IsMatchRegexp( version, "^V200R006C00" ) || IsMatchRegexp( version, "^V200R007C00" ) || IsMatchRegexp( version, "^V200R008C00" ) || IsMatchRegexp( version, "^V200R010C00" ) || IsMatchRegexp( version, "^V200R011C10" ) || IsMatchRegexp( version, "^V200R012C00" ) || IsMatchRegexp( version, "^V200R013C00" )){
	...
	if( cpe == "cpe:/o:huawei:s1700_firmware" ){
		if(IsMatchRegexp( version, "^V200R008C00" ) || IsMatchRegexp( version, "^V200R009C00" ) || IsMatchRegexp( version, "^V200R010C00" ) || IsMatchRegexp( version, "^V200R011C10" ) || IsMatchRegexp( version, "^V200R012C00" ) || IsMatchRegexp( version, "^V200R013C00" )){
		...
		if( cpe == "cpe:/o:huawei:s2300_firmware" ){
			if(IsMatchRegexp( version, "^V200R003C00" ) || IsMatchRegexp( version, "^V200R005C00" ) || IsMatchRegexp( version, "^V200R008C00" ) || IsMatchRegexp( version, "^V200R010C00" ) || IsMatchRegexp( version, "^V200R011C10" ) || IsMatchRegexp( version, "^V200R012C00" ) || IsMatchRegexp( version, "^V200R013C00" )){
			...
			if( cpe == "cpe:/o:huawei:s2700_firmware" ){
				...
				if( cpe == "cpe:/o:huawei:s5300_firmware" ){
					...
					if( cpe == "cpe:/o:huawei:s5700_firmware" ){
						if(IsMatchRegexp( version, "^V200R003C00" ) || IsMatchRegexp( version, "^V200R005C00" ) || IsMatchRegexp( version, "^V200R006C00" ) || IsMatchRegexp( version, "^V200R007C00" ) || IsMatchRegexp( version, "^V200R008C00" ) || IsMatchRegexp( version, "^V200R010C00" ) || IsMatchRegexp( version, "^V200R011C10" ) || IsMatchRegexp( version, "^V200R012C00" ) || IsMatchRegexp( version, "^V200R013C00" )){
						...
						if( cpe == "cpe:/o:huawei:s600-e_firmware" ){
							if(IsMatchRegexp( version, "^V200R008C00" ) || IsMatchRegexp( version, "^V200R010C00" ) || IsMatchRegexp( version, "^V200R011C10" ) || IsMatchRegexp( version, "^V200R012C00" ) || IsMatchRegexp( version, "^V200R013C00" )){
							...
							if( cpe == "cpe:/o:huawei:s6300_firmware" ){
								if(IsMatchRegexp( version, "^V200R003C00" ) || IsMatchRegexp( version, "^V200R005C00" ) || IsMatchRegexp( version, "^V200R007C00" ) || IsMatchRegexp( version, "^V200R008C00" ) || IsMatchRegexp( version, "^V200R010C00" ) || IsMatchRegexp( version, "^V200R011C10" ) || IsMatchRegexp( version, "^V200R012C00" ) || IsMatchRegexp( version, "^V200R013C00" )){
									if(!patch || version_is_less( version: patch, test_version: "V200R012SPH003" )){
										report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V200R012SPH003" );
										security_message( port: 0, data: report );
										exit( 0 );
								...
								if( cpe == "cpe:/o:huawei:s6700_firmware" ){
									...
									if( cpe == "cpe:/o:huawei:s7700_firmware" ){
										...
										if( cpe == "cpe:/o:huawei:s7900_firmware" ){
											if(IsMatchRegexp( version, "^V200R011C10" ) || IsMatchRegexp( version, "^V200R012C00" ) || IsMatchRegexp( version, "^V200R013C00" )){
												if(!patch || version_is_less( version: patch, test_version: "V200R013C00SPC500" )){
													report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V200R013C00SPC500" );
													security_message( port: 0, data: report );
													exit( 0 );
											...
											if( cpe == "cpe:/o:huawei:s9300_firmware" ){
												if(IsMatchRegexp( version, "^V200R003C00" ) || IsMatchRegexp( version, "^V200R008C00" ) || IsMatchRegexp( version, "^V200R008C10" ) || IsMatchRegexp( version, "^V200R010C00" ) || IsMatchRegexp( version, "^V200R011C10" ) || IsMatchRegexp( version, "^V200R012C00" ) || IsMatchRegexp( version, "^V200R013C00" )){
												...
												if( cpe == "cpe:/o:huawei:s9300x_firmware" ){
													if(IsMatchRegexp( version, "^V200R010C00" ) || IsMatchRegexp( version, "^V200R011C10" ) || IsMatchRegexp( version, "^V200R012C00" ) || IsMatchRegexp( version, "^V200R013C00" )){
														if(!patch || version_is_less( version: patch, test_version: "V200R012SPH003" )){
															report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V200R012SPH003" );
															security_message( port: 0, data: report );
															exit( 0 );
