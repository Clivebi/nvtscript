...
if( cpe == "cpe:/o:huawei:ips_module_firmware" ){
	...
	if( cpe == "cpe:/o:huawei:ngfw_module_firmware" ){
		...
		if( cpe == "cpe:/o:huawei:nip6300_firmware" ){
			if(IsMatchRegexp( version, "^V500R001C30SPC200" )){
				if(!patch || version_is_less( version: patch, test_version: "V500R005C00SPC200" )){
					report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V500R005C00SPC200" );
					security_message( port: 0, data: report );
					exit( 0 );
			...
			if( cpe == "cpe:/o:huawei:nip6600_firmware" ){
				...
				if( cpe == "cpe:/o:huawei:s5700_firmware" ){
					if(IsMatchRegexp( version, "^V200R005C00SPC500" ) || IsMatchRegexp( version, "^V200R005C02" ) || IsMatchRegexp( version, "^V200R005C03" ) || IsMatchRegexp( version, "^V200R006C00SPC100" ) || IsMatchRegexp( version, "^V200R006C00SPC300" ) || IsMatchRegexp( version, "^V200R006C00SPC500" ) || IsMatchRegexp( version, "^V200R007C00SPC100" ) || IsMatchRegexp( version, "^V200R007C00SPC500" ) || IsMatchRegexp( version, "^V200R008C00" )){
					...
					if( cpe == "cpe:/o:huawei:s6700_firmware" ){
						if(IsMatchRegexp( version, "^V200R005C00SPC500" ) || IsMatchRegexp( version, "^V200R005C01" ) || IsMatchRegexp( version, "^V200R005C02" ) || IsMatchRegexp( version, "^V200R008C00" )){
							if(!patch || version_is_less( version: patch, test_version: "V2R11C10" )){
								report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V2R11C10" );
								security_message( port: 0, data: report );
								exit( 0 );
