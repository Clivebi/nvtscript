if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2020-1806" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'ImageMagick' package(s) announced via the EulerOS-SA-2020-1806 advisory." );
...
ImageMagick 7.0.8-50 ... [Please see the references for more information on the vulnerabilities]" );
