...
if( cpe == "cpe:/o:huawei:ar1200_firmware" ){
	if(IsMatchRegexp( version, "^V200R007C00SPC600" ) || IsMatchRegexp( version, "^V200R008C20SPC800" ) || IsMatchRegexp( version, "^V200R008C50SPC500" ) || IsMatchRegexp( version, "^V200R009C00SPC500" ) || IsMatchRegexp( version, "^V200R010C00SPC200" )){
						...
						if( cpe == "cpe:/o:huawei:ar2200-s_firmware" ){
							...
							if( cpe == "cpe:/o:huawei:ar3200_firmware" ){
								...
								if( cpe == "cpe:/o:huawei:ar3600_firmware" ){
									if(IsMatchRegexp( version, "^V200R008C50SPC500" ) || IsMatchRegexp( version, "^V200R009C00SPC500" ) || IsMatchRegexp( version, "^V200R008C50" ) || IsMatchRegexp( version, "^V200R009C00" )){
									...
									if( cpe == "cpe:/o:huawei:srg1300_firmware" ){
										if(IsMatchRegexp( version, "^V200R007C00SPC600" ) || IsMatchRegexp( version, "^V200R008C50SPC500" ) || IsMatchRegexp( version, "^V200R009C00SPC500" ) || IsMatchRegexp( version, "^V200R010C00SPC200" )){
											if(!patch || version_is_less( version: patch, test_version: "V200R010SPH003" )){
												report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V200R010SPH003" );
												security_message( port: 0, data: report );
												exit( 0 );
