if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2020-2180" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'perl-DBI' package(s) announced via the EulerOS-SA-2020-2180 advisory." );
