...
if(cpe == "cpe:/o:huawei:s5700_firmware"){
	if(IsMatchRegexp( version, "^V200R006C00" ) || IsMatchRegexp( version, "^V200R007C00" )){
		report = report_fixed_ver( installed_version: version, fixed_version: "V200R009C00SPC500" );
		security_message( port: 0, data: report );
		exit( 0 );
	}
	if(IsMatchRegexp( version, "^V200R008C00" )){
		report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V200R008C00SPC500", fixed_patch: "V200R008SPH009" );
		security_message( port: 0, data: report );
		exit( 0 );
	}
}
