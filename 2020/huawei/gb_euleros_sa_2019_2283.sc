if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2019-2283" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'kernel' package(s) announced via the EulerOS-SA-2019-2283 advisory." );
...
base_sock_create in drivers/isdn/mISDN/socket.c in the AF_ISDN network module in the ... [Please see the references for more information on the vulnerabilities]" );
