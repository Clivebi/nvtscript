...
if( cpe == "cpe:/o:huawei:cloudengine_12800_firmware" ){
	if(IsMatchRegexp( version, "^V200R019C00SPC800" )){
	...
	if( cpe == "cpe:/o:huawei:cloudengine_16800_firmware" ){
		if(IsMatchRegexp( version, "^V200R005C20SPC800" )){
			if(!patch || version_is_less( version: patch, test_version: "V200R019C10SPC800" )){
				report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V200R019C10SPC800" );
				security_message( port: 0, data: report );
				exit( 0 );
		...
		if( cpe == "cpe:/o:huawei:cloudengine_5800_firmware" ){
			...
			if( cpe == "cpe:/o:huawei:cloudengine_6800_firmware" ){
				if(IsMatchRegexp( version, "^V200R005C20SPC800" ) || IsMatchRegexp( version, "^V200R019C00SPC800" )){
					if(!patch || version_is_less( version: patch, test_version: "V200R019C10SPC800" )){
						report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V200R019C10SPC800" );
						security_message( port: 0, data: report );
						exit( 0 );
