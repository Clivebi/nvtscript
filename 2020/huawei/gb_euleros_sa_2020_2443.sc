if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2020-2443" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'kernel' package(s) announced via the EulerOS-SA-2020-2443 advisory." );
...
A buffer over-read flaw was found in RH kernel versions before 5.0 in ... [Please see the references for more information on the vulnerabilities]" );
