if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2020-2222" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'kernel' package(s) announced via the EulerOS-SA-2020-2222 advisory." );
...
A flaw was found in the Linux kernel ext4 filesystem. An out-of-bound access is possible in the ext4_ext_drop_refs() function when operating on ... [Please see the references for more information on the vulnerabilities]" );
