if(description){
	...
	script_version( "2021-09-14T02:24:06+0000" );
	script_tag( name: "last_modification", value: "2021-09-14 02:24:06 +0000 (Tue, 14 Sep 2021)" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'gd' package(s) announced via the EulerOS-SA-2019-1647 advisory." );
...
Libgd version 2.2.5 contains a Double Free vulnerability in gdImageBmpPtr Function that can result in Remote Code Execution . This attack appear to be exploitable via Specially Crafted Jpeg Image can trigger double free. (CVE-2018-1000222)" );
