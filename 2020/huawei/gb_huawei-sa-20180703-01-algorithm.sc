if(description){
	...
	script_tag( name: "severity_date", value: "2018-10-12 13:37:00 +0000 (Fri, 12 Oct 2018)" );
...
if( cpe == "cpe:/o:huawei:cloudengine_12800_firmware" ){
	if(IsMatchRegexp( version, "^V100R003C00SPC600" ) || IsMatchRegexp( version, "^V100R003C10SPC100" ) || IsMatchRegexp( version, "^V100R005C00SPC300" ) || IsMatchRegexp( version, "^V100R005C10SPC200" ) || IsMatchRegexp( version, "^V100R006C00SPC600" ) || IsMatchRegexp( version, "^V200R001C00SPC700" ) || IsMatchRegexp( version, "^V200R002C50SPC800" )){
	...
	if( cpe == "cpe:/o:huawei:cloudengine_5800_firmware" ){
		...
		if( cpe == "cpe:/o:huawei:cloudengine_6800_firmware" ){
			if(IsMatchRegexp( version, "^V100R003C00SPC600" ) || IsMatchRegexp( version, "^V100R003C10SPC100" ) || IsMatchRegexp( version, "^V100R005C00SPC300" ) || IsMatchRegexp( version, "^V100R005C10SPC200" ) || IsMatchRegexp( version, "^V100R006C00SPC600" ) || IsMatchRegexp( version, "^V200R001C00SPC600" ) || IsMatchRegexp( version, "^V200R002C50SPC800" )){
				if(!patch || version_is_less( version: patch, test_version: "V200R003SPC810" )){
					report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V200R003SPC810" );
					security_message( port: 0, data: report );
					exit( 0 );
			...
			if( cpe == "cpe:/o:huawei:cloudengine_7800_firmware" ){
				...
				if( cpe == "cpe:/o:huawei:rse6500_firmware" ){
					...
					if( cpe == "cpe:/o:huawei:s12700_firmware" ){
						if(IsMatchRegexp( version, "^V200R007C00" ) || IsMatchRegexp( version, "^V200R007C01" ) || IsMatchRegexp( version, "^V200R008C00" ) || IsMatchRegexp( version, "^V200R009C00" ) || IsMatchRegexp( version, "^V200R010C00" )){
						...
						if( cpe == "cpe:/o:huawei:s1700_firmware" ){
							if(IsMatchRegexp( version, "^V200R006C10SPC100" ) || IsMatchRegexp( version, "^V200R009C00SPC200" ) || IsMatchRegexp( version, "^V200R010C00" )){
								if(!patch || version_is_less( version: patch, test_version: "V2R12C00" )){
									report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V2R12C00" );
									security_message( port: 0, data: report );
									exit( 0 );
							...
							if( cpe == "cpe:/o:huawei:s2700_firmware" ){
								if(IsMatchRegexp( version, "^V200R006C00SPC100" ) || IsMatchRegexp( version, "^V200R006C10" ) || IsMatchRegexp( version, "^V200R007C00" ) || IsMatchRegexp( version, "^V200R008C00" ) || IsMatchRegexp( version, "^V200R009C00" ) || IsMatchRegexp( version, "^V200R010C00" )){
									if(!patch || version_is_less( version: patch, test_version: "V2R12C00" )){
										report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V2R12C00" );
										security_message( port: 0, data: report );
										exit( 0 );
								...
								if( cpe == "cpe:/o:huawei:s5700_firmware" ){
									if(IsMatchRegexp( version, "^V200R005C02B010" ) || IsMatchRegexp( version, "^V200R005C03B020" ) || IsMatchRegexp( version, "^V200R006C00SPC100" ) || IsMatchRegexp( version, "^V200R007C00" ) || IsMatchRegexp( version, "^V200R008C00" ) || IsMatchRegexp( version, "^V200R009C00" ) || IsMatchRegexp( version, "^V200R010C00" )){
										if(!patch || version_is_less( version: patch, test_version: "V2R12C00" )){
											report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V2R12C00" );
											security_message( port: 0, data: report );
											exit( 0 );
									...
									if( cpe == "cpe:/o:huawei:s6700_firmware" ){
										if(IsMatchRegexp( version, "^V200R005C02B020" ) || IsMatchRegexp( version, "^V200R008C00" ) || IsMatchRegexp( version, "^V200R009C00" )){
											if(!patch || version_is_less( version: patch, test_version: "V2R12C00" )){
												report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V2R12C00" );
												security_message( port: 0, data: report );
												exit( 0 );
										...
										if( cpe == "cpe:/o:huawei:s7700_firmware" ){
											if(IsMatchRegexp( version, "^V200R006C00SPC300" ) || IsMatchRegexp( version, "^V200R007C00" ) || IsMatchRegexp( version, "^V200R008C00" ) || IsMatchRegexp( version, "^V200R009C00SPC500" ) || IsMatchRegexp( version, "^V200R010C00" )){
												if(!patch || version_is_less( version: patch, test_version: "V2R12C00" )){
													report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V2R12C00" );
													security_message( port: 0, data: report );
													exit( 0 );
											...
											if( cpe == "cpe:/o:huawei:s9700_firmware" ){
												if(IsMatchRegexp( version, "^V200R006C00SPC100" ) || IsMatchRegexp( version, "^V200R007C00" ) || IsMatchRegexp( version, "^V200R007C01B102" ) || IsMatchRegexp( version, "^V200R008C00SPC500" ) || IsMatchRegexp( version, "^V200R009C00" ) || IsMatchRegexp( version, "^V200R010C00" )){
													if(!patch || version_is_less( version: patch, test_version: "V2R12C00" )){
														report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V2R12C00" );
														security_message( port: 0, data: report );
														exit( 0 );
												...
												if( cpe == "cpe:/o:huawei:softco_firmware" ){
													if(IsMatchRegexp( version, "^V200R003C20SPCB00" )){
													...
													if( cpe == "cpe:/o:huawei:vp9660_firmware" ){
														...
														if(cpe == "cpe:/o:huawei:espace_u1981_firmware"){
															if(IsMatchRegexp( version, "^V100R001C20SPC700" ) || IsMatchRegexp( version, "^V200R003C20SPCB00" ) || IsMatchRegexp( version, "^V200R003C30SPC500" ) || IsMatchRegexp( version, "^V200R003C50" )){
																if(!patch || version_is_less( version: patch, test_version: "V200R003C50SPC300" )){
																	report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V200R003C50SPC300" );
																	security_message( port: 0, data: report );
																	exit( 0 );
