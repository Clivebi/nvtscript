if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2019-1419" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'httpd' package(s) announced via the EulerOS-SA-2019-1419 advisory." );
...
It was discovered that httpd used the value of the ... [Please see the references for more information on the vulnerabilities]" );
