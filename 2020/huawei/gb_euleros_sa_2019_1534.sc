if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2019-1534" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'kernel' package(s) announced via the EulerOS-SA-2019-1534 advisory." );
...
A use-after-free flaw was found in the way the ping_init_sock() function of the Linux kernel handled the group_info reference counter. A local, ... [Please see the references for more information on the vulnerabilities]" );
