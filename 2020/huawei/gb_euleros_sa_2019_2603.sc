if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2019-2603" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'lftp' package(s) announced via the EulerOS-SA-2019-2603 advisory." );
