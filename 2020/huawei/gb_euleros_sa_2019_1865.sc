if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2019-1865" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'php' package(s) announced via the EulerOS-SA-2019-1865 advisory." );
...
Integer overflow in the ... [Please see the references for more information on the vulnerabilities]" );
