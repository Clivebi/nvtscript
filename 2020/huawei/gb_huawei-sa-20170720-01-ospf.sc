...
if( cpe == "cpe:/o:huawei:ac6005_firmware" ){
	...
	if( cpe == "cpe:/o:huawei:ac6605_firmware" ){
		if(IsMatchRegexp( version, "^V200R005C10CP0582T" ) || IsMatchRegexp( version, "^V200R005C10HP0581T" ) || IsMatchRegexp( version, "^V200R005C20SPC026T" )){
		...
		if( cpe == "cpe:/o:huawei:ar1200_firmware" ){
			if(IsMatchRegexp( version, "^V200R005C20SPC026T" )){
				if(!patch || version_is_less( version: patch, test_version: "v200r007c00spcb00" )){
					report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "v200r007c00spcb00" );
					security_message( port: 0, data: report );
					exit( 0 );
			...
			if( cpe == "cpe:/o:huawei:ar200_firmware" ){
				...
				if( cpe == "cpe:/o:huawei:ar3200_firmware" ){
					...
					if( cpe == "cpe:/o:huawei:cloudengine_12800_firmware" ){
						if(IsMatchRegexp( version, "^V100R003C00" ) || IsMatchRegexp( version, "^V100R005C00" ) || IsMatchRegexp( version, "^V100R005C10" ) || IsMatchRegexp( version, "^V100R006C00" ) || IsMatchRegexp( version, "^V200R001C00" )){
							...
							if( cpe == "cpe:/o:huawei:cloudengine_6800_firmware" ){
								...
								if( cpe == "cpe:/o:huawei:cloudengine_7800_firmware" ){
									...
									if( cpe == "cpe:/o:huawei:cloudengine_8800_firmware" ){
										if(IsMatchRegexp( version, "^V100R006C00" ) || IsMatchRegexp( version, "^V200R001C00" )){
											if(!patch || version_is_less( version: patch, test_version: "V200R002C50" )){
												report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V200R002C50" );
												security_message( port: 0, data: report );
												exit( 0 );
										...
										if( cpe == "cpe:/o:huawei:e600_firmware" ){
											...
											if( cpe == "cpe:/o:huawei:ne20e-s_firmware" ){
												if(IsMatchRegexp( version, "^V800R005C01SPC100" ) || IsMatchRegexp( version, "^V800R005C01SPC200" ) || IsMatchRegexp( version, "^V800R006C00SPC300" ) || IsMatchRegexp( version, "^V800R007C00SPC200" ) || IsMatchRegexp( version, "^V800R007C10SPC100" ) || IsMatchRegexp( version, "^V800R008C10SPC300" ) || IsMatchRegexp( version, "^V800R008C10SPC500" )){
												...
												if( cpe == "cpe:/o:huawei:s12700_firmware" ){
													...
													if( cpe == "cpe:/o:huawei:s1700_firmware" ){
														if(IsMatchRegexp( version, "^V100R006C00" ) || IsMatchRegexp( version, "^V100R007C00" ) || IsMatchRegexp( version, "^V200R006C00" )){
															if(!patch || version_is_less( version: patch, test_version: "V200R009C00" )){
																report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V200R009C00" );
																security_message( port: 0, data: report );
																exit( 0 );
														...
														if( cpe == "cpe:/o:huawei:s2300_firmware" ){
															if(IsMatchRegexp( version, "^V100R005C00" ) || IsMatchRegexp( version, "^V100R006C00" ) || IsMatchRegexp( version, "^V100R006C03" ) || IsMatchRegexp( version, "^V100R006C05" ) || IsMatchRegexp( version, "^V200R003C00" ) || IsMatchRegexp( version, "^V200R003C02" ) || IsMatchRegexp( version, "^V200R003C10" ) || IsMatchRegexp( version, "^V200R005C00" ) || IsMatchRegexp( version, "^V200R005C01" ) || IsMatchRegexp( version, "^V200R005C02" ) || IsMatchRegexp( version, "^V200R005C03" ) || IsMatchRegexp( version, "^V200R006C00" ) || IsMatchRegexp( version, "^V200R007C00" ) || IsMatchRegexp( version, "^V200R008C00" )){
																if(!patch || version_is_less( version: patch, test_version: "V200R009C00" )){
																	report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V200R009C00" );
																	security_message( port: 0, data: report );
																	exit( 0 );
															...
															if( cpe == "cpe:/o:huawei:s2700_firmware" ){
																...
																if( cpe == "cpe:/o:huawei:s5300_firmware" ){
																	if(IsMatchRegexp( version, "^V100R005C00" ) || IsMatchRegexp( version, "^V100R006C00" ) || IsMatchRegexp( version, "^V100R006C01" ) || IsMatchRegexp( version, "^V200R001C00" ) || IsMatchRegexp( version, "^V200R001C01" ) || IsMatchRegexp( version, "^V200R002C00" ) || IsMatchRegexp( version, "^V200R003C00" ) || IsMatchRegexp( version, "^V200R003C02" ) || IsMatchRegexp( version, "^V200R003C10" ) || IsMatchRegexp( version, "^V200R005C00" ) || IsMatchRegexp( version, "^V200R006C00" ) || IsMatchRegexp( version, "^V200R007C00" ) || IsMatchRegexp( version, "^V200R008C00" )){
																		if(!patch || version_is_less( version: patch, test_version: "V200R009C00" )){
																			report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V200R009C00" );
																			security_message( port: 0, data: report );
																			exit( 0 );
																	...
																	if( cpe == "cpe:/o:huawei:s5700_firmware" ){
																		...
																		if( cpe == "cpe:/o:huawei:s6300_firmware" ){
																			if(IsMatchRegexp( version, "^V100R006C00" ) || IsMatchRegexp( version, "^V200R001C00" ) || IsMatchRegexp( version, "^V200R001C01" ) || IsMatchRegexp( version, "^V200R002C00" ) || IsMatchRegexp( version, "^V200R003C00" ) || IsMatchRegexp( version, "^V200R003C02" ) || IsMatchRegexp( version, "^V200R003C10" ) || IsMatchRegexp( version, "^V200R005C00" ) || IsMatchRegexp( version, "^V200R008C00" )){
																				if(!patch || version_is_less( version: patch, test_version: "V200R009C00" )){
																					report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V200R009C00" );
																					security_message( port: 0, data: report );
																					exit( 0 );
																			...
																			if( cpe == "cpe:/o:huawei:s6700_firmware" ){
																				...
																				if( cpe == "cpe:/o:huawei:s7700_firmware" ){
																					if(IsMatchRegexp( version, "^V100R003C00" ) || IsMatchRegexp( version, "^V100R006C00" ) || IsMatchRegexp( version, "^V200R001C00" ) || IsMatchRegexp( version, "^V200R001C01" ) || IsMatchRegexp( version, "^V200R002C00" ) || IsMatchRegexp( version, "^V200R003C00" ) || IsMatchRegexp( version, "^V200R005C00" ) || IsMatchRegexp( version, "^V200R006C00" ) || IsMatchRegexp( version, "^V200R007C00" ) || IsMatchRegexp( version, "^V200R008C00" )){
																						if(!patch || version_is_less( version: patch, test_version: "V200R009C00" )){
																							report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V200R009C00" );
																							security_message( port: 0, data: report );
																							exit( 0 );
																					...
																					if( cpe == "cpe:/o:huawei:s9300_firmware" ){
																						if(IsMatchRegexp( version, "^V100R001C00" ) || IsMatchRegexp( version, "^V100R002C00" ) || IsMatchRegexp( version, "^V100R003C00" ) || IsMatchRegexp( version, "^V100R006C00" ) || IsMatchRegexp( version, "^V200R001C00" ) || IsMatchRegexp( version, "^V200R002C00" ) || IsMatchRegexp( version, "^V200R003C00" ) || IsMatchRegexp( version, "^V200R005C00" ) || IsMatchRegexp( version, "^V200R006C00" ) || IsMatchRegexp( version, "^V200R007C00" ) || IsMatchRegexp( version, "^V200R008C00" ) || IsMatchRegexp( version, "^V200R008C10" )){
																							if(!patch || version_is_less( version: patch, test_version: "V200R009C00" )){
																								report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V200R009C00" );
																								security_message( port: 0, data: report );
																								exit( 0 );
																						...
																						if( cpe == "cpe:/o:huawei:s9700_firmware" ){
																							if(IsMatchRegexp( version, "^V200R001C00" ) || IsMatchRegexp( version, "^V200R002C00" ) || IsMatchRegexp( version, "^V200R003C00" ) || IsMatchRegexp( version, "^V200R005C00" ) || IsMatchRegexp( version, "^V200R006C00" ) || IsMatchRegexp( version, "^V200R007C00" ) || IsMatchRegexp( version, "^V200R008C00" )){
																								if(!patch || version_is_less( version: patch, test_version: "V200R009C00" )){
																									report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V200R009C00" );
																									security_message( port: 0, data: report );
																									exit( 0 );
																							...
																							if(cpe == "cpe:/o:huawei:usg6600_firmware"){
																								if(IsMatchRegexp( version, "^V500R001C00" ) || IsMatchRegexp( version, "^V500R001C00SPC050" ) || IsMatchRegexp( version, "^V500R001C20" ) || IsMatchRegexp( version, "^V500R001C30" )){
