if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2018-1031" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'kernel' package(s) announced via the EulerOS-SA-2018-1031 advisory." );
...
he KEYS subsystem in the Linux kernel before 4.14.6 omitted an ... [Please see the references for more information on the vulnerabilities]" );
