if(description){
	...
	script_tag( name: "severity_date", value: "2019-01-02 14:56:00 +0000 (Wed, 02 Jan 2019)" );
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2020-1606" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'kernel' package(s) announced via the EulerOS-SA-2020-1606 advisory." );
...
In the ... [Please see the references for more information on the vulnerabilities]" );
