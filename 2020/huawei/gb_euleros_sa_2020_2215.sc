if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2020-2215" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'dnsmasq' package(s) announced via the EulerOS-SA-2020-2215 advisory." );
