if(description){
	...
	script_tag( name: "severity_date", value: "2019-05-08 16:29:00 +0000 (Wed, 08 May 2019)" );
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2019-1639" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'kernel' package(s) announced via the EulerOS-SA-2019-1639 advisory." );
...
A flaw was found in the Linux kernel, prior to version 5.0.7, in ... [Please see the references for more information on the vulnerabilities]" );
