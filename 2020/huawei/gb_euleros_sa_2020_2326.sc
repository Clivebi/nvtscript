if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2020-2326" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'xorg-x11-server' package(s) announced via the EulerOS-SA-2020-2326 advisory." );
...
if(release == "EULEROS-2.0SP8"){
	if(!isnull( res = isrpmvuln( pkg: "xorg-x11-server", rpm: "xorg-x11-server~1.20.1~4.h6.eulerosv2r8", rls: "EULEROS-2.0SP8" ) )){
		report += res;
	}
