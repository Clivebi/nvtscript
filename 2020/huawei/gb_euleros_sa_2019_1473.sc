if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2019-1473" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'kernel' package(s) announced via the EulerOS-SA-2019-1473 advisory." );
...
Use-after-free vulnerability in the vhost_net_set_backend function in drivers/vhost/net.c in the Linux kernel through 3.10.3 ... [Please see the references for more information on the vulnerabilities]" );
