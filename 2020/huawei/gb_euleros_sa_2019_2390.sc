if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2019-2390" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'icu' package(s) announced via the EulerOS-SA-2019-2390 advisory." );
...
International Components for Unicode (ICU) for C/C++ before 2017-02-13 has an out-of-bounds write caused by a heap-based buffer overflow related to the utf8TextAccess function in common/utext.cpp and the ... [Please see the references for more information on the vulnerabilities]" );
