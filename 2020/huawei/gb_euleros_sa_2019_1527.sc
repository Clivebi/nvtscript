if(description){
	...
	script_tag( name: "severity_date", value: "2020-11-17 14:15:00 +0000 (Tue, 17 Nov 2020)" );
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2019-1527" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'kernel' package(s) announced via the EulerOS-SA-2019-1527 advisory." );
...
A flaw was found in the way the Linux kernel's networking implementation handled UDP packets with incorrect checksum values. A remote attacker could potentially use this flaw to trigger an infinite loop in the kernel, ... [Please see the references for more information on the vulnerabilities]" );
