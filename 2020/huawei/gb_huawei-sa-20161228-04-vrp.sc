if(description){
	...
	script_tag( name: "severity_date", value: "2018-03-26 15:24:00 +0000 (Mon, 26 Mar 2018)" );
...
if(cpe == "cpe:/o:huawei:s5700_firmware"){
	if(IsMatchRegexp( version, "^V200R007C00" )){
		report = report_fixed_ver( installed_version: version, fixed_version: "V200R009C00SPC500" );
		security_message( port: 0, data: report );
		exit( 0 );
	}
...
if(cpe == "cpe:/o:huawei:s7700_firmware"){
	if(IsMatchRegexp( version, "^V200R002C00" ) || IsMatchRegexp( version, "^V200R005C00" ) || IsMatchRegexp( version, "^V200R006C00" ) || IsMatchRegexp( version, "^V200R007C00" ) || IsMatchRegexp( version, "^V200R008C00" )){
		report = report_fixed_ver( installed_version: version, fixed_version: "V200R009C00SPC500" );
		security_message( port: 0, data: report );
		exit( 0 );
	}
