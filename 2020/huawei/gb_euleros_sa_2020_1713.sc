...
gadget_dev_desc_UDC_store in drivers/usb/gadget/configfs.c in the Linux kernel through ... [Please see the references for more information on the vulnerabilities]" );
