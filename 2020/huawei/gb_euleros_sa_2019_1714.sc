if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2019-1714" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'libarchive' package(s) announced via the EulerOS-SA-2019-1714 advisory." );
