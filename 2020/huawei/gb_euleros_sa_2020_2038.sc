if(description){
	...
	script_tag( name: "severity_date", value: "2019-03-26 17:46:00 +0000 (Tue, 26 Mar 2019)" );
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2020-2038" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'file' package(s) announced via the EulerOS-SA-2020-2038 advisory." );
