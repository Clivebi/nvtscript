if(description){
	...
	script_tag( name: "severity_date", value: "2019-10-11 00:15:00 +0000 (Fri, 11 Oct 2019)" );
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2019-1972" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'kernel' package(s) announced via the EulerOS-SA-2019-1972 advisory." );
