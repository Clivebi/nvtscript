if(description){
	...
	script_tag( name: "severity_date", value: "2020-11-08 13:15:00 +0000 (Sun, 08 Nov 2020)" );
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2020-1109" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'jakarta-commons-httpclient' package(s) announced via the EulerOS-SA-2020-1109 advisory." );
