if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2020-1581" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'java-1.8.0-openjdk' package(s) announced via the EulerOS-SA-2020-1581 advisory." );
...
Vulnerability in the Java SE, Java SE Embedded product of Oracle Java SE (component: Serialization). Supported versions that are affected are Java SE: 7u241, 8u231, 11.0.5 and 13.0.1, Java SE ... [Please see the references for more information on the vulnerabilities]" );
