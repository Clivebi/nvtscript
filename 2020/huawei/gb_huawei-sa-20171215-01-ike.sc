if(description){
	...
	script_tag( name: "severity_date", value: "2018-03-09 14:36:00 +0000 (Fri, 09 Mar 2018)" );
...
if( cpe == "cpe:/o:huawei:ar120-s_firmware" ){
	if(IsMatchRegexp( version, "^V200R006C10SPC300" ) || IsMatchRegexp( version, "^V200R007C00SPC900" )){
	...
	if( cpe == "cpe:/o:huawei:ar1200_firmware" ){
		if(IsMatchRegexp( version, "^V200R006C10SPC300" ) || IsMatchRegexp( version, "^V200R006C13" ) || IsMatchRegexp( version, "^V200R007C00SPC900" ) || IsMatchRegexp( version, "^V200R007C02" )){
			if(!patch || version_is_less( version: patch, test_version: "V200R008SPH003" )){
				report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V200R008SPH003" );
				security_message( port: 0, data: report );
				exit( 0 );
		...
		if( cpe == "cpe:/o:huawei:ar1200-s_firmware" ){
			if(IsMatchRegexp( version, "^V200R006C10SPC300" ) || IsMatchRegexp( version, "^V200R007C00SPC900" ) || IsMatchRegexp( version, "^V200R008C20SPC800PWE" )){
				if(!patch || version_is_less( version: patch, test_version: "V200R008SPH003" )){
					report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V200R008SPH003" );
					security_message( port: 0, data: report );
					exit( 0 );
			...
			if( cpe == "cpe:/o:huawei:ar150_firmware" ){
				if(IsMatchRegexp( version, "^V200R006C10SPC300" ) || IsMatchRegexp( version, "^V200R007C00SPC900" ) || IsMatchRegexp( version, "^V200R007C02" )){
					if(!patch || version_is_less( version: patch, test_version: "V200R008SPH003" )){
						report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V200R008SPH003" );
						security_message( port: 0, data: report );
						exit( 0 );
				...
				if( cpe == "cpe:/o:huawei:ar150-s_firmware" ){
					...
					if( cpe == "cpe:/o:huawei:ar160_firmware" ){
						if(IsMatchRegexp( version, "^V200R006C10SPC300" ) || IsMatchRegexp( version, "^V200R006C12" ) || IsMatchRegexp( version, "^V200R007C00SPC900" ) || IsMatchRegexp( version, "^V200R007C02" )){
							if(!patch || version_is_less( version: patch, test_version: "V200R008SPH003" )){
								report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V200R008SPH003" );
								security_message( port: 0, data: report );
								exit( 0 );
						...
						if( cpe == "cpe:/o:huawei:ar200_firmware" ){
							...
							if( cpe == "cpe:/o:huawei:ar200-s_firmware" ){
								...
								if( cpe == "cpe:/o:huawei:ar2200_firmware" ){
									if(IsMatchRegexp( version, "^V200R006C10SPC300" ) || IsMatchRegexp( version, "^V200R006C13" ) || IsMatchRegexp( version, "^V200R006C16PWE" ) || IsMatchRegexp( version, "^V200R007C00SPC900" ) || IsMatchRegexp( version, "^V200R007C02" )){
										if(!patch || version_is_less( version: patch, test_version: "V200R008SPH003" )){
											report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V200R008SPH003" );
											security_message( port: 0, data: report );
											exit( 0 );
									...
									if( cpe == "cpe:/o:huawei:ar2200-s_firmware" ){
										...
										if( cpe == "cpe:/o:huawei:ar3200_firmware" ){
											if(IsMatchRegexp( version, "^V200R006C10SPC200" ) || IsMatchRegexp( version, "^V200R006C11" ) || IsMatchRegexp( version, "^V200R007C00" ) || IsMatchRegexp( version, "^V200R007C02" )){
												if(!patch || version_is_less( version: patch, test_version: "V200R008SPH003" )){
													report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V200R008SPH003" );
													security_message( port: 0, data: report );
													exit( 0 );
											...
											if( cpe == "cpe:/o:huawei:ar3600_firmware" ){
												...
												if( cpe == "cpe:/o:huawei:ar510_firmware" ){
													if(IsMatchRegexp( version, "^V200R006C12" ) || IsMatchRegexp( version, "^V200R006C13" ) || IsMatchRegexp( version, "^V200R006C15" ) || IsMatchRegexp( version, "^V200R006C16" ) || IsMatchRegexp( version, "^V200R006C17" ) || IsMatchRegexp( version, "^V200R007C00SPC900" )){
														if(!patch || version_is_less( version: patch, test_version: "V200R008SPH003" )){
															report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V200R008SPH003" );
															security_message( port: 0, data: report );
															exit( 0 );
													...
													if( cpe == "cpe:/o:huawei:dbs3900_tdd_lte_firmware" ){
														...
														if( cpe == "cpe:/o:huawei:ips_module_firmware" ){
															if(IsMatchRegexp( version, "^V500R001C30SPC100PWE" )){
															...
															if( cpe == "cpe:/o:huawei:ngfw_module_firmware" ){
																if(IsMatchRegexp( version, "^V500R002C00SPC100PWE" )){
																	if(!patch || version_is_less( version: patch, test_version: "V500R001C60SPC200" )){
																		report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V500R001C60SPC200" );
																		security_message( port: 0, data: report );
																		exit( 0 );
																					...
																					if( cpe == "cpe:/o:huawei:srg3300_firmware" ){
																						...
																						if( cpe == "cpe:/o:huawei:usg6300_firmware" ){
																							...
																							if( cpe == "cpe:/o:huawei:usg6500_firmware" ){
																								if(IsMatchRegexp( version, "^V500R001C30SPC200PWE" )){
																									if(!patch || version_is_less( version: patch, test_version: "V500R001C60SPC200" )){
																										report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V500R001C60SPC200" );
																										security_message( port: 0, data: report );
																										exit( 0 );
