if(description){
	...
	script_tag( name: "severity_date", value: "2020-08-06 18:24:00 +0000 (Thu, 06 Aug 2020)" );
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2019-1525" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'kernel' package(s) announced via the EulerOS-SA-2019-1525 advisory." );
...
The l2tp_ip_recvmsg function in net/l2tp/l2tp_ip.c in the Linux kernel before 3.12.4 updates a certain length value before ensuring that an associated data structure has been initialized, which allows local users to obtain ... [Please see the references for more information on the vulnerabilities]" );
