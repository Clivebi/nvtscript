if(description){
	...
	script_tag( name: "severity_date", value: "2020-01-21 23:15:00 +0000 (Tue, 21 Jan 2020)" );
...
if( cpe == "cpe:/o:huawei:cloudengine_12800_firmware" ){
	if(IsMatchRegexp( version, "^V100R003C00SPC600" ) || IsMatchRegexp( version, "^V100R003C10SPC100" ) || IsMatchRegexp( version, "^V100R005C00SPC200" ) || IsMatchRegexp( version, "^V100R005C00SPC300" ) || IsMatchRegexp( version, "^V100R005C10HP0001" ) || IsMatchRegexp( version, "^V100R005C10SPC100" ) || IsMatchRegexp( version, "^V100R005C10SPC200" ) || IsMatchRegexp( version, "^V100R006C00" ) || IsMatchRegexp( version, "^V200R001C00" ) || IsMatchRegexp( version, "^V200R002C01" ) || IsMatchRegexp( version, "^V200R002C10" ) || IsMatchRegexp( version, "^V200R002C20" ) || IsMatchRegexp( version, "^V200R005C10" )){
	...
	if( cpe == "cpe:/o:huawei:s5700_firmware" ){
		if(IsMatchRegexp( version, "^V200R005C00SPC500" ) || IsMatchRegexp( version, "^V200R005C03" ) || IsMatchRegexp( version, "^V200R006C00SPC100" ) || IsMatchRegexp( version, "^V200R006C00SPC300" ) || IsMatchRegexp( version, "^V200R006C00SPC500" ) || IsMatchRegexp( version, "^V200R007C00SPC100" ) || IsMatchRegexp( version, "^V200R007C00SPC500" )){
		...
		if( cpe == "cpe:/o:huawei:s6700_firmware" ){
			if(IsMatchRegexp( version, "^V200R005C00SPC500" ) || IsMatchRegexp( version, "^V200R005C01" )){
				if(!patch || version_is_less( version: patch, test_version: "V200R008C00" )){
					report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V200R008C00" );
					security_message( port: 0, data: report );
					exit( 0 );
			...
			if( cpe == "cpe:/o:huawei:secospace_antiddos8000_firmware" ){
