if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2018-1420" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'openssl' package(s) announced via the EulerOS-SA-2018-1420 advisory." );
