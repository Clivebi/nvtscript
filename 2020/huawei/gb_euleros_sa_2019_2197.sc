if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2019-2197" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'webkitgtk4' package(s) announced via the EulerOS-SA-2019-2197 advisory." );
