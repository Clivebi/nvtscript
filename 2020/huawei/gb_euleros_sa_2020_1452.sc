if(description){
	...
	script_tag( name: "severity_date", value: "2019-11-08 20:51:00 +0000 (Fri, 08 Nov 2019)" );
...
A memory leak in the ql_alloc_large_buffers() function in drivers
et/ethernet/qlogic/qla3xxx.c in the Linux kernel before 5.3.5 allows local users to cause a denial of service (memory consumption) by triggering pci_dma_mapping_error() failures, aka CID-1acb8f2a7a9f.(CVE-2019-18806)
