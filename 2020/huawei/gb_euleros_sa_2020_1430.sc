...
hw/ide/core.c in QEMU does not properly restrict the commands accepted by an ATAPI device, which allows guest users to cause ... [Please see the references for more information on the vulnerabilities]" );
