if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2019-2510" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'elfutils' package(s) announced via the EulerOS-SA-2019-2510 advisory." );
...
The check_sysv_hash function in elflint.c in elfutils 0.168 allows remote attackers to cause a denial of ... [Please see the references for more information on the vulnerabilities]" );
