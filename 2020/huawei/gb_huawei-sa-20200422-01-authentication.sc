if(description){
	...
	script_tag( name: "severity_date", value: "2020-04-30 19:16:00 +0000 (Thu, 30 Apr 2020)" );
...
if(cpe == "cpe:/o:huawei:ar3200_firmware"){
	if(IsMatchRegexp( version, "^V200R007C00SPC900" ) || IsMatchRegexp( version, "^V200R007C00SPCA00" ) || IsMatchRegexp( version, "^V200R007C00SPCB00" ) || IsMatchRegexp( version, "^V200R007C00SPCC00" ) || IsMatchRegexp( version, "^V200R009C00SPC500" )){
