if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2020-2344" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'ghostscript' package(s) announced via the EulerOS-SA-2020-2344 advisory." );
...
A buffer overflow vulnerability in okiibm_print_page1() in devices/gdevokii.c of Artifex Software GhostScript v9.50 allows a remote attacker to cause a denial of service via a ... [Please see the references for more information on the vulnerabilities]" );
