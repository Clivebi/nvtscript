if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2019-2149" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'gd' package(s) announced via the EulerOS-SA-2019-2149 advisory." );
