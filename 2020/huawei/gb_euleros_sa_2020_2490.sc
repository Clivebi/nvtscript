if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2020-2490" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'python-pip' package(s) announced via the EulerOS-SA-2020-2490 advisory." );
...
if(release == "EULEROS-2.0SP9"){
	if(!isnull( res = isrpmvuln( pkg: "python-pip", rpm: "python-pip~18.0~13.h3.eulerosv2r9", rls: "EULEROS-2.0SP9" ) )){
		report += res;
	}
