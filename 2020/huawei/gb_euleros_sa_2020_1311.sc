if(description){
	...
	script_tag( name: "severity_date", value: "2020-03-06 19:15:00 +0000 (Fri, 06 Mar 2020)" );
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2020-1311" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'lvm2' package(s) announced via the EulerOS-SA-2020-1311 advisory." );
