if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2019-1547" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'openssl' package(s) announced via the EulerOS-SA-2019-1547 advisory." );
...
It was discovered that OpenSSL would perform an ECDH key exchange with a non-ephemeral key even when the ephemeral ECDH cipher suite was selected. A malicious server could make a TLS/SSL ... [Please see the references for more information on the vulnerabilities]" );
