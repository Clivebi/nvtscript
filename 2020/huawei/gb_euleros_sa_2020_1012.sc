if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2020-1012" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'kernel' package(s) announced via the EulerOS-SA-2020-1012 advisory." );
...
The acpi_ds_create_operands() function in drivers/acpi/acpica/dsutils.c in the Linux kernel through 4.12.9 does not flush the operand cache and causes a kernel stack dump, which allows ... [Please see the references for more information on the vulnerabilities]" );
