if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2019-2466" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'libtiff' package(s) announced via the EulerOS-SA-2019-2466 advisory." );
...
LibTIFF 4.0.7 has a signed integer overflow, which might allow remote attackers ... [Please see the references for more information on the vulnerabilities]" );
