if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2018-1023" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'gimp' package(s) announced via the EulerOS-SA-2018-1023 advisory." );
