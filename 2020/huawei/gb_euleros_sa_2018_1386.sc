if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2018-1386" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'java-1.8.0-openjdk' package(s) announced via the EulerOS-SA-2018-1386 advisory." );
...
OpenJDK: Incorrect handling of unsigned attributes in signed Jar manifests (CVE-2018-3136)
