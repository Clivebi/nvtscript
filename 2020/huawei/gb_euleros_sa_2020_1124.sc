if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2020-1124" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'php' package(s) announced via the EulerOS-SA-2020-1124 advisory." );
...
When PHP EXIF extension is parsing EXIF information from an image, e.g. via exif_read_data() function, in PHP versions 7.2.x below 7.2.26, 7.3.x below 7.3.13 and 7.4.0 it ... [Please see the references for more information on the vulnerabilities]" );
