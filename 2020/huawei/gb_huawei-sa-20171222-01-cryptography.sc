...
if( cpe == "cpe:/o:huawei:ar120-s_firmware" ){
	if(IsMatchRegexp( version, "^V200R005C32" ) || IsMatchRegexp( version, "^V200R006C10" ) || IsMatchRegexp( version, "^V200R007C00" ) || IsMatchRegexp( version, "^V200R008C20" )){
	...
	if( cpe == "cpe:/o:huawei:ar1200_firmware" ){
		if(IsMatchRegexp( version, "^V200R005C20" ) || IsMatchRegexp( version, "^V200R005C32" ) || IsMatchRegexp( version, "^V200R006C10" ) || IsMatchRegexp( version, "^V200R007C00" ) || IsMatchRegexp( version, "^V200R007C01" ) || IsMatchRegexp( version, "^V200R007C02" ) || IsMatchRegexp( version, "^V200R008C20" )){
			if(!patch || version_is_less( version: patch, test_version: "V200R009C00" )){
				report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V200R009C00" );
				security_message( port: 0, data: report );
				exit( 0 );
		...
		if( cpe == "cpe:/o:huawei:ar1200-s_firmware" ){
			...
			if( cpe == "cpe:/o:huawei:ar150_firmware" ){
				if(IsMatchRegexp( version, "^V200R006C10" ) || IsMatchRegexp( version, "^V200R007C00" ) || IsMatchRegexp( version, "^V200R007C01" ) || IsMatchRegexp( version, "^V200R007C02" ) || IsMatchRegexp( version, "^V200R008C20" )){
					if(!patch || version_is_less( version: patch, test_version: "V200R009C00" )){
						report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V200R009C00" );
						security_message( port: 0, data: report );
						exit( 0 );
				...
				if( cpe == "cpe:/o:huawei:ar160_firmware" ){
					if(IsMatchRegexp( version, "^V200R005C32" ) || IsMatchRegexp( version, "^V200R006C10" ) || IsMatchRegexp( version, "^V200R007C00" ) || IsMatchRegexp( version, "^V200R007C01" ) || IsMatchRegexp( version, "^V200R007C02" ) || IsMatchRegexp( version, "^V200R008C20" )){
						if(!patch || version_is_less( version: patch, test_version: "V200R009C00" )){
							report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V200R009C00" );
							security_message( port: 0, data: report );
							exit( 0 );
					...
					if( cpe == "cpe:/o:huawei:ar200_firmware" ){
						if(IsMatchRegexp( version, "^V200R005C32" ) || IsMatchRegexp( version, "^V200R006C10" ) || IsMatchRegexp( version, "^V200R007C00" ) || IsMatchRegexp( version, "^V200R007C01" ) || IsMatchRegexp( version, "^V200R008C20" )){
							if(!patch || version_is_less( version: patch, test_version: "V200R009C00" )){
								report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V200R009C00" );
								security_message( port: 0, data: report );
								exit( 0 );
										...
										if( cpe == "cpe:/o:huawei:ar3600_firmware" ){
											...
											if( cpe == "cpe:/o:huawei:ar510_firmware" ){
												...
												if( cpe == "cpe:/o:huawei:cloudengine_12800_firmware" ){
													if(IsMatchRegexp( version, "^V100R003C00" ) || IsMatchRegexp( version, "^V100R003C10" ) || IsMatchRegexp( version, "^V100R005C00" ) || IsMatchRegexp( version, "^V100R005C10" ) || IsMatchRegexp( version, "^V100R006C00" ) || IsMatchRegexp( version, "^V200R001C00" )){
														...
														if( cpe == "cpe:/o:huawei:cloudengine_6800_firmware" ){
															...
															if( cpe == "cpe:/o:huawei:cloudengine_7800_firmware" ){
																...
																if( cpe == "cpe:/o:huawei:dbs3900_tdd_lte_firmware" ){
																	if(IsMatchRegexp( version, "^V100R004C10" )){
																	...
																	if( cpe == "cpe:/o:huawei:dp300_firmware" ){
																		...
																		if( cpe == "cpe:/o:huawei:smc2.0_firmware" ){
																			if(IsMatchRegexp( version, "^V100R003C10" ) || IsMatchRegexp( version, "^V100R005C00" ) || IsMatchRegexp( version, "^V500R002C00" )){
																			...
																			if( cpe == "cpe:/o:huawei:srg1300_firmware" ){
																				if(IsMatchRegexp( version, "^V200R005C32" ) || IsMatchRegexp( version, "^V200R006C10" ) || IsMatchRegexp( version, "^V200R007C00" ) || IsMatchRegexp( version, "^V200R007C02" ) || IsMatchRegexp( version, "^V200R008C20" )){
																					if(!patch || version_is_less( version: patch, test_version: "V200R009C00" )){
																						report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V200R009C00" );
																						security_message( port: 0, data: report );
																						exit( 0 );
																				...
																				if( cpe == "cpe:/o:huawei:srg2300_firmware" ){
																					...
																					if( cpe == "cpe:/o:huawei:srg3300_firmware" ){
																						...
																						if( cpe == "cpe:/o:huawei:secospace_usg6300_firmware" ){
																							if(IsMatchRegexp( version, "^V500R001C30SPC100" ) || IsMatchRegexp( version, "^V500R001C30SPC200" ) || IsMatchRegexp( version, "^V500R001C30SPC600" )){
																								...
																								if( cpe == "cpe:/o:huawei:secospace_usg6600_firmware" ){
																									...
																									if( cpe == "cpe:/o:huawei:te30_firmware" ){
																										...
																										if( cpe == "cpe:/o:huawei:te60_firmware" ){
																											if(IsMatchRegexp( version, "^V100R003C00" ) || IsMatchRegexp( version, "^V500R002C00" )){
																												if(!patch || version_is_less( version: patch, test_version: "V600R006C00SPC200" )){
																													report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V600R006C00SPC200" );
																													security_message( port: 0, data: report );
																													exit( 0 );
																											...
																											if( cpe == "cpe:/o:huawei:usg9500_firmware" ){
																												...
																												if( cpe == "cpe:/o:huawei:vp9660_firmware" ){
																													if(IsMatchRegexp( version, "^V200R001C02" ) || IsMatchRegexp( version, "^V200R001C30" ) || IsMatchRegexp( version, "^V500R002C00" )){
																													...
																													if( cpe == "cpe:/o:huawei:viewpoint_8660_firmware" ){
																														if(IsMatchRegexp( version, "^V100R008C02" ) || IsMatchRegexp( version, "^V100R008C03" )){
																														...
																														if( cpe == "cpe:/o:huawei:espace_iad_firmware" ){
																															if(IsMatchRegexp( version, "^V300R002C01SPC500B010" )){
																															...
																															if( cpe == "cpe:/o:huawei:espace_u1981_firmware" ){
																																if(IsMatchRegexp( version, "^V200R003C20SPH103B010" ) || IsMatchRegexp( version, "^V200R003C30B015" )){
																																...
																																if(cpe == "cpe:/o:huawei:espace_usm_firmware"){
																																	if(IsMatchRegexp( version, "^V100R001C01" ) || IsMatchRegexp( version, "^V300R001C00" )){
