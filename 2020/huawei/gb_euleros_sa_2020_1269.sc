if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2020-1269" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'kernel' package(s) announced via the EulerOS-SA-2020-1269 advisory." );
...
** DISPUTED ** An ... [Please see the references for more information on the vulnerabilities]" );
