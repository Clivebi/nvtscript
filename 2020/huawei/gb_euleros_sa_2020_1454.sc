if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2020-1454" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'icu' package(s) announced via the EulerOS-SA-2020-1454 advisory." );
...
The Regular Expressions package in International Components for Unicode (ICU) 52 before ... [Please see the references for more information on the vulnerabilities]" );
