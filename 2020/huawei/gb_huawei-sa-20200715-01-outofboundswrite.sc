if(description){
	...
	script_tag( name: "severity_date", value: "2020-07-24 15:28:00 +0000 (Fri, 24 Jul 2020)" );
...
if(IsMatchRegexp( version, "^V500R001C30" ) || IsMatchRegexp( version, "^V500R001C60" ) || IsMatchRegexp( version, "^V500R005C00" ) || IsMatchRegexp( version, "^V500R005C10" )){
