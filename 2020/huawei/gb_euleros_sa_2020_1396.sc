if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2020-1396" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'kernel' package(s) announced via the EulerOS-SA-2020-1396 advisory." );
...
An out-of-bounds memory write issue was found in the Linux Kernel, version 3.13 through 5.4, in the way ... [Please see the references for more information on the vulnerabilities]" );
