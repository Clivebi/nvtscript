if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2020-1637" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'openssl098e' package(s) announced via the EulerOS-SA-2020-1637 advisory." );
...
The ssl23_get_client_hello function in s23_srvr.c in OpenSSL 1.0.1 before 1.0.1i allows man-in-the-middle attackers to force the use of TLS 1.0 by triggering ClientHello message fragmentation in communication between a client and server that both support later TLS versions, ... [Please see the references for more information on the vulnerabilities]" );
