if(description){
	...
	script_tag( name: "severity_date", value: "2018-03-07 15:08:00 +0000 (Wed, 07 Mar 2018)" );
...
if( cpe == "cpe:/o:huawei:ar120-s_firmware" ){
	if(IsMatchRegexp( version, "^V200R005C32" ) || IsMatchRegexp( version, "^V200R006C10" ) || IsMatchRegexp( version, "^V200R007C00" ) || IsMatchRegexp( version, "^V200R008C20" ) || IsMatchRegexp( version, "^V200R008C30" )){
	...
	if( cpe == "cpe:/o:huawei:ar1200_firmware" ){
		if(IsMatchRegexp( version, "^V200R005C32" ) || IsMatchRegexp( version, "^V200R006C10" ) || IsMatchRegexp( version, "^V200R007C00" ) || IsMatchRegexp( version, "^V200R007C01" ) || IsMatchRegexp( version, "^V200R007C02" ) || IsMatchRegexp( version, "^V200R008C20" ) || IsMatchRegexp( version, "^V200R008C30" )){
			if(!patch || version_is_less( version: patch, test_version: "V200R009C00SPC300" )){
				report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V200R009C00SPC300" );
				security_message( port: 0, data: report );
				exit( 0 );
		...
		if( cpe == "cpe:/o:huawei:ar1200-s_firmware" ){
			...
			if( cpe == "cpe:/o:huawei:ar150_firmware" ){
				...
				if( cpe == "cpe:/o:huawei:ar150-s_firmware" ){
					if(IsMatchRegexp( version, "^V200R005C32" ) || IsMatchRegexp( version, "^V200R007C00" ) || IsMatchRegexp( version, "^V200R008C20" ) || IsMatchRegexp( version, "^V200R008C30" )){
						if(!patch || version_is_less( version: patch, test_version: "V200R009C00SPC300" )){
							report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V200R009C00SPC300" );
							security_message( port: 0, data: report );
							exit( 0 );
					...
					if( cpe == "cpe:/o:huawei:ar160_firmware" ){
						...
						if( cpe == "cpe:/o:huawei:ar200_firmware" ){
							if(IsMatchRegexp( version, "^V200R005C32" ) || IsMatchRegexp( version, "^V200R006C10" ) || IsMatchRegexp( version, "^V200R007C00" ) || IsMatchRegexp( version, "^V200R007C01" ) || IsMatchRegexp( version, "^V200R008C20" ) || IsMatchRegexp( version, "^V200R008C30" )){
								if(!patch || version_is_less( version: patch, test_version: "V200R009C00SPC300" )){
									report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V200R009C00SPC300" );
									security_message( port: 0, data: report );
									exit( 0 );
										...
										if( cpe == "cpe:/o:huawei:ar3200_firmware" ){
											...
											if( cpe == "cpe:/o:huawei:ar3600_firmware" ){
												...
												if( cpe == "cpe:/o:huawei:ar510_firmware" ){
													if(IsMatchRegexp( version, "^V200R005C32" ) || IsMatchRegexp( version, "^V200R006C10" ) || IsMatchRegexp( version, "^V200R007C00SPC600" ) || IsMatchRegexp( version, "^V200R008C20" ) || IsMatchRegexp( version, "^V200R008C30" )){
														if(!patch || version_is_less( version: patch, test_version: "V200R009C00SPC300" )){
															report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V200R009C00SPC300" );
															security_message( port: 0, data: report );
															exit( 0 );
													...
													if( cpe == "cpe:/o:huawei:netengine16ex_firmware" ){
														...
														if( cpe == "cpe:/o:huawei:srg1300_firmware" ){
															if(IsMatchRegexp( version, "^V200R005C32" ) || IsMatchRegexp( version, "^V200R006C10" ) || IsMatchRegexp( version, "^V200R007C00" ) || IsMatchRegexp( version, "^V200R007C02" ) || IsMatchRegexp( version, "^V200R008C20" ) || IsMatchRegexp( version, "^V200R008C30" )){
																if(!patch || version_is_less( version: patch, test_version: "V200R009C00SPC300" )){
																	report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V200R009C00SPC300" );
																	security_message( port: 0, data: report );
																	exit( 0 );
