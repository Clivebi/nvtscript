if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2020-1821" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'php' package(s) announced via the EulerOS-SA-2020-1821 advisory." );
...
In PHP versions 7.2.x below 7.2.30, 7.3.x below 7.3.17 and 7.4.x below 7.4.5, if PHP is ... [Please see the references for more information on the vulnerabilities]" );
