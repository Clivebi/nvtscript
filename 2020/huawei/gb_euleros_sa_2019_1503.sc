if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2019-1503" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'kernel' package(s) announced via the EulerOS-SA-2019-1503 advisory." );
...
Stack-based buffer overflow in the brcmf_cfg80211_start_ap() function in 'drivers
et/wireless/broadcom/brcm80211/brcmfmac/cfg80211.c' in the Linux kernel before 4.7.5 allows local users to cause a denial of service (system crash) or possibly have unspecified other impact via a long SSID Information Element in a command to a Netlink socket.(CVE-2016-8658)
...
An issue where a provided address with access_ok() is not checked was discovered in i915_gem_execbuffer2_ioctl in drivers/gpu/drm/i915/i915_gem_execbuffer.c in the Linux ... [Please see the references for more information on the vulnerabilities]" );
