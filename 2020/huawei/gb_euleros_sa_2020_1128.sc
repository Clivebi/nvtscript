if(description){
	...
	script_tag( name: "severity_date", value: "2020-02-18 16:15:00 +0000 (Tue, 18 Feb 2020)" );
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2020-1128" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'python-pillow' package(s) announced via the EulerOS-SA-2020-1128 advisory." );
