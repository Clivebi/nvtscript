if(description){
	...
	script_tag( name: "severity_date", value: "2017-04-05 23:59:00 +0000 (Wed, 05 Apr 2017)" );
...
if(IsMatchRegexp( cpe, "^cpe:/o:huawei:cloudengine_(12800|5800|6800|7800)_firmware" )){
	if(IsMatchRegexp( version, "^V100R002C00" ) || IsMatchRegexp( version, "^V100R003C00" ) || IsMatchRegexp( version, "^V100R003C10" ) || IsMatchRegexp( version, "^V100R005C00" ) || IsMatchRegexp( version, "^V100R005C10" ) || IsMatchRegexp( version, "^V100R006C00" )){
...
if(cpe == "cpe:/o:huawei:usg6600_firmware"){
	if(IsMatchRegexp( version, "^V500R001C00" )){
