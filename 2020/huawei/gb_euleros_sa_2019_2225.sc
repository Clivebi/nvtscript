if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2019-2225" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'python' package(s) announced via the EulerOS-SA-2019-2225 advisory." );
...
An issue was discovered in urllib2 in Python 2.x through 2.7.16 and urllib in Python 3.x ... [Please see the references for more information on the vulnerabilities]" );
