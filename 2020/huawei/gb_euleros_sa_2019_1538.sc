if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2019-1538" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'kernel' package(s) announced via the EulerOS-SA-2019-1538 advisory." );
...
In the Linux kernel before ... [Please see the references for more information on the vulnerabilities]" );
