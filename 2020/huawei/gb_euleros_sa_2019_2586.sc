if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2019-2586" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'ghostscript' package(s) announced via the EulerOS-SA-2019-2586 advisory." );
...
The mem_get_bits_rectangle function in base/gdevmem.c in Artifex Software, Inc. Ghostscript 9.20 allows remote attackers to cause a denial ... [Please see the references for more information on the vulnerabilities]" );
