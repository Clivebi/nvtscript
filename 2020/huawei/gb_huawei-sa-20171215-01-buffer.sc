												...
												if( cpe == "cpe:/o:huawei:ar510_firmware" ){
													...
													if( cpe == "cpe:/o:huawei:dp300_firmware" ){
														...
														if( cpe == "cpe:/o:huawei:ips_module_firmware" ){
															if(IsMatchRegexp( version, "^V100R001C10SPC200" ) || IsMatchRegexp( version, "^V100R001C30" ) || IsMatchRegexp( version, "^V500R001C00" ) || IsMatchRegexp( version, "^V500R001C20" ) || IsMatchRegexp( version, "^V500R001C30" ) || IsMatchRegexp( version, "^V500R001C50" )){
																							...
																							if( cpe == "cpe:/o:huawei:srg2300_firmware" ){
																								...
																								if( cpe == "cpe:/o:huawei:srg3300_firmware" ){
																									...
																									if( cpe == "cpe:/o:huawei:svn5600_firmware" ){
																										if(IsMatchRegexp( version, "^V200R003C00SPC100" ) || IsMatchRegexp( version, "^V200R003C10" )){
																											if(!patch || version_is_less( version: patch, test_version: "V500R001C60" )){
																												report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V500R001C60" );
																												security_message( port: 0, data: report );
																												exit( 0 );
																										...
																										if( cpe == "cpe:/o:huawei:svn5800_firmware" ){
																											if(IsMatchRegexp( version, "^V200R003C10" )){
																												if(!patch || version_is_less( version: patch, test_version: "V500R001C60" )){
																													report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V500R001C60" );
																													security_message( port: 0, data: report );
																													exit( 0 );
																													...
																													if( cpe == "cpe:/o:huawei:usg6300_firmware" ){
																														...
																														if( cpe == "cpe:/o:huawei:usg6500_firmware" ){
																															...
																															if( cpe == "cpe:/o:huawei:usg6600_firmware" ){
																																if(IsMatchRegexp( version, "^V100R001C00SPC200" ) || IsMatchRegexp( version, "^V100R001C10SPC200" ) || IsMatchRegexp( version, "^V100R001C20SPC100" ) || IsMatchRegexp( version, "^V100R001C30" ) || IsMatchRegexp( version, "^V500R001C00" ) || IsMatchRegexp( version, "^V500R001C20" ) || IsMatchRegexp( version, "^V500R001C30" ) || IsMatchRegexp( version, "^V500R001C50" )){
																																	if(!patch || version_is_less( version: patch, test_version: "V500R001C60" )){
																																		report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V500R001C60" );
																																		security_message( port: 0, data: report );
																																		exit( 0 );
																																					...
																																					if( cpe == "cpe:/o:huawei:tp3206_firmware" ){
																																						...
																																						if( cpe == "cpe:/o:huawei:usg9500_firmware" ){
																																							...
																																							if( cpe == "cpe:/o:huawei:usg9520_firmware" ){
																																								if(IsMatchRegexp( version, "^V300R001C01SPC500" ) || IsMatchRegexp( version, "^V300R001C20SPC200" )){
																																									if(!patch || version_is_less( version: patch, test_version: "V500R001C60" )){
																																										report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V500R001C60" );
																																										security_message( port: 0, data: report );
																																										exit( 0 );
																																									...
																																									if( cpe == "cpe:/o:huawei:usg9580_firmware" ){
																																										...
																																										if( cpe == "cpe:/o:huawei:viewpoint_9030_firmware" ){
																																											...
																																											if(cpe == "cpe:/o:huawei:espace_u1981_firmware"){
																																												if(IsMatchRegexp( version, "^V200R003C20SPC900" ) || IsMatchRegexp( version, "^V200R003C30SPC200" )){
