...
if(IsMatchRegexp( cpe, "^cpe:/o:huawei:usg6[35]00_firmware" )){
	if(IsMatchRegexp( version, "^V100R001C10" ) || IsMatchRegexp( version, "^V100R001C20" ) || IsMatchRegexp( version, "^V100R001C30" ) || IsMatchRegexp( version, "^V500R001C00" ) || IsMatchRegexp( version, "^V500R001C20" ) || IsMatchRegexp( version, "^V500R001C30" ) || IsMatchRegexp( version, "^V500R001C50" )){
		report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V500R001C60SPC500", fixed_patch: "V500R001SPH015" );
		security_message( port: 0, data: report );
		exit( 0 );
	}
}
if(cpe == "cpe:/o:huawei:usg6600_firmware"){
	if(IsMatchRegexp( version, "^V100R001C00" ) || IsMatchRegexp( version, "^V100R001C20" ) || IsMatchRegexp( version, "^V100R001C30" ) || IsMatchRegexp( version, "^V500R001C00" ) || IsMatchRegexp( version, "^V500R001C20" ) || IsMatchRegexp( version, "^V500R001C30" ) || IsMatchRegexp( version, "^V500R001C50" )){
		report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V500R001C60SPC500", fixed_patch: "V500R001SPH015" );
		security_message( port: 0, data: report );
		exit( 0 );
	}
...
if(cpe == "cpe:/o:huawei:usg9500_firmware"){
	if(IsMatchRegexp( version, "^V300R001C01" ) || IsMatchRegexp( version, "^V500R001C00" ) || IsMatchRegexp( version, "^V500R001C20" ) || IsMatchRegexp( version, "^V500R001C30" )){
		report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V500R001C60SPC500", fixed_patch: "V500R001SPH015" );
		security_message( port: 0, data: report );
		exit( 0 );
	}
