...
if(cpe == "cpe:/o:huawei:s12700_firmware"){
	if(IsMatchRegexp( version, "^V200R005C00SPC300" )){
...
if(cpe == "cpe:/o:huawei:s5700_firmware"){
	if(IsMatchRegexp( version, "^V200R001C00" ) || IsMatchRegexp( version, "^V200R002C00SPC100" ) || IsMatchRegexp( version, "^V200R003C00SPC300" ) || IsMatchRegexp( version, "^V200R005C00" )){
...
if(cpe == "cpe:/o:huawei:s6700_firmware"){
	if(IsMatchRegexp( version, "^V200R001C00" ) || IsMatchRegexp( version, "^V200R002C00" ) || IsMatchRegexp( version, "^V200R005C00" ) || IsMatchRegexp( version, "^V200R005C01" ) || IsMatchRegexp( version, "^V200R005C02" )){
		if(!patch || version_is_less( version: patch, test_version: "V200R005SPH010" )){
			report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_patch: "V200R005SPH010" );
			security_message( port: 0, data: report );
			exit( 0 );
...
if(IsMatchRegexp( cpe, "^cpe:/o:huawei:s[79]700_firmware" )){
	if(IsMatchRegexp( version, "^V200R001C00" ) || IsMatchRegexp( version, "^V200R002C00" ) || IsMatchRegexp( version, "^V200R003C00" ) || IsMatchRegexp( version, "^V200R005C00" )){
