if(description){
	...
	script_version( "2021-09-18T02:26:39+0000" );
	script_tag( name: "last_modification", value: "2021-09-18 02:26:39 +0000 (Sat, 18 Sep 2021)" );
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2019-1920" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'bzip2' package(s) announced via the EulerOS-SA-2019-1920 advisory." );
