if(description){
	...
	script_tag( name: "severity_date", value: "2016-07-12 13:52:00 +0000 (Tue, 12 Jul 2016)" );
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2019-1482" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'kernel' package(s) announced via the EulerOS-SA-2019-1482 advisory." );
...
A race condition issue leading to a use-after-free flaw was found in the way the raw packet sockets implementation in the Linux kernel networking subsystem handled synchronization while creating the TPACKET_V3 ring buffer. A local user able to open a raw packet socket (requires the CAP_NET_RAW ... [Please see the references for more information on the vulnerabilities]" );
