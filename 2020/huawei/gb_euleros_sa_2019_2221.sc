if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2019-2221" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'php' package(s) announced via the EulerOS-SA-2019-2221 advisory." );
...
ext/wddx/wddx.c in PHP before 5.6.28 and 7.x before 7.0.13 allows remote attackers to cause a denial of service (NULL pointer dereference) via ... [Please see the references for more information on the vulnerabilities]" );
