...
if( cpe == "cpe:/o:huawei:s12700_firmware" ){
	if(IsMatchRegexp( version, "^V200R005C00" ) || IsMatchRegexp( version, "^V200R006C00" ) || IsMatchRegexp( version, "^V200R006C01" ) || IsMatchRegexp( version, "^V200R007C00" ) || IsMatchRegexp( version, "^V200R007C01" ) || IsMatchRegexp( version, "^V200R007C20" ) || IsMatchRegexp( version, "^V200R008C00" ) || IsMatchRegexp( version, "^V200R008C06" ) || IsMatchRegexp( version, "^V200R009C00" ) || IsMatchRegexp( version, "^V200R010C00" )){
	...
	if( cpe == "cpe:/o:huawei:s7700_firmware" ){
		if(IsMatchRegexp( version, "^V200R001C00" ) || IsMatchRegexp( version, "^V200R001C01" ) || IsMatchRegexp( version, "^V200R002C00" ) || IsMatchRegexp( version, "^V200R003C00" ) || IsMatchRegexp( version, "^V200R005C00" ) || IsMatchRegexp( version, "^V200R006C00" ) || IsMatchRegexp( version, "^V200R006C01" ) || IsMatchRegexp( version, "^V200R007C00" ) || IsMatchRegexp( version, "^V200R007C01" ) || IsMatchRegexp( version, "^V200R008C00" ) || IsMatchRegexp( version, "^V200R008C06" ) || IsMatchRegexp( version, "^V200R009C00" ) || IsMatchRegexp( version, "^V200R010C00" )){
			if(!patch || version_is_less( version: patch, test_version: "V200R010SPH002" )){
				report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V200R010SPH002" );
				security_message( port: 0, data: report );
				exit( 0 );
		...
		if(cpe == "cpe:/o:huawei:s9700_firmware"){
			if(IsMatchRegexp( version, "^V200R001C00" ) || IsMatchRegexp( version, "^V200R001C01" ) || IsMatchRegexp( version, "^V200R002C00" ) || IsMatchRegexp( version, "^V200R003C00" ) || IsMatchRegexp( version, "^V200R005C00" ) || IsMatchRegexp( version, "^V200R006C00" ) || IsMatchRegexp( version, "^V200R006C01" ) || IsMatchRegexp( version, "^V200R007C00" ) || IsMatchRegexp( version, "^V200R007C01" ) || IsMatchRegexp( version, "^V200R008C00" ) || IsMatchRegexp( version, "^V200R009C00" ) || IsMatchRegexp( version, "^V200R010C00" )){
				if(!patch || version_is_less( version: patch, test_version: "V200R010SPH002" )){
					report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V200R010SPH002" );
					security_message( port: 0, data: report );
					exit( 0 );
