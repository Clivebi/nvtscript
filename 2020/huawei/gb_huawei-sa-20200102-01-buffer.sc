...
if( cpe == "cpe:/o:huawei:ar120-s_firmware" ){
	if(IsMatchRegexp( version, "^V200R006C10" ) || IsMatchRegexp( version, "^V200R007C00" ) || IsMatchRegexp( version, "^V200R008C20" ) || IsMatchRegexp( version, "^V200R008C50" )){
	...
	if( cpe == "cpe:/o:huawei:ar1200_firmware" ){
		if(IsMatchRegexp( version, "^V200R003C01" ) || IsMatchRegexp( version, "^V200R005C20" ) || IsMatchRegexp( version, "^V200R006C10" ) || IsMatchRegexp( version, "^V200R007C00" ) || IsMatchRegexp( version, "^V200R008C20" ) || IsMatchRegexp( version, "^V200R008C50" )){
			if(!patch || version_is_less( version: patch, test_version: "V200R009C00SPC500" )){
				report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V200R009C00SPC500" );
				security_message( port: 0, data: report );
				exit( 0 );
			...
			if( cpe == "cpe:/o:huawei:ar150_firmware" ){
				...
				if( cpe == "cpe:/o:huawei:ar150-s_firmware" ){
					...
					if( cpe == "cpe:/o:huawei:ar160_firmware" ){
						if(IsMatchRegexp( version, "^V200R005C20" ) || IsMatchRegexp( version, "^V200R006C10" ) || IsMatchRegexp( version, "^V200R007C00" ) || IsMatchRegexp( version, "^V200R008C20" ) || IsMatchRegexp( version, "^V200R008C50" )){
							if(!patch || version_is_less( version: patch, test_version: "V200R009C00SPC500" )){
								report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V200R009C00SPC500" );
								security_message( port: 0, data: report );
								exit( 0 );
							...
							if( cpe == "cpe:/o:huawei:ar200-s_firmware" ){
								...
								if( cpe == "cpe:/o:huawei:ar2200_firmware" ){
									...
									if( cpe == "cpe:/o:huawei:ar2200-s_firmware" ){
										if(IsMatchRegexp( version, "^V200R003C01" ) || IsMatchRegexp( version, "^V200R005C20" ) || IsMatchRegexp( version, "^V200R006C10" ) || IsMatchRegexp( version, "^V200R008C20" ) || IsMatchRegexp( version, "^V200R008C50" )){
											if(!patch || version_is_less( version: patch, test_version: "V200R009C00SPC500" )){
												report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V200R009C00SPC500" );
												security_message( port: 0, data: report );
												exit( 0 );
										...
										if( cpe == "cpe:/o:huawei:ar3200_firmware" ){
											...
											if( cpe == "cpe:/o:huawei:ar3600_firmware" ){
												...
												if( cpe == "cpe:/o:huawei:ips_module_firmware" ){
													if(IsMatchRegexp( version, "^V500R001C20" ) || IsMatchRegexp( version, "^V500R001C30" )){
													...
													if( cpe == "cpe:/o:huawei:ngfw_module_firmware" ){
														if(IsMatchRegexp( version, "^V500R001C20" ) || IsMatchRegexp( version, "^V500R002C00" )){
															if(!patch || version_is_less( version: patch, test_version: "V500R002C00SPC200" )){
																report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V500R002C00SPC200" );
																security_message( port: 0, data: report );
																exit( 0 );
															...
															if( cpe == "cpe:/o:huawei:nip6600_firmware" ){
																...
																if( cpe == "cpe:/o:huawei:netengine16ex_firmware" ){
																	...
																	if( cpe == "cpe:/o:huawei:s5700_firmware" ){
																		if(IsMatchRegexp( version, "^V200R005C00" ) || IsMatchRegexp( version, "^V200R005C02" ) || IsMatchRegexp( version, "^V200R005C03" ) || IsMatchRegexp( version, "^V200R006C00" ) || IsMatchRegexp( version, "^V200R007C00" ) || IsMatchRegexp( version, "^V200R008C00" ) || IsMatchRegexp( version, "^V200R010C00" ) || IsMatchRegexp( version, "^V200R011C00" )){
																		...
																		if( cpe == "cpe:/o:huawei:s6700_firmware" ){
																			if(IsMatchRegexp( version, "^V200R005C00" ) || IsMatchRegexp( version, "^V200R005C01" ) || IsMatchRegexp( version, "^V200R005C02" ) || IsMatchRegexp( version, "^V200R008C00" ) || IsMatchRegexp( version, "^V200R010C00" ) || IsMatchRegexp( version, "^V200R011C00" )){
																				if(!patch || version_is_less( version: patch, test_version: "V200R011C10" )){
																					report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V200R011C10" );
																					security_message( port: 0, data: report );
																					exit( 0 );
																				...
																				if( cpe == "cpe:/o:huawei:srg2300_firmware" ){
																					...
																					if( cpe == "cpe:/o:huawei:srg3300_firmware" ){
																						...
																						if( cpe == "cpe:/o:huawei:antiddos8000_firmware" ){
																							if(IsMatchRegexp( version, "^V500R001C20" ) || IsMatchRegexp( version, "^V500R001C60" ) || IsMatchRegexp( version, "^V500R005C00" )){
																							...
																							if( cpe == "cpe:/o:huawei:usg6300_firmware" ){
																								...
																								if( cpe == "cpe:/o:huawei:usg6500_firmware" ){
																									...
																									if(cpe == "cpe:/o:huawei:usg6600_firmware"){
																										if(IsMatchRegexp( version, "^V500R001C20" ) || IsMatchRegexp( version, "^V500R001C30" ) || IsMatchRegexp( version, "^V500R001C50" ) || IsMatchRegexp( version, "^V500R001C60" ) || IsMatchRegexp( version, "^V500R005C00" )){
																											if(!patch || version_is_less( version: patch, test_version: "V500R002C00SPC200" )){
																												report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V500R002C00SPC200" );
																												security_message( port: 0, data: report );
																												exit( 0 );
