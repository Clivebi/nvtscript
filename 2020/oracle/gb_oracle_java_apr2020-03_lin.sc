if(description){
	...
	script_name( "Oracle Java SE Security Update (cpuapr2020 - 03) - Linux" );
...
vers = infos["version"];
path = infos["location"];
if(version_in_range( version: vers, test_version: "11.0", test_version2: "11.0.6" ) || version_is_equal( version: vers, test_version: "14.0" )){
