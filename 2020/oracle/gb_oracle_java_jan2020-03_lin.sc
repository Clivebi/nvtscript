if(description){
	...
	script_name( "Oracle Java SE Security Update (cpujan2020 - 03) - Linux" );
...
vers = infos["version"];
path = infos["location"];
if(version_in_range( version: vers, test_version: "11.0", test_version2: "11.0.5" ) || version_in_range( version: vers, test_version: "13.0", test_version2: "13.0.1" )){
