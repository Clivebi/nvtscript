if(description){
	...
	script_name( "Oracle Java SE Security Update (cpuoct2020 - 02) - Linux" );
...
vers = infos["version"];
path = infos["location"];
if(version_in_range( version: vers, test_version: "11.0", test_version2: "11.0.8" ) || version_is_equal( version: vers, test_version: "15.0" )){
