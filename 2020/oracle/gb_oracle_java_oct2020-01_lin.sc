if(description){
	...
	script_cve_id( "CVE-2020-14792", "CVE-2020-14781", "CVE-2020-14782", "CVE-2020-14797", "CVE-2020-14779", "CVE-2020-14796", "CVE-2020-14798" );
	...
	script_name( "Oracle Java SE Security Update (cpuoct2020 - 01) - Linux" );
...
vers = infos["version"];
path = infos["location"];
if(version_in_range( version: vers, test_version: "1.8.0", test_version2: "1.8.0.261" ) || version_in_range( version: vers, test_version: "1.7.0", test_version2: "1.7.0.271" ) || version_in_range( version: vers, test_version: "11.0", test_version2: "11.0.8" ) || version_is_equal( version: vers, test_version: "15.0" )){
