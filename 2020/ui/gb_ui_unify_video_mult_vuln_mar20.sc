...
if(description){
	...
	script_tag( name: "severity_vector", value: "CVSS:3.1/AV:A/AC:L/PR:H/UI:N/S:C/C:H/I:H/A:H" );
	script_tag( name: "severity_origin", value: "NVD" );
	script_tag( name: "severity_date", value: "2020-04-03 15:00:00 +0000 (Fri, 03 Apr 2020)" );
	...
	script_dependencies( "gb_ubnt_unifi_video_detect.sc", "os_detection.sc" );
