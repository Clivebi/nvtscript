...
if(!IsMatchRegexp( type, "^(400|450|600|650)$" )){
	exit( 99 );
}
...
if(IsMatchRegexp( version, "^5\\.0" ) && version_is_less( version: version, test_version: "5.0.19" )){
	report = report_fixed_ver( installed_version: version, fixed_version: "5.0.19" );
	security_message( port: 0, data: report );
	exit( 0 );
}
if(IsMatchRegexp( version, "^6\\.0" ) && version_is_less( version: version, test_version: "6.0.9" )){
