...
if(description){
	...
	script_tag( name: "severity_date", value: "2020-12-23 15:38:00 +0000 (Wed, 23 Dec 2020)" );
	...
	script_dependencies( "gb_apache_tomee_server_detect.sc" );
...
if(version_in_range( version: version, test_version: "1.0.0", test_version2: "1.7.5" ) || version_in_range( version: version, test_version: "7.0.0.M1", test_version2: "7.0.8" )){
