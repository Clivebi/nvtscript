...
if(description){
	...
	script_tag( name: "summary", value: "jQuery is prone to a cross-site scripting (XSS) vulnerability in
  jQuery.htmlPrefilter and related methods." );
	script_tag( name: "vuldetect", value: "Checks if a vulnerable version is present on the target host." );
	script_tag( name: "insight", value: "Passing HTML from untrusted sources - even after sanitizing it -
...
if(version_is_greater_equal( version: version, test_version: "1.2" ) && version_is_less( version: version, test_version: "3.5.0" )){
