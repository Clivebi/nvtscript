if(description){
	...
	script_tag( name: "summary", value: "The WordPress plugin TablePress is prone to a CSV injection
  vulnerability." );
	script_tag( name: "impact", value: "Successful exploitation would allow an attacker to force an
  unknown user to execute code on the affected device." );
