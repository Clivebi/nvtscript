if(description){
	...
	script_name( "Sympa <= 6.2.59 Privilege Escalation Vulnerability" );
	...
	script_tag( name: "insight", value: "The vulnerability is exploitable by modifying a Sympa
  configuration file." );
	script_tag( name: "impact", value: "Successful exploitation would allow an attacker to gain complete
  control over the target system." );
	script_tag( name: "affected", value: "Sympa through version 6.2.59." );
	...
	script_xref( name: "URL", value: "https://github.com/sympa-community/sympa/issues/946" );
	script_xref( name: "URL", value: "https://github.com/sympa-community/sympa/pull/1015" );
	exit( 0 );
}
...
if(version_is_less_equal( version: version, test_version: "6.2.59" )){
