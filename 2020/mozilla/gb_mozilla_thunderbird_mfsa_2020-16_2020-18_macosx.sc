...
if(description){
	...
	script_name( "Mozilla Thunderbird Security Update (mfsa_2020-16_2020-18) - Mac OS X" );
  ...
  on affected system." );
	script_tag( name: "affected", value: "Mozilla Thunderbird version before 68.8." );
	script_tag( name: "solution", value: "Update to Mozilla Thunderbird version 68.8
  or later." );
