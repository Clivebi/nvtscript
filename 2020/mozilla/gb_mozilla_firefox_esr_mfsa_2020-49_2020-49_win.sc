...
if(description){
	...
	script_name( "Mozilla Firefox ESR Security Update (mfsa_2020-49_2020-49) - Windows" );
	script_tag( name: "summary", value: "Mozilla Firefox ESR is prone to code execution vulnerability." );
  ...
  78.4.1 on Windows." );
	script_tag( name: "solution", value: "Update to Mozilla Firefox ESR version 78.4.1
...
vers = infos["version"];
path = infos["location"];
if(version_is_less( version: vers, test_version: "78.4.1" )){
	report = report_fixed_ver( installed_version: vers, fixed_version: "78.4.1", install_path: path );
