...
if(description){
	...
	script_name( "Mozilla Firefox ESR Security Update (mfsa_2020-54_2020-56) - Mac OS X" );
  ...
  78.6." );
	script_tag( name: "solution", value: "Update to Mozilla Firefox ESR version 78.6
  or later." );
