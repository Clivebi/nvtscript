...
if(description){
	...
	script_name( "Mozilla Firefox ESR Security Update (mfsa2020-25) - Mac OS X" );
  ...
  attackers to conduct a denial-of-service or out-of-bounds read on affected system." );
	script_tag( name: "affected", value: "Mozilla Firefox ESR version before 68.10." );
	script_tag( name: "solution", value: "Update to Mozilla Firefox ESR version 68.10
  or later." );
...
vers = infos["version"];
path = infos["location"];
if(version_is_less( version: vers, test_version: "68.10" )){
	report = report_fixed_ver( installed_version: vers, fixed_version: "68.10", install_path: path );
