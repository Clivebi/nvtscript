...
if(description){
	...
	script_name( "Mozilla Firefox ESR Security Update (mfsa_2020-08_2020-09) - Mac OS X" );
  ...
  of service condition." );
	...
	script_tag( name: "solution", value: "Update to Mozilla Firefox ESR version 68.6
  or later." );
