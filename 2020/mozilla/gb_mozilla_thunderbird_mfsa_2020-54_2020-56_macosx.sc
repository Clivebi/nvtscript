...
if(description){
	...
	script_name( "Mozilla Thunderbird Security Update (mfsa_2020-54_2020-56) - Mac OS X" );
  ...
  78.6." );
	script_tag( name: "solution", value: "Update to Mozilla Thunderbird version 78.6
  or later." );
...
vers = infos["version"];
path = infos["location"];
if(version_is_less( version: vers, test_version: "78.6" )){
	report = report_fixed_ver( installed_version: vers, fixed_version: "78.6", install_path: path );
