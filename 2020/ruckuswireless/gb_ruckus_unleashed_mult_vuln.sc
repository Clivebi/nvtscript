...
if(description){
	...
	script_cve_id( "CVE-2019-19834", "CVE-2019-19835", "CVE-2019-19836", "CVE-2019-19837", "CVE-2019-19838", "CVE-2019-19839", "CVE-2019-19840", "CVE-2019-19841", "CVE-2019-19842", "CVE-2019-19843" );
	...
	script_dependencies( "gb_ruckus_unleashed_http_detect.sc" );
...
if(IsMatchRegexp( res, "^HTTP/1\\.[01] 200" ) && ContainsString( res, "all_powerful_login_password" )){
	report = "It was possible to obtain sensitive information (e.g. admin credentials) at " + http_report_vuln_url( port: port, url: url, url_only: TRUE );
