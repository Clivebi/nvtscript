...
if(description){
	...
	script_cve_id( "CVE-2020-6493", "CVE-2020-6494", "CVE-2020-6495", "CVE-2020-6496", "CVE-2020-6497", "CVE-2020-6498" );
	...
	script_name( "Google Chrome Security Update (stable-channel-update-for-desktop-2020-06) - Windows" );
