...
if(description){
	...
	script_name( "Google Chrome Security Update (stable-channel-update-for-desktop_21-2020-09) - Windows" );
  ...
  condition." );
	...
	script_tag( name: "solution", value: "Update to Google Chrome version 85.0.4183.121 or later." );
