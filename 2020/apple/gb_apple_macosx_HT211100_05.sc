if(description){
	...
	script_tag( name: "severity_date", value: "2020-04-02 16:29:00 +0000 (Thu, 02 Apr 2020)" );
	script_tag( name: "creation_date", value: "2020-03-26 12:25:29 +0530 (Thu, 26 Mar 2020)" );
	script_name( "Apple Mac OS X Security Update (HT211100)-05" );
  ...
  Apple Mac OS X 10.14.x or upgrade to version 10.15.4 or later." );
