if(description){
	...
	script_cve_id( "CVE-2020-9817", "CVE-2020-9816", "CVE-2020-9830", "CVE-2020-9833", "CVE-2020-9832", "CVE-2020-9834", "CVE-2020-9811", "CVE-2020-9812", "CVE-2020-9841", "CVE-2020-9789", "CVE-2020-9790", "CVE-2019-20044", "CVE-2020-9808", "CVE-2020-9809", "CVE-2020-9847", "CVE-2020-9822", "CVE-2020-9821", "CVE-2020-9826", "CVE-2020-9797", "CVE-2020-9839", "CVE-2019-14868", "CVE-2020-9813", "CVE-2020-9814", "CVE-2020-9795" );
	script_tag( name: "cvss_base", value: "9.3" );
	script_tag( name: "cvss_base_vector", value: "AV:N/AC:M/Au:N/C:C/I:C/A:C" );
	script_tag( name: "last_modification", value: "2021-10-06 10:22:49 +0000 (Wed, 06 Oct 2021)" );
	script_tag( name: "severity_vector", value: "CVSS:3.1/AV:L/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:H" );
	script_tag( name: "severity_origin", value: "NVD" );
	script_tag( name: "severity_date", value: "2021-05-05 18:15:00 +0000 (Wed, 05 May 2021)" );
	script_tag( name: "creation_date", value: "2020-05-27 12:17:06 +0530 (Wed, 27 May 2020)" );
	script_name( "Apple Mac OS X Security Update (HT211170)-04" );
