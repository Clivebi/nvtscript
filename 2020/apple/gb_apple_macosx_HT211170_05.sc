if(description){
	...
	script_tag( name: "severity_date", value: "2020-10-29 19:38:00 +0000 (Thu, 29 Oct 2020)" );
	script_tag( name: "creation_date", value: "2020-05-27 12:17:09 +0530 (Wed, 27 May 2020)" );
	script_name( "Apple Mac OS X Security Update (HT211170 - 05)" );
  ...
  Mac OS X version 10.13.x and 10.14.x." );
