...
if(description){
	...
	script_cve_id( "CVE-2020-9784", "CVE-2020-3901", "CVE-2020-3887", "CVE-2020-3895", "CVE-2020-3900", "CVE-2020-3894", "CVE-2020-3897", "CVE-2020-9783", "CVE-2020-3899", "CVE-2020-3902", "CVE-2020-3885" );
	...
	script_name( "Apple Safari Security Update (HT211104)" );
  ...
  site scripting attacks." );
	...
	script_tag( name: "solution", value: "Update to Apple Safari 13.1 or later." );
...
vers = infos["version"];
path = infos["location"];
if(version_is_less( version: vers, test_version: "13.1" )){
	report = report_fixed_ver( installed_version: vers, fixed_version: "13.1", install_path: path );
