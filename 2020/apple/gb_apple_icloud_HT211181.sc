...
if(description){
	...
	script_name( "Apple iCloud Security Update (HT211181)" );
  ...
  restrictions, and launch denial of service attacks." );
	...
	script_tag( name: "solution", value: "Update to Apple iCloud 7.19 or later." );
...
vers = infos["version"];
path = infos["location"];
if(version_is_less( version: vers, test_version: "7.19" )){
	report = report_fixed_ver( installed_version: vers, fixed_version: "7.19", install_path: path );
