if(description){
	...
	script_cve_id( "CVE-2020-9785", "CVE-2020-9769", "CVE-2020-3889", "CVE-2020-3883", "CVE-2020-3881", "CVE-2019-19232", "CVE-2019-14615", "CVE-2020-3903", "CVE-2020-9776", "CVE-2020-9773", "CVE-2020-3913" );
	script_tag( name: "cvss_base", value: "9.3" );
	script_tag( name: "cvss_base_vector", value: "AV:N/AC:M/Au:N/C:C/I:C/A:C" );
	script_tag( name: "last_modification", value: "2021-10-06 10:22:49 +0000 (Wed, 06 Oct 2021)" );
	script_tag( name: "severity_vector", value: "CVSS:3.1/AV:L/AC:L/PR:N/UI:R/S:U/C:H/I:H/A:H" );
	script_tag( name: "severity_origin", value: "NVD" );
	script_tag( name: "severity_date", value: "2020-04-02 19:48:00 +0000 (Thu, 02 Apr 2020)" );
	script_tag( name: "creation_date", value: "2020-03-26 12:25:20 +0530 (Thu, 26 Mar 2020)" );
	script_name( "Apple Mac OS X Security Update (HT211100)-03" );
  ...
  information and elevate privileges." );
	...
	script_tag( name: "solution", value: "Update to Apple Mac OS X 10.15.4 or later." );
