...
if(!get_kb_item( "cisco/cucmim/detected" )){
	exit( 0 );
}
...
log_message( data: build_detection_report( app: "Cisco Unified Communications Manager IM and Presence", version: vers, install: "ssh", cpe: cpe, concluded: "show version active" ), port: 0 );
exit( 0 );
