...
if(ContainsString( res, "Log In | Puppet Enterprise" ) && ContainsString( res, "usernameError" )){
	version = "unknown";
	...
	log_message( data: build_detection_report( app: "Puppet Enterprise", version: version, install: "/", cpe: cpe, concluded: vers[0] ), port: port );
	exit( 0 );
}
exit( 0 );
