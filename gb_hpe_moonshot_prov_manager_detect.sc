...
if(ContainsString( res, "<title>Moonshot Provisioning</title>" ) && ContainsString( res, "UserLoginPage()" )){
	version = "unknown";
	...
	log_message( data: build_detection_report( app: "HPE Moonshot Provision Manager", version: version, install: "/", cpe: cpe ), port: port );
	exit( 0 );
}
exit( 0 );
