...
if(!banner || !IsMatchRegexp( banner, "Model name\\s*:\\s*MiiNePort " )){
	exit( 0 );
}
version = "unknown";
build = "unknown";
...
log_message( data: build_detection_report( app: "Moxa MiiNePort " + model, version: version, install: port + "/tcp", cpe: cpe, concluded: vers[0], extra: "Build: " + build ), port: port );
exit( 0 );
