...
if(strlen( ffVerCmd ) > 0 && !ContainsString( ffVerCmd, "does not exist" )){
...
if(strlen( smVerCmd ) > 0 && !ContainsString( smVerCmd, "does not exist" )){
...
if(strlen( tbVerCmd ) > 0 && !ContainsString( tbVerCmd, "does not exist" )){
