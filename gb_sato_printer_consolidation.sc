if(description){
	...
	script_dependencies( "gb_sato_printer_http_detect.sc", "gb_sato_printer_snmp_detect.sc", "global_settings.sc" );
...
os_register_and_report( os: os_name, cpe: os_cpe, desc: "SATO Printer Detection Consolidation", runs_key: "unixoide" );
