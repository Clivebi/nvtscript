...
if(description){
  ...
  and the Rugged Operating System including the version number and exposed services." );
	...
	script_dependencies( "gb_siemens_ruggedcom_snmp_detect.sc", "gb_siemens_ruggedcom_telnet_detect.sc" );
	if(FEED_NAME == "GSF" || FEED_NAME == "SCM"){
		script_dependencies( "gsf/gb_siemens_ruggedcom_http_detect.sc" );
	}
