...
if(IsMatchRegexp( buf, "Server: *Oracle_Web_Listener" )){
	...
	register_and_report_cpe( app: "Oracle Web Listener", ver: version, concluded: ver[0], base: CPE, expr: "([0-9.]+)", insloc: port + "/tcp", regPort: port, regService: "www" );
}
exit( 0 );
