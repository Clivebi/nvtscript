if(description){
	...
	script_cve_id( "CVE-2009-0556", "CVE-2009-0220", "CVE-2009-0221", "CVE-2009-0222", "CVE-2009-0223", "CVE-2009-0224", "CVE-2009-0225", "CVE-2009-0226", "CVE-2009-0227", "CVE-2009-1128", "CVE-2009-1129", "CVE-2009-1130", "CVE-2009-1131", "CVE-2009-1137", "CVE-2009-0202" );
	script_bugtraq_id( 34351, 34833, 34835, 34831, 34834, 34879, 34880, 34881, 34882, 34837, 34839, 34840, 34841, 34876, 35275 );
...
if(officeVer && IsMatchRegexp( officeVer, "^(9|10|11|12)\\." )){
	if(ppVer){
		if(version_in_range( version: ppVer, test_version: "9.0", test_version2: "9.0.0.8977" ) || version_in_range( version: ppVer, test_version: "10.0", test_version2: "10.0.6852.0" ) || version_in_range( version: ppVer, test_version: "11.0", test_version2: "11.0.8306.0" ) || version_in_range( version: ppVer, test_version: "12.0", test_version2: "12.0.6500.4999" )){
...
if(( ppVer && IsMatchRegexp( ppVer, "^12\\." ) ) || ppviewVer){
...
if(ppviewVer){
	if(version_in_range( version: ppviewVer, test_version: "11.0", test_version2: "11.0.8304.0" ) || version_in_range( version: ppviewVer, test_version: "12.0", test_version2: "12.0.6502.4999" )){
		security_message( port: 0, data: "The target host was found to be vulnerable" );
	}
}
