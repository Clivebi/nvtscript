...
vers = infos["version"];
path = infos["location"];
if(version_is_less_equal( version: vers, test_version: "1.3.41" ) || version_in_range( version: vers, test_version: "2.0", test_version2: "2.0.63" ) || version_in_range( version: vers, test_version: "2.2", test_version2: "2.2.13" )){
