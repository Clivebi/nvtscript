...
if(!banner || !ContainsString( banner, "dwhttpd" )){
	exit( 0 );
}
url = NASLString( "/ab2/Help_C/@Ab2HelpSearch?scope=HELP&DwebQuery=%3Cscript%3Ealert(%27VT-XSS-Test%27)%3C/script%3E&Search=+Search+" );
