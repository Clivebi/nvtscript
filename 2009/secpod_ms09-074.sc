...
if(( hotfix_missing( name: "961082" ) == 0 ) || ( hotfix_missing( name: "961083" ) == 0 ) || ( hotfix_missing( name: "961079" ) == 0 )){
	exit( 0 );
}
...
for path in make_list( "\\MS Project",
	...
	if(version_in_range( version: dllVer, test_version: "9.0", test_version2: "9.0.2001.1108" ) || version_in_range( version: dllVer, test_version: "10.0", test_version2: "10.0.2108.2215" ) || version_in_range( version: dllVer, test_version: "11.0", test_version2: "11.3.2008.1716" )){
