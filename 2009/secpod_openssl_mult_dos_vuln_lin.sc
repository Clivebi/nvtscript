...
vers = infos["version"];
path = infos["location"];
if(version_in_range( version: vers, test_version: "0.9.8", test_version2: "0.9.8k" ) || ( IsMatchRegexp( vers, "^1\\.0\\.0" ) && version_is_less_equal( version: vers, test_version: "1.0.0beta2" ) )){
