...
for item in registry_enum_keys( key: key ) {
	...
	if(jswsName && IsMatchRegexp( jswsName, "Sun (ONE |Java System )Web Server" )){
...
if(jswsVer && IsMatchRegexp( jswsVer, "^[67]" )){
	if(version_in_range( version: jswsVer, test_version: "6.1", test_version2: "6.1.SP11" ) || version_in_range( version: jswsVer, test_version: "7.0", test_version2: "7.0.5" )){
