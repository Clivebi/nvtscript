...
if(!version = eregmatch( string: banner, pattern: "WarFTPd ([0-9.]+[-RC0-9]*)" )){
	exit( 0 );
}
version[1] = ereg_replace( pattern: "-", string: version[1], replace: "." );
if(version_is_equal( version: version[1], test_version: "1.82.00.RC11" ) || version_is_equal( version: version[1], test_version: "1.82.00.RC12" )){
