...
if(hotfix_check_sp( winVista: 2, win2008: 2 ) > 0){
	if(version_in_range( version: dllVer, test_version: "6.0.6000.16000", test_version2: "6.0.6000.16819" ) || version_in_range( version: dllVer, test_version: "6.0.6000.20000", test_version2: "6.0.6000.21009" )){
		security_message( port: 0, data: "The target host was found to be vulnerable" );
		exit( 0 );
	}
	...
	if(ContainsString( SP, "Service Pack 1" )){
		if(version_in_range( version: dllVer, test_version: "6.0.6001.18000", test_version2: "6.0.6001.18214" ) || version_in_range( version: dllVer, test_version: "6.0.6001.22000", test_version2: "6.0.6001.22375" )){
			security_message( port: 0, data: "The target host was found to be vulnerable" );
		}
	}
}
