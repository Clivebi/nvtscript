if(description){
	...
	script_dependencies( "PowerPhlogger_detect.sc" );
...
if(!version = get_kb_item( NASLString( "www/", port, "/PowerPhlogger" ) )){
	exit( 0 );
}
...
if(!isnull( vers ) && !ContainsString( "unknown", vers )){
	if(version_is_equal( version: vers, test_version: "2.2.5" ) || version_is_equal( version: vers, test_version: "2.2.2.a" ) || version_is_equal( version: vers, test_version: "2.2.1" ) || version_is_equal( version: vers, test_version: "2.0.9" )){
