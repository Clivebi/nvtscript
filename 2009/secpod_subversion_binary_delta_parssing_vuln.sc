...
if(description){
	...
	script_dependencies( "secpod_subversion_detect.sc" );
...
if(version_is_less( version: version, test_version: "1.5.7" ) || version_in_range( version: version, test_version: "1.6", test_version2: "1.6.3" )){
