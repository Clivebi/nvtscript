if(description){
	...
	script_dependencies( "gb_avant_browser_detect.sc" );
...
if(version_is_equal( version: abVer, test_version: "11.7.0.35" ) || version_is_equal( version: abVer, test_version: "11.7.0.36" )){
