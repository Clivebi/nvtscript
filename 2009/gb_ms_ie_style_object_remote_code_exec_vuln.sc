...
if( hotfix_check_sp( win2k: 5 ) > 0 ){
	if(version_in_range( version: vers, test_version: "5.0", test_version2: "5.0.3882.2699" ) || version_in_range( version: vers, test_version: "6.0", test_version2: "6.0.2800.1641" )){
	...
	if( hotfix_check_sp( xp: 4 ) > 0 ){
		...
		if( ContainsString( SP, "Service Pack 2" ) ){
			if(version_in_range( version: vers, test_version: "6.0.2900.0000", test_version2: "6.0.2900.3639" ) || version_in_range( version: vers, test_version: "7.0", test_version2: "7.0.6000.21128" ) || version_in_range( version: vers, test_version: "8.0", test_version2: "8.0.6001.18853" )){
				security_message( port: 0, data: "The target host was found to be vulnerable" );
			}
			exit( 0 );
		}
			...
			if(ContainsString( SP, "Service Pack 3" )){
				if(version_in_range( version: vers, test_version: "6.0.2900.0000", test_version2: "6.0.2900.5896" ) || version_in_range( version: vers, test_version: "7.0", test_version2: "7.0.6000.16944" ) || version_in_range( version: vers, test_version: "7.0.6000.20000", test_version2: "7.0.6000.21147" ) || version_in_range( version: vers, test_version: "8.0", test_version2: "8.0.6001.18853" ) || version_in_range( version: vers, test_version: "8.0.6001.22000", test_version2: "8.0.6001.22944" )){
					security_message( port: 0, data: "The target host was found to be vulnerable" );
				}
				exit( 0 );
			}
		...
		if(hotfix_check_sp( win2003: 3 ) > 0){
			...
			if(ContainsString( SP, "Service Pack 2" )){
				if(version_in_range( version: vers, test_version: "6.0", test_version2: "6.0.3790.4610" ) || version_in_range( version: vers, test_version: "7.0", test_version2: "7.0.6000.16944" ) || version_in_range( version: vers, test_version: "7.0.6000.20000", test_version2: "7.00.6000.21147" ) || version_in_range( version: vers, test_version: "8.0.6001.00000", test_version2: "8.0.6001.18853" )){
					security_message( port: 0, data: "The target host was found to be vulnerable" );
				}
				exit( 0 );
			}
...
if( hotfix_check_sp( winVista: 3 ) > 0 ){
	...
	if(ContainsString( SP, "Service Pack 1" )){
		if(version_in_range( version: dllVer, test_version: "7.0", test_version2: "7.0.6001.18348" ) || version_in_range( version: dllVer, test_version: "8.0", test_version2: "8.0.6001.18864" )){
			security_message( port: 0, data: "The target host was found to be vulnerable" );
		}
		exit( 0 );
	}
