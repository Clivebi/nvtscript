...
if(description){
	...
	script_name( "Apache Struts Security Update (S2-002, S2-003)" );
	...
	script_xref( name: "URL", value: "http://issues.apache.org/struts/browse/WW-2414" );
	script_xref( name: "URL", value: "http://issues.apache.org/struts/browse/WW-2427" );
	script_tag( name: "summary", value: "Apache Struts is prone to multiple vulnerabilities." );
	script_tag( name: "vuldetect", value: "Checks if a vulnerable version is present on the target host." );
	script_tag( name: "insight", value: "- CVE-2008-6504: OGNL provides, among other features, extensive
  ...
  - CVE-2008-6682: This flaw is due to improper sanitization of the user supplied input in '<s:url>'
  and '<s:a>' tag which doesn't encode the URL parameter when specified in the action attribute
