if(description){
	...
	script_dependencies( "secpod_eset_remote_administrator_detect.sc" );
...
if(( esetConsVer != NULL ) || ( esetServVer != NULL )){
	if(version_is_less( version: esetConsVer, test_version: "3.0.105" ) || version_is_less( version: esetServVer, test_version: "3.0.105" )){
