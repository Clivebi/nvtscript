if(description){
  ...
  Upgrade to Adobe Flash Player version 9.0.246.0 or 10.0.32.18 or later." );
	...
	script_dependencies( "gb_adobe_flash_player_detect_lin.sc", "gb_adobe_prdts_detect_lin.sc" );
...
if(playerVer != NULL){
	if(version_in_range( version: playerVer, test_version: "9.0", test_version2: "9.0.159.0" ) || version_in_range( version: playerVer, test_version: "10.0", test_version2: "10.0.22.87" )){
