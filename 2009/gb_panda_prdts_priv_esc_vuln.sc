...
cpe_list = make_list( "cpe:/a:pandasecurity:panda_av_pro_2010",
	 "cpe:/a:pandasecurity:panda_internet_security_2010",
	 "cpe:/a:pandasecurity:panda_global_protection_2010" );
...
path = infos["location"];
cpe = infos["cpe"];
if( ContainsString( cpe, "cpe:/a:pandasecurity:panda_av_pro_2010" ) ){
	...
	if( ContainsString( cpe, "cpe:/a:pandasecurity:panda_internet_security_2010" ) ){
		...
		if(ContainsString( cpe, "cpe:/a:pandasecurity:panda_global_protection_2010" )){
