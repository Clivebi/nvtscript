...
if( registry_key_exists( key: "SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\{DD4CEE59-5192-4CE1-8AFA-1CFA8EB37209}" ) ){
	if(hotfix_missing( name: "968078" ) == 0){
		exit( 0 );
	}
	if( version_in_range( version: fileVer, test_version: "5.0.5720", test_version2: "5.0.5720.171" ) ){
		...
		if( version_in_range( version: fileVer, test_version: "5.0.5721", test_version2: "5.0.5721.260" ) ){
			report = report_fixed_ver( installed_version: fileVer, vulnerable_range: "5.0.5721 - 5.0.5721.260" );
			security_message( port: 0, data: report );
		}
		else {
			if(version_in_range( version: fileVer, test_version: "5.0.5723", test_version2: "5.0.5723.510" )){
	...
	if(registry_key_exists( key: "SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Uninstall\\{0AC95D97-1B75-4AC7-B061-F21E379FF809}" )){
		if(hotfix_missing( name: "960995" ) == 0){
			exit( 0 );
		}
		if( version_in_range( version: fileVer, test_version: "4.0.3445", test_version2: "4.0.3445.908" ) ){
			...
			if(version_in_range( version: fileVer, test_version: "4.0.2167", test_version2: "4.0.2167.908" )){
