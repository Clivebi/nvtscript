...
if(description){
	...
	script_tag( name: "summary", value: "Coppermine Photo Gallery is prone to a cross-site scripting
  ...
  other attacks." );
	script_tag( name: "solution", value: "Update to version 1.4.22 or later." );
	script_tag( name: "affected", value: "Versions prior to Coppermine Photo Gallery 1.4.22
  are vulnerable." );
