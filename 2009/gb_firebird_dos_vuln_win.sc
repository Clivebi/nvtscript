if(description){
	...
	script_dependencies( "find_service.sc", "gb_firebird_detect_win.sc" );
...
if(!safe_checks() && get_port_state( firebird_port )){
	...
	if(firebird_soc){
		...
		send( socket: firebird_soc, data: NASLString( packet ) );
		close( firebird_soc );
		sleep( 10 );
...
if(version_in_range( version: ver, test_version: "1.5", test_version2: "1.5.5.4926" ) || version_in_range( version: ver, test_version: "2.0", test_version2: "2.0.5.13206" ) || version_in_range( version: ver, test_version: "2.1", test_version2: "2.1.2.18118" ) || version_in_range( version: ver, test_version: "2.5", test_version2: "2.5.0.23247" )){
	security_message( firebird_port );
}
