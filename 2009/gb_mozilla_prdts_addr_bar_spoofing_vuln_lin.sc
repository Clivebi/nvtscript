if(description){
	...
	script_dependencies( "gb_firefox_detect_lin.sc", "gb_seamonkey_detect_lin.sc" );
...
if(ffVer){
	if(version_is_equal( version: ffVer, test_version: "3.5.1" ) || version_is_equal( version: ffVer, test_version: "3.5.2" )){
