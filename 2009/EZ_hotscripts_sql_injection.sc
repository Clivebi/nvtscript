...
for dir in nasl_make_list_unique( "/ez", http_cgi_dirs( port: port ) ) {
	if(dir == "/"){
		dir = "";
	}
	url = NASLString( dir, "/showcategory.php?cid=-101+union+select+12345678987654321,12345678987654321,3,4,5--" );
