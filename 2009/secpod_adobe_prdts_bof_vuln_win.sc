...
if(IsMatchRegexp( vers, "^[7-9]\\." )){
	if(version_in_range( version: vers, test_version: "7.0", test_version2: "7.1.0" ) || version_in_range( version: vers, test_version: "8.0", test_version2: "8.1.3" ) || IsMatchRegexp( vers, "^9\\.0" )){
