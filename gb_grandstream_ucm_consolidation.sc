...
if(description){
	...
	script_dependencies( "gb_grandstream_ucm_sip_detect.sc" );
	if(FEED_NAME == "GSF" || FEED_NAME == "SCM"){
		script_dependencies( "gsf/gb_grandstream_ucm_http_detect.sc" );
	}
...
os_register_and_report( os: os_name, cpe: os_cpe, desc: "Grandstream UCM Detection Consolidation", runs_key: "unixoide" );
