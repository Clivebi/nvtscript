...
for dir in nasl_make_list_unique( "/", http_cgi_dirs( port: port ) ) {
	...
	if(ContainsString( res, "name=\"Generator\" content=\"Sitefinity" )){
		version = "unknown";
		...
		log_message( data: build_detection_report( app: "Sitefinity", version: version, install: install, cpe: cpe, concluded: vers[0] ), port: port );
		exit( 0 );
	}
}
exit( 0 );
