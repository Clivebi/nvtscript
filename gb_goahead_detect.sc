...
if(IsMatchRegexp( buf, "Server: *GoAhead-Webs" )){
	...
	register_and_report_cpe( app: "GoAhead", ver: version, concluded: ver[0], base: CPE, expr: "([0-9.]+)", insloc: port + "/tcp", regPort: port, regService: "www" );
}
exit( 0 );
