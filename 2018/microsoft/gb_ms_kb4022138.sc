...
if(IsMatchRegexp( ppviewVer, "^(14\\.)" ) && version_is_less( version: ppviewVer, test_version: "14.0.7214.5000" )){
	report = report_fixed_ver( file_checked: ppviewPath + "\\pptview.exe", file_version: ppviewVer, vulnerable_range: "14.0 - 14.0.7214.4999" );
