...
if(IsMatchRegexp( ppviewVer, "^12\\." ) && version_is_less( version: ppviewVer, test_version: "12.0.6805.5000" )){
	report = report_fixed_ver( file_checked: ppviewPath + "\\pptview.exe", file_version: ppviewVer, vulnerable_range: "12.0 - 12.0.6805.4999" );
