...
if(IsMatchRegexp( exeVer, "^(12\\.)" ) && version_is_less( version: exeVer, test_version: "12.0.6787.5000" )){
	report = report_fixed_ver( file_checked: exePath + "winword.exe", file_version: exeVer, vulnerable_range: "12.0 - 12.0.6787.4999" );
