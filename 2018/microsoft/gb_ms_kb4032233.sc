...
for key in key_list {
	...
	if(msPath){
		...
		if(IsMatchRegexp( offdllVer, "^16\\." ) && version_is_less( version: offdllVer, test_version: "16.0.4732.1000" )){
			report = report_fixed_ver( file_checked: offPath + "\\Mso.dll", file_version: offdllVer, vulnerable_range: "16.0 - 16.0.4732.999" );
