...
if(IsMatchRegexp( officeVer, "^16\\." )){
	...
	for key in key_list {
		...
		if(propath){
			...
			if(IsMatchRegexp( offexeVer, "^16\\." ) && version_is_less( version: offexeVer, test_version: "16.0.4690.1000" )){
				report = report_fixed_ver( file_checked: offPath + "\\graph.exe", file_version: offexeVer, vulnerable_range: "16.0 - 16.0.4690.0999" );
