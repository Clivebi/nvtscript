...
if(IsMatchRegexp( shareVer, "^(14\\.)" )){
	dllVer = fetch_file_version( sysPath: path, file_name: "\\14.0\\WebServices\\WordServer\\Core\\oartserver.dll" );
	if(dllVer){
		if(version_in_range( version: dllVer, test_version: "14.0", test_version2: "14.0.7210.4999" )){
			report = report_fixed_ver( file_checked: path + "\\14.0\\WebServices\\WordServer\\Core\\oartserver.dll", file_version: dllVer, vulnerable_range: "14.0 - 14.0.7210.4999" );
