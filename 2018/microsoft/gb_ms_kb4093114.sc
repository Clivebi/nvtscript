if(description){
	...
	script_tag( name: "severity_date", value: "2018-05-17 17:44:00 +0000 (Thu, 17 May 2018)" );
...
if(version_is_less( version: fileVer, test_version: "11.0.9600.18978" )){
	report = report_fixed_ver( file_checked: sysPath + "\\urlmon.dll", file_version: fileVer, vulnerable_range: "Less than 11.0.9600.18978" );
