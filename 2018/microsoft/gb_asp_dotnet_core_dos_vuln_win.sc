...
path = infos["location"];
if(!coreVers || !IsMatchRegexp( coreVers, "^(1\\.[01]|2\\.0)" )){
	exit( 0 );
}
...
if( corerunVer ){
	if( version_in_range( version: corerunVer, test_version: "1.0", test_version2: "1.0.9" ) ){
		...
		if( version_in_range( version: corerunVer, test_version: "1.1", test_version2: "1.1.6" ) ){
			fix = "1.1.7";
		}
		else {
			if(version_in_range( version: corerunVer, test_version: "2.0", test_version2: "2.0.5" )){
				fix = "2.0.6";
			}
		}
	}
	...
	if(codesdkVer){
		if( version_in_range( version: codesdkVer, test_version: "1.1", test_version2: "1.1.7" ) ){
			...
			if(version_in_range( version: codesdkVer, test_version: "2.1", test_version2: "2.1.100" )){
				fix1 = "2.1.101";
			}
		}
	}
