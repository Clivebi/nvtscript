...
if(hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2, win8_1: 1, win8_1x64: 1, win2012R2: 1, win2008: 3, win2008x64: 3, win2016: 1, win10: 1, win10x64: 1 ) <= 0){
	exit( 0 );
}
...
if( ( override == 1 && overridemask == 1 ) || ( override == 3 && overridemask == 3 ) ){
	...
	if(( override == 0 && overridemask == 1 ) || ( override == 0 && overridemask == 3 )){
