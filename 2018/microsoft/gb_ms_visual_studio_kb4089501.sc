...
if(!vsVer || !IsMatchRegexp( vsVer, "^11\\." )){
	exit( 0 );
}
...
for key in key_list {
	...
	if(dllVer && IsMatchRegexp( dllVer, "^11\\.0" ) && version_is_less( version: dllVer, test_version: "11.0.61232.400" )){
		report = report_fixed_ver( file_checked: installPath + "mspdbsrv.exe", file_version: dllVer, vulnerable_range: "11.0 - 11.0.61232.399" );
