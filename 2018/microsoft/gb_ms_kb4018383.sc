if(description){
	...
	script_version( "2021-06-24T02:29:43+0000" );
	script_cve_id( "CVE-2018-8161" );
	script_tag( name: "cvss_base", value: "9.3" );
	script_tag( name: "cvss_base_vector", value: "AV:N/AC:M/Au:N/C:C/I:C/A:C" );
	script_tag( name: "last_modification", value: "2021-06-24 02:29:43 +0000 (Thu, 24 Jun 2021)" );
...
if(IsMatchRegexp( exeVer, "^(16\\.)" ) && version_is_less( version: exeVer, test_version: "16.0.4690.1000" )){
	report = report_fixed_ver( file_checked: exePath + "\\winword.exe", file_version: exeVer, vulnerable_range: "16.0 - 16.0.4690.0999" );
