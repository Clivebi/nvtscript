if(description){
	...
	script_bugtraq_id( 103232, 103250, 103251, 103234, 103265, 103262, 103295, 103309, 103231, 103238, 103240, 103241, 103242, 103243, 103244, 103245, 103246, 103310, 103299, 103307, 103298, 103312, 103248, 103249, 103236, 103230, 103256, 103259, 103261 );
...
if(version_is_less( version: fileVer, test_version: "6.1.7601.24059" )){
	report = report_fixed_ver( file_checked: sysPath + "\\win32k.sys", file_version: fileVer, vulnerable_range: "Less than 6.1.7601.24059" );
