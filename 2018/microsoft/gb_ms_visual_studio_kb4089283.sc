...
if(!vsVer || !IsMatchRegexp( vsVer, "^12\\." )){
	exit( 0 );
}
...
for key in key_list {
	...
	if(dllVer && IsMatchRegexp( dllVer, "^12\\.0" ) && version_is_less( version: dllVer, test_version: "12.0.40669.0" )){
		report = report_fixed_ver( file_checked: binPath + "\\mspdbsrv.exe", file_version: dllVer, vulnerable_range: "12.0 - 12.0.40668" );
