...
if(!vsVer || !IsMatchRegexp( vsVer, "^10\\." )){
	exit( 0 );
}
...
for key in key_list {
	...
	if(dllVer && IsMatchRegexp( dllVer, "^10\\.0" ) && version_is_less( version: dllVer, test_version: "10.0.40219.478" )){
		report = report_fixed_ver( file_checked: installPath + "mspdbsrv.exe", file_version: dllVer, vulnerable_range: "10.0 - 10.0.40219.477" );
