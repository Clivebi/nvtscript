	...
	for key in key_list {
		...
		if(msPath){
			...
			if(xlcnvVer && IsMatchRegexp( xlcnvVer, "^12\\." )){
				...
				if(sysVer && IsMatchRegexp( sysVer, "^12\\." ) && version_in_range( version: sysVer, test_version: "12.0", test_version2: "12.0.6798.4999" )){
					report = report_fixed_ver( file_checked: offpath + "\\excelcnv.exe", file_version: sysVer, vulnerable_range: "12.0 - 12.0.6798.4999" );
