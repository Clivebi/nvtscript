...
if(offexeVer && IsMatchRegexp( offexeVer, "^14\\." )){
	if(version_is_less( version: offexeVer, test_version: "14.0.7197.5000" )){
		report = report_fixed_ver( file_checked: offPath + "\\Mso.dll", file_version: offexeVer, vulnerable_range: "14.0 - 14.0.7197.4999" );
