...
for item in registry_enum_keys( key: key ) {
	...
	if(dotPath && ContainsString( dotPath, "\\Microsoft.NET\\Framework" )){
		...
		if(!sysdllVer || !IsMatchRegexp( sysdllVer, "^2\\." )){
			continue;
		}
		if(version_in_range( version: sysdllVer, test_version: "2.0.50727.5700", test_version2: "2.0.50727.8788" )){
			report = report_fixed_ver( file_checked: dotPath + "\\mscorlib.dll", file_version: sysdllVer, vulnerable_range: "2.0.50727.5700 - 2.0.50727.8788" );
