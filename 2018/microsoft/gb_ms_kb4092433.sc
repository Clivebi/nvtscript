...
if(IsMatchRegexp( wordviewVer, "^(11\\.)" ) && version_is_less( version: wordviewVer, test_version: "11.0.8450.0" )){
	report = report_fixed_ver( file_checked: wordviewPath + "wordview.exe", file_version: wordviewVer, vulnerable_range: "11.0 - 11.0.8449" );
