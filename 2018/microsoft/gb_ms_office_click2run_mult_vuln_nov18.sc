if(description){
	...
	script_cve_id( "CVE-2018-8574", "CVE-2018-8577", "CVE-2018-8522", "CVE-2018-8524", "CVE-2018-8558", "CVE-2018-8576", "CVE-2018-8579", "CVE-2018-8582", "CVE-2018-8575", "CVE-2018-8539", "CVE-2018-8573", "CVE-2018-8546" );
	...
	if( UpdateChannel == "Semi-Annual Channel (Targeted)" ){
		...
		if(UpdateChannel == "Semi-Annual Channel"){
			if( version_is_less( version: officeVer, test_version: "16.0.8431.2329" ) ){
				...
				if(version_in_range( version: officeVer, test_version: "16.0.9000", test_version2: "16.0.9126.2315" )){
