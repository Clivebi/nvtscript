...
for item in registry_enum_keys( key: key ) {
	...
	if(dotPath && ContainsString( dotPath, "\\Microsoft.NET\\Framework" )){
		...
		if(!sysdllVer || !IsMatchRegexp( sysdllVer, "^4\\." )){
			continue;
		}
		if(version_in_range( version: sysdllVer, test_version: "4.0.30319.30000", test_version2: "4.0.30319.36449" )){
			report = report_fixed_ver( file_checked: dotPath + "System.IdentityModel.dll", file_version: sysdllVer, vulnerable_range: "4.0.30319.30000 - 4.0.30319.36449" );
