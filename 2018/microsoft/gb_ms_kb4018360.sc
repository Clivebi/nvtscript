...
if(IsMatchRegexp( webappVer, "^(14\\.)" )){
	...
	if(dllVer){
		if(version_in_range( version: dllVer, test_version: "14.0", test_version2: "14.0.7197.4999" )){
			report = report_fixed_ver( file_checked: path + "\\14.0\\WebServices\\ConversionService\\Bin\\Converter\\sword.dll", file_version: dllVer, vulnerable_range: "14.0 - 14.0.7197.4999" );
