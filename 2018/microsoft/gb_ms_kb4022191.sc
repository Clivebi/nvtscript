...
if(IsMatchRegexp( excelVer, "^(15\\.)" ) && version_is_less( version: excelVer, test_version: "15.0.5041.0999" )){
	report = report_fixed_ver( file_checked: excelPath + "Excel.exe", file_version: excelVer, vulnerable_range: "15.0 - 15.0.5041.0999" );
