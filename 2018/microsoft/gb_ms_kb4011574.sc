if(description){
	...
	script_cve_id( "CVE-2018-0798", "CVE-2018-0801", "CVE-2018-0802", "CVE-2018-0812", "CVE-2018-0804", "CVE-2018-0805", "CVE-2018-0806", "CVE-2018-0807", "CVE-2018-0845", "CVE-2018-0848", "CVE-2018-0849", "CVE-2018-0862" );
	...
	for key in key_list {
		...
		if(propath){
			...
			if( !msdllVer ){
				...
				report = report_fixed_ver( file_checked: offPath + "\\eqnedt32.exe", file_version: msdllVer, vulnerable_range: "File 'eqnedt32.exe' is present" );
