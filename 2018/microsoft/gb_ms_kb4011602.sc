...
if(IsMatchRegexp( excelVer, "^(12\\.)" ) && version_is_less( version: excelVer, test_version: "12.0.6784.5000" )){
	report = report_fixed_ver( file_checked: excelPath + "Excel.exe", file_version: excelVer, vulnerable_range: "12.0 - 12.0.6784.4999" );
