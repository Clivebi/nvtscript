...
if(IsMatchRegexp( excelviewVer, "^12\\." ) && version_is_less( version: excelviewVer, test_version: "12.0.6805.5000" )){
	report = report_fixed_ver( file_checked: "Xlview.exe", file_version: excelviewVer, vulnerable_range: "12.0 - 12.0.6805.4999" );
