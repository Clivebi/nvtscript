if(description){
	...
	script_tag( name: "severity_date", value: "2018-09-07 15:31:00 +0000 (Fri, 07 Sep 2018)" );
...
if(version_in_range( version: edgeVer, test_version: "11.0.10240.0", test_version2: "11.0.10240.17945" )){
	report = report_fixed_ver( file_checked: sysPath + "\\Edgehtml.dll", file_version: edgeVer, vulnerable_range: "11.0.10240.0 - 11.0.10240.17945" );
