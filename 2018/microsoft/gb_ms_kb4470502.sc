...
for key in key_list {
				...
				for item in registry_enum_keys( key: key ) {
					...
					if(sysdllVer){
						if( version_in_range( version: sysdllVer, test_version: "3.5.30729.0", test_version2: "3.5.30729.9034" ) ){
							...
							if(version_in_range( version: sysdllVer, test_version: "4.7", test_version2: "4.7.3281" )){
	...
	if(vuln_range){
		report = report_fixed_ver( file_checked: dotPath + "system.web.extensions.dll", file_version: sysdllVer, vulnerable_range: vuln_range );
