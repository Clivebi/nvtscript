...
for key in key_list {
	...
	if(dllVer && IsMatchRegexp( dllVer, "^1\\.15\\." ) && version_is_less( version: dllVer, test_version: "1.15.3227.4915" )){
		report = report_fixed_ver( file_checked: dllPath + "\\Microsoft.VisualStudio.Setup.dll", file_version: dllVer, vulnerable_range: "1.15.0 - 1.15.3227.4914" );
