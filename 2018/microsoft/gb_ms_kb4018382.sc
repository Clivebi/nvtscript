...
if(IsMatchRegexp( excelVer, "^(16\\.)" ) && version_is_less( version: excelVer, test_version: "16.0.4690.1000" )){
	report = report_fixed_ver( file_checked: excelPath + "\\Excel.exe", file_version: excelVer, vulnerable_range: "16.0 - 16.0.4690.0999" );
