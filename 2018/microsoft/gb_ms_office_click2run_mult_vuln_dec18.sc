if(description){
	...
	script_cve_id( "CVE-2018-8597", "CVE-2018-8598", "CVE-2018-8627", "CVE-2018-8636", "CVE-2018-8587", "CVE-2018-8628" );
	...
	if( UpdateChannel == "Semi-Annual Channel (Targeted)" ){
		...
		if(UpdateChannel == "Semi-Annual Channel"){
			if( version_is_less( version: officeVer, test_version: "16.0.8431.2351" ) ){
				...
				if(version_in_range( version: officeVer, test_version: "16.0.9000", test_version2: "16.0.9126.2336" )){
