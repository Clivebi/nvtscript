if(description){
	...
	script_tag( name: "severity_date", value: "2018-08-06 16:55:00 +0000 (Mon, 06 Aug 2018)" );
  ...
  In many libraries, the code that performs modular addition does not run in constant time, and so a
  side channel can recover information that can be used to calculate the private key." );
