if(description){
	...
	script_tag( name: "summary", value: "PHPMailer is prone to an object injection vulnerability." );
	script_tag( name: "vuldetect", value: "Checks if a vulnerable version is present on the target host." );
	script_tag( name: "affected", value: "PHPMailer before 5.2.27 and 6.x before 6.0.6." );
	script_tag( name: "solution", value: "Update to version 5.2.27 or 6.0.6 respectively." );
