...
if(description){
	...
	script_name( "PHPMailer < 1.73 Long Header DoS Vulnerability" );
	...
	script_tag( name: "summary", value: "PHPMailer is prone to a denial of service (DoS) vulnerability." );
  ...
  (infinite loop leading to memory and CPU consumption)." );
	...
	script_tag( name: "solution", value: "Update to version 1.73 or later." );
