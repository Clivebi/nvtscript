...
if(description){
	...
	script_cve_id( "CVE-2018-11362", "CVE-2018-11360", "CVE-2018-11359", "CVE-2018-11358", "CVE-2018-11357", "CVE-2018-11356" );
...
if( vers == "2.6.0" ){
	...
	if( version_in_range( version: vers, test_version: "2.4.0", test_version2: "2.4.6" ) ){
		fix = "2.4.7";
	}
	else {
		if(version_in_range( version: vers, test_version: "2.2.0", test_version2: "2.2.14" )){
			fix = "2.2.15";
		}
	}
}
