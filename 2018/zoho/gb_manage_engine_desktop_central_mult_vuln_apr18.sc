...
if(http_vuln_check( port: port, url: url, pattern: "execute SQL queries", extra_check: make_list( ">CREATEDTIME<",
	 ">USER_ID<",
	 ">LAST_NAME<",
	 "retrieve any specific  information",
	 "Query Executor" ), check_header: TRUE )){
