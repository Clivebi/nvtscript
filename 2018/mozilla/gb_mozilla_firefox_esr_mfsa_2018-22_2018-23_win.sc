...
if(description){
	...
	script_name( "Mozilla Firefox ESR Security Update (mfsa_2018-22_2018-23) - Windows" );
	script_tag( name: "summary", value: "Mozilla Firefox is prone to denial of service vulnerability." );
  ...
  on Windows." );
	script_tag( name: "solution", value: "Update to Mozilla Firefox ESR version 60.2.1
