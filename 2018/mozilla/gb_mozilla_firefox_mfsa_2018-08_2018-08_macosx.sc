...
if(description){
	...
	script_name( "Mozilla Firefox Security Update (mfsa_2018-08_2018-08) - Mac OS X" );
	script_tag( name: "summary", value: "Mozilla Firefox is prone to a remote code execution (RCE)
  vulnerability." );
  ...
  conditions." );
	script_tag( name: "affected", value: "Mozilla Firefox versions before 59.0.1." );
	script_tag( name: "solution", value: "Update to version 59.0.1 or later." );
...
vers = infos["version"];
path = infos["location"];
if(version_is_less( version: vers, test_version: "59.0.1" )){
	report = report_fixed_ver( installed_version: vers, fixed_version: "59.0.1", install_path: path );
