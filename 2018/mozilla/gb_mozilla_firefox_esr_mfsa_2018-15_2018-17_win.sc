...
if(description){
	...
	script_cve_id( "CVE-2018-12359", "CVE-2018-12360", "CVE-2018-12361", "CVE-2018-12362", "CVE-2018-5188", "CVE-2018-5156", "CVE-2018-12363", "CVE-2018-12364", "CVE-2018-12365", "CVE-2018-12371", "CVE-2018-12366", "CVE-2018-12367", "CVE-2018-12368", "CVE-2018-12369", "CVE-2018-5187" );
	...
	script_name( "Mozilla Firefox ESR Security Update (mfsa_2018-15_2018-17) - Windows" );
...
vers = infos["version"];
path = infos["location"];
if(version_in_range( version: vers, test_version: "60.0.0", test_version2: "60.0.2" )){
	report = report_fixed_ver( installed_version: vers, fixed_version: "60.1", install_path: path );
