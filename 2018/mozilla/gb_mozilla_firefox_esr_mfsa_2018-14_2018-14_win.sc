...
if(description){
	...
	script_name( "Mozilla Firefox ESR Security Update (mfsa_2018-14_2018-14) - Windows" );
...
if( version_is_less( version: vers, test_version: "52.8.1" ) ){
	...
	if(IsMatchRegexp( vers, "^(60\\.0)" ) && version_is_less( version: vers, test_version: "60.0.2" )){
		fix = "60.0.2";
	}
}
if(fix){
