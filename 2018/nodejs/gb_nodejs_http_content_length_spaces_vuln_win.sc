...
if( IsMatchRegexp( nodejsVer, "^4\\." ) && version_is_less( version: nodejsVer, test_version: "4.9.0" ) ){
	fix = "4.9.0";
}
else {
	if( IsMatchRegexp( nodejsVer, "^6\\." ) && version_is_less( version: nodejsVer, test_version: "6.14.0" ) ){
		fix = "6.14.0";
	}
	else {
		if( IsMatchRegexp( nodejsVer, "^8\\." ) && version_is_less( version: nodejsVer, test_version: "8.11.0" ) ){
			fix = "8.11.0";
		}
		else {
			if(IsMatchRegexp( nodejsVer, "^9\\." ) && version_is_less( version: nodejsVer, test_version: "9.10.0" )){
				fix = "9.10.0";
			}
		}
	}
