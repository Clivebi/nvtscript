...
if(description){
	...
	script_cve_id( "CVE-2018-8733", "CVE-2018-8734", "CVE-2018-8735", "CVE-2018-8736", "CVE-2018-10736", "CVE-2018-10735", "CVE-2018-10738", "CVE-2018-10737", "CVE-2018-10810" );
	script_tag( name: "cvss_base", value: "9.0" );
	script_tag( name: "cvss_base_vector", value: "AV:N/AC:L/Au:S/C:C/I:C/A:C" );
	script_tag( name: "last_modification", value: "2021-08-10 15:24:26 +0000 (Tue, 10 Aug 2021)" );
	script_tag( name: "severity_vector", value: "CVSS:3.0/AV:N/AC:L/PR:L/UI:N/S:U/C:H/I:H/A:H" );
	script_tag( name: "severity_origin", value: "NVD" );
	script_tag( name: "severity_date", value: "2019-03-04 18:48:00 +0000 (Mon, 04 Mar 2019)" );
...
login_data = "txtRootPath=nagiosql%2F&txtBasePath=%2Fvar%2Fwww%2Fhtml" + "%2Fnagiosql%2F&selProtocol=http&txtTempdir=%2Ftmp&selLa" + "nguage=en_GB&txtEncoding=utf-8&txtDBserver=localhost&tx" + "tDBport=3306&txtDBname=nagiosql&txtDBuser=nagiosql&txtD" + "Bpass=n%40gweb&txtLogoff=3600&txtLines=15&selSeldisable=1";
req = http_post_put_req( port: http_port, url: url, data: login_data, add_headers: make_array( "Content-Type", "application/x-www-form-urlencoded" ) );
buf = http_keepalive_send_recv( port: http_port, data: req );
if(IsMatchRegexp( buf, "HTTP/1.. 302" ) && ContainsString( buf, ">Sub key<" ) && ContainsString( buf, ">Nagios Core Config Manager<" ) && ContainsString( buf, ">serviceextinfo<" ) && ContainsString( buf, ">NagiosQL - Version:" )){
...
req = http_post_put_req( port: http_port, url: url, data: login_data, add_headers: make_array( "Content-Type", "application/x-www-form-urlencoded" ) );
buf = http_keepalive_send_recv( port: http_port, data: req );
if(IsMatchRegexp( buf, "HTTP/1.. 302" ) && ContainsString( buf, "NagiosQL System Monitoring Administration Tool" ) && ContainsString( buf, ">Nagios Core Config Manager<" ) && ContainsString( buf, ">Settings<" ) && ContainsString( buf, ">NagiosQL<" )){
	report = http_report_vuln_url( port: http_port, url: url );
	security_message( port: http_port, data: report );
	exit( 0 );
}
