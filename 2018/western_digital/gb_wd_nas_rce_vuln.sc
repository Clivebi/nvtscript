if(description){
	...
	script_dependencies( "gb_wd_mybook_live_http_detect.sc", "gb_wd_mycloud_consolidation.sc" );
...
cpe_list = make_list( "cpe:/o:western_digital:my_book_live_firmware",
	 "cpe:/o:wdc:my_cloud_unknown_model_firmware",
	 "cpe:/o:wdc:my_cloud_firmware",
	 "cpe:/o:wdc:wd_cloud_firmware",
