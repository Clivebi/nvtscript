...
if(description){
	...
	script_tag( name: "severity_date", value: "2018-06-22 16:16:00 +0000 (Fri, 22 Jun 2018)" );
	script_tag( name: "creation_date", value: "2018-05-23 12:12:14 +0530 (Wed, 23 May 2018)" );
	script_name( "Joomla 'Unpublished Tags' Information Disclosure Vulnerability (20180503)" );
...
potentially sensitive information." );
	script_tag( name: "affected", value: "Joomla versions 3.1.0 through 3.8.7." );
...
vers = infos["version"];
path = infos["location"];
if(version_in_range( version: vers, test_version: "3.1.0", test_version2: "3.8.7" )){
