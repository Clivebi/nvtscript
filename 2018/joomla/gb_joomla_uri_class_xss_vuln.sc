...
if(description){
	...
	script_tag( name: "severity_date", value: "2018-02-13 17:56:00 +0000 (Tue, 13 Feb 2018)" );
...
arbitrary javascript code in the context of current user." );
	script_tag( name: "affected", value: "Joomla version 1.5.0 through 3.8.3." );
...
vers = infos["version"];
path = infos["location"];
if(version_in_range( version: vers, test_version: "1.5.0", test_version2: "3.8.3" )){
