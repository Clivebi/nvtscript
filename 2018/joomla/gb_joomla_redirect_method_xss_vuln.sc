...
if(description){
	...
	script_tag( name: "severity_date", value: "2018-06-22 16:17:00 +0000 (Fri, 22 Jun 2018)" );
	script_tag( name: "creation_date", value: "2018-05-23 13:55:14 +0530 (Wed, 23 May 2018)" );
	script_name( "Joomla 'Redirect' Method XSS Vulnerability (20180508)" );
	...
	script_tag( name: "affected", value: "Joomla versions 3.1.2 through 3.8.7." );
...
vers = infos["version"];
path = infos["location"];
if(version_in_range( version: vers, test_version: "3.1.2", test_version2: "3.8.7" )){
