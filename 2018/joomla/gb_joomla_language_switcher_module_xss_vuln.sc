...
if(description){
	...
	script_tag( name: "severity_date", value: "2018-08-20 13:48:00 +0000 (Mon, 20 Aug 2018)" );
	script_tag( name: "creation_date", value: "2018-06-27 15:36:27 +0530 (Wed, 27 Jun 2018)" );
	script_name( "Joomla 'Language Switcher' Module Cross Site Scripting Vulnerability (20180602)" );
...
via injection of arbitrary parameters and/or values on the current page url." );
	script_tag( name: "affected", value: "Joomla versions 1.6.0 through 3.8.8" );
	script_tag( name: "solution", value: "Update to version 3.8.9 or later. Please see the references for more information." );
...
vers = infos["version"];
path = infos["location"];
if(version_in_range( version: vers, test_version: "1.6.0", test_version2: "3.8.8" )){
	report = report_fixed_ver( installed_version: vers, fixed_version: "3.8.9", install_path: path );
