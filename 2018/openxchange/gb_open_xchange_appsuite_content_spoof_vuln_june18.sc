...
if(description){
	...
	script_tag( name: "severity_date", value: "2018-08-03 18:19:00 +0000 (Fri, 03 Aug 2018)" );
...
if( version_is_less( version: oxVer, test_version: "7.6.3.31" ) ){
	...
	if( version_in_range( version: oxVer, test_version: "7.8.2", test_version2: "7.8.2.30" ) ){
		fix = "7.8.2-rev31";
	}
	else {
		if( version_in_range( version: oxVer, test_version: "7.8.3", test_version2: "7.8.3.40" ) ){
			...
			if(version_in_range( version: oxVer, test_version: "7.8.4", test_version2: "7.8.4.19" )){
				fix = "7.8.4-rev20";
			}
		}
	}
