...
if(description){
	...
	script_tag( name: "severity_date", value: "2018-08-03 18:28:00 +0000 (Fri, 03 Aug 2018)" );
...
if( version_is_less( version: oxVer, test_version: "7.6.3.3" ) ){
	...
	if( version_in_range( version: oxVer, test_version: "7.8.2", test_version2: "7.8.2.3" ) ){
		fix = "7.8.2-rev4";
	}
	else {
		if( version_in_range( version: oxVer, test_version: "7.8.3", test_version2: "7.8.3.4" ) ){
			fix = "7.8.3-rev5";
		}
		else {
			if(version_in_range( version: oxVer, test_version: "7.8.4", test_version2: "7.8.4.3" )){
				fix = "7.8.4-rev4";
			}
		}
	}
