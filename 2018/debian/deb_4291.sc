...
res = "";
report = "";
if(!isnull( res = isdpkgvuln( pkg: "mgetty", ver: "1.1.36-3+deb9u1", rls: "DEB9" ) )){
	report += res;
}
if(!isnull( res = isdpkgvuln( pkg: "mgetty-docs", ver: "1.1.36-3+deb9u1", rls: "DEB9" ) )){
	report += res;
}
if(!isnull( res = isdpkgvuln( pkg: "mgetty-fax", ver: "1.1.36-3+deb9u1", rls: "DEB9" ) )){
	report += res;
}
if(!isnull( res = isdpkgvuln( pkg: "mgetty-pvftools", ver: "1.1.36-3+deb9u1", rls: "DEB9" ) )){
	report += res;
}
if(!isnull( res = isdpkgvuln( pkg: "mgetty-viewfax", ver: "1.1.36-3+deb9u1", rls: "DEB9" ) )){
	report += res;
}
if(!isnull( res = isdpkgvuln( pkg: "mgetty-voice", ver: "1.1.36-3+deb9u1", rls: "DEB9" ) )){
	report += res;
}
if( report != "" ){
