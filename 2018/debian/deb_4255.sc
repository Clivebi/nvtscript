...
res = "";
report = "";
if(!isnull( res = isdpkgvuln( pkg: "ant", ver: "1.9.9-1+deb9u1", rls: "DEB9" ) )){
	report += res;
}
if(!isnull( res = isdpkgvuln( pkg: "ant-doc", ver: "1.9.9-1+deb9u1", rls: "DEB9" ) )){
	report += res;
}
if(!isnull( res = isdpkgvuln( pkg: "ant-gcj", ver: "1.9.9-1+deb9u1", rls: "DEB9" ) )){
	report += res;
}
if(!isnull( res = isdpkgvuln( pkg: "ant-optional", ver: "1.9.9-1+deb9u1", rls: "DEB9" ) )){
	report += res;
}
if(!isnull( res = isdpkgvuln( pkg: "ant-optional-gcj", ver: "1.9.9-1+deb9u1", rls: "DEB9" ) )){
	report += res;
}
if( report != "" ){
