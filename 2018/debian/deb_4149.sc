...
res = "";
report = "";
if(!isnull( res = isdpkgvuln( pkg: "libplexus-utils2-java", ver: "3.0.15-1+deb8u1", rls: "DEB8" ) )){
	report += res;
}
if(!isnull( res = isdpkgvuln( pkg: "libplexus-utils2-java-doc", ver: "3.0.15-1+deb8u1", rls: "DEB8" ) )){
	report += res;
}
if( report != "" ){
