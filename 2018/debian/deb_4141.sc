...
res = "";
report = "";
if(!isnull( res = isdpkgvuln( pkg: "libvorbisidec-dev", ver: "1.0.2+svn18153-1~deb8u2", rls: "DEB8" ) )){
	report += res;
}
if(!isnull( res = isdpkgvuln( pkg: "libvorbisidec1", ver: "1.0.2+svn18153-1~deb8u2", rls: "DEB8" ) )){
	report += res;
}
if(!isnull( res = isdpkgvuln( pkg: "libvorbisidec-dev", ver: "1.0.2+svn18153-1+deb9u1", rls: "DEB9" ) )){
	report += res;
}
if(!isnull( res = isdpkgvuln( pkg: "libvorbisidec1", ver: "1.0.2+svn18153-1+deb9u1", rls: "DEB9" ) )){
	report += res;
}
if( report != "" ){
