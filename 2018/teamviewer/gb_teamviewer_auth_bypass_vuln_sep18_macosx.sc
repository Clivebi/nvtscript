...
if(description){
  ...
  to 6 characters. Update to TeamViewer version 10.0.140455, 11.0.140568, 12.0.139437, 13.2.75535 or later." );
...
if( IsMatchRegexp( version, "^10\\.0" ) && version_is_less( version: version, test_version: "10.0.140455" ) ){
	report = report_fixed_ver( installed_version: version, fixed_version: "10.0.140455", install_path: location );
	security_message( data: report, port: 0 );
	exit( 0 );
}
else {
	if( IsMatchRegexp( version, "^11\\.0" ) && version_is_less( version: version, test_version: "11.0.140568" ) ){
		report = report_fixed_ver( installed_version: version, fixed_version: "11.0.140568", install_path: location );
		security_message( data: report, port: 0 );
		exit( 0 );
	}
	else {
		if( IsMatchRegexp( version, "^12\\.0" ) && version_is_less( version: version, test_version: "12.0.139437" ) ){
			report = report_fixed_ver( installed_version: version, fixed_version: "12.0.139437", install_path: location );
			security_message( data: report, port: 0 );
			exit( 0 );
		}
		else {
			if(IsMatchRegexp( version, "^13\\.[0-2]" ) && version_is_less( version: version, test_version: "13.2.75535" )){
