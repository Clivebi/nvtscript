if(description){
	...
	script_dependencies( "gb_portainer_detect.sc" );
...
if(ContainsString( res, "User not found" ) || ContainsString( res, "No administrator account found inside the database" ) || ContainsString( res, "Object not found inside the database" )){
