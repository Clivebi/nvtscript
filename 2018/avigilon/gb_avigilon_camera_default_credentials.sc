if(description){
	...
	script_dependencies( "gb_avigilon_camera_detect.sc", "gb_default_credentials_options.sc" );
...
req = http_post_put_req( port: port, url: url2, data: data, add_headers: make_array( "Content-Type", "application/x-www-form-urlencoded", "Cookie", sessionID[0] ) );
