if(description){
	...
	script_cve_id( "CVE-2018-10658", "CVE-2018-10659", "CVE-2018-10660", "CVE-2018-10661", "CVE-2018-10662", "CVE-2018-10663", "CVE-2018-10664" );
...
if(ContainsString( res, "content=\"Axis Communications AB\"" ) && ContainsString( res, "<title>AXIS</title>" )){
	req = http_post_put_req( port: axport, url: "/index.html/VT_TEST.srv", data: "action=test&return_page=VT_Vulnerability_Test", add_headers: make_array( "Content-Type", "application/x-www-form-urlencoded" ) );
	res = http_keepalive_send_recv( port: axport, data: req );
	if(IsMatchRegexp( res, "^(HTTP/1.. 303)" ) && ContainsString( res, "Location:" ) && ContainsString( res, "Location: VT_Vulnerability_Test" )){
