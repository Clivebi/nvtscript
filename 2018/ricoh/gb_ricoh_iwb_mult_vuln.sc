if(description){
	...
	script_dependencies( "gb_ricoh_iwb_detect.sc" );
...
if( cpe == "cpe:/o:ricoh:iwb_d2200_firmware" ){
	...
	if( cpe == "cpe:/o:ricoh:iwb_d5500_firmware" ){
		...
		if( cpe == "cpe:/o:ricoh:iwb_d5510_firmware" ){
			...
			if( version_is_less( version: version, test_version: "2.2" ) ){
				...
				if(IsMatchRegexp( version, "^3\\." ) && version_is_less( version: version, test_version: "3.1.0" )){
					report = report_fixed_ver( installed_version: version, fixed_version: "See advisory" );
					security_message( port: port, data: report );
					exit( 0 );
				}
