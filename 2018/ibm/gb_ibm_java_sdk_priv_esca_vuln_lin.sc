...
if( IsMatchRegexp( javaVer, "^7\\.1" ) && version_is_less( version: javaVer, test_version: "7.1.4.20" ) ){
	fix = "7.1.4.20";
}
else {
	if(IsMatchRegexp( javaVer, "^8\\.0" ) && version_is_less( version: javaVer, test_version: "8.0.5.10" )){
		fix = "8.0.5.10";
	}
}
if(fix){
