...
if(description){
	...
	script_name( "phpMyAdmin XSS Vulnerability (PMASA-2018-1) - Windows" );
  ...
  attacker to inject arbitrary web script or HTML via a crafted URL." );
	...
	script_dependencies( "os_detection.sc", "secpod_phpmyadmin_detect_900129.sc" );
...
vers = infos["version"];
path = infos["location"];
if(IsMatchRegexp( vers, "^4\\.7" ) && version_is_less( version: vers, test_version: "4.7.8" )){
