...
if(IsMatchRegexp( res, "HTTP/1.. 200 OK" ) && IsMatchRegexp( res, "email-subscribers.*csv" ) && IsMatchRegexp( res, "Email.Name.Status.Created.EmailGroup" ) && IsMatchRegexp( res, "\"[a-z0-9]+@[a-z]+.com\".\"[A-Za-z0-9]+\"." )){
