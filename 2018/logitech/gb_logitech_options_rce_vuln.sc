if(description){
	...
	script_version( "2019-06-14T09:48:28+0000" );
	script_tag( name: "last_modification", value: "2019-06-14 09:48:28 +0000 (Fri, 14 Jun 2019)" );
	...
	script_dependencies( "gb_logitech_options_detect_win.sc" );
	script_mandatory_keys( "logitech/options/win/detected" );
	script_tag( name: "summary", value: "Logitech Options is prone to a remote command execution
vulnerability." );
