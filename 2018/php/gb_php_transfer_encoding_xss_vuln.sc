...
if(description){
  ...
  the references for more information." );
	...
	script_dependencies( "gb_php_http_detect.sc", "secpod_apache_http_server_http_detect.sc" );
...
req = http_post_put_req( port: port, url: url, data: data, add_headers: make_array( "Transfer-Encoding", "chunked" ) );
