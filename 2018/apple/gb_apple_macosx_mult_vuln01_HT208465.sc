if(description){
	...
	script_cve_id( "CVE-2018-4096", "CVE-2018-4088", "CVE-2018-4089", "CVE-2018-4091", "CVE-2018-4093", "CVE-2018-4092", "CVE-2018-4090", "CVE-2017-8817" );
...
if(!osVer || !IsMatchRegexp( osVer, "^10\\.13" )){
	exit( 0 );
}
