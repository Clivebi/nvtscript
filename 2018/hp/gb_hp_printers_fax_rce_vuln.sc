if(description){
	...
	script_tag( name: "severity_date", value: "2018-10-15 13:36:00 +0000 (Mon, 15 Oct 2018)" );
...
if(IsMatchRegexp( model, "^PageWide MFP P57750" )){
...
if(IsMatchRegexp( model, "^PageWide Managed MFP (P77740(dn|dw|z|P777(5|6)0z))" )){
...
if(IsMatchRegexp( model, "^PageWide P55250dw" )){
...
if(IsMatchRegexp( model, "^PageWide (Managed )?P75050(dn|dw)" )){
	if(version_is_less( version: fw_ver, test_version: "LIMOFWPP1N005.1828A.00" )){
		report = report_fixed_ver( installed_version: fw_ver, fixed_version: "LIMOFWPP1N005.1828A.00" );
		security_message( port: 0, data: report );
		exit( 0 );
...
if(IsMatchRegexp( model, "^PageWide Pro 552dw" )){
	if(version_is_less( version: fw_ver, test_version: "ICHDWOPP1N001.1829A.00" )){
...
if(IsMatchRegexp( model, "^PageWide Pro 750(dn|dw)" )){
	if(version_is_less( version: fw_ver, test_version: "LIMOFWPP1N005.1828A.00" )){
		report = report_fixed_ver( installed_version: fw_ver, fixed_version: "LIMOFWPP1N005.1828A.00" );
		security_message( port: 0, data: report );
		exit( 0 );
...
if(IsMatchRegexp( model, "^PageWide Pro 477(dn|dw)" )){
...
if(IsMatchRegexp( model, "^PageWide Pro 577" )){
	if(version_is_less( version: fw_ver, test_version: "MAHDWOPP1N001.1829A.00" )){
		report = report_fixed_ver( installed_version: fw_ver, fixed_version: "MAHDWOPP1N001.1829A.00" );
		security_message( port: 0, data: report );
		exit( 0 );
...
if(IsMatchRegexp( model, "^PageWide Pro MFP 772(dn|dw)" )){
	if(version_is_less( version: fw_ver, test_version: "LIMOFWPP1N005.1828A.00" )){
		report = report_fixed_ver( installed_version: fw_ver, fixed_version: "LIMOFWPP1N005.1828A.00" );
		security_message( port: 0, data: report );
		exit( 0 );
...
if(IsMatchRegexp( model, "^PageWide Pro 452dw" )){
	if(version_is_less( version: fw_ver, test_version: "ICEMDWPP1N001.1829A.00" )){
		report = report_fixed_ver( installed_version: fw_ver, fixed_version: "ICEMDWPP1N001.1829A.00" );
		security_message( port: 0, data: report );
		exit( 0 );
...
if(IsMatchRegexp( model, "^Officejet Pro X451(dn|dw)" )){
...
if(IsMatchRegexp( model, "^Officejet Pro X476(dn|dw)" )){
...
if(IsMatchRegexp( model, "^Officejet Pro X551dw" )){
...
if(IsMatchRegexp( model, "^Officejet Pro X576dw" )){
...
if(IsMatchRegexp( model, "^Designjet T120" )){
...
if(IsMatchRegexp( model, "^Designjet T520" )){
	if(version_is_less( version: fw_ver, test_version: "AXP2CN1829BR" )){
		report = report_fixed_ver( installed_version: fw_ver, fixed_version: "AXP2CN1829BR" );
		security_message( port: 0, data: report );
		exit( 0 );
...
if(IsMatchRegexp( model, "^DesignJet T730" )){
...
if(IsMatchRegexp( model, "^DesignJet T830" )){
	if(version_is_less( version: fw_ver, test_version: "CANDELPR2N001.1829A.00" )){
		report = report_fixed_ver( installed_version: fw_ver, fixed_version: "CANDELPR2N001.1829A.00" );
		security_message( port: 0, data: report );
		exit( 0 );
...
if(IsMatchRegexp( model, "^Deskjet 2540" )){
...
if(IsMatchRegexp( model, "^Deskjet 2600" )){
...
if(IsMatchRegexp( model, "^Deskjet Ink Advantage 3540" )){
...
if(IsMatchRegexp( model, "^DeskJet 3630" )){
...
if(IsMatchRegexp( model, "^DeskJet 3700" )){
...
if(IsMatchRegexp( model, "^Deskjet Ink Advantage 4510" )){
...
if(IsMatchRegexp( model, "^Deskjet Ink Advantage 4530" )){
...
if(IsMatchRegexp( model, "^DeskJet Ink Advantage Ultra 4720" )){
...
if(IsMatchRegexp( model, "^DeskJet Ink Advantage 5640" )){
...
if(IsMatchRegexp( model, "^DeskJet Ink Advantage Ultra 5730" )){
...
if(IsMatchRegexp( model, "^DeskJet GT 5820" )){
...
if(IsMatchRegexp( model, "^DeskJet Ink Advantage 2600" )){
...
if(IsMatchRegexp( model, "^DeskJet Ink Advantage 3700" )){
...
if(IsMatchRegexp( model, "^DeskJet Ink Advantage 3830" )){
...
if(IsMatchRegexp( model, "^DeskJet Ink Advantage 4640" )){
...
if(IsMatchRegexp( model, "^DeskJet Ink Advantage 4670" )){
...
if(IsMatchRegexp( model, "^DeskJet Ink Advantage 5570" )){
...
if(IsMatchRegexp( model, "^ENVY 120" )){
...
if(IsMatchRegexp( model, "^ENVY 4500" )){
...
if(IsMatchRegexp( model, "^ENVY 4510" )){
...
if(IsMatchRegexp( model, "^ENVY 4520" )){
...
if(IsMatchRegexp( model, "^ENVY 5530" )){
...
if(IsMatchRegexp( model, "^ENVY 5540" )){
...
if(IsMatchRegexp( model, "^ENVY 5640" )){
...
if(IsMatchRegexp( model, "^ENVY 5660" )){
	if(version_is_less( version: fw_ver, test_version: "NLM5CN1830BR" )){
		report = report_fixed_ver( installed_version: fw_ver, fixed_version: "NLM5CN1830BR" );
		security_message( port: 0, data: report );
		exit( 0 );
...
if(IsMatchRegexp( model, "^ENVY 7640" )){
...
if(IsMatchRegexp( model, "^Ink Tank Wireless 410" )){
	...
	if(IsMatchRegexp( fw_ver, "KEP1FN1805" )){
...
if(IsMatchRegexp( model, "^OfficeJet 200" )){
...
if(IsMatchRegexp( model, "^OfficeJet 250" )){
...
if(IsMatchRegexp( model, "^OfficeJet 3830" )){
...
if(IsMatchRegexp( model, "^OfficeJet 4620" )){
...
if(IsMatchRegexp( model, "^OfficeJet 4630" )){
...
if(IsMatchRegexp( model, "^OfficeJet 4650" )){
...
if(IsMatchRegexp( model, "^OfficeJet 5740" )){
...
if(IsMatchRegexp( model, "^OfficeJet 6600" )){
...
if(IsMatchRegexp( model, "^OfficeJet 6700" )){
...
if(IsMatchRegexp( model, "^OfficeJet 6950" )){
...
if(IsMatchRegexp( model, "^OfficeJet (Pro )?6960" )){
...
if(IsMatchRegexp( model, "^OfficeJet 7110" )){
...
if(IsMatchRegexp( model, "^OfficeJet 7510" )){
...
if(IsMatchRegexp( model, "^OfficeJet 7610" )){
...
if(IsMatchRegexp( model, "^Officejet Pro 251dw" )){
...
if(IsMatchRegexp( model, "^Officejet Pro 276dw" )){
...
if(IsMatchRegexp( model, "^Officejet Pro 3610" )){
...
if(IsMatchRegexp( model, "^Officejet Pro 6830" )){
...
if(IsMatchRegexp( model, "^Officejet Pro 6970" )){
	if(version_is_less( version: fw_ver, test_version: "MCP2CN1828AR" )){
		report = report_fixed_ver( installed_version: fw_ver, fixed_version: "MCP2CN1828AR" );
		security_message( port: 0, data: report );
		exit( 0 );
...
if(IsMatchRegexp( model, "^Officejet Pro 7740" )){
...
if(IsMatchRegexp( model, "^Officejet Pro 8600" )){
	if( IsMatchRegexp( fw_ver, "^CKP1CN" ) ){
...
if(IsMatchRegexp( model, "^Officejet Pro 8610" )){
...
if(IsMatchRegexp( model, "^Officejet Pro 8620" )){
	if(version_is_less( version: fw_ver, test_version: "FDP1CN1828AR" )){
		report = report_fixed_ver( installed_version: fw_ver, fixed_version: "FDP1CN1828AR" );
		security_message( port: 0, data: report );
		exit( 0 );
...
if(IsMatchRegexp( model, "^Officejet Pro 8630" )){
	if(version_is_less( version: fw_ver, test_version: "FDP1CN1828AR" )){
		report = report_fixed_ver( installed_version: fw_ver, fixed_version: "FDP1CN1828AR" );
		security_message( port: 0, data: report );
		exit( 0 );
...
if(IsMatchRegexp( model, "^Officejet Pro 8640" )){
...
if(IsMatchRegexp( model, "^Officejet Pro 8660" )){
	if(version_is_less( version: fw_ver, test_version: "FDP1CN1828AR" )){
		report = report_fixed_ver( installed_version: fw_ver, fixed_version: "FDP1CN1828AR" );
		security_message( port: 0, data: report );
		exit( 0 );
...
if(IsMatchRegexp( model, "^Officejet Pro 8710" )){
...
if(IsMatchRegexp( model, "^Officejet Pro 8720" )){
...
if(IsMatchRegexp( model, "^Officejet Pro 8730" )){
...
if(IsMatchRegexp( model, "^Officejet Pro 8740" )){
	if(version_is_less( version: fw_ver, test_version: "WEBPDLPP1N001.1827B.00" )){
		report = report_fixed_ver( installed_version: fw_ver, fixed_version: "WEBPDLPP1N001.1827B.00" );
		security_message( port: 0, data: report );
		exit( 0 );
...
if(IsMatchRegexp( model, "^Photosmart 5510" )){
...
if(IsMatchRegexp( model, "^Photosmart 5510d" )){
...
if(IsMatchRegexp( model, "^Photosmart 5520" )){
...
if(IsMatchRegexp( model, "^Photosmart 6510" )){
...
if(IsMatchRegexp( model, "^Photosmart 6520" )){
...
if(IsMatchRegexp( model, "^Photosmart 7520" )){
...
if(IsMatchRegexp( model, "^Photosmart Plus B210" )){
...
if(IsMatchRegexp( model, "^Smart Tank Wireless 450" )){
	...
	if(IsMatchRegexp( fw_ver, "KDP1FN1805" )){
