...
if(IsMatchRegexp( vers, "^1\\.[6-8]\\." )){
	if(( version_in_range( version: vers, test_version: "1.6.0", test_version2: "1.6.0.181" ) ) || ( version_in_range( version: vers, test_version: "1.7.0", test_version2: "1.7.0.161" ) ) || ( version_in_range( version: vers, test_version: "1.8.0", test_version2: "1.8.0.152" ) )){
