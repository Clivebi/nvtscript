...
if(description){
	...
	script_cve_id( "CVE-2018-3156", "CVE-2018-3251", "CVE-2018-3278", "CVE-2018-3276", "CVE-2018-3143", "CVE-2018-3247" );
...
vers = infos["version"];
path = infos["location"];
if(version_in_range( version: vers, test_version: "5.6", test_version2: "5.6.41" ) || version_in_range( version: vers, test_version: "5.7", test_version2: "5.7.23" ) || version_in_range( version: vers, test_version: "8.0", test_version2: "8.0.12" )){
