...
if(description){
	...
	script_cve_id( "CVE-2018-2766", "CVE-2018-2782", "CVE-2018-2784", "CVE-2018-2787", "CVE-2018-2758" );
...
path = infos["location"];
if(version_in_range( version: mysqlVer, test_version: "5.6", test_version2: "5.6.39" ) || version_in_range( version: mysqlVer, test_version: "5.7", test_version2: "5.7.21" )){
