if(description){
	...
	script_cve_id( "CVE-2018-2677", "CVE-2018-2599", "CVE-2018-2603", "CVE-2018-2641", "CVE-2018-2602", "CVE-2018-2629", "CVE-2018-2678", "CVE-2018-2663", "CVE-2018-2633", "CVE-2018-2588", "CVE-2018-2637", "CVE-2018-2618", "CVE-2018-2579" );
...
if(IsMatchRegexp( vers, "^(1\\.[6-8]|9)\\." )){
	if(version_in_range( version: vers, test_version: "1.6.0", test_version2: "1.6.0.171" ) || version_in_range( version: vers, test_version: "1.7.0", test_version2: "1.7.0.161" ) || version_in_range( version: vers, test_version: "1.8.0", test_version2: "1.8.0.152" ) || version_in_range( version: vers, test_version: "9.0", test_version2: "9.0.1" )){
