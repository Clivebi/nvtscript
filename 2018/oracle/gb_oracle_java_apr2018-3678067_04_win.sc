if(description){
	...
	script_cve_id( "CVE-2018-2814", "CVE-2018-2798", "CVE-2018-2797", "CVE-2018-2795", "CVE-2018-2790", "CVE-2018-2794", "CVE-2018-2815" );
...
vers = infos["version"];
path = infos["location"];
if(IsMatchRegexp( vers, "^(1\\.[6-8]|10)\\." )){
	if(( version_in_range( version: vers, test_version: "1.6.0", test_version2: "1.6.0.181" ) ) || ( version_in_range( version: vers, test_version: "1.7.0", test_version2: "1.7.0.171" ) ) || ( version_in_range( version: vers, test_version: "1.8.0", test_version2: "1.8.0.162" ) ) || ( IsMatchRegexp( vers, "^10" ) && version_is_less( version: vers, test_version: "10.0.1" ) )){
