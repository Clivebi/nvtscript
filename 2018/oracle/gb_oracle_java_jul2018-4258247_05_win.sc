...
path = infos["location"];
if(IsMatchRegexp( jreVer, "^((1\\.(8|7))|10)" )){
	if(( version_in_range( version: jreVer, test_version: "10.0", test_version2: "10.0.1" ) ) || ( version_in_range( version: jreVer, test_version: "1.8.0", test_version2: "1.8.0.172" ) ) || ( version_in_range( version: jreVer, test_version: "1.7.0", test_version2: "1.7.0.181" ) )){
