...
if(description){
	...
	script_cve_id( "CVE-2018-3054", "CVE-2018-3077", "CVE-2018-3056", "CVE-2018-3060", "CVE-2018-3065" );
...
vers = infos["version"];
path = infos["location"];
if(version_in_range( version: vers, test_version: "5.7", test_version2: "5.7.22" ) || version_in_range( version: vers, test_version: "8.0", test_version2: "8.0.11" )){
