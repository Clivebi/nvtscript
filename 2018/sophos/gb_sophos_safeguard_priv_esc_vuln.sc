if(description){
	...
	script_dependencies( "gb_sophos_safeguard_detect_win.sc" );
...
cpe_list = make_list( "cpe:/a:sophos:safeguard_lan_crypt_encryption_client",
	 "cpe:/a:sophos:safeguard_enterprise_device_encryption_client",
	 "cpe:/a:sophos:safeguard_easy_device_encryption_client" );
...
path = infos["location"];
cpe = infos["cpe"];
if( ContainsString( cpe, "cpe:/a:sophos:safeguard_lan_crypt_encryption_client" ) ){
	...
	if( ContainsString( cpe, "cpe:/a:sophos:safeguard_enterprise_device_encryption_client" ) ){
		...
		if(ContainsString( cpe, "cpe:/a:sophos:safeguard_easy_device_encryption_client" )){
