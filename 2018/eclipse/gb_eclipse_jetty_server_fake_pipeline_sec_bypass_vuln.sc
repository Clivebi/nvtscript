...
if( version_in_range( version: vers, test_version: "9.2.0", test_version2: "9.2.25.20180605" ) ){
	...
	if( version_in_range( version: vers, test_version: "9.3.0", test_version2: "9.3.24.20180604" ) ){
		fix = "9.3.24.v20180605";
	}
	else {
		if(version_in_range( version: vers, test_version: "9.4.0", test_version2: "9.4.11.20180604" )){
