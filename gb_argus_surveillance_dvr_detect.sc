...
if(ContainsString( res, "<B>Argus Surveillance DVR</B>" ) && ContainsString( res, "MotionAndEvents.html" )){
	version = "unknown";
	...
	log_message( data: build_detection_report( app: "Argus Surveillance DVR", version: version, install: "/", cpe: cpe, concluded: vers[0], concludedUrl: concUrl ), port: port );
	exit( 0 );
}
exit( 0 );
