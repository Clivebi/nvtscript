...
if(ContainsString( res, "<title>MESR901" ) && ContainsString( res, "Modbus Gateway - Login Page" ) && ContainsString( res, "ID=\"DeviceName\"" )){
	version = "unknown";
	...
	log_message( data: build_detection_report( app: "Advantech MESR901 Modbus Gateway", version: version, install: "/", cpe: cpe, concluded: vers[0] ), port: port );
	exit( 0 );
}
exit( 0 );
