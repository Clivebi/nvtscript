...
if(ContainsString( res, "<title>Opmantek</title>" ) && IsMatchRegexp( res, "Open-AudIT (Community|Enterprise|Professional)?" )){
	version = "unknown";
	...
	log_message( data: build_detection_report( app: "Opmantec Open-AudIT", version: version, install: "/", cpe: cpe, concluded: vers[0], concludedUrl: concUrl ), port: port );
	exit( 0 );
}
exit( 0 );
