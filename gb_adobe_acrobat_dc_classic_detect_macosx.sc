...
psVer = chomp( ssh_cmd( socket: sock, cmd: "defaults read /Applications/" + "Adobe\\ Acrobat\\ 2015/Adobe\\ Acrobat.app/Contents/Info CFBundleShortVersionString" ) );
close( sock );
...
log_message( data: build_detection_report( app: "Adobe Acrobat DC Classic", version: psVer, install: "/Applications/Adobe Acrobat 2015", cpe: cpe, concluded: psVer ) );
exit( 0 );
