...
if(IsMatchRegexp( buf, "Server: *NetCache" )){
	...
	register_and_report_cpe( app: "NetCache", ver: version, concluded: ver[0], base: CPE, expr: "([0-9.]+)([A-Z][0-9.]+)?", insloc: port + "/tcp", regPort: port, regService: "www" );
}
exit( 0 );
