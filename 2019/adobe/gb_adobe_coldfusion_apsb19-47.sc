...
path = infos["location"];
if(IsMatchRegexp( version, "^2016\\.0" ) && version_is_less( version: version, test_version: "2016.0.12.315717" )){
	report = report_fixed_ver( installed_version: version, fixed_version: "2016 Update 12", install_path: path );
	security_message( port: port, data: report );
	exit( 0 );
}
if(IsMatchRegexp( version, "^2018\\.0" ) && version_is_less( version: version, test_version: "2018.0.05.315699" )){
