...
if(IsMatchRegexp( model, "^Color LaserJet CM4540 MFP" )){
...
if(IsMatchRegexp( model, "^Color LaserJet CP5525" )){
...
if(IsMatchRegexp( model, "^Color LaserJet M553" )){
...
if(IsMatchRegexp( model, "^Color LaserJet M552" )){
	if( version_is_less( version: fw_ver, test_version: "2309010_581409" ) ){
		report = report_fixed_ver( installed_version: fw_ver, fixed_version: "2309010_581409" );
		security_message( port: 0, data: report );
		exit( 0 );
		...
		if(IsMatchRegexp( fw_ver, "^240" ) && version_is_less( version: fw_ver, test_version: "2407081_000601" )){
...
if(IsMatchRegexp( model, "^Color LaserJet M651" )){
	if( version_is_less( version: fw_ver, test_version: "2309010_581418" ) ){
		...
		if(IsMatchRegexp( fw_ver, "^240" ) && version_is_less( version: fw_ver, test_version: "2407081_000585" )){
...
if(IsMatchRegexp( model, "^Color LaserJet M65[23]" )){
...
if(IsMatchRegexp( model, "^Color LaserJet M750" )){
...
if(IsMatchRegexp( model, "^Color LaserJet M855" )){
	if( version_is_less( version: fw_ver, test_version: "2309010_581419" ) ){
		...
		if(IsMatchRegexp( fw_ver, "^240" ) && version_is_less( version: fw_ver, test_version: "2407081_0005895" )){
...
if(IsMatchRegexp( model, "^Color LaserJet (Flow)?MFP M577" )){
	if( version_is_less( version: fw_ver, test_version: "2309010_581408" ) ){
		...
		if(IsMatchRegexp( fw_ver, "^240" ) && version_is_less( version: fw_ver, test_version: "2407081_000571" )){
...
if(IsMatchRegexp( model, "^Color LaserJet (Flow)?MFP M680" )){
	if( version_is_less( version: fw_ver, test_version: "2309010_581416" ) ){
		...
		if(IsMatchRegexp( fw_ver, "^240" ) && version_is_less( version: fw_ver, test_version: "2407081_000591" )){
...
if(IsMatchRegexp( model, "^Color LaserJet (Flow)?MFP M681" )){
...
if(IsMatchRegexp( model, "^Color LaserJet (Flow)?MFP M682" )){
	if(version_is_less( version: fw_ver, test_version: "2407081_000578" )){
		report = report_fixed_ver( installed_version: fw_ver, fixed_version: "2407081_000578" );
		security_message( port: 0, data: report );
		exit( 0 );
...
if(IsMatchRegexp( model, "^Color LaserJet (Flow)?MFP M880z" )){
	if( version_is_less( version: fw_ver, test_version: "2309010_581433" ) ){
		...
		if(IsMatchRegexp( fw_ver, "^240" ) && version_is_less( version: fw_ver, test_version: "2407081_0005991" )){
...
if(IsMatchRegexp( model, "^Color LaserJet E55040dw" )){
...
if(IsMatchRegexp( model, "^Color LaserJet E650(5|6)0" )){
	if(version_is_less( version: fw_ver, test_version: "2407081_000586" )){
		report = report_fixed_ver( installed_version: fw_ver, fixed_version: "2407081_000586" );
		security_message( port: 0, data: report );
		exit( 0 );
...
if(IsMatchRegexp( model, "^Color LaserJet MFP E778(22|25|30)" )){
...
if(IsMatchRegexp( model, "^Color LaserJet (Flow)?MFP E57540" )){
...
if(IsMatchRegexp( model, "^Color LaserJet (Flow)?MFP E675(5|6)0" )){
	if(version_is_less( version: fw_ver, test_version: "2407081_000578" )){
		report = report_fixed_ver( installed_version: fw_ver, fixed_version: "2407081_000578" );
		security_message( port: 0, data: report );
		exit( 0 );
...
if(IsMatchRegexp( model, "^Color LaserJet (Flow)?MFP E876(4|5|6)0" )){
...
if(IsMatchRegexp( model, "^LaserJet 500 color M551" )){
...
if(IsMatchRegexp( model, "^LaserJet 500 (Flow)?MFP M525" )){
	if( version_is_less( version: fw_ver, test_version: "2309010_581414" ) ){
		...
		if(IsMatchRegexp( fw_ver, "^240" ) && version_is_less( version: fw_ver, test_version: "2407081_000594" )){
...
if(IsMatchRegexp( model, "^LaserJet 500 (Flow)?MFP M575" )){
	if( version_is_less( version: fw_ver, test_version: "2309010_581424" ) ){
		...
		if(IsMatchRegexp( fw_ver, "^240" ) && version_is_less( version: fw_ver, test_version: "2407081_000587" )){
...
if(IsMatchRegexp( model, "^LaserJet 600 M60(1|2|3)" )){
...
if(IsMatchRegexp( model, "^LaserJet 700 color MFP M775" )){
	if( version_is_less( version: fw_ver, test_version: "2309010_581426" ) ){
		...
		if(IsMatchRegexp( fw_ver, "^240" ) && version_is_less( version: fw_ver, test_version: "2407081_000583" )){
...
if(IsMatchRegexp( model, "^LaserJet 700 M712" )){
...
if(IsMatchRegexp( model, "^LaserJet Flow MFP M630" )){
	if( version_is_less( version: fw_ver, test_version: "2309010_581400" ) ){
		...
		if(IsMatchRegexp( fw_ver, "^240" ) && version_is_less( version: fw_ver, test_version: "2407081_000588" )){
...
if(IsMatchRegexp( model, "^LaserJet Flow MFP M830" )){
	if( version_is_less( version: fw_ver, test_version: "2309010_581432" ) ){
		...
		if(IsMatchRegexp( fw_ver, "^240" ) && version_is_less( version: fw_ver, test_version: "2407081_000569" )){
...
if(IsMatchRegexp( model, "^LaserJet M4555 MFP" )){
...
if(IsMatchRegexp( model, "^LaserJet M506" )){
	if( version_is_less( version: fw_ver, test_version: "2309010_581411" ) ){
		...
		if(IsMatchRegexp( fw_ver, "^240" ) && version_is_less( version: fw_ver, test_version: "2407081_000597" )){
...
if(IsMatchRegexp( model, "^LaserJet M60(4|5|6)" )){
	if( version_is_less( version: fw_ver, test_version: "2309010_581410" ) ){
		...
		if(IsMatchRegexp( fw_ver, "^240" ) && version_is_less( version: fw_ver, test_version: "2407081_000593" )){
...
if(IsMatchRegexp( model, "^LaserJet M60(7|8|9)" )){
...
if(IsMatchRegexp( model, "^LaserJet M806" )){
	if( version_is_less( version: fw_ver, test_version: "2309010_581423" ) ){
		...
		if(IsMatchRegexp( fw_ver, "^240" ) && version_is_less( version: fw_ver, test_version: "2407081_000574" )){
...
if(IsMatchRegexp( model, "^LaserJet (Flow )?MFP M527" )){
	if( version_is_less( version: fw_ver, test_version: "2309010_581407" ) ){
		...
		if(IsMatchRegexp( fw_ver, "^240" ) && version_is_less( version: fw_ver, test_version: "2407081_000575" )){
...
if(IsMatchRegexp( model, "^LaserJet (Flow )?MFP M63(1|2|3)" )){
...
if(IsMatchRegexp( model, "^LaserJet MFP M725" )){
	if( version_is_less( version: fw_ver, test_version: "2309010_581420" ) ){
		...
		if(IsMatchRegexp( fw_ver, "^240" ) && version_is_less( version: fw_ver, test_version: "2407081_000570" )){
...
if(IsMatchRegexp( model, "^LaserJet E50045" )){
...
if(IsMatchRegexp( model, "^LaserJet MFP E52545" )){
...
if(IsMatchRegexp( model, "^LaserJet E600(5|6|7)5" )){
...
if(IsMatchRegexp( model, "^LaserJet E625(5|6|7)5" )){
	if(version_is_less( version: fw_ver, test_version: "2407081_000592" )){
		report = report_fixed_ver( installed_version: fw_ver, fixed_version: "2407081_000592" );
		security_message( port: 0, data: report );
		exit( 0 );
...
if(IsMatchRegexp( model, "^LaserJet (Flow )?MFP E725(25|30|35)" )){
...
if(IsMatchRegexp( model, "^LaserJet (Flow )?MFP E825(4|5|6)0" )){
...
if(IsMatchRegexp( model, "^Officejet Color FlowMFP X585" )){
	if( version_is_less( version: fw_ver, test_version: "2309010_581406" ) ){
		...
		if(IsMatchRegexp( fw_ver, "^240" ) && version_is_less( version: fw_ver, test_version: "2407081_000567" )){
...
if(IsMatchRegexp( model, "^Officejet Color X555" )){
	if( version_is_less( version: fw_ver, test_version: "2309010_581403" ) ){
		...
		if(IsMatchRegexp( fw_ver, "^240" ) && version_is_less( version: fw_ver, test_version: "2407081_000595" )){
...
if(IsMatchRegexp( model, "^PageWide Color 755" )){
...
if(IsMatchRegexp( model, "^PageWide Color MFP 77(4|9)" )){
...
if(IsMatchRegexp( model, "^PageWide Color 556" )){
	if( version_is_less( version: fw_ver, test_version: "2309010_581412" ) ){
		...
		if(IsMatchRegexp( fw_ver, "^240" ) && version_is_less( version: fw_ver, test_version: "2407081_000598" )){
...
if(IsMatchRegexp( model, "^PageWide Color 765" )){
	if(version_is_less( version: fw_ver, test_version: "2407081_000573" )){
		report = report_fixed_ver( installed_version: fw_ver, fixed_version: "2407081_000573" );
		security_message( port: 0, data: report );
		exit( 0 );
...
if(IsMatchRegexp( model, "^PageWide Color (Flow )?MFP 586" )){
	if( version_is_less( version: fw_ver, test_version: "2309010_581413" ) ){
		...
		if(IsMatchRegexp( fw_ver, "^240" ) && version_is_less( version: fw_ver, test_version: "2407081_000584" )){
...
if(IsMatchRegexp( model, "^PageWide Color (Flow )?MFP 78(0|5)" )){
...
if(IsMatchRegexp( model, "^PageWide Color E55650" )){
	if( version_is_less( version: fw_ver, test_version: "2309010_581412" ) ){
		report = report_fixed_ver( installed_version: fw_ver, fixed_version: "2309010_581412" );
		security_message( port: 0, data: report );
		exit( 0 );
...
if(IsMatchRegexp( model, "^PageWide Color (Flow )?MFP E58650(dn|z)" )){
	if( version_is_less( version: fw_ver, test_version: "2309010_581413" ) ){
		report = report_fixed_ver( installed_version: fw_ver, fixed_version: "2309010_581413" );
		security_message( port: 0, data: report );
		exit( 0 );
...
if(IsMatchRegexp( model, "^PageWide Color E75(160|250)" )){
	if(version_is_less( version: fw_ver, test_version: "2407081_000573" )){
		report = report_fixed_ver( installed_version: fw_ver, fixed_version: "2407081_000573" );
		security_message( port: 0, data: report );
		exit( 0 );
...
if(IsMatchRegexp( model, "^PageWide Color P75250" )){
	if(version_is_less( version: fw_ver, test_version: "2407081_000573" )){
		report = report_fixed_ver( installed_version: fw_ver, fixed_version: "2407081_000573" );
		security_message( port: 0, data: report );
		exit( 0 );
...
if(IsMatchRegexp( model, "^PageWide Color MFP P77440" )){
	if(version_is_less( version: fw_ver, test_version: "2407163_000240" )){
		report = report_fixed_ver( installed_version: fw_ver, fixed_version: "2407163_000240" );
		security_message( port: 0, data: report );
		exit( 0 );
...
if(IsMatchRegexp( model, "^PageWide Color (Flow )?MFP E776(5|6)0" )){
	if(version_is_less( version: fw_ver, test_version: "2407163_000211" )){
		report = report_fixed_ver( installed_version: fw_ver, fixed_version: "2407163_000211" );
		security_message( port: 0, data: report );
		exit( 0 );
...
if(IsMatchRegexp( model, "^PageWide Color Flow MFP E77660z" )){
	if(version_is_less( version: fw_ver, test_version: "2407163_000211" )){
		report = report_fixed_ver( installed_version: fw_ver, fixed_version: "2407163_000211" );
		security_message( port: 0, data: report );
		exit( 0 );
...
if(IsMatchRegexp( model, "^PageWide Color MFP P779(4|5|6)0" )){
	if(version_is_less( version: fw_ver, test_version: "2407163_000240" )){
		report = report_fixed_ver( installed_version: fw_ver, fixed_version: "2407163_000240" );
		security_message( port: 0, data: report );
		exit( 0 );
...
if(IsMatchRegexp( model, "^ScanJet Flow N9120 fn1" )){
	if(version_is_less( version: fw_ver, test_version: "2309010_581403" )){
		report = report_fixed_ver( installed_version: fw_ver, fixed_version: "2309010_581403" );
		security_message( port: 0, data: report );
		exit( 0 );
...
if(IsMatchRegexp( model, "^ScanJet Flow N9120 fn2" )){
