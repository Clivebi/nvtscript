if(description){
	...
	script_tag( name: "severity_date", value: "2019-04-18 13:35:00 +0000 (Thu, 18 Apr 2019)" );
...
if(IsMatchRegexp( model, "^Color LaserJet M651" )){
	if( version_is_less( version: fw_ver, test_version: "2308974_579770" ) ){
		...
		if(IsMatchRegexp( fw_ver, "^240" ) && version_is_less( version: fw_ver, test_version: "2406048_029632" )){
...
if(IsMatchRegexp( model, "^Color LaserJet (Flow)?MFP M577" )){
	if( version_is_less( version: fw_ver, test_version: "2308974_579760" ) ){
		...
		if(IsMatchRegexp( fw_ver, "^240" ) && version_is_less( version: fw_ver, test_version: "2406048_029627" )){
...
if(IsMatchRegexp( model, "^Color LaserJet (Flow)?MFP M680" )){
	if( version_is_less( version: fw_ver, test_version: "2308974_579771" ) ){
		...
		if(IsMatchRegexp( fw_ver, "^240" ) && version_is_less( version: fw_ver, test_version: "2406048_029633" )){
...
if(IsMatchRegexp( model, "^Color LaserJet E65050dn" )){
	if(version_is_less( version: fw_ver, test_version: "2406087_000016" )){
		report = report_fixed_ver( installed_version: fw_ver, fixed_version: "2406087_000016" );
		security_message( port: 0, data: report );
		exit( 0 );
...
if(IsMatchRegexp( model, "^Color LaserJet E65060" )){
...
if(IsMatchRegexp( model, "^Color LaserJet (Flow)?MFP E67550" )){
	if(version_is_less( version: fw_ver, test_version: "2406087_000017" )){
		report = report_fixed_ver( installed_version: fw_ver, fixed_version: "2406087_000017" );
		security_message( port: 0, data: report );
		exit( 0 );
...
if(IsMatchRegexp( model, "^Color LaserJet (Flow)?MFP E67560" )){
	if(version_is_less( version: fw_ver, test_version: "2406087_000017" )){
		report = report_fixed_ver( installed_version: fw_ver, fixed_version: "2406087_000017" );
		security_message( port: 0, data: report );
		exit( 0 );
...
if(IsMatchRegexp( model, "^Color LaserJet MFP E876(40|50|60)" )){
...
if(IsMatchRegexp( model, "^Digital Sender Flow 8500 fn2" )){
	if( version_is_less( version: fw_ver, test_version: "2308937_578483" ) ){
		...
		if(IsMatchRegexp( fw_ver, "^240" ) && version_is_less( version: fw_ver, test_version: "2406048_029623" )){
...
if(IsMatchRegexp( model, "^LaserJet 500 (Flow)?MFP M575" )){
	if( version_is_less( version: fw_ver, test_version: "2308974_579774" ) ){
		...
		if(IsMatchRegexp( fw_ver, "^240" ) && version_is_less( version: fw_ver, test_version: "2406048_029634" )){
...
if(IsMatchRegexp( model, "^LaserJet 500 (Flow)?MFP M525" )){
	if( version_is_less( version: fw_ver, test_version: "2308974_579765" ) ){
		...
		if(IsMatchRegexp( fw_ver, "^240" ) && version_is_less( version: fw_ver, test_version: "2406048_029635" )){
...
if(IsMatchRegexp( model, "^Color LaserJet M855" )){
	if( version_is_less( version: fw_ver, test_version: "2308974_579768" ) ){
		...
		if(IsMatchRegexp( fw_ver, "^240" ) && version_is_less( version: fw_ver, test_version: "2406048_029621" )){
...
if(IsMatchRegexp( model, "^Color LaserJet (Flow)?MFP M880z" )){
	if( version_is_less( version: fw_ver, test_version: "2308974_579767" ) ){
		...
		if(IsMatchRegexp( fw_ver, "^240" ) && version_is_less( version: fw_ver, test_version: "2406048_029641" )){
...
if(IsMatchRegexp( model, "^LaserJet Flow MFP M830" )){
	if( version_is_less( version: fw_ver, test_version: "2308974_579769" ) ){
		...
		if(IsMatchRegexp( fw_ver, "^240" ) && version_is_less( version: fw_ver, test_version: "2406048_029645" )){
...
if(IsMatchRegexp( model, "^LaserJet Flow MFP M630" )){
	if( version_is_less( version: fw_ver, test_version: "2308974_579755" ) ){
		...
		if(IsMatchRegexp( fw_ver, "^240" ) && version_is_less( version: fw_ver, test_version: "2406048_029631" )){
...
if(IsMatchRegexp( model, "^LaserJet M806" )){
	if( version_is_less( version: fw_ver, test_version: "2308974_579772" ) ){
		...
		if(IsMatchRegexp( fw_ver, "^240" ) && version_is_less( version: fw_ver, test_version: "2406048_029646" )){
...
if(IsMatchRegexp( model, "^LaserJet (Flow )?MFP M527" )){
	if( version_is_less( version: fw_ver, test_version: "2308974_579761" ) ){
		...
		if(IsMatchRegexp( fw_ver, "^240" ) && version_is_less( version: fw_ver, test_version: "2406048_029628" )){
...
if(IsMatchRegexp( model, "^LaserJet MFP M725" )){
	if( version_is_less( version: fw_ver, test_version: "2308974_579773" ) ){
		...
		if(IsMatchRegexp( fw_ver, "^240" ) && version_is_less( version: fw_ver, test_version: "2406048_029644" )){
...
if(IsMatchRegexp( model, "^Officejet Color FlowMFP X585" )){
	if( version_is_less( version: fw_ver, test_version: "2308974_579759" ) ){
		...
		if(IsMatchRegexp( fw_ver, "^240" ) && version_is_less( version: fw_ver, test_version: "2406048_029636" )){
...
if(IsMatchRegexp( model, "^Officejet Color X555" )){
	if( version_is_less( version: fw_ver, test_version: "2308974_579758" ) ){
		...
		if(IsMatchRegexp( fw_ver, "^240" ) && version_is_less( version: fw_ver, test_version: "2406048_029642" )){
...
if(IsMatchRegexp( model, "^PageWide Color (Flow )?MFP 586" )){
	if( version_is_less( version: fw_ver, test_version: "2308974_579780" ) ){
		...
		if(IsMatchRegexp( fw_ver, "^240" ) && version_is_less( version: fw_ver, test_version: "2406048_029624" )){
...
if(IsMatchRegexp( model, "^PageWide Color X556" )){
	if( version_is_less( version: fw_ver, test_version: "2308974_579766" ) ){
		...
		if(IsMatchRegexp( fw_ver, "^240" ) && version_is_less( version: fw_ver, test_version: "2406048_029637" )){
...
if(IsMatchRegexp( model, "^PageWide Color E75160" )){
	if(version_is_less( version: fw_ver, test_version: "2406048_029619" )){
		report = report_fixed_ver( installed_version: fw_ver, fixed_version: "2406048_029619" );
		security_message( port: 0, data: report );
		exit( 0 );
...
if(IsMatchRegexp( model, "^PageWide Color (Flow )?MFP E58650" )){
	if( version_is_less( version: fw_ver, test_version: "2308974_579780" ) ){
		report = report_fixed_ver( installed_version: fw_ver, fixed_version: "2308974_579780" );
		security_message( port: 0, data: report );
		exit( 0 );
...
if(IsMatchRegexp( model, "^Scanjet Enterprise 8500" )){
...
if(IsMatchRegexp( model, "^Scanjet Enterprise Flow N9120" )){
