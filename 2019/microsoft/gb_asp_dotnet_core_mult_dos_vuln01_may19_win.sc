...
path = infos["location"];
if( IsMatchRegexp( coreVers, "^1\\.0" ) && version_is_less( version: coreVers, test_version: "1.0.16" ) ){
	fix = "1.0.16";
}
else {
	if(IsMatchRegexp( coreVers, "^1\\.1" ) && version_is_less( version: coreVers, test_version: "1.1.13" )){
		fix = "1.1.13";
	}
}
if(fix){
