...
if(description){
	...
	script_cve_id( "CVE-2019-1001", "CVE-2019-1004", "CVE-2019-1056", "CVE-2019-1059", "CVE-2019-1063", "CVE-2019-1104" );
...
if(version_is_less( version: iedllVer, test_version: "11.0.9600.19400" )){
	report = report_fixed_ver( file_checked: iePath + "\\Mshtml.dll", file_version: iedllVer, vulnerable_range: "Less than 11.0.9600.19400" );
