...
path = infos["location"];
if( IsMatchRegexp( coreVers, "^2\\.1" ) && version_is_less( version: coreVers, test_version: "2.1.13" ) ){
	fix = "2.1.13";
}
else {
	if(IsMatchRegexp( coreVers, "^2\\.2" ) && version_is_less( version: coreVers, test_version: "2.2.7" )){
		fix = "2.2.7";
	}
}
if(fix){
