if(description){
	...
	script_cve_id( "CVE-2019-1453", "CVE-2019-1458", "CVE-2019-1465", "CVE-2019-1466", "CVE-2019-1467", "CVE-2019-1468", "CVE-2019-1469", "CVE-2019-1470", "CVE-2019-1474", "CVE-2019-1478", "CVE-2019-1480", "CVE-2019-1481", "CVE-2019-1484", "CVE-2019-1485", "CVE-2019-1488" );
...
if(version_is_less( version: dllVer, test_version: "6.1.7601.24540" )){
	report = report_fixed_ver( file_checked: sysPath + "\\Ntdll.dll", file_version: dllVer, vulnerable_range: "Less than 6.1.7601.24540" );
