...
for key in key_list {
	...
	if(IsMatchRegexp( offexeVer, "^12\\." ) && version_is_less( version: offexeVer, test_version: "12.0.6806.5000" )){
		report = report_fixed_ver( file_checked: offPath + "\\msohev.dll", file_version: offexeVer, vulnerable_range: "12.0 - 12.0.6802.4999" );
