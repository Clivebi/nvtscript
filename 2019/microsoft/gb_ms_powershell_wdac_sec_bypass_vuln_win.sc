...
if( IsMatchRegexp( psVer, "^6\\.1\\." ) && version_is_less( version: psVer, test_version: "6.1.5" ) ){
	fix = "6.1.5";
}
else {
	if(IsMatchRegexp( psVer, "^6\\.2\\." ) && version_is_less( version: psVer, test_version: "6.2.2" )){
		fix = "6.2.2";
	}
}
if(fix){
