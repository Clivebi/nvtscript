if(description){
	...
	script_cve_id( "CVE-2019-1400", "CVE-2019-1461", "CVE-2019-1462", "CVE-2019-1463", "CVE-2019-1464" );
	...
	if( UpdateChannel == "Semi-Annual Channel (Targeted)" ){
		...
		if(UpdateChannel == "Semi-Annual Channel"){
			if( version_is_less( version: officeVer, test_version: "16.0.10730.20426" ) ){
				...
				if(version_in_range( version: officeVer, test_version: "16.0.11328", test_version2: "16.0.11328.20492" )){
