if(description){
  ...
  to bypass defense-in-depth measures and perform exploitation." );
	script_tag( name: "affected", value: "- Microsoft Windows 7 for 32-bit/x64 Systems Service Pack 1 and
...
if(version_is_less( version: cryptVer, test_version: "6.1.7601.24382" )){
	report = report_fixed_ver( file_checked: sysPath + "\\Crypt32.dll", file_version: cryptVer, vulnerable_range: "Less than 6.1.7601.24382" );
