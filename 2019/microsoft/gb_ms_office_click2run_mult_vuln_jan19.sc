if(description){
	...
	script_cve_id( "CVE-2019-0559", "CVE-2019-0561", "CVE-2019-0585", "CVE-2019-0541", "CVE-2019-0560" );
	...
	if( UpdateChannel == "Semi-Annual Channel (Targeted)" ){
		...
		if(UpdateChannel == "Semi-Annual Channel"){
			if( version_is_less( version: officeVer, test_version: "16.0.8431.2366" ) ){
				...
				if( version_in_range( version: officeVer, test_version: "16.0.9000", test_version2: "16.0.9126.2350" ) ){
					fix = "1803 (Build 9126.2351)";
				}
				else {
					if(version_in_range( version: officeVer, test_version: "16.0.10730", test_version2: "16.0.10730.20263" )){
						fix = "1808 (Build 10730.20264)";
					}
				}
			}
