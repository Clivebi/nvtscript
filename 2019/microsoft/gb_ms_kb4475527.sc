...
for key in key_list {
	...
	if(path){
		...
		if(IsMatchRegexp( dllVer, "^15\\." ) && version_is_less( version: dllVer, test_version: "15.0.5153.0999" )){
			report = report_fixed_ver( file_checked: path + "\\Onetutil.dll", file_version: dllVer, vulnerable_range: "15.0 - 15.0.5153.0999" );
