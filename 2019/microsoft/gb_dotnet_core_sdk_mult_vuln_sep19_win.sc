...
path = infos["location"];
if( IsMatchRegexp( coreVers, "^2\\.1" ) && version_is_less( version: coreVers, test_version: "2.1.509" ) ){
	fix = "2.1.509";
}
else {
	if(IsMatchRegexp( coreVers, "^2\\.2" ) && version_is_less( version: coreVers, test_version: "2.2.109" )){
		fix = "2.2.109";
	}
}
if(fix){
