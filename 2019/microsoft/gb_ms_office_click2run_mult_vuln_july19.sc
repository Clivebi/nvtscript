if(description){
	...
	script_cve_id( "CVE-2019-1084", "CVE-2019-1109", "CVE-2019-1110", "CVE-2019-1111", "CVE-2019-1112" );
	...
	if( UpdateChannel == "Semi-Annual Channel (Targeted)" ){
		...
		if(UpdateChannel == "Semi-Annual Channel"){
			if( version_is_less( version: officeVer, test_version: "16.0.9126.2428" ) ){
				...
				if( version_in_range( version: officeVer, test_version: "16.0.10730", test_version2: "16.0.10730.20359" ) ){
					fix = "1808 (Build 10730.20360)";
				}
				else {
					if(version_in_range( version: officeVer, test_version: "16.0.11328", test_version2: "16.0.11328.20367" )){
						fix = "1902 (Build 11328.20368)";
					}
				}
			}
