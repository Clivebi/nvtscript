				...
				for item in registry_enum_keys( key: key ) {
					...
					if(dllVer){
						if( version_in_range( version: dllVer, test_version: "2.0.50727.5700", test_version2: "2.0.50727.8809" ) ){
							...
							if( version_in_range( version: dllVer, test_version: "4.0.30319.30000", test_version2: "4.0.30319.36574" ) ){
								vulnerable_range = "4.0.30319.30000 - 4.0.30319.36574";
								break;
							}
							else {
								if( version_in_range( version: dllVer, test_version: "4.6", test_version2: "4.7.3459" ) ){
