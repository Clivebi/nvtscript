...
path = infos["location"];
if( IsMatchRegexp( coreVers, "^2\\.2" ) && version_is_less( version: coreVers, test_version: "2.2.5" ) ){
	fix = "2.2.5";
}
else {
	if(IsMatchRegexp( coreVers, "^2\\.1" ) && version_is_less( version: coreVers, test_version: "2.1.11" )){
		fix = "2.1.11";
	}
}
if(fix){
