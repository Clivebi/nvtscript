	...
	if(ContainsString( sql_path, "Microsoft SQL Server" )){
		...
		if(sysVer && IsMatchRegexp( sysVer, "^13\\.0" )){
			if(version_in_range( version: sysVer, test_version: "13.0.4411.0", test_version2: "13.0.4258.0" )){
				report = report_fixed_ver( file_checked: sql_path + "\\microsoft.sqlserver.chainer.infrastructure.dll", file_version: sysVer, vulnerable_range: "13.0.4411.0 - 13.0.4258.0" );
