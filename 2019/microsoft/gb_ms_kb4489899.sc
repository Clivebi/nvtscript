if(description){
	...
	script_tag( name: "severity_date", value: "2019-04-10 03:37:00 +0000 (Wed, 10 Apr 2019)" );
...
if(version_in_range( version: fileVer, test_version: "11.0.17763.0", test_version2: "11.0.17763.378" )){
	report = report_fixed_ver( file_checked: dllPath + "\\Edgehtml.dll", file_version: fileVer, vulnerable_range: "11.0.17763.0 - 11.0.17763.378" );
