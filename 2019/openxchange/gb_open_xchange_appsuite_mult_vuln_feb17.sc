...
if(description){
	...
	script_cve_id( "CVE-2017-5864", "CVE-2017-5210", "CVE-2017-5863", "CVE-2016-10078", "CVE-2017-5213", "CVE-2016-10077" );
...
if(version_is_less( version: version, test_version: "7.8.3.13" )){
	report = report_fixed_ver( installed_version: version, fixed_version: "7.8.3.13", install_path: path );
