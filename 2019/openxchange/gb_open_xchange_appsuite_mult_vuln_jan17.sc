...
if(description){
	...
	script_tag( name: "severity_date", value: "2019-05-23 18:08:00 +0000 (Thu, 23 May 2019)" );
...
if(version_is_less( version: version, test_version: "7.8.3.11" )){
	report = report_fixed_ver( installed_version: version, fixed_version: "7.8.3.11", install_path: path );
	security_message( port: port, data: report );
	exit( 0 );
}
if(version_in_range( version: version, test_version: "7.8.4", test_version2: "7.8.4.2" )){
	report = report_fixed_ver( installed_version: version, fixed_version: "7.8.4.3", install_path: path );
	security_message( port: port, data: report );
	exit( 0 );
}
exit( 99 );
