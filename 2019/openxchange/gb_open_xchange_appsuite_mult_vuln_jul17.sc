...
if(version_is_less( version: version, test_version: "7.8.3.25" )){
	report = report_fixed_ver( installed_version: version, fixed_version: "7.8.3.25", install_path: path );
	security_message( port: port, data: report );
	exit( 0 );
}
if(version_in_range( version: version, test_version: "7.8.4", test_version2: "7.8.4.5" )){
	report = report_fixed_ver( installed_version: version, fixed_version: "7.8.4.6", install_path: path );
	security_message( port: port, data: report );
	exit( 0 );
}
exit( 99 );
