if(description){
	...
	script_tag( name: "severity_date", value: "2019-09-19 15:59:00 +0000 (Thu, 19 Sep 2019)" );
	...
	script_tag( name: "summary", value: "GetSimple CMS is prone to a stored cross-site scripting (XSS)
  vulnerability." );
