...
if(!infos = get_app_version_and_location( cpe: CPE, port: port, version_regex: "^[0-9]+\\.[0-9]+\\.[0-9]+\\.[0-9]+", exit_no_version: TRUE )){
	exit( 0 );
}
version = infos["version"];
path = infos["location"];
if(version_is_equal( version: version, test_version: "9.4.21.20190926" ) || version_is_equal( version: version, test_version: "9.4.22.20191022" ) || version_is_equal( version: version, test_version: "9.4.23.20191118" )){
