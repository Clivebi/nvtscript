...
if(description){
	...
	script_name( "TightVNC <= 1.3.10 Multiple Vulnerabilities - Windows" );
  ...
  to execute arbitrary code and cause denial of service condition." );
	...
	script_tag( name: "solution", value: "Update version 2.0 or later." );
...
vers = infos["version"];
path = infos["location"];
if(version_is_less_equal( installed_version: vers, test_version: "1.3.10" )){
