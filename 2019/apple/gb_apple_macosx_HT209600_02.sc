if(description){
	...
	script_tag( name: "severity_date", value: "2019-12-22 15:52:00 +0000 (Sun, 22 Dec 2019)" );
  ...
  or apply Security Update 2019-002 Sierra. Please see the references for more information." );
	...
	script_mandatory_keys( "ssh/login/osx_name", "ssh/login/osx_version",  "ssh/login/osx_version=^10\\.1[24]" );
	exit( 0 );
}
...
if(!osVer || !IsMatchRegexp( osVer, "^10\\.1[24]" ) || !ContainsString( osName, "Mac OS X" )){
	exit( 0 );
}
