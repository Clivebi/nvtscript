...
if(description){
	...
	script_cve_id( "CVE-2019-8745", "CVE-2019-8625", "CVE-2019-8719", "CVE-2019-8707", "CVE-2019-8763", "CVE-2019-8726", "CVE-2019-8733", "CVE-2019-8735" );
...
if( version_is_less( version: vers, test_version: "7.14" ) ){
	...
	if(IsMatchRegexp( vers, "^10\\." ) && version_is_less( version: vers, test_version: "10.7" )){
		fix = "10.7";
	}
}
if(fix){
