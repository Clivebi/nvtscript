...
if(description){
	...
	script_name( "Wireshark Security Updates (wnpa-sec-2019-06, wnpa-sec-2019-07, wnpa-sec-2019-08) - Mac OS X" );
...
if( version_in_range( version: vers, test_version: "2.4.0", test_version2: "2.4.12" ) ){
	...
	if(version_in_range( version: vers, test_version: "2.6.0", test_version2: "2.6.6" )){
		fix = "2.6.7";
	}
}
if(fix){
