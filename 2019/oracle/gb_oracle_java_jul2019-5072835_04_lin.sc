if(description){
	...
	script_tag( name: "severity_vector", value: "CVSS:3.0/AV:N/AC:H/PR:N/UI:R/S:C/C:L/I:N/A:N" );
...
vers = infos["version"];
path = infos["location"];
if(version_in_range( version: vers, test_version: "1.8.0", test_version2: "1.8.0.212" ) || version_in_range( version: vers, test_version: "11.0", test_version2: "11.0.3" ) || version_in_range( version: vers, test_version: "12.0", test_version2: "12.0.1" )){
