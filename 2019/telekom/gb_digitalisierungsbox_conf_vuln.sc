if(description){
	...
	script_dependencies( "gb_digitalisierungsbox_consolidation.sc" );
...
vers = infos["version"];
if(version_is_less( version: vers, test_version: "11.1.2.102" )){
	report = report_fixed_ver( installed_version: vers, fixed_version: "11.1.2.102" );
