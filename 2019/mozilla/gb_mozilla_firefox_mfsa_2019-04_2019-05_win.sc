...
if(description){
	...
	script_name( "Mozilla Firefox Security Update (mfsa_2019-04_2019-05) - Windows" );
  ...
  attackers to cause denial of service." );
	...
	script_tag( name: "solution", value: "Update to Mozilla Firefox version 65.0.1
...
vers = infos["version"];
path = infos["location"];
if(version_is_less( version: vers, test_version: "65.0.1" )){
	report = report_fixed_ver( installed_version: vers, fixed_version: "65.0.1", install_path: path );
