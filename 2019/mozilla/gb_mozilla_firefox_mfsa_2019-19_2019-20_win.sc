...
if(description){
	...
	script_name( "Mozilla Firefox Security Update (mfsa_2019-19_2019-20) - Windows" );
	script_tag( name: "summary", value: "Mozilla Firefox is prone to security bypass vulnerability." );
  ...
  on Windows." );
	script_tag( name: "solution", value: "Update to Mozilla Firefox version 67.0.4
