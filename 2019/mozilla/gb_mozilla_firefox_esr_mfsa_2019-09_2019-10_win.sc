...
if(description){
	...
	script_name( "Mozilla Firefox ESR Security Update (mfsa_2019-09_2019-10) - Windows" );
  ...
  attackers to execute arbitrary code and cause denial of service." );
	...
	script_tag( name: "solution", value: "Update to Mozilla Firefox ESR version 60.6.1 or later. Please see the references for more information." );
