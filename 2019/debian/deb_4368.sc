...
res = "";
report = "";
if(!isnull( res = isdpkgvuln( pkg: "libzmq3-dev", ver: "4.2.1-4+deb9u1", rls: "DEB9" ) )){
	report += res;
}
if(!isnull( res = isdpkgvuln( pkg: "libzmq5", ver: "4.2.1-4+deb9u1", rls: "DEB9" ) )){
	report += res;
}
if(!isnull( res = isdpkgvuln( pkg: "libzmq5-dbg", ver: "4.2.1-4+deb9u1", rls: "DEB9" ) )){
	report += res;
}
if( report != "" ){
