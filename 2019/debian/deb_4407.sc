...
res = "";
report = "";
if(!isnull( res = isdpkgvuln( pkg: "libxmltooling-dev", ver: "1.6.0-4+deb9u2", rls: "DEB9" ) )){
	report += res;
}
if(!isnull( res = isdpkgvuln( pkg: "libxmltooling-doc", ver: "1.6.0-4+deb9u2", rls: "DEB9" ) )){
	report += res;
}
if(!isnull( res = isdpkgvuln( pkg: "libxmltooling7", ver: "1.6.0-4+deb9u2", rls: "DEB9" ) )){
	report += res;
}
if(!isnull( res = isdpkgvuln( pkg: "xmltooling-schemas", ver: "1.6.0-4+deb9u2", rls: "DEB9" ) )){
	report += res;
}
if( report != "" ){
