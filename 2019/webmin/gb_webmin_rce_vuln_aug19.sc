...
headers = make_array( "Referer", http_report_vuln_url( port: port, url: "/session_login.cgi", url_only: TRUE ), "Content-Type", "application/x-www-form-urlencoded", "Cookie", "redirect=1; testing=1; sid=x; sessiontest=1" );
