...
if(description){
	...
	script_tag( name: "summary", value: "Nessus is prone to a stored cross-site scripting (XSS) vulnerability." );
  ...
  arbitrary script code in a user's browser session." );
	...
	script_tag( name: "solution", value: "Update to version 8.2.2 or later. Please see the references for more information." );
