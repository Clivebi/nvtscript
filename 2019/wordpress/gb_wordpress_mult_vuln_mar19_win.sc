...
vers = infos["version"];
path = infos["location"];
if( IsMatchRegexp( vers, "^5\\.1\\." ) && version_is_less( version: vers, test_version: "5.1.1" ) ) {
	fix = "5.1.1";
}
else {
	if( IsMatchRegexp( vers, "^5\\.0\\." ) && version_is_less( version: vers, test_version: "5.0.4" ) ) {
		fix = "5.0.4";
	}
	else {
		if( IsMatchRegexp( vers, "^4\\.9\\." ) && version_is_less( version: vers, test_version: "4.9.10" ) ) {
			fix = "4.9.10";
		}
		else {
			if( IsMatchRegexp( vers, "^4\\.8\\." ) && version_is_less( version: vers, test_version: "4.8.9" ) ) {
				fix = "4.8.9";
			}
			else {
				if( IsMatchRegexp( vers, "^4\\.7\\." ) && version_is_less( version: vers, test_version: "4.7.13" ) ) {
					fix = "4.7.13";
				}
				else {
					if( IsMatchRegexp( vers, "^4\\.6\\." ) && version_is_less( version: vers, test_version: "4.6.14" ) ) {
						fix = "4.6.14";
					}
					else {
						if( IsMatchRegexp( vers, "^4\\.5\\." ) && version_is_less( version: vers, test_version: "4.5.17" ) ) {
							fix = "4.5.17";
						}
						else {
							if( IsMatchRegexp( vers, "^4\\.4\\." ) && version_is_less( version: vers, test_version: "4.4.18" ) ) {
								fix = "4.4.18";
							}
							else {
								if( IsMatchRegexp( vers, "^4\\.3\\." ) && version_is_less( version: vers, test_version: "4.3.19" ) ) {
									fix = "4.3.19";
								}
								else {
									if( IsMatchRegexp( vers, "^4\\.2\\." ) && version_is_less( version: vers, test_version: "4.2.23" ) ) {
										fix = "4.2.23";
									}
									else {
										if( IsMatchRegexp( vers, "^4\\.1\\." ) && version_is_less( version: vers, test_version: "4.1.26" ) ) {
											fix = "4.1.26";
										}
										else {
											if( IsMatchRegexp( vers, "^4\\.0\\." ) && version_is_less( version: vers, test_version: "4.0.26" ) ) {
												fix = "4.0.26";
											}
											else {
												if(version_is_less( version: vers, test_version: "3.9.27" )){
													fix = "3.9.27";
												}
											}
										}
