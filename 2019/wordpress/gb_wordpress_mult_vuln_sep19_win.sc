...
vers = infos["version"];
path = infos["location"];
if( IsMatchRegexp( vers, "^5\\.2\\." ) && version_is_less( version: vers, test_version: "5.2.3" ) ) {
	fix = "5.2.3";
}
else {
	if( IsMatchRegexp( vers, "^5\\.1\\." ) && version_is_less( version: vers, test_version: "5.1.2" ) ) {
		fix = "5.1.2";
	}
	else {
		if( IsMatchRegexp( vers, "^5\\.0\\." ) && version_is_less( version: vers, test_version: "5.0.6" ) ) {
			fix = "5.0.6";
		}
		else {
			if( IsMatchRegexp( vers, "^4\\.9\\." ) && version_is_less( version: vers, test_version: "4.9.11" ) ) {
				fix = "4.9.11";
			}
			else {
				if( IsMatchRegexp( vers, "^4\\.8\\." ) && version_is_less( version: vers, test_version: "4.8.10" ) ) {
					fix = "4.8.10";
				}
				else {
					if( IsMatchRegexp( vers, "^4\\.7\\." ) && version_is_less( version: vers, test_version: "4.7.14" ) ) {
						fix = "4.7.14";
					}
					else {
						if( IsMatchRegexp( vers, "^4\\.6\\." ) && version_is_less( version: vers, test_version: "4.6.15" ) ) {
							fix = "4.6.15";
						}
						else {
							if( IsMatchRegexp( vers, "^4\\.5\\." ) && version_is_less( version: vers, test_version: "4.5.18" ) ) {
								fix = "4.5.18";
							}
							else {
								if( IsMatchRegexp( vers, "^4\\.4\\." ) && version_is_less( version: vers, test_version: "4.4.19" ) ) {
									fix = "4.4.19";
								}
								else {
									if( IsMatchRegexp( vers, "^4\\.3\\." ) && version_is_less( version: vers, test_version: "4.3.20" ) ) {
										fix = "4.3.20";
									}
									else {
										if( IsMatchRegexp( vers, "^4\\.2\\." ) && version_is_less( version: vers, test_version: "4.2.24" ) ) {
											fix = "4.2.24";
										}
										else {
											if( IsMatchRegexp( vers, "^4\\.1\\." ) && version_is_less( version: vers, test_version: "4.1.27" ) ) {
												fix = "4.1.27";
											}
											else {
												if( IsMatchRegexp( vers, "^4\\.0\\." ) && version_is_less( version: vers, test_version: "4.0.27" ) ) {
													fix = "4.0.27";
												}
												else {
													if( IsMatchRegexp( vers, "^3\\.9\\." ) && version_is_less( version: vers, test_version: "3.9.28" ) ) {
														fix = "3.9.28";
													}
													else {
														if( IsMatchRegexp( vers, "^3\\.8\\." ) && version_is_less( version: vers, test_version: "3.8.30" ) ) {
															fix = "3.8.30";
														}
														else {
															if(version_is_less( version: vers, test_version: "3.7.30" )){
																fix = "3.7.30";
															}
														}
													}
