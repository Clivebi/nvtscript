...
if(ContainsString( res, "<title>Data Protection Advisor</title>" ) && ContainsString( res, "description\">Server is starting. Please wait." )){
	version = "unknown";
	...
	log_message( data: build_detection_report( app: "Dell EMC Data Protection Advisor", version: version, install: "/", cpe: cpe, concluded: vers[0], extra: "Build: " + build ), port: port );
	exit( 0 );
}
exit( 0 );
