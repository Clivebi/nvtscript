if(description){
	...
	script_version( "2021-03-02T07:59:17+0000" );
	script_tag( name: "last_modification", value: "2021-03-02 07:59:17 +0000 (Tue, 02 Mar 2021)" );
	...
	script_dependencies( "find_service.sc", "ssh_detect.sc" );
...
if(get_port_state( 822 ) && get_port_state( 1750 ) && get_port_state( 1751 )){
