if(description){
	...
	script_tag( name: "summary", value: "SMB login-based detection of Microsoft Office Products." );
...
WORDVIEW_LIST = make_list( "^9\\.",
	 "cpe:/a:microsoft:office_word_viewer:2000",
	 "^10\\.",
	 "cpe:/a:microsoft:office_word_viewer:2002",
	 "^11\\.",
	 "cpe:/a:microsoft:office_word_viewer:2003",
	 "^12\\.",
	 "cpe:/a:microsoft:office_word_viewer:2007",
	 "^14\\.",
	 "cpe:/a:microsoft:office_word_viewer:2010",
	 "^15\\.",
	 "cpe:/a:microsoft:office_word_viewer:2013",
	 "^16\\.",
	 "cpe:/a:microsoft:office_word_viewer:2016" );
WORDVIEW_MAX = max_index( WORDVIEW_LIST );
XLVIEW_LIST = make_list( "^9\\.",
	 "cpe:/a:microsoft:office_excel_viewer:2000",
	 "^10\\.",
	 "cpe:/a:microsoft:office_excel_viewer:2002",
	 "^11\\.",
	 "cpe:/a:microsoft:office_excel_viewer:2003",
	 "^12\\.",
	 "cpe:/a:microsoft:office_excel_viewer:2007",
	 "^14\\.",
	 "cpe:/a:microsoft:office_excel_viewer:2010",
	 "^15\\.",
	 "cpe:/a:microsoft:office_excel_viewer:2013",
	 "^16\\.",
	 "cpe:/a:microsoft:office_excel_viewer:2016" );
XLVIEW_MAX = max_index( XLVIEW_LIST );
PPVIEW_LIST = make_list( "^9\\.",
	 "cpe:/a:microsoft:office_powerpoint_viewer:2000",
	 "^10\\.",
	 "cpe:/a:microsoft:office_powerpoint_viewer:2002",
	 "^11\\.",
	 "cpe:/a:microsoft:office_powerpoint_viewer:2003",
	 "^12\\.",
	 "cpe:/a:microsoft:office_powerpoint_viewer:2007",
	 "^14\\.",
	 "cpe:/a:microsoft:office_powerpoint_viewer:2010",
	 "^15\\.",
	 "cpe:/a:microsoft:office_powerpoint_viewer:2013",
	 "^16\\.",
	 "cpe:/a:microsoft:office_powerpoint_viewer:2016" );
PPVIEW_MAX = max_index( PPVIEW_LIST );
VISIO_LIST = make_list( "^9\\.",
	 "cpe:/a:microsoft:visio_viewer:2000",
	 "^10\\.",
	 "cpe:/a:microsoft:visio_viewer:2002",
	 "^11\\.",
	 "cpe:/a:microsoft:visio_viewer:2003",
	 "^12\\.",
	 "cpe:/a:microsoft:visio_viewer:2007",
	 "^14\\.",
	 "cpe:/a:microsoft:visio_viewer:2010",
	 "^15\\.",
	 "cpe:/a:microsoft:visio_viewer:2013",
	 "^16\\.",
	 "cpe:/a:microsoft:visio_viewer:2016" );
VISIO_MAX = max_index( VISIO_LIST );
WORD_LIST = make_list( "^9\\.",
	 "cpe:/a:microsoft:office_word:2000",
	 "^10\\.",
	 "cpe:/a:microsoft:office_word:2002",
	 "^11\\.",
	 "cpe:/a:microsoft:office_word:2003",
	 "^12\\.",
	 "cpe:/a:microsoft:office_word:2007",
	 "^14\\.",
	 "cpe:/a:microsoft:office_word:2010",
	 "^15\\.",
	 "cpe:/a:microsoft:office_word:2013",
	 "^16\\.",
	 "cpe:/a:microsoft:office_word:2016" );
WORD_MAX = max_index( WORD_LIST );
EXCEL_LIST = make_list( "^9\\.",
	 "cpe:/a:microsoft:office_excel:2000",
	 "^10\\.",
	 "cpe:/a:microsoft:office_excel:2002",
	 "^11\\.",
	 "cpe:/a:microsoft:office_excel:2003",
	 "^12\\.",
	 "cpe:/a:microsoft:office_excel:2007",
	 "^14\\.",
	 "cpe:/a:microsoft:office_excel:2010",
	 "^15\\.",
	 "cpe:/a:microsoft:office_excel:2013",
	 "^16\\.",
	 "cpe:/a:microsoft:office_excel:2016" );
EXCEL_MAX = max_index( EXCEL_LIST );
ACCESS_LIST = make_list( "^9\\.",
	 "cpe:/a:microsoft:access:2000",
	 "^10\\.",
	 "cpe:/a:microsoft:access:2002",
	 "^11\\.",
	 "cpe:/a:microsoft:access:2003",
	 "^12\\.",
...
POWERPNT_LIST = make_list( "^9\\.",
	 "cpe:/a:microsoft:office_powerpoint:2000",
	 "^10\\.",
	 "cpe:/a:microsoft:office_powerpoint:2002",
	 "^11\\.",
	 "cpe:/a:microsoft:office_powerpoint:2003",
	 "^12\\.",
	 "cpe:/a:microsoft:office_powerpoint:2007",
	 "^14\\.",
	 "cpe:/a:microsoft:office_powerpoint:2010",
	 "^15\\.",
	 "cpe:/a:microsoft:office_powerpoint:2013",
	 "^16\\.",
	 "cpe:/a:microsoft:office_powerpoint:2016" );
POWERPNT_MAX = max_index( POWERPNT_LIST );
OUTLOOK_LIST = make_list( "^9\\.",
...
PUBLISHER_LIST = make_list( "^9\\.",
	 "cpe:/a:microsoft:office_publisher:2000",
	 "^10\\.",
	 "cpe:/a:microsoft:office_publisher:2002",
	 "^11\\.",
	 "cpe:/a:microsoft:office_publisher:2003",
	 "^12\\.",
	 "cpe:/a:microsoft:office_publisher:2007",
	 "^14\\.",
	 "cpe:/a:microsoft:office_publisher:2010",
	 "^15\\.",
	 "cpe:/a:microsoft:office_publisher:2013",
	 "^16\\.",
	 "cpe:/a:microsoft:office_publisher:2016" );
	...
	if(wordviewVer){
		...
		for(i = 0;i < WORDVIEW_MAX - 1;i = i + 2){
			if(egrep( string: wordviewVer, pattern: WORDVIEW_LIST[i] )){
				register_and_report_cpe( app: "Microsoft Office WordView", ver: wordviewVer, insloc: wordviewFile, base: WORDVIEW_LIST[i + 1], expr: WORDVIEW_LIST[i] );
				break;
			}
		}
	}
...
for key in key_list {
	for item in registry_enum_keys( key: key ) {
		if(ContainsString( registry_get_sz( key: key + item, item: "DisplayName" ), "Microsoft Office Excel Viewer" )){
					...
					if(xlviewVer){
						...
						for(i = 0;i < XLVIEW_MAX - 1;i = i + 2){
							if(egrep( string: xlviewVer, pattern: XLVIEW_LIST[i] )){
								register_and_report_cpe( app: "Microsoft Office Excel Viewer", ver: xlviewVer, insloc: xlviewFile, base: XLVIEW_LIST[i + 1], expr: XLVIEW_LIST[i] );
								break;
							}
						}
					}
		...
		if(ContainsString( registry_get_sz( key: key + item, item: "DisplayName" ), "Microsoft Office PowerPoint Viewer" ) || ContainsString( registry_get_sz( key: key + item, item: "DisplayName" ), "Microsoft PowerPoint Viewer" )){
					...
					if(pptviewVer){
						...
						for(i = 0;i < PPVIEW_MAX - 1;i = i + 2){
							if(egrep( string: pptviewVer, pattern: PPVIEW_LIST[i] )){
								register_and_report_cpe( app: "Microsoft PowerPoint Viewer", ver: pptviewVer, insloc: ppviewFile, base: PPVIEW_LIST[i + 1], expr: PPVIEW_LIST[i] );
								break;
							}
						}
					}
		...
		if(ContainsString( registry_get_sz( key: key + item, item: "DisplayName" ), "Compatibility Pack" )){
			cPackVer = registry_get_sz( key: key + item, item: "DisplayVersion" );
			if(cPackVer){
				set_kb_item( name: "SMB/Office/ComptPack/Version", value: cPackVer );
				set_kb_item( name: "MS/Office/Prdts/Installed", value: TRUE );
				if(IsMatchRegexp( cPackVer, "^12\\." )){
					register_and_report_cpe( app: "Microsoft Office Compatibility Pack", ver: cPackVer, base: "cpe:/a:microsoft:compatibility_pack_word_excel_powerpoint:2007:", expr: "^(12\\..*)" );
				}
			}
		}
	}
...
if(groovePath){
	...
	if(grooveVer){
		...
		set_kb_item( name: "MS/Office/Prdts/Installed", value: TRUE );
		if(IsMatchRegexp( grooveVer, "^12\\." )){
			register_and_report_cpe( app: "Microsoft Office Groove", ver: grooveVer, insloc: groovePath, base: "cpe:/a:microsoft:office_groove:2007:", expr: "^(12\\..*)" );
		}
	}
}
...
if(visioPath || visioPath1){
	for path in make_list( "Office12",
		 "Office14",
		 "Office15",
		 "Office16" ) {
		...
		if(visiovVer){
			...
			for(i = 0;i < VISIO_MAX - 1;i = i + 2){
				if(egrep( string: visiovVer, pattern: VISIO_LIST[i] )){
					register_and_report_cpe( app: "Microsoft Office VisioViewer", ver: visiovVer, insloc: exePath + "\\Vpreview.exe", base: VISIO_LIST[i + 1], expr: VISIO_LIST[i] );
					break;
				}
			}
		}
	...
	if(wordVer){
		...
		for(i = 0;i < WORD_MAX - 1;i = i + 2){
			if(egrep( string: wordVer, pattern: WORD_LIST[i] )){
				register_and_report_cpe( app: "Microsoft Office Word", ver: wordVer, insloc: wordFile, base: WORD_LIST[i + 1], expr: WORD_LIST[i] );
				break;
			}
		}
	}
	...
	if(excelVer){
		...
		for(i = 0;i < EXCEL_MAX - 1;i = i + 2){
			if(egrep( string: excelVer, pattern: EXCEL_LIST[i] )){
				register_and_report_cpe( app: "Microsoft Office Excel", ver: excelVer, insloc: excelFile, base: EXCEL_LIST[i + 1], expr: EXCEL_LIST[i] );
				break;
			}
		}
	}
	...
	if(accessVer){
		...
		for(i = 0;i < ACCESS_MAX - 1;i = i + 2){
			if(egrep( string: accessVer, pattern: ACCESS_LIST[i] )){
				register_and_report_cpe( app: "Microsoft Office Access", ver: accessVer, insloc: accessFile, base: ACCESS_LIST[i + 1], expr: ACCESS_LIST[i] );
				break;
			}
		}
	}
	...
	if(powerPptVer){
		...
		for(i = 0;i < POWERPNT_MAX - 1;i = i + 2){
			if(egrep( string: powerPptVer, pattern: POWERPNT_LIST[i] )){
				register_and_report_cpe( app: "Microsoft Office PowerPoint", ver: powerPptVer, insloc: powerpointFile, base: POWERPNT_LIST[i + 1], expr: POWERPNT_LIST[i] );
				break;
			}
		}
	}
...
if(wordcnvFile){
	...
	if(wordcnvVer){
		...
		if(IsMatchRegexp( wordcnvVer, "^12\\." )){
			register_and_report_cpe( app: "Microsoft Office Word Converter", ver: wordcnvVer, insloc: wordcnvFile, base: "", expr: "^(12\\..*)" );
		}
	}
}
...
if(xlcnvFile1 || xlcnvFile2){
	...
	if(xlcnvVer){
		...
		if(IsMatchRegexp( xlcnvVer, "^12\\." )){
			register_and_report_cpe( app: "Microsoft Office Excel Converter", ver: xlcnvVer, insloc: xlcnvFile, base: "", expr: "^(12\\..*)" );
		}
	}
}
	...
	if(pubVer){
		...
		for(i = 0;i < PUBLISHER_MAX - 1;i = i + 2){
			if(egrep( string: pubVer, pattern: PUBLISHER_LIST[i] )){
				register_and_report_cpe( app: "Microsoft Office Publisher", ver: pubVer, insloc: pubFile + "\\MSPUB.exe", base: PUBLISHER_LIST[i + 1], expr: PUBLISHER_LIST[i] );
				break;
			}
		}
	}
	...
	if(outlookVer){
		...
		for(i = 0;i < OUTLOOK_MAX - 1;i = i + 2){
			if(egrep( string: outlookVer, pattern: OUTLOOK_LIST[i] )){
				register_and_report_cpe( app: "Microsoft Office Outlook", ver: outlookVer, insloc: outlookFile + "\\OUTLOOK.EXE", base: OUTLOOK_LIST[i + 1], expr: OUTLOOK_LIST[i] );
				break;
			}
		}
	}
