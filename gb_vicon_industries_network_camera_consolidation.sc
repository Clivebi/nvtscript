if(description){
	...
	script_dependencies( "gb_vicon_industries_network_camera_detect_snmp.sc", "gb_vicon_industries_network_camera_detect_telnet.sc", "gb_vicon_industries_network_camera_detect_http.sc" );
...
report += "\n\n" + build_detection_report( app: hw_name, install: location, cpe: hw_cpe, skip_version: TRUE );
if(extra){
	report += "\n\nDetection methods:\n";
	report += "\n" + extra;
}
