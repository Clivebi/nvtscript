...
for dir in nasl_make_list_unique( "/", "/e107", "/cms", http_cgi_dirs( port: port ) ) {
	install = dir;
	if(dir == "/"){
		dir = "";
	}
	...
	if(egrep( pattern: "This site is powered by <a.*e107.org.*[^>]+>e107</a>", string: buf, icase: TRUE ) || egrep( pattern: "src=\'/e107", string: buf2, icase: TRUE ) || ContainsString( buf3, "e107 Powered Website: News" )){
		...
		cpe = "cpe:/a:e107:e107:";
		register_and_report_cpe( app: "e107", ver: version, concluded: concluded, base: cpe, expr: "([0-9.]+)", insloc: install, regService: "www", conclUrl: concluded_url, regPort: port );
		exit( 0 );
	}
}
exit( 0 );
