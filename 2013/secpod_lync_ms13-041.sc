...
if(get_kb_item( "MS/Lync/Ver" )){
	...
	if(path){
		...
		if(commVer){
			if(version_in_range( version: commVer, test_version: "3.5", test_version2: "3.5.6907.267" ) || version_in_range( version: commVer, test_version: "4.0", test_version2: "4.0.7577.4387" )){
