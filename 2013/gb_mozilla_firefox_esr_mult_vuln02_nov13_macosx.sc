...
if(ffVer && IsMatchRegexp( ffVer, "^(17\\.0|24\\.0)" )){
	if(version_in_range( version: ffVer, test_version: "17.0", test_version2: "17.0.9" ) || version_in_range( version: ffVer, test_version: "24.0", test_version2: "24.0.2" )){
