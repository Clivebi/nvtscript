...
url = dir + "/wp-content/plugins/dhtmlxspreadsheet/codebase/spreadsheet.php" + "?page=<script>alert(document.cookie);</script>";
if(http_vuln_check( port: http_port, url: url, check_header: TRUE, pattern: "<script>alert\\(document.cookie\\);</script>", extra_check: "window.dhtmlxSpreadSheet" )){
