...
if( hotfix_check_sp( xp: 4, xpx64: 3, win2003: 3, win2003x64: 3 ) > 0 ){
	if(version_in_range( version: scrVer, test_version: "5.6.0.0", test_version2: "5.6.0.8850" ) || version_in_range( version: scrVer, test_version: "5.7.6002.0", test_version2: "5.7.6002.18959" )){
	...
	if( hotfix_check_sp( winVista: 3, win2008: 3 ) > 0 ){
		if(version_is_less( version: scrVer, test_version: "5.7.6002.18960" ) || version_in_range( version: scrVer, test_version: "5.7.6002.23000", test_version2: "5.7.6002.23241" )){
			security_message( port: 0, data: "The target host was found to be vulnerable" );
		}
		exit( 0 );
	}
		...
		if( hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0 ){
			if(version_is_less( version: scrVer, test_version: "5.8.7601.18283" ) || version_in_range( version: scrVer, test_version: "5.8.7601.22480", test_version2: "5.8.7601.22479" )){
				security_message( port: 0, data: "The target host was found to be vulnerable" );
			}
			exit( 0 );
		}
			...
			if( hotfix_check_sp( win8: 1, win8x64: 1, win2012: 1 ) > 0 ){
				if(version_is_less( version: scrVer, test_version: "5.8.9200.16734" ) || version_in_range( version: scrVer, test_version: "5.8.9200.20000", test_version2: "5.8.9200.20844" )){
					security_message( port: 0, data: "The target host was found to be vulnerable" );
				}
				exit( 0 );
			}
