if(description){
	...
	script_mandatory_keys( "canon_printer/installed", "canon_printer_model", "canon_printer/port" );
...
if(http_vuln_check( port: port, url: "/English/pages_MacUS/wls_set_content.html", pattern: ">Authentication Type:", extra_check: make_list( ">Passphrase:",
	 ">Password" ) )){
