...
if(ereg( pattern: "^11", string: version )){
	if( version_is_less( version: version, test_version: "11.4.R6" ) ){
		...
		if(version_is_less( version: version, test_version: "11.4X27.43" ) && version_is_greater( version: version, test_version: "11.4.X" )){
			security_message( port: 0, data: desc );
			exit( 0 );
		}
	}
...
if(ereg( pattern: "^12\\.1", string: version )){
	if( version_is_less( version: version, test_version: "12.1R5" ) ){
		...
		if(version_is_less( version: version, test_version: "12.1X44-D15" ) && version_is_greater( version: version, test_version: "12.1X" )){
			security_message( port: 0, data: desc );
			exit( 0 );
		}
	}
...
if(ereg( pattern: "^12\\.3", string: version )){
	if( version_is_less( version: version, test_version: "12.3R1" ) ){
		...
		if(version_is_less( version: version, test_version: "12.3X50-D11" ) && version_is_greater( version: version, test_version: "12.3X" )){
			security_message( port: 0, data: desc );
			exit( 0 );
		}
	}
