...
if(hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0){
	if(version_is_less( version: afdSysVer, test_version: "6.1.7601.18272" ) || version_in_range( version: afdSysVer, test_version: "6.2.9200.22000", test_version2: "6.1.7601.22466" )){
		security_message( port: 0, data: "The target host was found to be vulnerable" );
	}
	exit( 0 );
}
if(hotfix_check_sp( win2012: 1 ) > 0){
	if(version_is_less( version: afdSysVer, test_version: "6.2.9200.16706" ) || version_in_range( version: afdSysVer, test_version: "6.2.9200.20000", test_version2: "6.2.9200.20813" )){
		security_message( port: 0, data: "The target host was found to be vulnerable" );
	}
	exit( 0 );
}
