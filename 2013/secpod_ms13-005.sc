...
if( hotfix_check_sp( winVista: 3, win2008: 3 ) > 0 ){
	if(version_is_less( version: sysVer, test_version: "6.0.6002.18739" ) || version_in_range( version: sysVer, test_version: "6.0.6002.22000", test_version2: "6.0.6002.22983" )){
	...
	if(hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0){
		if(version_is_less( version: sysVer, test_version: "6.1.7600.17175" ) || version_in_range( version: sysVer, test_version: "6.1.7600.20000", test_version2: "6.1.7600.21379" ) || version_in_range( version: sysVer, test_version: "6.1.7601.17000", test_version2: "6.1.7601.18009" ) || version_in_range( version: sysVer, test_version: "6.1.7601.21000", test_version2: "6.1.7601.22171" )){
			security_message( port: 0, data: "The target host was found to be vulnerable" );
		}
	}
}
