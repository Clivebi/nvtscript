...
url = dir + "/plugins/content/plugin_googlemap2_proxy.php" + "?url=%3Cbody%20onload=alert(document.cookie)%3E";
if(http_vuln_check( port: port, url: url, check_header: TRUE, pattern: "onload=alert\\(document.cookie\\)", extra_check: "Couldn't resolve host" )){
