...
if(!mariadbVer || !IsMatchRegexp( mariadbVer, "^5\\.[1235]\\." )){
	exit( 0 );
}
if(version_in_range( version: mariadbVer, test_version: "5.1", test_version2: "5.1.67" ) || version_in_range( version: mariadbVer, test_version: "5.2", test_version2: "5.2.14" ) || version_in_range( version: mariadbVer, test_version: "5.3", test_version2: "5.3.12" ) || version_in_range( version: mariadbVer, test_version: "5.5", test_version2: "5.5.29" )){
