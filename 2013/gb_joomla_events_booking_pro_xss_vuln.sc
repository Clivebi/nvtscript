...
url = dir + "/modules/mod_eb_v5_mini_calendar/tmpl/tootip.php?info=" + "eyJldmVudHMiOiI8c2NyaXB0PmFsZXJ0KGRvY3VtZW50LmxvY2F0aW" + "9uKTs8L3NjcmlwdD4ifQ==";
if(http_vuln_check( port: port, url: url, check_header: TRUE, pattern: "><script>alert\\(document\\.location\\);</script>", extra_check: "com_events_booking" )){
