...
url = dir + "/wp-content/plugins/mobilechief-mobile-site-creator/lib/" + "jquery-validate/demo/captcha/index.php/\"/><script>alert(" + "document.cookie);</script>";
if(http_vuln_check( port: http_port, url: url, check_header: TRUE, pattern: "<script>alert\\(document.cookie\\);</script>", extra_check: ">AJAX CAPTCHA<" )){
