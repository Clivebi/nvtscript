if(description){
  ...
  - Microsoft Windows Server 2008 x32/x64 Edition Service Pack 2 and prior" );
	...
	script_dependencies( "smb_reg_service_pack.sc", "gb_ms_groove_server_detect_win.sc", "gb_ms_expression_web_detect.sc", "secpod_office_products_version_900032.sc", "gb_ms_sharepoint_sever_n_foundation_detect.sc" );
	...
	if( hotfix_check_sp( xpx64: 3, win2003x64: 3 ) > 0 ){
		...
		if(hotfix_check_sp( win7x64: 2, win2008r2: 2 ) > 0){
			if( version_is_less( version: dllVer3, test_version: "8.110.7600.17157" ) ){
				...
				if( version_in_range( version: dllVer3, test_version: "8.110.7600.20000", test_version2: "8.110.7600.21359" ) ){
					Vulnerable_range = "8.110.7600.20000 - 8.110.7600.21359";
					VULN = TRUE;
				}
				else {
					if( version_in_range( version: dllVer3, test_version: "8.110.7601.17000", test_version2: "8.110.7601.17987" ) ){
						Vulnerable_range = "8.110.7601.17000 - 8.110.7601.17987";
						VULN = TRUE;
					}
					else {
						if(version_in_range( version: dllVer3, test_version: "8.110.7601.21000", test_version2: "8.110.7601.22148" )){
			...
			if( hotfix_check_sp( winVista: 3, win2008: 3 ) > 0 ){
				...
				if(hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0){
					if( version_is_less( version: dllVer6, test_version: "6.30.7600.17157" ) ){
						...
						if( version_in_range( version: dllVer6, test_version: "6.30.7600.20000", test_version2: "6.30.7600.21359" ) ){
							Vulnerable_range = "6.30.7600.20000 - 6.30.7600.21359";
							VULN = TRUE;
						}
						else {
							if( version_in_range( version: dllVer6, test_version: "6.30.7601.17000", test_version2: "6.30.7601.17987" ) ){
								Vulnerable_range = "6.30.7601.17000 - 6.30.7601.17987";
								VULN = TRUE;
							}
							else {
								if(version_in_range( version: dllVer6, test_version: "6.30.7601.21000", test_version2: "6.30.7601.22148" )){
...
if(( officeVer && IsMatchRegexp( officeVer, "^1[12]\\." ) ) || wordVer || wordCnvVer || ( grooveSrvVer && IsMatchRegexp( grooveSrvVer, "^12\\." ) ) || ( shrPtSrvVer && IsMatchRegexp( shrPtSrvVer, "^12\\." ) ) || ( expressWebVer && IsMatchRegexp( expressWebVer, "^12\\." ) )){
