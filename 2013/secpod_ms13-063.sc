...
if(hotfix_check_sp( xp: 4, win2003: 3, winVista: 3, win7: 2, win7x64: 2, win2008: 3, win2008r2: 2, win8: 1 ) <= 0){
	exit( 0 );
}
...
if( hotfix_check_sp( xp: 4 ) > 0 ){
	...
	if( hotfix_check_sp( win2003: 3 ) > 0 ){
		...
		if( hotfix_check_sp( winVista: 3, win2008: 3 ) > 0 ){
			if(version_is_less( version: exeVer, test_version: "6.0.6002.18881" ) || version_in_range( version: exeVer, test_version: "6.0.6002.22000", test_version2: "6.0.6002.23153" )){
				security_message( port: 0, data: "The target host was found to be vulnerable" );
			}
			exit( 0 );
		}
			...
			if( hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0 ){
				if(version_is_less( version: exeVer, test_version: "6.1.7601.18205" ) || version_in_range( version: exeVer, test_version: "6.1.7601.22000", test_version2: "6.1.7601.22378" )){
					security_message( port: 0, data: "The target host was found to be vulnerable" );
				}
				exit( 0 );
			}
				...
				if(hotfix_check_sp( win8: 1 ) > 0){
					if(version_is_less( version: exeVer, test_version: "6.2.9200.16659" ) || version_in_range( version: exeVer, test_version: "6.2.9200.20000", test_version2: "6.2.9200.20771" )){
						security_message( port: 0, data: "The target host was found to be vulnerable" );
					}
					exit( 0 );
				}
