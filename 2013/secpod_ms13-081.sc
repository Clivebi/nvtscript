if(description){
	...
	script_cve_id( "CVE-2013-3128", "CVE-2013-3200", "CVE-2013-3879", "CVE-2013-3880", "CVE-2013-3881", "CVE-2013-3888", "CVE-2013-3894" );
...
if(usbdSysVer || atmfdVer || hidparseVer || win32SysVer || dwVer || cddVer || wdVer){
	if(hotfix_check_sp( xp: 4 ) > 0){
		if( version_is_less( version: atmfdVer, test_version: "5.1.2.236" ) && ( atmfdVer ) ){
			Vulnerable_range_atmfd = "Less than 5.1.2.236";
		}
		else {
			if( version_is_less( version: usbdSysVer, test_version: "5.1.2600.6437" ) && ( usbdSysVer ) ){
				Vulnerable_range_usbdSys = "Less than 5.1.2600.6437";
			}
			else {
				if( version_is_less( version: hidparseVer, test_version: "5.1.2600.6418" ) && ( hidparseVer ) ){
					Vulnerable_range_hidparse = "Less than 5.1.2600.6418";
				}
				else {
					if(version_is_less( version: win32SysVer, test_version: "5.1.2600.6442" ) && ( win32SysVer )){
	...
	if(hotfix_check_sp( xpx64: 3, win2003x64: 3, win2003: 3 ) > 0){
		if( version_is_less( version: atmfdVer, test_version: "5.1.2.236" ) && ( atmfdVer ) ){
			...
			if( version_is_less( version: usbdSysVer, test_version: "5.2.3790.5203" ) && ( usbdSysVer ) ){
				Vulnerable_range_usbdSys = "Less than 5.2.3790.5203";
			}
			else {
				if( version_is_less( version: hidparseVer, test_version: "5.2.3790.5189" ) && ( hidparseVer ) ){
					Vulnerable_range_hidparse = "Less than 5.2.3790.5189";
				}
				else {
					if(version_is_less( version: win32SysVer, test_version: "5.2.3790.5216" ) && ( win32SysVer )){
	...
	if(hotfix_check_sp( winVista: 3, win2008: 3 ) > 0){
		if(fontsubVer){
			if( version_is_less( version: fontsubVer, test_version: "6.0.6002.18272" ) ){
				...
				if(version_in_range( version: fontsubVer, test_version: "6.0.6002.22000", test_version2: "6.0.6002.23131" )){
		...
		if(usbdSysVer){
			if( version_is_less( version: usbdSysVer, test_version: "6.0.6002.18875" ) ){
				...
				if(version_in_range( version: usbdSysVer, test_version: "6.0.6002.22000", test_version2: "6.0.6002.23146" )){
		...
		if(hidparseVer){
			if( version_is_less( version: hidparseVer, test_version: "6.0.6002.18878" ) ){
				...
				if(version_in_range( version: hidparseVer, test_version: "6.0.6002.22000", test_version2: "6.0.6002.23149" )){
		...
		if(win32SysVer){
			if( version_is_less( version: win32SysVer, test_version: "6.0.6002.18927" ) ){
				...
				if(version_in_range( version: win32SysVer, test_version: "6.0.6002.22000", test_version2: "6.0.6002.23203" )){
		...
		if(dwVer){
			if( version_is_less( version: dwVer, test_version: "7.0.6002.18923" ) ){
				...
				if(version_in_range( version: dwVer, test_version: "7.0.6002.22000", test_version2: "7.0.6002.23199" )){
		...
		if(cddVer){
			if( version_is_less( version: cddVer, test_version: "7.0.6002.18392" ) ){
				...
				if(version_in_range( version: cddVer, test_version: "7.0.6002.22000", test_version2: "7.0.6002.23180" )){
	...
	if(hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0){
		if(fontsubVer){
			if( version_is_less( version: fontsubVer, test_version: "6.1.7601.18177" ) ){
				...
				if(version_in_range( version: fontsubVer, test_version: "6.1.7601.22000", test_version2: "6.1.7601.22349" )){
		...
		if(usbdSysVer){
			if( version_is_less( version: usbdSysVer, test_version: "6.1.7601.18251" ) ){
				...
				if(version_in_range( version: usbdSysVer, test_version: "6.1.7601.22000", test_version2: "6.1.7601.22440" )){
		...
		if(hidparseVer){
			if( version_is_less( version: hidparseVer, test_version: "6.1.7601.18199" ) ){
				...
				if(version_in_range( version: hidparseVer, test_version: "6.1.7601.22000", test_version2: "6.1.7601.22373" )){
		...
		if(win32SysVer){
			if( version_is_less( version: win32SysVer, test_version: "6.1.7601.18246" ) ){
				...
				if(version_in_range( version: win32SysVer, test_version: "6.1.7601.22000", test_version2: "6.1.7601.22434" )){
		...
		if(dwVer){
			if( version_is_less( version: dwVer, test_version: "6.1.7601.18245" ) ){
				...
				if(version_in_range( version: dwVer, test_version: "6.1.7601.22000", test_version2: "6.1.7601.22433" )){
		...
		if(cddVer){
			if( version_is_less( version: cddVer, test_version: "6.1.7601.17514" ) ){
				...
				if(version_in_range( version: cddVer, test_version: "6.1.7601.22000", test_version2: "6.1.7601.17513" )){
	...
	if(hotfix_check_sp( win8: 1, win2012: 1 ) > 0){
		...
		if(usbdSysVer){
			if( version_is_less( version: usbdSysVer, test_version: "6.2.9200.16654" ) ){
				...
				if(version_in_range( version: usbdSysVer, test_version: "6.2.9200.20000", test_version2: "6.2.9200.20760" )){
		...
		if(hidparseVer){
			if( version_is_less( version: hidparseVer, test_version: "6.2.9200.16654" ) ){
				...
				if(version_in_range( version: hidparseVer, test_version: "6.2.9200.20000", test_version2: "6.2.9200.20762" )){
		...
		if(win32SysVer){
			if( version_is_less( version: win32SysVer, test_version: "6.2.9200.16699" ) ){
				...
				if(version_in_range( version: win32SysVer, test_version: "6.2.9200.20000", test_version2: "6.2.9200.20806" )){
