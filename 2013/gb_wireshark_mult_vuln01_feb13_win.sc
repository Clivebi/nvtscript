...
if(!sharkVer || !IsMatchRegexp( sharkVer, "^1\\.[68]\\." )){
	exit( 0 );
}
if(version_in_range( version: sharkVer, test_version: "1.8.0", test_version2: "1.8.4" ) || version_in_range( version: sharkVer, test_version: "1.6.0", test_version2: "1.6.12" )){
