...
if(apVer && IsMatchRegexp( apVer, "^5\\." )){
	if(version_in_range( version: apVer, test_version: "5.8.2", test_version2: "5.14.3" ) || version_in_range( version: apVer, test_version: "5.15", test_version2: "5.16.2" )){
