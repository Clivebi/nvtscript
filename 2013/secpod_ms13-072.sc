...
if(InsPath && !ContainsString( InsPath, "Could not find the install Location" )){
	for offsubver in make_list( "Office11",
		...
		if(exeVer){
			if(version_in_range( version: exeVer, test_version: "11.0", test_version2: "11.0.8404" ) || version_in_range( version: exeVer, test_version: "12.0", test_version2: "12.0.6683.4999" )){
