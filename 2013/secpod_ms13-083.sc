...
if(hotfix_check_sp( xpx64: 3, win2003: 3, win2003x64: 3, winVista: 3, winVistax64: 3, win7: 2, win7x64: 2, win2008: 3, win2008x64: 3, win2008r2: 2, win8: 1, win8x64: 1, win2012: 1 ) <= 0){
	exit( 0 );
}
...
if( hotfix_check_sp( win2003: 3, xpx64: 3, win2003x64: 3 ) > 0 ){
	...
	if( hotfix_check_sp( winVista: 3, win2008: 3 ) > 0 ){
		if(version_is_less( version: sysVer, test_version: "5.82.6002.18879" ) || version_in_range( version: sysVer, test_version: "5.82.6002.23000", test_version2: "5.82.6002.23150" )){
			security_message( port: 0, data: "The target host was found to be vulnerable" );
		}
		exit( 0 );
	}
		...
		if( hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0 ){
			if(version_is_less( version: sysVer, test_version: "5.82.7601.18201" ) || version_in_range( version: sysVer, test_version: "5.82.7601.22000", test_version2: "5.82.7601.22375" )){
				security_message( port: 0, data: "The target host was found to be vulnerable" );
			}
			exit( 0 );
		}
			...
			if(hotfix_check_sp( win8: 1, win2012: 1 ) > 0){
				if(version_is_less( version: sysVer, test_version: "5.82.9200.16657" ) || version_in_range( version: sysVer, test_version: "5.82.9200.20000", test_version2: "5.82.9200.20764" )){
					security_message( port: 0, data: "The target host was found to be vulnerable" );
				}
				exit( 0 );
			}
