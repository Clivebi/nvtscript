	...
	if( hotfix_check_sp( xp: 4 ) > 0 ){
		...
		if( hotfix_check_sp( win2003: 3, xpx64: 3, win2003x64: 3 ) > 0 ){
			...
			if( hotfix_check_sp( winVista: 3, win2008: 3 ) > 0 ){
				if(version_is_less( version: winSysVer, test_version: "6.0.6002.18817" ) || version_in_range( version: winSysVer, test_version: "6.0.6002.22000", test_version2: "6.0.6002.23093" ) || version_is_less( version: DxgVer, test_version: "7.0.6002.18822" ) || version_in_range( version: DxgVer, test_version: "7.0.6002.23000", test_version2: "7.0.6002.23094" )){
					security_message( port: 0, data: "The target host was found to be vulnerable" );
				}
				exit( 0 );
			}
				...
				if( hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0 ){
					if(version_in_range( version: winSysVer, test_version: "6.1.7601.17000", test_version2: "6.1.7601.18125" ) || version_in_range( version: winSysVer, test_version: "6.1.7601.21000", test_version2: "6.1.7601.22295" ) || version_in_range( version: DxgVer, test_version: "6.1.7601.18000", test_version2: "6.1.7601.18125" ) || version_in_range( version: DxgVer, test_version: "6.1.7601.22000", test_version2: "6.1.7601.22295" )){
						security_message( port: 0, data: "The target host was found to be vulnerable" );
					}
					exit( 0 );
				}
					...
					if(hotfix_check_sp( win8: 1, win2012: 1 ) > 0){
						if(version_is_less( version: ntosVer, test_version: "6.2.9200.16581" ) || version_in_range( version: ntosVer, test_version: "6.2.9200.20000", test_version2: "6.2.9200.20684" ) || version_in_range( version: DxgVer, test_version: "6.2.9200.16000", test_version2: "6.2.9200.16582" ) || version_in_range( version: DxgVer, test_version: "6.2.9200.20000", test_version2: "6.2.9200.20686" )){
							security_message( port: 0, data: "The target host was found to be vulnerable" );
						}
						exit( 0 );
					}
