...
if(description){
	...
	script_bugtraq_id( 59930, 59911, 59917, 59906, 59916, 59914, 59926, 59908, 59910, 59905, 59925, 59904, 59921, 59923, 59918, 59903, 59920, 59919, 59927, 59915, 59913, 59912, 59909, 59907, 59902 );
...
if(acrobatVer && IsMatchRegexp( acrobatVer, "^9|10|11" )){
	if(( version_in_range( version: acrobatVer, test_version: "9.0", test_version2: "9.5.4" ) ) || ( version_in_range( version: acrobatVer, test_version: "10.0", test_version2: "10.1.6" ) ) || ( version_in_range( version: acrobatVer, test_version: "11.0", test_version2: "11.0.02" ) )){
