...
for item in registry_enum_keys( key: key ) {
	...
	if(ContainsString( filterName, "Microsoft Filter Pack" )){
		filterVer = fetch_file_version( sysPath: path, file_name: "\\Microsoft Shared\\Filters\\ONIFILTER.DLL" );
		if(filterVer && IsMatchRegexp( filterVer, "^14\\." )){
