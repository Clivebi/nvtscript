if(description){
	...
	script_cve_id( "CVE-2013-5831", "CVE-2013-5832", "CVE-2013-5812", "CVE-2013-5824", "CVE-2013-5818", "CVE-2013-5819", "CVE-2013-5823", "CVE-2013-5789", "CVE-2013-5820", "CVE-2013-5852", "CVE-2013-5848", "CVE-2013-5776", "CVE-2013-5772", "CVE-2013-5784", "CVE-2013-5787" );
	script_bugtraq_id( 63129, 63158, 63126, 63157, 63141, 63110, 63139, 63133, 63130, 63124, 63156, 63152, 63089, 63098, 63155 );
...
if(IsMatchRegexp( vers, "^1\\.[67]" )){
	if(version_in_range( version: vers, test_version: "1.6.0.0", test_version2: "1.6.0.60" ) || version_in_range( version: vers, test_version: "1.7.0.0", test_version2: "1.7.0.40" )){
