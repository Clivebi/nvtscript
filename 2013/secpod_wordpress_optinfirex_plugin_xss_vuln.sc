...
url = dir + "/wp-content/plugins/optinfirex/lp/index.php?" + "id=\"/><script>alert(document.cookie);</script>";
if(http_vuln_check( port: word_port, url: url, check_header: TRUE, pattern: "<script>alert\\(document.cookie\\);</script>", extra_check: "Signing Up!<" )){
