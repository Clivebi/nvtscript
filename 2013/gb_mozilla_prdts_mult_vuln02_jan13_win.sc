...
if(vers || esrvers){
	if(( vers && version_is_less( version: vers, test_version: "18.0" ) ) || ( esrvers && version_is_equal( version: esrvers, test_version: "17.0.0" ) ) || ( esrvers && version_in_range( version: esrvers, test_version: "10.0", test_version2: "10.0.11" ) )){
...
if(vers || esrvers){
	if(( vers && version_is_less( version: vers, test_version: "17.0.2" ) ) || ( esrvers && version_is_equal( version: esrvers, test_version: "17.0.0" ) ) || ( esrvers && version_in_range( version: esrvers, test_version: "10.0", test_version2: "10.0.11" ) )){
		security_message( port: 0, data: "The target host was found to be vulnerable" );
		exit( 0 );
	}
}
