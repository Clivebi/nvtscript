...
req_common = NASLString( "POST ", url, " HTTP/1.1\\r\\n", "Host: ", host, "\\r\\n", "User-Agent: ", useragent, "\\r\\n", "Content-Type: application/xml\\r\\n" );
post_data1 = NASLString( "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\r\n", "<probe type=\"string\"><![CDATA[\r\n", "hello\r\n", "]]></probe>" );
req1 = NASLString( req_common, "Content-Length: ", strlen( post_data1 ), "\\r\\n\\r\\n", post_data1 );
res1 = http_send_recv( port: port, data: req1 );
if(!res1 || egrep( pattern: "^HTTP/1\\.[01] [45][0-9][0-9]", string: res1 )){
	exit( 0 );
}
post_data2 = NASLString( "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\r\n", "<probe type=\"yaml\"><![CDATA[\r\n", "--- !ruby/object:Time {}\r\n", "\r\n", "]]></probe>" );
req2 = NASLString( req_common, "Content-Length: ", strlen( post_data2 ), "\\r\\n\\r\\n", post_data2 );
res2 = http_send_recv( port: port, data: req2 );
if(egrep( pattern: "^HTTP/1\\.[01] [23][0-9][0-9]", string: res2 )){
	post_data3 = NASLString( "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\r\n", "<probe type=\"yaml\"><![CDATA[\r\n", "--- !ruby/object:\x00\r\n", "]]></probe>" );
	req3 = NASLString( req_common, "Content-Length: ", strlen( post_data3 ), "\\r\\n\\r\\n", post_data3 );
