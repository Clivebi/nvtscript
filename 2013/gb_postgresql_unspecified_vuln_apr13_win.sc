...
vers = infos["version"];
loc = infos["location"];
if(!IsMatchRegexp( vers, "^(8\\.4|9\\.[0-2])\\." )){
	exit( 99 );
}
if(version_in_range( version: vers, test_version: "8.4", test_version2: "8.4.16" ) || version_in_range( version: vers, test_version: "9.0", test_version2: "9.0.12" ) || version_in_range( version: vers, test_version: "9.1", test_version2: "9.1.8" ) || version_in_range( version: vers, test_version: "9.2", test_version2: "9.2.3" )){
