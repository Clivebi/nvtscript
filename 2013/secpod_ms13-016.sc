if(description){
	...
	script_cve_id( "CVE-2013-1248", "CVE-2013-1249", "CVE-2013-1250", "CVE-2013-1264", "CVE-2013-1251", "CVE-2013-1265", "CVE-2013-1252", "CVE-2013-1266", "CVE-2013-1253", "CVE-2013-1267", "CVE-2013-1254", "CVE-2013-1255", "CVE-2013-1256", "CVE-2013-1257", "CVE-2013-1258", "CVE-2013-1259", "CVE-2013-1260", "CVE-2013-1261", "CVE-2013-1262", "CVE-2013-1263", "CVE-2013-1268", "CVE-2013-1269", "CVE-2013-1270", "CVE-2013-1271", "CVE-2013-1272", "CVE-2013-1273", "CVE-2013-1274", "CVE-2013-1275", "CVE-2013-1276", "CVE-2013-1277" );
	script_bugtraq_id( 57786, 57791, 57792, 57806, 57793, 57807, 57794, 57808, 57795, 57809, 57796, 57797, 57798, 57799, 57800, 57801, 57802, 57803, 57804, 57805, 57810, 57811, 57812, 57813, 57814, 57815, 57816, 57817, 57818, 57819 );
...
if( hotfix_check_sp( xp: 4 ) > 0 ){
	...
	if( hotfix_check_sp( win2003: 3, xpx64: 3, win2003x64: 3 ) > 0 ){
		...
		if( hotfix_check_sp( winVista: 3, win2008: 3 ) > 0 ){
			if(version_is_less( version: sysVer, test_version: "6.0.6002.18764" ) || version_in_range( version: sysVer, test_version: "6.0.6002.22000", test_version2: "6.0.6002.23012" )){
				security_message( port: 0, data: "The target host was found to be vulnerable" );
			}
			exit( 0 );
		}
