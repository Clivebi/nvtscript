...
if(!banner || !ContainsString( banner, "SysaxSSH" )){
	exit( 0 );
}
...
if( !soc2 ){
	...
	if(!ContainsString( resp, "SysaxSSH" )){
		close( soc2 );
		security_message( port );
		exit( 0 );
	}
