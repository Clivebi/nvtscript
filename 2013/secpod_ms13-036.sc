...
if( hotfix_check_sp( xp: 4 ) > 0 && Win32sysVer ){
	...
	if( hotfix_check_sp( win2003: 3, xpx64: 3, win2003x64: 3 ) > 0 && Win32sysVer ){
		...
		if( hotfix_check_sp( winVista: 3, win2008: 3 ) > 0 ){
			if(Win32sysVer){
				if(version_is_less( version: Win32sysVer, test_version: "6.0.6002.18800" ) || version_in_range( version: Win32sysVer, test_version: "6.0.6002.22000", test_version2: "6.0.6002.23070" )){
					security_message( port: 0, data: "The target host was found to be vulnerable" );
				}
			}
			if(ntfsVer){
				if(version_is_less( version: ntfsVer, test_version: "6.0.6002.18799" ) || version_in_range( version: ntfsVer, test_version: "6.0.6002.22000", test_version2: "6.0.6002.23069" )){
					security_message( port: 0, data: "The target host was found to be vulnerable" );
				}
			}
			exit( 0 );
			...
			if( hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0 ){
				if(Win32sysVer){
					if(version_is_less( version: Win32sysVer, test_version: "6.1.7600.17266" ) || version_in_range( version: Win32sysVer, test_version: "6.1.7600.20000", test_version2: "6.1.7600.21481" ) || version_in_range( version: Win32sysVer, test_version: "6.1.7601.17000", test_version2: "6.1.7601.18104" ) || version_in_range( version: Win32sysVer, test_version: "6.1.7601.21000", test_version2: "6.1.7601.22270" )){
						security_message( port: 0, data: "The target host was found to be vulnerable" );
					}
				}
				if(ntfsVer){
					if(version_is_less( version: ntfsVer, test_version: "6.1.7600.17281" ) || version_in_range( version: ntfsVer, test_version: "6.1.7600.20000", test_version2: "6.1.7600.21498" ) || version_in_range( version: ntfsVer, test_version: "6.1.7601.17000", test_version2: "6.1.7601.18126" ) || version_in_range( version: ntfsVer, test_version: "6.1.7601.21000", test_version2: "6.1.7601.22296" )){
						security_message( port: 0, data: "The target host was found to be vulnerable" );
					}
				}
				exit( 0 );
				...
				if(hotfix_check_sp( win8: 1, win2012: 1 ) > 0 && Win32sysVer){
					if(version_is_less( version: Win32sysVer, test_version: "6.2.9200.16559" ) || version_in_range( version: Win32sysVer, test_version: "6.2.9200.20000", test_version2: "6.2.9200.20662" )){
						security_message( port: 0, data: "The target host was found to be vulnerable" );
					}
					exit( 0 );
				}
