...
if(IsMatchRegexp( ver, "^(8\\.[0|1]\\.|7\\.3\\.)" )){
	if(version_is_equal( version: ver, test_version: "7.3.4" ) || version_is_equal( version: ver, test_version: "8.0.6" ) || version_is_equal( version: ver, test_version: "8.1.6" )){
