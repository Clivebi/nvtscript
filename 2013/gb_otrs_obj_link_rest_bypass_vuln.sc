...
if(vers = get_app_version( cpe: CPE, port: port )){
	if(version_in_range( version: vers, test_version: "3.0.0", test_version2: "3.0.18" ) || version_in_range( version: vers, test_version: "3.1.0", test_version2: "3.1.13" ) || version_in_range( version: vers, test_version: "3.2.0", test_version2: "3.2.3" )){
