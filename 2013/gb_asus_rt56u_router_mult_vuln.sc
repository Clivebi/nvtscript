...
if(banner && !ContainsString( banner, "WWW-Authenticate: Basic realm=\"RT-N56U\"" )){
	exit( 0 );
}
if(http_vuln_check( port: port, url: "/Nologin.asp", pattern: ">Login user IP:", extra_check: make_list( ">You cannot Login unless logout another user first",
