if(description){
	...
	script_mandatory_keys( "ssh/login/osx_name", "ssh/login/osx_version",  "ssh/login/osx_version=^10\\.[5-7]\\." );
...
if(IsMatchRegexp( osVer, "^10\\.[5-7]\\." ) && version_in_range( version: osVer, test_version: "10.5.0", test_version2: "10.7.2" )){
