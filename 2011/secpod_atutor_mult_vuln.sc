...
if(IsMatchRegexp( res, "^HTTP/1\\.. 200" ) && ContainsString( res, "\"><script>alert(1)</script>" )){
	report = "It was possible to conduct an XSS attack at " + http_report_vuln_url( port: port, url: filename, url_only: TRUE ) + "\n\nRequest:\n" + req;
