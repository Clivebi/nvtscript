if(description){
	...
	script_dependencies( "novell_edirectory_detect.sc", "os_detection.sc" );
...
edirVer = major + "." + sp;
if(version_in_range( version: edirVer, test_version: "8.8.5", test_version2: "8.8.5.5" ) || version_in_range( version: edirVer, test_version: "8.8.6", test_version2: "8.8.6.1" )){
