...
if(ereg( pattern: "^HTTP/1\\.[01] 200", string: res ) && ContainsString( res, "DB_NAME" ) && ContainsString( res, "DB_USER" ) && ContainsString( res, "DB_PASSWORD" ) && ContainsString( res, "AUTH_KEY" )){
