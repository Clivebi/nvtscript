if(description){
	...
	script_cve_id( "CVE-2011-1986", "CVE-2011-1987", "CVE-2011-1988", "CVE-2011-1989", "CVE-2011-1990" );
...
if(IsMatchRegexp( excelVer, "^1[124]\\.0" )){
	if(version_in_range( version: excelVer, test_version: "11.0", test_version2: "11.0.8340.0" ) || version_in_range( version: excelVer, test_version: "12.0", test_version2: "12.0.6565.5002" ) || version_in_range( version: excelVer, test_version: "14.0", test_version2: "14.0.6106.5004" )){
...
if(comptVer && IsMatchRegexp( comptVer, "^12\\.0" )){
	xlcnvVer = get_kb_item( "SMB/Office/XLCnv/Version" );
	if(xlcnvVer && IsMatchRegexp( xlcnvVer, "^12\\.0" )){
...
if(officeVer && IsMatchRegexp( officeVer, "^1[24]\\.0" )){
	...
	if(path12){
		...
		if(IsMatchRegexp( ort12Ver, "^12\\.0" ) || IsMatchRegexp( ortconv12Ver, "^12\\.0" )){
			if(version_in_range( version: ort12Ver, test_version: "12.0", test_version2: "12.0.6565.4999" ) || version_in_range( version: ortconv12Ver, test_version: "12.0", test_version2: "12.0.6565.4999" )){
	...
	if(path14){
		...
		if(IsMatchRegexp( ort14Ver, "^14\\.0" ) || IsMatchRegexp( ortconv14Ver, "^14\\.0" )){
			if(version_in_range( version: ort14Ver, test_version: "14.0", test_version2: "14.0.6106.5004" ) || version_in_range( version: ortconv14Ver, test_version: "14.0", test_version2: "14.0.6106.5004" )){
...
for item in registry_enum_keys( key: key ) {
	...
	if(ContainsString( appName, "Microsoft Office SharePoint Server 2007" )){
		...
		if(dllPath){
			...
			if(dllVer && IsMatchRegexp( dllVer, "^8\\.0" )){
