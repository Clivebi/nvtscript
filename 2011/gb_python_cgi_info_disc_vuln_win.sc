...
if(description){
  ...
  supply a specially crafted request without the leading '/' character to the CGIHTTPServer." );
	script_tag( name: "summary", value: "Python is prone to information disclosure vulnerability." );
...
if(version_is_equal( version: version, test_version: "2.5" ) || version_is_equal( version: version, test_version: "2.6" ) || version_is_equal( version: version, test_version: "3.0" )){
