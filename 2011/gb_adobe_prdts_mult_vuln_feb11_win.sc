...
vers = infos["version"];
path = infos["location"];
if(version_is_equal( version: vers, test_version: "10.0" ) || version_in_range( version: vers, test_version: "9.0", test_version2: "9.4.1" ) || version_is_less( version: vers, test_version: "8.2.6" )){
