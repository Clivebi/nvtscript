	...
	if( hotfix_check_sp( win2003: 3 ) > 0 ){
		...
		if( hotfix_check_sp( winVista: 3, win2008: 3 ) > 0 ){
			...
			if(hotfix_check_sp( win7: 2 ) > 0){
				if(version_is_less( version: sysVer, test_version: "6.1.7600.16920" ) || version_in_range( version: sysVer, test_version: "6.1.7600.20000", test_version2: "6.1.7600.21096" ) || version_in_range( version: sysVer, test_version: "6.1.7601.17000", test_version2: "6.1.7601.17729" ) || version_in_range( version: sysVer, test_version: "6.1.7601.21000", test_version2: "6.1.7601.21865" )){
					security_message( port: 0, data: "The target host was found to be vulnerable" );
				}
			}
		}
