...
url = NASLString( dir, "/phpgwapi/js/jscalendar/test.php?lang=\"></script><script>alert(/", vt_strings["lowercase"], "/)</script>" );
if(http_vuln_check( port: port, url: url, pattern: "<script>alert\\(/" + vt_strings["lowercase"] + "/\\)</script>", check_header: TRUE, extra_check: make_list( "Calendar.php ",
