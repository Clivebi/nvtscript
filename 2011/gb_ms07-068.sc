...
if(dllVer){
	if(hotfix_missing( name: "941569" ) == 1){
		if( hotfix_check_sp( win2k: 5 ) > 0 ){
			if(version_in_range( version: dllVer, test_version: "7.0", test_version2: "7.10.0.3080" ) || version_in_range( version: dllVer, test_version: "9.0", test_version2: "9.0.0.3266" )){
			...
			if( hotfix_check_sp( xp: 4 ) > 0 ){
				...
				if(ContainsString( SP, "Service Pack 2" )){
					if(version_in_range( version: dllVer, test_version: "9.0", test_version2: "9.0.0.3266" ) || version_in_range( version: dllVer, test_version: "10.0", test_version2: "10.0.0.4059" ) || version_in_range( version: dllVer, test_version: "11.0", test_version2: "11.0.5721.5237" )){
						security_message( port: 0, data: "The target host was found to be vulnerable" );
					}
				}
			}
