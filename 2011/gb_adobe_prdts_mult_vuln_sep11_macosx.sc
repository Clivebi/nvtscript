...
if(readerVer = get_app_version( cpe: CPE )){
	if(IsMatchRegexp( readerVer, "^(8|9|10)" )){
		if(version_in_range( version: readerVer, test_version: "10.0", test_version2: "10.1" ) || version_in_range( version: readerVer, test_version: "9.0", test_version2: "9.4.5" ) || version_in_range( version: readerVer, test_version: "8.0", test_version2: "8.3.0" )){
...
if(acrobatVer){
	if(version_in_range( version: acrobatVer, test_version: "10.0", test_version2: "10.1" ) || version_in_range( version: acrobatVer, test_version: "9.0", test_version2: "9.4.5" ) || version_in_range( version: acrobatVer, test_version: "8.0", test_version2: "8.3.0" )){
		security_message( port: 0, data: "The target host was found to be vulnerable" );
		exit( 0 );
	}
}
