...
for dir in nasl_make_list_unique( "/script", "/demo", http_cgi_dirs( port: port ) ) {
	if(dir == "/"){
		dir = "";
	}
	res = http_get_cache( item: dir + "/index.php", port: port );
	if(ContainsString( res, ">BlueSoft Classifieds Script</" )){
		exploit = NASLString( dir, "/search.php?c='" );
