...
for dir in nasl_make_list_unique( "/igallery", "/gallery", http_cgi_dirs( port: port ) ) {
	if(dir == "/"){
		dir = "";
	}
	url = NASLString( dir, "/igallery.asp?d=%22%3E%3Cscript%3Ealert%28%27", vt_strings["lowercase"], "%27%29%3C/script%3E" );
