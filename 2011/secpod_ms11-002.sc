...
if(( hotfix_missing( name: "2419635" ) == 0 ) || ( hotfix_missing( name: "2419640" ) == 0 ) || ( hotfix_missing( name: "2419632" ) == 0 )){
	exit( 0 );
}
...
file = ereg_replace( pattern: "[a-zA-Z]:(.*)", replace: "\\1", string: dllPath + "\\Msadco.dll" );
