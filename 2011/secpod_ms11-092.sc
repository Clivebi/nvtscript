...
if( hotfix_check_sp( xp: 4 ) > 0 ){
	...
	if( hotfix_check_sp( winVista: 3 ) > 0 ){
		...
		if(ContainsString( SP, "Service Pack 2" )){
			if(version_in_range( version: dllVer, test_version: "6.0.6002.18000", test_version2: "6.6.6002.18527" ) || version_in_range( version: dllVer, test_version: "6.6.6002.22000", test_version2: "6.6.6002.22725" )){
				security_message( port: 0, data: "The target host was found to be vulnerable" );
			}
			exit( 0 );
		}
		...
		if(hotfix_check_sp( win7: 2 ) > 0){
			if(version_is_less( version: dllVer, test_version: "6.6.7600.16899" ) || version_in_range( version: dllVer, test_version: "6.6.7600.20000", test_version2: "6.6.7600.21069" ) || version_in_range( version: dllVer, test_version: "6.6.7601.17000", test_version2: "6.6.7601.17707" ) || version_in_range( version: dllVer, test_version: "6.6.7601.21000", test_version2: "6.6.7601.21839" )){
				security_message( port: 0, data: "The target host was found to be vulnerable" );
			}
		}
	}
