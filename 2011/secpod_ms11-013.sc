...
if( hotfix_check_sp( xp: 4 ) > 0 ){
	...
	if( hotfix_check_sp( win2003: 3 ) > 0 ){
		...
		if(hotfix_check_sp( win7: 2 ) > 0){
			if(version_is_less( version: sysVer, test_version: "6.1.7600.16722" ) || version_in_range( version: sysVer, test_version: "6.1.7600.20000", test_version2: "6.1.7600.20860" ) || version_in_range( version: sysVer, test_version: "6.1.7601.10000", test_version2: "6.1.7601.17526" ) || version_in_range( version: sysVer, test_version: "6.1.7601.20000", test_version2: "6.1.7601.21623" )){
				security_message( port: 0, data: "The target host was found to be vulnerable" );
			}
		}
	}
