if(description){
	...
	script_dependencies( "gb_symantec_backup_exec_detect.sc" );
...
cpe_list = make_list( "cpe:/a:symantec:veritas_backup_exec_for_windows_servers",
...
path = infos["location"];
cpe = infos["cpe"];
if( ContainsString( cpe, "cpe:/a:symantec:veritas_backup_exec_for_windows_servers" ) ){
	...
	if(ContainsString( cpe, "cpe:/a:symantec:backup_exec" )){
