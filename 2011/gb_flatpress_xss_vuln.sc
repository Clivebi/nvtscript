...
authVariables = "name=%22%3E%3Cscript%3Ealert%28%22VT-XSS-TEST%22%" + "29%3B%3C%2Fscript%3E";
sndReq = NASLString( "POST ", filename, " HTTP/1.1\\r\\n", "Host: ", host, "\\r\\n\\r\\n", "User-Agent: ", useragent, "\\r\\n", "Content-Type: application/x-www-form-urlencoded\\r\\n\\r\\n", "Content-Length: ", strlen( authVariables ), "\\r\\n", authVariables );
rcvRes = http_keepalive_send_recv( port: port, data: sndReq );
if(IsMatchRegexp( rcvRes, "^HTTP/1\\.[01] 200" ) && ContainsString( rcvRes, "><script>alert(\"VT-XSS-TEST\");</script>" )){
