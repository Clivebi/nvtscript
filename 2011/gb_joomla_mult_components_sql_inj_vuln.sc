...
if(description){
	...
	script_cve_id( "CVE-2010-4927", "CVE-2010-4928", "CVE-2010-4929", "CVE-2010-4937", "CVE-2010-4945", "CVE-2010-4902", "CVE-2010-4865", "CVE-2010-4904" );
...
for page in pages {
	url = dir + page;
	if(http_vuln_check( port: port, url: url, pattern: "<b>Warning</b>:  Invalid argument supplied for foreach\\(\\)" ) || http_vuln_check( port: port, url: url, pattern: "You have an error in your SQL syntax;" )){
