if(description){
	...
	script_cve_id( "CVE-2011-1049", "CVE-2011-1050", "CVE-2011-1051", "CVE-2011-1052", "CVE-2011-1053", "CVE-2011-1054" );
	...
	script_dependencies( "secpod_ida_pro_detect.sc" );
...
if(IsMatchRegexp( version, "^6\\.0\\." ) || IsMatchRegexp( version, "^5\\.7\\." )){
