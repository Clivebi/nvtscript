...
for dir in nasl_make_list_unique( "/webatall", "/weball", http_cgi_dirs( port: port ) ) {
	if(dir == "/"){
		dir = "";
	}
	url = NASLString( dir, "/404.php?url=1%3Cscript%3Ealert(%27", vt_strings["lowercase"], "%27)%3C/script%3E" );
