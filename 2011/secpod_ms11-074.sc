if(description){
	...
	script_cve_id( "CVE-2011-0653", "CVE-2011-1252", "CVE-2011-1890", "CVE-2011-1891", "CVE-2011-1892", "CVE-2011-1893" );
	...
	script_dependencies( "secpod_reg_enum.sc", "secpod_office_products_version_900032.sc" );
	...
	for item in registry_enum_keys( key: key ) {
		...
		if(ContainsString( srvcName, "Microsoft Windows SharePoint Services" )){
			...
			if(dllPath){
				...
				if(dllVer1 || dllVer2){
					if(version_in_range( version: dllVer2, test_version: "11.0", test_version2: "11.0.8339.0" ) || version_in_range( version: dllVer1, test_version: "12.0", test_version2: "12.0.6565.5000" )){
						security_message( port: 0, data: "The target host was found to be vulnerable" );
						exit( 0 );
					}
				}
