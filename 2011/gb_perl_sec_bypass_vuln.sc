...
if(apVer){
	if(( IsMatchRegexp( apVer, "^5\\.10" ) ) || ( IsMatchRegexp( apVer, "^5\\.11" ) ) || version_in_range( version: apVer, test_version: "5.12", test_version2: "5.12.3" ) || version_in_range( version: apVer, test_version: "5.13", test_version2: "5.13.11" )){
...
if(spVer){
	if(( IsMatchRegexp( spVer, "^5\\.10" ) ) || ( IsMatchRegexp( spVer, "^5\\.11" ) ) || version_in_range( version: spVer, test_version: "5.12", test_version2: "5.12.3" ) || version_in_range( version: spVer, test_version: "5.13", test_version2: "5.13.11" )){
		security_message( port: 0, data: "The target host was found to be vulnerable" );
	}
}
