...
if(usernames){
	for name in usernames {
		userstr += NASLString( name );
	}
	userstr = chomp( userstr );
	rep = NASLString( "The following user names were revealed in id range 1-25.\\n\\n" );
