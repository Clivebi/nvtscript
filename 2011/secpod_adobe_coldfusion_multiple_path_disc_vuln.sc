...
if(description){
  ...
  release, disable respective features, remove the product or replace the product by another one." );
	script_tag( name: "summary", value: "Adobe ColdFusion is prone to multiple path disclosure vulnerabilities." );
...
if(http_vuln_check( port: port, url: url, pattern: ".*\\\\wwwroot\\\\CFIDE\\\\adminapi\\\\_datasource\\\\formatjdbcurl\\.cfm", extra_check: "Unable to display error's location in a CFML template." )){
