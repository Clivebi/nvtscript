...
url = dir + "/index.php/using-joomla/extensions/templates?%27%2522%253E%253Cscript%253Ealert(%252FVT-XSS-Att" + "ack-Test%252F)%253C%252Fscript%253E=1";
if(http_vuln_check( port: port, url: url, pattern: "><script>alert(/VT-XSS-Attack-Test/)</script>=1", check_header: TRUE )){
