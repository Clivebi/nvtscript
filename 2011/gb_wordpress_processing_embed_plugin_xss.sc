...
res = http_get_cache( item: NASLString( dir, "/wp-content/plugins/wordpress-processing-embed/readme.txt" ), port: port );
if(ContainsString( res, "Wordpress Processing Embed" )){
