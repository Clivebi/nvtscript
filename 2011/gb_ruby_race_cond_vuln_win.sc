...
if(version_in_range( version: version, test_version: "1.8.6", test_version2: "1.8.6.420" ) || version_in_range( version: version, test_version: "1.8.7", test_version2: "1.8.7.330" )){
	report = report_fixed_ver( installed_version: version, fixed_version: "1.8.7-p334", install_path: location );
	security_message( data: report, port: port );
	exit( 0 );
}
if(version_in_range( version: version, test_version: "1.9.1", test_version2: "1.9.1.430" ) || version_is_equal( version: version, test_version: "1.8.8" )){
