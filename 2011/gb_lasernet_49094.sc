...
for dir in nasl_make_list_unique( "/cms", "/lasernet", http_cgi_dirs( port: port ) ) {
	if(dir == "/"){
		dir = "";
	}
	url = NASLString( dir, "/index.php?id=-1'%20UNION%20SELECT%201,2,3,0x53514c2d496e6a656374696f6e2d54657374,5,6,7,8,9,10,11,12,13--+" );
