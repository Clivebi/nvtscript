...
if(description){
	...
	script_dependencies( "sw_postfix_detect.sc" );
...
if(version_is_less( version: vers, test_version: "2.5.13" ) || version_in_range( version: vers, test_version: "2.6", test_version2: "2.6.9" ) || version_in_range( version: vers, test_version: "2.7", test_version2: "2.7.3" ) || version_in_range( version: vers, test_version: "2.8", test_version2: "2.8.2" )){
	auths = get_kb_list( "smtp/fingerprints/" + port + "/authlist" );
	if(!auths || !is_array( auths )){
		exit( 0 );
	}
	if(in_array( search: "DIGEST-MD5", array: auths, part_match: FALSE ) || in_array( search: "CRAM-MD5", array: auths, part_match: FALSE )){
