...
if(description){
	...
	script_cve_id( "CVE-2011-1127", "CVE-2011-1128", "CVE-2011-1129", "CVE-2011-1130", "CVE-2011-1131" );
...
if(version_is_less( version: ver, test_version: "1.1.3" ) || version_in_range( version: ver, test_version: "2.0.RC", test_version2: "2.0.RC4" )){
