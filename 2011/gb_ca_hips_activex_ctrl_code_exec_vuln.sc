...
if(( hipsVer = get_kb_item( "CA/HIPS/Engine/Win/Ver" ) ) && ( issVer = get_kb_item( "CA/ISS/Win/Ver" ) )){
	if( version_in_range( version: issVer, test_version: "6.0", test_version2: "6.0.0.285" ) && version_is_less_equal( version: hipsVer, test_version: "1.6.384" ) ){
		security_message( port: 0, data: "The target host was found to be vulnerable" );
	}
	else {
		if(version_in_range( version: issVer, test_version: "7.0", test_version2: "7.0.0.115" ) && version_is_less_equal( version: hipsVer, test_version: "1.6.418" )){
			security_message( port: 0, data: "The target host was found to be vulnerable" );
		}
	}
}
