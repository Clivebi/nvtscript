...
for item in registry_enum_keys( key: key ) {
	...
	if(ContainsString( refName, "Attachmate Reflection" )){
		refVer = registry_get_sz( key: key + item, item: "DisplayVersion" );
		if(!isnull( refVer )){
			if(version_in_range( version: refVer, test_version: "15.3", test_version2: "15.3.569.0" ) || version_in_range( version: refVer, test_version: "15.4", test_version2: "15.4.327.0)" ) || version_in_range( version: refVer, test_version: "7.2", test_version2: "7.2.1163" ) || version_in_range( version: refVer, test_version: "14.1", test_version2: "14.1.1173" )){
