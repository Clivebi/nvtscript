...
if(IsMatchRegexp( res, "initProdNbr=\"([^\"]+)\";" ) && IsMatchRegexp( res, "BrandCopyright=\"TP-Link\\s*\";" )){
	version = "unknown";
	model = "unknown";
	...
	os_register_and_report( os: os_name, cpe: os_cpe, desc: "TP-Link IP Cameras Remote Detection", runs_key: "unixoide" );
	conclUrl = http_report_vuln_url( port: port, url: url, url_only: TRUE );
	register_and_report_cpe( app: "TP-Link IP Camera", ver: version, base: hw_cpe, expr: "^([0-9.]+)", insloc: "/", regPort: port, regService: "www", conclUrl: conclUrl, extra: extra_info );
}
exit( 0 );
