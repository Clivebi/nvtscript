...
bopupPath = registry_get_sz( key: "SOFTWARE\\B Labs\\Bopup Communication Server", item: "Location" );
if(bopupPath){
	...
	if(bopupVer != NULL){
		...
		log_message( data: "Bopup Communication Server version " + bopupVer + " running at location " + bopupPath + " was detected on the host" );
