...
if(banner && ContainsString( banner, "TYPSoft FTP" )){
	version = "unknown";
	...
	log_message( data: build_detection_report( app: "TYPSoft FTP Server", version: version, install: port + "/tcp", cpe: cpe, concluded: banner ), port: port );
}
exit( 0 );
