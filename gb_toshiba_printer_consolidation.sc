if(description){
	...
	script_dependencies( "gb_toshiba_printer_snmp_detect.sc", "gb_toshiba_printer_http_detect.sc", "gb_toshiba_printer_ftp_detect.sc", "gb_toshiba_printer_fingerd_detect.sc", "gb_toshiba_printer_pjl_detect.sc", "global_settings.sc" );
...
if( detected_model != "unknown" ){
	...
	if( detected_fw_version != "unknown" ) {
		os_cpe = build_cpe( value: tolower( detected_fw_version ), exp: "^([0-9a-z.-]+)", base: "cpe:/o:toshibatec:" + cpe_model + "_firmware:" );
	}
	else {
	...
	if( detected_fw_version != "unknown" ) {
		os_cpe = build_cpe( value: tolower( detected_fw_version ), exp: "^([0-9a-z.-]+)", base: "cpe:/o:toshibatec:printer_firmware:" );
	}
	else {
...
os_register_and_report( os: os_name, cpe: os_cpe, desc: "Toshiba Printer Detection Consolidation", runs_key: "unixoide" );
