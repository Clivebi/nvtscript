...
if(ContainsString( res, "<title>Welcome to ScrumWorks" ) && ContainsString( res, "scrumworkspro" )){
	...
	log_message( data: build_detection_report( app: "ScrumWorks Pro", version: version, install: install, cpe: cpe, concluded: ver[0] ), port: port );
	exit( 0 );
}
exit( 0 );
