...
if(ContainsString( res, "gsProductTitle = \"McAfee VirusScan Enterprise for Linux" )){
	version = "unknown";
	...
	log_message( data: build_detection_report( app: "McAfee VirusScan Enterprise for Linux", version: version, install: "/", cpe: cpe, concluded: vers[0] ), port: port );
	exit( 0 );
}
exit( 0 );
