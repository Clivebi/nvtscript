if(description){
	...
	script_tag( name: "severity_date", value: "2021-04-10 01:15:00 +0000 (Sat, 10 Apr 2021)" );
	script_name( "SSL/TLS: BREACH attack against HTTP compression" );
	script_category( ACT_GATHER_INFO );
	script_copyright( "Copyright (C) 2021 Greenbone Networks GmbH" );
	script_family( "SSL and TLS" );
	script_dependencies( "gb_tls_version_get.sc", "find_service.sc", "no404.sc", "webmirror.sc", "DDI_Directory_Scanner.sc", "global_settings.sc" );
