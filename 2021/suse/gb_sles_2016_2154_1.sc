...
- CVE-2016-4463: Apache Xerces-C XML Parser crashed on malformed DTD
 (bnc#985860)." );
	script_tag( name: "affected", value: "'xerces-c' package(s) on SUSE Linux Enterprise Desktop 12-SP1, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Software Development Kit 12-SP1." );
