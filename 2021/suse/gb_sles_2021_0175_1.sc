...
Conflicting with older versions is not limited to SLE." );
	script_tag( name: "affected", value: "'postgresql, postgresql13' package(s) on SUSE Linux Enterprise Module for Basesystem 15-SP2, SUSE Linux Enterprise Module for Packagehub Subpackages 15-SP2, SUSE Linux Enterprise Module for Server Applications 15-SP2." );
