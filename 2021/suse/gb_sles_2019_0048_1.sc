if(description){
	script_oid( "1.3.6.1.4.1.25623.1.1.4.2019.0048.1" );
	...
	script_name( "SUSE: Security Advisory (SUSE-SU-2019:0048-1)" );
	script_category( ACT_GATHER_INFO );
	script_copyright( "Copyright (C) 2021 Greenbone Networks GmbH" );
	script_family( "SuSE Local Security Checks" );
	script_dependencies( "gather-package-list.sc" );
	script_mandatory_keys( "ssh/login/suse_sles", "ssh/login/rpms",  "ssh/login/release=(SLES15\\.0)" );
	script_xref( name: "Advisory-ID", value: "SUSE-SU-2019:0048-1" );
	script_xref( name: "URL", value: "https://www.suse.com/support/update/announcement/2019/suse-su-20190048-1/" );
	script_tag( name: "summary", value: "The remote host is missing an update for the 'helm-mirror' package(s) announced via the SUSE-SU-2019:0048-1 advisory." );
...
Include helm-mirror into the containers module (bsc#1116182)" );
	script_tag( name: "affected", value: "'helm-mirror' package(s) on SUSE Linux Enterprise Module for Containers 15." );
...
report = "";
if(release == "SLES15.0"){
	if(!isnull( res = isrpmvuln( pkg: "helm-mirror", rpm: "helm-mirror~0.2.1~1.7.1", rls: "SLES15.0" ) )){
		report += res;
	}
	if( report != "" ){
