if(description){
	...
	script_xref( name: "URL", value: "https://www.suse.com/support/update/announcement/2020/suse-su-20202628-1/" );
...
shim-install: install MokManager to \\EFI\\boot to process the pending MOK
 request (bsc#1175626, bsc#1175656)" );
	script_tag( name: "affected", value: "'shim' package(s) on SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server for SAP 12-SP2, SUSE OpenStack Cloud 7." );
