...
python-paramiko was adjusted to work together with this python-pycrypto change. (bsc#1047666)" );
	script_tag( name: "affected", value: "'python-pycrypto' package(s) on OpenStack Cloud Magnum Orchestration 7, SUSE Container as a Service Platform ALL, SUSE Enterprise Storage 3, SUSE Enterprise Storage 4, SUSE Linux Enterprise Module for Advanced Systems Management 12, SUSE Linux Enterprise Module for Public Cloud 12, SUSE Linux Enterprise Module for Web Scripting 12, SUSE Linux Enterprise Point of Sale 12-SP2, SUSE Manager Proxy 3.0, SUSE Manager Proxy 3.1, SUSE Manager Server 3.0, SUSE Manager Server 3.1, SUSE Manager Tools 12, SUSE OpenStack Cloud 6, SUSE OpenStack Cloud 7." );
