if(description){
	...
	script_xref( name: "URL", value: "https://www.suse.com/support/update/announcement/2015/suse-su-20150436-1/" );
	script_tag( name: "summary", value: "The remote host is missing an update for the 'PHP 5.3' package(s) announced via the SUSE-SU-2015:0436-1 advisory." );
