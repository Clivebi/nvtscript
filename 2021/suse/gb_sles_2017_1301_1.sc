if(description){
	...
	script_xref( name: "URL", value: "https://www.suse.com/support/update/announcement/2017/suse-su-20171301-1/" );
...
- CVE-2017-7187: The sg_ioctl function in drivers/scsi/sg.c in the Linux
 ...
 write access in the sg_write function ... [Please see the references for more information on the vulnerabilities]" );
