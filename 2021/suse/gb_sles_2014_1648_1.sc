if(description){
	...
	script_tag( name: "severity_date", value: "2019-04-29 17:11:00 +0000 (Mon, 29 Apr 2019)" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the 'docker, sle2docker, go' package(s) announced via the SUSE-SU-2014:1648-1 advisory." );
...
- Removed extra src folder in /usr/share/go/contrib: the goal is to
 transform this folder into ... [Please see the references for more information on the vulnerabilities]" );
	script_tag( name: "affected", value: "'docker, sle2docker, go' package(s) on SUSE Linux Enterprise Server 12." );
