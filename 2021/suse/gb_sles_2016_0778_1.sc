if(description){
	script_oid( "1.3.6.1.4.1.25623.1.1.4.2016.0778.1" );
	script_cve_id( "CVE-2014-9761", "CVE-2015-0293", "CVE-2015-3197", "CVE-2015-6908", "CVE-2015-7547", "CVE-2015-8776", "CVE-2015-8777", "CVE-2015-8778", "CVE-2015-8779", "CVE-2016-0702", "CVE-2016-0703", "CVE-2016-0704", "CVE-2016-0705", "CVE-2016-0755", "CVE-2016-0797", "CVE-2016-0799", "CVE-2016-0800" );
	...
	script_name( "SUSE: Security Advisory (SUSE-SU-2016:0778-1)" );
	script_category( ACT_GATHER_INFO );
	script_copyright( "Copyright (C) 2021 Greenbone Networks GmbH" );
	script_family( "SuSE Local Security Checks" );
	script_dependencies( "gather-package-list.sc" );
	script_mandatory_keys( "ssh/login/suse_sles", "ssh/login/rpms",  "ssh/login/release=(SLES12\\.0)" );
	script_xref( name: "Advisory-ID", value: "SUSE-SU-2016:0778-1" );
	script_xref( name: "URL", value: "https://www.suse.com/support/update/announcement/2016/suse-su-20160778-1/" );
	script_tag( name: "summary", value: "The remote host is missing an update for the 'sles11sp4-docker-image' package(s) announced via the SUSE-SU-2016:0778-1 advisory." );
	script_tag( name: "vuldetect", value: "Checks if a vulnerable package version is present on the target host." );
	script_tag( name: "insight", value: "This rebuild for sles11sp4-docker-image fixes several important security issues done in libraries contained inside, for glibc, openssl, curl and openldap2.
...
- bsc#956988: Fix deadlock in __dl_iterate_phdr openssl security issues fixed:
...
- CVE-2016-0797 (bnc#968048): The BN_hex2bn() and BN_dec2bn() functions
 ...
 uses data from ... [Please see the references for more information on the vulnerabilities]" );
	script_tag( name: "affected", value: "'sles11sp4-docker-image' package(s) on SUSE Linux Enterprise Module for Containers 12." );
...
report = "";
if(release == "SLES12.0"){
	if(!isnull( res = isrpmvuln( pkg: "sles11sp4-docker-image", rpm: "sles11sp4-docker-image~1.1.1~20160304104123", rls: "SLES12.0" ) )){
		report += res;
	}
	if(!isnull( res = isrpmvuln( pkg: "sles11sp4-docker-image", rpm: "sles11sp4-docker-image~1.1.1~20160304104143", rls: "SLES12.0" ) )){
		report += res;
	}
	if( report != "" ){
