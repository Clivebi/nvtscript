if(description){
	script_oid( "1.3.6.1.4.1.25623.1.1.4.2020.3282.1" );
	...
	script_name( "SUSE: Security Advisory (SUSE-SU-2020:3282-1)" );
	script_category( ACT_GATHER_INFO );
	script_copyright( "Copyright (C) 2021 Greenbone Networks GmbH" );
	script_family( "SuSE Local Security Checks" );
	script_dependencies( "gather-package-list.sc" );
	script_mandatory_keys( "ssh/login/suse_sles", "ssh/login/rpms",  "ssh/login/release=(SLES15\\.0SP1)" );
	script_xref( name: "Advisory-ID", value: "SUSE-SU-2020:3282-1" );
	script_xref( name: "URL", value: "https://www.suse.com/support/update/announcement/2020/suse-su-20203282-1/" );
	script_tag( name: "summary", value: "The remote host is missing an update for the 'u-boot' package(s) announced via the SUSE-SU-2020:3282-1 advisory." );
...
CVE-2019-11059 (bsc#1134853), CVE-2019-11690 (bsc#1134157) and CVE-2020-10648 (bsc#1167209)" );
	script_tag( name: "affected", value: "'u-boot' package(s) on SUSE Linux Enterprise Module for Basesystem 15-SP1." );
...
if(release == "SLES15.0SP1"){
	if(!isnull( res = isrpmvuln( pkg: "u-boot-rpi3", rpm: "u-boot-rpi3~2019.01~7.10.2", rls: "SLES15.0SP1" ) )){
		report += res;
	}
	if(!isnull( res = isrpmvuln( pkg: "u-boot-tools", rpm: "u-boot-tools~2019.01~7.10.1", rls: "SLES15.0SP1" ) )){
		report += res;
	}
	if(!isnull( res = isrpmvuln( pkg: "u-boot-tools-debuginfo", rpm: "u-boot-tools-debuginfo~2019.01~7.10.1", rls: "SLES15.0SP1" ) )){
		report += res;
	}
	if( report != "" ){
