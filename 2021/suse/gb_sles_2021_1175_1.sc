if(description){
	...
	script_xref( name: "URL", value: "https://www.suse.com/support/update/announcement/2021/suse-su-20211175-1/" );
...
CVE-2021-26930: Fixed an ... [Please see the references for more information on the vulnerabilities]" );
