if(description){
	...
	script_xref( name: "URL", value: "https://www.suse.com/support/update/announcement/2016/suse-su-20161784-1/" );
...
- CVE-2014-9809: SEGV due to ... [Please see the references for more information on the vulnerabilities]" );
