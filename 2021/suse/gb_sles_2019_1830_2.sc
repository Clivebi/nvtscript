if(description){
	...
	script_xref( name: "URL", value: "https://www.suse.com/support/update/announcement/2019/suse-su-20191830-2/" );
...
Added explicit requires between libglib2 and libgio2 (bsc#1140122)." );
	script_tag( name: "affected", value: "'glib2' package(s) on HPE Helion Openstack 8, SUSE Enterprise Storage 5, SUSE Linux Enterprise Server 12-SP3, SUSE OpenStack Cloud Crowbar 8." );
