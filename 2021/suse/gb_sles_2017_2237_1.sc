...
The CTDB resource agent was also fixed to not fail when the database is empty." );
	script_tag( name: "affected", value: "'samba and resource-agents' package(s) on SUSE Linux Enterprise Desktop 12-SP3, SUSE Linux Enterprise High Availability 12-SP3, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Software Development Kit 12-SP3." );
