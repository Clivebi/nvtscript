...
- Enable support for SASL-based authentication. [bsc#979531]" );
	script_tag( name: "affected", value: "'sudo' package(s) on SUSE Linux Enterprise Desktop 12-SP1, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Software Development Kit 12-SP1." );
