...
(CVE-2021-3524) sanitize \\r in s3 CORSConfiguration's ExposeHeader
 (bsc#1185619)" );
	script_tag( name: "affected", value: "'ceph' package(s) on SUSE Enterprise Storage 7, SUSE Linux Enterprise Module for Basesystem 15-SP2, SUSE Linux Enterprise Module for Basesystem 15-SP3, SUSE MicroOS 5.0." );
