if(description){
	...
	script_xref( name: "URL", value: "https://www.suse.com/support/update/announcement/2016/suse-su-20161311-1/" );
...
- CVE-2015-7691, CVE-2015-7692, CVE-2015-7702: ... [Please see the references for more information on the vulnerabilities]" );
