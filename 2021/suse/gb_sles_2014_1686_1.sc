if(description){
	script_oid( "1.3.6.1.4.1.25623.1.1.4.2014.1686.1" );
	...
	script_name( "SUSE: Security Advisory (SUSE-SU-2014:1686-1)" );
	...
	script_xref( name: "Advisory-ID", value: "SUSE-SU-2014:1686-1" );
	script_xref( name: "URL", value: "https://www.suse.com/support/update/announcement/2014/suse-su-20141686-1/" );
	script_tag( name: "summary", value: "The remote host is missing an update for the 'ntp' package(s) announced via the SUSE-SU-2014:1686-1 advisory." );
 ...
 * CVE-2014-9295" );
	script_tag( name: "affected", value: "'ntp' package(s) on SUSE Linux Enterprise Desktop 11 SP3, SUSE Linux Enterprise Server 11 SP2, SUSE Linux Enterprise Server 11 SP3." );
...
if(release == "SLES11.0SP2"){
	if(!isnull( res = isrpmvuln( pkg: "ntp", rpm: "ntp~4.2.4p8~1.28.1", rls: "SLES11.0SP2" ) )){
		report += res;
	}
	if(!isnull( res = isrpmvuln( pkg: "ntp-doc", rpm: "ntp-doc~4.2.4p8~1.28.1", rls: "SLES11.0SP2" ) )){
		report += res;
	}
	if( report != "" ){
