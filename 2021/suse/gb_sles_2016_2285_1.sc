if(description){
	...
	script_xref( name: "URL", value: "https://www.suse.com/support/update/announcement/2016/suse-su-20162285-1/" );
...
- Use apache2-systemd-ask-pass to prompt for a certificate passphrase.
 (bsc#972968, bsc#975394)" );
	script_tag( name: "affected", value: "'apache2-mod_nss' package(s) on SUSE Linux Enterprise Server 12-SP1." );
