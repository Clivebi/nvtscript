...
CVE-2021-23336: Fixed a potential web cache poisoning by using a
 ...
 separator (bsc#1182379)." );
	script_tag( name: "affected", value: "'python3' package(s) on SUSE Linux Enterprise Module for Basesystem 15-SP2, SUSE Linux Enterprise Module for Development Tools 15-SP2, SUSE MicroOS 5.0." );
