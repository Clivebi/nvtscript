...
Ignore whitespaces after the header or footer in PEM X.509 cert
 (bsc#1171352)" );
	script_tag( name: "affected", value: "'java-1_8_0-openjdk' package(s) on SUSE Linux Enterprise Module for Legacy Software 15-SP1, SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Server for SAP 15." );
