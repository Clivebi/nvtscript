...
- CVE-2017-7544: Fixed out-of-bounds heap read vulnerability in
 ...
 (bsc#1059893)" );
	script_tag( name: "affected", value: "'libexif' package(s) on SUSE Linux Enterprise Debuginfo 11-SP4, SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Software Development Kit 11-SP4." );
