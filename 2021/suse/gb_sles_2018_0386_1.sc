if(description){
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the 'Version update for docker, docker-runc, containerd, golang-github-docker-libnetwork' package(s) announced via the SUSE-SU-2018:0386-1 advisory." );
...
'runc' package to match that we now ship the Docker fork of runc." );
	script_tag( name: "affected", value: "'Version update for docker, docker-runc, containerd, golang-github-docker-libnetwork' package(s) on SUSE Linux Enterprise Module for Containers 12, SUSE OpenStack Cloud 6." );
