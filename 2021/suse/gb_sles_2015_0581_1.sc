if(description){
	...
	script_xref( name: "URL", value: "https://www.suse.com/support/update/announcement/2015/suse-su-20150581-1/" );
	...
	script_tag( name: "insight", value: "The SUSE Linux Enterprise 11 SP3 kernel has been updated to receive various security and bugfixes.
 ...
 * CVE-2014-8134: The paravirt_ops_setup function in
 ...
 for guest OS users to bypass the ASLR protection ... [Please see the references for more information on the vulnerabilities]" );
