...
* CVE-2015-4000: Very difficult to exploit ... [Please see the references for more information on the vulnerabilities]" );
	script_tag( name: "affected", value: "'java-1_6_0-ibm' package(s) on SUSE Linux Enterprise Server 11-SP1, SUSE Linux Enterprise Server 11-SP2, SUSE Linux Enterprise Server 11-SP3, SUSE Linux Enterprise Server for VMWare 11-SP3, SUSE Linux Enterprise Software Development Kit 11-SP3." );
