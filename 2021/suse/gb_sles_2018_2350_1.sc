if(description){
	...
	script_xref( name: "URL", value: "https://www.suse.com/support/update/announcement/2018/suse-su-20182350-1/" );
...
- CVE-2018-10853: A flaw was found in kvm. In which certain instructions
 ...
 (bsc#1097108)." );
	script_tag( name: "affected", value: "'Linux Kernel (Live Patch 21 for SLE 12 SP1)' package(s) on SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server for SAP 12-SP1." );
