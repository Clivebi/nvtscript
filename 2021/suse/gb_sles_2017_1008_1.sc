...
- Add sslNoSSLv3 and sslNoTLSv1 configuration options (bsc#923349,
 bsc#1008130)" );
	script_tag( name: "affected", value: "'sblim-sfcb' package(s) on SUSE Linux Enterprise Debuginfo 11-SP4, SUSE Linux Enterprise Server 11, SUSE Linux Enterprise Server 11-SP4." );
