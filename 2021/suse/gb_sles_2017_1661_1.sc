if(description){
	...
	script_xref( name: "URL", value: "https://www.suse.com/support/update/announcement/2017/suse-su-20171661-1/" );
...
- CVE-2016-10009: limit directories for loading PKCS11 modules
 (bsc#1016366)
