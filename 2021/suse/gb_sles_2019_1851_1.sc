if(description){
	...
	script_xref( name: "URL", value: "https://www.suse.com/support/update/announcement/2019/suse-su-20191851-1/" );
...
CVE-2019-12818: The nfc_llcp_build_tlv function in
 net/nfc/llcp_commands.c ... [Please see the references for more information on the vulnerabilities]" );
