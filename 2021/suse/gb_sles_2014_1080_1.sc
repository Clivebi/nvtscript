if(description){
	script_oid( "1.3.6.1.4.1.25623.1.1.4.2014.1080.1" );
	...
	script_name( "SUSE: Security Advisory (SUSE-SU-2014:1080-1)" );
	script_category( ACT_GATHER_INFO );
	script_copyright( "Copyright (C) 2021 Greenbone Networks GmbH" );
	script_family( "SuSE Local Security Checks" );
	script_dependencies( "gather-package-list.sc" );
	script_mandatory_keys( "ssh/login/suse_sles", "ssh/login/rpms",  "ssh/login/release=(SLES11\\.0SP2)" );
	script_xref( name: "Advisory-ID", value: "SUSE-SU-2014:1080-1" );
	script_xref( name: "URL", value: "https://www.suse.com/support/update/announcement/2014/suse-su-20141080-1/" );
	script_tag( name: "summary", value: "The remote host is missing an update for the 'apache2' package(s) announced via the SUSE-SU-2014:1080-1 advisory." );
 ...
 * CVE-2014-0226
 * CVE-2014-0231" );
	script_tag( name: "affected", value: "'apache2' package(s) on SUSE Linux Enterprise Server 11 SP2." );
