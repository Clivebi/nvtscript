if(description){
	...
	script_tag( name: "severity_date", value: "2021-06-09 15:02:06 +0000 (Wed, 09 Jun 2021)" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the 'MozillaFirefox, mozilla-nss, mozilla-nspr' package(s) announced via the SUSE-SU-2019:14114-1 advisory." );
...
It also includes new additional helper libraries to allow Firefox to run on SUSE Linux Enterprise 11." );
	script_tag( name: "affected", value: "'MozillaFirefox, mozilla-nss, mozilla-nspr' package(s) on SUSE Linux Enterprise Server 11-SP4." );
