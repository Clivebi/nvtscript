if(description){
	...
	script_xref( name: "URL", value: "https://www.suse.com/support/update/announcement/2016/suse-su-20162781-1/" );
...
- CVE-2014-5388: Off-by-one error in the pci_read function in the ACPI PCI
 hotplug interface (hw/acpi/pcihp.c) in QEMU allowed local guest users to
 obtain sensitive information and have other unspecified impact related
 to a crafted PCI device that triggers memory corruption (bsc#893323).
...
- CVE-2016-5126: Heap-based buffer overflow in the iscsi_aio_ioctl
 ...
 a denial of service (QEMU process crash) or possibly execute ... [Please see the references for more information on the vulnerabilities]" );
...
if(release == "SLES12.0"){
	...
	if(!isnull( res = isrpmvuln( pkg: "qemu-block-curl-debuginfo", rpm: "qemu-block-curl-debuginfo~2.0.2~48.22.1", rls: "SLES12.0" ) )){
		report += res;
	}
	if(!isnull( res = isrpmvuln( pkg: "qemu-block-rbd", rpm: "qemu-block-rbd~2.0.2~48.22.1", rls: "SLES12.0" ) )){
		report += res;
	}
	if(!isnull( res = isrpmvuln( pkg: "qemu-block-rbd-debuginfo", rpm: "qemu-block-rbd-debuginfo~2.0.2~48.22.1", rls: "SLES12.0" ) )){
		report += res;
	}
	if(!isnull( res = isrpmvuln( pkg: "qemu-debugsource", rpm: "qemu-debugsource~2.0.2~48.22.1", rls: "SLES12.0" ) )){
		report += res;
	}
	if(!isnull( res = isrpmvuln( pkg: "qemu-guest-agent", rpm: "qemu-guest-agent~2.0.2~48.22.1", rls: "SLES12.0" ) )){
		report += res;
	}
	if(!isnull( res = isrpmvuln( pkg: "qemu-guest-agent-debuginfo", rpm: "qemu-guest-agent-debuginfo~2.0.2~48.22.1", rls: "SLES12.0" ) )){
		report += res;
	}
	...
	if(!isnull( res = isrpmvuln( pkg: "qemu-ppc-debuginfo", rpm: "qemu-ppc-debuginfo~2.0.2~48.22.1", rls: "SLES12.0" ) )){
		report += res;
	}
	if(!isnull( res = isrpmvuln( pkg: "qemu-s390", rpm: "qemu-s390~2.0.2~48.22.1", rls: "SLES12.0" ) )){
		report += res;
	}
	if(!isnull( res = isrpmvuln( pkg: "qemu-s390-debuginfo", rpm: "qemu-s390-debuginfo~2.0.2~48.22.1", rls: "SLES12.0" ) )){
		report += res;
	}
	...
	if(!isnull( res = isrpmvuln( pkg: "qemu-tools-debuginfo", rpm: "qemu-tools-debuginfo~2.0.2~48.22.1", rls: "SLES12.0" ) )){
		report += res;
	}
	...
	if(!isnull( res = isrpmvuln( pkg: "qemu-x86-debuginfo", rpm: "qemu-x86-debuginfo~2.0.2~48.22.1", rls: "SLES12.0" ) )){
		report += res;
	}
	if( report != "" ){
