if(description){
	...
	script_xref( name: "URL", value: "https://www.suse.com/support/update/announcement/2016/suse-su-20160010-1/" );
...
- Fix kvm live migration fails between sles11 sp3 and sp4 (bsc#950590)" );
	script_tag( name: "affected", value: "'kvm' package(s) on SUSE Linux Enterprise Desktop 11-SP4, SUSE Linux Enterprise Server 11-SP4." );
