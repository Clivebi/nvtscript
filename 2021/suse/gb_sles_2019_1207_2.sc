if(description){
	script_oid( "1.3.6.1.4.1.25623.1.1.4.2019.1207.2" );
	...
	script_name( "SUSE: Security Advisory (SUSE-SU-2019:1207-2)" );
	script_category( ACT_GATHER_INFO );
	script_copyright( "Copyright (C) 2021 Greenbone Networks GmbH" );
	script_family( "SuSE Local Security Checks" );
	script_dependencies( "gather-package-list.sc" );
	script_mandatory_keys( "ssh/login/suse_sles", "ssh/login/rpms",  "ssh/login/release=(SLES15\\.0SP1)" );
	script_xref( name: "Advisory-ID", value: "SUSE-SU-2019:1207-2" );
	script_xref( name: "URL", value: "https://www.suse.com/support/update/announcement/2019/suse-su-20191207-2/" );
	script_tag( name: "summary", value: "The remote host is missing an update for the '389-ds' package(s) announced via the SUSE-SU-2019:1207-2 advisory." );
...
CVE-2018-14624: The lock controlling the error log was not correctly
 ...
 could have caused slapd to crash (bsc#1106699)." );
	script_tag( name: "affected", value: "'389-ds' package(s) on SUSE Linux Enterprise Module for Open Buildservice Development Tools 15-SP1, SUSE Linux Enterprise Module for Server Applications 15-SP1." );
...
if(release == "SLES15.0SP1"){
	if(!isnull( res = isrpmvuln( pkg: "389-ds", rpm: "389-ds~1.4.0.3~4.7.52", rls: "SLES15.0SP1" ) )){
		report += res;
	}
	if(!isnull( res = isrpmvuln( pkg: "389-ds-debuginfo", rpm: "389-ds-debuginfo~1.4.0.3~4.7.52", rls: "SLES15.0SP1" ) )){
		report += res;
	}
	if(!isnull( res = isrpmvuln( pkg: "389-ds-debugsource", rpm: "389-ds-debugsource~1.4.0.3~4.7.52", rls: "SLES15.0SP1" ) )){
		report += res;
	}
	if(!isnull( res = isrpmvuln( pkg: "389-ds-devel", rpm: "389-ds-devel~1.4.0.3~4.7.52", rls: "SLES15.0SP1" ) )){
		report += res;
	}
	if( report != "" ){
