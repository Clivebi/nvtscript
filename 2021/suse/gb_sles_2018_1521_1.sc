if(description){
	...
	script_xref( name: "URL", value: "https://www.suse.com/support/update/announcement/2018/suse-su-20181521-1/" );
...
- bsc#1083125: Fixed kgraft: small race in reversion code" );
	script_tag( name: "affected", value: "'Linux Kernel (Live Patch 15 for SLE 12 SP1)' package(s) on SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server for SAP 12-SP1." );
