 ...
 * CVE-2013-2850
>" );
	script_tag( name: "affected", value: "'Linux kernel' package(s) on SLE 11, SUSE Linux Enterprise Desktop 11 SP2, SUSE Linux Enterprise High Availability Extension 11 SP2, SUSE Linux Enterprise Real Time 11 SP2, SUSE Linux Enterprise Server 11 SP2." );
