if(description){
	...
	script_xref( name: "URL", value: "https://www.suse.com/support/update/announcement/2019/suse-su-20192914-1/" );
...
Add gdb-s390-handle-arch13.diff to handle most new s390 arch13
 instructions. [fate#327369, jsc#ECO-368]" );
	script_tag( name: "affected", value: "'gdb' package(s) on SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server for SAP 12-SP1, SUSE Linux Enterprise Server for SAP 12-SP2, SUSE OpenStack Cloud 7." );
