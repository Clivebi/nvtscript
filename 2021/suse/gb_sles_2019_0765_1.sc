if(description){
	...
	script_xref( name: "URL", value: "https://www.suse.com/support/update/announcement/2019/suse-su-20190765-1/" );
...
acpi/device_sysfs: Avoid OF modalias creation ... [Please see the references for more information on the vulnerabilities]" );
