if(description){
	...
	script_tag( name: "severity_date", value: "2021-06-09 15:00:32 +0000 (Wed, 09 Jun 2021)" );
...
- Remove sysvinit script, not used under systemd. (bsc#974092)" );
	script_tag( name: "affected", value: "'dbus-1' package(s) on OpenStack Cloud Magnum Orchestration 7, SUSE Linux Enterprise Desktop 12-SP1, SUSE Linux Enterprise Desktop 12-SP2, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Software Development Kit 12-SP1, SUSE Linux Enterprise Software Development Kit 12-SP2." );
