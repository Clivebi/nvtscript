...
DMF: Some files had a wrong tempo since libopenmpt 0.2.5705-beta15." );
	script_tag( name: "affected", value: "'libopenmpt' package(s) on SUSE Linux Enterprise Module for Desktop Applications 15-SP2, SUSE Linux Enterprise Module for Desktop Applications 15-SP3." );
