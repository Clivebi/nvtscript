if(description){
	script_oid( "1.3.6.1.4.1.25623.1.1.4.2017.2700.1" );
	...
	script_name( "SUSE: Security Advisory (SUSE-SU-2017:2700-1)" );
	script_category( ACT_GATHER_INFO );
	script_copyright( "Copyright (C) 2021 Greenbone Networks GmbH" );
	script_family( "SuSE Local Security Checks" );
	script_dependencies( "gather-package-list.sc" );
	script_mandatory_keys( "ssh/login/suse_sles", "ssh/login/rpms",  "ssh/login/release=(SLES12\\.0)" );
	script_xref( name: "Advisory-ID", value: "SUSE-SU-2017:2700-1" );
	script_xref( name: "URL", value: "https://www.suse.com/support/update/announcement/2017/suse-su-20172700-1/" );
	script_tag( name: "summary", value: "The remote host is missing an update for the 'SLES 12-SP1 Docker image' package(s) announced via the SUSE-SU-2017:2700-1 advisory." );
	script_tag( name: "vuldetect", value: "Checks if a vulnerable package version is present on the target host." );
	script_tag( name: "insight", value: "The SUSE Linux Enterprise Server 12 SP1 container image has been updated to include security and stability fixes.
...
- ... [Please see the references for more information on the vulnerabilities]" );
	script_tag( name: "affected", value: "'SLES 12-SP1 Docker image' package(s) on SUSE Linux Enterprise Module for Containers 12." );
...
report = "";
if(release == "SLES12.0"){
	if(!isnull( res = isrpmvuln( pkg: "sles12sp1-docker-image", rpm: "sles12sp1-docker-image~1.0.7~20171002", rls: "SLES12.0" ) )){
		report += res;
	}
	if( report != "" ){
