...
Be sure to check the Release Notes at [link moved to references] for any additional known issues or behavioral changes." );
	script_tag( name: "affected", value: "'Security changes in Kubernetes, etcd, and helm, Bugfix in cri-o package' package(s) on SUSE CaaS Platform 4.0, SUSE Linux Enterprise Module for Containers 15-SP1." );
