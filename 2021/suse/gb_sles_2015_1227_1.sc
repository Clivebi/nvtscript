if(description){
	...
	script_xref( name: "URL", value: "https://www.suse.com/support/update/announcement/2015/suse-su-20151227-1/" );
	...
	script_tag( name: "insight", value: "strongswan was updated to fix a problem that could enable rogue servers to gain user credentials from a client in certain IKEv2 setups. (CVE-2015-4171)
Security Issues:
CVE-2015-4171" );
...
if(release == "SLES11.0SP3"){
	if(!isnull( res = isrpmvuln( pkg: "strongswan", rpm: "strongswan~4.4.0~6.27.1", rls: "SLES11.0SP3" ) )){
		report += res;
	}
	if(!isnull( res = isrpmvuln( pkg: "strongswan-doc", rpm: "strongswan-doc~4.4.0~6.27.1", rls: "SLES11.0SP3" ) )){
		report += res;
	}
	if( report != "" ){
