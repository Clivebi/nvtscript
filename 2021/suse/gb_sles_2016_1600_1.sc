...
- CVE-2016-4008: Fixed infinite loop while parsing DER certificates
 (bsc#982779)" );
	script_tag( name: "affected", value: "'libtasn1' package(s) on SUSE Linux Enterprise Debuginfo 11-SP4, SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Software Development Kit 11-SP4." );
