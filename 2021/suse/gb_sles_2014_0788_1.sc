if(description){
	script_oid( "1.3.6.1.4.1.25623.1.1.4.2014.0788.1" );
	...
	script_name( "SUSE: Security Advisory (SUSE-SU-2014:0788-1)" );
	...
	script_xref( name: "Advisory-ID", value: "SUSE-SU-2014:0788-1" );
	script_xref( name: "URL", value: "https://www.suse.com/support/update/announcement/2014/suse-su-20140788-1/" );
	script_xref( name: "URL", value: "http://www.gnutls.org/security.html#GNUTLS-SA-2014-3" );
	script_tag( name: "summary", value: "The remote host is missing an update for the 'GnuTLS' package(s) announced via the SUSE-SU-2014:0788-1 advisory." );
	script_tag( name: "vuldetect", value: "Checks if a vulnerable package version is present on the target host." );
	script_tag( name: "insight", value: "GnuTLS was patched to ensure proper parsing of session ids during the TLS/SSL handshake. Additionally three issues inherited from libtasn1 were fixed.
 ...
 * CVE-2014-3468
 * CVE-2014-3469" );
	script_tag( name: "affected", value: "'GnuTLS' package(s) on SUSE Linux Enterprise Server 11 SP1, SUSE Linux Enterprise Server 11 SP2." );
