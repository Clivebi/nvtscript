if(description){
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the 'MozillaFirefox, MozillaFirefox-branding-SLE, llvm4, mozilla-nspr, mozilla-nss, apache2-mod_nss' package(s) announced via the SUSE-SU-2018:3591-2 advisory." );
...
The following CA certificates were Removed: OU = Security Communication
 EV RootCA1 CN = CA Disig Root R1 CN = DST ACES CA X6 ... [Please see the references for more information on the vulnerabilities]" );
	script_tag( name: "affected", value: "'MozillaFirefox, MozillaFirefox-branding-SLE, llvm4, mozilla-nspr, mozilla-nss, apache2-mod_nss' package(s) on SUSE Linux Enterprise Desktop 12-SP4, SUSE Linux Enterprise Server 12-SP4, SUSE Linux Enterprise Software Development Kit 12-SP4." );
