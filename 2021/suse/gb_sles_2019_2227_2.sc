if(description){
	...
	script_xref( name: "URL", value: "https://www.suse.com/support/update/announcement/2019/suse-su-20192227-2/" );
...
Added support for overriding max threads per process limit (bsc#1133719)" );
	script_tag( name: "affected", value: "'libvirt' package(s) on SUSE Enterprise Storage 5, SUSE Linux Enterprise Server 12-SP3." );
