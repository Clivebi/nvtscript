if(description){
	...
	script_xref( name: "URL", value: "https://www.suse.com/support/update/announcement/2018/suse-su-20181401-1/" );
...
- CVE-2017-15422: An integer overflow in icu during persian calendar date
 processing could lead to incorrect years shown (bnc#1077999)" );
	script_tag( name: "affected", value: "'icu' package(s) on OpenStack Cloud Magnum Orchestration 7, SUSE CaaS Platform ALL, SUSE Enterprise Storage 4, SUSE Linux Enterprise Desktop 12-SP3, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server for SAP 12-SP1, SUSE Linux Enterprise Server for SAP 12-SP2, SUSE Linux Enterprise Software Development Kit 12-SP3, SUSE Linux Enterprise Workstation Extension 12-SP3, SUSE OpenStack Cloud 7." );
...
report = "";
if(release == "SLES12.0"){
	if(!isnull( res = isrpmvuln( pkg: "icu-debuginfo", rpm: "icu-debuginfo~52.1~8.7.1", rls: "SLES12.0" ) )){
		report += res;
	}
	if(!isnull( res = isrpmvuln( pkg: "icu-debugsource", rpm: "icu-debugsource~52.1~8.7.1", rls: "SLES12.0" ) )){
		report += res;
	}
	...
	if(!isnull( res = isrpmvuln( pkg: "libicu52_1-debuginfo-32bit", rpm: "libicu52_1-debuginfo-32bit~52.1~8.7.1", rls: "SLES12.0" ) )){
		report += res;
	}
	if(!isnull( res = isrpmvuln( pkg: "libicu52_1-debuginfo", rpm: "libicu52_1-debuginfo~52.1~8.7.1", rls: "SLES12.0" ) )){
		report += res;
	}
	if( report != "" ){
