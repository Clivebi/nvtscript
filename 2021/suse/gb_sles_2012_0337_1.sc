 ...
 * CVE-2012-0870
>" );
	script_tag( name: "affected", value: "'Samba' package(s) on SLE SDK 10 SP4, SUSE Linux Enterprise Desktop 10 SP4, SUSE Linux Enterprise Server 10 SP3, SUSE Linux Enterprise Server 10 SP4." );
