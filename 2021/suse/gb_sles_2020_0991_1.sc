...
CVE-2020-5260: With a crafted URL that contains a newline in it, the
 ...
 for a wrong host (bsc#1168930)." );
	script_tag( name: "affected", value: "'git' package(s) on SUSE Linux Enterprise High Performance Computing 15, SUSE Linux Enterprise Module for Basesystem 15-SP1, SUSE Linux Enterprise Module for Development Tools 15-SP1, SUSE Linux Enterprise Module for Open Buildservice Development Tools 15-SP1, SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Server for SAP 15." );
