...
CVE-2021-32399: Fixed a race condition when removing the HCI controller
 (bnc#1184611)." );
	script_tag( name: "affected", value: "'Linux Kernel (Live Patch 22 for SLE 15)' package(s) on SUSE Linux Enterprise Module for Live Patching 15, SUSE Linux Enterprise Server 12-SP3, SUSE Linux Enterprise Server for SAP 12-SP3." );
