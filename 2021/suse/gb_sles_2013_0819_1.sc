...
> )" );
	script_tag( name: "affected", value: "'Linux Kernel (x86)' package(s) on SLE 11, SUSE Linux Enterprise Desktop 11 SP2, SUSE Linux Enterprise High Availability Extension 11 SP2, SUSE Linux Enterprise Server 11 SP2." );
