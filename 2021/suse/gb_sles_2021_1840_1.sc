...
CVE-2021-21343: replace or inject objects, that result in the deletion
 of files on the local host (bsc#1184376)" );
	script_tag( name: "affected", value: "'xstream' package(s) on SUSE Linux Enterprise Module for Development Tools 15-SP2, SUSE Linux Enterprise Module for Development Tools 15-SP3, SUSE Linux Enterprise Module for SUSE Manager Server 4.1." );
