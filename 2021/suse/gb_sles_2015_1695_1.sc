if(description){
	...
	script_xref( name: "URL", value: "https://www.suse.com/support/update/announcement/2015/suse-su-20151695-1/" );
...
sshd might not correctly restart. Please verify that the ssh daemon is running after installing this update.
...
Additional a bug was fixed that could lead to openssh not working in chroot (bsc#947458)." );
	script_tag( name: "affected", value: "'openssh' package(s) on SUSE Linux Enterprise Debuginfo 11-SP4, SUSE Linux Enterprise Desktop 11-SP4, SUSE Linux Enterprise Server 11-SP4." );
