if(description){
	script_oid( "1.3.6.1.4.1.25623.1.1.4.2014.0967.1" );
	...
	script_name( "SUSE: Security Advisory (SUSE-SU-2014:0967-1)" );
	script_category( ACT_GATHER_INFO );
	script_copyright( "Copyright (C) 2021 Greenbone Networks GmbH" );
	script_family( "SuSE Local Security Checks" );
	script_dependencies( "gather-package-list.sc" );
	script_mandatory_keys( "ssh/login/suse_sles", "ssh/login/rpms",  "ssh/login/release=(SLES11\\.0SP3)" );
	script_xref( name: "Advisory-ID", value: "SUSE-SU-2014:0967-1" );
	script_xref( name: "URL", value: "https://www.suse.com/support/update/announcement/2014/suse-su-20140967-1/" );
	script_tag( name: "summary", value: "The remote host is missing an update for the 'Apache Web Server' package(s) announced via the SUSE-SU-2014:0967-1 advisory." );
...
This update also introduces a new configuration parameter CGIDScriptTimeout, which defaults to the value of parameter Timeout.
CGIDScriptTimeout is set to 60s if mod_cgid is loaded/active, via
/etc/apache2/conf.d/cgid-timeout.conf. The new directive and its effect prevent request workers to be eaten until starvation if cgi programs do not send output back to the server within the timeout set by CGIDScriptTimeout. (bnc#887768, CVE-2014-0231)
 ...
 * CVE-2014-0098
 * CVE-2014-0231" );
	script_tag( name: "affected", value: "'Apache Web Server' package(s) on SUSE Linux Enterprise Server 11 SP3, SUSE Linux Enterprise Software Development Kit 11 SP3." );
