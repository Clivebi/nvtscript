if(description){
	...
	script_mandatory_keys( "ssh/login/suse_sles", "ssh/login/rpms",  "ssh/login/release=(SLES15\\.0SP1|SLES15\\.0SP2|SLES15\\.0SP3)" );
...
CVE-2021-21330: Fixed the way pure-Python HTTP parser interprets `//`
 (bsc#1184745)" );
	script_tag( name: "affected", value: "'python-aiohttp' package(s) on SUSE Linux Enterprise Module for Public Cloud 15-SP1, SUSE Linux Enterprise Module for Public Cloud 15-SP2, SUSE Linux Enterprise Module for Public Cloud 15-SP3." );
