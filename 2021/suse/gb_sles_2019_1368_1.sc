if(description){
	...
	script_mandatory_keys( "ssh/login/suse_sles", "ssh/login/rpms",  "ssh/login/release=(SLES15\\.0|SLES12\\.0)" );
...
CVE-2019-5021: Include an invalidated root password by default, not an
 empty one (bsc#1134524)" );
	script_tag( name: "affected", value: "'sles12sp3-docker-image, sles12sp4-image, system-user-root' package(s) on SUSE Linux Enterprise Module for Basesystem 15, SUSE Linux Enterprise Module for Containers 12." );
