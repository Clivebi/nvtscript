if(description){
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the 'ruby-bundled-gems-rpmhelper, ruby2.5' package(s) announced via the SUSE-SU-2019:1804-1 advisory." );
...
ruby: change over of the Japanese Era to the new emperor May 1st 2019
 ... [Please see the references for more information on the vulnerabilities]" );
	script_tag( name: "affected", value: "'ruby-bundled-gems-rpmhelper, ruby2.5' package(s) on SUSE Linux Enterprise Module for Basesystem 15, SUSE Linux Enterprise Module for Basesystem 15-SP1, SUSE Linux Enterprise Module for Open Buildservice Development Tools 15, SUSE Linux Enterprise Module for Open Buildservice Development Tools 15-SP1." );
