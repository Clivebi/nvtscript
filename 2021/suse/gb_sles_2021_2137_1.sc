...
avoid hard coding 127.0.0.1 in host ID of alive message test, let system
 ...
 key server." );
	script_tag( name: "affected", value: "'cryptctl' package(s) on SUSE Linux Enterprise Server 12-SP5, SUSE Linux Enterprise Server for SAP 12-SP3, SUSE Linux Enterprise Server for SAP 12-SP4, SUSE Linux Enterprise Server for SAP 12-SP5." );
