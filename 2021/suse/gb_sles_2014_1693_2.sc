if(description){
	script_oid( "1.3.6.1.4.1.25623.1.1.4.2014.1693.2" );
	...
	script_name( "SUSE: Security Advisory (SUSE-SU-2014:1693-2)" );
	script_category( ACT_GATHER_INFO );
	script_copyright( "Copyright (C) 2021 Greenbone Networks GmbH" );
	script_family( "SuSE Local Security Checks" );
	script_dependencies( "gather-package-list.sc" );
	script_mandatory_keys( "ssh/login/suse_sles", "ssh/login/rpms",  "ssh/login/release=(SLES11\\.0SP3)" );
	script_xref( name: "Advisory-ID", value: "SUSE-SU-2014:1693-2" );
	script_xref( name: "URL", value: "https://www.suse.com/support/update/announcement/2014/suse-su-20141693-2/" );
	script_tag( name: "summary", value: "The remote host is missing an update for the 'Linux kernel' package(s) announced via the SUSE-SU-2014:1693-2 advisory." );
 ...
 * CVE-2014-3184: The report_fixup functions in the HID subsystem in
 ...
 crafted device that provides a small report descriptor, related ... [Please see the references for more information on the vulnerabilities]" );
	script_tag( name: "affected", value: "'Linux kernel' package(s) on SUSE Linux Enterprise High Availability Extension 11 SP3, SUSE Linux Enterprise Server 11 SP3." );
