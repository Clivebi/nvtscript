if(description){
	...
	script_tag( name: "severity_date", value: "2013-10-08 19:24:00 +0000 (Tue, 08 Oct 2013)" );
 ...
 *
 ...
 o Added the python PMAPI bindings and an initial python client in pmcollectl. Separate, new package exists for python ... [Please see the references for more information on the vulnerabilities]" );
	script_tag( name: "affected", value: "'pcp' package(s) on SLE SDK 10 SP4, SUSE Linux Enterprise Desktop 10 SP4, SUSE Linux Enterprise Desktop 11 SP2, SUSE Linux Enterprise Server 10 SP4, SUSE Linux Enterprise Server 11 SP2, SUSE Linux Enterprise Software Development Kit 11 SP2." );
