if(description){
	...
	script_xref( name: "URL", value: "https://www.suse.com/support/update/announcement/2021/suse-su-20210685-1/" );
...
if(release == "SLES15.0"){
	...
	if(!isnull( res = isrpmvuln( pkg: "grub2-debuginfo", rpm: "grub2-debuginfo~2.02~19.66.1", rls: "SLES15.0" ) )){
		report += res;
	}
	if(!isnull( res = isrpmvuln( pkg: "grub2-debugsource", rpm: "grub2-debugsource~2.02~19.66.1", rls: "SLES15.0" ) )){
		report += res;
	}
