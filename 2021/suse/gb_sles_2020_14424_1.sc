if(description){
	...
	script_xref( name: "URL", value: "https://www.suse.com/support/update/announcement/2020/suse-su-202014424-1/" );
...
added patches fix CVE-2020-14398 [bsc#1173880], improperly closed TCP
