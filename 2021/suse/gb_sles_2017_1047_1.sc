if(description){
	...
	script_xref( name: "URL", value: "https://www.suse.com/support/update/announcement/2017/suse-su-20171047-1/" );
...
if(release == "SLES12.0"){
	...
	if(!isnull( res = isrpmvuln( pkg: "ntp-debuginfo", rpm: "ntp-debuginfo~4.2.8p10~46.23.1", rls: "SLES12.0" ) )){
		report += res;
	}
	if(!isnull( res = isrpmvuln( pkg: "ntp-debugsource", rpm: "ntp-debugsource~4.2.8p10~46.23.1", rls: "SLES12.0" ) )){
		report += res;
	}
