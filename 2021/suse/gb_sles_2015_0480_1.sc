if(description){
	...
	script_xref( name: "URL", value: "https://www.suse.com/support/update/announcement/2015/suse-su-20150480-1/" );
 ...
 *
 ...
 A flaw when handling malformed NSEC3-signed zones could lead named to a crash. (CVE-2014-0591, bnc#858639)
...
if(release == "SLES11.0SP1"){
	...
	if(!isnull( res = isrpmvuln( pkg: "bind-libs-32bit", rpm: "bind-libs-32bit~9.6ESVR11W1~0.2.1", rls: "SLES11.0SP1" ) )){
		report += res;
	}
