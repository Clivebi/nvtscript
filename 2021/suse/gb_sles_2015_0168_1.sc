if(description){
	script_oid( "1.3.6.1.4.1.25623.1.1.4.2015.0168.1" );
	...
	script_name( "SUSE: Security Advisory (SUSE-SU-2015:0168-1)" );
	script_category( ACT_GATHER_INFO );
	script_copyright( "Copyright (C) 2021 Greenbone Networks GmbH" );
	script_family( "SuSE Local Security Checks" );
	script_dependencies( "gather-package-list.sc" );
	script_mandatory_keys( "ssh/login/suse_sles", "ssh/login/rpms",  "ssh/login/release=(SLES11\\.0SP3)" );
	script_xref( name: "Advisory-ID", value: "SUSE-SU-2015:0168-1" );
	script_xref( name: "URL", value: "https://www.suse.com/support/update/announcement/2015/suse-su-20150168-1/" );
	script_tag( name: "summary", value: "The remote host is missing an update for the 'binutils' package(s) announced via the SUSE-SU-2015:0168-1 advisory." );
	script_tag( name: "vuldetect", value: "Checks if a vulnerable package version is present on the target host." );
	script_tag( name: "insight", value: "binutils has been updated to fix eight security issues:
 ...
 * CVE-2014-8484
 * CVE-2014-8737" );
	script_tag( name: "affected", value: "'binutils' package(s) on SUSE Linux Enterprise Desktop 11 SP3, SUSE Linux Enterprise Server 11 SP3, SUSE Linux Enterprise Software Development Kit 11 SP3." );
...
if(release == "SLES11.0SP3"){
	if(!isnull( res = isrpmvuln( pkg: "binutils", rpm: "binutils~2.23.1~0.23.15", rls: "SLES11.0SP3" ) )){
		report += res;
	}
	if( report != "" ){
