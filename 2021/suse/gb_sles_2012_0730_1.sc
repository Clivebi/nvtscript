if(description){
	...
	script_mandatory_keys( "ssh/login/suse_sles", "ssh/login/rpms",  "ssh/login/release=(SLES10\\.0SP2|SLES10\\.0SP3|SLES10\\.0SP4|SLES11\\.0SP1)" );
...
Please reboot the system after installing this update." );
	script_tag( name: "affected", value: "'Xen' package(s) on SLE SDK 10 SP4, SUSE Linux Enterprise Desktop 10 SP4, SUSE Linux Enterprise Desktop 11 SP1, SUSE Linux Enterprise Server 10 SP2, SUSE Linux Enterprise Server 10 SP3, SUSE Linux Enterprise Server 10 SP4, SUSE Linux Enterprise Server 11 SP1, SUSE Linux Enterprise Software Development Kit 11 SP1." );
