if(description){
	...
	script_xref( name: "URL", value: "https://www.suse.com/support/update/announcement/2016/suse-su-20163161-1/" );
...
- CVE-2015-8391: Some pathological patterns causes pcre_compile() to ... [Please see the references for more information on the vulnerabilities]" );
	script_tag( name: "affected", value: "'pcre' package(s) on SUSE Linux Enterprise Desktop 12-SP1, SUSE Linux Enterprise Desktop 12-SP2, SUSE Linux Enterprise High Availability 12-SP1, SUSE Linux Enterprise High Availability 12-SP2, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Server 12-SP2, SUSE Linux Enterprise Server for Raspberry Pi 12-SP2, SUSE Linux Enterprise Server for SAP 12, SUSE Linux Enterprise Software Development Kit 12-SP1, SUSE Linux Enterprise Software Development Kit 12-SP2, SUSE Linux Enterprise Workstation Extension 12-SP1, SUSE Linux Enterprise Workstation Extension 12-SP2." );
...
if(release == "SLES12.0"){
	...
	if(!isnull( res = isrpmvuln( pkg: "libpcre1-debuginfo-32bit", rpm: "libpcre1-debuginfo-32bit~8.39~7.1", rls: "SLES12.0" ) )){
		report += res;
	}
	if(!isnull( res = isrpmvuln( pkg: "libpcre1-debuginfo", rpm: "libpcre1-debuginfo~8.39~7.1", rls: "SLES12.0" ) )){
		report += res;
	}
	if(!isnull( res = isrpmvuln( pkg: "libpcre16-0", rpm: "libpcre16-0~8.39~7.1", rls: "SLES12.0" ) )){
		report += res;
	}
	if(!isnull( res = isrpmvuln( pkg: "libpcre16-0-debuginfo", rpm: "libpcre16-0-debuginfo~8.39~7.1", rls: "SLES12.0" ) )){
		report += res;
	}
	if(!isnull( res = isrpmvuln( pkg: "pcre-debugsource", rpm: "pcre-debugsource~8.39~7.1", rls: "SLES12.0" ) )){
		report += res;
	}
	if( report != "" ){
