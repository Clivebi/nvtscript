if(description){
	...
	script_xref( name: "URL", value: "https://www.suse.com/support/update/announcement/2018/suse-su-20183622-1/" );
...
CVE-2018-16427: Fixed out of bounds reads when handling responses in
 OpenSC (bsc#1107033)" );
	script_tag( name: "affected", value: "'opensc' package(s) on SUSE Linux Enterprise Desktop 12-SP3, SUSE Linux Enterprise Server 12-SP3." );
