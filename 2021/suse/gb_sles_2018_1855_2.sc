if(description){
	...
	script_xref( name: "URL", value: "https://www.suse.com/support/update/announcement/2018/suse-su-20181855-2/" );
...
CVE-2018-1000199: Prevent vulnerability in modify_user_hw_breakpoint()
 that could ... [Please see the references for more information on the vulnerabilities]" );
