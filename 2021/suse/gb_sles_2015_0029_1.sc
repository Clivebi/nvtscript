...
- Passing special crafted jpeg file smashes stack (CVE-2014-9092)." );
	script_tag( name: "affected", value: "'libjpeg-turbo, libjpeg62-turbo' package(s) on SUSE Linux Enterprise Desktop 12, SUSE Linux Enterprise Server 12, SUSE Linux Enterprise Software Development Kit 12." );
