...
Add sudo to requires: used to drop privileges." );
	script_tag( name: "affected", value: "'avahi' package(s) on SUSE Linux Enterprise Module for Basesystem 15-SP2, SUSE Linux Enterprise Module for Desktop Applications 15-SP2, SUSE Linux Enterprise Module for Packagehub Subpackages 15-SP2." );
