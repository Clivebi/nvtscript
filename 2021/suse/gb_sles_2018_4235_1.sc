...
Update mozilla-nspr to 4.20 (bsc#1119105)" );
	script_tag( name: "affected", value: "'MozillaFirefox, mozilla-nspr and mozilla-nss' package(s) on SUSE Linux Enterprise Module for Basesystem 15, SUSE Linux Enterprise Module for Desktop Applications 15, SUSE Linux Enterprise Module for Open Buildservice Development Tools 15." );
