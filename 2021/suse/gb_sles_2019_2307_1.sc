...
Hardening for su wrappers (bsc#353876)" );
	script_tag( name: "affected", value: "'util-linux and shadow' package(s) on SUSE Linux Enterprise Module for Basesystem 15-SP1, SUSE Linux Enterprise Module for Open Buildservice Development Tools 15-SP1, SUSE Linux Enterprise Module for Server Applications 15-SP1." );
