if(description){
	script_oid( "1.3.6.1.4.1.25623.1.1.4.2020.1922.1" );
	...
	script_name( "SUSE: Security Advisory (SUSE-SU-2020:1922-1)" );
	...
	script_xref( name: "Advisory-ID", value: "SUSE-SU-2020:1922-1" );
	script_xref( name: "URL", value: "https://www.suse.com/support/update/announcement/2020/suse-su-20201922-1/" );
	script_tag( name: "summary", value: "The remote host is missing an update for the 'LibVNCServer' package(s) announced via the SUSE-SU-2020:1922-1 advisory." );
...
added patches fix CVE-2018-21247 [bsc#1173874], uninitialized memory
 ...
 [bsc#1173477], preauth buffer overwrite" );
	script_tag( name: "affected", value: "'LibVNCServer' package(s) on SUSE Linux Enterprise Module for Packagehub Subpackages 15-SP1, SUSE Linux Enterprise Module for Packagehub Subpackages 15-SP2, SUSE Linux Enterprise Workstation Extension 15-SP1, SUSE Linux Enterprise Workstation Extension 15-SP2." );
...
if(release == "SLES15.0SP1"){
	if(!isnull( res = isrpmvuln( pkg: "LibVNCServer-debugsource", rpm: "LibVNCServer-debugsource~0.9.10~4.22.1", rls: "SLES15.0SP1" ) )){
		report += res;
	}
	if(!isnull( res = isrpmvuln( pkg: "libvncserver0", rpm: "libvncserver0~0.9.10~4.22.1", rls: "SLES15.0SP1" ) )){
		report += res;
	}
	if(!isnull( res = isrpmvuln( pkg: "libvncserver0-debuginfo", rpm: "libvncserver0-debuginfo~0.9.10~4.22.1", rls: "SLES15.0SP1" ) )){
		report += res;
	}
	if( report != "" ){
...
if(release == "SLES15.0SP2"){
	if(!isnull( res = isrpmvuln( pkg: "LibVNCServer-debugsource", rpm: "LibVNCServer-debugsource~0.9.10~4.22.1", rls: "SLES15.0SP2" ) )){
		report += res;
	}
	if(!isnull( res = isrpmvuln( pkg: "libvncserver0", rpm: "libvncserver0~0.9.10~4.22.1", rls: "SLES15.0SP2" ) )){
		report += res;
	}
	if(!isnull( res = isrpmvuln( pkg: "libvncserver0-debuginfo", rpm: "libvncserver0-debuginfo~0.9.10~4.22.1", rls: "SLES15.0SP2" ) )){
		report += res;
	}
	if( report != "" ){
		security_message( data: report );
