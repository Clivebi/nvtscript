...
Add udev rule for Feitian ePass FIDO
 - Add a timeout to the register and authenticate actions." );
	script_tag( name: "affected", value: "'libu2f-host' package(s) on SUSE Linux Enterprise Module for Basesystem 15-SP2, SUSE Linux Enterprise Module for Basesystem 15-SP3." );
