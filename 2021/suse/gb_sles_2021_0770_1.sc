...
add '-D' option in rpmdb2solv to set the dbpath" );
	script_tag( name: "affected", value: "'libsolv, libzypp, yast2-installation, zypper' package(s) on SUSE Linux Enterprise High Performance Computing 15, SUSE Linux Enterprise Installer 15, SUSE Linux Enterprise Server 15, SUSE Linux Enterprise Server for SAP 15." );
