...
bsc#1074247: Fix test suite, use correct date (gh#shazow/urllib3#1303)." );
	script_tag( name: "affected", value: "'python-urllib3' package(s) on OpenStack Cloud Magnum Orchestration 7, SUSE CaaS Platform 3.0, SUSE CaaS Platform ALL, SUSE Enterprise Storage 4, SUSE Enterprise Storage 5, SUSE Linux Enterprise Module for Public Cloud 12, SUSE Manager Server 3.1, SUSE Manager Server 3.2." );
