if(description){
	...
	script_tag( name: "severity_date", value: "2020-09-23 16:09:00 +0000 (Wed, 23 Sep 2020)" );
...
ath9k: hif_usb: fix race condition between usb_get_urb() and
 usb_kill_anchored_urbs() ... [Please see the references for more information on the vulnerabilities]" );
	script_tag( name: "affected", value: "'Linux Kernel' package(s) on SUSE Linux Enterprise High Availability 15-SP1, SUSE Linux Enterprise Module for Basesystem 15-SP1, SUSE Linux Enterprise Module for Development Tools 15-SP1, SUSE Linux Enterprise Module for Legacy Software 15-SP1, SUSE Linux Enterprise Workstation Extension 15-SP1." );
