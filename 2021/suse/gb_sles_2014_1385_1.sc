if(description){
	script_oid( "1.3.6.1.4.1.25623.1.1.4.2014.1385.1" );
	...
	script_name( "SUSE: Security Advisory (SUSE-SU-2014:1385-1)" );
	...
	script_xref( name: "Advisory-ID", value: "SUSE-SU-2014:1385-1" );
	script_xref( name: "URL", value: "https://www.suse.com/support/update/announcement/2014/suse-su-20141385-1/" );
	script_tag( name: "summary", value: "The remote host is missing an update for the 'MozillaFirefox' package(s) announced via the SUSE-SU-2014:1385-1 advisory." );
 ...
 * CVE-2014-1585
 * CVE-2014-1586" );
	script_tag( name: "affected", value: "'MozillaFirefox' package(s) on SUSE Linux Enterprise Desktop 11 SP3, SUSE Linux Enterprise Server 11 SP2, SUSE Linux Enterprise Server 11 SP3, SUSE Linux Enterprise Software Development Kit 11 SP3." );
...
if(release == "SLES11.0SP2"){
	if(!isnull( res = isrpmvuln( pkg: "MozillaFirefox", rpm: "MozillaFirefox~31.2.0esr~0.9.1", rls: "SLES11.0SP2" ) )){
		report += res;
	}
	if(!isnull( res = isrpmvuln( pkg: "MozillaFirefox-branding-SLED", rpm: "MozillaFirefox-branding-SLED~31.0~0.3.1", rls: "SLES11.0SP2" ) )){
		report += res;
	}
	if(!isnull( res = isrpmvuln( pkg: "MozillaFirefox-translations", rpm: "MozillaFirefox-translations~31.2.0esr~0.9.1", rls: "SLES11.0SP2" ) )){
		report += res;
	}
...
if(release == "SLES11.0SP3"){
	...
	if(!isnull( res = isrpmvuln( pkg: "MozillaFirefox-branding-SLES-for-VMware", rpm: "MozillaFirefox-branding-SLES-for-VMware~31.0~0.3.1", rls: "SLES11.0SP3" ) )){
		report += res;
	}
