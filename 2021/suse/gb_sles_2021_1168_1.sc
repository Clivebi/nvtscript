...
CVE-2020-26572: Fixed a stack-based buffer overflow in tcos_decipher
 (bsc#1177378)." );
	script_tag( name: "affected", value: "'opensc' package(s) on SUSE Linux Enterprise Module for Basesystem 15-SP2, SUSE Linux Enterprise Module for Basesystem 15-SP3." );
