if(description){
	...
	script_xref( name: "URL", value: "https://www.suse.com/support/update/announcement/2015/suse-su-20150985-1/" );
	...
	script_tag( name: "insight", value: "This update for sudo provides the following fixes:
...
Create log files with ownership set to user and group 'root'. (bnc#904694)
...
if(release == "SLES11.0SP3"){
	if(!isnull( res = isrpmvuln( pkg: "sudo", rpm: "sudo~1.7.6p2~0.23.1", rls: "SLES11.0SP3" ) )){
		report += res;
	}
	if( report != "" ){
