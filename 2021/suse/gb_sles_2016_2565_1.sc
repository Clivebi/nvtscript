...
- Clean up some memory leaks in test code (fdo#90021)" );
	script_tag( name: "affected", value: "'dbus-1' package(s) on SUSE Linux Enterprise Desktop 12-SP1, SUSE Linux Enterprise Server 12-SP1, SUSE Linux Enterprise Software Development Kit 12-SP1." );
