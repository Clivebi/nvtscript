if(description){
	...
	script_xref( name: "URL", value: "https://www.suse.com/support/update/announcement/2019/suse-su-20191235-1/" );
...
if(release == "SLES12.0"){
	...
	if(!isnull( res = isrpmvuln( pkg: "ucode-intel-debuginfo", rpm: "ucode-intel-debuginfo~20190507~13.41.1", rls: "SLES12.0" ) )){
		report += res;
	}
	if(!isnull( res = isrpmvuln( pkg: "ucode-intel-debugsource", rpm: "ucode-intel-debugsource~20190507~13.41.1", rls: "SLES12.0" ) )){
		report += res;
	}
	if( report != "" ){
