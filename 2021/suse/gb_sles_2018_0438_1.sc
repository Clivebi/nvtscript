if(description){
	...
	script_xref( name: "URL", value: "https://www.suse.com/support/update/announcement/2018/suse-su-20180438-1/" );
...
- bsc#1067317: pass cache=writeback<pipe>unsafe<pipe>directsync to qemu depending on
