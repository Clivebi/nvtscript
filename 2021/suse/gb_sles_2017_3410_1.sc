if(description){
	...
	script_xref( name: "URL", value: "https://www.suse.com/support/update/announcement/2017/suse-su-20173410-1/" );
...
This update enables SMB encryption in the CIFS support in the Linux Kernel
(fate#324404)
...
- CVE-2017-16646: ... [Please see the references for more information on the vulnerabilities]" );
