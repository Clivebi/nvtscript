if(description){
	...
	script_xref( name: "URL", value: "https://www.suse.com/support/update/announcement/2018/suse-su-20183621-1/" );
...
CVE-2018-16427: Fixed out of bounds reads when handling responses in
 OpenSC (bsc#1107033)" );
	script_tag( name: "affected", value: "'opensc' package(s) on SUSE Linux Enterprise Debuginfo 11-SP4, SUSE Linux Enterprise Server 11-SP4, SUSE Linux Enterprise Software Development Kit 11-SP4." );
