if(description){
	...
	script_xref( name: "URL", value: "https://www.suse.com/support/update/announcement/2018/suse-su-20181362-1/" );
...
- Add support for block resize support for xen disks through the monitor This non-security issue was fixed:
