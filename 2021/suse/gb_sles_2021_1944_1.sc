...
Update to version 1.16.3:
 ...
 - webrtc: Unmap all non-binary buffers received via the datachannel" );
	script_tag( name: "affected", value: "'gstreamer-plugins-bad' package(s) on SUSE Linux Enterprise Module for Basesystem 15-SP3, SUSE Linux Enterprise Module for Desktop Applications 15-SP3." );
