if(description){
	...
	script_tag( name: "severity_date", value: "2021-06-09 14:59:49 +0000 (Wed, 09 Jun 2021)" );
	...
	script_xref( name: "URL", value: "https://www.suse.com/support/update/announcement/2015/suse-su-20151011-1/" );
	...
	script_tag( name: "insight", value: "This update fixes a privilege escalation via cross-site scripting and bad print job submission used to replace cupsd.conf on the server. This combination of issues could lead to remote code execution.
