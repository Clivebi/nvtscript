if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2021-1041" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'ghostscript' package(s) announced via the EulerOS-SA-2021-1041 advisory." );
...
A buffer overflow vulnerability in tiff12_print_page() in devices/gdevtfnx.c of Artifex Software ... [Please see the references for more information on the vulnerabilities]" );
