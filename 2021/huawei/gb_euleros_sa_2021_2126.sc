if(description){
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'grub2' package(s) announced via the EulerOS-SA-2021-2126 advisory." );
...
if(release == "EULEROSVIRT-3.0.2.2"){
	if(!isnull( res = isrpmvuln( pkg: "grub2", rpm: "grub2~2.02~0.65.2.h16", rls: "EULEROSVIRT-3.0.2.2" ) )){
		report += res;
	}
	if(!isnull( res = isrpmvuln( pkg: "grub2-common", rpm: "grub2-common~2.02~0.65.2.h16", rls: "EULEROSVIRT-3.0.2.2" ) )){
		report += res;
	}
	if(!isnull( res = isrpmvuln( pkg: "grub2-efi-x64-modules", rpm: "grub2-efi-x64-modules~2.02~0.65.2.h16", rls: "EULEROSVIRT-3.0.2.2" ) )){
		report += res;
	}
	if(!isnull( res = isrpmvuln( pkg: "grub2-pc", rpm: "grub2-pc~2.02~0.65.2.h16", rls: "EULEROSVIRT-3.0.2.2" ) )){
		report += res;
	}
	if(!isnull( res = isrpmvuln( pkg: "grub2-pc-modules", rpm: "grub2-pc-modules~2.02~0.65.2.h16", rls: "EULEROSVIRT-3.0.2.2" ) )){
		report += res;
	}
	if(!isnull( res = isrpmvuln( pkg: "grub2-tools", rpm: "grub2-tools~2.02~0.65.2.h16", rls: "EULEROSVIRT-3.0.2.2" ) )){
		report += res;
	}
	if(!isnull( res = isrpmvuln( pkg: "grub2-tools-extra", rpm: "grub2-tools-extra~2.02~0.65.2.h16", rls: "EULEROSVIRT-3.0.2.2" ) )){
		report += res;
	}
	if(!isnull( res = isrpmvuln( pkg: "grub2-tools-minimal", rpm: "grub2-tools-minimal~2.02~0.65.2.h16", rls: "EULEROSVIRT-3.0.2.2" ) )){
		report += res;
	}
	if( report != "" ){
