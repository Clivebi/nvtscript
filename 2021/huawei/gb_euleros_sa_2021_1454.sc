if(description){
	...
	script_xref( name: "URL", value: "https://access.redhat.com/solutions/41278" );
...
To mitigate this issue, prevent the module nouveau from being loaded. Please see [link moved to references] for information on how to blacklist a kernel module to prevent it from loading automatically.(CVE-2020-27820)
