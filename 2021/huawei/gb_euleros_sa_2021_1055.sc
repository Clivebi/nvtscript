if(description){
	...
	script_cve_id( "CVE-2019-2455", "CVE-2019-2481", "CVE-2019-2974", "CVE-2020-2574" );
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2021-1055" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'mariadb' package(s) announced via the EulerOS-SA-2021-1055 advisory." );
