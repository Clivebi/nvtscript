if(description){
	...
	script_tag( name: "severity_date", value: "2021-08-30 16:25:00 +0000 (Mon, 30 Aug 2021)" );
...
if(IsMatchRegexp( version, "^V200R013C00SPC500" )){
...
if(IsMatchRegexp( version, "^V200R019C00SPC500" )){
