if(description){
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'p11-kit' package(s) announced via the EulerOS-SA-2021-1620 advisory." );
