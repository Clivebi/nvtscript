if(description){
	...
	script_xref( name: "Advisory-ID", value: "EulerOS-SA-2021-1095" );
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'lldpad' package(s) announced via the EulerOS-SA-2021-1095 advisory." );
