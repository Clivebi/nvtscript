if(description){
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'libldb' package(s) announced via the EulerOS-SA-2021-2102 advisory." );
