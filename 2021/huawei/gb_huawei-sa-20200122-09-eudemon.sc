if(description){
	...
	script_tag( name: "severity_date", value: "2021-01-19 17:12:00 +0000 (Tue, 19 Jan 2021)" );
...
if(cpe == "cpe:/o:huawei:s12700_firmware" || cpe == "cpe:/o:huawei:s2700_firmware" || cpe == "cpe:/o:huawei:s5700_firmware" || cpe == "cpe:/o:huawei:s6700_firmware" || cpe == "cpe:/o:huawei:s7700_firmware" || cpe == "cpe:/o:huawei:s9700_firmware"){
...
if(cpe == "cpe:/o:huawei:usg6600_firmware"){
	if(IsMatchRegexp( version, "^V500R001C30SPC200" ) || IsMatchRegexp( version, "^V500R001C30SPC600" ) || IsMatchRegexp( version, "^V500R001C60SPC500" ) || IsMatchRegexp( version, "^V500R005C00" )){
...
if(cpe == "cpe:/o:huawei:usg9500_firmware"){
	if(IsMatchRegexp( version, "^V500R001C30SPC300" ) || IsMatchRegexp( version, "^V500R001C30SPC600" ) || IsMatchRegexp( version, "^V500R001C60SPC500" ) || IsMatchRegexp( version, "V500R005C00" )){
		report = report_fixed_ver( installed_version: version, fixed_version: "V500R005C20SPC300" );
		security_message( port: 0, data: report );
		exit( 0 );
	}
