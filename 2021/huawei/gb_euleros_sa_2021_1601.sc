if(description){
	...
	script_tag( name: "summary", value: "The remote host is missing an update for the Huawei EulerOS 'grub2' package(s) announced via the EulerOS-SA-2021-1601 advisory." );
...
In grub2 versions before 2.06 the grub memory allocator doesn't check for ... [Please see the references for more information on the vulnerabilities]" );
