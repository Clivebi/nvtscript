if(description){
	...
	script_tag( name: "severity_date", value: "2021-03-24 20:32:00 +0000 (Wed, 24 Mar 2021)" );
...
if(cpe == "cpe:/o:huawei:s12700_firmware" || cpe == "cpe:/o:huawei:s9700_firmware"){
	if(IsMatchRegexp( version, "^V200R007C01" ) || IsMatchRegexp( version, "^V200R007C01B102" ) || IsMatchRegexp( version, "^V200R008C00" ) || IsMatchRegexp( version, "^V200R010C00" ) || IsMatchRegexp( version, "^V200R010C00SPC300" ) || IsMatchRegexp( version, "^V200R011C00" ) || IsMatchRegexp( version, "^V200R011C00SPC100" ) || IsMatchRegexp( version, "^V200R011C10" )){
...
if(cpe == "cpe:/o:huawei:s1700_firmware"){
	if(IsMatchRegexp( version, "^V200R009C00SPC200" ) || IsMatchRegexp( version, "^V200R009C00SPC500" ) || IsMatchRegexp( version, "^V200R010C00" ) || IsMatchRegexp( version, "^V200R010C00SPC300" ) || IsMatchRegexp( version, "^V200R011C00" ) || IsMatchRegexp( version, "^V200R011C00SPC100" ) || IsMatchRegexp( version, "^V200R011C10" )){
		report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V200R013C00SPC500" );
		security_message( port: 0, data: report );
		exit( 0 );
	}
...
if(cpe == "cpe:/o:huawei:s2700_firmware" || cpe == "cpe:/o:huawei:s7700_firmware"){
	if(IsMatchRegexp( version, "^V200R008C00" ) || IsMatchRegexp( version, "^V200R010C00" ) || IsMatchRegexp( version, "^V200R010C00SPC300" ) || IsMatchRegexp( version, "^V200R011C00" ) || IsMatchRegexp( version, "^V200R011C00SPC100" ) || IsMatchRegexp( version, "^V200R011C10" )){
...
if(cpe == "cpe:/o:huawei:s5700_firmware" || cpe == "cpe:/o:huawei:s6700_firmware"){
	if(IsMatchRegexp( version, "^V200R008C00" ) || IsMatchRegexp( version, "^V200R010C00" ) || IsMatchRegexp( version, "^V200R010C00SPC300" ) || IsMatchRegexp( version, "^V200R011C00" ) || IsMatchRegexp( version, "^V200R011C00SPC100" ) || IsMatchRegexp( version, "^V200R011C10" ) || IsMatchRegexp( version, "^V200R011C10SPC100" )){
		report = report_fixed_ver( installed_version: version, installed_patch: patch, fixed_version: "V200R013C00SPC500" );
		security_message( port: 0, data: report );
		exit( 0 );
	}
}
if(cpe == "cpe:/o:huawei:usg6300_firmware" || cpe == "cpe:/o:huawei:usg6500_firmware" || cpe == "cpe:/o:huawei:usg6600_firmware" || cpe == "cpe:/o:huawei:usg9500_firmware"){
