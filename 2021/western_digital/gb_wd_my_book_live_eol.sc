...
if(description){
	...
	script_dependencies( "gb_wd_mybook_live_http_detect.sc" );
...
report = build_eol_message( name: "Western Digital My Book Live", cpe: CPE, eol_date: "Received final firmware update in 2015", eol_url: "https://support-en.wd.com/app/answers/detail/a_id/28740", eol_version: "All versions", eol_type: "prod", skip_version: TRUE );
