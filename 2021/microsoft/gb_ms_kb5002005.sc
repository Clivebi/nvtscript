if(description){
	...
	script_tag( name: "severity_date", value: "2021-09-24 19:07:00 +0000 (Fri, 24 Sep 2021)" );
...
for key in key_list {
	...
	if(msPath){
		...
		if(IsMatchRegexp( offdllVer, "^16\\." ) && version_is_less( version: offdllVer, test_version: "16.0.5215.1000" )){
			report = report_fixed_ver( file_checked: msPath + "\\Microsoft Office\\root\\VFS\\ProgramFilesCommonX86\\Microsoft Shared\\Office16", file_version: offdllVer, vulnerable_range: "16.0 - 16.0.5215.0999" );
