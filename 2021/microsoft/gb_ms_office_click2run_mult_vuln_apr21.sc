if(description){
	...
	script_cve_id( "CVE-2021-28451", "CVE-2021-28452", "CVE-2021-28453", "CVE-2021-28454", "CVE-2021-28456", "CVE-2021-28449" );
	...
	if( UpdateChannel == "Semi-Annual Channel (Targeted)" ){
		...
		if(UpdateChannel == "Semi-Annual Channel"){
			if( version_is_less( version: officeVer, test_version: "16.0.13127.21506" ) ){
				...
				if(version_in_range( version: officeVer, test_version: "16.0.12527", test_version2: "16.0.12527.21813" )){
