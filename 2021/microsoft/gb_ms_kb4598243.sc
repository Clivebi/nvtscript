...
if(version_in_range( version: fileVer, test_version: "10.0.14393.0", test_version2: "10.0.14393.4168" )){
	report = report_fixed_ver( file_checked: dllPath + "\\Calc.exe", file_version: fileVer, vulnerable_range: "10.0.14393.0 - 10.0.14393.4168" );
