if(description){
	...
	script_tag( name: "severity_date", value: "2021-01-19 20:37:00 +0000 (Tue, 19 Jan 2021)" );
...
if(IsMatchRegexp( officeVer, "^16\\." )){
	...
	for key in key_list {
		...
		if(propath){
			...
			if(IsMatchRegexp( offexeVer, "^16\\." ) && version_is_less( version: offexeVer, test_version: "16.0.5110.1000" )){
				report = report_fixed_ver( file_checked: offPath + "\\acecore.dll", file_version: offexeVer, vulnerable_range: "16.0 - 16.0.5110.0999" );
