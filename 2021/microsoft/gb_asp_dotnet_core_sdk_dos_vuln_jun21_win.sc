...
path = infos["location"];
if( IsMatchRegexp( coreVers, "^5\\.0" ) && version_is_less( version: coreVers, test_version: "5.0.204" ) ){
	fix = "5.0.204";
}
else {
	if(IsMatchRegexp( coreVers, "^3\\.1" ) && version_is_less( version: coreVers, test_version: "3.1.116" )){
		fix = "3.1.116";
	}
}
if(fix){
