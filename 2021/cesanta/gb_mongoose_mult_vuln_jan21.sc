...
if(description){
	...
	script_tag( name: "severity_date", value: "2021-02-12 20:57:00 +0000 (Fri, 12 Feb 2021)" );
	script_cve_id( "CVE-2021-26528", "CVE-2021-26529", "CVE-2021-26530" );
	script_tag( name: "qod_type", value: "remote_banner" );
	script_tag( name: "solution_type", value: "VendorFix" );
	script_name( "Mongoose Web Server < 7.1 Multiple Vulnerabilities" );
  ...
  - CVE-2021-26528: Out-of-bounds write caused by incorrect error handling of calloc in
  mg_http_serve_file.

  - CVE-2021-26529, CVE-2021-26530: Out-of-bounds write caused by incorrect error handling of calloc
  in mg_tls_init." );
	script_tag( name: "affected", value: "Mongoose Web Server version 7.0 and prior." );
