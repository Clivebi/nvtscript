...
if(description){
	...
	script_tag( name: "last_modification", value: "2021-09-20 08:40:49 +0000 (Mon, 20 Sep 2021)" );
	...
	script_dependencies( "postgresql_detect.sc", "secpod_postgresql_detect_lin.sc", "os_detection.sc" );
