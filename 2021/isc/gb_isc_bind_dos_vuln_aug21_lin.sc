...
if(description){
	...
	script_tag( name: "last_modification", value: "2021-09-17 10:40:50 +0000 (Fri, 17 Sep 2021)" );
...
if(IsMatchRegexp( version, "^9\\." )){
	...
	if(version_is_greater_equal( version: version, test_version: "9.16.0" ) && version_is_less( version: version, test_version: "9.16.20" )){
		report = report_fixed_ver( installed_version: version, fixed_version: "9.16.20", install_path: location );
		security_message( port: port, data: report, proto: proto );
		exit( 0 );
	}
	if(version_is_greater_equal( version: version, test_version: "9.17.0" ) && version_is_less( version: version, test_version: "9.17.17" )){
