...
if(description){
	...
	script_name( "Zoom Client < 5.4.0 Privilege Escalation Vulnerability - Windows" );
  ...
  possible to launch Internet Explorer. If the installer was launched with elevated privileges such
  as by 'SCCM' this can result in a local privilege escalation." );
	script_tag( name: "affected", value: "All versions of the Zoom Client before 5.4.0." );
