...
if(description){
	...
	script_cve_id( "CVE-2020-2803", "CVE-2020-2805", "CVE-2020-2816", "CVE-2020-2781", "CVE-2020-2830", "CVE-2020-2767", "CVE-2020-2800", "CVE-2020-2778", "CVE-2020-2754", "CVE-2020-2755", "CVE-2020-2773", "CVE-2020-2756", "CVE-2020-2757" );
  ...
  vulnerabilities." );
	script_tag( name: "affected", value: "Oracle OpenJDK versions 14, 13.0.2, 11.0.6, 8u242 (1.8.0.242),
  7u251 (1.7.0.251) and prior." );
...
vers = infos["version"];
path = infos["location"];
if(IsMatchRegexp( vers, "^14" ) && version_is_less_equal( version: vers, test_version: "14.0" )){
	report = report_fixed_ver( installed_version: vers, fixed_version: "See advisory", install_path: path );
	security_message( port: port, data: report );
	exit( 0 );
}
if(IsMatchRegexp( vers, "^13" ) && version_is_less_equal( version: vers, test_version: "13.0.2" )){
	report = report_fixed_ver( installed_version: vers, fixed_version: "See advisory", install_path: path );
	security_message( port: port, data: report );
	exit( 0 );
}
if(IsMatchRegexp( vers, "^11" ) && version_is_less_equal( version: vers, test_version: "11.0.6" )){
	report = report_fixed_ver( installed_version: vers, fixed_version: "See advisory", install_path: path );
	security_message( port: port, data: report );
	exit( 0 );
}
if(IsMatchRegexp( vers, "^1\\.8" ) && version_is_less_equal( version: vers, test_version: "1.8.0.242" )){
	report = report_fixed_ver( installed_version: vers, fixed_version: "See advisory", install_path: path );
	security_message( port: port, data: report );
	exit( 0 );
}
if(IsMatchRegexp( vers, "^1\\.7" ) && version_is_less_equal( version: vers, test_version: "1.7.0.251" )){
	report = report_fixed_ver( installed_version: vers, fixed_version: "See advisory", install_path: path );
	security_message( port: port, data: report );
	exit( 0 );
}
