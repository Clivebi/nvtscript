...
if(description){
	...
	script_cve_id( "CVE-2019-2949", "CVE-2019-2989", "CVE-2019-2958", "CVE-2019-2975", "CVE-2019-2977", "CVE-2019-2999", "CVE-2019-2981", "CVE-2019-2973", "CVE-2019-2983", "CVE-2019-2988", "CVE-2019-2978", "CVE-2019-2964", "CVE-2019-2992", "CVE-2019-2962", "CVE-2019-2987", "CVE-2019-2894", "CVE-2019-2933", "CVE-2019-2945" );
...
if(IsMatchRegexp( vers, "^11" ) && version_is_less_equal( version: vers, test_version: "11.0.4" )){
	report = report_fixed_ver( installed_version: vers, fixed_version: "See advisory", install_path: path );
	security_message( port: port, data: report );
	exit( 0 );
}
if(IsMatchRegexp( vers, "^1\\.8" ) && version_is_less_equal( version: vers, test_version: "1.8.0.222" )){
	report = report_fixed_ver( installed_version: vers, fixed_version: "See advisory", install_path: path );
	security_message( port: port, data: report );
	exit( 0 );
}
if(IsMatchRegexp( vers, "^1\\.7" ) && version_is_less_equal( version: vers, test_version: "1.7.0.231" )){
	report = report_fixed_ver( installed_version: vers, fixed_version: "See advisory", install_path: path );
	security_message( port: port, data: report );
	exit( 0 );
}
