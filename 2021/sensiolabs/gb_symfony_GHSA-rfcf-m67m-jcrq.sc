...
if(description){
	...
	script_tag( name: "severity_date", value: "2021-06-24 19:00:00 +0000 (Thu, 24 Jun 2021)" );
...
if(IsMatchRegexp( version, "^5\\.3\\." ) && version_is_less( version: version, test_version: "5.3.2" )){
