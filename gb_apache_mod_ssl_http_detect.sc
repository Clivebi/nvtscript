if(description){
	...
	script_tag( name: "last_modification", value: "2021-07-19 10:09:41 +0000 (Mon, 19 Jul 2021)" );
...
log_message( data: build_detection_report( app: "Apache mod_ssl", version: version, install: install, cpe: cpe, concludedUrl: conclurl, concluded: concluded ), port: port );
exit( 0 );
