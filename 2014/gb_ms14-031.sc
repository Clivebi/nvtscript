...
if(hotfix_check_sp( winVista: 3, winVistax64: 3, win7: 2, win7x64: 2, win2008: 3, win2008x64: 3, win2008r2: 2, win8: 1, win8x64: 1, win2012: 1, win8_1: 1, win8_1x64: 1 ) <= 0){
	exit( 0 );
}
...
if( hotfix_check_sp( winVista: 3, win2008: 3 ) > 0 ){
	if(version_in_range( version: sysVer, test_version: "6.0.6002.18000", test_version2: "6.0.6002.19079" ) || version_in_range( version: sysVer, test_version: "6.0.6002.23000", test_version2: "6.0.6002.23369" )){
	...
	if( hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0 ){
		if(version_in_range( version: sysVer, test_version: "6.1.7601.18000", test_version2: "6.1.7601.18437" ) || version_in_range( version: sysVer, test_version: "6.1.7601.22000", test_version2: "6.1.7601.22647" )){
			security_message( port: 0, data: "The target host was found to be vulnerable" );
		}
	}
	else {
		if( hotfix_check_sp( win8: 1, win8x64: 1, win2012: 1 ) > 0 ){
			if(version_in_range( version: sysVer, test_version: "6.2.9200.16000", test_version2: "6.2.9200.16885" ) || version_in_range( version: sysVer, test_version: "6.2.9200.20000", test_version2: "6.2.9200.21004" )){
				security_message( port: 0, data: "The target host was found to be vulnerable" );
			}
			exit( 0 );
		}
			...
			if(hotfix_check_sp( win8_1: 1, win8_1x64: 1 ) > 0){
				if(version_in_range( version: sysVer, test_version: "6.3.9600.16000", test_version2: "6.3.9600.16659" ) || version_in_range( version: sysVer, test_version: "6.3.9600.17000", test_version2: "6.3.9600.17087" )){
					security_message( port: 0, data: "The target host was found to be vulnerable" );
				}
				exit( 0 );
			}
