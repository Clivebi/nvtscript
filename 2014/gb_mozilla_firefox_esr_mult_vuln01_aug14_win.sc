...
if(description){
	...
	script_cve_id( "CVE-2014-1547", "CVE-2014-1555", "CVE-2014-1557", "CVE-2014-1551", "CVE-2014-1544", "CVE-2014-1556" );
...
vers = infos["version"];
path = infos["location"];
if(IsMatchRegexp( vers, "^24\\." ) && version_in_range( version: vers, test_version: "24.0", test_version2: "24.6" )){
