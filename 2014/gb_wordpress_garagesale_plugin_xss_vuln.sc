...
url = dir + "/wp-content/plugins/garagesale/templates/printAdminUsersList_Fo" + "oter.tpl.php?page=\"</script><script>alert(document.cookie)</script>";
if(http_vuln_check( port: http_port, url: url, check_header: TRUE, pattern: "<script>alert\\(document.cookie\\)</script>", extra_check: "garagesale-filter" )){
