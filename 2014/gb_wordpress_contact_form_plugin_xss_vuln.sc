...
url = dir + "/wp-content/plugins/contactme/xd_resize.php?width=1'})</s" + "cript><script>alert(document.cookie)</script>&height=0";
if(http_vuln_check( port: http_port, url: url, check_header: TRUE, pattern: "<script>alert\\(document.cookie\\)</script>", extra_check: ">ContactMe<" )){
