...
if(hotfix_check_sp( winVista: 3, win2008: 3 ) > 0){
	if(version_is_less( version: dllVer, test_version: "10.0.6002.19154" ) || version_in_range( version: dllVer, test_version: "10.0.6002.23000", test_version2: "10.0.6002.23458" )){
		security_message( port: 0, data: "The target host was found to be vulnerable" );
	}
	exit( 0 );
}
if(hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0){
	if(version_is_less( version: dllVer, test_version: "10.1.7601.18556" ) || version_in_range( version: dllVer, test_version: "10.1.7601.22000", test_version2: "10.1.7601.22763" )){
		security_message( port: 0, data: "The target host was found to be vulnerable" );
	}
	exit( 0 );
}
