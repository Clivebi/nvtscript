...
url = dir + "/wp-content/plugins/easy-post-types/classes/custom-image/media.php?" + "ref=ref\"</script><script>alert(document.cookie)</script>&#";
if(http_vuln_check( port: http_port, url: url, check_header: TRUE, pattern: "><script>alert\\(document.cookie\\)</script>", extra_check: ">Images Available<" )){
