...
if(hotfix_check_sp( win2003: 3, win2003x64: 3, winVista: 3, winVistax64: 3, win7: 2, win7x64: 2, win2008: 3, win2008x64: 3, win2008r2: 2 ) > 0){
	...
	if( hotfix_check_sp( win2003: 3, win2003x64: 3 ) > 0 ){
		...
		if( hotfix_check_sp( winVista: 3, win2008: 3 ) > 0 ){
			if(version_in_range( version: dllVer, test_version: "1.626.6002.18000", test_version2: "1.626.6002.19095" ) || version_in_range( version: dllVer, test_version: "1.626.6002.23000", test_version2: "1.626.6002.23385" )){
				security_message( port: 0, data: "The target host was found to be vulnerable" );
			}
			exit( 0 );
		}
			...
			if(hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0){
				if(version_in_range( version: dllVer, test_version: "1.626.7601.18000", test_version2: "1.626.7601.18453" ) || version_in_range( version: dllVer, test_version: "1.626.7601.22000", test_version2: "1.626.7601.22665" )){
					security_message( port: 0, data: "The target host was found to be vulnerable" );
				}
				exit( 0 );
			}
...
if(hotfix_check_sp( win8: 1, win8x64: 1, win2012: 1, win8_1: 1, win8_1x64: 1 ) <= 0){
	...
	if( hotfix_check_sp( win8: 1, win2012: 1 ) > 0 ){
		if(version_in_range( version: dllVer2, test_version: "6.2.9200.16000", test_version2: "6.2.9200.16908" ) || version_in_range( version: dllVer2, test_version: "6.2.9200.20000", test_version2: "6.2.9200.21031" )){
			security_message( port: 0, data: "The target host was found to be vulnerable" );
		}
		exit( 0 );
	}
		...
		if(hotfix_check_sp( win8_1: 1, win8_1x64: 1 ) > 0){
			...
			if(version_is_less( version: dllVer2, test_version: "6.3.9600.17111" ) || version_is_less( version: dllVer3, test_version: "6.3.9600.17111" )){
				security_message( port: 0, data: "The target host was found to be vulnerable" );
			}
			exit( 0 );
		}
