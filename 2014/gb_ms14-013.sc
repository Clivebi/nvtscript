...
if( hotfix_check_sp( xp: 4 ) > 0 ){
	...
	if( hotfix_check_sp( win2003: 3, xpx64: 3, win2003x64: 3 ) > 0 ){
		...
		if( hotfix_check_sp( winVista: 3, win2008: 3 ) > 0 ){
			if(version_is_less( version: sysVer, test_version: "6.6.6002.19033" ) || version_in_range( version: sysVer, test_version: "6.6.6002.23000", test_version2: "6.6.6002.23320" )){
				security_message( port: 0, data: "The target host was found to be vulnerable" );
			}
			exit( 0 );
		}
			...
			if( hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0 ){
				if(version_is_less( version: sysVer, test_version: "6.6.7601.18386" ) || version_in_range( version: sysVer, test_version: "6.6.7601.22000", test_version2: "6.6.7601.22589" )){
					security_message( port: 0, data: "The target host was found to be vulnerable" );
				}
				exit( 0 );
			}
				...
				if( hotfix_check_sp( win8: 1, win8x64: 1, win2012: 1 ) > 0 ){
					if(version_is_less( version: sysVer, test_version: "6.6.9200.16812" ) || version_in_range( version: sysVer, test_version: "6.6.9200.20000", test_version2: "6.6.9200.20930" )){
						security_message( port: 0, data: "The target host was found to be vulnerable" );
					}
					exit( 0 );
				}
