...
if(rcvRes && ContainsString( rcvRes, "Enter your ListManager administrator" )){
	...
	if(IsMatchRegexp( rcvRes, "^HTTP/1\\.[01] 200" ) && IsMatchRegexp( rcvRes, "</td><script>alert(document.cookie);</script><td>" ) && ContainsString( rcvRes, "No records were found" )){
		;
	}
	{
