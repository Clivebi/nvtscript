...
url = dir + "/wp-content/plugins/sagepay-direct-for-woocommerce-payment-ga" + "teway/pages/3DComplete.php?MD='><script>alert(document.cookie)</sc" + "ript>&PARes";
if(http_vuln_check( port: http_port, url: url, check_header: TRUE, pattern: "<script>alert\\(document.cookie\\)</script>", extra_check: ">3D-Secure Redirect<" )){
