...
if(IsMatchRegexp( version, "^12" )){
	if( IsMatchRegexp( version, "^12\\.1" ) ){
		if( revcomp( a: version, b: "12.1R8-S3" ) < 0 ){
			security_message( port: 0, data: desc );
			exit( 0 );
		}
		else {
			if( ( revcomp( a: version, b: "12.1X44-D30" ) < 0 ) && ( revcomp( a: version, b: "12.1X" ) >= 0 ) ){
				security_message( port: 0, data: desc );
				exit( 0 );
			}
			else {
				if(( revcomp( a: version, b: "12.1X45-D20" ) < 0 ) && ( revcomp( a: version, b: "12.1X45" ) >= 0 )){
					security_message( port: 0, data: desc );
					exit( 0 );
				}
			}
		...
		if( ( revcomp( a: version, b: "12.2R7" ) < 0 ) && ( revcomp( a: version, b: "12.2" ) >= 0 ) ){
			...
			if(( revcomp( a: version, b: "12.3R5" ) < 0 ) && ( revcomp( a: version, b: "12.3R4-S2" ) != 0 ) && ( revcomp( a: version, b: "12.3" ) >= 0 )){
				security_message( port: 0, data: desc );
				exit( 0 );
			}
		}
