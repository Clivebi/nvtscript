if(description){
	...
	script_cve_id( "CVE-2013-5755", "CVE-2013-5756", "CVE-2013-5757", "CVE-2013-5758", "CVE-2013-5759" );
...
if(!ContainsString( kBanner, "WWW-Authenticate: Basic realm=\"Gigabit Color IP Phone SIP-T38G\"" )){
	exit( 0 );
}
host = http_host_name( port: kPort );
credentials = make_list( "user:user",
	 "admin:admin",
	 "var:var" );
for credential in credentials {
	...
	if(IsMatchRegexp( sipRes, "^HTTP/1\\.[01] 200" ) && ContainsString( sipRes, "<title>IP Phone<" )){
