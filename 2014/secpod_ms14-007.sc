...
if(hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2, win8: 1, win8x64: 1, win2012: 1, win8_1: 1, win8_1x64: 1 ) <= 0){
	exit( 0 );
}
...
if( hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0 ){
	...
	if( hotfix_check_sp( win8: 1, win8x64: 1, win2012: 1 ) > 0 ){
		if(version_is_less( version: sysVer, test_version: "6.2.9200.16765" ) || version_in_range( version: sysVer, test_version: "6.2.9200.20000", test_version2: "6.2.9200.20881" )){
			security_message( port: 0, data: "The target host was found to be vulnerable" );
		}
		exit( 0 );
	}
