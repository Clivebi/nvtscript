...
if( hotfix_check_sp( xp: 4, win2003: 3, xpx64: 3, win2003x64: 3 ) > 0 ){
	...
	if( hotfix_check_sp( winVista: 3, win2008: 3 ) > 0 ){
		...
		if( hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0 ){
			if(version_is_less( version: sysVer, test_version: "8.110.7601.18334" ) || version_in_range( version: sysVer, test_version: "8.110.7601.22000", test_version2: "8.110.7601.22531" )){
				security_message( port: 0, data: "The target host was found to be vulnerable" );
			}
			exit( 0 );
		}
			...
			if( hotfix_check_sp( win8: 1, win8x64: 1, win2012: 1 ) > 0 ){
				if(version_is_less( version: sysVer, test_version: "8.110.9200.16772" ) || version_in_range( version: sysVer, test_version: "8.110.9200.20000", test_version2: "8.110.9200.20889" )){
					security_message( port: 0, data: "The target host was found to be vulnerable" );
				}
				exit( 0 );
			}
