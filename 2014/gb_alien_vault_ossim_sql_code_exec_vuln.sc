...
url = dir + "/geoloc/graph_geoloc.php?date_from=%27%20and%28select%201%20from%28s" + "elect%20count%28*%29,concat%28%28select%20%28select%200x4f70656e5641" + "532d53514c2d496e6a656374696f6e2d54657374%29%20%29%2cfloor%28rand%280" + "%29*2%29%29x%20from%20information_schema.tables%20group%20by%20x%29a" + "%29%20and%20%2703636%27=%2703636";
if(http_vuln_check( port: port, url: url, check_header: TRUE, pattern: "OpenVAS-SQL-Injection-Test", extra_check: "Duplicate entry" )){
