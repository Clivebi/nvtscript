...
if(http_vuln_check( port: http_port, url: url, check_header: TRUE, pattern: "HTTP/1.. 200 OK" )){
	url = dir + "/wp-content/plugins/w3-total-cache/%22%3E%3C" + "script%3Ealert(document.cookie)%3C/script%3E%22";
