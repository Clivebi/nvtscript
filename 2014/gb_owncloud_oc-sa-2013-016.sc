...
if(description){
	...
	script_tag( name: "last_modification", value: "2021-09-22 07:07:26 +0000 (Wed, 22 Sep 2021)" );
...
vers = infos["version"];
path = infos["location"];
if(version_in_range( version: vers, test_version: "4.0.0", test_version2: "4.0.13" ) || version_in_range( version: vers, test_version: "4.5.0", test_version2: "4.5.8" ) || version_in_range( version: vers, test_version: "5.0.0", test_version2: "5.0.3" )){
