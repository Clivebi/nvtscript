...
if(description){
	...
	script_name( "Dropbear SSH < 0.47 Buffer Overflow Vulnerability" );
	...
	script_tag( name: "summary", value: "Dropbear SSH is prone to a buffer overflow vulnerability." );
  ...
  code via unspecified inputs that cause insufficient memory to be allocated." );
	script_tag( name: "affected", value: "Versions prior to Dropbear SSH 0.47 are vulnerable." );
