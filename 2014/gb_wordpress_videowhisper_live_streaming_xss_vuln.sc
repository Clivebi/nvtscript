...
url = dir + "/wp-content/plugins/videowhisper-live-streaming-integration/ls" + "/vv_login.php?room_name=%27%3E%3Cscript%3Ealert(document.cooki" + "e)%3C%2Fscript%3E";
if(http_vuln_check( port: http_port, url: url, check_header: TRUE, pattern: "<script>alert\\(document.cookie\\)</script>", extra_check: "tokenKey=VideoWhisper" )){
