...
if(description){
	...
	script_name( "Dropbear SSH < 0.49 MitM Vulnerability" );
	...
	script_tag( name: "summary", value: "Dropbear SSH is prone to a man-in-the-middle vulnerability." );
	script_tag( name: "vuldetect", value: "Checks if a vulnerable version is present on the target host." );
	script_tag( name: "insight", value: "dbclient in Dropbear SSH before 0.49 does
