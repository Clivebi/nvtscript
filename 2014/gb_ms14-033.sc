...
if(hotfix_check_sp( win2003: 3, win2003x64: 3, winVista: 3, winVistax64: 3, win7: 2, win7x64: 2, win2008: 3, win2008x64: 3, win2008r2: 2, win8: 1, win8x64: 1, win2012: 1, win8_1: 1, win8_1x64: 1 ) <= 0){
	exit( 0 );
}
	...
	if( hotfix_check_sp( win2003: 3, win2003x64: 3 ) > 0 ){
		...
		if( hotfix_check_sp( winVista: 3, win2008: 3 ) > 0 ){
			...
			if( hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0 ){
				if(version_in_range( version: dllVer3, test_version: "8.110.7601.18000", test_version2: "8.110.7601.18430" ) || version_in_range( version: dllVer3, test_version: "8.110.7601.22000", test_version2: "8.110.7601.22639" )){
					security_message( port: 0, data: "The target host was found to be vulnerable" );
				}
				exit( 0 );
			}
				...
				if( hotfix_check_sp( win8x64: 1, win2012: 1 ) > 0 ){
					if(version_in_range( version: dllVer3, test_version: "8.110.9200.16000", test_version2: "8.110.9200.16862" ) || version_in_range( version: dllVer3, test_version: "8.110.9200.20000", test_version2: "8.110.9200.20981" )){
						security_message( port: 0, data: "The target host was found to be vulnerable" );
					}
					exit( 0 );
				}
					...
					if(hotfix_check_sp( win8_1: 1, win8_1x64: 1 ) > 0){
						if(version_in_range( version: dllVer3, test_version: "8.110.9200.16800", test_version2: "8.110.9200.16862" ) || version_in_range( version: dllVer3, test_version: "8.110.9200.20000", test_version2: "8.110.9200.20981" ) || version_in_range( version: dllVer3, test_version: "8.110.9600.16000", test_version2: "8.110.9600.16662" )){
							security_message( port: 0, data: "The target host was found to be vulnerable" );
						}
						exit( 0 );
					}
...
if(dllVer6){
	if( hotfix_check_sp( winVista: 3, win2008: 3 ) > 0 ){
		...
		if( hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0 ){
			if(version_is_less( version: dllVer6, test_version: "6.30.7601.18431" ) || version_in_range( version: dllVer6, test_version: "6.30.7601.22000", test_version2: "6.30.7601.22639" )){
				security_message( port: 0, data: "The target host was found to be vulnerable" );
			}
			exit( 0 );
		}
