...
if(hotfix_check_sp( winVista: 3, win2008: 3 ) > 0){
	if(version_is_less( version: msiVer, test_version: "4.5.6002.19116" ) || version_in_range( version: msiVer, test_version: "4.5.6002.23000", test_version2: "4.5.6002.23414" )){
		security_message( port: 0, data: "The target host was found to be vulnerable" );
	}
	exit( 0 );
}
if(hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0){
	if(version_is_less( version: msiVer, test_version: "5.0.7601.18493" ) || version_in_range( version: msiVer, test_version: "5.0.7601.22000", test_version2: "5.0.7601.22707" )){
		security_message( port: 0, data: "The target host was found to be vulnerable" );
	}
	exit( 0 );
}
if(hotfix_check_sp( win8: 1, win8x64: 1, win2012: 1 ) > 0){
	if(version_is_less( version: msiVer, test_version: "5.0.9200.17022" ) || version_in_range( version: msiVer, test_version: "5.0.9200.21000", test_version2: "5.0.9200.21138" )){
		security_message( port: 0, data: "The target host was found to be vulnerable" );
	}
	exit( 0 );
}
