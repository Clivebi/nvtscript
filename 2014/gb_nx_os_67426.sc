...
if( IsMatchRegexp( nx_model, "^1[0-9][0-9][0-9]([Vv])" ) ){
	...
	if( IsMatchRegexp( nx_model, "^3[0-9][0-9][0-9]" ) ){
		...
		if( IsMatchRegexp( nx_model, "^4[0-9][0-9][0-9]" ) ){
			...
			if( IsMatchRegexp( nx_model, "^5[0-9][0-9][0-9]" ) ){
				...
				if(IsMatchRegexp( nx_model, "^7[0-9][0-9][0-9]" )){
