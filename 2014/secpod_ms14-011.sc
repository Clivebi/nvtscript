...
if( hotfix_check_sp( xp: 4 ) > 0 ){
	if(version_is_less( version: sysVer, test_version: "5.7.6002.23292" ) || ( IsMatchRegexp( ieVer, "^8" ) && version_in_range( version: sysVer, test_version: "5.8", test_version2: "5.8.6001.23551" ) )){
	...
	if( hotfix_check_sp( win2003: 3, xpx64: 3, win2003x64: 3 ) > 0 ){
		if(version_is_less( version: sysVer, test_version: "5.6.0.8852" ) || version_in_range( version: sysVer, test_version: "5.7", test_version2: "5.7.6002.23291" ) || ( IsMatchRegexp( ieVer, "^8" ) && version_in_range( version: sysVer, test_version: "5.8", test_version2: "5.8.6001.23551" ) )){
		...
		if( hotfix_check_sp( winVista: 3, win2008: 3 ) > 0 ){
			if(version_is_less( version: sysVer, test_version: "5.7.6002.19005" ) || version_in_range( version: sysVer, test_version: "5.7.6002.23000", test_version2: "5.7.6002.23291" ) || ( IsMatchRegexp( ieVer, "^8" ) && version_in_range( version: sysVer, test_version: "5.8.6001.19000", test_version2: "5.8.6001.19497" ) ) || ( IsMatchRegexp( ieVer, "^8" ) && version_in_range( version: sysVer, test_version: "5.8.6001.23000", test_version2: "5.8.6001.23551" ) )){
			...
			if( hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2, win8: 1, win8x64: 1, win2012: 1 ) > 0 ){
				if(version_is_less( version: sysVer, test_version: "5.8.7601.18337" ) || version_in_range( version: sysVer, test_version: "5.8.7601.22000", test_version2: "5.8.7601.22534" )){
				...
				if(ieVer && IsMatchRegexp( ieVer, "^10" )){
					if(version_is_less( version: sysVer, test_version: "5.8.9200.16775" ) || version_in_range( version: sysVer, test_version: "5.8.9200.20000", test_version2: "5.8.9200.20900" )){
