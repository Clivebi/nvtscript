...
if(hotfix_check_sp( win2003: 3, win2003x64: 3, winVista: 3, winVistax64: 3, win7: 2, win7x64: 2, win2008: 3, win2008x64: 3, win2008r2: 2, win8: 1, win8x64: 1, win2012: 1, win8_1: 1, win8_1x64: 1, win2012R2: 1 ) <= 0){
	exit( 0 );
}
...
if( hotfix_check_sp( win2003: 3, win2003x64: 3 ) > 0 ){
	...
	if( hotfix_check_sp( winVista: 3, win2008: 3 ) > 0 ){
		if(version_is_less( version: afdSysVer, test_version: "6.0.6002.19115" ) || version_in_range( version: afdSysVer, test_version: "6.6.6002.23000", test_version2: "6.0.6002.23413" )){
			security_message( port: 0, data: "The target host was found to be vulnerable" );
		}
		exit( 0 );
	}
		...
		if( hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0 ){
			if(version_is_less( version: afdSysVer, test_version: "6.1.7601.18489" ) || version_in_range( version: afdSysVer, test_version: "6.6.7601.22000", test_version2: "6.1.7601.22704" )){
				security_message( port: 0, data: "The target host was found to be vulnerable" );
			}
			exit( 0 );
		}
			...
			if( hotfix_check_sp( win8: 1, win8x64: 1, win2012: 1 ) > 0 ){
				if(version_is_less( version: afdSysVer, test_version: "6.2.9200.17014" ) || version_in_range( version: afdSysVer, test_version: "6.6.9200.20000", test_version2: "6.2.9200.21132" )){
					security_message( port: 0, data: "The target host was found to be vulnerable" );
				}
				exit( 0 );
			}
				...
				if(hotfix_check_sp( win8_1: 1, win8_1x64: 1, win2012R2: 1 ) > 0){
					if(version_is_less( version: afdSysVer, test_version: "6.3.9600.16668" ) || version_in_range( version: afdSysVer, test_version: "6.6.9600.17000", test_version2: "6.3.9600.17193" )){
						security_message( port: 0, data: "The target host was found to be vulnerable" );
					}
					exit( 0 );
				}
