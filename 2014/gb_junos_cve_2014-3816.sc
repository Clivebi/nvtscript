			...
			if( ( revcomp( a: version, b: "12.1X45-D30" ) < 0 ) && ( revcomp( a: version, b: "12.1X45" ) >= 0 ) ){
				...
				if( ( revcomp( a: version, b: "12.1X46-D20" ) < 0 ) && ( revcomp( a: version, b: "12.1X46" ) >= 0 ) ){
					...
					if( ( revcomp( a: version, b: "12.1X47-D10" ) < 0 ) && ( revcomp( a: version, b: "12.1X47" ) >= 0 ) ){
						...
						if( ( revcomp( a: version, b: "12.2R8-S2" ) < 0 ) && ( revcomp( a: version, b: "12.2" ) >= 0 ) ){
							security_message( port: 0, data: version );
							exit( 0 );
						}
						else {
...
if(IsMatchRegexp( version, "^13" )){
	if( revcomp( a: version, b: "13.1R4-S2" ) < 0 ){
		...
		if( ( revcomp( a: version, b: "13.2R5" ) < 0 ) && ( revcomp( a: version, b: "13.2" ) >= 0 ) ){
			security_message( port: 0, data: version );
			exit( 0 );
		}
		else {
			if(( revcomp( a: version, b: "13.3R2-S2" ) < 0 ) && ( revcomp( a: version, b: "13.3" ) >= 0 )){
				security_message( port: 0, data: version );
				exit( 0 );
			}
		}
