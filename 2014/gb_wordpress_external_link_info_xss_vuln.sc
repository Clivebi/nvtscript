...
url = dir + "/wp-content/plugins/wp-js-external-link-info/redirect.php" + "?blog=%3Cscript%3Ealert(document.cookie)%3C%2Fscript%3E";
if(http_vuln_check( port: http_port, url: url, check_header: TRUE, pattern: "<script>alert\\(document.cookie\\)</script>", extra_check: make_list( ">here<",
	 "please click" ) )){
