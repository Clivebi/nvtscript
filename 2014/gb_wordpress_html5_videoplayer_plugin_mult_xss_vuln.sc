...
url = dir + "/wp-content/plugins/html5-video-player-with-playlist/videopl" + "ayer/autoplay.php?theme=\"><script>alert(document.cookie)</script>";
if(http_vuln_check( port: http_port, url: url, check_header: TRUE, pattern: "<script>alert\\(document.cookie\\)</script>", extra_check: ">HTML5 VIDEO PLAYER<" )){
