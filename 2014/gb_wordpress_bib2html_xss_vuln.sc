...
url = dir + "/wp-content/plugins/bib2html/OSBiB/create/index.php?" + "action=adminStyleAdd&styleShortName=\"/><script>" + "alert(document.cookie);</script>";
if(http_vuln_check( port: http_port, url: url, check_header: TRUE, pattern: "<script>alert\\(document\\.cookie\\);</script>", extra_check: ">OSBib-Create<" )){
