...
srcaddr = this_host();
a1 = ereg_replace( pattern: "([0-9]*)\\.[0-9]*\\.[0-9]*\\.[0-9]*", string: srcaddr, replace: "\\1" );
a1 = a1 % 255;
a2 = ereg_replace( pattern: "[0-9]*\\.([0-9]*)\\.[0-9]*\\.[0-9]*", string: srcaddr, replace: "\\1" );
a2 = a2 % 255;
a3 = ereg_replace( pattern: "[0-9]*\\.[0-9]*\\.([0-9]*)\\.[0-9]*", string: srcaddr, replace: "\\1" );
a3 = a3 % 255;
a4 = ereg_replace( pattern: "[0-9]*\\.[0-9]*\\.[0-9]*\\.([0-9]*)", string: srcaddr, replace: "\\1" );
a4 = a4 % 255;
dstaddr = get_host_ip();
b1 = ereg_replace( pattern: "([0-9]*)\\.[0-9]*\\.[0-9]*\\.[0-9]*", string: dstaddr, replace: "\\1" );
b1 = b1 % 255;
b2 = ereg_replace( pattern: "[0-9]*\\.([0-9]*)\\.[0-9]*\\.[0-9]*", string: dstaddr, replace: "\\1" );
b2 = b2 % 255;
b3 = ereg_replace( pattern: "[0-9]*\\.[0-9]*\\.([0-9]*)\\.[0-9]*", string: dstaddr, replace: "\\1" );
b3 = b3 % 255;
b4 = ereg_replace( pattern: "[0-9]*\\.[0-9]*\\.[0-9]*\\.([0-9]*)", string: dstaddr, replace: "\\1" );
b4 = b4 % 255;
sendata = raw_string( 0x01, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, a1, a2, a3, a4, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x04, 0x04, b1, b2, b3, b4, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x30, 0x9F, 0x72, 0x6F, 0x6F, 0x74, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x72, 0x6F, 0x6F, 0x74, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 );
send( socket: soc, data: sendata );
result = recv( socket: soc, length: 4096 );
if(result){
	banner = "talkd protocol version: ";
	banner = NASLString( banner, ord( result[0] ) );
