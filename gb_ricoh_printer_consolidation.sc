if(description){
	...
	script_dependencies( "gb_ricoh_printer_snmp_detect.sc", "gb_ricoh_printer_ftp_detect.sc", "gb_ricoh_printer_http_detect.sc", "gb_ricoh_printer_pjl_detect.sc", "global_settings.sc" );
...
if( detected_model != "unknown" ){
	...
	if( detected_fw_version != "unknown" ) {
		os_cpe = build_cpe( value: detected_fw_version, exp: "^([0-9.]+)", base: "cpe:/o:ricoh:" + cpe_model + "_firmware:" );
	}
	else {
...
os_register_and_report( os: os_name, cpe: os_cpe, desc: "RICOH Printer Detection Consolidation", runs_key: "unixoide" );
