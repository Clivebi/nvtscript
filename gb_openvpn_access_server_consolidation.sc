if(description){
	...
	script_dependencies( "gb_openvpn_access_server_ssh_login_detect.sc", "gb_openvpn_access_server_http_detect.sc" );
...
os_register_and_report( os: "Linux", cpe: "cpe:/o:linux:kernel", desc: "OpenVPN Access Server Detection Consolidation", runs_key: "unixoide" );
...
report = build_detection_report( app: "OpenVPN Access Server", version: detected_version, cpe: cpe, install: location );
if(extra){
	report += "\n\nDetection methods:\n";
	report += "\n" + extra;
}
