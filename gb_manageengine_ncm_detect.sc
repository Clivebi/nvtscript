...
if(ContainsString( res, "Configuration Manager" ) && ContainsString( res, "'info'>Network Configuration & Change Management Software" )){
	version = "unknown";
	...
	log_message( data: build_detection_report( app: "ManageEngine Network Configuration Manager", version: version, install: "/", cpe: cpe, concluded: vers[0] ), port: port );
	exit( 0 );
}
exit( 0 );
