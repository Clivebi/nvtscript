...
if(ContainsString( res, "<title>About IP Office" ) && ContainsString( res, "<o:Company>Avaya</o:Company>" )){
	version = "unknown";
	...
	log_message( data: build_detection_report( app: "Avaya IP Office", version: version, install: "/", cpe: cpe, concluded: vers[0] ), port: port );
	exit( 0 );
}
exit( 0 );
