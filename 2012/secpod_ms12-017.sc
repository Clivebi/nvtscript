...
if(hotfix_check_sp( win2008: 3 ) > 0){
	if(version_is_less( version: sysVer, test_version: "6.0.6002.18557" ) || version_in_range( version: sysVer, test_version: "6.0.6002.22000", test_version2: "6.0.6002.22762" )){
		security_message( port: 0, data: "The target host was found to be vulnerable" );
	}
}
