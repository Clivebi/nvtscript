	...
	if(path && ContainsString( path, "\\Microsoft.NET\\Framework" )){
		...
		if(dllVer){
			if(( hotfix_missing( name: "2633870" ) == 1 )){
				if(version_in_range( version: dllVer, test_version: "4.0.30319.000", test_version2: "4.0.30319.257" ) || version_in_range( version: dllVer, test_version: "4.0.30319.500", test_version2: "4.0.30319.522" )){
					security_message( port: 0, data: "The target host was found to be vulnerable" );
					exit( 0 );
				}
			}
			if(( ( hotfix_missing( name: "2633873" ) == 1 ) || ( hotfix_missing( name: "2633879" ) == 1 ) ) && ( hotfix_check_sp( win7: 2 ) > 0 )){
				if(version_in_range( version: dllVer, test_version: "2.0.50727.4000", test_version2: "2.0.50727.4967" ) || version_in_range( version: dllVer, test_version: "2.0.50727.5000", test_version2: "2.0.50727.5452" ) || version_in_range( version: dllVer, test_version: "2.0.50727.5600", test_version2: "2.0.50727.5702" )){
					security_message( port: 0, data: "The target host was found to be vulnerable" );
					exit( 0 );
				}
			}
			if(( hotfix_missing( name: "2633874" ) == 1 ) && ( hotfix_check_sp( winVista: 3, win2008: 3 ) > 0 )){
				if(version_in_range( version: dllVer, test_version: "2.0.50727.4000", test_version2: "2.0.50727.4219" ) || version_in_range( version: dllVer, test_version: "2.0.50727.5600", test_version2: "2.0.50727.5702" )){
					security_message( port: 0, data: "The target host was found to be vulnerable" );
					exit( 0 );
				}
			}
			if(( hotfix_missing( name: "2633880" ) == 1 ) && ( hotfix_check_sp( xp: 4, win2003: 3 ) > 0 )){
				if(version_in_range( version: dllVer, test_version: "2.0.50727.3000", test_version2: "2.0.50727.3630" ) || version_in_range( version: dllVer, test_version: "2.0.50727.5600", test_version2: "2.0.50727.5703" )){
					security_message( port: 0, data: "The target host was found to be vulnerable" );
					exit( 0 );
				}
			}
