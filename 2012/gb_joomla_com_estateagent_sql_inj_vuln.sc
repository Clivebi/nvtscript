...
if(http_vuln_check( port: port, url: url, extra_check: "[j|J]oomla", check_header: TRUE, pattern: "Invalid argument supplied for foreach\\(\\)|You have an error in your SQL syntax;" )){
