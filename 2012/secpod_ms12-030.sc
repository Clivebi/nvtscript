if(description){
	...
	script_cve_id( "CVE-2012-0141", "CVE-2012-0142", "CVE-2012-0143", "CVE-2012-0184", "CVE-2012-0185", "CVE-2012-1847" );
...
if(excelVer && IsMatchRegexp( excelVer, "^1[124]\\.0" )){
	if(version_in_range( version: excelVer, test_version: "11.0", test_version2: "11.0.8345" ) || version_in_range( version: excelVer, test_version: "12.0", test_version2: "12.0.6661.4999" ) || version_in_range( version: excelVer, test_version: "14.0", test_version2: "14.0.6117.5002" )){
	...
	if(path){
		...
		if(graphVer && IsMatchRegexp( graphVer, "^1[24]\\.0" )){
			if(version_in_range( version: graphVer, test_version: "12.0", test_version2: "12.0.6658.5003" ) || version_in_range( version: graphVer, test_version: "14.0", test_version2: "14.0.6117.5002" )){
...
if(excelviewVer && IsMatchRegexp( excelviewVer, "^12\\.0" )){
...
if(cmptPckVer && IsMatchRegexp( cmptPckVer, "^12\\.0" )){
