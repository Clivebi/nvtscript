...
if(description){
	...
	script_cve_id( "CVE-2012-0751", "CVE-2012-0752", "CVE-2012-0753", "CVE-2012-0754", "CVE-2012-0757", "CVE-2012-0756", "CVE-2012-0767" );
...
vers = infos["version"];
path = infos["location"];
if(version_is_less( version: vers, test_version: "10.3.183.15" ) || version_in_range( version: vers, test_version: "11.0", test_version2: "11.1.102.55" )){
