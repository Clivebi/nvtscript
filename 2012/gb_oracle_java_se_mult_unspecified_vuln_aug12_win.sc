if(description){
	...
	script_cve_id( "CVE-2012-1718", "CVE-2012-1711", "CVE-2012-1713", "CVE-2012-1719", "CVE-2012-1720", "CVE-2012-1723" );
...
if(jreVer){
	if(version_is_less_equal( version: jreVer, test_version: "1.4.2.37" ) || version_in_range( version: jreVer, test_version: "1.7", test_version2: "1.7.0.4" ) || version_in_range( version: jreVer, test_version: "1.6", test_version2: "1.6.0.32" ) || version_in_range( version: jreVer, test_version: "1.5", test_version2: "1.5.0.35" )){
