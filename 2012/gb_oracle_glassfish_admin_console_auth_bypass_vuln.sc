...
req = NASLString( "TRACE /common/security/realms/manageUserNew.jsf" + "?name=admin-realm&configName=server-config&bare" + "=true HTTP/1.1\\r\\n", "Host: ", host, "\\r\\n\\r\\n" );
res = http_keepalive_send_recv( port: port, data: req );
if(ContainsString( res, "ConfirmPassword" ) && ContainsString( res, "newPasswordProp:NewPassword" ) && !ContainsString( res, "405 TRACE method is not allowed" )){
