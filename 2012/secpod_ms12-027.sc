...
if(registry_key_exists( key: key )){
	...
	if(ContainsString( bizName, "Microsoft BizTalk Server 2002" )){
		if(version_is_less( version: sysVer, test_version: "6.1.98.33" )){
			security_message( port: 0, data: "The target host was found to be vulnerable" );
			exit( 0 );
		}
...
keys = make_list( "SOFTWARE\\Microsoft\\Commerce Server",
	 ...
	 "SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Uninstall" + "\\Microsoft Commerce Server 2009" );
for key in keys {
	if(registry_key_exists( key: key )){
		if(version_is_less( version: sysVer, test_version: "6.1.98.33" )){
			security_message( port: 0, data: "The target host was found to be vulnerable" );
...
if(registry_key_exists( key: key )){
	...
	if(exeVer){
		if(version_is_less( version: exeVer, test_version: "2000.80.2065.0" ) || version_in_range( version: exeVer, test_version: "2000.80.2300.0", test_version2: "2000.80.2300.9" )){
			security_message( port: 0, data: "The target host was found to be vulnerable" );
			exit( 0 );
		}
	}
