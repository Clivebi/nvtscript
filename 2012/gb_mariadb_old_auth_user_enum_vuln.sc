...
if(description){
	...
	script_tag( name: "last_modification", value: "2021-02-10 15:50:32 +0000 (Wed, 10 Feb 2021)" );
...
vers = infos["version"];
path = infos["location"];
if( IsMatchRegexp( vers, "^5\\.5\\." ) && version_is_less( version: vers, test_version: "5.5.29" ) ) {
	fix = "5.5.29";
}
else {
	if( IsMatchRegexp( vers, "^5\\.3\\." ) && version_is_less( version: vers, test_version: "5.3.12" ) ) {
		fix = "5.3.12";
	}
	else {
		if(IsMatchRegexp( vers, "^5\\.2\\." ) && version_is_less( version: vers, test_version: "5.2.14" )){
			fix = "5.2.14";
		}
	}
}
