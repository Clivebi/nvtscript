...
if(dllv4 && ( version_in_range( version: dllv4, test_version: "4.0.30319.000", test_version2: "4.0.30319.277" ) || version_in_range( version: dllv4, test_version: "4.0.30319.500", test_version2: "4.0.30319.559" ) )){
	security_message( port: 0, data: "The target host was found to be vulnerable" );
	exit( 0 );
}
if(dllv2 && ( hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0 )){
	if(version_in_range( version: dllv2, test_version: "2.0.50727.0000", test_version2: "2.0.50727.4976" ) || version_in_range( version: dllv2, test_version: "2.0.50727.5700", test_version2: "2.0.50727.5723" ) || version_in_range( version: dllv2, test_version: "2.0.50727.5400", test_version2: "2.0.50727.5459" )){
		security_message( port: 0, data: "The target host was found to be vulnerable" );
		exit( 0 );
	}
}
if(dllv2 && ( hotfix_check_sp( winVista: 3, win2008: 3 ) > 0 )){
	if(version_in_range( version: dllv2, test_version: "2.0.50727.0000", test_version2: "2.0.50727.4227" ) || version_in_range( version: dllv2, test_version: "2.0.50727.5000", test_version2: "2.0.50727.5723" )){
		security_message( port: 0, data: "The target host was found to be vulnerable" );
		exit( 0 );
	}
}
if(dllv2 && ( hotfix_check_sp( xp: 4, xpx64: 3, win2003: 3, win2003x64: 3 ) > 0 )){
	if(version_in_range( version: dllv2, test_version: "2.0.50727.0000", test_version2: "2.0.50727.3636" ) || version_in_range( version: dllv2, test_version: "2.0.50727.5000", test_version2: "2.0.50727.5723" )){
		security_message( port: 0, data: "The target host was found to be vulnerable" );
		exit( 0 );
	}
}
if(dllv4 && ( hotfix_check_sp( win7: 2, win2008: 3, win7x64: 2, win2008r2: 2 ) > 0 )){
	if(version_in_range( version: dllv4, test_version: "4.0.30319.17000", test_version2: "4.0.30319.17450" ) || version_in_range( version: dllv4, test_version: "4.0.30319.17500", test_version2: "4.0.30319.17542" )){
		security_message( port: 0, data: "The target host was found to be vulnerable" );
		exit( 0 );
	}
}
