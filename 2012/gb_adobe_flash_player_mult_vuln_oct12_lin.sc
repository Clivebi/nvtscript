...
if(vers && ContainsString( vers, "," )){
	vers = ereg_replace( pattern: ",", string: vers, replace: "." );
}
if(vers){
	if(version_is_less( version: vers, test_version: "10.3.183.29" ) || version_in_range( version: vers, test_version: "11.0", test_version2: "11.2.202.238" )){
