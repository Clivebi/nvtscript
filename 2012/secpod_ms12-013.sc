...
if( hotfix_check_sp( winVista: 3, win2008: 3 ) > 0 ){
	if(version_is_less( version: dllVer, test_version: "7.0.6002.18551" ) || version_in_range( version: dllVer, test_version: "7.0.6002.22000", test_version2: "7.0.6002.22754" )){
	...
	if(hotfix_check_sp( win7: 2 ) > 0){
		if(version_is_less( version: dllVer, test_version: "7.0.7600.16930" ) || version_in_range( version: dllVer, test_version: "7.0.7600.20000", test_version2: "7.0.7600.21107" ) || version_in_range( version: dllVer, test_version: "7.0.7601.17000", test_version2: "7.0.7601.17743" ) || version_in_range( version: dllVer, test_version: "7.0.7601.21000", test_version2: "7.0.7601.21877" )){
			security_message( port: 0, data: "The target host was found to be vulnerable" );
		}
	}
}
