...
if(!IsMatchRegexp( res, "^\xeb\0x90\xeb\x90\xeb\x90*" )){
	close( soc );
	exit( 0 );
}
header = raw_string( 0xeb, 0x90, 0xeb, 0x90, 0xeb, 0x90, 0xa3, 0xa3, 0xa3, 0xa3, 0x38, 0x5c, 0x5c, 0x5c, 0x55, 0x8b, 0xcc, 0xb7 );
