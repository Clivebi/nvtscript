if(description){
	...
	script_cve_id( "CVE-2012-0467", "CVE-2012-0469", "CVE-2012-0468", "CVE-2012-0470", "CVE-2012-0471", "CVE-2012-0472", "CVE-2012-0474", "CVE-2012-0477", "CVE-2012-0478", "CVE-2012-0479" );
	script_bugtraq_id( 53223, 53220, 53221, 53225, 53219, 53218, 53228, 53229, 53227, 53224 );
...
if(vers){
	if(version_in_range( version: vers, test_version: "4.0", test_version2: "10.0.3" ) || version_is_equal( version: vers, test_version: "11.0" )){
...
if(vers){
	if(version_in_range( version: vers, test_version: "5.0", test_version2: "10.0.3" ) || version_is_equal( version: vers, test_version: "11.0" )){
		security_message( port: 0, data: "The target host was found to be vulnerable" );
	}
}
