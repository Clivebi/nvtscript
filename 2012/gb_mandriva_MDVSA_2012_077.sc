if(description){
	...
	script_cve_id( "CVE-2010-4167", "CVE-2012-0247", "CVE-2012-0248", "CVE-2012-1185", "CVE-2012-0259", "CVE-2012-0260", "CVE-2012-1798" );
  ...
  package(s) announced via the referenced advisory." );
	...
	script_mandatory_keys( "ssh/login/mandriva_mandrake_linux", "ssh/login/release",  "ssh/login/release=MNDK_(mes5\\.2|2010\\.1)" );
