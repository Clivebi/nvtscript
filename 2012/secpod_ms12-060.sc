...
if(registry_key_exists( key: key )){
	...
	if(exeVer){
		if(version_is_less( version: exeVer, test_version: "2000.80.2066.0" ) || version_in_range( version: exeVer, test_version: "2000.80.2300.0", test_version2: "2000.80.2304.0" )){
			security_message( port: 0, data: "The target host was found to be vulnerable" );
			exit( 0 );
		}
	}
...
if(registry_key_exists( key: key )){
	...
	if(ContainsString( prdName, "Microsoft Host Integration Server 2004" )){
