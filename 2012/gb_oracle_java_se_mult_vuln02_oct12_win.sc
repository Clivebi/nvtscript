if(description){
	...
	script_cve_id( "CVE-2012-5085", "CVE-2012-5084", "CVE-2012-5073", "CVE-2012-5077", "CVE-2012-5079", "CVE-2012-5081", "CVE-2012-5083" );
...
if(jreVer){
	if(version_is_less_equal( version: jreVer, test_version: "1.4.2.38" ) || version_in_range( version: jreVer, test_version: "1.7", test_version2: "1.7.0.7" ) || version_in_range( version: jreVer, test_version: "1.6", test_version2: "1.6.0.35" ) || version_in_range( version: jreVer, test_version: "1.5", test_version2: "1.5.0.36" )){
