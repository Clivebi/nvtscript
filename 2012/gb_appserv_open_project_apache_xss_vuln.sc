...
if(description){
	...
	script_dependencies( "gb_appserv_open_project_detect.sc" );
...
if(http_vuln_check( port: port, url: url, check_header: TRUE, pattern: "><script>alert\\(document.cookie\\)</script>", extra_check: "AppServ Open Project" )){
