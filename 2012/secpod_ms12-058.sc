...
for version in make_list( "Microsoft Exchange v14",
	...
	if(exchangePath){
		...
		if(exeVer){
			if(version_is_less( version: exeVer, test_version: "8.3.279.4" ) || version_in_range( version: exeVer, test_version: "14.1", test_version2: "14.1.421.1" ) || version_in_range( version: exeVer, test_version: "14.2", test_version2: "14.2.318.3" )){
