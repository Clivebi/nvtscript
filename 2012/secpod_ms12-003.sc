if(description){
	...
	script_dependencies( "secpod_reg_enum.sc", "gb_wmi_access.sc" );
...
if(ContainsString( windows_info, "Locale = 0404" ) || ContainsString( windows_info, "Locale = 0804" ) || ContainsString( windows_info, "Locale = 0C04" ) || ContainsString( windows_info, "Locale = 1004" ) || ContainsString( windows_info, "Locale = 1404" ) || ContainsString( windows_info, "Locale = 0411" ) || ContainsString( windows_info, "Locale = 0412" )){
		...
		if( hotfix_check_sp( xp: 4 ) > 0 ){
			...
			if( hotfix_check_sp( win2003: 3 ) > 0 ){
				...
				if(hotfix_check_sp( winVista: 3, win2008: 3 ) > 0){
					if(version_in_range( version: sysVer, test_version: "6.0.6002.18000", test_version2: "6.0.6002.18544" ) || version_in_range( version: sysVer, test_version: "6.0.6002.22000", test_version2: "6.0.6002.22746" )){
						security_message( port: 0 );
						exit( 0 );
					}
				}
