...
if(IsMatchRegexp( excelVer, "^1[124]\\." )){
	if(version_in_range( version: excelVer, test_version: "11.0", test_version2: "11.0.8346" ) || version_in_range( version: excelVer, test_version: "12.0", test_version2: "12.0.6665.5002" ) || version_in_range( version: excelVer, test_version: "14.0", test_version2: "14.0.6126.5002" )){
		security_message( port: 0, data: "The target host was found to be vulnerable" );
		exit( 0 );
	}
}
excelviewVer = get_kb_item( "SMB/Office/XLView/Version" );
if(excelviewVer && IsMatchRegexp( excelviewVer, "^12\\." )){
...
if(cmptPckVer && IsMatchRegexp( cmptPckVer, "^1[24]\\." )){
	xlcnvVer = get_kb_item( "SMB/Office/XLCnv/Version" );
	if(xlcnvVer && IsMatchRegexp( xlcnvVer, "^1[24]\\." )){
		if(version_in_range( version: xlcnvVer, test_version: "12.0", test_version2: "12.0.6665.5002" ) || version_in_range( version: xlcnvVer, test_version: "14.0", test_version2: "14.0.6126.5002" )){
			security_message( port: 0, data: "The target host was found to be vulnerable" );
		}
	}
}
