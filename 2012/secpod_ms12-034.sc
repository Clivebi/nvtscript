if(description){
	...
	script_bugtraq_id( 50462, 53324, 53326, 53327, 53335, 53347, 53351, 53358, 53360, 53363 );
	script_cve_id( "CVE-2011-3402", "CVE-2012-0159", "CVE-2012-0162", "CVE-2012-0164", "CVE-2012-0165", "CVE-2012-0167", "CVE-2012-0176", "CVE-2012-0180", "CVE-2012-0181", "CVE-2012-1848" );
	...
	script_dependencies( "smb_reg_service_pack.sc", "gb_ms_silverlight_detect.sc", "secpod_office_products_version_900032.sc" );
...
if(infos = get_app_version_and_location( cpe: "cpe:/a:microsoft:silverlight", exit_no_version: FALSE )){
	...
	if(mslVers){
		if(version_is_less( version: mslVers, test_version: "4.1.10329" ) || version_in_range( version: mslVers, test_version: "5.0", test_version2: "5.1.10410" )){
...
if(dllv4 && ( version_in_range( version: dllv4, test_version: "4.0.30319.000", test_version2: "4.0.30319.274" ) || version_in_range( version: dllv4, test_version: "4.0.30319.500", test_version2: "4.0.30319.549" ) )){
...
if(dllv3 && ( hotfix_check_sp( xp: 4, xpx64: 3, win2003: 3, win2003x64: 3 ) > 0 )){
	if(version_in_range( version: dllv3, test_version: "3.0.6920.4000", test_version2: "3.0.6920.4020" ) || version_in_range( version: dllv3, test_version: "3.0.6920.5000", test_version2: "3.0.6920.5809" )){
		security_message( port: 0, data: "The target host was found to be vulnerable" );
		exit( 0 );
	}
}
if(dllv3 && ( hotfix_check_sp( winVista: 3, win2008: 3 ) > 0 )){
	if(version_in_range( version: dllv3, test_version: "3.0.6920.4000", test_version2: "3.0.6920.4212" ) || version_in_range( version: dllv3, test_version: "3.0.6920.5000", test_version2: "3.0.6920.5793" )){
		security_message( port: 0, data: "The target host was found to be vulnerable" );
		exit( 0 );
	}
}
if(dllv3 && ( hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0 )){
	if(version_in_range( version: dllv3, test_version: "3.0.6920.4000", test_version2: "3.0.6920.5004" ) || version_in_range( version: dllv3, test_version: "3.0.6920.5800", test_version2: "3.0.6920.5808" ) || version_in_range( version: dllv3, test_version: "3.0.6920.5400", test_version2: "3.0.6920.5447" ) || version_in_range( version: dllv3, test_version: "3.0.6920.5700", test_version2: "3.0.6920.5793" )){
		security_message( port: 0, data: "The target host was found to be vulnerable" );
		exit( 0 );
	}
}
...
if(officeVer && IsMatchRegexp( officeVer, "^1[24]\\." )){
	...
	if(path){
		for ver in make_list( "OFFICE12",
			...
			if(dllVer && ( version_in_range( version: dllVer, test_version: "14.0", test_version2: "14.0.6117.5000" ) || version_in_range( version: dllVer, test_version: "12.0", test_version2: "12.0.6659.4999" ) )){
				security_message( port: 0, data: "The target host was found to be vulnerable" );
				exit( 0 );
			}
		}
	...
	if( hotfix_check_sp( xp: 4 ) > 0 ){
		...
		if( hotfix_check_sp( win2003: 3, xpx64: 3, win2003x64: 3 ) > 0 ){
			...
			if( hotfix_check_sp( winVista: 3, win2008: 3 ) > 0 ){
				if(version_is_less( version: sysVer, test_version: "6.0.6002.18607" ) || version_in_range( version: sysVer, test_version: "6.0.6002.22000", test_version2: "6.0.6002.22830" )){
					security_message( port: 0, data: "The target host was found to be vulnerable" );
					exit( 0 );
				}
			}
				...
				if(hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0){
					if(version_is_less( version: sysVer, test_version: "6.1.7600.16988" ) || version_in_range( version: sysVer, test_version: "6.1.7600.20000", test_version2: "6.1.7600.21178" ) || version_in_range( version: sysVer, test_version: "6.1.7601.17000", test_version2: "6.1.7601.17802" ) || version_in_range( version: sysVer, test_version: "6.1.7601.21000", test_version2: "6.1.7601.21954" )){
						security_message( port: 0, data: "The target host was found to be vulnerable" );
						exit( 0 );
					}
				}
...
if(dllVer){
	if( hotfix_check_sp( winVista: 3, win2008: 3 ) > 0 ){
		if(version_is_less( version: dllVer, test_version: "7.0.6002.18592" ) || version_in_range( version: dllVer, test_version: "7.0.6002.22000", test_version2: "7.0.6002.22806" )){
			security_message( port: 0, data: "The target host was found to be vulnerable" );
			exit( 0 );
		}
	}
		...
		if(hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0){
			if(version_is_less( version: dllVer, test_version: "6.1.7600.16972" ) || version_in_range( version: dllVer, test_version: "6.1.7600.20000", test_version2: "6.1.7600.21161" ) || version_in_range( version: dllVer, test_version: "6.1.7601.17000", test_version2: "6.1.7601.17788" ) || version_in_range( version: dllVer, test_version: "6.1.7601.21000", test_version2: "6.1.7601.21934" )){
				security_message( port: 0, data: "The target host was found to be vulnerable" );
				exit( 0 );
			}
		}
