...
if(description){
	...
	script_dependencies( "gb_hp_inode_mgmt_center_detect.sc" );
...
if(imcPath && !ContainsString( imcPath, "Could not find the install Location" )){
	...
	if(get_file_size( share: share, file: file + "\\\\iNodeMngChecker.exe" )){
		...
		if(imcVer && version_in_range( version: imcVer, test_version: "5.00", test_version2: "5.10.0303" )){
