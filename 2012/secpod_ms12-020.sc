	...
	if( hotfix_check_sp( xp: 4 ) > 0 ){
		...
		if( hotfix_check_sp( win2003: 3 ) > 0 ){
			...
			if(hotfix_check_sp( winVista: 3, win2008: 3 ) > 0){
				if(version_is_less( version: rdpVer1, test_version: "6.0.6002.18568" ) || version_in_range( version: rdpVer1, test_version: "6.0.6002.22000", test_version2: "6.0.6002.22773" )){
					security_message( port: 0, data: "The target host was found to be vulnerable" );
				}
				exit( 0 );
			}
...
if(hotfix_check_sp( win7: 2 ) > 0){
	if(rdpVer1){
		if(version_is_less( version: rdpVer1, test_version: "6.1.7600.16963" ) || version_in_range( version: rdpVer1, test_version: "6.1.7600.20000", test_version2: "6.1.7600.21150" ) || version_in_range( version: rdpVer1, test_version: "6.1.7601.17000", test_version2: "6.1.7601.17778" ) || version_in_range( version: rdpVer1, test_version: "6.1.7601.21000", test_version2: "6.1.7601.21923" )){
			security_message( port: 0, data: "The target host was found to be vulnerable" );
		}
	}
	if(rdpVer2){
		if(version_is_less( version: rdpVer2, test_version: "6.1.7600.17009" ) || version_in_range( version: rdpVer2, test_version: "6.1.7600.20000", test_version2: "6.1.7600.21199" ) || version_in_range( version: rdpVer2, test_version: "6.1.7601.17000", test_version2: "6.1.7601.17827" ) || version_in_range( version: rdpVer2, test_version: "6.1.7601.21000", test_version2: "6.1.7601.21979" )){
			security_message( port: 0, data: "The target host was found to be vulnerable" );
		}
	}
}
