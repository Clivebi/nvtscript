...
url = dir + "/doku.php?do=edit&id=S9F8W2A&target=<script>alert" + "(document.cookie);</script>";
if(http_vuln_check( port: port, url: url, pattern: "<script>alert\\(document.cookie\\);</script>", check_header: TRUE, extra_check: "content=\"DokuWiki\"/>" )){
