...
if(IsMatchRegexp( buf, "X-Puppet-Version\\s*:" )){
	...
	register_and_report_cpe( app: "Puppet", ver: version, concluded: ver[0], base: CPE, expr: "([0-9.]+)", insloc: port + "/tcp", regPort: port, regService: "www" );
}
exit( 0 );
