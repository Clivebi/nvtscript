...
if(ContainsString( res, "SoftNAS Login</title>" ) && ContainsString( res, "SoftNAS StorageCenter" )){
	install = "/softnas";
	version = "unknown";
	...
	log_message( data: build_detection_report( app: "SoftNAS Cloud", version: version, install: install, cpe: cpe ), port: port );
}
exit( 0 );
