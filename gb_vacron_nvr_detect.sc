...
if(ContainsString( res, "<title>VACRON NVR LOGIN</title>" ) && ContainsString( res, "<strong>ADVANCES IN SECURITY SOLUTION</strong>" )){
	version = "unknown";
	...
	log_message( data: build_detection_report( app: "Vacron NVR IP Surveillance", version: version, install: "/", cpe: cpe ), port: port );
}
exit( 0 );
