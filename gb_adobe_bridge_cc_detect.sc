...
if(appPath && ( ContainsString( appPath, "Adobe Bridge CC" ) || IsMatchRegexp( appPath, "Adobe Bridge ([0-9]+)" ) )){
...
if(!isnull( brdVer )){
	...
	log_message( data: build_detection_report( app: "Adobe Bridge CC", version: brdVer, install: appPath, cpe: cpe, concluded: brdVer ) );
}
