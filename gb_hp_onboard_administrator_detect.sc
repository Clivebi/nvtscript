...
if(!IsMatchRegexp( buf, "<PN>.*Onboard Administrator.*</PN>" ) || !ContainsString( buf, "<FWRI>" )){
	exit( 0 );
}
version = "unknown";
...
report = build_detection_report( app: "HP/HPE Onboard Administrator", version: version, install: "/", cpe: app_cpe, concluded: vers[0], concludedUrl: http_report_vuln_url( port: port, url: url, url_only: TRUE ) );
report += "\n\n";
