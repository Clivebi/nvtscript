...
if(ContainsString( res, "<title>Tracer SC</title>" ) && ContainsString( res, "setCookie(\"cookiecheck\", \"TracerSC\"" )){
	version = "unknown";
	...
	log_message( data: build_detection_report( app: "Trane Tracer SC", version: version, install: "/", cpe: cpe, concluded: vers[0], concludedUrl: concUrl ), port: port );
	exit( 0 );
}
exit( 0 );
