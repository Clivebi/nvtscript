if(description){
	...
	script_cve_id( "CVE-2017-0072", "CVE-2017-0083", "CVE-2017-0084", "CVE-2017-0085", "CVE-2017-0086", "CVE-2017-0087", "CVE-2017-0088", "CVE-2017-0089", "CVE-2017-0090", "CVE-2017-0091", "CVE-2017-0092", "CVE-2017-0111", "CVE-2017-0112", "CVE-2017-0113", "CVE-2017-0114", "CVE-2017-0115", "CVE-2017-0116", "CVE-2017-0117", "CVE-2017-0118", "CVE-2017-0119", "CVE-2017-0120", "CVE-2017-0121", "CVE-2017-0122", "CVE-2017-0123", "CVE-2017-0124", "CVE-2017-0125", "CVE-2017-0126", "CVE-2017-0127", "CVE-2017-0128" );
	script_bugtraq_id( 96599, 96608, 96610, 96652, 96603, 96604, 96605, 96606, 96607, 96657, 96676, 96658, 96659, 96660, 96661, 96663, 96665, 96679, 96680, 96666, 96667, 96678, 96668, 96669, 96670, 96672, 96673, 96674, 96675 );
...
if( hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0 && usrVer ){
	...
	if( hotfix_check_sp( winVista: 3, winVistax64: 3, win2008: 3, win2008x64: 3 ) > 0 && usrVer ){
		if( version_is_less( version: usrVer, test_version: "1.626.6002.19743" ) ){
			Vulnerable_range1 = "Less than 1.626.6002.19743";
			VULN1 = TRUE;
		}
		else {
			if(version_in_range( version: usrVer, test_version: "1.626.6002.24000", test_version2: "1.626.6002.24066" )){
		...
		if( hotfix_check_sp( win2012: 1 ) > 0 && mshVer ){
			...
			if( hotfix_check_sp( win8_1: 1, win8_1x64: 1, win2012R2: 1 ) > 0 ){
				...
				if(hotfix_check_sp( win10: 1, win10x64: 1, win2016: 1 ) > 0 && mshVer){
					if( version_is_less( version: mshVer, test_version: "11.0.10240.17319" ) ){
						Vulnerable_range = "Less than 11.0.10240.17319";
						VULN = TRUE;
					}
					else {
						if( version_in_range( version: mshVer, test_version: "11.0.10586.0", test_version2: "11.0.10586.838" ) ){
							Vulnerable_range = "11.0.10586.0 - 11.0.10586.838";
							VULN = TRUE;
						}
						else {
							if(version_in_range( version: mshVer, test_version: "11.0.14393.0", test_version2: "11.0.14393.952" )){
