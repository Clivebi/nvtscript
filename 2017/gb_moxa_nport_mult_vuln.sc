...
if(description){
	...
	script_cve_id( "CVE-2016-9361", "CVE-2016-9369", "CVE-2016-9363", "CVE-2016-9371", "CVE-2016-9365", "CVE-2016-9366", "CVE-2016-9348", "CVE-2016-9367" );
	...
	script_dependencies( "gb_moxa_nport_consolidation.sc" );
...
cpe = infos["cpe"];
if(!IsMatchRegexp( cpe, "^cpe:/o:moxa:nport_5[1246]" )){
	exit( 0 );
}
if(!version = get_app_version( cpe: cpe, nofork: TRUE )){
	exit( 0 );
}
if(IsMatchRegexp( cpe, "^cpe:/o:moxa:nport_5110" )){
...
if(IsMatchRegexp( cpe, "^cpe:/o:moxa:nport_51[35]0" )){
...
if(IsMatchRegexp( cpe, "^cpe:/o:moxa:nport_52[0-9]{2}_firmware" )){
...
if(IsMatchRegexp( cpe, "^cpe:/o:moxa:nport_54[0-9]{2}_firmware" )){
...
if(IsMatchRegexp( cpe, "^cpe:/o:moxa:nport_56[0-9]{2}" )){
...
if(IsMatchRegexp( cpe, "^cpe:/o:moxa:nport_5[12][0-9]{2}a_firmware" ) || IsMatchRegexp( cpe, "^cpe:/o:moxa:nport_5600-8-dtl" )){
...
if(IsMatchRegexp( cpe, "^cpe:/o:moxa:nport_5(1|2|4)50ai-m12" )){
...
if(IsMatchRegexp( cpe, "^cpe:/o:moxa:nport_5600-8-dt" )){
...
if(IsMatchRegexp( cpe, "^cpe:/o:moxa:nport_5600-8-dtl" )){
	if(version_is_less( version: version, test_version: "1.4" )){
		report = report_fixed_ver( installed_version: version, fixed_version: "1.4" );
		security_message( port: 0, data: report );
	}
...
if(IsMatchRegexp( cpe, "^cpe:/o:moxa:nport_6.50" )){
...
if(IsMatchRegexp( cpe, "^cpe:/o:moxa:nport_5450a" )){
	if(version_is_less( version: version, test_version: "1.4" )){
		report = report_fixed_ver( installed_version: version, fixed_version: "1.4" );
		security_message( port: 0, data: report );
	}
