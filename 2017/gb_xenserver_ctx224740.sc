...
if(description){
	...
	script_cve_id( "CVE-2017-10911", "CVE-2017-10912", "CVE-2017-10913", "CVE-2017-10914", "CVE-2017-10915", "CVE-2017-10917", "CVE-2017-10918", "CVE-2017-10920", "CVE-2017-10921", "CVE-2017-10922" );
...
patches = make_array();
patches["7.2.0"] = make_list( "XS72E001",
	 "XS72E002" );
patches["7.1.0"] = make_list( "XS71E011",
	 "XS71E012" );
patches["7.0.0"] = make_list( "XS70E035",
	 "XS70E036" );
patches["6.5.0"] = make_list( "XS65ESP1057",
	 "XS65ESP1058" );
patches["6.2.0"] = make_list( "XS62ESP1061",
	 "XS62ESP1062" );
patches["6.0.2"] = make_list( "XS602ECC045",
	 "XS602ECC046" );
