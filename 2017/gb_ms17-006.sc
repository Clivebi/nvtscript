...
if(description){
	...
	script_cve_id( "CVE-2017-0008", "CVE-2017-0009", "CVE-2017-0012", "CVE-2017-0018", "CVE-2017-0033", "CVE-2017-0037", "CVE-2017-0040", "CVE-2017-0049", "CVE-2017-0059", "CVE-2017-0130", "CVE-2017-0149", "CVE-2017-0154" );
...
if(hotfix_check_sp( winVista: 3, winVistax64: 3, win2008: 3, win2008x64: 3, win2012: 1, win7: 2, win7x64: 2, win2008r2: 2, win2012R2: 1, win8_1: 1, win8_1x64: 1, win10: 1, win10x64: 1, win2016: 1 ) <= 0){
	exit( 0 );
}
...
if( hotfix_check_sp( winVista: 3, win2008: 3, winVistax64: 3, win2008x64: 3 ) > 0 ){
	if( version_in_range( version: iedllVer, test_version: "9.0.8112.16000", test_version2: "9.0.8112.16870" ) && iedllVer ){
		...
		if( version_in_range( version: iedllVer, test_version: "9.0.8112.20000", test_version2: "9.0.8112.20984" ) && iedllVer ){
			Vulnerable_range = "9.0.8112.20000 - 9.0.8112.20984";
			VULN = TRUE;
		}
		else {
			if( version_is_less( version: oleVer, test_version: "6.0.6002.19728" ) && oleVer ){
				Vulnerable_range = "Less than 6.0.6002.19728";
				VULN1 = TRUE;
			}
			else {
				if(version_in_range( version: oleVer, test_version: "6.0.6002.23000", test_version2: "6.0.6002.24051" ) && oleVer){
	...
	if(hotfix_check_sp( win2012: 1 ) > 0 && iedllVer){
...
if( hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2, win8_1: 1, win8_1x64: 1, win2012R2: 1 ) > 0 && iedllVer ){
	...
	if(hotfix_check_sp( win10: 1, win10x64: 1, win2016: 1 ) > 0 && edgeVer){
