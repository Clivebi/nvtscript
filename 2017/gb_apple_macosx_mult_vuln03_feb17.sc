if(description){
	...
	script_cve_id( "CVE-2016-7584", "CVE-2016-4678", "CVE-2016-4667", "CVE-2016-4674", "CVE-2016-7579", "CVE-2016-4673", "CVE-2016-7577", "CVE-2016-4660", "CVE-2016-4688", "CVE-2016-4721", "CVE-2016-4669", "CVE-2016-7613", "CVE-2016-4679", "CVE-2016-4675", "CVE-2016-4661", "CVE-2016-4670", "CVE-2016-4780" );
...
if(!osVer || !IsMatchRegexp( osVer, "^10\\.1[0-2]" )){
	exit( 0 );
}
if( IsMatchRegexp( osVer, "^10\\.1[01]" ) ){
	if( version_in_range( version: osVer, test_version: "10.10", test_version2: "10.11.5" ) || version_in_range( version: osVer, test_version: "10.11", test_version2: "10.10.4" ) ){
		...
		if(osVer == "10.11.6" || osVer == "10.10.5"){
			...
			if(buildVer){
				if(( osVer == "10.11.6" && version_is_less( version: buildVer, test_version: "15G1108" ) ) || ( osVer == "10.10.5" && version_is_less( version: buildVer, test_version: "14F2009" ) )){
	...
	if(IsMatchRegexp( osVer, "^10\\." ) && version_is_less( version: osVer, test_version: "10.12.1" )){
		fix = "10.12.1";
	}
}
if(fix){
