...
if(description){
	...
	script_version( "2021-02-23T14:48:15+0000" );
	script_tag( name: "last_modification", value: "2021-02-23 14:48:15 +0000 (Tue, 23 Feb 2021)" );
...
if(http_vuln_check( port: port, url: url, pattern: "<username>.*</username>", check_header: TRUE, extra_check: "<password>.*</password>" )){
