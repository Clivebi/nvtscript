if(description){
	...
	script_cve_id( "CVE-2017-0029", "CVE-2017-0019", "CVE-2017-0030", "CVE-2017-0031", "CVE-2017-0053", "CVE-2017-0105" );
...
if(exeVer && IsMatchRegexp( exeVer, "^(12|14|15|16).*" )){
	...
	if(version_in_range( version: exeVer, test_version: "12.0", test_version2: "12.0.6765.4999" ) || version_in_range( version: exeVer, test_version: "14.0", test_version2: "14.0.7179.4999" ) || version_in_range( version: exeVer, test_version: "15.0", test_version2: "15.0.4911.999" ) || version_in_range( version: exeVer, test_version: "16.0", test_version2: "16.0.4510.999" )){
