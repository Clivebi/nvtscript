...
if(IsMatchRegexp( appVer, "^[6-9]\\." )){
	if( version_in_range( version: appVer, test_version: "6.0.0", test_version2: "6.0.47" ) ){
		...
		if( version_in_range( version: appVer, test_version: "7.0.0", test_version2: "7.0.72" ) ){
			fix = "7.0.73";
			VULN = TRUE;
		}
		else {
			if( version_in_range( version: appVer, test_version: "8.5.0", test_version2: "8.5.6" ) ){
				fix = "8.5.8";
				VULN = TRUE;
			}
			else {
				if( version_in_range( version: appVer, test_version: "8.0.0.RC1", test_version2: "8.0.38" ) ){
					...
					if(version_in_range( version: appVer, test_version: "9.0.0.M1", test_version2: "9.0.0.M11" )){
						fix = "9.0.0.M13";
						VULN = TRUE;
					}
				}
