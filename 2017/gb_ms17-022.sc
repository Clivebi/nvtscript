if(description){
	...
	script_tag( name: "severity_date", value: "2017-09-28 01:29:00 +0000 (Thu, 28 Sep 2017)" );
...
if(hotfix_check_sp( winVista: 3, winVistax64: 3, win2008x64: 3, win2008: 3, win7: 2, win7x64: 2, win2008r2: 2, win8_1: 1, win8_1x64: 1, win2012: 1, win2012R2: 1, win10: 1, win10x64: 1, win2016: 1 ) <= 0){
	exit( 0 );
}
...
if( hotfix_check_sp( winVista: 3, winVistax64: 3, win2008: 3, win2008x64: 3 ) > 0 && msdllVer ){
	...
	if( hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0 && msdllVer ){
		...
		if( hotfix_check_sp( win8_1: 1, win8_1x64: 1, win2012R2: 1 ) > 0 && pdfVer ){
			...
			if( hotfix_check_sp( win2012: 1 ) > 0 && msdllVer ){
