...
if(IsMatchRegexp( version, "^14" )){
	if( revcomp( a: version, b: "14.1R9" ) < 0 ){
		...
		if( ( revcomp( a: version, b: "14.1X53-D50" ) < 0 ) && ( revcomp( a: version, b: "14.1X53" ) >= 0 ) ){
			report = report_fixed_ver( installed_version: version, fixed_version: "14.1X53-D50" );
			security_message( port: 0, data: report );
			exit( 0 );
		}
		else {
			if(( revcomp( a: version, b: "14.2R7" ) < 0 ) && ( revcomp( a: version, b: "14.2" ) >= 0 )){
...
if(IsMatchRegexp( version, "^15" )){
	if( ( revcomp( a: version, b: "15.1F5-S5" ) < 0 ) && ( revcomp( a: version, b: "15.1F" ) >= 0 ) ){
		...
		if( ( revcomp( a: version, b: "15.1R5" ) < 0 ) && ( revcomp( a: version, b: "15.1R" ) >= 0 ) ){
			...
			if( ( revcomp( a: version, b: "15.1X49-D60" ) < 0 ) && ( revcomp( a: version, b: "15.1X49" ) >= 0 ) ){
				...
				if(( revcomp( a: version, b: "15.1X53-D230" ) < 0 ) && ( revcomp( a: version, b: "15.1X53" ) >= 0 )){
