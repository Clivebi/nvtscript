...
if(!image || ( !IsMatchRegexp( image, "^C23(5|6)0" ) && !IsMatchRegexp( image, "^C29(18|28|60|70|75)" ) && !IsMatchRegexp( image, "^C35(50|60)" ) && !IsMatchRegexp( image, "^C3750" ) && !IsMatchRegexp( image, "^C4(0|5)00" ) && !IsMatchRegexp( image, "^C49(00|28|48)" ) && !IsMatchRegexp( image, "^WS-CBS30(12|20|30|32|40)" ) && !IsMatchRegexp( image, "^WS-CBS31(1|2|3)0" ) && !IsMatchRegexp( image, "^IE(2|3|4|5)000" ) && !IsMatchRegexp( image, "^IE(3|4)010" ) )){
	exit( 99 );
}
if(!version = get_app_version( cpe: CPE )){
	exit( 0 );
}
affected = make_list( "12.1(11)EA1",
	 "12.1(11)EA1a",
	 "12.1(12c)EA1",
	 "12.1(12c)EA1a",
	 "12.1(13)EA1",
