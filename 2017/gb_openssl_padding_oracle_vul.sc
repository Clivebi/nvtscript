if(description){
	...
	script_version( "2021-09-22T14:06:27+0000" );
	script_cve_id( "CVE-2016-2107" );
	script_tag( name: "cvss_base", value: "2.6" );
	script_tag( name: "cvss_base_vector", value: "AV:N/AC:H/Au:N/C:P/I:N/A:N" );
	script_tag( name: "last_modification", value: "2021-09-22 14:06:27 +0000 (Wed, 22 Sep 2021)" );
...
if(defined_func( "prf_sha256" ) && defined_func( "tls1_prf" ) && defined_func( "rsa_public_encrypt" ) && defined_func( "aes128_cbc_encrypt" )){
	...
	for(;!hello_done;){
		...
		if(certificate){
			for cert in certificate["cert_list"] {
