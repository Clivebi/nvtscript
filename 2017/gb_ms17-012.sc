if(description){
	...
	script_cve_id( "CVE-2017-0007", "CVE-2017-0016", "CVE-2017-0039", "CVE-2017-0057", "CVE-2017-0100", "CVE-2017-0104" );
...
if( hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0 && gdiVer ){
	...
	if( hotfix_check_sp( winVista: 3, winVistax64: 3, win2008: 3, win2008x64: 3 ) > 0 && lmVer ){
		if( version_is_less( version: lmVer, test_version: "10.0.6002.19729" ) ){
			Vulnerable_range = "Less than 10.0.6002.19729";
			VULN = TRUE;
		}
		else {
			if(version_in_range( version: lmVer, test_version: "10.0.6002.24000", test_version2: "10.0.6002.24051" )){
		...
		if( hotfix_check_sp( win2012: 1 ) > 0 && gdiVer ){
			...
			if( hotfix_check_sp( win8_1: 1, win8_1x64: 1, win2012R2: 1 ) > 0 && gdiVer ){
				...
				if(hotfix_check_sp( win10: 1, win10x64: 1, win2016: 1 ) > 0 && gdiVer){
