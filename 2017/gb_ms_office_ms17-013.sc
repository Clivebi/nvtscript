...
if(!OfficeVer || !IsMatchRegexp( OfficeVer, "^(12|14).*" )){
	exit( 0 );
}
...
if(msPath){
	for ver in make_list( "OFFICE12",
		...
		if(msdllVer){
			if( IsMatchRegexp( msdllVer, "^12" ) ){
				Vulnerable_range = "12.0 - 12.0.6764.4999";
			}
			else {
				if(IsMatchRegexp( msdllVer, "^14" )){
					Vulnerable_range = "14.0 - 14.0.7179.4999";
				}
			}
			if(version_in_range( version: msdllVer, test_version: "14.0", test_version2: "14.0.7179.4999" ) || version_in_range( version: msdllVer, test_version: "12.0", test_version2: "12.0.6764.4999" )){
		...
		if(dllVer){
			if( version_in_range( version: dllVer, test_version: "1.0626.6002.00000", test_version2: "1.0626.6002.24057" ) ){
				...
				if(version_in_range( version: dllVer, test_version: "1.0626.7601.00000", test_version2: "1.0626.7601.23667" )){
					VULN1 = TRUE;
