if(description){
	...
	script_cve_id( "CVE-2017-3309", "CVE-2017-3308", "CVE-2017-3329", "CVE-2017-3456", "CVE-2017-3453", "CVE-2017-3600", "CVE-2017-3462", "CVE-2017-3463", "CVE-2017-3461", "CVE-2017-3464" );
	script_bugtraq_id( 97742, 97725, 97763, 97831, 97776, 97765, 97851, 97849, 97812, 97818 );
...
vers = infos["version"];
path = infos["location"];
if(version_in_range( version: vers, test_version: "5.5", test_version2: "5.5.54" ) || version_in_range( version: vers, test_version: "5.6", test_version2: "5.6.35" ) || version_in_range( version: vers, test_version: "5.7", test_version2: "5.7.17" )){
