...
if( IsMatchRegexp( git_ver, "^(2\\.14\\.)" ) && version_is_less( version: git_ver, test_version: "2.14.1" ) ){
	fix = "2.14.1";
}
else {
	if( IsMatchRegexp( git_ver, "^(2\\.13\\.)" ) && version_is_less( version: git_ver, test_version: "2.13.5" ) ){
		fix = "2.13.5";
	}
	else {
		if( IsMatchRegexp( git_ver, "^(2\\.12\\.)" ) && version_is_less( version: git_ver, test_version: "2.12.4" ) ){
			fix = "2.12.4";
		}
		else {
			if( IsMatchRegexp( git_ver, "^(2\\.11\\.)" ) && version_is_less( version: git_ver, test_version: "2.11.3" ) ){
				fix = "2.11.3";
			}
			else {
				if( IsMatchRegexp( git_ver, "^(2\\.10\\.)" ) && version_is_less( version: git_ver, test_version: "2.10.4" ) ){
					fix = "2.10.4";
				}
				else {
					if( IsMatchRegexp( git_ver, "^(2\\.9\\.)" ) && version_is_less( version: git_ver, test_version: "2.9.5" ) ){
						fix = "2.9.5";
					}
					else {
						if( IsMatchRegexp( git_ver, "^(2\\.8\\.)" ) && version_is_less( version: git_ver, test_version: "2.8.6" ) ){
							fix = "2.8.6";
						}
						else {
							if(IsMatchRegexp( git_ver, "^(2\\.7\\.)" ) && version_is_less( version: git_ver, test_version: "2.7.6" )){
								fix = "2.7.6";
							}
						}
					}
