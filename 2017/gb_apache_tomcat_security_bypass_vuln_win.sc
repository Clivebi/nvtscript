...
if(IsMatchRegexp( appVer, "^[7-9]\\." )){
	if( version_in_range( version: appVer, test_version: "8.5.0", test_version2: "8.5.14" ) ){
		...
		if( version_in_range( version: appVer, test_version: "8.0.0.RC1", test_version2: "8.0.43" ) ){
			fix = "8.0.44";
		}
		else {
			if( version_in_range( version: appVer, test_version: "7.0", test_version2: "7.0.77" ) ){
				fix = "7.0.78";
			}
			else {
				if(version_in_range( version: appVer, test_version: "9.0.0.M1", test_version2: "9.0.0.M20" )){
					fix = "9.0.0.M21";
				}
			}
		}
