...
if(ContainsString( model, "Officejet Pro 8620" ) || ContainsString( model, "Officejet Pro 8710" )){
	vuln_url = "/DevMgmt/Email/Contacts";
	if(http_vuln_check( port: port, url: vuln_url, check_header: TRUE, pattern: "<emaildyn:EmailContacts xmlns:dd=", extra_check: make_list( "www\\.hp\\.com",
		 "xmlns:emaildyn=",
		 "emailservicedyn",
		 "dictionaries" ) )){
