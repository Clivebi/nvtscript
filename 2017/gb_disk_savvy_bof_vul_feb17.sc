...
if(description){
	...
	script_tag( name: "summary", value: "This host is installed with DiskSavvy Enterprise and is prone to a
  GET buffer overflow vulnerability." );
  ...
  release, disable respective features, remove the product or replace the product by another one." );
	...
	script_dependencies( "gb_disk_savvy_enterprise_server_detect.sc", "os_detection.sc" );
