if(description){
	...
	script_cve_id( "CVE-2017-0024", "CVE-2017-0026", "CVE-2017-0056", "CVE-2017-0078", "CVE-2017-0079", "CVE-2017-0080", "CVE-2017-0081", "CVE-2017-0082" );
...
if( hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0 && gdiVer ){
	...
	if( hotfix_check_sp( winVista: 3, winVistax64: 3, win2008: 3, win2008x64: 3 ) > 0 && winVer ){
		if( version_is_less( version: winVer, test_version: "6.0.6002.19741" ) ){
			Vulnerable_range = "Less than 6.0.6002.19741";
			VULN = TRUE;
		}
		else {
			if(version_in_range( version: winVer, test_version: "6.0.6002.24000", test_version2: "6.0.6002.24064" )){
