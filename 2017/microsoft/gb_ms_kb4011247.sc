...
if(IsMatchRegexp( webappVer, "^(15\\.)" )){
	...
	if(dllVer){
		if(version_in_range( version: dllVer, test_version: "15.0", test_version2: "15.0.4981.0999" )){
			report = report_fixed_ver( file_checked: path + "\\15.0\\WebServices\\ConversionService\\Bin\\Converter\\sword.dll", file_version: dllVer, vulnerable_range: "15.0 - 15.0.4981.0999" );
