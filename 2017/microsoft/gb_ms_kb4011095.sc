...
if(IsMatchRegexp( officeVer, "^16\\." )){
	...
	for key in key_list {
		...
		if(msPath){
			...
			if(exeVer && IsMatchRegexp( exeVer, "^16\\." )){
				if(version_in_range( version: exeVer, test_version: "16.0", test_version2: "16.0.4627.999" )){
					report = report_fixed_ver( file_checked: msPath + "\\Microsoft Office\\Root\\Office16\\chart.dll", file_version: exeVer, vulnerable_range: "16.0 - 16.0.4627.999" );
