if(description){
	...
	script_cve_id( "CVE-2017-11847", "CVE-2017-11849", "CVE-2017-11851", "CVE-2017-11852", "CVE-2017-11853" );
...
if(version_is_less( version: fileVer, test_version: "6.0.6002.24215" )){
	report = report_fixed_ver( file_checked: sysPath + "\\win32k.sys", file_version: fileVer, vulnerable_range: "Less than 6.0.6002.24215" );
