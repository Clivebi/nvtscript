...
if(description){
	...
	script_cve_id( "CVE-2017-11791", "CVE-2017-11834", "CVE-2017-11843", "CVE-2017-11846", "CVE-2017-11848", "CVE-2017-11855", "CVE-2017-11858", "CVE-2017-11869" );
...
if(hotfix_check_sp( win2008: 3, win2008x64: 3 ) > 0){
	if(version_is_less( version: iedllVer, test_version: "9.0.8112.21073" )){
		report = report_fixed_ver( file_checked: iePath + "\\Mshtml.dll", file_version: iedllVer, vulnerable_range: "Less than 9.0.8112.21073" );
