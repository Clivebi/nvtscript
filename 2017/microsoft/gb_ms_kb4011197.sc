...
if(IsMatchRegexp( excelVer, "^(14\\.)" ) && version_is_less( version: excelVer, test_version: "14.0.7190.5000" )){
	report = report_fixed_ver( file_checked: excelPath + "Excel.exe", file_version: excelVer, vulnerable_range: "14.0 - 14.0.7190.4999" );
