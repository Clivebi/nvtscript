...
if(fileList1 && is_array( fileList1 )){
	for filePath1 in keys( fileList1 ) {
		...
		if(vers1 && version1 = eregmatch( string: vers1, pattern: "^([0-9.]+)" )){
			if( IsMatchRegexp( version1[1], "^1\\.0" ) && version_is_less( version: version1[1], test_version: "1.0.6" ) ){
				VULN = TRUE;
				report += report_fixed_ver( file_version: version1[1], file_checked: filePath1, fixed_version: "1.0.6" ) + "\n";
			}
			else {
				if(IsMatchRegexp( version1[1], "^1\\.1" ) && version_is_less( version: version1[1], test_version: "1.1.4" )){
					VULN = TRUE;
...
if(fileList2 && is_array( fileList2 )){
	for filePath2 in keys( fileList2 ) {
		...
		if(vers2 && version2 = eregmatch( string: vers2, pattern: "^([0-9.]+)" )){
			if( IsMatchRegexp( version2[1], "^1\\.0" ) && version_is_less( version: version2[1], test_version: "1.0.6" ) ){
				VULN = TRUE;
				report += report_fixed_ver( file_version: version2, file_checked: filePath2, fixed_version: "1.0.6" ) + "\n";
			}
			else {
				if(IsMatchRegexp( version2[1], "^1\\.1" ) && version_is_less( version: version2[1], test_version: "1.1.4" )){
					VULN = TRUE;
...
if(fileList3 && is_array( fileList3 )){
	for filePath3 in keys( fileList3 ) {
		vers3 = fileList3[filePath3];
		if(vers3 && version3 = eregmatch( string: vers3, pattern: "^([0-9.]+)" )){
			if(IsMatchRegexp( version3[1], "^2\\.0" ) && version_is_less( version: version3[1], test_version: "2.0.2" )){
				VULN = TRUE;
