...
if(IsMatchRegexp( version, "^12" )){
	if( ( revcomp( a: version, b: "12.1X46-D67" ) < 0 ) && ( revcomp( a: version, b: "12.1X46" ) >= 0 ) ){
		...
		if(( revcomp( a: version, b: "12.3X48-D51" ) < 0 ) && ( revcomp( a: version, b: "12.3X48" ) >= 0 )){
...
if(IsMatchRegexp( version, "^14" )){
	if( ( revcomp( a: version, b: "14.1R9" ) < 0 ) && ( revcomp( a: version, b: "14.1R" ) >= 0 ) ){
		...
		if( ( revcomp( a: version, b: "14.1X53-D45" ) < 0 ) && ( revcomp( a: version, b: "14.1X53" ) >= 0 ) ){
			report = report_fixed_ver( installed_version: version, fixed_version: "14.1X53-D454" );
			security_message( port: 0, data: report );
			exit( 0 );
		}
		else {
			if(( revcomp( a: version, b: "14.2R7-S7" ) < 0 ) && ( revcomp( a: version, b: "14.2R" ) >= 0 )){
...
if(IsMatchRegexp( version, "^15" )){
	if( ( revcomp( a: version, b: "15.1F2-S18" ) < 0 ) && ( revcomp( a: version, b: "15.1F2" ) >= 0 ) ){
		report = report_fixed_ver( installed_version: version, fixed_version: "15.1F2-S18" );
		security_message( port: 0, data: report );
		exit( 0 );
	}
	else {
		if( ( revcomp( a: version, b: "15.1F6-S7" ) < 0 ) && ( revcomp( a: version, b: "15.1F6" ) >= 0 ) ){
			report = report_fixed_ver( installed_version: version, fixed_version: "15.1F6-S7" );
			security_message( port: 0, data: report );
			exit( 0 );
		}
		else {
			if( ( revcomp( a: version, b: "15.1R7" ) < 0 ) && ( revcomp( a: version, b: "15.1R" ) >= 0 ) ){
...
if(IsMatchRegexp( version, "^17" )){
	if( revcomp( a: version, b: "17.1R2" ) < 0 ){
		...
		if(( revcomp( a: version, b: "17.2R2" ) < 0 ) && ( revcomp( a: version, b: "17.2R" ) >= 0 )){
