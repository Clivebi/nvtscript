...
if(description){
	...
	script_cve_id( "CVE-2017-8517", "CVE-2017-8519", "CVE-2017-8522", "CVE-2017-8524", "CVE-2017-8529", "CVE-2017-8547", "CVE-2016-3326" );
...
if( hotfix_check_sp( win2008: 3, win2008x64: 3 ) > 0 && iedllVer ){
	if( version_in_range( version: iedllVer, test_version: "9.0.8112.16000", test_version2: "9.0.8112.16905" ) ){
		...
		if(version_in_range( version: iedllVer, test_version: "9.0.8112.20000", test_version2: "9.0.8112.21016" )){
	...
	if( hotfix_check_sp( win2012: 1 ) > 0 && sllVer ){
		...
		if(hotfix_check_sp( win8_1: 1, win8_1x64: 1, win2012R2: 1, win7: 2, win7x64: 2, win2008r2: 2 ) > 0 && iedllVer){
