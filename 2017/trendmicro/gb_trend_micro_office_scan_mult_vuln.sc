...
if(description){
	...
	script_cve_id( "CVE-2017-14083", "CVE-2017-14084", "CVE-2017-14085", "CVE-2017-14086", "CVE-2017-14087", "CVE-2017-14088", "CVE-2017-14089" );
...
if(http_vuln_check( port: port, url: url, pattern: "Content-Length:.*", extra_check: make_list( "\"NODES\"",
	 "\"NAME\"",
	 "\"ERROR_CODE\"",
	 "\"RESPONSE\"" ), check_header: TRUE )){
