...
if(description){
	...
	script_dependencies( "gb_pfsense_detect.sc", "gb_default_credentials_options.sc" );
...
req_2 = http_post_put_req( port: port, url: "/", data: data, accept_header: accept, host_header_use_ip: TRUE, add_headers: make_array( "Upgrade-Insecure-Requests", "1", "Cookie", cookie_1, "Content-Type", "application/x-www-form-urlencoded" ) );
...
if(ContainsString( res_3, "Status: Dashboard</title>" )){
