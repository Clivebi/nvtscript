...
if( hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0 ){
	...
	if( hotfix_check_sp( winVista: 3, win2008: 3, win2008x64: 3, winVistax64: 3 ) > 0 ){
		if( version_is_less_equal( version: dllver1, test_version: "6.0.6002.19660" ) ){
			Vulnerable_range = "Version 6.0.6002.19660 and prior";
			VULN1 = TRUE;
		}
		else {
			if(version_in_range( version: dllver1, test_version: "6.0.6002.23000", test_version2: "6.0.6002.23975" )){
			...
			if( hotfix_check_sp( win2012: 1 ) > 0 ){
				...
				if(hotfix_check_sp( win10: 1, win10x64: 1 ) > 0){
					if( version_is_less_equal( version: dllver1, test_version: "10.0.10240.16942" ) ){
						...
						if(version_in_range( version: dllver1, test_version: "10.0.10586.0", test_version2: "10.0.10586.420" )){
