...
if( version_is_less( version: vers, test_version: "1.23.12" ) ){
	...
	if( version_in_range( version: vers, test_version: "1.24.0", test_version2: "1.24.4" ) ){
		fix = "1.24.5";
		VULN = TRUE;
	}
	else {
		if( version_in_range( version: vers, test_version: "1.25.0", test_version2: "1.25.3" ) ){
			fix = "1.25.4";
			VULN = TRUE;
		}
		else {
			if(version_is_equal( version: vers, test_version: "1.26.0" )){
				fix = "1.26.1";
				VULN = TRUE;
			}
		}
