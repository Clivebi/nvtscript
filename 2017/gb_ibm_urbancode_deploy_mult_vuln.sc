...
if(description){
	...
	script_cve_id( "CVE-2016-2942", "CVE-2016-2941", "CVE-2016-0320", "CVE-2016-6068", "CVE-2016-8938", "CVE-2016-9008" );
	...
	script_dependencies( "gb_ibm_urbancode_deploy_detect.sc" );
...
if(version_in_range( version: version, test_version: "6.0", test_version2: "6.0.1.14" ) || version_in_range( version: version, test_version: "6.1", test_version2: "6.1.3.3" ) || version_in_range( version: version, test_version: "6.2", test_version2: "6.2.2.1" )){
