...
if(description){
	...
	script_dependencies( "gb_synology_photo_station_detect.sc" );
...
if(!infos = get_app_version_and_location( cpe: CPE, port: synport, exit_no_version: TRUE )){
	exit( 0 );
}
...
if( version_is_less( version: synVer, test_version: "6.3-2968" ) ){
	...
	if(version_in_range( version: synVer, test_version: "6.7", test_version2: "6.7.3-3432" ) || version_in_range( version: synVer, test_version: "6.6", test_version2: "6.6.3-3347" ) || version_in_range( version: synVer, test_version: "6.5", test_version2: "6.5.3-3226" ) || version_in_range( version: synVer, test_version: "6.4", test_version2: "6.4-3166" )){
		fix = "6.7.3-3433";
	}
}
if(fix){
