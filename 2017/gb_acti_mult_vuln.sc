...
if(description){
	...
	script_dependencies( "gb_acti_devices_detect.sc" );
...
if(http_vuln_check( port: port, url: url, pattern: "Factory Default", check_header: TRUE, extra_check: "SETTING_FACTORY_DEFAULT_CONFIG" )){
