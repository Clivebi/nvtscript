...
IBM Security Network Protection 5.3.2" );
	...
	script_dependencies( "gb_ibm_security_network_protection_version.sc" );
...
if(IsMatchRegexp( version, "^5\\.3\\.1" )){
	if(version_is_less( version: version, test_version: "5.3.1.6" )){
		fix = "5.3.1.7";
	}
}
if(IsMatchRegexp( version, "^5\\.3\\.2" )){
	if(version_is_less( version: version, test_version: "5.3.2.0" )){
		fix = "5.3.2.1";
	}
}
if(fix){
