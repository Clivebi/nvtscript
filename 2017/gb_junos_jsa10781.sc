...
if(!model || !IsMatchRegexp( toupper( model ), "^EX" )){
	exit( 99 );
}
...
if(IsMatchRegexp( version, "^12" )){
	if(( revcomp( a: version, b: "12.3R12-S4" ) < 0 ) && ( revcomp( a: version, b: "12.3" ) >= 0 )){
...
if(IsMatchRegexp( version, "^12" )){
	if(( revcomp( a: version, b: "13.3R10" ) < 0 ) && ( revcomp( a: version, b: "12.3" ) >= 0 )){
	...
	if( revcomp( a: version, b: "14.1R8-S3" ) < 0 ){
		...
		if( ( revcomp( a: version, b: "14.1X53-D40" ) < 0 ) && ( revcomp( a: version, b: "14.1X53" ) >= 0 ) ){
			...
			if( ( revcomp( a: version, b: "14.1X55-D35" ) < 0 ) && ( revcomp( a: version, b: "14.1X55" ) >= 0 ) ){
				...
				if(( revcomp( a: version, b: "14.2R6-S4" ) < 0 ) && ( revcomp( a: version, b: "14.2" ) >= 0 )){
