if(description){
	...
	script_cve_id( "CVE-2017-0001", "CVE-2017-0005", "CVE-2017-0025", "CVE-2017-0047", "CVE-2017-0060", "CVE-2017-0062", "CVE-2017-0073", "CVE-2017-0061", "CVE-2017-0063", "CVE-2017-0038", "CVE-2017-0108", "CVE-2017-0014" );
...
if(hotfix_check_sp( winVista: 3, winVistax64: 3, win7: 2, win7x64: 2, win2008: 3, win2008r2: 2, win2008x64: 3, win2012: 1, win2012R2: 1, win8_1: 1, win8_1x64: 1, win10: 1, win10x64: 1, win2016: 1, win8: 1, win8x64: 1, xp: 4, xpx64: 3, win2003: 3, win2003x64: 3 ) <= 0){
	exit( 0 );
}
...
if( hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0 ){
	...
	if( hotfix_check_sp( winVista: 3, win2008: 3 ) > 0 ){
		if( winVer && version_is_less( version: winVer, test_version: "6.0.6002.19741" ) ){
			...
			if( winVer && version_in_range( version: winVer, test_version: "6.0.6002.24000", test_version2: "6.0.6002.24064" ) ){
				Vulnerable_range = "6.0.6002.24000 - 6.0.6002.24064";
				VULN = TRUE;
			}
			else {
				if( uspVer && version_is_less( version: uspVer, test_version: "1.626.6002.19743" ) ){
					Vulnerable_range1 = "Less than 1.626.6002.19743";
					VULN1 = TRUE;
				}
				else {
					if(uspVer && version_in_range( version: uspVer, test_version: "1.626.6002.24000", test_version2: "1.626.6002.24066" )){
		...
		if( hotfix_check_sp( winVistax64: 3, win2008x64: 3 ) > 0 ){
			if( icmVer && version_is_less( version: icmVer, test_version: "6.0.6002.19741" ) ){
				Vulnerable_range2 = "Less than 6.0.6002.19741";
				VULN2 = TRUE;
			}
			else {
				if(winVer && version_in_range( version: icmVer, test_version: "6.0.6002.24000", test_version2: "6.0.6002.24064" )){
				...
				if( hotfix_check_sp( win8_1: 1, win8_1x64: 1, win2012R2: 1 ) > 0 ){
					...
					if( hotfix_check_sp( win10: 1, win10x64: 1, win2016: 1 ) > 0 ){
						if( winVer && version_is_less( version: winVer, test_version: "10.0.10240.16384" ) ){
							...
							if( winVer && version_in_range( version: winVer, test_version: "10.0.10586.0", test_version2: "10.0.10586.19" ) ){
