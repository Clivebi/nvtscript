if(description){
	...
	script_cve_id( "CVE-2016-2183", "CVE-2017-3231", "CVE-2017-3261", "CVE-2016-5548", "CVE-2017-3253", "CVE-2017-3272", "CVE-2017-3252", "CVE-2017-3259", "CVE-2016-5552", "CVE-2016-5546", "CVE-2017-3241" );
	script_bugtraq_id( 92630, 95563, 95566, 95559, 95498, 95533, 95509, 95570, 95512, 95506, 95488 );
...
if(IsMatchRegexp( vers, "^1\\.[6-8]\\." )){
	if(version_in_range( version: vers, test_version: "1.6.0", test_version2: "1.6.0.131" ) || version_in_range( version: vers, test_version: "1.7.0", test_version2: "1.7.0.121" ) || version_in_range( version: vers, test_version: "1.8.0", test_version2: "1.8.0.112" )){
