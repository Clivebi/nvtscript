if(description){
	...
	script_cve_id( "CVE-2017-3514", "CVE-2017-3526", "CVE-2017-3509", "CVE-2017-3533", "CVE-2017-3544", "CVE-2017-3539" );
...
if(IsMatchRegexp( vers, "^1\\.[6-8]\\." )){
	if(version_in_range( version: vers, test_version: "1.6.0", test_version2: "1.6.0.141" ) || version_in_range( version: vers, test_version: "1.7.0", test_version2: "1.7.0.131" ) || version_in_range( version: vers, test_version: "1.8.0", test_version2: "1.8.0.121" )){
