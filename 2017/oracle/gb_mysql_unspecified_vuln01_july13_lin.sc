...
if(mysqlVer && IsMatchRegexp( mysqlVer, "^(5\\.(1|5|6))" )){
	if(version_in_range( version: mysqlVer, test_version: "5.1", test_version2: "5.1.69" ) || version_in_range( version: mysqlVer, test_version: "5.5", test_version2: "5.5.31" ) || version_in_range( version: mysqlVer, test_version: "5.6", test_version2: "5.6.11" )){
