...
if(description){
	...
	script_cve_id( "CVE-2017-0030", "CVE-2017-0031", "CVE-2017-0105", "CVE-2017-0027", "CVE-2017-0020", "CVE-2017-0029" );
...
if(IsMatchRegexp( offVer, "^14\\." ) && version_is_less( version: offVer, test_version: "14.7.2" )){
	report = "File version:     " + offVer + "\n" + "Vulnerable range: 14.1.0 - 14.7.1 " + "\n";
	security_message( data: report );
}
if(IsMatchRegexp( offVer, "^15\\." ) && version_is_less( version: offVer, test_version: "15.32.0" )){
