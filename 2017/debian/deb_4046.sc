...
res = "";
report = "";
if(!isnull( res = isdpkgvuln( pkg: "libspring-ldap-java", ver: "1.3.1.RELEASE-5+deb8u1", rls: "DEB8" ) )){
	report += res;
}
if(!isnull( res = isdpkgvuln( pkg: "libspring-ldap-java-doc", ver: "1.3.1.RELEASE-5+deb8u1", rls: "DEB8" ) )){
	report += res;
}
if( report != "" ){
