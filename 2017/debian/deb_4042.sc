...
res = "";
report = "";
if(!isnull( res = isdpkgvuln( pkg: "libxml-libxml-perl", ver: "2.0128+dfsg-1+deb9u1", rls: "DEB9" ) )){
	report += res;
}
if(!isnull( res = isdpkgvuln( pkg: "libxml-libxml-perl", ver: "2.0116+dfsg-1+deb8u2", rls: "DEB8" ) )){
	report += res;
}
if( report != "" ){
