...
if(description){
	...
	script_cve_id( "CVE-2017-0064", "CVE-2017-0222", "CVE-2017-0226", "CVE-2017-0228", "CVE-2017-0231", "CVE-2017-0238" );
...
if(hotfix_check_sp( xp: 4, xpx64: 3, win2003: 3, win2003x64: 3, winVista: 3, winVistax64: 3, win2008: 3, win2008x64: 3, win7: 2, win7x64: 2, win2008r2: 2, win8: 1, win8x64: 1, win2012: 1, win2012R2: 1, win8_1: 1, win8_1x64: 1 ) <= 0){
	exit( 0 );
}
ieVer = get_app_version( cpe: CPE );
if(!ieVer || !IsMatchRegexp( ieVer, "^([89|1[01])\\." )){
	exit( 0 );
}
...
if( hotfix_check_sp( winVista: 3, winVistax64: 3, win2008: 3, win2008x64: 3 ) > 0 ){
	if( version_in_range( version: iedllVer, test_version: "9.0.8112.16000", test_version2: "9.0.8112.16895" ) ){
		...
		if(version_in_range( version: iedllVer, test_version: "9.0.8112.20000", test_version2: "9.0.8112.21006" )){
	...
	if( hotfix_check_sp( xp: 4, win2003: 3, win2003x64: 3, xpx64: 3 ) > 0 ){
		...
		if( hotfix_check_sp( win2012: 1, win8: 1, win8x64: 1 ) > 0 ){
