...
if(description){
  ...
  8.0R17 or later." );
	...
	script_dependencies( "gb_pulse_connect_secure_consolidation.sc" );
...
if(IsMatchRegexp( version, "^8\\.3" ) && version_is_less( version: version, test_version: "8.3r1" )){
	fix = "8.3R1";
}
if(IsMatchRegexp( version, "^8\\.2" ) && version_is_less( version: version, test_version: "8.2r6" )){
	fix = "8.2R6";
}
if(IsMatchRegexp( version, "^8\\.1" ) && version_is_less( version: version, test_version: "8.1r12" )){
	fix = "8.1R12";
}
if(IsMatchRegexp( version, "^8\\.0" ) && version_is_less( version: version, test_version: "8.0r17" )){
	fix = "8.0R17";
}
if(fix){
