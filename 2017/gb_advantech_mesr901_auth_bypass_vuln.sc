...
if(description){
	...
	script_dependencies( "gb_advantech_mesr901_detect.sc" );
...
if(ContainsString( res, "I want DHCP to setup the network" ) && ContainsString( res, "validateIPAddrAndGateway(this)" )){
	report = "It was possible to access " + http_report_vuln_url( port: port, url: url, url_only: TRUE ) + " without authentication.\\n";
