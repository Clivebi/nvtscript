...
if(IsMatchRegexp( version, "^9\\." )){
	if( IsMatchRegexp( version, "^9\\.9\\.[3-9]s[1-7]" ) ){
		fix = "9.9.9-S8";
		VULN = TRUE;
	}
	else {
		if( IsMatchRegexp( version, "^9\\.9\\.[3-9]" ) ){
			...
			if( IsMatchRegexp( version, "^9\\.10\\." ) ){
				...
				if( IsMatchRegexp( version, "^9\\.11\\.0" ) ){
					...
					if(version_is_equal( version: version, test_version: "9.11.1b1" ) || version_is_equal( version: version, test_version: "9.10.5b1" ) || version_is_equal( version: version, test_version: "9.8.8" )){
