if(description){
	...
	script_cve_id( "CVE-2017-0021", "CVE-2017-0051", "CVE-2017-0074", "CVE-2017-0075", "CVE-2017-0076", "CVE-2017-0097", "CVE-2017-0099", "CVE-2017-0095", "CVE-2017-0096", "CVE-2017-0098", "CVE-2017-0109" );
...
if(hotfix_check_sp( winVistax64: 3, win2008x64: 3, win7x64: 2, win2008r2: 2, win8_1x64: 1, win2012: 1, win2012R2: 1, win10x64: 1, win2016: 1 ) <= 0){
	exit( 0 );
}
...
if( hotfix_check_sp( winVistax64: 3, win2008x64: 3 ) > 0 && hypVer ){
	...
	if( hotfix_check_sp( win7x64: 2, win2008r2: 2 ) > 0 && hypVer ){
		...
		if( hotfix_check_sp( win8_1x64: 1, win2012R2: 1 ) > 0 && hypVer ){
			...
			if( hotfix_check_sp( win2012: 1 ) > 0 && hypVer ){
