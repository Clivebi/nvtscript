...
if(description){
  ...
  remove the product or replace the product by another one." );
	...
	script_dependencies( "gb_parallels_plesk_sitebuilder_remote_detect.sc" );
...
if(http_vuln_check( port: port, url: "/Wizard/Default.aspx", check_header: TRUE, pattern: "Copyright.*Parallels", extra_check: make_list( ">Design",
	 ">Pages",
	 ">Publish",
	 ">Apply changes?" ) )){
