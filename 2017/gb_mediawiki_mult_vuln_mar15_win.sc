...
if(description){
	...
	script_cve_id( "CVE-2015-2931", "CVE-2015-2932", "CVE-2015-2933", "CVE-2015-2934", "CVE-2015-2935", "CVE-2015-2936", "CVE-2015-2937", "CVE-2015-2938", "CVE-2015-2941", "CVE-2015-2942" );
...
if( version_is_less( version: vers, test_version: "1.19.24" ) ){
	...
	if( version_in_range( version: vers, test_version: "1.20", test_version2: "1.23.8" ) ){
		fix = "1.23.9";
		VULN = TRUE;
	}
	else {
		if(version_in_range( version: vers, test_version: "1.24.0", test_version2: "1.24.1" )){
			fix = "1.24.2";
			VULN = TRUE;
		}
	}
