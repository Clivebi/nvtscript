...
path = infos["location"];
if(IsMatchRegexp( appVer, "^[6-9]\\." )){
	if( version_in_range( version: appVer, test_version: "6.0.0", test_version2: "6.0.52" ) ){
		fix = "6.0.53";
		VULN = TRUE;
	}
	else {
		if( version_in_range( version: appVer, test_version: "7.0.0", test_version2: "7.0.76" ) ){
			fix = "7.0.77";
			VULN = TRUE;
		}
		else {
			if( version_in_range( version: appVer, test_version: "8.5.0", test_version2: "8.5.12" ) ){
				...
				if( version_in_range( version: appVer, test_version: "8.0.0.RC1", test_version2: "8.0.42" ) ){
					fix = "8.0.43";
					VULN = TRUE;
				}
				else {
					if(version_in_range( version: appVer, test_version: "9.0.0.M1", test_version2: "9.0.0.M18" )){
						fix = "9.0.0.M19";
						VULN = TRUE;
					}
				}
