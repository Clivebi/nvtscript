...
if(description){
	...
	script_version( "2021-03-12T08:47:33+0000" );
	script_tag( name: "cvss_base", value: "10.0" );
	script_tag( name: "cvss_base_vector", value: "AV:N/AC:L/Au:N/C:C/I:C/A:C" );
	script_tag( name: "last_modification", value: "2021-03-12 08:47:33 +0000 (Fri, 12 Mar 2021)" );
  ...
  features, remove the product or replace the product by another one." );
	...
	script_dependencies( "gb_a2billing_detect.sc" );
...
if(http_vuln_check( port: port, url: url, pattern: "^(-- (MySQL|MariaDB) dump |INSERT INTO |DROP TABLE |CREATE TABLE )", check_header: TRUE )){
	report = "It was possible to execute SQL dump remotely, the SQL dump can be accessed at " + http_report_vuln_url( port: port, url: url, url_only: TRUE ) + ".\\n\\nPlease remove this file.";
