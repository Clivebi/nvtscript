if(description){
	...
	script_cve_id( "CVE-2017-8527", "CVE-2017-8531", "CVE-2017-0283", "CVE-2017-8532", "CVE-2017-8533", "CVE-2017-0287", "CVE-2017-0288", "CVE-2017-0289", "CVE-2017-0286" );
...
if(!offVer || !IsMatchRegexp( offVer, "^12\\." )){
	exit( 0 );
}
offPath = registry_get_sz( key: "SOFTWARE\\Microsoft\\Office\\12.0\\Common\\InstallRoot", item: "Path" );
if(!offPath){
	exit( 0 );
}
