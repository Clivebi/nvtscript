...
if(description){
	...
	script_name( "Mozilla Firefox Security Update (mfsa_2017-15_2017-16) - Mac OS X" );
  ...
  a denial of service." );
	...
	script_tag( name: "solution", value: "Update to version 54.0 or later." );
