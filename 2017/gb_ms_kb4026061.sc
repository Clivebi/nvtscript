...
if(!sysPath = registry_get_sz( key: "SOFTWARE\\Microsoft\\Windows\\CurrentVersion", item: "ProgramFilesDir" )){
	exit( 0 );
}
...
if( version_is_less( version: fileVer, test_version: "6.0.6002.19812" ) ){
	...
	if(version_in_range( version: fileVer, test_version: "6.0.6002.23000", test_version2: "6.0.6002.24132" )){
