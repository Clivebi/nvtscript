...
if(description){
	...
	script_name( "Adobe Flash Player Security Update (apsb17-10) - MAC OS X" );
  ...
  25.0.0.148." );
	script_tag( name: "solution", value: "Update to version 25.0.0.148 or later." );
...
if(version_is_less( version: vers, test_version: "25.0.0.148" )){
	report = report_fixed_ver( installed_version: vers, fixed_version: "25.0.0.148", install_path: path );
