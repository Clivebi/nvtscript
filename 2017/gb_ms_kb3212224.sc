...
if( IsMatchRegexp( offVer, "^(14\\.)" ) && version_in_range( version: offVer, test_version: "14.1.0", test_version2: "14.7.5" ) ){
	report = "File version:     " + offVer + "\n" + "Vulnerable range: 14.1.0 - 14.7.5" + "\n";
	security_message( data: report );
	exit( 0 );
}
else {
	if(IsMatchRegexp( offVer, "^(15\\.)" ) && version_is_less( version: offVer, test_version: "15.36.0" )){
