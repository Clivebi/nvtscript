...
if(IsMatchRegexp( version, "^12" )){
	if( ( revcomp( a: version, b: "12.3R13" ) < 0 ) && ( revcomp( a: version, b: "12.3R" ) >= 0 ) ){
...
if(IsMatchRegexp( version, "^14" )){
	if( ( revcomp( a: version, b: "14.1R9" ) < 0 ) && ( revcomp( a: version, b: "14.1R" ) >= 0 ) ){
		...
		if( ( revcomp( a: version, b: "14.1X53-D40" ) < 0 ) && ( revcomp( a: version, b: "14.1X53" ) >= 0 ) ){
			...
			if( ( revcomp( a: version, b: "14.1X55-D35" ) < 0 ) && ( revcomp( a: version, b: "14.1X55" ) >= 0 ) ){
...
if(IsMatchRegexp( version, "^15" )){
	if( ( revcomp( a: version, b: "15.1F6" ) < 0 ) && ( revcomp( a: version, b: "15.1F" ) >= 0 ) ){
		report = report_fixed_ver( installed_version: version, fixed_version: "15.1F6" );
		security_message( port: 0, data: report );
		exit( 0 );
	}
	else {
		if( ( revcomp( a: version, b: "15.1R4" ) < 0 ) && ( revcomp( a: version, b: "15.1R" ) >= 0 ) ){
			...
			if( ( revcomp( a: version, b: "15.1X49-D100" ) < 0 ) && ( revcomp( a: version, b: "15.1X49" ) >= 0 ) ){
				...
				if(( revcomp( a: version, b: "15.1X53-D50" ) < 0 ) && ( revcomp( a: version, b: "15.1X53" ) >= 0 )){
