...
if(!registry_key_exists( key: "SOFTWARE\\Panda Software" ) && !registry_key_exists( key: "SOFTWARE\\Wow6432Node\\Panda Software" )){
	exit( 0 );
}
...
pskmadVer = fetch_file_version( sysPath: pandaurlPath, file_name: "\\pskmad.sys" );
