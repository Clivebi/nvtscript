...
if(description){
  ...
  Citrix XenServer 6.5, Citrix XenServer 6.2.0 Sp1, Citrix XenServer 6.2." );
	...
	script_dependencies( "gb_xenserver_web_detect.sc" );
...
if(version_is_equal( version: ver, test_version: "6.0.2" ) || version_is_equal( version: ver, test_version: "6.5.2" ) || version_is_equal( version: ver, test_version: "6.2" ) || version_is_equal( version: ver, test_version: "7.0" )){
