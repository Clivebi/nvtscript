if(description){
	...
	script_tag( name: "severity_date", value: "2017-11-19 02:29:00 +0000 (Sun, 19 Nov 2017)" );
...
if(hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2, win2012R2: 1, win8_1: 1, win8_1x64: 1, win10: 1, win10x64: 1, win2016: 1 ) <= 0){
	exit( 0 );
}
	...
	if( ( hotfix_check_sp( win2016: 1 ) > 0 ) ){
		...
		if(hotfix_check_sp( win10: 1, win10x64: 1 ) > 0){
			if( version_is_less_equal( version: edgeVer, test_version: "11.0.10240.17236" ) ){
				...
				if( version_in_range( version: edgeVer, test_version: "11.0.10586.0", test_version2: "11.0.10586.753" ) ){
