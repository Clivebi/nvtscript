...
for executableFile in smbName {
	...
	if(!isnull( smbVer[0] )){
		...
		log_message( data: build_detection_report( app: "Samba", version: smbVer[0], install: executableFile, cpe: cpe, concluded: smbVer[max_index( smbVer ) - 1] ) );
	}
}
