if(description){
	...
	script_tag( name: "last_modification", value: "2021-07-13 07:25:02 +0000 (Tue, 13 Jul 2021)" );
...
log_message( data: build_detection_report( app: "Apache Tomcat JK Connector (mod_jk)", version: version, install: install, cpe: cpe, concludedUrl: conclurl, concluded: concluded ), port: port );
exit( 0 );
