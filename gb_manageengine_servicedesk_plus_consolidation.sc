...
if(description){
	...
	script_dependencies( "gb_manageengine_servicedesk_plus_detect.sc" );
	if(FEED_NAME == "GSF" || FEED_NAME == "SCM"){
		script_dependencies( "gsf/gb_manageengine_servicedesk_plus_smb_detect.sc" );
	}
...
report = build_detection_report( app: "ManageEngine ServiceDesk Plus", version: version, patch: build, install: "/", cpe: CPE );
if(extra){
	report += "\n\nDetection methods:\n";
	report += extra;
}
