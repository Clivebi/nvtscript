...
for item in registry_enum_keys( key: key ) {
	...
	if(ContainsString( nortonName, "Norton Security" )){
		...
		log_message( data: build_detection_report( app: "Norton Security", version: nortonVer, install: nortonPath, cpe: cpe, concluded: nortonVer ) );
		exit( 0 );
	}
}
