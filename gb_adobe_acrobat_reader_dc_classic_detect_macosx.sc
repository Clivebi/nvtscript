...
psVer = chomp( ssh_cmd( socket: sock, cmd: "defaults read /Applications/" + "Adobe\\ Acrobat\\ Reader\\ 2015.app/Contents/Info CFBundleShortVersionString" ) );
close( sock );
...
log_message( data: build_detection_report( app: "Adobe Acrobat Reader DC Classic", version: psVer, install: "/Applications", cpe: cpe, concluded: psVer ) );
exit( 0 );
