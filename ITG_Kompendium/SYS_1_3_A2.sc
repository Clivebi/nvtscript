if(description){
	...
	script_dependencies( "os_detection.sc", "compliance_tests.sc", "Policy/Linux/SystemMaintenance/no_duplicate_username.sc", "Policy/Linux/SystemMaintenance/groups_passwd_in_group.sc", "Policy/Linux/SystemMaintenance/no_duplicate_gids.sc", "Policy/Linux/SystemMaintenance/no_duplicate_uids.sc" );
