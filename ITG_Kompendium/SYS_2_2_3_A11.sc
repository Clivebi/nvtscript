if(description){
	...
	script_dependencies( "smb_reg_service_pack.sc", "os_detection.sc", "Policy/WindowsGeneral/MSSecurityGuide/win_sg_wdigest_authentication.sc", "Policy/WindowsGeneral/System/win_vbs_credential_guard.sc" );
