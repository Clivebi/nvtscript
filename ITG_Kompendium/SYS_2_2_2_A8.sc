if(description){
	...
	script_dependencies( "smb_reg_service_pack.sc", "os_detection.sc", "Policy/WindowsGeneral/WindowsComponents/win_prevent_join_homegroup.sc", "Policy/WindowsGeneral/UserTemplates/win_share_files_profile.sc" );
