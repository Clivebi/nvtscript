if(description){
	...
	script_dependencies( "smb_reg_service_pack.sc", "os_detection.sc", "Policy/WindowsGeneral/System/win_vbs_credential_guard.sc", "Policy/WindowsGeneral/SCM/win_lsa_protection.sc" );
