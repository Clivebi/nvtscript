if(description){
	...
	script_dependencies( "smb_reg_service_pack.sc", "os_detection.sc", "Policy/WindowsGeneral/System/win_domain_pin_logon.sc", "Policy/WindowsGeneral/System/win_picture_password_sign_in.sc" );
