if(description){
	...
	script_dependencies( "smb_reg_service_pack.sc", "os_detection.sc", "Policy/WindowsGeneral/SecurityOptions/win_block_microsoft_accounts.sc", "Policy/WindowsGeneral/WindowsComponents/win_ie_defender_smartscreen.sc" );
