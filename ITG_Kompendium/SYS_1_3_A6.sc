if(description){
	...
	script_dependencies( "os_detection.sc", "compliance_tests.sc", "Policy/Linux/SystemMaintenance/etc_passwd_permissions.sc", "Policy/Linux/SystemMaintenance/etc_shadow_permissions.sc", "Policy/Linux/SystemMaintenance/etc_group_permissions.sc" );
