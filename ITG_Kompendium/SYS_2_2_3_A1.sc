if(description){
	...
	script_dependencies( "smb_reg_service_pack.sc", "os_detection.sc", "Policy/Windows10/SystemServices/win_push_notifications.sc", "Policy/WindowsGeneral/ControlPanel/win_cp_input_personalization.sc", "Policy/Windows10/WindowsComponents/win_microsoft_consumer_experiences.sc", "Policy/WindowsGeneral/WindowsComponents/prevent_onedrive_file_storage.sc", "Policy/Windows10/UserTemplates/win_spotlight_lockscreen.sc", "Policy/Windows10/UserTemplates/win_spotlight_third_party.sc", "Policy/Windows10/UserTemplates/win_dignostic_data_experience.sc", "Policy/Windows10/UserTemplates/win_spotlight_features.sc" );
