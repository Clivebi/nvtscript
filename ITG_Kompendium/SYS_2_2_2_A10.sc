if(description){
	...
	script_dependencies( "smb_reg_service_pack.sc", "os_detection.sc", "Policy/WindowsGeneral/SecurityOptions/win_block_microsoft_accounts.sc", "Policy/Windows10/UserRightsAssignment/win10_allow_logon_locally.sc" );
