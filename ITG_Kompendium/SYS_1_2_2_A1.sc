if(description){
	...
	script_dependencies( "smb_reg_service_pack.sc", "os_detection.sc", "Policy/WindowsGeneral/WindowsComponents/win_microsoft_accounts_optional.sc", "Policy/WindowsGeneral/SecurityOptions/win_block_microsoft_accounts.sc", "Policy/WindowsGeneral/WindowsComponents/prevent_onedrive_file_storage.sc", "Policy/WindowsGeneral/WindowsComponents/win_install_elevated_priv.sc", "Policy/WindowsDefenderAV/win_av_local_setting_override.sc", "Policy/WindowsGeneral/WindowsComponents/win_spynet_reporting.sc" );
