if(description){
	...
	script_dependencies( "smb_reg_service_pack.sc", "os_detection.sc", "Policy/WindowsGeneral/WindowsComponents/win_powsh_script_block_log.sc", "Policy/WindowsGeneral/WindowsComponents/win_powsh_transcription.sc", "Policy/WindowsGeneral/WindowsComponents/win_powsh_execution_policy.sc", "Policy/WindowsGeneral/Audit/turn_on_module_logging.sc" );
