if(description){
	...
	script_dependencies( "os_detection.sc", "compliance_tests.sc", "Policy/Linux/Setup/noexec_option_on_dev_shm.sc", "Policy/Linux/Setup/noexec_option_on_var_tmp.sc", "Policy/Linux/Setup/noexec_option_on_tmp.sc" );
