if(description){
	...
	script_dependencies( "smb_reg_service_pack.sc", "os_detection.sc", "Policy/WindowsGeneral/System/win_access_store.sc", "Policy/Windows10/WindowsComponents/win_block_hosted_app_access_winrt.sc", "Policy/Windows10/WindowsComponents/win_store_no_apps.sc", "Policy/WindowsGeneral/WindowsComponents/win_store_app.sc" );
