...
if(ContainsString( res, "HomeMatic Zentrale" ) && ContainsString( res, "lblLicenseInformation" )){
	version = "unknown";
	...
	log_message( data: build_detection_report( app: "HomeMatic CCU2", version: version, install: "/", cpe: cpe, concluded: vers[0], concludedUrl: concUrl ), port: port );
	exit( 0 );
}
exit( 0 );
