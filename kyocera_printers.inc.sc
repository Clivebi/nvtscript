var ky_last_user, ky_last_pass;
func get_ky_detect_urls(  ){
	var ky_detect_urls;
	ky_detect_urls = make_array();
	ky_detect_urls["/"] = "var ModelName=\"([^\"]+)\"";
	ky_detect_urls["/startwlm/Start_Wlm.htm"] = "HeaderStatusPC.\"([^\"]+)\"";
	ky_detect_urls["/eng/start/about.htm"] = "PtrVal\\[0\\] = \"([^\"]+)\";";
	ky_detect_urls["/start/about.htm"] = "PtrVal\\[0\\] = \"([^\"]+)\";";
	ky_detect_urls["/eng/status/statprn.htm"] = "sVal\\[0\\] = \"([^\"]+)\";";
	ky_detect_urls["/eng/status/statprn1.htm"] = "sVal\\[0\\] = \"([^\"]+)\";";
	return ky_detect_urls;
}
func ky_default_logins(  ){
...
func check_ky_default_login( model, port ){
	var model, port;
	var ky, logins, host, useragent, _login, user_pass;
	var username, password, login_data, len, req, c_buf;
	...
	for _login in logins {
		...
		if( ky["req_type"] == "POST" ){
			req = NASLString( "POST ", ky["login_url"], " HTTP/1.1\\r\\n", "Host: ", host, "\\r\\n", "DNT: 1\\r\\n", "User-Agent: ", useragent, "\\r\\n", "Content-Type: application/x-www-form-urlencoded\\r\\n", "Content-Length: ", len, "\\r\\n", "Connection: close\\r\\n", "\\r\\n", login_data );
		}
		else {
			if(ky["req_type"] == "GET"){
				if(ky["req_auth"] == "BASIC"){
					...
					req = NASLString( "GET ", ky["login_url"], " HTTP/1.1\\r\\n", "Host: ", host, "\\r\\n" );
...
func ky_login_details( model ){
	...
	if( model == "FS-1030D" ){
		...
		if( model == "FS-9530DN" || model == "KM-2560" || model == "KM-2050" || model == "CD 1240_DC 2240" || model == "FS-2000D" || model == "FS-9130DN" || model == "KM-3060" || model == "KM-C4035E" || model == "FS-3820N" || model == "FS-3900DN" || model == "TASKalfa 221" || model == "2GR-50" || model == "KM-C2525E" || model == "KM-C2525E(J)" || model == "A3-3140_314G" || model == "A3-2640_264G" || model == "TASKalfa 181(J)" || model == "CHC-2650_265G-05" || model == "KM-2550" || model == "KM-1650(J)" || model == "KM-1820" || model == "FS-C5030N" || model == "KM-4050" || model == "FS-C5015N" || model == "KM-5050" ){
			ky_printer["req_type"] = "GET";
			...
			if( model == "FS-9500DN" || model == "FS-1920" || model == "FS-9100DN" || model == "FS-1900" || model == "FS-1000" || model == "FS-1010" || model == "Printing System (U) 30" || model == "Printing System (N) 35" || model == "Printing System (U) 50" || model == "Printing System (Q) 45" || model == "KM-2530" || model == "KM-3035(J)" || model == "KM-3035" || model == "KM-5035" || model == "KM-5035(J)" || model == "FS-3800" || model == "CHC-3035" || model == "KM-3530" || model == "A4_Cr-16PPM-04" || model == "KM-2030" || model == "FS-9120DN" || model == "FS-9520DN" || model == "FS-1300D" || model == "FS-6020" || model == "CHC-4035" || model == "KM-2531(J)" || model == "FS-1020D" || model == "FS-1120D" ){
				ky_printer["req_type"] = "GET";
				...
				if( model == "FS-6025MFP" || model == "TASKalfa 300i" || model == "FS-1128MFP" || model == "FS-C5250DN" || model == "FS-C5200DN" || model == "TASKalfa 400ci" || model == "FS-1135MFP" || model == "FS-1370DN" || model == "FS-C5100DN" || model == "FS-C2126MFP" || model == "FS-1028MFP" || model == "FS-C5150DN" || model == "FS-4020DN" || model == "FS-3925DN" || model == "FS-2020D" || model == "TASKalfa 255" || model == "FS-3920DN" || model == "FS-1035MFP" || model == "FS-C5350DN" || model == "FS-C2126MFP+" || model == "FS-C5300DN" || model == "FS-C5400DN" || model == "FS-3540MFP" || model == "FS-C8020MFP" || model == "KM-2810" || model == "TASKalfa 420i" || model == "TASKalfa 300ci" || model == "FS-C2626MFP" || model == "FS-3140MFP" || model == "FS-3640MFP" || model == "FS-C8025MFP" || model == "FS-C2026MFP+" || model == "FS-1130MFP" || model == "FS-2025D" || model == "KM-2820" ){
					...
					if( model == "TASKalfa 4500i" || model == "TASKalfa 2550ci" || model == "TASKalfa 3500i" || model == "TASKalfa 4550ci" || model == "TASKalfa 5500i" || model == "FS-4300DN" || model == "FS-6525MFP" || model == "TASKalfa 3050ci" ){
						ky_printer["req_type"] = "POST";
