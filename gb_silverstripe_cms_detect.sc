...
if(ContainsString( res, "<meta name=\"generator\" content=\"SilverStripe" ) && ContainsString( login_page, "MemberLoginForm_LoginForm" )){
	version = "unknown";
	set_kb_item( name: "silverstripe_cms/installed", value: TRUE );
	cpe = "cpe:/a:silverstripe:silverstripe";
	register_product( cpe: cpe, location: "/", port: port, service: "www" );
	log_message( data: build_detection_report( app: "SilverStripe CMS", version: version, install: "/", cpe: cpe ), port: port );
	exit( 0 );
}
exit( 0 );
