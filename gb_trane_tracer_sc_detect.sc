...
if(!vendor || !ContainsString( vendor, "Trane" )){
	exit( 0 );
}
model = get_kb_item( "bacnet/model_name" );
if(!model || !IsMatchRegexp( model, "Tracer SC" )){
	exit( 0 );
}
sw_version = "unknown";
...
log_message( data: build_detection_report( app: "Trane Tracer SC", version: sw_version, install: "47808/udp", cpe: cpe, concluded: version ), port: 47808, proto: "udp" );
exit( 0 );
