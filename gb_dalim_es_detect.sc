...
if(ContainsString( res, "dalimsoftware.png" ) && ContainsString( res, "www.dalim.com" )){
	version = "unknown";
	build = "unknown";
	...
	log_message( data: build_detection_report( app: "DALIM ES", version: version, install: "/", cpe: cpe, concluded: vers[0], extra: "Build:    " + build ), port: port );
	exit( 0 );
}
exit( 0 );
