...
if(ContainsString( res, "contec.camera.js" ) && ContainsString( res, "The room content was changed" )){
	version = "unknown";
	...
	log_message( data: build_detection_report( app: "Contec Smart Home", version: version, install: "/", cpe: cpe, concluded: vers[0] ), port: port );
	exit( 0 );
}
exit( 0 );
