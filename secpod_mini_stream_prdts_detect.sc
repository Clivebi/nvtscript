...
if(ssRVer[1] != NULL){
	...
	register_and_report_cpe( app: ssRecName, ver: ssRVer[1], base: "cpe:/a:mini-stream:shadow_stream_recorder:", expr: "^([0-9.]+)" );
}
...
if(rmTmpVer[1] != NULL){
	...
	register_and_report_cpe( app: rmTmp, ver: rmTmpVer[1], base: "cpe:/a:mini-stream:easy_rm-mp3_converter:", expr: "^([0-9.]+)" );
}
...
if(wmDownVer[1] != NULL){
	...
	register_and_report_cpe( app: wmDown, ver: wmDownVer[1], base: "cpe:/a:mini-stream:wm_downloader:", expr: "^([0-9.]+)" );
}
...
if(rmDownVer[1] != NULL){
	...
	register_and_report_cpe( app: rmDown, ver: rmDownVer[1], base: "cpe:/a:mini-stream:mini-stream_rm_downloader:", expr: "^([0-9.]+)" );
}
...
if(asx2mpVer[1] != NULL){
	...
	register_and_report_cpe( app: asx2mpName, ver: asx2mpVer[1], base: "cpe:/a:mini-stream:mini-stream_to_mp3_converter:", expr: "^([0-9.]+)" );
}
...
if(msRipperVer[1] != NULL){
	...
	register_and_report_cpe( app: msRipper, ver: msRipperVer[1], base: "cpe:/a:mini-stream:ripper:", expr: "^([0-9.]+)" );
}
item7 = "CastRipper_is1\\";
nameRipper = registry_get_sz( key: key + item7, item: "Publisher" );
if(ContainsString( nameRipper, "Mini-stream" )){
	...
	if(castripperVer[1] != NULL){
		...
		register_and_report_cpe( app: nameRipper, ver: castripperVer[1], base: "cpe:/a:mini-stream:castripper:", expr: "^([0-9.]+)" );
	}
}
exit( 0 );
