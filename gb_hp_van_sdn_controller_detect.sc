...
if(ContainsString( res, "VAN SDN Controller Login</title>" ) && ContainsString( res, "ski-input-shadow" )){
	version = "unknown";
	...
	log_message( data: build_detection_report( app: "HP VAN SDN Controller", version: version, install: "/sdn", cpe: cpe ), port: port );
	exit( 0 );
}
exit( 0 );
