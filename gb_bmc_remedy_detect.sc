...
if(ContainsString( res, "\"product\">BMC Remedy Action Request System" ) && ContainsString( res, "title>BMC&nbsp;Remedy&nbsp;Mid&nbsp;Tier" )){
	version = "unknown";
	...
	log_message( data: build_detection_report( app: "BMC Remedy", version: version, install: "/", cpe: cpe, concluded: vers[0] ), port: port );
	exit( 0 );
}
exit( 0 );
