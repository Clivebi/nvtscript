...
if(description){
  ...
  further attacks." );
	...
	script_dependencies( "gb_achievo_detect.sc" );
...
if(http_vuln_check( port: achPort, url: url, check_header: TRUE, pattern: "<script>alert\\(document\\_cookie\\)</script>", extra_check: make_list( "Achievo",
	 ">Login",
	 ">Username" ) )){
