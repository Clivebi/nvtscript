...
if(description){
	...
	script_cve_id( "CVE-2016-0154", "CVE-2016-0159", "CVE-2016-0160", "CVE-2016-0164", "CVE-2016-0166" );
...
if( hotfix_check_sp( winVista: 3, win2008: 3 ) > 0 ){
	if( version_in_range( version: iedllVer, test_version: "9.0.8112.16000", test_version2: "9.0.8112.16772" ) ){
		...
		if(version_in_range( version: iedllVer, test_version: "9.0.8112.20000", test_version2: "9.0.8112.20887" )){
		...
		if( hotfix_check_sp( win2012: 1 ) > 0 ){
			...
			if(hotfix_check_sp( win10: 1, win10x64: 1 ) > 0){
				if( version_is_less( version: iedllVer, test_version: "11.0.10240.16769" ) ){
					...
					if(version_in_range( version: iedllVer, test_version: "11.0.10586.0", test_version2: "11.0.10586.211" )){
