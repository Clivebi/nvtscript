if(description){
  ...
  SharePoint version 16.13.1 or later." );
	...
	script_dependencies( "gb_hpe_sizer_microsoft_sharepoint_detect.sc" );
	script_mandatory_keys( "HPE/sizer/microsoft/sharepoint/Win/Ver" );
	exit( 0 );
}
require("version_func.inc.sc");
require("host_details.inc.sc");
cpe_list = make_list( "cpe:/a:hp:sizer_for_microsoft_sharepoint_2010",
	 "cpe:/a:hp:sizer_for_microsoft_sharepoint_2013" );
...
path = infos["location"];
cpe = infos["cpe"];
if( ContainsString( cpe, "cpe:/a:hp:sizer_for_microsoft_sharepoint_2010" ) ){
	...
	if(ContainsString( cpe, "cpe:/a:hp:sizer_for_microsoft_sharepoint_2013" )){
