...
vers = infos["version"];
path = infos["location"];
if(version_is_less( version: vers, test_version: "0.9.6e" ) || version_is_equal( version: vers, test_version: "0.9.7-beta1" ) || version_is_equal( version: vers, test_version: "0.9.7-beta2" )){
