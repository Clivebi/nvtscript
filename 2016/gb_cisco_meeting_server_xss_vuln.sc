...
if(IsMatchRegexp( version, "^(1\\.(7|8|9))" )){
	if( version_in_range( version: version, test_version: "1.7", test_version2: "1.7.23" ) ){
		VULN = TRUE;
		fix = "1.7.24";
	}
	else {
		if( version_in_range( version: version, test_version: "1.8", test_version2: "1.8.14" ) ){
			VULN = TRUE;
			fix = "1.8.15";
		}
		else {
			if(version_in_range( version: version, test_version: "1.9", test_version2: "1.9.1" )){
				VULN = TRUE;
				fix = "1.9.2";
			}
		}
