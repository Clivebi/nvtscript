...
if(hotfix_check_sp( win10: 1, win10x64: 1, win2016: 1 ) > 0){
	if( version_is_less( version: kerVer, test_version: "10.0.10240.17202" ) ){
		...
		if( version_in_range( version: kerVer, test_version: "10.0.10586.0", test_version2: "10.0.10586.671" ) ){
			Vulnerable_range = "10.0.10586.0 - 10.0.10586.671";
			VULN = TRUE;
		}
		else {
			if(version_in_range( version: kerVer, test_version: "10.0.14393.0", test_version2: "10.0.14393.575" )){
