...
if( hotfix_check_sp( win2008: 3 ) > 0 && wgdllVer ){
	if( version_is_less( version: wgdllVer, test_version: "6.0.6002.19659" ) ){
		...
		if(version_in_range( version: wgdllVer, test_version: "6.0.6002.23000", test_version2: "6.0.6002.23973" )){
	...
	if( hotfix_check_sp( win2008r2: 2 ) > 0 && cngsysVer ){
		...
		if( hotfix_check_sp( win2012: 1 ) > 0 && cngsysVer ){
			...
			if( hotfix_check_sp( win2012R2: 1 ) > 0 && cngsysVer ){
				...
				if(hotfix_check_sp( win2012R2: 1 ) > 0 && wgdllVer){
