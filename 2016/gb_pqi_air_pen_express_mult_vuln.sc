...
if(description){
	...
	script_dependencies( "gb_pqi_air_pen_express_remote_detect.sc" );
...
if(http_vuln_check( port: port, url: url, check_header: TRUE, pattern: "staWirelessMode", extra_check: make_list( "wanConnectionMode",
	 "HostName",
	 "lan_ipaddr",
	 "WAN_MAC_ADDR" ) )){
