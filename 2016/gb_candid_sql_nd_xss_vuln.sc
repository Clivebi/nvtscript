...
if(description){
  ...
  product or replace the product by another one." );
	...
	script_dependencies( "gb_candid_remote_detect.sc" );
...
if(http_vuln_check( port: candidPort, url: url, check_header: TRUE, pattern: "You have an error in your SQL syntax", extra_check: "SQL-INJECTION-TEST" )){
