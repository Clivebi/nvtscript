if(description){
	...
	script_cve_id( "CVE-2016-3486", "CVE-2016-3501", "CVE-2016-3614", "CVE-2016-3459", "CVE-2016-5439", "CVE-2016-2105", "CVE-2016-2106" );
...
vers = infos["version"];
path = infos["location"];
if(version_in_range( version: vers, test_version: "5.6", test_version2: "5.6.30" ) || version_in_range( version: vers, test_version: "5.7", test_version2: "5.7.12" )){
