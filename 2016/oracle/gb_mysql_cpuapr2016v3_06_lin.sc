if(description){
	...
	script_cve_id( "CVE-2016-0649", "CVE-2016-0650", "CVE-2016-0644", "CVE-2016-0646", "CVE-2016-0640", "CVE-2016-0641" );
...
vers = infos["version"];
path = infos["location"];
if(version_is_less_equal( version: vers, test_version: "5.5.47" ) || version_in_range( version: vers, test_version: "5.6", test_version2: "5.6.28" ) || version_in_range( version: vers, test_version: "5.7", test_version2: "5.7.10" )){
