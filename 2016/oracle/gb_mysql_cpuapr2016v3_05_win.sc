if(description){
	...
	script_cve_id( "CVE-2016-0655", "CVE-2016-0639", "CVE-2016-0705", "CVE-2015-3197", "CVE-2016-0702", "CVE-2016-0797", "CVE-2016-0798", "CVE-2016-0799", "CVE-2016-0800" );
...
vers = infos["version"];
path = infos["location"];
if(version_in_range( version: vers, test_version: "5.6", test_version2: "5.6.29" ) || version_in_range( version: vers, test_version: "5.7", test_version2: "5.7.11" )){
