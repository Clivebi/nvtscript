...
vers = infos["version"];
path = infos["location"];
if(version_is_less_equal( version: vers, test_version: "5.5.50" ) || version_in_range( version: vers, test_version: "5.6", test_version2: "5.6.31" ) || version_in_range( version: vers, test_version: "5.7", test_version2: "5.7.13" )){
