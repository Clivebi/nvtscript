if(description){
	...
	script_cve_id( "CVE-2016-0668", "CVE-2016-0665", "CVE-2016-0661", "CVE-2015-3194", "CVE-2015-3195" );
...
vers = infos["version"];
path = infos["location"];
if(version_in_range( version: vers, test_version: "5.6", test_version2: "5.6.28" ) || version_in_range( version: vers, test_version: "5.7", test_version2: "5.7.10" )){
