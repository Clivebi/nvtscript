...
if( hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0 ){
	...
	if( hotfix_check_sp( winVista: 3, winVistax64: 3, win2008: 3, win2008x64: 3 ) > 0 ){
		if( gdiVer && version_is_less( version: gdiVer, test_version: "6.0.6002.19712" ) ){
			...
			if( gdiVer && version_in_range( version: gdiVer, test_version: "6.0.6002.24000", test_version2: "6.0.6002.24033" ) ){
				Vulnerable_range = "6.0.6002.24000 - 6.0.6002.24033";
				VULN = TRUE;
			}
			else {
				if( usrVer && version_is_less( version: usrVer, test_version: "6.0.6002.19714" ) ){
					Vulnerable_range1 = "Less than 6.0.6002.19714";
					VULN1 = TRUE;
				}
				else {
					if(usrVer && version_in_range( version: usrVer, test_version: "6.0.6002.24000", test_version2: "6.0.6002.24036" )){
			...
			if( hotfix_check_sp( win8_1: 1, win8_1x64: 1, win2012R2: 1 ) > 0 ){
				...
				if( hotfix_check_sp( win10: 1, win10x64: 1 ) > 0 ){
					if( gdiVer && version_is_less( version: gdiVer, test_version: "10.0.10240.17202" ) ){
						...
						if( gdiVer && version_in_range( version: gdiVer, test_version: "10.0.10586.0", test_version2: "10.0.10586.712" ) ){
