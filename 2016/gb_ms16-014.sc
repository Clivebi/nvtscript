if(description){
	...
	script_cve_id( "CVE-2016-0040", "CVE-2016-0041", "CVE-2016-0042", "CVE-2016-0044", "CVE-2016-0049" );
...
if( hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0 ){
	if(dllVer2){
		if( version_is_less( version: dllVer2, test_version: "6.1.7601.19117" ) ){
			...
			if(version_in_range( version: dllVer2, test_version: "6.1.7601.23000", test_version2: "6.1.7601.23320" )){
	...
	if(dllVer3){
		if( version_is_less( version: dllVer3, test_version: "2001.12.8531.19135" ) ){
			...
			if(version_in_range( version: dllVer3, test_version: "2001.12.8531.23000", test_version2: "2001.12.8531.23337" )){
	...
	if( hotfix_check_sp( winVista: 3, win2008: 3 ) > 0 ){
		if(dllVer2){
			if( version_is_less( version: dllVer2, test_version: "6.0.6002.19580" ) ){
				...
				if(version_in_range( version: dllVer2, test_version: "6.0.6002.23000", test_version2: "6.0.6002.23889" )){
		...
		if(dllVer3){
			if( version_is_less( version: dllVer3, test_version: "2001.12.6932.19580" ) ){
				...
				if(version_in_range( version: dllVer3, test_version: "2001.12.6932.23890", test_version2: "2001.12.6932.23889" )){
		...
		if( hotfix_check_sp( win2012: 1 ) > 0 ){
			if(dllVer2){
				if( version_is_less( version: dllVer2, test_version: "6.2.9200.17623" ) ){
					...
					if(version_in_range( version: dllVer2, test_version: "6.2.9200.21000", test_version2: "6.2.9200.21742" )){
			...
			if(dllVer3){
				if( version_is_less( version: dllVer3, test_version: "2001.12.10130.17623" ) ){
					...
					if(version_in_range( version: dllVer3, test_version: "2001.12.10130.21000", test_version2: "2001.12.10130.21742" )){
			...
			if( hotfix_check_sp( win8_1: 1, win8_1x64: 1, win2012R2: 1 ) > 0 ){
				...
				if(hotfix_check_sp( win10: 1, win10x64: 1 ) > 0 && dllVer4){
					if( version_is_less( version: dllVer4, test_version: "10.0.10240.16683" ) ){
						Vulnerable_range4 = "Less than 10.0.10240.16683";
						VULN4 = TRUE;
					}
					else {
						if(version_in_range( version: dllVer4, test_version: "10.0.10586.0", test_version2: "10.0.10586.102" )){
