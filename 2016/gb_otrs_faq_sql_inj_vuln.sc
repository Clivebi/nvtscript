...
stop = unixtime();
if(!ContainsString( res, "<title>FAQ -" )){
	exit( 0 );
}
latency = stop - start;
url = dir + "/public.pl";
...
for sleep in make_list( 3,
	...
	data = "Action=PublicFAQSearch&Subaction=Search&Number=&Fulltext=&Title=&Keyword=&LanguageIDs=" + query + "&VoteSearchOption=&VoteSearchType=Equals&VoteSearch=&RateSearchOption=" + "&RateSearchType=Equals&RateSearch=0&TimeSearchType=&ItemCreateTimePointStart=Last" + "&ItemCreateTimePoint=1&ItemCreateTimePointFormat=day&ItemCreateTimeStartMonth=8" + "&ItemCreateTimeStartDay=28&ItemCreateTimeStartYear=2016&ItemCreateTimeStopMonth=9" + "&ItemCreateTimeStopDay=27&ItemCreateTimeStopYear=2016&ResultForm=Normal";
