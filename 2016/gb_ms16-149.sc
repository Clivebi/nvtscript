...
if(hotfix_check_sp( winVista: 3, winVistax64: 3, win7: 2, win7x64: 2, win2008: 3, win2008x64: 3, win2008r2: 2, win2012: 1, win2012R2: 1, win8_1: 1, win8_1x64: 1, win10: 1, win10x64: 1, win2016: 1 ) <= 0){
	exit( 0 );
}
...
if( hotfix_check_sp( winVista: 3, winVistax64: 3, win2008: 3, win2008x64: 3 ) > 0 ){
	if( version_is_less( version: msiVer, test_version: "4.5.6002.19712" ) && msiVer ){
		...
		if(version_in_range( version: msiVer, test_version: "4.5.6002.23000", test_version2: "4.5.6002.24033" ) && msiVer){
	...
	if( version_is_less( version: lsVer, test_version: "6.0.6002.19701" ) && lsVer ){
		...
		if(version_in_range( version: lsVer, test_version: "6.0.6002.23000", test_version2: "6.0.6002.24042" ) && lsVer){
	...
	if( hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0 && msiVer ){
		...
		if( hotfix_check_sp( win8_1: 1, win8_1x64: 1, win2012R2: 1 ) > 0 && msiVer ){
			...
			if(hotfix_check_sp( win2012: 1 ) > 0 && msiVer){
...
if(hotfix_check_sp( win10: 1, win10x64: 1, win2016: 1 ) > 0 && msiVer){
	if( version_is_less( version: msiVer, test_version: "5.0.10240.17202" ) ){
		...
		if( version_in_range( version: msiVer, test_version: "5.0.10586.0", test_version2: "5.0.10586.712" ) ){
			Vulnerable_range1 = "5.0.10586.0 - 5.0.10586.712";
			VULN1 = TRUE;
		}
		else {
			if(version_in_range( version: msiVer, test_version: "5.0.14393.0", test_version2: "5.0.14393.575" )){
