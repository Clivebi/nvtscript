...
if(description){
	...
	script_tag( name: "summary", value: "ntopng is prone to a username enumeration vulnerability." );
	script_tag( name: "vuldetect", value: "Checks if a vulnerable version is present on the target host." );
	script_tag( name: "impact", value: "Successful exploitation will allow attackers to enumerate usernames." );
	script_tag( name: "affected", value: "ntopng 2.5.160805 and probably prior." );
...
if(version_is_less_equal( version: version, test_version: "2.5.160805" )){
