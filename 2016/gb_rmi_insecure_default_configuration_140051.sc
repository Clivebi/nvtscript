...
req = raw_string(  );
req += raw_string( 0x68, 0x74, 0x74, 0x70, 0x3a, 0x2f, 0x2f ) + this_host() + raw_string( 0x3a ) + cport;
req += "/" + rand() + "/" + rand() + ".jar";
req += raw_string( 0x01, 0x00 );
res = send_capture( socket: soc, data: req, timeout: 10, pcap_filter: "dst host " + this_host() + " and dst port " + cport + " and src host " + get_host_ip() + " and tcp[tcpflags] & (tcp-syn) != 0" );
close( soc );
if(res){
