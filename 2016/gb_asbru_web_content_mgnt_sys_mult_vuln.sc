...
if(description){
  ...
  credentials, and other malicious activities." );
	...
	script_dependencies( "gb_asbru_web_content_mgnt_sys_detect.sc" );
...
if(http_vuln_check( port: asbPort, url: url, check_header: TRUE, pattern: "<display-name>Asbru Web Content Management System</display-name>", extra_check: make_list( ">GET<",
	 ">POST<",
	 ">Configuration file<" ) )){
