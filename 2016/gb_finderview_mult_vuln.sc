...
if(description){
  ...
  release, disable respective features, remove the product or replace the product by another one." );
	...
	script_dependencies( "gb_finderview_detect.sc" );
...
if(http_vuln_check( port: find_port, url: url, check_header: TRUE, pattern: "<script>alert\\(document.cookie\\)</script>", extra_check: "README.md" )){
