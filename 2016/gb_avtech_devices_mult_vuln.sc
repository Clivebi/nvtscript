...
if(description){
  ...
  General solution options are to upgrade to a newer release, disable respective features, remove the product or replace the product by another one." );
	...
	script_dependencies( "gb_avtech_device_detect.sc" );
...
if(http_vuln_check( port: port, url: url, check_header: TRUE, pattern: "Firmware.Version=", extra_check: make_list( "MACAddress=",
	 "Product.Type=",
