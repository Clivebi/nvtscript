...
if(description){
  ...
  release, disable respective features, remove the product or replace the product by another one." );
	...
	script_dependencies( "gb_vpet_engine_detect.sc" );
...
if(http_vuln_check( port: vpet_Port, url: url, check_header: TRUE, pattern: "supplied argument is not a valid MySQL", extra_check: make_list( "VT-SQL-INJECTION-TEST",
	 "vPet Engine" ) )){
