...
if(description){
	...
	script_cve_id( "CVE-2016-0041", "CVE-2016-0059", "CVE-2016-0060", "CVE-2016-0061", "CVE-2016-0062", "CVE-2016-0063", "CVE-2016-0064", "CVE-2016-0067", "CVE-2016-0068", "CVE-2016-0069", "CVE-2016-0071", "CVE-2016-0072", "CVE-2016-0077" );
...
if( hotfix_check_sp( winVista: 3, win2008: 3 ) > 0 ){
	if( version_in_range( version: dllVer, test_version: "9.0.8112.16000", test_version2: "9.0.8112.16747" ) ){
		...
		if(version_in_range( version: dllVer, test_version: "9.0.8112.20000", test_version2: "9.0.8112.20862" )){
	...
	if( hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2, win8_1: 1, win8_1x64: 1, win2012R2: 1 ) > 0 ){
		...
		if( hotfix_check_sp( win2012: 1 ) > 0 ){
			if( version_in_range( version: dllVer, test_version: "10.0.9200.16000", test_version2: "10.0.9200.17639" ) ){
				...
				if(version_in_range( version: dllVer, test_version: "10.0.9200.20000", test_version2: "10.0.9200.21758" )){
			...
			if(hotfix_check_sp( win10: 1, win10x64: 1 ) > 0){
				if( version_is_less( version: dllVer, test_version: "11.0.10240.16683" ) ){
					...
					if(version_in_range( version: dllVer, test_version: "11.0.10586.0", test_version2: "11.0.10586.102" )){
