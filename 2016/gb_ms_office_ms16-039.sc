...
if(msPath){
	for ver in make_list( "OFFICE12",
		...
		if(msdllVer){
			...
			if(version_in_range( version: msdllVer, test_version: "14.0", test_version2: "14.0.7168.4999" ) || version_in_range( version: msdllVer, test_version: "12.0", test_version2: "12.0.6746.4999" )){
