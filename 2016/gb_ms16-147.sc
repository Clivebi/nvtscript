...
if( hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0 && usrVer ){
	...
	if( hotfix_check_sp( winVista: 3, winVistax64: 3, win2008: 3, win2008x64: 3 ) > 0 && usrVer ){
		if( version_is_less( version: usrVer, test_version: "1.626.6002.19707" ) ){
			...
			if(version_in_range( version: usrVer, test_version: "1.626.6002.24000", test_version2: "1.626.6002.24029" )){
			...
			if( hotfix_check_sp( win8_1: 1, win8_1x64: 1, win2012R2: 1 ) > 0 && gdiVer ){
				...
				if( hotfix_check_sp( win10: 1, win10x64: 1 ) > 0 && gdiVer ){
					if( version_is_less( version: gdiVer, test_version: "11.0.10240.17202" ) ){
						...
						if( version_in_range( version: gdiVer, test_version: "11.0.10586.0", test_version2: "11.0.10586.712" ) ){
