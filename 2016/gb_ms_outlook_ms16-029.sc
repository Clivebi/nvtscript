...
if(!outlookVer || !IsMatchRegexp( outlookVer, "^1[2456]\\." )){
	exit( 0 );
}
...
if(outlookFile){
	...
	if(outlookVer){
		if( version_in_range( version: outlookVer, test_version: "12.0", test_version2: "12.0.6744.4999" ) ){
			...
			if( version_in_range( version: outlookVer, test_version: "14.0", test_version2: "14.0.7167.4999" ) ){
				Vulnerable_range = "14.0 - 14.0.7167.4999";
				VULN = TRUE;
			}
			else {
				if( version_in_range( version: outlookVer, test_version: "15.0", test_version2: "15.0.4805.0999" ) ){
					Vulnerable_range = "15.0 - 15.0.4805.0999";
					VULN = TRUE;
				}
				else {
					if(version_in_range( version: outlookVer, test_version: "16.0", test_version2: "16.0.4351.0999" )){
