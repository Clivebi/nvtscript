if(description){
	...
	script_cve_id( "CVE-2016-0168", "CVE-2016-0169", "CVE-2016-0170", "CVE-2016-0184", "CVE-2016-0195" );
	...
	if( hotfix_check_sp( winVista: 3, win2008: 3 ) > 0 ){
		if( dllVer ){
			if( version_is_less( version: dllVer, test_version: "6.0.6002.19636" ) ){
				...
				if(version_in_range( version: dllVer, test_version: "6.0.6002.23000", test_version2: "6.0.6002.23949" )){
			...
			if( dllVer1 ){
				if( version_is_less( version: dllVer1, test_version: "7.0.6002.19636" ) ){
					...
					if(version_in_range( version: dllVer1, test_version: "7.0.6002.23000", test_version2: "7.0.6002.23949" )){
				...
				if(dllVer2){
					if( version_is_less( version: dllVer2, test_version: "7.0.6002.19647" ) ){
						...
						if(version_in_range( version: dllVer2, test_version: "7.0.6002.23000", test_version2: "7.0.6002.23949" )){
		...
		if( hotfix_check_sp( win2012: 1 ) > 0 ){
			if( version_is_less( version: dllVer3, test_version: "6.2.9200.21831" ) ){
				...
				if( version_is_less( version: dllVer1, test_version: "6.2.9200.21831" ) ){
					Vulnerable_range1 = "Less than 6.2.9200.21831";
					VULN1 = TRUE;
				}
				else {
					if(version_is_less( version: dllVer2, test_version: "6.2.9200.21830" )){
			...
			if( hotfix_check_sp( win8_1: 1, win8_1x64: 1, win2012R2: 1 ) > 0 ){
				...
				if(hotfix_check_sp( win10: 1, win10x64: 1 ) > 0){
					if( version_is_less( version: dllVer, test_version: "10.0.10240.16841" ) ){
						...
						if(version_in_range( version: dllVer, test_version: "10.0.10586.0", test_version2: "10.0.10586.305" )){
