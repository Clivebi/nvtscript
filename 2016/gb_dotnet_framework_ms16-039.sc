...
if(hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2, win2012: 1, win8_1: 1, win8_1x64: 1, win2012R2: 1, winVista: 3, win2008: 3 ) <= 0){
	exit( 0 );
}
	...
	if( hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2, win2012: 1, win8_1: 1, win8_1x64: 1, win2012R2: 1 ) > 0 ){
		...
		if(hotfix_check_sp( winVista: 3, win2008: 3 ) > 0){
			if( version_in_range( version: dllVer, test_version: "3.0.6920.4000", test_version2: "3.0.6920.4234" ) ){
				...
				if(version_in_range( version: dllVer, test_version: "3.0.6920.8000", test_version2: "3.0.6920.8711" )){
					VULN = TRUE;
