...
if(description){
	...
	script_name( "Adobe Flash Player Security Update (apsb16-25) - MAC OS X" );
  ...
  18.0.0.366 and 21.x before 22.0.0.209." );
	script_tag( name: "solution", value: "Update to version 18.0.0.366, 22.0.0.209 or later." );
...
vers = infos["version"];
path = infos["location"];
if( version_in_range( version: vers, test_version: "21", test_version2: "22.0.0.208" ) ){
	fix = "22.0.0.209";
	VULN = TRUE;
}
else {
	if(version_is_less( version: vers, test_version: "18.0.0.366" )){
		fix = "18.0.0.366";
		VULN = TRUE;
	}
}
