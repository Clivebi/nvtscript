...
if(description){
	...
	script_name( "Mozilla Firefox ESR Security Update (mfsa_2016-39_2016-48 2) - Mac OS X" );
  ...
  and to execute arbitrary code." );
	script_tag( name: "affected", value: "Mozilla Firefox ESR version 45.x before 45.1." );
...
vers = infos["version"];
path = infos["location"];
if(version_is_equal( version: vers, test_version: "45.0" )){
