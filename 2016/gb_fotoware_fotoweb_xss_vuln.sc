...
if(description){
  ...
  later." );
	...
	script_dependencies( "gb_fotoware_fotoweb_detect.sc" );
...
url = dir + "/views/login?to=/fotoweb/%22;}%20else%20{%20alert%28document.cookie%29;%20}" + "%20if%20%28inIframe%28%29%29%20{%20var%20relleno=%22";
if(http_vuln_check( port: fbPort, url: url, check_header: TRUE, pattern: "alert\\(document.cookie\\);", extra_check: make_list( "Log in to FotoWeb",
	 ">Password" ) )){
