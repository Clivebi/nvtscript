...
if(description){
	...
	script_name( "Adobe Flash Player Security Update (apsb16-29) - Linux" );
  ...
  11.2.202.635." );
	script_tag( name: "solution", value: "Update to version 11.2.202.635 or later." );
...
vers = infos["version"];
path = infos["location"];
if(version_is_less( version: vers, test_version: "11.2.202.635" )){
	report = report_fixed_ver( installed_version: vers, fixed_version: "11.2.202.635", install_path: path );
