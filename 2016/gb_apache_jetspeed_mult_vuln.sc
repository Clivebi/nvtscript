...
if(description){
	...
	script_cve_id( "CVE-2016-0709", "CVE-2016-0710", "CVE-2016-0711", "CVE-2016-0712", "CVE-2016-2171" );
	...
	script_tag( name: "severity_date", value: "2016-04-20 18:14:00 +0000 (Wed, 20 Apr 2016)" );
  ...
  - ---" );
	...
	script_dependencies( "gb_apache_jetspeed_detect.sc" );
...
if(http_vuln_check( port: jetPort, url: url, check_header: TRUE, pattern: "alert\\(document\\.cookie\\)", extra_check: make_list( "Jetspeed",
	 "Username",
	 "Password" ) )){
