...
if(description){
	...
	script_tag( name: "affected", value: "All 7.2 releases, all 7.3 releases, all 7.4 releases prior to
  7.4.140.0(MD), all 7.5 releases, all 7.6 releases and all 8.0 releases prior to 8.0.115.0(ED)." );
...
if(IsMatchRegexp( vers, "^7\\.[2356]" )){
	fix = "8.0.132.0";
}
if(IsMatchRegexp( vers, "^7\\.4" )){
	if(version_is_less( version: vers, test_version: "7.4.140.0" )){
		fix = "7.4.140.0(MD)";
	}
}
if(IsMatchRegexp( vers, "^8\\.0" )){
	if(version_is_less( version: vers, test_version: "8.0.115.0" )){
		fix = "8.0.115.0(ED)";
	}
}
if(fix){
