...
if( hotfix_check_sp( winVista: 3, winVistax64: 3, win2008x64: 3, win2008: 3 ) > 0 ){
	if(kerVer){
		if(version_is_less( version: kerVer, test_version: "6.0.6002.19697" ) || version_in_range( version: kerVer, test_version: "6.0.6002.23000", test_version2: "6.0.6002.24019" )){
			VULN = TRUE;
		}
	}
}
