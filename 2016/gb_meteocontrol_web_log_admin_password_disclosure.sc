...
if(description){
	...
	script_tag( name: "last_modification", value: "2021-09-17 12:31:03 +0000 (Fri, 17 Sep 2021)" );
	...
	script_dependencies( "gb_Meteocontrol_detect.sc" );
...
if(IsMatchRegexp( buf, "^HTTP/1\\.[01] 200" ) && ( IsMatchRegexp( buf, "szWebAdminPassword" ) || IsMatchRegexp( buf, "/Admin Monitoring/" ) )){
