...
if(description){
  ...
  release, disable respective features, remove the product or replace the product by another one." );
	...
	script_dependencies( "gb_dorg_detect.sc" );
...
url = dir + "/results.php?q=%27%22%3C%2fscript%3E%3Cscript%3Ealert%28docum" + "ent.cookie%29%3C%2fscript%3E&search=Search&type=3";
if(http_vuln_check( port: dorgPort, url: url, check_header: TRUE, pattern: "<script>alert\\(document.cookie\\)</script>", extra_check: make_list( "DORG Search results</title",
	 "dorg.png" ) )){
