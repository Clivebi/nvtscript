...
if(description){
	...
	script_cve_id( "CVE-2012-3306", "CVE-2012-3304", "CVE-2012-3311", "CVE-2012-3325", "CVE-2012-4853" );
...
if( version_in_range( version: wasVer, test_version: "6.1", test_version2: "6.1.0.44" ) ){
	...
	if( version_in_range( version: wasVer, test_version: "7.0", test_version2: "7.0.0.24" ) ){
		fix = "7.0.0.25";
		VULN = TRUE;
	}
	else {
		if( version_in_range( version: wasVer, test_version: "8.0", test_version2: "8.0.0.4" ) ){
			fix = "8.0.0.5";
			VULN = TRUE;
		}
		else {
			if(version_in_range( version: wasVer, test_version: "8.5", test_version2: "8.5.0.0" )){
				fix = "8.5.0.1";
				VULN = TRUE;
			}
		}
