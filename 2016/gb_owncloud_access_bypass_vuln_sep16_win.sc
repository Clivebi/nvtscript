...
if(IsMatchRegexp( ownVer, "^(8|7|6)" )){
	if( version_is_less( version: ownVer, test_version: "6.0.9" ) ){
		fix = "6.0.9";
		VULN = TRUE;
	}
	else {
		if( version_in_range( version: ownVer, test_version: "7.0.0", test_version2: "7.0.6" ) ){
			fix = "7.0.7";
			VULN = TRUE;
		}
		else {
			if(version_in_range( version: ownVer, test_version: "8.0.0", test_version2: "8.0.4" )){
				fix = "8.0.5";
				VULN = TRUE;
			}
		}
