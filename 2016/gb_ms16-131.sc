...
if(hotfix_check_sp( winVista: 3, winVistax64: 3, win7: 2, win7x64: 2, win2008r2: 2, win2012R2: 1, win8_1: 1, win8_1x64: 1, win10: 1, win10x64: 1 ) <= 0){
	exit( 0 );
}
...
if( hotfix_check_sp( win8_1: 1, win8_1x64: 1, win2012R2: 1 ) > 0 ){
	...
	if( hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0 ){
		...
		if( hotfix_check_sp( winVista: 3, winVistax64: 3 ) > 0 && msvDll ){
			if( version_is_less( version: msvDll, test_version: "6.5.6002.19700" ) ){
				Vulnerable_range1 = "Less than 6.5.6002.19700";
				VULN1 = TRUE;
			}
			else {
				if(version_in_range( version: msvDll, test_version: "6.5.6002.23000", test_version2: "6.5.6002.24023" )){
