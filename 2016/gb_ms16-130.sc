...
if( hotfix_check_sp( win8_1: 1, win8_1x64: 1, win2012R2: 1 ) > 0 && sysVer ){
	...
	if( hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0 && sysVer ){
		...
		if( hotfix_check_sp( win2012: 1 ) > 0 ){
			...
			if(ctfdll){
				if( version_is_less( version: ctfdll, test_version: "6.0.6002.19705" ) ){
					...
					if(version_in_range( version: ctfdll, test_version: "6.0.6002.23000", test_version2: "6.0.6002.24027" )){
			...
			if( hotfix_check_sp( winVista: 3, winVistax64: 3, win2008: 3, win2008x64: 3 ) > 0 && asyVer ){
				if( version_is_less( version: asyVer, test_version: "6.0.6002.19700" ) ){
					Vulnerable_range3 = "Less than 6.0.6002.19700";
					VULN3 = TRUE;
				}
				else {
					if(version_in_range( version: asyVer, test_version: "6.0.6002.23000", test_version2: "6.0.6002.24023" )){
				...
				if(hotfix_check_sp( win10: 1, win10x64: 1 ) > 0 && edgeVer){
					if( version_is_less( version: edgeVer, test_version: "11.0.10240.17184" ) ){
						...
						if( version_in_range( version: edgeVer, test_version: "11.0.10586.0", test_version2: "11.0.10586.671" ) ){
							Vulnerable_range2 = "11.0.10586.0 - 11.0.10586.671";
							VULN2 = TRUE;
						}
						else {
							if(version_in_range( version: edgeVer, test_version: "11.0.14393.0", test_version2: "11.0.14393.446" )){
