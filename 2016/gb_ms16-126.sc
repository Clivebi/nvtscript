...
if( hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0 && Win32Ver ){
	...
	if( hotfix_check_sp( winVista: 3, winVistax64: 3, win2008: 3, win2008x64: 3 ) > 0 && oleVer ){
		if( version_is_less( version: oleVer, test_version: "6.0.6002.19694" ) ){
			Vulnerable_range1 = "Less than 6.0.6002.19694";
			VULN1 = TRUE;
		}
		else {
			if(version_in_range( version: oleVer, test_version: "6.0.6002.23000", test_version2: "6.0.6002.24017" )){
		...
		if( hotfix_check_sp( win2012: 1 ) > 0 && Win32Ver ){
			...
			if( hotfix_check_sp( win2012R2: 1, win8_1: 1, win8_1x64: 1 ) > 0 && Win32Ver ){
