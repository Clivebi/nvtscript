...
was installed from, see advisory." );
	...
	script_family( "CISCO" );
	script_dependencies( "gb_cisco_webexarf_detect_win.sc" );
...
vers = infos["version"];
path = infos["location"];
if(version_in_range( version: vers, test_version: "27", test_version2: "27.32.15" ) || version_in_range( version: vers, test_version: "28", test_version2: "28.11" ) || version_in_range( version: vers, test_version: "29", test_version2: "29.1" )){
