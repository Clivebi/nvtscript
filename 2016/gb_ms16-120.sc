if(description){
	...
	script_cve_id( "CVE-2016-3209", "CVE-2016-3262", "CVE-2016-3263", "CVE-2016-3270", "CVE-2016-3393", "CVE-2016-3396", "CVE-2016-7182" );
		...
		if( hotfix_check_sp( win2012: 1 ) > 0 ){
			...
			if( hotfix_check_sp( winVista: 3, winVistax64: 3, win2008: 3, win2008x64: 3 ) > 0 ){
				if( version_is_less( version: sysVer, test_version: "6.0.6002.19693" ) ){
					...
					if(version_in_range( version: sysVer, test_version: "6.0.6002.23000", test_version2: "6.0.6002.24016" )){
