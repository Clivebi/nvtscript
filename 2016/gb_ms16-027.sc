...
if( hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0 ){
	if(sysVer1){
		if( version_is_less( version: sysVer1, test_version: "12.0.7601.19148" ) ){
			...
			if(version_in_range( version: sysVer1, test_version: "12.0.7601.23000", test_version2: "12.0.7601.23347" )){
	...
	if(sysVer2){
		if( version_is_less( version: sysVer2, test_version: "12.0.7601.19145" ) ){
			...
			if(version_in_range( version: sysVer2, test_version: "12.0.7601.23000", test_version2: "12.0.7601.23345" )){
		...
		if( hotfix_check_sp( win2012: 1 ) > 0 ){
			if(sysVer1){
				if( version_is_less( version: sysVer1, test_version: "12.0.9200.17648" ) ){
					...
					if(version_in_range( version: sysVer1, test_version: "12.0.9200.21000", test_version2: "12.0.9200.21766" )){
			...
			if(sysVer2){
				if( version_is_less( version: sysVer2, test_version: "12.0.9200.17647" ) ){
					...
					if(version_in_range( version: sysVer2, test_version: "12.0.9200.21000", test_version2: "12.0.9200.21765" )){
			...
			if(hotfix_check_sp( win10: 1, win10x64: 1 ) > 0 && sysVer1){
				if( version_is_less( version: sysVer1, test_version: "12.0.10240.16724" ) ){
					Vulnerable_range1 = "Less than 12.0.10240.16724";
					VULN1 = TRUE;
				}
				else {
					if(version_in_range( version: sysVer1, test_version: "12.0.10586.0", test_version2: "12.0.10586.161" )){
