...
if(description){
	...
	script_cve_id( "CVE-2016-2038", "CVE-2016-2039", "CVE-2016-2040", "CVE-2016-2041", "CVE-2016-1927" );
...
if(http_vuln_check( port: http_port, url: url, check_header: TRUE, pattern: "Fatal error.*PMA_fatalError.*common.inc.php" )){
