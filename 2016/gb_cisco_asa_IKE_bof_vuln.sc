...
if( IsMatchRegexp( cisVer, "^(7\\.2)|^(8\\.0)|^(8\\.1)|^(8\\.3)|^(8\\.6)" ) ){
	fix = "9.1(6.11)";
	VULN = TRUE;
}
else {
	if( IsMatchRegexp( cisVer, "^(8\\.2)" ) ){
