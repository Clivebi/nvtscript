if(description){
	...
	script_cve_id( "CVE-2016-3348", "CVE-2016-3349", "CVE-2016-3354", "CVE-2016-3355", "CVE-2016-3356" );
...
if( hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0 ){
	...
	if( hotfix_check_sp( winVista: 3, winVistax64: 3, win2008: 3, win2008x64: 3 ) > 0 ){
		if( version_is_less( version: win32kVer, test_version: "6.0.6002.19681" ) ){
			...
			if(version_in_range( version: win32kVer, test_version: "6.0.6002.24000", test_version2: "6.0.6002.24007" )){
			...
			if( hotfix_check_sp( win8_1: 1, win8_1x64: 1, win2012R2: 1 ) > 0 ){
				...
				if(hotfix_check_sp( win10: 1, win10x64: 1 ) > 0){
					if( version_is_less( version: win32kVer, test_version: "10.0.10240.16384" ) ){
						...
						if(version_in_range( version: win32kVer, test_version: "10.0.10586.0", test_version2: "10.0.10586.19" )){
