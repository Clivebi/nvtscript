...
if(description){
	...
	script_name( "Adobe Flash Player Security Update (apsb16-15) - Linux" );
  ...
  11.2.202.621." );
	script_tag( name: "solution", value: "Update to version 11.2.202.621 or later." );
...
vers = infos["version"];
path = infos["location"];
if(version_is_less( version: vers, test_version: "11.2.202.621" )){
	report = report_fixed_ver( installed_version: vers, fixed_version: "11.2.202.621", install_path: path );
