...
if(description){
	...
	script_cve_id( "CVE-2016-3267", "CVE-2016-3298", "CVE-2016-3331", "CVE-2016-3382", "CVE-2016-3383", "CVE-2016-3384", "CVE-2016-3385", "CVE-2016-3387", "CVE-2016-3388", "CVE-2016-3390", "CVE-2016-3391" );
	script_bugtraq_id( 93376, 93386, 93387, 93397, 93396, 93382, 93383, 93393, 93392, 93379, 93381 );
...
if( hotfix_check_sp( winVista: 3, win2008: 3, winVistax64: 3, win2008x64: 3 ) > 0 ){
	if( version_in_range( version: iedllVer, test_version: "9.0.8112.16000", test_version2: "9.0.8112.16829" ) ){
		...
		if(version_in_range( version: iedllVer, test_version: "9.0.8112.20000", test_version2: "9.0.8112.20946" )){
		...
		if( hotfix_check_sp( win8_1: 1, win8_1x64: 1, win2012R2: 1, win7: 2, win7x64: 2, win2008r2: 2 ) > 0 ){
			...
			if(hotfix_check_sp( win10: 1, win10x64: 1 ) > 0){
				if( version_is_less( version: iedllVer, test_version: "11.0.10240.17146" ) ){
					...
					if( version_in_range( version: edgedllVer, test_version: "11.0.10586.0", test_version2: "11.0.10586.632" ) ){
						Vulnerable_range2 = "11.0.10586.0 - 11.0.10586.632";
						VULN2 = TRUE;
					}
					else {
						if(version_in_range( version: edgedllVer, test_version: "11.0.14393.0", test_version2: "11.0.14393.320" )){
