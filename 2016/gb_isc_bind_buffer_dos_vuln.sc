...
if( version_in_range( version: version, test_version: "9.0.0", test_version2: "9.8.8" ) || version_in_range( version: version, test_version: "9.9.0", test_version2: "9.9.7p2" ) ){
	fix = "9.9.7-P3";
	VULN = TRUE;
}
else {
	if(version_in_range( version: version, test_version: "9.10", test_version2: "9.10.2p3" )){
		fix = "9.10.2-P4";
		VULN = TRUE;
	}
}
