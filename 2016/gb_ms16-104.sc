...
if(description){
	...
	script_cve_id( "CVE-2016-3247", "CVE-2016-3291", "CVE-2016-3292", "CVE-2016-3295", "CVE-2016-3297", "CVE-2016-3324", "CVE-2016-3325", "CVE-2016-3351", "CVE-2016-3353", "CVE-2016-3375" );
...
if( hotfix_check_sp( winVista: 3, win2008: 3, winVistax64: 3, win2008x64: 3 ) > 0 ){
	if( version_in_range( version: iedllVer, test_version: "9.0.8112.16000", test_version2: "9.0.8112.16818" ) ){
		...
		if(version_in_range( version: iedllVer, test_version: "9.0.8112.20000", test_version2: "9.0.8112.20940" )){
			...
			if( hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0 ){
				...
				if(hotfix_check_sp( win10: 1, win10x64: 1 ) > 0){
					if( version_in_range( version: iedllVer, test_version: "11.0.10586.0", test_version2: "11.0.10586.588" ) ){
						...
						if(version_is_less( version: iedllVer, test_version: "11.0.10240.17113" )){
