...
if(description){
	...
	script_cve_id( "CVE-2015-3144", "CVE-2015-3145", "CVE-2014-8151", "CVE-2014-3613", "CVE-2014-3620", "CVE-2015-3143", "CVE-2015-3148", "CVE-2015-3153", "CVE-2014-3707", "CVE-2014-8150", "CVE-2014-0015" );
...
if(IsMatchRegexp( version, "^12" )){
	if( revcomp( a: version, b: "12.1X46-D50" ) < 0 ){
		...
		if( ( revcomp( a: version, b: "12.1X47-D40" ) < 0 ) && ( revcomp( a: version, b: "12.1X47" ) >= 0 ) ){
			report = report_fixed_ver( installed_version: version, fixed_version: "12.1X47-D40" );
			security_message( port: 0, data: report );
			exit( 0 );
		}
		else {
			if( ( revcomp( a: version, b: "12.3R11" ) < 0 ) && ( revcomp( a: version, b: "12.3" ) >= 0 ) ){
				report = report_fixed_ver( installed_version: version, fixed_version: "12.3R11" );
				security_message( port: 0, data: report );
				exit( 0 );
			}
			else {
				if(( revcomp( a: version, b: "12.3X48-D30" ) < 0 ) && ( revcomp( a: version, b: "12.3X48" ) >= 0 )){
...
if(IsMatchRegexp( version, "^13" )){
	if( revcomp( a: version, b: "13.2R9" ) < 0 ){
		...
		if( ( revcomp( a: version, b: "13.2X51-D39" ) < 0 ) && ( revcomp( a: version, b: "13.2X51" ) >= 0 ) ){
...
if(IsMatchRegexp( version, "^14" )){
	if( revcomp( a: version, b: "14.1R6" ) < 0 ){
		...
		if( ( revcomp( a: version, b: "14.1X53-D30" ) < 0 ) && ( revcomp( a: version, b: "14.1X53" ) >= 0 ) ){
...
if(IsMatchRegexp( version, "^15" )){
	if( revcomp( a: version, b: "15.1R2" ) < 0 ){
		...
		if( ( revcomp( a: version, b: "15.1X49-D40" ) < 0 ) && ( revcomp( a: version, b: "14.1X49" ) >= 0 ) ){
			report = report_fixed_ver( installed_version: version, fixed_version: "15.1X49-D40" );
			security_message( port: 0, data: report );
			exit( 0 );
		}
		else {
			if(( revcomp( a: version, b: "15.1X53-D35" ) < 0 ) && ( revcomp( a: version, b: "15.1X53" ) >= 0 )){
