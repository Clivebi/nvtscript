...
if(description){
	...
	script_cve_id( "CVE-2014-2434", "CVE-2014-2442", "CVE-2014-2444", "CVE-2014-2450", "CVE-2014-2451" );
...
if(IsMatchRegexp( vers, "^5\\.6" ) && version_in_range( version: vers, test_version: "5.6", test_version2: "5.6.15" )){
