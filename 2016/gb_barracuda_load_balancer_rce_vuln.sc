...
if(description){
	...
	script_dependencies( "gb_barracuda_load_balancer_detect.sc" );
	script_mandatory_keys( "barracuda/loadbalancer/detected" );
	script_tag( name: "summary", value: "Barracuda Load Balancer is prone to a remote code execution vulnerability." );
