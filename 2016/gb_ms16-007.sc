if(description){
	...
	script_cve_id( "CVE-2016-0014", "CVE-2016-0015", "CVE-2016-0016", "CVE-2016-0018", "CVE-2016-0019", "CVE-2016-0020" );
...
if( hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0 ){
	if(dllVer1){
		if( version_is_less( version: dllVer1, test_version: "6.1.7601.19091" ) ){
			...
			if(version_in_range( version: dllVer1, test_version: "6.1.7601.23000", test_version2: "6.1.7601.23289" )){
	...
	if(dllVer3){
		if( version_is_less( version: dllVer3, test_version: "6.6.7601.19091" ) ){
			...
			if(version_in_range( version: dllVer3, test_version: "6.6.7601.23000", test_version2: "6.6.7601.23289" )){
	...
	if( hotfix_check_sp( winVista: 3, win2008: 3 ) > 0 ){
		if(dllVer1){
			if( version_is_less( version: dllVer1, test_version: "6.0.6002.19555" ) ){
				...
				if(version_in_range( version: dllVer1, test_version: "6.0.6002.23000", test_version2: "6.0.6002.23864" )){
		...
		if(dllVer2){
			if( version_is_less( version: dllVer2, test_version: "6.6.6002.19554" ) ){
				...
				if(version_in_range( version: dllVer2, test_version: "6.6.6002.23000", test_version2: "6.6.6002.23863" )){
		...
		if(dllVer3){
			if( version_is_less( version: dllVer3, test_version: "6.6.6002.19554" ) ){
				...
				if(version_in_range( version: dllVer3, test_version: "6.6.6002.23000", test_version2: "6.6.6002.23863" )){
		...
		if( hotfix_check_sp( win8: 1, win8x64: 1 ) > 0 ){
			if( hotfix_check_sp( win8: 1 ) > 0 && dllVer1 ){
				if( version_is_less( version: dllVer1, test_version: "6.2.9200.17592" ) ){
					...
					if(version_in_range( version: dllVer1, test_version: "6.2.9200.21000", test_version2: "6.2.9200.21712" )){
				...
				if(hotfix_check_sp( win8x64: 1 ) > 0 && dllVer6){
					if( version_is_less( version: dllVer6, test_version: "6.2.9200.17591" ) ){
						...
						if(version_in_range( version: dllVer6, test_version: "6.2.9200.21000", test_version2: "6.2.9200.21713" )){
			...
			if(dllVer2){
				if( version_is_less( version: dllVer2, test_version: "6.6.9200.17590" ) ){
					...
					if(version_in_range( version: dllVer2, test_version: "6.6.9200.21000", test_version2: "6.6.9200.21707" )){
			...
			if(dllVer3){
				if( version_is_less( version: dllVer3, test_version: "6.6.9200.17590" ) ){
					...
					if(version_in_range( version: dllVer3, test_version: "6.6.9200.21000", test_version2: "6.6.9200.21707" )){
				...
				if( hotfix_check_sp( win8_1: 1, win8_1x64: 1, win2012R2: 1 ) > 0 ){
					...
					if(hotfix_check_sp( win10: 1, win10x64: 1 ) > 0 && dllVer2){
						if( version_is_less( version: dllVer2, test_version: "10.0.10240.16644" ) ){
							...
							if(version_in_range( version: dllVer2, test_version: "10.0.10586.0", test_version2: "10.0.10586.62" )){
