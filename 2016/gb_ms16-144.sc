...
if(description){
	...
	script_cve_id( "CVE-2016-7202", "CVE-2016-7278", "CVE-2016-7279", "CVE-2016-7281", "CVE-2016-7282", "CVE-2016-7283", "CVE-2016-7284", "CVE-2016-7287" );
...
if(hotfix_check_sp( winVista: 3, winVistax64: 3, win2008x64: 3, win7: 2, win7x64: 2, win2008: 3, win2008r2: 2, win2012: 1, win2012R2: 1, win8_1: 1, win8_1x64: 1, win10: 1, win10x64: 1, win2016: 1 ) <= 0){
	exit( 0 );
}
...
if( hotfix_check_sp( winVista: 3, win2008: 3, winVistax64: 3, win2008x64: 3 ) > 0 ){
	if( version_in_range( version: iedllVer, test_version: "9.0.8112.16000", test_version2: "9.0.8112.16844" ) ){
		...
		if(version_in_range( version: iedllVer, test_version: "9.0.8112.20000", test_version2: "9.0.8112.20961" )){
		...
		if( hotfix_check_sp( win8_1: 1, win8_1x64: 1, win2012R2: 1, win7: 2, win7x64: 2, win2008r2: 2 ) > 0 ){
			...
			if( hotfix_check_sp( win10: 1, win10x64: 1 ) > 0 ){
				if( version_is_less( version: iedllVer, test_version: "11.0.10240.17202" ) ){
					...
					if( version_in_range( version: iedllVer, test_version: "11.0.10586.0", test_version2: "11.0.10586.712" ) ){
				...
				if(( hotfix_check_sp( win2016: 1 ) > 0 )){
					if(version_in_range( version: iedllVer, test_version: "11.0.14393.0", test_version2: "11.0.14393.575" )){
