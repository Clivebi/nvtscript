...
if( hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0 ){
	...
	if( hotfix_check_sp( winVista: 3, winVistax64: 3, win2008: 3, win2008x64: 3 ) > 0 ){
		if( version_is_less( version: dllVer, test_version: "6.0.6002.19668" ) ){
			...
			if(version_in_range( version: dllVer, test_version: "6.0.6002.23000", test_version2: "6.0.6002.23983" )){
			...
			if( hotfix_check_sp( win8_1: 1, win8_1x64: 1, win2012R2: 1 ) > 0 ){
				...
				if(hotfix_check_sp( win10: 1, win10x64: 1 ) > 0){
					if( version_is_less( version: dllVer, test_version: "10.0.10240.17071" ) ){
						...
						if(version_in_range( version: dllVer, test_version: "10.0.10586.0", test_version2: "10.0.10586.544" )){
