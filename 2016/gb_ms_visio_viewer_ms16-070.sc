...
if(IsMatchRegexp( vvVer, "^(12|14)\\..*" )){
	if( IsMatchRegexp( vvVer, "^12" ) ){
		Vulnerable_range = "12 - 12.0.6676.4999";
	}
	else {
		if(IsMatchRegexp( vvVer, "^14" )){
			Vulnerable_range = "14 - 14.0.7163.4999";
		}
	}
	if(version_in_range( version: vvVer, test_version: "14.0", test_version2: "14.0.7163.4999" ) || version_in_range( version: vvVer, test_version: "12.0", test_version2: "12.0.6676.4999" )){
