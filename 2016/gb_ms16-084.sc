...
if(description){
	...
	script_cve_id( "CVE-2016-3204", "CVE-2016-3240", "CVE-2016-3241", "CVE-2016-3242", "CVE-2016-3243", "CVE-2016-3245", "CVE-2016-3248", "CVE-2016-3259", "CVE-2016-3260", "CVE-2016-3261", "CVE-2016-3264", "CVE-2016-3273", "CVE-2016-3274", "CVE-2016-3276", "CVE-2016-3277" );
	script_bugtraq_id( 91584, 91568, 91569, 91570, 91571, 91585, 91578, 91581, 91580, 91575, 91598, 91576, 91591, 91593, 91596 );
...
if( hotfix_check_sp( winVista: 3, win2008: 3, winVistax64: 3, win2008x64: 3 ) > 0 ){
	if( version_in_range( version: iedllVer, test_version: "9.0.8112.16000", test_version2: "9.0.8112.16799" ) ){
		...
		if(version_in_range( version: iedllVer, test_version: "9.0.8112.20000", test_version2: "9.0.8112.20914" )){
			...
			if( hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0 ){
				...
				if(hotfix_check_sp( win10: 1, win10x64: 1 ) > 0){
					if( version_in_range( version: iedllVer, test_version: "11.0.10586.0", test_version2: "11.0.10586.493" ) ){
						...
						if(version_is_less( version: iedllVer, test_version: "11.0.10240.17022" )){
