...
if( hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0 ){
	if(dllVer){
		if( version_is_less( version: dllVer, test_version: "6.1.7601.19091" ) ){
			...
			if(version_in_range( version: dllVer, test_version: "6.1.7601.23000", test_version2: "6.1.7601.23289" )){
	...
	if(sysVer){
		if( version_is_less( version: sysVer, test_version: "6.1.7601.19091" ) ){
			...
			if(sysVer && version_in_range( version: sysVer, test_version: "6.1.7601.23000", test_version2: "6.1.7601.23289" )){
				Vulnerable_range = "6.1.7601.23000 - 6.1.7601.23289";
				VULN2 = TRUE;
			}
		}
	...
	if( hotfix_check_sp( winVista: 3, win2008: 3 ) > 0 ){
		if(dllVer){
			if( version_is_less( version: dllVer, test_version: "6.0.6002.19554" ) ){
				...
				if(version_in_range( version: dllVer, test_version: "6.0.6002.23000", test_version2: "6.0.6002.23863" )){
		...
		if(sysVer){
			if( version_is_less( version: sysVer, test_version: "6.0.6002.19554" ) ){
				...
				if(version_in_range( version: sysVer, test_version: "6.0.6002.23000", test_version2: "6.0.6002.23863" )){
					Vulnerable_range = "6.0.6002.23000 - 6.0.6002.23863";
					VULN2 = TRUE;
				}
			}
		...
		if( hotfix_check_sp( win8: 1 ) > 0 && dllVer ){
			if( version_is_less( version: dllVer, test_version: "6.2.9200.17592" ) ){
				...
				if(version_in_range( version: dllVer, test_version: "6.2.9200.21000", test_version2: "6.2.9200.21712" )){
			...
			if( hotfix_check_sp( win8x64: 1, win2012: 1 ) > 0 && dllVer3 ){
				if( version_is_less( version: dllVer3, test_version: "6.2.9200.17591" ) ){
					...
					if(version_in_range( version: dllVer3, test_version: "6.2.9200.21000", test_version2: "6.2.9200.21713" )){
				...
				if( hotfix_check_sp( win8_1: 1, win8_1x64: 1, win2012R2: 1 ) > 0 && dllVer ){
					...
					if(hotfix_check_sp( win10: 1, win10x64: 1 ) > 0 && dllVer){
						if( version_is_less( version: dllVer, test_version: "10.0.10240.16644" ) ){
							Vulnerable_range = "Less than 10.0.10240.16644";
							VULN1 = TRUE;
						}
						else {
							if(version_in_range( version: dllVer, test_version: "10.0.10586.0", test_version2: "10.0.10586.62" )){
