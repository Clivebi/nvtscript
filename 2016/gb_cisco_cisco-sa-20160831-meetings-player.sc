...
player was installed from, see advisory." );
	...
	script_family( "CISCO" );
	script_dependencies( "gb_cisco_webexwrf_detect_win.sc" );
...
vers = infos["version"];
path = infos["location"];
if(version_in_range( version: vers, test_version: "29", test_version2: "29.13.111" ) || version_in_range( version: vers, test_version: "30", test_version2: "30.12.0" ) || version_in_range( version: vers, test_version: "31", test_version2: "31.5.19" )){
