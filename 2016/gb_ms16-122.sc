...
if(hotfix_check_sp( winVista: 3, win7: 2, win7x64: 2, winVistax64: 3, win8_1: 1, win8_1x64: 1, win10: 1, win10x64: 1 ) <= 0){
	exit( 0 );
}
...
if( IsMatchRegexp( vidVer, "^6\\.5\\.6002\\.1" ) ){
	Vulnerable_range = "Less than 6.5.6002.19689";
}
else {
	if( IsMatchRegexp( vidVer, "^6\\.5\\.6002\\.2" ) ){
		Vulnerable_range = "6.5.6002.23000 - 6.5.6002.24013";
	}
	else {
		if( IsMatchRegexp( vidVer, "^6\\.5\\.7601" ) ){
			Vulnerable_range = "Less than 6.5.7601.23544";
		}
		else {
			if(IsMatchRegexp( vidVer, "^6\\.5\\.9600\\.1" )){
...
if( hotfix_check_sp( winVista: 3, winVistax64: 3 ) > 0 ){
	if(version_is_less( version: vidVer, test_version: "6.5.6002.19689" ) || version_in_range( version: vidVer, test_version: "6.5.6002.23000", test_version2: "6.5.6002.24013" )){
		VULN = TRUE;
	}
}
else {
...
if(hotfix_check_sp( win10: 1, win10x64: 1 ) > 0){
	if( version_is_less( version: edgVer, test_version: "11.0.10240.17146" ) ){
		...
		if( version_in_range( version: edgVer, test_version: "11.0.10586.0", test_version2: "11.0.10586.632" ) ){
			Vulnerable_range1 = "11.0.10586.0 - 11.0.10586.632";
			VULN1 = TRUE;
		}
		else {
			if(version_in_range( version: edgVer, test_version: "11.0.14393.0", test_version2: "11.0.14393.320" )){
