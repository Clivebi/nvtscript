...
if(description){
  ...
  release, disable respective features, remove the product or replace the product by another one." );
	...
	script_dependencies( "gb_wpn_xm_server_stack_detect.sc" );
...
if(http_vuln_check( port: wpnport, url: url, check_header: TRUE, pattern: "<script>alert\\(document.cookie\\)</script>", extra_check: make_list( ">Configuration<",
	 ">phpmyadmin<" ) )){
