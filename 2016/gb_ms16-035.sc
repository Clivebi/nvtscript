					...
					if( hotfix_check_sp( win8_1: 1, win8_1x64: 1, win2012R2: 1 ) > 0 ){
						...
						if( hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0 ){
							...
							if( hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2, winVista: 3, win2008: 3 ) > 0 ){
								...
								if( ( hotfix_check_sp( win2012: 1 ) > 0 ) && ( version_in_range( version: dllVer2, test_version: "4.0.30319.34000", test_version2: "4.0.30319.34291" ) ) ){
									VULN = TRUE;
									vulnerable_range = "4.0.30319.34000 - 4.0.30319.34291";
								}
								else {
									if( ( hotfix_check_sp( win8_1: 1, win8_1x64: 1 ) > 0 ) && ( version_in_range( version: dllVer2, test_version: "4.0.30319.34000", test_version2: "4.0.30319.36345" ) ) ){
										VULN = TRUE;
										vulnerable_range = "4.0.30319.34000 - 4.0.30319.36345";
									}
									else {
										if( ( hotfix_check_sp( win8_1: 1, win8_1x64: 1, win2012: 1 ) > 0 ) && ( version_in_range( version: dllVer2, test_version: "4.6.1000.0", test_version2: "4.6.1072.0" ) ) ){
											VULN = TRUE;
											vulnerable_range = "4.6.1000.0 - 4.6.1072.0";
										}
										else {
											if(( hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2, winVista: 3, win2008: 3 ) > 0 ) && ( version_in_range( version: dllVer2, test_version: "4.6.1000.0", test_version2: "4.6.1070.0" ) )){
												VULN = TRUE;
					...
					if( hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0 ){
						...
						if(hotfix_check_sp( winVista: 3, win2008: 3 ) > 0){
							if( version_in_range( version: dllVer, test_version: "3.0.6920.4000", test_version2: "3.0.6920.4230" ) ){
								...
								if(version_in_range( version: dllVer, test_version: "3.0.6920.8000", test_version2: "3.0.6920.8701" )){
									VULN1 = TRUE;
