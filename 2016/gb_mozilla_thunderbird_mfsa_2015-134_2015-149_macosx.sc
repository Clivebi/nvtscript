...
if(description){
	...
	script_cve_id( "CVE-2015-7214", "CVE-2015-7213", "CVE-2015-7205", "CVE-2015-7212", "CVE-2015-7201", "CVE-2015-7202" );
	...
	script_name( "Mozilla Thunderbird Security Update (mfsa_2015-134_2015-149) - Mac OS X" );
  ...
  (memory corruption and application crash) or possibly execute arbitrary code." );
	script_tag( name: "affected", value: "Mozilla Thunderbird versions before 38.5." );
	script_tag( name: "solution", value: "Update to version 38.5 or later." );
...
if(version_is_less( version: vers, test_version: "38.5" )){
	report = report_fixed_ver( installed_version: vers, fixed_version: "38.5", install_path: path );
