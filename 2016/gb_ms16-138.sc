	...
	if( hotfix_check_sp( win2012: 1 ) > 0 ){
		...
		if(hotfix_check_sp( win10: 1, win10x64: 1 ) > 0){
			if( version_is_less( version: MsvVer, test_version: "6.5.10240.17184" ) ){
				...
				if( version_in_range( version: MsvVer, test_version: "6.5.10586.0", test_version2: "6.5.10586.671" ) ){
					Vulnerable_range = "6.5.10586.0 - 6.5.10586.671";
					VULN = TRUE;
				}
				else {
					if(version_in_range( version: MsvVer, test_version: "6.5.14393.0", test_version2: "6.5.14393.446" )){
