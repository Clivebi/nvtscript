...
if(hotfix_check_sp( win8: 1, win8x64: 1, win2012: 1, win2012R2: 1, win8_1: 1, win8_1x64: 1, win10: 1, win10x64: 1 ) <= 0){
	exit( 0 );
}
...
if( hotfix_check_sp( win8: 1 ) > 0 && dllVer ){
	if( version_is_less( version: dllVer, test_version: "6.2.9200.17592" ) ){
		...
		if(version_in_range( version: dllVer, test_version: "6.2.9200.21000", test_version2: "6.2.9200.21707" )){
	...
	if( hotfix_check_sp( win8x64: 1, win2012: 1 ) > 0 && dllVer1 ){
		if( version_is_less( version: dllVer1, test_version: "6.2.9200.17590" ) ){
			...
			if(version_in_range( version: dllVer1, test_version: "6.2.9200.21000", test_version2: "6.2.9200.21707" )){
