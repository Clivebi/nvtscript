...
if(description){
  ...
  449 or later, or 6.1.3 build 441 or later, or 6.2.0 build 505 or later." );
	...
	script_dependencies( "gb_mcafee_application_control_detect.sc" );
...
if( version_in_range( version: mcafeeVer, test_version: "6.1.0", test_version2: "6.1.0.705" ) ){
	...
	if( version_in_range( version: mcafeeVer, test_version: "6.1.1", test_version2: "6.1.1.403" ) ){
		fix = "6.1.1 build 404";
		VULN = TRUE;
	}
	else {
		if( version_in_range( version: mcafeeVer, test_version: "6.1.2", test_version2: "6.1.2.448" ) ){
			fix = "6.1.2 build 449";
			VULN = TRUE;
		}
		else {
			if( version_in_range( version: mcafeeVer, test_version: "6.1.3", test_version2: "6.1.3.440" ) ){
				fix = "6.1.3 build 441";
				VULN = TRUE;
			}
			else {
				if(version_in_range( version: mcafeeVer, test_version: "6.2.0", test_version2: "6.2.0.504" )){
					fix = "6.2.0 build 505";
					VULN = TRUE;
				}
			}
