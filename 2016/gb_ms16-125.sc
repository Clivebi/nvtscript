...
if(hotfix_check_sp( win10: 1, win10x64: 1 ) > 0){
	if( version_is_less( version: sysVer, test_version: "11.0.10240.17146" ) ){
		...
		if( version_in_range( version: sysVer, test_version: "11.0.10586.0", test_version2: "11.0.10586.632" ) ){
			Vulnerable_range = "11.0.10586.0 - 11.0.10586.632";
			VULN = TRUE;
		}
		else {
			if(version_in_range( version: sysVer, test_version: "11.0.14393.0", test_version2: "11.0.14393.320" )){
