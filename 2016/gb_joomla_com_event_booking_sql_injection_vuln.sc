...
url = dir + "/index.php?option=com_eventbooking&view=calendar&layout" + "=weekly&date=%27SQL-INJECTION-TEST&Itemid=354#";
if(http_vuln_check( port: http_port, url: url, pattern: "You have an error in your SQL syntax", extra_check: make_list( "SQL-INJECTION-TEST",
	 ">1064 - Error: 1064<",
	 "FROM #__eb_events AS" ) )){
