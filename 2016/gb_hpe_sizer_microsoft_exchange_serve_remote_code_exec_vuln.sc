if(description){
  ...
  Exchange Server version 16.12.1 or later." );
	...
	script_dependencies( "gb_hpe_sizer_microsoft_exchange_server_detect.sc" );
	script_mandatory_keys( "HPE/sizer/microsoft/exchange/server" );
	exit( 0 );
}
require("version_func.inc.sc");
require("host_details.inc.sc");
cpe_list = make_list( "cpe:/a:hp:sizer_for_microsoft_exchange_server_2010",
	 "cpe:/a:hp:sizer_for_microsoft_exchange_server_2013",
	 "cpe:/a:hp:sizer_for_microsoft_exchange_server_2016" );
