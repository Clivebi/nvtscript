if(description){
	...
	script_cve_id( "CVE-2016-3266", "CVE-2016-3376", "CVE-2016-7185", "CVE-2016-7211", "CVE-2016-3341" );
...
if( hotfix_check_sp( win8_1: 1, win8_1x64: 1, win2012R2: 1 ) > 0 && win32Ver ){
	...
	if( hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0 && win32Ver ){
		...
		if( hotfix_check_sp( win2012: 1 ) > 0 && win32Ver ){
			...
			if( hotfix_check_sp( winVista: 3, winVistax64: 3, win2008: 3, win2008x64: 3 ) > 0 ){
				if( win32Ver && version_is_less( version: win32Ver, test_version: "6.0.6002.19693" ) ){
					...
					if( win32Ver && version_in_range( version: win32Ver, test_version: "6.0.6002.23000", test_version2: "6.0.6002.24016" ) ){
						Vulnerable_range = "6.0.6002.23000 - 6.0.6002.24016";
						VULN = TRUE;
					}
					else {
						if( mrxVer && version_is_less( version: mrxVer, test_version: "6.0.6002.19691" ) ){
							Vulnerable_range1 = "Less than 6.0.6002.19691";
							VULN1 = TRUE;
						}
						else {
							if(mrxVer && version_in_range( version: mrxVer, test_version: "6.0.6002.23000", test_version2: "6.0.6002.24015" )){
				...
				if(hotfix_check_sp( win10: 1, win10x64: 1 ) > 0 && edgeVer){
					if( edgeVer && version_is_less( version: edgeVer, test_version: "11.0.10240.17146" ) ){
						...
						if( edgeVer && version_in_range( version: edgeVer, test_version: "11.0.10586.0", test_version2: "11.0.10586.632" ) ){
							Vulnerable_range2 = "11.0.10586.0 - 11.0.10586.632";
							VULN2 = TRUE;
						}
						else {
							if(edgeVer && version_in_range( version: edgeVer, test_version: "11.0.14393.0", test_version2: "11.0.14393.320" )){
