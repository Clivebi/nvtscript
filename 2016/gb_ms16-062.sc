if(description){
	...
	script_cve_id( "CVE-2016-0171", "CVE-2016-0173", "CVE-2016-0174", "CVE-2016-0196", "CVE-2016-0175", "CVE-2016-0176", "CVE-2016-0197" );
	...
	if( hotfix_check_sp( winVista: 3, win2008: 3 ) > 0 ){
		if( dllVer1 ){
			if( version_is_less( version: dllVer1, test_version: "6.0.6002.19636" ) ){
				...
				if(version_in_range( version: dllVer1, test_version: "6.0.6002.23000", test_version2: "6.0.6002.23949" )){
			...
			if(dllVer2){
				if( version_is_less( version: dllVer2, test_version: "6.0.6002.19636" ) ){
					...
					if(version_in_range( version: dllVer2, test_version: "6.0.6002.23000", test_version2: "6.0.6002.23949" )){
				...
				if(hotfix_check_sp( win10: 1, win10x64: 1 ) > 0){
					if( dllVer1 ){
						if( version_is_less( version: dllVer1, test_version: "10.0.10240.16384" ) ){
							...
							if(version_in_range( version: dllVer1, test_version: "10.0.10586.0", test_version2: "10.0.10586.19" )){
						...
						if(dllVer2){
							if( version_is_less( version: dllVer2, test_version: "10.0.10240.16841" ) ){
								...
								if(version_in_range( version: dllVer2, test_version: "10.0.10586.0", test_version2: "10.0.10586.305" )){
