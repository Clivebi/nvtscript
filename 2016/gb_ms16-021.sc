...
if( hotfix_check_sp( win2012: 1 ) > 0 ){
	if( version_is_less( version: dllVer, test_version: "6.2.9200.17623" ) ){
		...
		if(version_in_range( version: dllVer, test_version: "6.2.9200.21000", test_version2: "6.2.9200.21742" )){
	...
	if( hotfix_check_sp( win2012R2: 1 ) > 0 ){
		...
		if( hotfix_check_sp( win2008: 3 ) > 0 ){
			if( version_is_less( version: dllVer, test_version: "6.0.6002.19578" ) ){
				...
				if(version_in_range( version: dllVer, test_version: "6.0.6002.23000", test_version2: "6.0.6002.23887" )){
			...
			if(hotfix_check_sp( win2008r2: 2 ) > 0){
				if( version_is_less( version: dllVer, test_version: "6.1.7601.19114" ) ){
					...
					if(version_in_range( version: dllVer, test_version: "6.1.7601.23000", test_version2: "6.1.7601.23317" )){
