if(description){
	...
	script_cve_id( "CVE-2016-7214", "CVE-2016-7215", "CVE-2016-7218", "CVE-2016-7246", "CVE-2016-7255" );
...
if(hotfix_check_sp( winVista: 3, win7: 2, win7x64: 2, win2008: 3, win2008r2: 2, winVistax64: 3, win2008x64: 3, win2012: 1, win2012R2: 1, win8_1: 1, win8_1x64: 1, win10: 1, win10x64: 1 ) <= 0){
	exit( 0 );
}
...
if( hotfix_check_sp( winVista: 3, winVistax64: 3, win2008: 3, win2008x64: 3 ) > 0 ){
	if( version_is_less( version: winVer, test_version: "6.0.6002.19706" ) ){
		...
		if( version_in_range( version: winVer, test_version: "6.0.6002.23000", test_version2: "6.0.6002.24028" ) ){
			Vulnerable_range1 = "6.0.6002.23000 - 6.0.6002.24028";
			VULN1 = TRUE;
		}
		else {
			if( version_is_less( version: brVer, test_version: "6.0.6002.19698" ) ){
				Vulnerable_range2 = "Less than 6.0.6002.19698";
				VULN2 = TRUE;
			}
			else {
				if(version_in_range( version: brVer, test_version: "6.0.6002.23000", test_version2: "6.0.6002.24020" )){
	...
	if( hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2 ) > 0 && brVer ){
		...
		if( hotfix_check_sp( win2012: 1 ) > 0 && brVer ){
			...
			if( hotfix_check_sp( win8_1: 1, win8_1x64: 1, win2012R2: 1 ) > 0 && winVer ){
				...
				if(hotfix_check_sp( win10: 1, win10x64: 1 ) > 0 && winVer){
					if( version_is_less( version: winVer, test_version: "10.0.10240.16384" ) ){
						Vulnerable_range1 = "Less than 10.0.10240.16384";
						VULN1 = TRUE;
					}
					else {
						if( version_in_range( version: winVer, test_version: "10.0.10586.0", test_version2: "10.0.10586.19" ) ){
							Vulnerable_range1 = "10.0.10586.0 - 10.0.10586.19";
							VULN1 = TRUE;
						}
						else {
							if(version_in_range( version: winVer, test_version: "10.0.14393.0", test_version2: "10.0.14393.446" )){
