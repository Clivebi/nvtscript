...
if(description){
	...
	script_name( "ISC BIND Denial of Service Vulnerability (CVE-2015-8000)" );
	script_tag( name: "summary", value: "ISC BIND is prone to a remote denial of service vulnerability." );
	script_tag( name: "vuldetect", value: "Checks if a vulnerable version is present on the target host." );
	script_tag( name: "insight", value: "The flaw is due to an error in the 'db.c'
  file in ISC BIND." );
  ...
  9.10.0 through 9.10.3." );
	script_tag( name: "solution", value: "Update to ISC BIND version 9.9.8-P2
...
if( version_in_range( version: version, test_version: "9.0", test_version2: "9.9.8" ) ){
	...
	if(version_in_range( version: version, test_version: "9.10.0", test_version2: "9.10.3" )){
		fix = "9.10.3-P2";
		VULN = TRUE;
	}
}
