...
if(hotfix_check_sp( winVista: 3, win7: 2, win7x64: 2, winVistax64: 3, win2008: 3, win2008x64: 3, win2008r2: 2 ) <= 0){
	exit( 0 );
}
...
if( hotfix_check_sp( winVista: 3, winVistax64: 3, win2008x64: 3, win2008: 3 ) > 0 ){
	if(version_is_less( version: kerVer, test_version: "6.0.6002.19700" ) || version_in_range( version: kerVer, test_version: "6.0.6002.23000", test_version2: "6.0.6002.24023" )){
		VULN = TRUE;
	}
}
else {
