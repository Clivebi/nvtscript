...
if(description){
  ...
  release, disable respective features, remove the product or replace the product by another one." );
	...
	script_dependencies( "gb_option_cloudgate_consolidation.sc" );
...
if(http_vuln_check( port: port, url: url, check_header: TRUE, pattern: "navigation.firewall' | i18n", extra_check: make_list( "firewall.defaultPolicies",
	 "firewall.rebootChanges",
