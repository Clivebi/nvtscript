	...
	if( hotfix_check_sp( winVista: 3, win2008: 3 ) > 0 ){
		if(dllver1){
			if( version_is_less( version: dllver1, test_version: "6.0.6002.19660" ) ){
				...
				if(version_in_range( version: dllver1, test_version: "6.0.6002.23000", test_version2: "6.0.6002.23974" )){
		...
		if(dllver2){
			if( version_is_less( version: dllver2, test_version: "6.0.6002.18272" ) ){
				...
				if(version_in_range( version: dllver2, test_version: "6.0.6002.23000", test_version2: "6.0.6002.23973" )){
				...
				if(hotfix_check_sp( win10: 1, win10x64: 1 ) > 0){
					if(dllver1){
						if( version_is_less( version: dllver1, test_version: "10.0.10240.16942" ) ){
							...
							if(version_in_range( version: dllver1, test_version: "10.0.10586.0", test_version2: "10.0.10586.419" )){
					...
					if(dllver2){
						if( version_is_less( version: dllver2, test_version: "10.0.10240.16384" ) ){
							...
							if(version_in_range( version: dllver2, test_version: "10.0.10586.0", test_version2: "10.0.10586.419" )){
								Vulnerable_range = "10.0.10586.0 - 10.0.10586.419";
								VULN2 = TRUE;
							}
						}
