...
if(description){
  ...
  relationship between their browser and the server." );
	...
	script_dependencies( "gb_xzeres_442SR_wind_turbine_detect.sc" );
...
if(http_vuln_check( port: windPort, url: url, check_header: TRUE, pattern: "<script>alert\\(document.cookie\\);</script>", extra_check: make_list( "VOLTAGE",
	 "CURRENT",
	 "POWER" ) )){
