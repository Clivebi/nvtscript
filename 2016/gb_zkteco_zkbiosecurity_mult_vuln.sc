...
if(description){
  ...
  release, disable respective features, remove the product or replace the product by another one." );
	...
	script_dependencies( "gb_zkteco_zkbiosecurity_detect.sc", "gb_default_credentials_options.sc" );
...
if(ContainsString( resp, "OK - Number of results:" ) && ContainsString( resp, "Name: Catalina:" ) && ContainsString( resp, "modelerType:" ) && ContainsString( resp, "minTime:" )){
