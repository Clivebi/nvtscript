...
if(description){
	...
	script_cve_id( "CVE-2016-0102", "CVE-2016-0103", "CVE-2016-0104", "CVE-2016-0105", "CVE-2016-0106", "CVE-2016-0107", "CVE-2016-0108", "CVE-2016-0109", "CVE-2016-0110", "CVE-2016-0111", "CVE-2016-0112", "CVE-2016-0113", "CVE-2016-0114" );
...
if( hotfix_check_sp( winVista: 3, win2008: 3 ) > 0 ){
	if( version_in_range( version: dllVer, test_version: "9.0.8112.16000", test_version2: "9.0.8112.16748" ) ){
		...
		if(version_in_range( version: dllVer, test_version: "9.0.8112.20000", test_version2: "9.0.8112.20863" )){
	...
	if( hotfix_check_sp( win7: 2, win7x64: 2, win2008r2: 2, win8_1: 1, win8_1x64: 1, win2012R2: 1 ) > 0 ){
		...
		if( hotfix_check_sp( win2012: 1 ) > 0 ){
			if( version_in_range( version: dllVer, test_version: "10.0.9200.16000", test_version2: "10.0.9200.17661" ) ){
				...
				if(version_in_range( version: dllVer, test_version: "10.0.9200.20000", test_version2: "10.0.9200.21779" )){
