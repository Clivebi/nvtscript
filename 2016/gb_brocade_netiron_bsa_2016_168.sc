...
if(description){
	...
	script_dependencies( "gb_brocade_netiron_snmp_detect.sc" );
...
if(!ContainsString( t, "MLX" )){
	exit( 99 );
}
fix = FALSE;
if(IsMatchRegexp( version, "^5\\.8\\.0" )){
	if(revcomp( a: version, b: "5.8.0e" ) <= 0){
		fix = "5.8.00ec";
	}
}
if(IsMatchRegexp( version, "^5\\.9\\.0" )){
	if(revcomp( a: version, b: "5.9.0bd" ) <= 0){
		fix = "5.9.00be";
	}
}
if(IsMatchRegexp( version, "^6\\.0\\.0" )){
	if(revcomp( a: version, b: "6.0.0a" ) <= 0){
		fix = "6.0.00ab";
	}
}
if(fix){
