...
if(description){
  ...
  6.3.2.6, or 6.4.3.3, or 7.1.6, or later." );
	...
	script_dependencies( "gb_ibm_tiv_tsm_detect_lin.sc" );
...
if( version_in_range( version: tivVer, test_version: "5.5", test_version2: "6.3.2.5" ) ){
	...
	if( version_in_range( version: tivVer, test_version: "6.4", test_version2: "6.4.3.2" ) ){
		fix = "6.4.3.3";
		VULN = TRUE;
	}
	else {
		if(version_in_range( version: tivVer, test_version: "7.1", test_version2: "7.1.5" )){
			fix = "7.1.6";
			VULN = TRUE;
		}
	}
