...
exePath = registry_get_sz( key: "SOFTWARE\\Microsoft\\Windows\\CurrentVersion" + "\\Uninstall\\FFFTP", item: "InstallLocation" );
if(exePath){
	...
	if(ffftpVer != NULL){
		...
		log_message( data: "FFFTP Client version " + ffftpVer + " running at location " + exePath + " was detected on the host" );
