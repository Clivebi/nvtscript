if(description){
	...
	script_version( "2021-09-03T07:24:29+0000" );
	script_tag( name: "cvss_base", value: "0.0" );
	script_tag( name: "cvss_base_vector", value: "AV:N/AC:L/Au:N/C:N/I:N/A:N" );
	script_tag( name: "last_modification", value: "2021-09-03 07:24:29 +0000 (Fri, 03 Sep 2021)" );
...
for key in key_list {
	for item in registry_enum_keys( key: key ) {
		...
		if(!app_name || !IsMatchRegexp( app_name, "PuTTY" ) || IsMatchRegexp( app_name, "Session Manager" )){
			continue;
		}
		...
		register_and_report_cpe( app: app_name, ver: version, concluded: concluded, base: "cpe:/a:putty:putty:", expr: "^([0-9.]+)", insloc: location, regService: "smb-login", regPort: 0 );
		exit( 0 );
	}
}
exit( 0 );
