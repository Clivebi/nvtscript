...
for key in key_list {
	for item in registry_enum_keys( key: key ) {
		...
		if(ContainsString( adName, "Adobe Premiere Rush" )){
			...
			register_and_report_cpe( app: "Adobe Premiere Rush", ver: adVer, concluded: "Adobe Premiere Rush", cpename: cpe, insloc: adPath );
			exit( 0 );
		}
	}
}
