...
if(ContainsString( res, "meta name=\"sa/config/environment\"" ) && ContainsString( res, "rsa-loader__wheel" )){
	version = "unknown";
	...
	log_message( data: build_detection_report( app: "RSA NetWitness Platform", version: version, install: "/", cpe: cpe, concluded: vers[0] ), port: port );
	exit( 0 );
}
exit( 0 );
