...
if(banner && ContainsString( banner, "Avaya Aura Conferencing" )){
	version = "unknown";
	...
	log_message( data: build_detection_report( app: "Avaya Aura Conferencing", version: version, install: location, cpe: cpe, concluded: banner ), port: port, proto: proto );
}
exit( 0 );
