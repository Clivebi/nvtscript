...
if( AppEventLAutoBackupLogFiles == "0" || AppEventLAutoBackupLogFiles ){
	...
	set_kb_item( name: "WMI/ELCP/AppEventLAutoBackupLogFiles", value: val );
}
if( SecEventLAutoBackupLogFiles == "0" || SecEventLAutoBackupLogFiles ){
	...
	set_kb_item( name: "WMI/ELCP/SecEventLAutoBackupLogFiles", value: val );
}
if( SetEventLAutoBackupLogFiles == "0" || SetEventLAutoBackupLogFiles ){
	...
	set_kb_item( name: "WMI/ELCP/SetEventLAutoBackupLogFiles", value: val );
}
if( SysEventLAutoBackupLogFiles == "0" || SysEventLAutoBackupLogFiles ){
	...
	set_kb_item( name: "WMI/ELCP/SysEventLAutoBackupLogFiles", value: val );
}
if( AppEventLChannelAccess == "0" || AppEventLChannelAccess ){
	...
	set_kb_item( name: "WMI/ELCP/AppEventLChannelAccess", value: val );
}
if( SecEventLChannelAccess == "0" || SecEventLChannelAccess ){
	...
	set_kb_item( name: "WMI/ELCP/SecEventLChannelAccess", value: val );
}
if( SetEventLChannelAccess == "0" || SetEventLChannelAccess ){
	...
	set_kb_item( name: "WMI/ELCP/SetEventLChannelAccess", value: val );
}
...
if( LocAppEventLRetention == "0" || LocAppEventLRetention ){
	...
	set_kb_item( name: "WMI/ELCP/LocAppEventLRetention", value: val );
}
if( LocSecEventLRetention == "0" || LocSecEventLRetention ){
	...
	set_kb_item( name: "WMI/ELCP/LocSecEventLRetention", value: val );
}
if( LocSysEventLRetention == "0" || LocSysEventLRetention ){
	...
	set_kb_item( name: "WMI/ELCP/LocSysEventLRetention", value: val );
}
if( LocAppEventLRestrictGuestAccess == "0" || LocAppEventLRestrictGuestAccess ){
	...
	set_kb_item( name: "WMI/ELCP/LocAppEventLRestrictGuestAccess", value: val );
}
if( LocSecEventLRestrictGuestAccess == "0" || LocSecEventLRestrictGuestAccess ){
	...
	set_kb_item( name: "WMI/ELCP/LocSecEventLRestrictGuestAccess", value: val );
}
if( LocSysEventLRestrictGuestAccess == "0" || LocSysEventLRestrictGuestAccess ){
	...
	set_kb_item( name: "WMI/ELCP/LocSysEventLRestrictGuestAccess", value: val );
}
if( LocAppEventLAutoBackupLogFiles == "0" || LocAppEventLAutoBackupLogFiles ){
	...
	set_kb_item( name: "WMI/ELCP/LocAppEventLAutoBackupLogFiles", value: val );
}
if( LocSecEventLAutoBackupLogFiles == "0" || LocSecEventLAutoBackupLogFiles ){
	...
	set_kb_item( name: "WMI/ELCP/LocSecEventLAutoBackupLogFiles", value: val );
}
if( LocSysEventLAutoBackupLogFiles == "0" || LocSysEventLAutoBackupLogFiles ){
	...
	set_kb_item( name: "WMI/ELCP/LocSysEventLAutoBackupLogFiles", value: val );
}
wmi_close( wmi_handle: handlereg );
