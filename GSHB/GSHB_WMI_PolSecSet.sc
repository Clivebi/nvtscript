...
if(autodisconnect != "0"){
	autodisconnect = hex2dec( xvalue: autodisconnect );
}
...
if(KeepAliveTime != "0"){
	KeepAliveTime = hex2dec( xvalue: KeepAliveTime );
}
...
if( ContainsString( MachinePathsKEY, "machine" ) ){
...
if(maximumComppasswordage != "0"){
	maximumComppasswordage = hex2dec( xvalue: maximumComppasswordage );
}
...
if( ContainsString( NullSessionPipesKEY, "nullsessionpipes" ) ){
	...
	if(!NullSessionPipes){
		NullSessionPipes = "Empty";
	}
}
else {
	NullSessionPipes = "None";
}
if( ContainsString( NullSessionPipesKEY, "nullsessionshares" ) ){
...
if(passwordexpirywarning != "0"){
	passwordexpirywarning = hex2dec( xvalue: passwordexpirywarning );
}
...
if(ScreenSaverGracePeriod != "0"){
	ScreenSaverGracePeriod = hex2dec( xvalue: ScreenSaverGracePeriod );
}
...
if(TcpMaxDataRetransmissions != "0"){
	TcpMaxDataRetransmissions = hex2dec( xvalue: TcpMaxDataRetransmissions );
}
...
if(WarningLevel != "0"){
	WarningLevel = hex2dec( xvalue: WarningLevel );
}
...
if( disablepasswordchange == "0" || disablepasswordchange ){
	...
	set_kb_item( name: "WMI/cps/disablepasswordchange", value: val );
}
if( DisableSavePasswordRasMan == "0" || DisableSavePasswordRasMan ){
	...
	set_kb_item( name: "WMI/cps/DisableSavePasswordRasMan", value: val );
}
...
if( EnableSecuritySignatureWs == "0" || EnableSecuritySignatureWs ){
	...
	set_kb_item( name: "WMI/cps/EnableSecuritySignatureWs", value: val );
}
if( EnableSecuritySignatureSvr == "0" || EnableSecuritySignatureSvr ){
	...
	set_kb_item( name: "WMI/cps/EnableSecuritySignatureSvr", value: val );
}
...
if( MachineAccessRestriction == "0" || MachineAccessRestriction ){
	...
	set_kb_item( name: "WMI/cps/MachineAccessRestriction", value: val );
}
if( MachineLaunchRestriction == "0" || MachineLaunchRestriction ){
	...
	set_kb_item( name: "WMI/cps/MachineLaunchRestriction", value: val );
}
...
if( NoNameReleaseOnDemand == "0" || NoNameReleaseOnDemand ){
	...
	set_kb_item( name: "WMI/cps/NoNameReleaseOnDemand", value: val );
}
...
if( passwordexpirywarning == "0" || passwordexpirywarning ){
	...
	set_kb_item( name: "WMI/cps/passwordexpirywarning", value: val );
}
...
if( TcpMaxConnectResponseRetransmissions == "0" || TcpMaxConnectResponseRetransmissions ){
	...
	set_kb_item( name: "WMI/cps/TcpMaxConnectResponseRetransmissions", value: val );
}
...
if( HandwritingRecognition1 == "0" || HandwritingRecognition1 ){
	...
	set_kb_item( name: "WMI/Win8Policies/HandwritingRecognition1", value: val );
}
if( HandwritingRecognition2 == "0" || HandwritingRecognition2 ){
	...
	set_kb_item( name: "WMI/Win8Policies/HandwritingRecognition2", value: val );
}
...
if( SeIncreaseQuotaPrivilege || SeIncreaseQuotaPrivilege == "0" ){
	...
	set_kb_item( name: "WMI/cps/SeIncreaseQuotaPrivilege", value: val );
}
if( SeBackupPrivilege || SeBackupPrivilege == "0" ){
	set_kb_item( name: "WMI/cps/SeBackupPrivilege", value: SeBackupPrivilege );
}
else {
	set_kb_item( name: "WMI/cps/SeBackupPrivilege", value: val );
}
if( SeChangeNotifyPrivilege || SeChangeNotifyPrivilege == "0" ){
	...
	set_kb_item( name: "WMI/cps/SeChangeNotifyPrivilege", value: val );
}
if( SeSystemtimePrivilege || SeSystemtimePrivilege == "0" ){
	...
	set_kb_item( name: "WMI/cps/SeSystemtimePrivilege", value: val );
}
if( SeCreatePagefilePrivilege || SeCreatePagefilePrivilege == "0" ){
	...
	set_kb_item( name: "WMI/cps/SeCreatePagefilePrivilege", value: val );
}
if( SeCreateTokenPrivilege || SeCreateTokenPrivilege == "0" ){
	...
	set_kb_item( name: "WMI/cps/SeCreateTokenPrivilege", value: val );
}
if( SeCreateGlobalPrivilege || SeCreateGlobalPrivilege == "0" ){
	...
	set_kb_item( name: "WMI/cps/SeCreateGlobalPrivilege", value: val );
}
if( SeCreatePermanentPrivilege || SeCreatePermanentPrivilege == "0" ){
	...
	set_kb_item( name: "WMI/cps/SeCreatePermanentPrivilege", value: val );
}
if( SeDebugPrivilege || SeDebugPrivilege == "0" ){
	set_kb_item( name: "WMI/cps/SeDebugPrivilege", value: SeDebugPrivilege );
}
else {
	set_kb_item( name: "WMI/cps/SeDebugPrivilege", value: val );
}
if( SeDenyNetworkLogonRight || SeDenyNetworkLogonRight == "0" ){
	...
	set_kb_item( name: "WMI/cps/SeDenyNetworkLogonRight", value: val );
}
if( SeEnableDelegationPrivilege || SeEnableDelegationPrivilege == "0" ){
	...
	set_kb_item( name: "WMI/cps/SeEnableDelegationPrivilege", value: val );
}
if( SeRemoteShutdownPrivilege || SeRemoteShutdownPrivilege == "0" ){
	...
	set_kb_item( name: "WMI/cps/SeRemoteShutdownPrivilege", value: val );
}
if( SeImpersonatePrivilege || SeImpersonatePrivilege == "0" ){
	...
	set_kb_item( name: "WMI/cps/SeImpersonatePrivilege", value: val );
}
if( SeIncreaseBasePriorityPrivilege || SeIncreaseBasePriorityPrivilege == "0" ){
	...
	set_kb_item( name: "WMI/cps/SeIncreaseBasePriorityPrivilege", value: val );
}
if( SeLoadDriverPrivilege || SeLoadDriverPrivilege == "0" ){
	...
	set_kb_item( name: "WMI/cps/SeLoadDriverPrivilege", value: val );
}
...
if( SeSystemEnvironmentPrivilege || SeSystemEnvironmentPrivilege == "0" ){
	...
	set_kb_item( name: "WMI/cps/SeSystemEnvironmentPrivilege", value: val );
}
if( SeManageVolumePrivilege || SeManageVolumePrivilege == "0" ){
	...
	set_kb_item( name: "WMI/cps/SeManageVolumePrivilege", value: val );
}
if( SeProfileSingleProcessPrivilege || SeProfileSingleProcessPrivilege == "0" ){
	...
	set_kb_item( name: "WMI/cps/SeProfileSingleProcessPrivilege", value: val );
}
if( SeSystemProfilePrivilege || SeSystemProfilePrivilege == "0" ){
	...
	set_kb_item( name: "WMI/cps/SeSystemProfilePrivilege", value: val );
}
if( SeUndockPrivilege || SeUndockPrivilege == "0" ){
	set_kb_item( name: "WMI/cps/SeUndockPrivilege", value: SeUndockPrivilege );
}
else {
	set_kb_item( name: "WMI/cps/SeUndockPrivilege", value: val );
}
if( SeAssignPrimaryTokenPrivilege || SeAssignPrimaryTokenPrivilege == "0" ){
	...
	set_kb_item( name: "WMI/cps/SeAssignPrimaryTokenPrivilege", value: val );
}
if( SeShutdownPrivilege || SeShutdownPrivilege == "0" ){
	set_kb_item( name: "WMI/cps/SeShutdownPrivilege", value: SeShutdownPrivilege );
}
else {
	set_kb_item( name: "WMI/cps/SeShutdownPrivilege", value: val );
}
if( SeMachineAccountPrivilege || SeMachineAccountPrivilege == "0" ){
	...
	set_kb_item( name: "WMI/cps/SeMachineAccountPrivilege", value: val );
}
if( SeInteractiveLogonRight || SeInteractiveLogonRight == "0" ){
	...
	set_kb_item( name: "WMI/cps/SeInteractiveLogonRight", value: val );
}
if( SeRemoteInteractiveLogonRight || SeRemoteInteractiveLogonRight == "0" ){
	...
	set_kb_item( name: "WMI/cps/SeRemoteInteractiveLogonRight", value: val );
}
if( SeDenyBatchLogonRight || SeDenyBatchLogonRight == "0" ){
	...
	set_kb_item( name: "WMI/cps/SeDenyBatchLogonRight", value: val );
}
if( SeDenyServiceLogonRight || SeDenyServiceLogonRight == "0" ){
	...
	set_kb_item( name: "WMI/cps/SeDenyServiceLogonRight", value: val );
}
if( SeDenyInteractiveLogonRight || SeDenyInteractiveLogonRight == "0" ){
	...
	set_kb_item( name: "WMI/cps/SeDenyInteractiveLogonRight", value: val );
}
...
if( SeTakeOwnershipPrivilege || SeTakeOwnershipPrivilege == "0" ){
	...
	set_kb_item( name: "WMI/cps/SeTakeOwnershipPrivilege", value: val );
}
...
if( RestrictGuestAccessApp || RestrictGuestAccessApp == "0" ){
	...
	set_kb_item( name: "WMI/cps/RestrictGuestAccessApp", value: val );
}
if( RestrictGuestAccessSec || RestrictGuestAccessSec == "0" ){
	...
	set_kb_item( name: "WMI/cps/RestrictGuestAccessSec", value: val );
}
...
if( !LMCOMPLEVELKEY ){
	...
	if( !ContainsString( LMCOMPLEVELKEY, "lmcompatibilitylevel" ) ){
...
if( IsMatchRegexp( lmcomplevel, "[0-9]" ) ) {
	set_kb_item( name: "WMI/scp/LMCompatibilityLevel", value: lmcomplevel );
}
else {
	set_kb_item( name: "WMI/scp/LMCompatibilityLevel", value: "None" );
}
...
if(NTLMMinClientSec != "0"){
	NTLMMinClientSec = hex2dec( xvalue: NTLMMinClientSec );
}
...
if(NTLMMinServerSec != "0"){
	NTLMMinServerSec = hex2dec( xvalue: NTLMMinServerSec );
}
...
if( requiresignorseal || requiresignorseal == "0" ){
	...
	set_kb_item( name: "WMI/cps/requiresignorseal", value: val );
}
if( requirestrongkey || requirestrongkey == "0" ){
	set_kb_item( name: "WMI/cps/requirestrongkey", value: requirestrongkey );
}
else {
	set_kb_item( name: "WMI/cps/requirestrongkey", value: val );
}
if( RequireSecuritySignatureWs || RequireSecuritySignatureWs == "0" ){
	...
	set_kb_item( name: "WMI/cps/RequireSecuritySignatureWs", value: val );
}
...
if( EnablePlainTextPassword || EnablePlainTextPassword == "0" ){
	...
	set_kb_item( name: "WMI/cps/EnablePlainTextPassword", value: val );
}
wmi_close( wmi_handle: handlereg );
wmi_close( wmi_handle: handlersop );
wmi_close( wmi_handle: handle );
