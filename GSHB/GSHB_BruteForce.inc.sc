BruteForcePWList = make_list( "|",
	 ...
	 "daemon|daemon",
	 "daemon|",
	 "[DATABASENAME]_MAINT|[DATABASENAME]_MAINT_PW",
	 "DATAMOVE|",
	 "davox|davox",
	 "|db2admin",
	 "|dbase",
