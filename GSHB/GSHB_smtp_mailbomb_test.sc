if(description){
	...
	script_dependencies( "compliance_tests.sc", "smtpserver_detect.sc", "smtp_settings.sc" );
...
send( socket: s, data: NASLString( "HELO ", smtp_get_helo_from_kb(), "\\r\\n" ) );
...
header = NASLString( "From: ", fromaddr, "\\r\\n", "To: ", toaddr, "\\r\\n", "Organization: ", vtstrings["default"], "\\r\\n", "MIME-Version: 1.0\\r\\n" );
