mtitle = make_list( "APP.1.1.A1|Sicherstellen der Integrität von Office-Produkten|",
	 ...
	 "APP.1.1.A9|Beseitigung von Restinformationen vor Weitergabe von Dokumenten|",
	 ...
	 "APP.1.1.A13|Verwendung von Viewer-Funktionen|",
	 "APP.1.1.A14|Schutz gegen nachträgliche Veränderungen von Informationen|",
	 "APP.1.1.A15|Einsatz von Verschlüsselung und Digitalen Signaturen|",
	 "APP.1.1.A16|Integritätsprüfung von Dokumenten|",
	 "APP.3.3.A1|Geeignete Aufstellung|",
	 ...
	 "APP.3.4.A1|Planung des Einsatzes eines Samba-Servers|",
	 ...
	 "APP.5.2.A13|Schulung von Administratoren|",
	 "APP.5.2.A14|Schulung zu Sicherheitsmechanismen von Outlook für Anwender|",
	 "APP.5.2.A15|Anwendungsdokumentation für Microsoft Exchange|",
	 "APP.5.2.A16|Erstellung eines Notfallplans für den Ausfall von Microsoft Exchange und Outlook|",
	 "APP.5.2.A17|Verschlüsselung von Microsoft Exchange-Systemdatenbanken|",
	 "APP.5.2.A18|Regelmäßige Sicherheitsprüfungen für Microsoft Exchange-Systeme|",
	 "SYS.1.2.2.A1|Planung von Windows Server 2012|Basis",
	 "SYS.1.2.2.A2|Sichere Installation von Windows Server 2012|Basis",
	 "SYS.1.2.2.A3|Sichere Administration von Windows Server 2012|Basis",
	 "SYS.1.2.2.A4|Sichere Konfiguration von Windows Server 2012|Standard",
	 "SYS.1.2.2.A5|Schutz vor Schadsoftware|Standard",
	 "SYS.1.2.2.A6|Sichere Authentisierung und Autorisierung in Windows Server 2012|Standard",
	 "SYS.1.2.2.A7|Sicherheitsprüfung von Windows Server 2012|Standard",
	 "SYS.1.2.2.A8|Schutz der Systemintegrität|Standard",
	 "SYS.1.2.2.A9|Lokale Kommunikationsfilterung|Kern",
	 "SYS.1.2.2.A10|Festplattenverschlüsselung bei Windows Server 2012|Kern",
	 "SYS.1.2.2.A11|Angriffserkennung bei Windows Server 2012|Kern",
	 "SYS.1.2.2.A12|Redundanz und Hochverfügbarkeit|Kern",
	 "SYS.1.2.2.A13|Starke Authentifizierung bei Windows Server 2012|Kern",
	 "SYS.1.2.2.A14|Herunterfahren verschlüsselter Server und virtueller Maschinen|Kern",
	 "SYS.1.3.A1|Benutzerauthentisierung unter Unix|Basis",
	 "SYS.1.3.A2|Sorgfältige Vergabe von IDs|Basis",
	 "SYS.1.3.A3|Automatisches Einbinden von Wechsellaufwerken|Basis",
	 "SYS.1.3.A4|Schutz von Anwendungen|Basis",
	 "SYS.1.3.A5|Sichere Installation von Software-Paketen|Basis",
	 "SYS.1.3.A6|Verwaltung von Benutzern und Gruppen|Standard",
	 "SYS.1.3.A7|Zusätzliche Absicherung des Zugangs zum Single-User- und Wiederherstellungsmodus|Standard",
	 "SYS.1.3.A8|Verschlüsselter Zugriff über Secure Shell|Standard",
	 "SYS.1.3.A9|Absicherung des Bootvorgangs|Standard",
	 "SYS.1.3.A10|Verhinderung der Ausbreitung bei der Ausnutzung von Schwachstellen|Standard",
	 "SYS.1.3.A11|Einsatz der Sicherheitsmechanismen von NFS|Standard",
	 "SYS.1.3.A12|Einsatz der Sicherheitsmechanismen von NIS|Standard",
	 "SYS.1.3.A13|Zusätzlicher Schutz der priviligierten Anmeldeinformationen|Kern",
	 "SYS.1.3.A14|Verhinderung des Ausspähens von System- und Benutzerinformationen|Kern",
	 "SYS.1.3.A15|Zusätzliche Absicherung des Bootvorgangs|Kern",
	 "SYS.1.3.A16|Zusätzliche Verhinderung der Ausbreitung bei der Ausnutzung von Schwachstellen|Kern",
	 "SYS.1.3.A17|Zusätzlicher Schutz des Kernels|Kern",
	 ...
	 "SYS.2.2.2.A1|Geeignete Auswahl einer Windows 8.1-Version|Basis",
	 "SYS.2.2.2.A2|Festlegung eines Anmeldeverfahrens|Basis",
	 "SYS.2.2.2.A3|Einsatz von Viren-Schutzprogrammen|Basis",
	 "SYS.2.2.2.A4|Beschaffung von Windows 8.1|Standard",
	 "SYS.2.2.2.A5|Lokale Sicherheitsrichtlinien|Standard",
	 "SYS.2.2.2.A6|Datei- und Freigabeberechtigungen|Standard",
	 "SYS.2.2.2.A7|Einsatz der Windows-Benutzerkontensteuerung UAC|Standard",
	 "SYS.2.2.2.A8|Verwendung der Heimnetzgruppen-Funktion|Standard",
	 "SYS.2.2.2.A9|Datenschutz und Datensparsamkeit bei Windows 8.1-Clients|Standard",
	 "SYS.2.2.2.A10|Integration von Online-Konten in das Betriebssystem|Standard",
	 "SYS.2.2.2.A11|Konfiguration von Synchronisationsmechanismen in Windows 8.1|Standard",
	 "SYS.2.2.2.A12|Zentrale Authentifizierung in Windows-Netzwerken|Standard",
	 "SYS.2.2.2.A13|Anbindung von Windows 8.1 an AppStores|Standard",
	 "SYS.2.2.2.A14|Anwendungssteuerung mit Software Restriction Policies und AppLocker|Kern",
	 "SYS.2.2.2.A15|Verschlüsselung des Dateisystems mit EFS|Kern",
	 "SYS.2.2.2.A16|Verwendung der Windows PowerShell|Kern",
	 "SYS.2.2.2.A17|Sicherer Einsatz des Wartungscenters|Kern",
	 "SYS.2.2.2.A18|Aktivierung des Last-Access-Zeitstempels|Kern",
	 "SYS.2.2.2.A19|Verwendung der Anmeldeinformationsverwaltung|Kern",
	 "SYS.2.2.2.A20|Sicherheit beim Fernzugriff über RDP|Kern",
	 "SYS.2.2.2.A21|Einsatz von File und Registry Virtualization|Kern",
	 "SYS.2.2.3.A1|Planung des Einsatzes von Cloud-Diensten|Basis",
	 "SYS.2.2.3.A2|Geeignete Auswahl einer Windows 10-Version und Beschaffung|Basis",
	 "SYS.2.2.3.A3|Geeignetes Patch- und Änderungsmanagement|Basis",
	 "SYS.2.2.3.A4|Telemetrie und Datenschutzeinstellungen|Basis",
	 "SYS.2.2.3.A5|Schutz vor Schadsoftware|Basis",
	 "SYS.2.2.3.A6|Integration von Online-Konten in das Betriebssystem|Basis",
	 "SYS.2.2.3.A7|Lokale Sicherheitsrichtlinien|Standard",
	 "SYS.2.2.3.A8|Zentrale Verwaltung der Sicherheitsrichtlinien von Clients|Standard",
	 "SYS.2.2.3.A9|Sichere zentrale Authentisierung der Windows-Clients|Standard",
	 "SYS.2.2.3.A10|Konfiguration zum Schutz von Anwendungen in Windows 10|Standard",
	 "SYS.2.2.3.A11|Schutz der Anmeldeinformationen in Windows 10|Standard",
	 "SYS.2.2.3.A12|Datei- und Freigabeberechtigungen|Standard",
	 "SYS.2.2.3.A13|Einsatz der SmartScreen-Funktionen|Standard",
	 "SYS.2.2.3.A14|Einsatz des Sprachassistenten Cortana|Standard",
	 "SYS.2.2.3.A15|Einsatz der Synchronisationsmechanismen in Windows 10|Standard",
	 "SYS.2.2.3.A16|Anbindung von Windows 10 an den Windows Store|Standard",
	 "SYS.2.2.3.A17|Verwendung der automatischen Anmeldung|Standard",
	 "SYS.2.2.3.A18|Einsatz der Windows-Remoteunterstützung|Standard",
	 "SYS.2.2.3.A19|Verwendung des Fernzugriffs über RDP|Standard",
	 "SYS.2.2.3.A20|Einsatz der Benutzerkontensteuerung für privilegierte Konten|Standard",
	 "SYS.2.2.3.A21|Einsatz des Encrypting File Systems EFS|Kern",
	 "SYS.2.2.3.A22|Windows PowerShell|Kern",
	 "SYS.2.2.3.A23|Erweiterter Schutz der Anmeldeinformationen in Windows 10|Kern",
	 "SYS.2.2.3.A24|Aktivierung des Last-Access-Zeitstempels|Kern",
	 "SYS.2.2.3.A25|Umgang mit Fernzugriffsfunktionen der \"Connected User Experience and Telemetry\"|Kern",
	 "SYS.2.3.A1|Authentisierung von Administratoren und Benutzer|Basis",
	 "SYS.2.3.A2|Auswahl einer geeigneten Distribution|Basis",
	 "SYS.2.3.A3|Cloud- und Online-Inhalte|Basis",
	 "SYS.2.3.A4|Einspielen von Updates und Patches|Basis",
	 "SYS.2.3.A5|Sichere Installation von Software-Paketen|Basis",
	 "SYS.2.3.A6|Automatisches Einbinden von Wechsellaufwerken|Standard",
	 "SYS.2.3.A7|Restriktive Rechtevergabe auf Dateien und Verzeichnisse|Standard",
	 "SYS.2.3.A8|Einsatz von Techniken zur Rechtebeschränkung von Anwendungen|Standard",
	 "SYS.2.3.A9|Passwörter auf der Kommandozeile|Standard",
	 "SYS.2.3.A10|Absicherung des Bootvorgangs|Standard",
	 "SYS.2.3.A11|Verhinderung der Überlastung der Festplatte|Standard",
	 "SYS.2.3.A12|Einsatz von Appliances als Clients|Standard",
	 "SYS.2.3.A13|Schutz vor unbefugten Anmeldungen|Kern",
	 "SYS.2.3.A14|Absicherung gegen Nutzung unbefugter Peripheriegeräte|Kern",
	 "SYS.2.3.A15|Zusätzlicher Schutz vor der Ausführung unerwünschter Dateien|Kern",
	 "SYS.2.3.A16|Zusätzliche Absicherung des Bootvorgangs|Kern",
	 "SYS.2.3.A17|Zusätzliche Verhinderung der Ausbreitung bei der Ausnutzung von Schwachstellen|Kern",
	 "SYS.2.3.A18|Zusätzlicher Schutz des Kernels|Kern",
	 "SYS.2.3.A19|Festplatten- oder Dateiverschlüsselung|Kern",
	 "SYS.2.3.A20|Abschaltung kritischer SysRq-Funktionen|Kern",
