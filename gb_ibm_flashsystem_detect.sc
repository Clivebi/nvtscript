...
if(ContainsString( res, "- Log in -" ) && ContainsString( res, "poweredByStorwize" ) && ContainsString( res, "IBM FlashSystem" )){
	version = "unknown";
	...
	log_message( data: build_detection_report( app: "IBM FlashSystem " + model, version: version, install: "/", cpe: cpe ), port: port );
	exit( 0 );
}
exit( 0 );
