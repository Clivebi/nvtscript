...
for item in registry_enum_keys( key: key ) {
	...
	if(IsMatchRegexp( avastName, "avast! Endpoint Protection$" )){
		...
		if(avastVer){
			...
			log_message( data: build_detection_report( app: "Avast Endpoint Protection", version: avastVer, install: avastPath, cpe: cpe, concluded: avastVer ) );
			exit( 0 );
		}
	}
}
